# -*- coding: utf-8 -*-
"""Load per-Program Postlog import configuration."""
...
def load_program_config(program_name):
    base_path = Path(__file__).resolve().parents[2] / "postlog_configs"
    ...
    for path in candidate_paths:
        if path.exists():
            ...
            return config
    raise UserError(
        "No Postlog import config was found for Program '%s' and no default config exists."
