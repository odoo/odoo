...
class TestPayslipOvertime(HrWorkEntryAttendanceCommon):
    ...
    def test_02_overtime_classic_day_before_after(self):
        ...
        self.assertEqual(work_entries[1].work_entry_type_id, self.attendance_type)
        self.assertEqual(work_entries[2].date_start, datetime(2022, 12, 12, 11, 0))
        self.assertEqual(work_entries[2].date_stop, datetime(2022, 12, 12, 12, 0))
        self.assertEqual(work_entries[2].work_entry_type_id, self.overtime_type)
        self.assertEqual(work_entries[3].date_start, datetime(2022, 12, 12, 12, 0))
        self.assertEqual(work_entries[3].date_stop, datetime(2022, 12, 12, 16, 0))
        self.assertEqual(work_entries[3].work_entry_type_id, self.attendance_type)
        self.assertEqual(work_entries[4].date_start, datetime(2022, 12, 12, 16, 0))
        self.assertEqual(work_entries[4].date_stop, datetime(2022, 12, 12, 20, 0))
        self.assertEqual(work_entries[4].work_entry_type_id, self.overtime_type)
    ...
    def test_04_overtime_classic_day_after(self):
        ...
        self.assertEqual(work_entries[0].date_stop, datetime(2022, 12, 12, 11, 0))
        self.assertEqual(work_entries[0].work_entry_type_id, self.attendance_type)
        self.assertEqual(work_entries[1].date_start, datetime(2022, 12, 12, 11, 0))
        self.assertEqual(work_entries[1].date_stop, datetime(2022, 12, 12, 12, 0))
        ...
        self.assertEqual(work_entries[3].date_stop, datetime(2022, 12, 12, 17, 0))
