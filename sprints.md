...
| Sprint | Fechas planificadas | Lider / Scrum Master | Objetivo del sprint | Entregable principal | Estado |
|---|---|---|---|---|---|
...
Esta tabla muestra quien creo issues en GitHub. No equivale necesariamente a quien hizo todo el trabajo, pero si muestra quien formalizo tareas en el backlog.
...
| Integrante | Sprint 0 | Sprint 1 | Sprint 2 | Sprint 3 | Sprint 4 |
|---|---|---|---|---|---|
| Saul Sivincha | Planificacion del cronograma maestro y apoyo al backlog inicial | Gestion de backlog e issues, organizacion de tareas y analisis de Ventas | QA, pruebas funcionales y consolidacion de evidencias | Pruebas del flujo de aprobacion y limite parametrizable | Scrum Master, portal GitHub Pages, insumos finales y PR de cierre |
