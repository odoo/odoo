            ...
            # -------------------------------------------------
                ...
                if field._type == 'datetime' and right and len(right) == 10:
                    ...
                    subselect = """WITH temp_{current_table} (id, name) as (
                            ...
                            SELECT id FROM temp_{current_table} WHERE {quote_left} {operator} {right} order by name
                            """.format(current_table=working_model._table, quote_left=quote_left, operator=sql_operator,
                                       right=instr)
