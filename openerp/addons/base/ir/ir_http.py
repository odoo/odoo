...
class ir_http(osv.AbstractModel):
    ...
    def _serve_attachment(self):
        ...
        attach = self.pool['ir.attachment'].search_read(request.cr, openerp.SUPERUSER_ID, domain, ['__last_update', 'datas', 'datas_fname'], context=request.context)
        if attach:
            ...
            response.mimetype = mimetypes.guess_type(attach[0]['datas_fname'])[0] or 'application/octet-stream'
