...
class module(osv.osv):
    ...
    def uninstalled_module_dependencies(self, cr, uid, ids, known_dep_ids=None,
        ...
        known_dep_ids |= new_dep_ids
        if missing_mod_ids:
            known_dep_ids |= set(self.uninstalled_module_dependencies(cr, uid, list(missing_mod_ids),
                                                              known_dep_ids, exclude_states, context))
        return list(known_dep_ids)
