...
class TestGetFilters(FiltersCase):
    ...
    def test_own_filters(self):
        ...
        self.assertItemsEqual(map(noid, filters), [
            dict(name='a', is_default=False, user_id=self.USER, domain='[]', context='{}', sort='[]', serialization=False),
            dict(name='b', is_default=False, user_id=self.USER, domain='[]', context='{}', sort='[]', serialization=False),
            dict(name='c', is_default=False, user_id=self.USER, domain='[]', context='{}', sort='[]', serialization=False),
            dict(name='d', is_default=False, user_id=self.USER, domain='[]', context='{}', sort='[]', serialization=False),
        ])
    ...
    def test_global_filters(self):
        ...
        self.assertItemsEqual(map(noid, filters), [
            dict(name='a', is_default=False, user_id=False, domain='[]', context='{}', sort='[]', serialization=False),
            dict(name='b', is_default=False, user_id=False, domain='[]', context='{}', sort='[]', serialization=False),
            dict(name='c', is_default=False, user_id=False, domain='[]', context='{}', sort='[]', serialization=False),
            dict(name='d', is_default=False, user_id=False, domain='[]', context='{}', sort='[]', serialization=False),
        ])
...
class TestOwnDefaults(FiltersCase):
    ...
    def test_new_no_filter(self):
        ...
        self.assertItemsEqual(map(noid, filters), [
            dict(name='a', user_id=self.USER, is_default=True,
                 domain='[]', context='{}', sort='[]', serialization=False)
        ])
    ...
    def test_new_filter_not_default(self):
        ...
        self.assertItemsEqual(map(noid, filters), [
            dict(name='a', user_id=self.USER, is_default=False, domain='[]', context='{}', sort='[]', serialization=False),
            dict(name='b', user_id=self.USER, is_default=False, domain='[]', context='{}', sort='[]', serialization=False),
            dict(name='c', user_id=self.USER, is_default=True, domain='[]', context='{}', sort='[]', serialization=False),
        ])
    ...
    def test_update_filter_set_default(self):
        ...
        self.assertItemsEqual(map(noid, filters), [
            dict(name='a', user_id=self.USER, is_default=True, domain='[]', context='{}', sort='[]', serialization=False),
            dict(name='b', user_id=self.USER, is_default=False, domain='[]', context='{}', sort='[]', serialization=False),
        ])
...
class TestGlobalDefaults(FiltersCase):
    ...
    def test_new_filter_not_default(self):
        ...
        self.assertItemsEqual(map(noid, filters), [
            dict(name='a', user_id=False, is_default=False, domain='[]', context='{}', sort='[]', serialization=False),
            dict(name='b', user_id=False, is_default=False, domain='[]', context='{}', sort='[]', serialization=False),
            dict(name='c', user_id=False, is_default=True, domain='[]', context='{}', sort='[]', serialization=False),
        ])
    ...
    def test_update_default_filter(self):
        ...
        self.assertItemsEqual(map(noid, filters), [
            dict(name='a', user_id=False, is_default=False, domain='[]', context='{}', sort='[]', serialization=False),
            dict(name='b', user_id=False, is_default=True, domain='[]', context=context_value, sort='[]', serialization=False),
        ])
