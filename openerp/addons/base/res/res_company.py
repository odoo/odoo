...
<header>
    <pageTemplate>
        ...
        <pageGraphics>
            ...
            <drawString x="1.3cm" y="%s">[[ display_address(company.partner_id) or  '' ]]</drawString>
    ...
    _header_a4 = _header_main % ('23.0cm', '27.6cm', '27.7cm', '27.7cm', '27.8cm', '27.2cm', '26.8cm', '26.0cm', '26.0cm', '25.6cm', '25.6cm', '25.5cm', '25.5cm')
