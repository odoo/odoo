...
class res_company(osv.osv):
    ...
    def _company_default_get(self, cr, uid, object=False, field=False, context=None):
        ...
        The 'object' and 'field' arguments are unused and have been left
        there for backward compatibility with code from before the 
        'multi_company.default' feature removal.
        """
