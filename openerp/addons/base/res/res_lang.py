    ...
    def unlink(self, cr, uid, ids, context=None):
        ...
        for language in languages:
            ...
            if language['code']=='en_US':
                raise UserError(_('User Error'), _("Base Language 'en_US' can not be deleted!"))
            if ctx_lang and (language['code']==ctx_lang):
                raise UserError(_('User Error'), _("You cannot delete the language which is User's Preferred Language!"))
            if language['active']:
                raise UserError(_('User Error'), _("You cannot delete the language which is Active!\nPlease de-activate the language first."))
