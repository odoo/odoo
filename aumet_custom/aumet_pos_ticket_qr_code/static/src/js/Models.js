odoo.define('aumet_pos_ticket_qr_code.models', function (require) {
    "use strict";
    ...
    models.Order = models.Order.extend({
        initialize: function (attributes, options) {
			...
			var link_str = web_base_url+'/verify/qr/'+this.get_name();
            var rpc_qr = rpc.query({model: 'pos.order', method: 'action_receipt_qrcode', args: [[], link_str]})
                .then(function (data) {
                    self.qr_code = data
                })
            return this
