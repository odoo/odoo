...
"use strict";
    ...
    models.load_fields('product.product',['active_ingredient_ids','active_ingredient_str', 'supplier_data_json']);
    ...
    POS_db.include({
        ...
        if (product.active_ingredient_str) {
                str += '|' + product.active_ingredient_str;
            }
