...
class TestRecurrentEvent(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.daily_event = self.CalendarEvent = self.env['calendar.event']
    ...
    def test_recurrent_meeting1(self):
        ...
        self.daily_event = self.CalendarEvent.create({
            'count': 5,
    ...
    def test_recurrent_meeting3(self):
        ...
        idval = '%d-%s' % (self.calendar_event_sprint_review, '20110901130100')
        ...
        idval = '%d-%s' % (self.calendar_event_sprint_review, '20110425124700')
        ...
        self.calendar_event_sprint_review.write({'description': DESCRIPTION})
        self.assertEqual(self.calendar_event_sprint_review.description, DESCRIPTION, "Event %d has not been updated" % self.calendar_event_sprint_review.id)
