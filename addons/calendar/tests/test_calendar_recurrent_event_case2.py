...
class TestRecurrentEvent(common.TransactionCase):
    ...
    def test_recurrent_meeting1(self):
        ...
        self.CalendarEvent.create({
            'count': 5,
            'start_datetime': '2011-04-13 11:04:00',
            'stop_datetime': '2011-04-13 12:04:00',
            'duration': 1.0,
            'name': 'Test Meeting',
            'recurrency': True,
            'rrule_type': 'daily'
        ...
        meetings_count = self.CalendarEvent.with_context({'virtual_id': True}).search_count([
            ('start_datetime', '>=', '2011-03-13'), ('stop_datetime', '<=', '2011-05-13')
        ])
    ...
    def test_recurrent_meeting2(self):
        ...
        self.CalendarEvent.create({
            'start_datetime': '2011-04-18 11:47:00',
            'stop_datetime': '2011-04-18 12:47:00',
            'day': 1,
            'duration': 1.0,
            'until': '2011-04-30',
            'end_type': 'end_date',
