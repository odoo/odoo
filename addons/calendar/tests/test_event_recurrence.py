...
class TestUpdateRecurrentEvents(TestRecurrentEvents):
    ...
    def test_unlink_recurrence_wizard_next(self):
        ...
        # Test preparation
        # Retrieve the recurring event to delete the next occurrence
        event = self.events[1]
        # Test execution
        ...
        form_delete.save()
        # Test execution
        # Send cancellation notifications and delete the next occurrence
    ...
    def test_unlink_recurrence_wizard_all(self):
        ...
        # Test preparation
        # Retrieve the recurring event to be deleted
        event = self.events[1]
        # Test execution
        ...
        form_delete.save()
        # Test execution
        # Send cancellation notifications and delete all recurrences
        wizard_delete.action_send_mail_and_delete()
        # Test expected results
