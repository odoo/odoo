...
class Meeting(models.Model):
    ...
    def get_origin_meeting_and_schedule_fields(self):
        """ Given a virtual event record. This method return the original record and its id. It also return schedule fields for the virtual event.
            Mainly used to avoid code duplication.
        """
    ...
    def action_detach_recurring_event(self):
        """ Action used in the view to only update the virtual event we selected. It call the function to detach the virtual record and create a new from it.
    ...
    def get_split_recurring_event(self):
        ...
        try:
            ...
            raise UserError('Save your recurrent settings before choosing an action')
        if event_position == 0:
