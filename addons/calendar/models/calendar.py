...
class Meeting(models.Model):
    ...
    def read(self, fields=None, load='_classic_read'):
        ...
        public_fields = set(recurrent_fields + ['id', 'active', 'allday', 'start', 'stop', 'display_start', 'display_stop', 'duration', 'user_id', 'state', 'interval', 'count', 'recurrent_id', 'recurrent_id_date', 'rrule', 'privacy'])
        for r in result:
            if r['user_id']:
