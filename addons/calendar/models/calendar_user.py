...
class CalendarUser(models.Model):
    ...
    user_id = fields.Many2one('res.users', string='User', index='btree', required=True, readonly=True)
    ...
    is_filter_active = fields.Boolean('Shown in Filters List', default=True)
    is_filter_checked = fields.Boolean('Filter Enabled', default=True)
