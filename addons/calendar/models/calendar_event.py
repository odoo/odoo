...
from odoo.tools import pycompat, html2plaintext, is_html_empty, single_email_re, html_sanitize
...
class Meeting(models.Model):
    ...
    def _get_customer_description(self):
        """:return (html): The description in HTML format to include in calendar exports"""
