...
class calendar_event(osv.Model):
    ...
    _columns = {
        ...
        'start': fields.function(_compute, fnct_inv=lambda *args: None, string='Start', type="datetime", multi='attendee', store=True, help="Start date of an event, without time for full days events"),
        'stop': fields.function(_compute, string='Stop', type="datetime", multi='attendee', store=True, help="Stop date of an event, without time for full days events"),
