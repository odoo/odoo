...
export class AttendeeCalendarModel extends CalendarModel {
    ...
    /**
     * Get the Ids of all partners we should fetch events for. This includes the users
     * selected in the attendee filters and the current user if the primary calendar
     * filter is active.
     */
