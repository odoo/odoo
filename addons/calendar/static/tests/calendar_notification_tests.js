...
import { createWebClient, getActionManagerTestConfig } from '@web/../tests/actions/helpers';
...
QUnit.module('Calendar Notification', (hooks) => {
  ...
  hooks.beforeEach(() => {
    ...
    testConfig.serviceRegistry.add('calendarNotification', calendarNotificationService);
  ...
  QUnit.test('can listen on bus and display notifications in DOM and click OK', async (assert) => {
    assert.expect(5);
  ...
  QUnit.test('can listen on bus and display notifications in DOM and click Detail', async (assert) => {
    assert.expect(5);
  ...
  QUnit.test('can listen on bus and display notifications in DOM and click Snooze', async (assert) => {
    assert.expect(4);
