...
class TestBlueprintInheritance(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.base_blueprint = cls.env['populate.blueprint'].create({
            ...
            'definition_xml': '''
                <data>
                    <create model="test_populate.customer" count="100" id="customers">
                    ...
                    <create model="test_populate.supplier" count="50" id="suppliers">
    ...
    def test_inherit_modify_model_attributes(self):
        child_blueprint = self.env['populate.blueprint'].create({
            ...
            'definition_xml': '''
                <data>
                    <create model="test_populate.customer" position="attributes">
        ...
        customer_model = next(m for m in definition if m['model'] == 'test_populate.customer')

        self.assertEqual(customer_model['count'], 500)
        self.assertEqual(customer_model['id'], 'customers')
    ...
    def test_inherit_add_model_after(self):
        child_blueprint = self.env['populate.blueprint'].create({
            ...
            'definition_xml': '''
                <data>
                    <create model="test_populate.customer" position="after">
                        <create model="test_populate.product" count="200" id="products">
        ...
        definition = child_blueprint.definition
        model_names = [m['model'] for m in definition]
    ...
    def test_inherit_add_model_before(self):
        child_blueprint = self.env['populate.blueprint'].create({
            ...
            'definition_xml': '''
                <data>
                    <create model="test_populate.supplier" position="before">
                        <create model="test_populate.product" count="75">
    ...
    def test_inherit_replace_model(self):
        child_blueprint = self.env['populate.blueprint'].create({
            ...
            'definition_xml': '''
                <data>
                    <create model="test_populate.customer" id="customers" position="replace">
                        <create model="test_populate.customer" count="1000" id="big_customers">
        ...
        self.assertEqual(customer_model['id'], 'big_customers')
    ...
    def test_inherit_add_field_inside_model(self):
        child_blueprint = self.env['populate.blueprint'].create({
            ...
            'definition_xml': '''
                <data>
                    <create model="test_populate.customer" position="inside">
    ...
    def test_inherit_using_xpath(self):
        child_blueprint = self.env['populate.blueprint'].create({
            ...
            'definition_xml': '''
                <data>
                    <xpath expr="//create[@model='test_populate.supplier']" position="attributes">
                        <attribute name="count">200</attribute>
                    </xpath>
                    <xpath expr="//create[@model='test_populate.supplier']" position="inside">
        ...
        definition = child_blueprint.definition
        supplier_model = next(m for m in definition if m['model'] == 'test_populate.supplier')
    ...
    def test_inherit_delete_model(self):
        child_blueprint = self.env['populate.blueprint'].create({
            ...
            'definition_xml': '''
                <data>
                    <create model="test_populate.supplier" position="replace"/>
                </data>
            ''',
        })
        ...
        child_blueprint = self.env['populate.blueprint'].create({
            ...
            'definition_xml': '''
                <data>
                    ...
                    <create model="test_populate.supplier" position="inside">
                        <field name="country_code" generator="choice.selection"/>
                    </create>
                    <create model="test_populate.supplier" position="after">
                        <create model="test_populate.product" count="100">
    ...
    def test_inherit_xpath_with_id_selector(self):
        child_blueprint = self.env['populate.blueprint'].create({
            ...
            'definition_xml': '''
                <data>
                    <xpath expr="//create[@id='customers']" position="attributes">
    ...
    def test_inherit_modify_field_inside_model(self):
        child_blueprint = self.env['populate.blueprint'].create({
            ...
            'definition_xml': '''
                <data>
                    <xpath expr="//create[@model='test_populate.customer']/field[@name='name']" position="attributes">
    ...
    def test_inherit_replace_field(self):
        child_blueprint = self.env['populate.blueprint'].create({
            ...
            'definition_xml': '''
                <data>
                    <xpath expr="//create[@model='test_populate.customer']/field[@name='email']" position="replace">
    ...
    def test_inherit_add_field_after_existing(self):
        child_blueprint = self.env['populate.blueprint'].create({
            ...
            'definition_xml': '''
                <data>
                    <xpath expr="//create[@model='test_populate.customer']/field[@name='name']" position="after">
    ...
    def test_inherit_remove_field(self):
        child_blueprint = self.env['populate.blueprint'].create({
            ...
            'definition_xml': '''
                <data>
                    <xpath expr="//create[@model='test_populate.customer']/field[@name='age']" position="replace"/>
                </data>
            ''',
        })
        ...
        grandchild_blueprint = self.env['populate.blueprint'].create({
            ...
            'definition_xml': '''
                <data>
                    ...
                    <create model="test_populate.supplier" position="attributes">
    ...
    def test_inherit_from_json_only_parent_fails(self):
        ...
        with self.assertRaises(ValueError):
            ...
            self.env['populate.blueprint'].create({
                ...
                'definition_xml': '''
                    <data>
                        <create model="test_populate.product" position="attributes">
