...
class ProductTemplate(models.Model):
    ...
    def _get_sales_prices(self, website):
        ...
        if (
            ...
            pricelist_prices = website.current_session_pricelist_id.sudo()._compute_price_rule(self, 1.0)
            for template_id, template_val in res.items():
                ...
                mapped_taxes = website.current_session_fiscal_position_id.sudo().map_tax(product_taxes)
    ...
    def _get_additionnal_combination_info(self, product_or_template, quantity, uom, date, website):
        ...
        if (
            ...
            pricelist_prices = website.current_session_pricelist_id.sudo()._compute_price_rule(product_or_template, quantity)
