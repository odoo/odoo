...
class ProductCatalogMixin(models.AbstractModel):
    ...
    def _create_order_section(self, section_name, child_field, *, at_top=False, **kwargs):
        ...
        :param bool at_top: If True, the section will be created at the top of the order.
        :param dict kwargs: Additional values given for inherited models.
        ...
        if self[child_field]:
            sequence = (
                self[child_field][0].sequence - 1 if at_top
                else self[child_field][-1].sequence + 1
            )
    ...
    def _get_order_sections(self, child_field, **kwargs):
        ...
        if no_section_count > 0:
            sections[False] = {
                ...
                'sequence': self[child_field][0].sequence - 1,
    ...
    def _get_section_model_info(self):
        ...
        :return: tuple of (line_model, parent_field)
        """
        return (False, False)

    def _is_valid_line(self, line):
        """ Determine whether a line should be counted as a valid line for section purposes.

        :param line: A record of an order line.
        :type line: recordset
        :return: True if this line is a valid line, else False.
        :rtype: bool
        """
        return (
