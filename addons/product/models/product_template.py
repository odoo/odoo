    ...
    def _create_variant_ids(self):
        ...
        for tmpl_id in self:
            ...
            if not tmpl_id.has_dynamic_attributes():
                ...
                for possible_combination in tmpl_id._filter_combinations_impossible_by_config(all_combinations, ignore_no_variant=True):
                    if possible_combination in existing_variants:
                        current_variants_to_activate += existing_variants[possible_combination]
                    else:
                        current_variants_to_create.append(tmpl_id._prepare_variant_values(possible_combination))
                ...
                variants_combinations = Product.concat(*existing_variants.values()).product_template_attribute_value_ids
