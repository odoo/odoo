...
class ProductTemplate(models.Model):
    ...
    uom_ids = fields.Many2many('uom.uom', string='Packagings', help="Packagings whih can be used for sales")
    ...
    def _get_weight_uom_name_from_ir_config_parameter(self):
        ...
        return 'lb' if product_weight_in_lbs_param == '1' else 'kg'
    ...
    def _get_length_uom_name_from_ir_config_parameter(self):
        ...
        return 'ft' if product_length_in_feet_param == '1' else 'mm'
