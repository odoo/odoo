...
class ProductPackaging(models.Model):
    ...
    barcode = fields.Char('Barcode', copy=False, help="Barcode used for packaging identification. Scan this product from a transfer in the Barcode app to move all the contained units")
