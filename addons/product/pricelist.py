...
# Added default function to fetch the Price type Based on Pricelist type.
    ...
    _columns = {
        ...
        'price_surcharge': fields.float('Price Surcharge',
            digits_compute= dp.get_precision('Price'), help='Specify the fixed amount to add or substract(if negative) to the amount calculated with the discount.'),
        'price_discount': fields.float('Price Discount', digits_compute=dp.get_precision('Price')),
        ...
        'price_min_margin': fields.float('Min. Price Margin',
            digits_compute= dp.get_precision('Price'), help='Specify the minimum amount of margin over the base price.'),
        'price_max_margin': fields.float('Max. Price Margin',
            digits_compute= dp.get_precision('Price'), help='Specify the maximum amount of margin over the base price.'),
