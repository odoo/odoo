...
class TestVariants(ProductVariantsCommon):
    ...
    def test_list_price(self):
        """ Ensure list_price/lst_price and currency_id are correctly (re)computed
        depending on the company context, mirroring standard_price/cost_currency_id. """
        one_variant_product = self.product
        self.assertEqual(one_variant_product.product_variant_count, 1)
        ...
        self.assertEqual(one_variant_product.with_company(company_b).currency_id, company_b.currency_id)
