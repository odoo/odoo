...
class product_template(osv.osv):
    ...
    _columns = {
        ...
        'volume': fields.float('Volume', help="The volume in m3 (Cubic Meters)."),
        ...
        'uom_po_id': fields.many2one('product.uom', 'Purchase Unit of Measure', required=True, help="Default Unit of Measure used for purchase orders. It must be in the same category as the default unit of measure.\n(e.g. KG(defaut UOM and Grams(purchase UOM))."),
...
class product_product(osv.osv):
    ...
    _columns = {
        ...
        'price_margin': fields.float('Variant Price Margin', digits_compute=dp.get_precision('Product Price'), help="Price Margin: Margin in percentage on a sale price for this variant product. eg. 10 price margin, 1000 * 1.1 = 1100. (or 10% variant price margin on 1000 sale price)."),
