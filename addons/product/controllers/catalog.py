...
class ProductCatalogController(Controller):
    ...
    def product_catalog_update_order_line_info(
        ...
        """Update the given 'order' for a given product.
        ...
        uom = order.env["uom.uom"].browse(uom_id) or product.uom_id
        return order._update_order_line_info(product, quantity, uom, **kwargs)
