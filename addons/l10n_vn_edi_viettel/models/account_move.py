...
class AccountMove(models.Model):
    ...
    def _l10n_vn_edi_fetch_invoice_xml_file_data(self):
        ...
        with SInvoiceService(access_token=access_token, vat=self.company_id.vat, env=self.env) as sinvoice:
            zip_data, error = sinvoice.get_invoice_file(
                self.l10n_vn_symbol_id.invoice_template_code,
    ...
    def action_l10n_vn_edi_update_payment_status(self):
        ...
        for invoice in invoices:
            ...
            with SInvoiceService(access_token=access_token, vat=invoice.company_id.vat, env=self.env) as sinvoice:
                ...
                template_code = invoice.l10n_vn_symbol_id.invoice_template_code
    ...
    def _l10n_vn_edi_check_invoice_configuration(self):
        ...
        if not self.l10n_vn_symbol_id:
            errors.append(_('The invoice symbol must be provided.'))
        if self.l10n_vn_symbol_id and not self.l10n_vn_symbol_id.invoice_template_code:
    ...
    def _l10n_vn_edi_add_general_invoice_information(self, json_values):
        ...
        invoice_data = {
            ...
            'templateCode': self.l10n_vn_symbol_id.invoice_template_code,
            'invoiceSeries': self.l10n_vn_symbol_id.name,
        ...
        if adjustment_origin_invoice:
            invoice_data.update({
                ...
                'originalTemplateCode': adjustment_origin_invoice.l10n_vn_symbol_id.invoice_template_code,
