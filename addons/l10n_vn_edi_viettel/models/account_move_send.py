...
class AccountMoveSend(models.AbstractModel):
    ...
    @api.model
    def _is_vn_sinvoice_applicable(self, move):
    ...
    def _get_default_extra_edi_checkboxes(self, move):
        ...
        if self._is_vn_sinvoice_applicable(move):
            extra_edi['vn_sinvoice_send'] = {'checked': True, 'readonly': False, 'label': _('Send to SInvoice')}
        return extra_edi
    ...
    def _generate_sinvoice_file_date(self, invoice, invoice_data):
        ...
        need_file = (
            ...
            or 'vn_sinvoice_send' in invoice_data['extra_edi']
        )
    ...
    def _call_web_service_before_invoice_pdf_render(self, invoices_data):
        ...
        for invoice, invoice_data in invoices_data.items():
            if 'vn_sinvoice_send' in invoice_data['extra_edi']:
                errors = invoice._l10n_vn_edi_check_invoice_configuration()
                if not errors:
