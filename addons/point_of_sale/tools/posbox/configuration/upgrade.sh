...
copy_raspios () {
    ...
    wget -c 'http://nightly.odoo.com/master/posbox/iotbox/iotbox-latest.zip' -O raspios/iotbox-latest.zip
    wget -c 'http://nightly.odoo.com/master/posbox/iotbox/SHA1SUMS.txt' -O raspios/SHA1SUMS.txt
    cd raspios/
