...
class pos_order(osv.osv):
    ...
    _columns = {
        ...
        'amount_tax': fields.function(_amount_all, string='Taxes', digits_compute=dp.get_precision('Amount'), multi='all'),
        'amount_total': fields.function(_amount_all, string='Total', multi='all'),
        'amount_paid': fields.function(_amount_all, string='Paid', states={'draft': [('readonly', False)]}, readonly=True, digits_compute=dp.get_precision('Amount'), multi='all'),
        'amount_return': fields.function(_amount_all, 'Returned', digits_compute=dp.get_precision('Amount'), multi='all'),
...
class pos_order_line(osv.osv):
    ...
    _columns = {
        ...
        'price_unit': fields.float(string='Unit Price', digits_compute=dp.get_precision('Price')),
        'qty': fields.float('Quantity', digits_compute=dp.get_precision('Quantity')),
