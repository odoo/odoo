...
class pos_order(osv.osv):
        ...
        if 'partner_id' in vals:
            for posorder in self.browse(cr, uid, ids, context=context):
                if posorder.invoice_id:
                    raise Warning( _('Error!'), _("You cannot change the partner of a POS order for which an invoice has already been issued."))
                if vals['partner_id']:
    ...
    def unlink(self, cr, uid, ids, context=None):
        for rec in self.browse(cr, uid, ids, context=context):
            if rec.state not in ('draft','cancel'):
                raise Warning(_('Unable to Delete!'), _('In order to delete a sale, it must be new or cancelled.'))
        ...
        for order in self.browse(cr, uid, ids, context=context):
            ...
            if order.partner_id:
                ...
                if not picking_type.default_location_dest_id:
                    raise Warning(_('Error!'), _('Missing source or destination location for picking type %s. Please configure those fields and try again.' % (picking_type.name,)))
    ...
    def cancel_order(self, cr, uid, ids, context=None):
        ...
        for order in self.browse(cr, uid, ids, context=context):
            ...
            if stock_picking_obj.browse(cr, uid, order.picking_id.id, context=context).state <> 'cancel':
                raise Warning(_('Error!'), _('Unable to cancel the picking.'))
    ...
    def add_payment(self, cr, uid, order_id, data, context=None):
        ...
        if not statement_id:
            raise Warning(_('Error!'), _('You have to open at least one cashbox.'))
    ...
    def refund(self, cr, uid, ids, context=None):
        ...
        for order in self.browse(cr, uid, ids, context=context):
            ...
            if not current_session_ids:
                raise Warning(_('Error!'), _('To return product(s), you need to open a session that will be used to register the refund.'))
    ...
    def action_invoice(self, cr, uid, ids, context=None):
        ...
        for order in self.pool.get('pos.order').browse(cr, uid, ids, context=context):
            ...
            if not order.partner_id:
                raise Warning(_('Error!'), _('Please provide a partner for the sale.'))
    ...
    def _create_account_move_line(self, cr, uid, ids, session=None, move_id=None, context=None):
        ...
        if session and not all(session.id == order.session_id.id for order in self.browse(cr, uid, ids, context=context)):
            raise Warning(_('Error!'), _('Selected orders do not have the same session!'))
        ...
        for order in self.browse(cr, uid, ids, context=context):
            ...
            for line in order.lines:
                ...
                if  line.product_id.property_account_income.id:
                    ...
                    raise Warning(_('Error!'), _('Please define income '\
