...
class PosMakeInvoice(models.TransientModel):
    ...
    def _prepare_invoice_vals(self, orders):
        ...
        vals = {
            ...
            'partner_bank_id': partner_id.bank_ids[0].id if partner_id.bank_ids else False,
    ...
    def prepare_invoices(self, orders):
        ...
        move.sudo().with_company(orders[0].company_id).with_context(skip_invoice_sync=True)._post()
