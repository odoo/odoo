...
class TestPointOfSaleCommon(ValuationReconciliationTestCommon):
    ...
    def setUpClass(cls):
        ...
        cls.main_company.point_of_sale_update_stock_quantities = 'real'
        setup_test_pos(cls)
        cls.pos_config.invoice_journal_id = cls.company_data['default_journal_sale']
        cls.pos_config.payment_method_ids.write({
