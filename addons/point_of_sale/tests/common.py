...
class TestPoSCommon(TransactionCase):
    ...
    def _create_taxes(self):
        ...
        self.tax_tag_invoice_base = create_tag('Invoice Base tag')
        self.tax_tag_invoice_tax = create_tag('Invoice Tax tag')
        self.tax_tag_refund_base = create_tag('Refund Base tag')
        self.tax_tag_refund_tax = create_tag('Refund Tax tag')
    ...
    def create_ui_order_data(self, product_quantity_discount_triplet, customer=False, is_invoiced=False, payments=None, uid=None):
        ...
        def create_order_line(product, quantity, discount=0):
            ...
            price_unit_after_discount = price_unit * (1-(discount or 0.0)/100.0)
            tax_values = (
