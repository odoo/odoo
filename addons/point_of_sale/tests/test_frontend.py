...
class TestUi(TestPointOfSaleHttpCommon):
    ...
    def test_receipt_screen_tour(self):
        ...
        self.start_pos_tour('FeedbackScreenTour', login="pos_user")
    ...
    #     self.main_pos_config.with_user(self.pos_admin).open_ui()
    #     self.start_tour("/pos/ui/%d" % self.main_pos_config.id, 'PaymentScreenTour2', login="pos_user", watch=True, debug=True, step_delay=250)
