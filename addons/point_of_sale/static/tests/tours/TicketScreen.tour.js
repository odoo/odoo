...
registry.category("web_tour.tours").add("test_multiple_refunds", {
        test: true,
        steps: () => [
                ProductScreen.confirmOpeningPopup(),
                ProductScreen.clickHomeCategory(),
                ...
                ProductScreen.selectedOrderlineHas("Product B", "1.00"),
                ProductScreen.clickPartnerButton(),
                ProductScreen.clickCustomer("John Doe"),
                ProductScreen.clickPayButton(),
                PaymentScreen.clickPaymentMethod("Bank"),
                ...
                TicketScreen.confirmRefund(),
                {
                content: "refund not possible",
                trigger: ".modal-header:contains('Refund not possible')",
                run: () => {},
                },
        ].flat(),
});
