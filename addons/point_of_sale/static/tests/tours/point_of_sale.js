odoo.define('point_of_sale.tour.pricelist', function (require) {
    ...
    var steps = [{ // Leave category displayed by default
        ...
        run: function () {
            ...
            var product_miscellaneous = posmodel.db.search_product_in_category(0, 'Misc')[0];
    ...
    steps = steps.concat([{
        ...
        trigger: ".product:contains('Misc'):contains('$ 1.00')",
        run: function () {}, // it's a check
    }, {
...
shelf have not (their price was manually overridden)",
        ...
        trigger: ".orderline:contains('Misc') em:contains('3.000')",
        run: function () {}, // it's a check
    }, {
