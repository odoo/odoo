...
registry.category("web_tour.tours").add("TicketScreenTour", {
    ...
    steps: () =>
        [
            ...
            Chrome.clickMenuButton(),
            Chrome.clickTicketButton(),
            TicketScreen.checkNthRowContains(2, "-0003"),
            TicketScreen.clickDiscard(),
            ProductScreen.addOrderline("Desk Pad", "1", "2"),
            ...
            Chrome.clickMenuButton(),
            Chrome.clickTicketButton(),
            TicketScreen.checkNthRowContains(2, "Partner Test 1", false),
            TicketScreen.clickNewTicket(),
            ProductScreen.addOrderline("Desk Pad", "1", "3"),
            ProductScreen.clickPartnerButton(),
            ...
            Chrome.clickMenuButton(),
            Chrome.clickTicketButton(),
            TicketScreen.checkNthRowContains(3, "Partner Test 2", false),
            TicketScreen.clickNewTicket(),
            ...
            Chrome.clickMenuButton(),
            Chrome.clickTicketButton(),
            TicketScreen.checkNthRowContains(4, "Receipt"),
            TicketScreen.selectFilter("Receipt"),
            TicketScreen.checkNthRowContains(2, "Receipt"),
            ...
            TicketScreen.checkNthRowContains(2, "Partner Test 2", false),
            ...
            TicketScreen.checkNthRowContains(2, "-0005"),
            TicketScreen.selectOrder("-0005"),
            TicketScreen.clickControlButton("Print Receipt"),
            TicketScreen.checkReceiptTotalIs("8.00"),
            ...
            TicketScreen.selectFilter("Paid"),
            TicketScreen.checkNthRowContains(2, "Partner Test 2", false),
            TicketScreen.checkNthRowContains(3, "-0005"),
            // Invoice order
            TicketScreen.selectOrder("-0005"),
            ...
            TicketScreen.checkToRefundTextContains("To Refund: 1.00"),
            TicketScreen.confirmRefund(),
            ProductScreen.goBackToMainScreen(),
            ProductScreen.isShown(),
            ProductScreen.checkSelectedOrderlineHas("Desk Pad", "-1.00"),
            inLeftSide([
            ...
            ProductScreen.checkSelectedOrderlineHas("Desk Pad", "-2.00"),
            // Check if the amount being refunded changed to 2.
            ...ProductScreen.clickRefund(),
            TicketScreen.selectOrder("-0005"),
            TicketScreen.checkToRefundTextContains("Refunding 2.00"),
            TicketScreen.clickDiscard(),
            ProductScreen.goBackToMainScreen(),
            ...
            ...ProductScreen.clickRefund(),
            TicketScreen.selectOrder("-0005"),
            TicketScreen.checkRefundedNoteContains("2.00 Refunded"),
        ].flat(),
});
