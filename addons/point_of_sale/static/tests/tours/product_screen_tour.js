...
registry.category("web_tour.tours").add("FiscalPositionNoTax", {
    ...
    steps: () =>
        [
            ...
            ProductScreen.clickInfoProduct("Test Product"),
            ProductScreen.priceOnProductInfoIs("100.00"),
            ProductScreen.productInfoTaxesAre(["VAT: Tax 15% (= $ 13.04"]),
            Dialog.confirm("Ok"),
            Dialog.isNot(),
            ...
            ProductScreen.clickInfoProduct("Test Product"),
            ProductScreen.priceOnProductInfoIs("100.00"),
            ProductScreen.productInfoTaxesAre(["VAT: 0 (= $ 0.00)"]), // We still show the VAT, it's just 0
            Dialog.confirm("Ok"),
            Dialog.isNot(),
