...
describe("pos.order", () => {
    ...
    test("preventRoundingErrorsCombo", async () => {
        ...
        expect(Math.round(order.lines[3].price_unit * 100) / 100).toBe(16.66);
        ...
        expect(order3.lines[1].qty).toBe(1);
        expect(order3.lines[1].price_unit).toBe(16.67);
        expect(Math.round(order3.lines[3].price_unit * 100) / 100).toBe(16.66);
        expect(order3.lines[4].qty).toBe(3);
        expect(order3.lines[4].price_unit).toBe(10);
    });
});
