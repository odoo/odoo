    ...
    steps: () =>
        [
            ...
            scan_barcode("MULTI_001"),
            {
                ...
                trigger: ".modal .modal-title:contains('Multi Attr Product')",
            },
            ProductConfiguratorPopup.pickMulti("Bacon"),
            Dialog.confirm("Add"),
            ProductScreen.selectedOrderlineHas("Multi Attr Product", "1.0", "13.0", "Bacon"),

            // dbc23b106c8b guard: "always" variant extra must be added once, not twice
            scan_barcode("ALWAYS_BLACK_001"),
            ProductScreen.selectedOrderlineHas("Always Variant Product", "1.0", "30.0", "Black"),
