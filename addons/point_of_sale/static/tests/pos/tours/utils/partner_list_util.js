    ...
    return [
        {
            ...
            trigger: `.modal-body.partner-list .overflow-y-auto`,
            run: () => {
                const partnerList = document.querySelector(".mobile-scroll-target");
        ...
        },
        {
            ...
            trigger: `.modal-body.partner-list .overflow-y-auto`,
            run: () => {
                const partnerList = document.querySelector(
                    ".modal-body.partner-list .overflow-y-auto"
                );
                partnerList.scrollTop = partnerList.scrollHeight;
            },
        },
