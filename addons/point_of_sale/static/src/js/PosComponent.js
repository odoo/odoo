...
export default class PosComponent extends LegacyComponent {
    setup() {
    ...
    showPopup(name, props) {
        // FIXME REMOVE THIS USE DIALOG SERVICE DIRECTLY
        return this.dialog.add(this.constructor.components[name], props);
        // FIXME popups background and style and promise.
