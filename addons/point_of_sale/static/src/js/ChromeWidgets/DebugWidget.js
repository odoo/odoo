...
export class DebugWidget extends PosComponent {
    setup() {
        ...
        this.state = useState({
            ...
            buffer: this.pos.numberBuffer.get(),
        });
        ...
        onMounted(() => {
            this.pos.numberBuffer.on("buffer-update", this, this._onBufferUpdate);
        });

        onWillUnmount(() => {
            this.pos.numberBuffer.off("buffer-update", this, this._onBufferUpdate);
        });
    }
    setWeight() {
