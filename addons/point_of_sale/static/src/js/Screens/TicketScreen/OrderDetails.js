odoo.define('point_of_sale.OrderDetails', function (require) {
    ...
    class OrderDetails extends PosComponent {
        ...
        get total() {
            return this.env.pos.format('monetary', this.order ? this.order.get_total_with_tax() : 0);
        }
        get tax() {
            return this.env.pos.format('monetary', this.order ? this.order.get_total_tax() : 0);
        }
    }
