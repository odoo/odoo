/** @odoo-module alias=point_of_sale.NumberBuffer **/
...
class NumberBuffer extends EventBus {
    ...
    _setUp() {
        ...
        this.maxTimeBetweenKeys = this.config.useWithBarcode ? BarcodeEvents.max_time_between_keys_in_ms : 0;
    }
    ...
    _updateBuffer(input) {
        ...
        if (input === this.decimalPoint) {
            ...
            this.state.buffer = this.component.env.model.formatValue(inputValue + currentBufferValue);
