/** @odoo-module alias=point_of_sale.Draggable **/
...
class Draggable extends PosComponent {
    ...
    mounted() {
        this.limitArea = this.props.limitArea ? document.querySelector(this.props.limitArea) : this.el.offsetParent;
        ...
        if (this.limitArea === this.el.offsetParent) {
            ...
            this.limitRight = this.limitAreaBoundingRect.width - this.el.offsetParent.offsetLeft;
            this.limitBottom = this.limitAreaBoundingRect.height - this.el.offsetParent.offsetTop;
        }
...
Draggable.template = 'point_of_sale.Draggable';
