...
export class Orderline extends PosModel {
    setup(_defaultObj, options) {
        ...
        this.price_changed = options.price_changed || false;
        if (options.json) {
            try {
    ...
    init_from_JSON(json) {
        ...
        this.price_changed = json.price_changed;
    ...
    clone() {
        ...
        orderline.price_changed = this.price_changed;
    ...
    set_quantity(quantity, keep_price) {
        ...
        if (!keep_price && !this.price_changed) {
            this.set_unit_price(
...
export class Order extends PosModel {
    ...
    set_pricelist(pricelist) {
        ...
        var lines_to_recompute = this.get_orderlines().filter((line) => !line.price_changed);
