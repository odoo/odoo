...
export class ReceiptPreview extends Component {
    ...
    setup() {
        ...
        useEffect(
            (value) => {
                if (!this.wrapwrapEl) {
                    this.loadHtmlIntoIframe(value);
                } else if (!this.props.record.data["write_date"]) {
                    this.mountReceiptComponent(value);
                }
            },
    ...
    mountReceiptComponent(value) {
        ...
        const app = new App(LazyComponent, {
            getTemplate,
            props: {
                bundle: "point_of_sale.recipt_assets_lazy",
...
export const receiptPreview = {
    ...
    displayName: "Order Receipt Preview",
