...
export class OrderReceipt extends Component {
    ...
    _getAdditionalLineInfo(line) {
        ...
        if (!this.props.basic_receipt && this.isLightLayout && line.price !== 0) {
            info.push({
                class: "price-per-unit",
                value: `${formatCurrency(line.unitDisplayPrice)} / ${
                    line.product_id.uom_id?.name || ""
                }`,
                iclass: "fa-money center pe-1",
            });
        }
