...
export class PosStore extends Reactive {
    ...
    async afterOrderDeletion() {
        this.set_order(this.get_open_orders().at(-1) || (await this.createNewOrder()));
    }
    ...
    async createNewOrder(data = {}) {
        ...
        const [posReference, sequenceNumber, trackingNumber] = await this.getPosReference();
    ...
    async add_new_order(data = {}) {
        ...
        const order = await this.createNewOrder(data);
