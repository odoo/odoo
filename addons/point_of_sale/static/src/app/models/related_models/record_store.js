...
export class RecordStore {
    ...
    /**
     * Iterates over each record in the specified index and applies a method to each entry.
     * @param {string} model - The name of the model.
     * @param {string} index - The name of the index
     * @param {Function} callback - The function to execute for each record (receives value and key).
     */
    forEachRecord(model, index = "id", callback) {
        const indexMap = this.getRecordsMap(model, index);
