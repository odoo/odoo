...
export class WebSerialScale extends ScaleInterface {
    ...
    async connectToScale() {
        ...
        for (const port of connectedPorts) {
            ...
            if (await this.isScaleSupported()) {
                break;
            }
    ...
    async isScaleSupported() {
        try {
            ...
            console.log(`Failed to open serial port: ${error.message}`);
            return false;
        }
        ...
        if (supported) {
            ...
            console.log(`Scale is not supported, response: ${response}`);
