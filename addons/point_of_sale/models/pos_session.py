...
class PosSession(models.Model):
    ...
    def _load_pos_data_models(self, config):
        return ['pos.config', 'pos.preset', 'resource.calendar.attendance', 'pos.order', 'pos.order.line', 'pos.pack.operation.lot', 'pos.payment', 'pos.payment.method', 'pos.printer',
            ...
            'account.cash.rounding', 'account.fiscal.position', 'stock.picking.type', 'res.currency', 'pos.note', 'product.tag', 'account.move', 'account.account', 'pos.product.template.snooze',
            'ir.ui.view']
