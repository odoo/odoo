...
class PosOrder(models.Model):
    ...
    def _amount_line_tax(self, cr, uid, line, fiscal_position_id, context=None):
        ...
        if fiscal_position_id:
            taxes = fiscal_position_id.map_tax(taxes, product_id=line.product_id.id, partner_id=line.order_id.partner_id.id)
    ...
    def _action_create_invoice_line(self, line=False, invoice_id=False):
        ...
        if fiscal_position_id:
            invoice_line.invoice_line_tax_ids = fiscal_position_id.map_tax(invoice_line.invoice_line_tax_ids, product_id=line.product_id.id, partner_id=line.order_id.partner_id.id)
...
class PosOrderLine(models.Model):
    ...
    def _get_tax_ids_after_fiscal_position(self):
        for line in self:
            line.tax_ids_after_fiscal_position = line.order_id.fiscal_position_id.map_tax(line.tax_ids, product_id=line.product_id.id, partner_id=line.order_id.partner_id.id)
