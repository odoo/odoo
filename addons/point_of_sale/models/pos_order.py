...
class PosOrder(models.Model):
    ...
    def _process_payment_lines(self, amount_return, order, pos_session, draft):
    ...
    def write(self, vals):
        for order in self:
            ...
            self._process_payment_lines(vals.get('amount_return', 0), order, order.session_id, order.state == 'draft')
    ...
    def action_pos_order_paid(self):
        ...
        # TODO: add support for mix of cash and non-cash payments when both cash_rounding and only_round_cash_method
...
class PosOrderLine(models.Model):
    ...
    def _load_pos_data_fields(self, config_id):
        return [
            ...
            'product_id', 'discount', 'tax_ids', 'pack_lot_ids', 'customer_note', 'price_extra', 'full_product_name', 'refunded_orderline_id', 'combo_parent_id', 'combo_line_ids', 'combo_item_id', 'refund_orderline_ids',
            'extra_tax_data',
        ]
