...
class PosOrder(models.Model):
    ...
    def _process_order(self, order, existing_order):
        ...
        combo_child_uuids_by_parent_uuid = defaultdict(list)
        for child_uuid, rec_fields in record_uuid_mapping.get('pos.order.line', {}).items():
            if 'combo_parent_id' in rec_fields:
                combo_child_uuids_by_parent_uuid[rec_fields['combo_parent_id']].append(child_uuid)
