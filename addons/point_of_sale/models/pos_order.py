...
class PosOrder(models.Model):
    ...
    currency_id = fields.Many2one('res.currency', related='config_id.currency_id', string="Currency", precompute=True, store=True)
...
class PosOrderLine(models.Model):
    ...
    currency_id = fields.Many2one('res.currency', related='order_id.currency_id', precompute=True, store=True)
