...
class PosOrderLine(models.Model):
    ...
    is_manual_price = fields.Boolean(string='Is Price Changed', help='Indicates if the price was manually changed in the order line.')
    ...
    def _load_pos_data_fields(self, config):
        return [
            ...
            'extra_tax_data', 'write_date', 'is_manual_price',
        ]
    ...
    def _prepare_base_line_for_taxes_computation(self):
        ...
        if line.tax_ids and self.is_manual_price:
