...
class PosOrder(models.Model):
    ...
    def cancel_order_from_pos(self):
        ...
        if draft_orders:
            ...
            draft_orders._post_cancel_message()
    ...
    def _get_message_author(self):
        """Partner to set author for the chatter messages generated by the PoS.
        Overridden in pos_hr to use the cashier instead of the user running the session.
        """
        self.ensure_one()
    ...
    def _generate_pos_order_invoice(self):
        ...
        body = _("This invoice has been created from the point of sale order: %s",
