...
class PosOrder(models.Model):
    ...
    email = fields.Char(string='Email', compute="_compute_contact_details", store=True)
    mobile = fields.Char(string='Mobile', compute="_compute_contact_details", store=True)
