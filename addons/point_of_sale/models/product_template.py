...
class ProductTemplate(models.Model):
    ...
    def _load_pos_data_fields(self, config_id):
        return [
            ...
            'write_date', 'available_in_pos', 'attribute_line_ids', 'active', 'image_128', 'combo_ids', 'product_variant_ids', 'pos_optional_product_ids',
            'public_description',
        ]
    ...
    def get_product_info_pos(self, price, quantity, pos_config_id, product_variant_id=False):
        ...
        optional_products = [
            ...
            for p in self.pos_optional_product_ids
        ]
