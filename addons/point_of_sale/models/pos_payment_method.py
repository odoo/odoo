...
class PosPaymentMethod(models.Model):
    ...
    ##############################################################
    def _create_bank_payment_line(self, session, amount, partner=None, message=None):
        self.ensure_one()
        ...
        destination_account = partner_account or pm_account or session_account
