...
class ResConfigSettings(models.TransientModel):
    ...
    module_l10n_it_pos_fiskaly = fields.Boolean(string="Italy Fiscalization", help="Configure Fiskaly credentials required for the Italian software fiscalization")
