...
class ResConfigSettings(models.TransientModel):
    ...
    module_pos_alipay = fields.Boolean(string="Alipay QR Code Payment", help="The transactions are processed by Alipay. Set your Alipay credentials on the related payment method.")
