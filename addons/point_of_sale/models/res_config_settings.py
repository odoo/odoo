...
class ResConfigSettings(models.TransientModel):
    ...
    group_pos_email_printing = fields.Boolean(string="Email Printing", help="Send reports to printers via email.", implied_group="point_of_sale.group_pos_email_printing")
