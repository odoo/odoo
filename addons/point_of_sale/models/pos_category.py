...
class PosCategory(models.Model):
    ...
    _constraints = [(models.Model._check_recursion, _('Error ! You cannot create recursive categories.'), ['parent_id'])]
    ...
    image = fields.Binary(help="This field holds the image used as image for the cateogry, limited to 1024x1024px.")
