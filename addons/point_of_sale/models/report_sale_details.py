...
class ReportPoint_Of_SaleReport_Saledetails(models.AbstractModel):
    ...
    def _get_cancel_domain(self, date_start=False, date_stop=False, config_ids=False, session_ids=False):
        domain = [('state', '=', 'cancel')]
    ...
    def get_sale_details(self, date_start=False, date_stop=False, config_ids=False, session_ids=False, **kwargs):
        ...
        cancel_order_domain = self._get_cancel_domain(date_start, date_stop, config_ids, session_ids, **kwargs)
        orders = self.env['pos.order'].search(domain)
        cancel_orders = self.env['pos.order'].search(cancel_order_domain)
        ...
        # TODO: Extract a common function for computing cancelled_products.
        # The same logic and object structure are used for refund_products and products.
        products_cancelled = {}
        cancelled_taxes = {
            'base_amount': 0.0,
            'taxes': {},
