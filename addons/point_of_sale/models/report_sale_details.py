...
class ReportSaleDetails(models.AbstractModel):
    ...
    def get_sale_details(self, date_start=False, date_stop=False, config_ids=False, session_ids=False, **kwargs):
        ...
        products, products_info = self.with_context(config_id=session.config_id.id)._get_total_and_qty_per_category(products)
        refund_products, refund_info = self.with_context(config_id=session.config_id.id)._get_total_and_qty_per_category(refund_products)
