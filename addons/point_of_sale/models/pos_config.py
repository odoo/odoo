...
class PosConfig(models.Model):
    ...
    iface_print_arabic = fields.Boolean(string='Print with Arabic compatibility', help="This option makes it possible to print Arabic texts. Enabling this will make printing very slow!")
