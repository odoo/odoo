...
class TestProcessingFlows(AsiaPayCommon, PaymentHttpCommon):
    @mute_logger("odoo.addons.payment_asiapay.models.payment_transaction")
    def test_webhook_notification_triggers_processing(self):
        ...
        with (
            patch(
                "odoo.addons.payment_asiapay.models.payment_transaction.PaymentTransaction._verify_notification_signature"
            ),
            patch(
    ...
    def test_accept_webhook_notification_with_valid_signature(self):
        ...
        self.assertTrue(tx._verify_notification_signature(self.webhook_payment_data))
