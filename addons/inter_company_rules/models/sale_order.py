...
class sale_order(models.Model):
    ...
    def inter_company_create_purchase_order(self, company):
        ...
        company_partner = (self.company_id and
                           self.company_id.partner_id or False)
    ...
    @api.model
    def _prepare_purchase_order_line_data(self, so_line, date_order,
                                          purchase_id, company):
        ...
        return {
            ...
            'product_id': (so_line.product_id and
                           so_line.product_id.id or False),
