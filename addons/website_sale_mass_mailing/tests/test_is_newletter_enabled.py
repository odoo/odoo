...
class TestWebsiteDependentIsEnabled(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.site_one_settings = cls._create_settings_for_website(cls.site_one, enable_newsletter=False)
        cls.site_two_settings = cls._create_settings_for_website(cls.site_two, enable_newsletter=False)
    ...
    def _get_newsletter_view_for_website(self, website):
        ...
        return self.env['ir.ui.view'].with_context(active_test=False).search([
            ('key', '=', 'website_sale_mass_mailing.newsletter'),
            ('website_id', '=', website.id)
        ])
    ...
    def test_newsletter_enabled_per_website(self):
        ...
        site_one_newsletter_view = self._get_newsletter_view_for_website(self.site_one)
        ...
        site_two_newsletter_view = self._get_newsletter_view_for_website(self.site_two)
