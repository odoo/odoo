...
from odoo.addons.l10n_es_edi_facturae.xml_utils import _canonicalize_node, _reference_digests, NS_MAP
...
class AccountMove(models.Model):
    ...
    def _l10n_es_edi_facturae_render_facturae(self):
        ...
        errors = []
        try:
            xml_content = self._sign_xml(xml_content, signature_values)
        except ValueError:
    ...
    def _sign_xml(self, edi_data, signature_data):
        ...
        e, n = certificate_sudo._get_public_key_numbers_bytes(block=True)
        issuer = certificate_sudo._l10n_es_edi_get_issuer()
        ...
        signature_data.update({
            ...
            'sigcertif_digest': certificate_sudo._get_fingerprint_bytes(block=False).decode(),
