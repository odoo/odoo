...
class AccountMove(models.Model):
    ...
    def _l10n_es_edi_facturae_prepare_inv_line(self, base_line, aggregated_values):
        ...
        """
        self.ensure_one()
        extended_dp = self.env['decimal.precision'].precision_get('Product Price') or 2
    ...
    def _l10n_es_edi_facturae_export_facturae(self):
        ...
        template_values = {
            ...
            'unit_price_decimals': self.env['decimal.precision'].precision_get('Product Price') or 2,
            'eur': eur_curr,
