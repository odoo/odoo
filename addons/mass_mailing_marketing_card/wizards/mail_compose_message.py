...
class MailComposeMessage(models.TransientModel):
    ...
    @api.model
    def _process_generic_card_url_body(self, res_id_body_pairs):
        ...
        :param list[tuple[int, str]] res_id_body_pairs:
        ...
        for res_id, body in res_id_body_pairs:
            ...
            def fill_card_preview_url(match):
                ...
                return f'{match[1]}/{campaign_id}/{res_id}/{campaign_tokens[(campaign_id, res_id)]}'
