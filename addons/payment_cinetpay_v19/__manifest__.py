{
    ...
    'data': [
        ...
        'views/payment_cinetpay_form.xml',
    ...
    'assets': {
        'web.assets_frontend': [
            'payment_cinetpay_v19/static/src/js/buy_now.js',
        ],
        'point_of_sale._assets_pos': [
            'payment_cinetpay_v19/static/src/js/cinetpay_payment.js',
        ],
        'point_of_sale._assets': [
            'payment_cinetpay_v19/static/src/js/cinetpay_pos.js',
        ],   },
    'installable': True,
    'auto_install': False,
    'application': True,
