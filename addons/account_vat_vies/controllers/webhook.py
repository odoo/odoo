...
class AccountVatViesWebhookController(http.Controller):
    @http.route('/account_vat_vies/1/webhook_update_vies', type='http', csrf=False, save_session=False, auth='public')
