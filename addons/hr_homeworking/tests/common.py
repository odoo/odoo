...
class TestHrHomeworkingCommon(common.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        Work_location = cls.env['hr.work.location'].with_context(tracking_disable=True)
        ...
        cls.work_office_1 = Work_location.create({
            'name': "Bureau 1",
            'location_type': "office"
        })

        cls.work_office_2 = Work_location.create({
            'name': "Bureau 2",
            'location_type': "office"
        })

        cls.work_home = Work_location.create({
            'name': "Maison",
            'location_type': "home"
        })
