...
class WebsiteForum(WebsiteProfile):
    ...
    @http.route(routes_with_embed('/forum/<model("forum.forum"):forum>/post/<model("forum.post"):post>/toggle_correct'), type='json', auth="user", website=True)
    ...
    @http.route(routes_with_embed('/forum/<model("forum.forum"):forum>/post/<model("forum.post"):post>/upvote'), type='json', auth="user", website=True)
    ...
    @http.route(routes_with_embed('/forum/<model("forum.forum"):forum>/post/<model("forum.post"):post>/downvote'), type='json', auth="user", website=True)
    ...
    @http.route(routes_with_embed('/forum/<model("forum.forum"):forum>/post/<model("forum.post"):post>/flag'), type='json', auth="user", website=True)
