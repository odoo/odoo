...
SAT_CODES = {
    ...
    for line in file_open('l10n_mx/data/account.group.template.csv').read().split('\n')
}  # Getting every value from "code_prefix_start" column and removing quotes
XXXX_PATTERN = re.compile(r'\.\d{1,2}[1-9]')  # A dot, two or three digits, last digit cannot be 0
...
class AccountAccount(models.Model):
    ...
    def ensure_code_conforms_coa_sat(self):
        ...
        # last part is up to the user but should match XXXX_PATTERN which is detailed in the header
