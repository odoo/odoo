...
class DriverController(http.Controller):
    @helpers.toggleable
    @route.iot_route(
        ["/iot_drivers/action", "/hw_drivers/action"],
        type="jsonrpc",
        cors="*",
        csrf=False,
    )
    ...
    @helpers.toggleable
    @route.iot_route(
        ["/iot_drivers/event", "/hw_drivers/event"],
        type="jsonrpc",
        cors="*",
        csrf=False,
    )
    ...
    @route.iot_route(
        ["/iot_drivers/download_logs", "/hw_drivers/download_logs"],
        type="http",
        cors="*",
        csrf=False,
    )
    def download_logs(self):
        ...
        try:
            ...
            msg = "Log file has not been found. Check your Log file configuration."
