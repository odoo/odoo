...
class AccountMoveLine(models.Model):
    ...
    def _compute_l10n_pk_edi_from_product(self):
        for record in self:
            record.l10n_pk_edi_sale_type = record.product_id.l10n_pk_edi_sale_type
            record.l10n_pk_edi_sro_id = record.product_id.l10n_pk_edi_sro_id
            record.l10n_pk_edi_sro_item_id = record.product_id.l10n_pk_edi_sro_item_id
