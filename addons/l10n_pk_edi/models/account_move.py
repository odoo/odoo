...
class AccountMove(models.Model):
    ...
    def _l10n_pk_validate_moves(self):
        ...
        if corrupt_move_name:
            ...
            return {
                "title": "Please configure following details to confirm Invoices.",
                "msg": error_msg,
            }
        for move in move_ids:
        ...
        if corrupt_move_name:
            ...
            return {
                "title": _("To confirm credit/debit note, set cancel reason and remarks "
                         "at Electronic Invoicing tab in following invoices:"),
                "msg": error_msg,
            }
        return False
