...
class SlidePartnerRelation(models.Model):
    ...
    survey_scoring_success = fields.Boolean('Certification Quizz Passed', compute='_compute_survey_scoring_success', store=True)
    ...
    def _compute_survey_scoring_success(self):
        ...
        for record in self:
            record.survey_scoring_success = record in passed_slide_partners
