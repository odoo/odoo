                    ...
                    if i_line.product_id.type != 'service':
                        ...
                        for line in res:
                            if a == line['account_id'] and i_line.product_id.id == line['product_id']:
                                ...
                                if inv.currency_id.id != company_currency:
                                    standard_price = self.pool.get('res.currency').compute(cr, uid, company_currency, inv.currency_id.id, i_line.product_id.standard_price, context={'date': inv.date_invoice})
