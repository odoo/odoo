...
class ResConfigSettings(models.TransientModel):
    ...
    l10n_jo_edi_sequence_income_source = fields.Char(
        related="company_id.l10n_jo_edi_config_id.l10n_jo_edi_sequence_income_source",
    ...
    l10n_jo_edi_client_identifier = fields.Char(
        related="company_id.l10n_jo_edi_config_id.l10n_jo_edi_client_identifier",
        string="JoFotara Client ID",
        readonly=False,
    )
    l10n_jo_edi_taxpayer_type = fields.Selection(
        related="company_id.l10n_jo_edi_config_id.l10n_jo_edi_taxpayer_type",
        string="JoFotara Taxpayer Type",
        readonly=False,
    )
    l10n_jo_edi_demo_mode = fields.Boolean(
        related="company_id.l10n_jo_edi_config_id.l10n_jo_edi_demo_mode",
