...
export const turnStile = {
    addTurnstile(action, selector) {
        ...
        globalThis.turnstileSuccess = function () {
            ...
            // kept for stable compatibility
            // however this is unreliable as the selector will be overwritten
            // every time the set-up method id called
            if (!selector) {
                return;
            }
            const selectorEl = document.querySelector(selector);
            if (selectorEl && selectorEl.classList.contains("cf_form_disabled")) {
                selectorEl.classList.remove("disabled", "cf_form_disabled");
            }
        };
