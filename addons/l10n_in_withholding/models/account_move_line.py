...
class AccountMoveLine(models.Model):
    ...
    section_id = fields.Many2one(related="account_id.l10n_in_tds_tcs_section_id")
    ...
    def action_apply_tcs_to_selected_invoice_lines(self):
        lines = self.env['account.move.line'].browse(self.env.context.get('active_ids'))
        self.move_id.apply_applicable_tcs_invoice_lines(lines)
