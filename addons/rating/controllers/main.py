...
class Rating(http.Controller):
    ...
    def action_open_rating(self, token, rate, **kwargs):
        ...
        record_sudo.rating_apply(rate, rating=rating, subtype_xmlid='mail.mt_note')
    ...
    def action_submit_rating(self, token, rate, **kwargs):
        ...
        record_sudo.rating_apply(rate, rating=rating, feedback=kwargs.get('feedback'), subtype_xmlid='mail.mt_comment')
