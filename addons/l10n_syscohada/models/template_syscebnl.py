...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_syscebnl_template_data(self):
        return {
            ...
            'property_account_expense_categ_id': 'syscebnl_6011',
    ...
    def _get_syscebnl_res_company(self):
        return {
            self.env.company.id: {
                ...
                'account_journal_early_pay_discount_loss_account_id': 'syscebnl_6019',
                'account_journal_early_pay_discount_gain_account_id': 'syscebnl_773',
                'default_cash_difference_expense_account_id': 'syscebnl_658',
                'default_cash_difference_income_account_id': 'syscebnl_7588',
            },
        }
