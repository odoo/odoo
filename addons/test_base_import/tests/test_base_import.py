...
class TestPreview(TransactionCase):
    ...
    def test_xls_success(self):
        xls_file_path = get_module_resource('test_base_import', 'tests', 'test.xls')
    ...
    def test_xlsx_success(self):
        xlsx_file_path = get_module_resource('test_base_import', 'tests', 'test.xlsx')
    ...
    def test_ods_success(self):
        ods_file_path = get_module_resource('test_base_import', 'tests', 'test.ods')
