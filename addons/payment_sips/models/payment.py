...
class AcquirerSips(models.Model):
    ...
    sips_merchant_id = fields.Char('Merchant ID', help="Used for production only", required_if_provider='sips', groups='base.group_system')
    sips_secret = fields.Char('Secret Key', size=64, required_if_provider='sips', groups='base.group_system')
