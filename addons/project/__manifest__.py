...

{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'project/static/src/project_right_side_panel/**/*',
            'project/static/src/project_update_kanban/*',
            'project/static/src/project_update_list/*',
        ...
        'web.assets_qweb': [
            ...
            'project/static/src/project_private_task_many2one_field/*.xml',
            'project/static/src/project_right_side_panel/**/*.xml',
            'project/static/src/project_update_kanban/*.xml',
            'project/static/src/project_update_list/*.xml',
        ],
