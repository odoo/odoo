...
class Task(models.Model):
    ...
    def _track_subtype(self, init_values):
        ...
        if 'stage_id' or 'kanban_state_label' in init_values and self.kanban_state in mail_message_subtype_per_kanban_state:
            return self.env.ref('project.mt_task_stage') or self.env.ref(mail_message_subtype_per_kanban_state[self.kanban_state])
