...
class ProjectTask(models.Model):
    ...
    parent_id = fields.Many2one('project.task', string='Parent Task', inverse="_inverse_parent_id", index=True, domain="['!', ('id', 'child_of', id), '|', ('project_id', '!=', False), ('is_template', '=' , True)]", tracking=True)
