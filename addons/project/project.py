...
class project_task_type(osv.osv):
    ...
    _columns = {
        ...
        'state': fields.selection(_TASK_STATE, 'State', required=True, help="The related state for the stage. The state of you document will automatically change regarding the selected stage. Example, a stage is related to the state 'Close', when your document reach this stage, it will be automatically closed."),
    }
    _defaults = {
        'state': 'draft',
        'sequence': 1
