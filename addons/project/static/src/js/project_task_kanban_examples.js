...
const exampleData = {
    ...
    examples:[{
        ...
        get description() {
            return markup(renderToString("project.example.generic"));
        },
        ...
        get description() {
            return markup(renderToString("project.example.agilescrum"));
        },
        ...
        get description() {
            return markup(renderToString("project.example.digitalmarketing"));
        },
        bullets: [greenBullet, redBullet],
    }, {
        ...
        get description() {
            return markup(renderToString("project.example.customerfeedback"));
        },
        bullets: [greenBullet, redBullet],
    }, {
        name: _lt('Consulting'),
        ...
        get description() {
            return markup(renderToString("project.example.consulting"));
        },
        bullets: [greenBullet, redBullet],
    }, {
        ...
        get description() {
            return markup(renderToString("project.example.researchproject"));
        },
        bullets: [greenBullet, redBullet],
    }, {
        ...
        get description() {
            return markup(renderToString("project.example.tshirtprinting"));
        },
        bullets: [star],
    }, {
        name: _lt('Design'),
