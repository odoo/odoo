...
QUnit.module('Subtask Kanban List tests', {
    ...
    QUnit.debug("Update closed subtask count in the kanban card when the state of a subtask is set to Done.", async function (assert) {
        ...
        checkSteps = true;
        await click(target.querySelector('.subtask_list_button'));
        let subtaskEl = target.querySelector(".subtask_list");
        ...
        subtaskEl = target.querySelector(".subtask_list");
