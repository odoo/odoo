...
class TestCIIFR(TestUBLCommon):
    ...
    def test_export_with_fixed_taxes_case1(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, expected_file='from_odoo/facturx_ecotaxes_case1.xml')
    ...
    def test_export_with_fixed_taxes_case2(self):
        ...
        self.assertEqual(invoice.amount_total, 121)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, expected_file='from_odoo/facturx_ecotaxes_case2.xml')
    ...
    def test_export_with_fixed_taxes_case3(self):
        ...
        self.assertEqual(invoice.amount_total, 121)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, expected_file='from_odoo/facturx_ecotaxes_case3.xml')
