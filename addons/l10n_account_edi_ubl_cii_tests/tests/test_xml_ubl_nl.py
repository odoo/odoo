...
class TestUBLNL(TestUBLCommon):
    ...
    def setUpClass(cls):
        ...
        cls.partner_1 = cls.env['res.partner'].create({
            ...
            'bank_ids': [(0, 0, {'formatted_account_number': 'NL000099998B57', 'allow_out_payment': True})],
            'peppol_eas': '0106',
        ...
        cls.partner_2 = cls.env['res.partner'].create({
            ...
            'vat': 'NL41452B11',
            'country_id': cls.env.ref('base.nl').id,
            'bank_ids': [(0, 0, {'formatted_account_number': 'NL93999574162167', 'allow_out_payment': True})],
            'peppol_eas': '9944',
