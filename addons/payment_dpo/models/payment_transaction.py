...
class PaymentTransaction(models.Model):
    ...
    def _get_specific_rendering_values(self, processing_values):
        ...
        #TODO-PDA check if same payment URL for prod vs test
    ...
    def _dpo_create_token(self):
        ...
        #TODO-PDA customerLastName, customerFirstName, how do we split from self.partner_id.name?
        #TODO-PDA customerAddress needed? or city/zip if v2 pay form?
        #TODO-PDA test BackURL to return to the cart and look for Result and ResultExplanation
        #TODO-PDA add Transaction CompanyRefUnique to avoid double payments (idempotent key)?
        payload = f"""
            ...
            <API3G>
                ...
                <Transaction>
                    ...
                    <customerEmail>{self.partner_id.email}</customerEmail>
    ...
    def _process_notification_data(self, notification_data):
        ...
        # TODO-PDA check when choosing a different payment method
