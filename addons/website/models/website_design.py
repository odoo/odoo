...
class WebsiteDesign(models.Model):
    ...
    footer_template = fields.Many2one('website.design.option', string='Footer Template', default=lambda self: self.env.ref('website.design_option_footertemplate_default'))
    ...
    color_palettes_name = fields.Char(string='Color Palettes Name', default='base-1')
    ...
    btn_border_width = fields.Char(string='Button Border Width', default='2px')
    btn_primary_flat = fields.Boolean(string='Primary Button Flat', default=False)
    btn_secondary_flat = fields.Boolean(string='Secondary Button Flat', default=False)
    btn_primary_outline = fields.Boolean(string='Primary Button Outline', default=False)
    btn_secondary_outline = fields.Boolean(string='Secondary Button Outline', default=False)
    ...
    footer_scrolltop = fields.Boolean(string='Footer Scrolltop', default=False)
    header_font_size = fields.Char(string='Header Font Size', default='1rem')
    menu_border_width = fields.Char(string='Menu Border Width', default='null')
    # Maybe menu-border-style should be a selection field
    menu_border_style = fields.Char(string='Menu Border Style', default='solid')
    menu_border_radius = fields.Char(string='Menu Border Radius', default='null')
    menu_box_shadow = fields.Char(string='Menu Box Shadow', default='null')
