...
class Website(models.CachedModel):
    ...
    def write(self, vals):
        ...
        if 'robots_txt' in values:
            self._upsert_robots_txt_attachment()
    ...
    def _upsert_robots_txt_attachment(self):
        """
        Generates or updates the robots.txt attachment for the current
        website.
        """
        current_website = self.get_current_website()
        ...
        values = {
            ...
            'raw': robots_content,
            'mimetype': 'text/plain',
            'description': 'Robots.txt file. This file is automatically generated and admins should not be tampering with it.',
        }
