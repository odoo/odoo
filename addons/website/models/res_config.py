...
class website_config_settings(osv.osv_memory):
    ...
    _columns = {
        ...
        'social_xing': fields.related('website_id', 'social_xing', type="char", string='Xing Account'),
        'social_dribbble': fields.related('website_id', 'social_dribbble', type="char", string='Dribbble Account'),
    }
