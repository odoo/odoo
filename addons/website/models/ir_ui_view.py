...
class View(models.Model):
    ...
    def _get_inheriting_hierarchy_domain(self):
        domain = super(View, self)._get_inheriting_hierarchy_domain()
    ...
    def _get_inheriting_hierarchy(self):
        if not self._context.get('website_id'):
            return super(View, self)._get_inheriting_hierarchy()

        views = super(View, self.with_context(active_test=False))._get_inheriting_hierarchy()
