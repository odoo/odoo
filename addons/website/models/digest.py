...
class Digest(models.Model):
    ...
    def _calculate_website_visitor_count(self, websites, start, end):
        ...
        return {Website.browse(website_id): count for website_id, count in self._cr.fetchall()}
    ...
    def _compute_kpis_actions(self, company, user):
        ...
        res['kpi_website_visitor_count'] = f'website.website_visitors_action&menu_id={menu_root_id}'
        res['kpi_website_track_count'] = f'website.website_visitor_view_action&menu_id={menu_root_id}'
        return res
