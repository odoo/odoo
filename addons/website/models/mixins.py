...
class WebsiteSeoMetadata(models.AbstractModel):
    ...
    website_lcp_image_desktop = fields.Char("Website desktop LCP image", translate=True)
    website_lcp_image_mobile = fields.Char("Website mobile LCP image", translate=True)
