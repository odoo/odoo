...
class WebsitePublishedMixin(models.AbstractModel):
    ...
    website_absolute_url = fields.Char('Absolute URL', compute='_compute_website_absolute_url',
    ...
    def _compute_website_absolute_url(self):
        self.website_absolute_url = False
        for record in self:
            if record.website_url != '#':
                record.website_absolute_url = record.get_base_url() + record.website_url
