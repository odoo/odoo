...
class Website(Home):
    ...
    def update_footer_template(self, template_key, possible_values):
        """ Enables the given footer template and disables the other ones. The
            content width is independent from the template (see
            `website.footer_content_width_*`), so it is kept as is.
        """
