...
class Website(openerp.addons.web.controllers.main.Home):
    ...
    def customize_template_get(self, key, full=False, bundles=False):
        ...
        """
        return request.registry["ir.ui.view"].customize_template_get(request.cr, request.uid, key, full=full, bundles=bundles, context=request.context)

    @http.route('/website/get_view_translations', type='json', auth='public', website=True)
    def get_view_translations(self, xml_id, lang=None):
        lang = lang or request.context.get('lang')
        return request.registry["ir.ui.view"].get_view_translations(request.cr, request.uid, xml_id, lang=lang, context=request.context)
