...
class Website(Home):
    ...
    def get_new_page_templates(self, **kw):
        ...
        current_website_page_ids = self.env['website.page'].search([
            ('id', 'in', page_ids),
            ('website_id', '=', website.id)
        ]).ids
        filtered_configurator_templates = [self.get_filtered_page_template(page_id) for page_id in current_website_page_ids]
