...
import { StoreLocatorMap } from '@website/components/store_locator_map/store_locator_map';
import { Component, onWillStart, useState } from '@odoo/owl';
import { AssetsLoadingError, loadCSS, loadJS } from '@web/core/assets';
import { _t } from '@web/core/l10n/translation';

export class StoreLocatorMapContainer extends Component {
    static components = { StoreLocatorLocationSchedule, StoreLocatorMap };
    static template = 'website.store_locator_map_container';
    static props = {
        locations: {
            type: Array,
            element: {
