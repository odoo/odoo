...
import {
    Map
} from '@delivery/js/location_selector/map/map';
...
patch(Map.prototype, {
        ...
        useEffect(
            () => {
                this.leafletMap = L.map(this.mapRef.el, {
                    zoom: parseInt(this.__owl__.parent.parent.props.zoom),
                });
    ...
    addMarkers(locations) {
        for (const loc of locations) {
            ...
            const markerTooltipText = "<b>" + loc.name + "</b><br>" + loc.street + "<br>" + loc.zip_code + " " + loc.city;
