...
const savableSelector = '[data-oe-translation-initial-sha], ' +
    ...
    '[data-oe-expression*="data-oe-translation-initial-sha="], ' +
...
export class WebsiteTranslator extends WebsiteEditorComponent {
    ...
    async _beforeEditorActive($wysiwygEditable) {
        ...
        let $edited = $();
        for (const attr of ["placeholder", "title", "alt", "value", "src", "href", "data-oe-expression"]) {
            const attrEdit = $editable.filter('[' + attr + '*="data-oe-translation-initial-sha="]').filter(':empty, input, select, textarea, img, a, div');
