...
// const Many2manyUserValueWidget = options.userValueWidgetsRegistry["we-many2many"];

// Many2manyUserValueWidget.include({
//     /**
//      * @override
//      */
//     async willStart() {
...
//         const selectedRecords = await this.orm.read(this.m2oModel, selectedRecordIds, ['street']);
