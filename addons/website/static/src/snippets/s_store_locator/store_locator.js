...
import { LocationSelectorComponent } from "@location_selector/location_selector_component/location_selector_component";
...
export class StoreLocator extends Interaction {
    ...
    createAndStartStoreLocatorApp() {
        ...
        this.mountComponent(mapContainerEl, LocationSelectorComponent, props);
    }
}
