...
export class StoreLocator extends Interaction {
    ...
    //TODO
    //Check which method to use when loading locations (JS in options)
    //Save latitude and longitude to avoid having to fetch them every time from OpenStreetMap api (check contact map)
    //Decide what to do with opening hours
    //Decide searchbar function (just zip or other parameters too ? ask Lionel)
