...
export class AnimatedNumber extends BaseAnimation {
    ...
    setup() {
        ...
        this.setNumberValue(this.startValue);
        this.registerCleanup(() => this.setNumberValue(this.startValue));
    }
    ...
    startAnimation() {
        ...
        this.waitForTimeout(() => {
            ...
            const animate = () => {
                ...
                this.setNumberValue(Math.round(value));
