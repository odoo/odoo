odoo.define('website.s_website_form', function (require) {
    ...
    publicWidget.registry.s_website_form = publicWidget.Widget.extend({
        ...
        destroy: function () {
            ...
            // Most fields should already be reset by the "Apply default values"
            // since the data-for and prefill code doesn't update the attribute
            // value, but hidden fields are updated so this code is still
            // necessary for them.
