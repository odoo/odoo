...
export class Many2ManySelection extends Interaction {
    ...
    dynamicContent = {
        ...
        ".s_website_form_m2m_toggle_all": {
            "t-on-click": () => this.setAll(!this.areAllSelected()),
            "t-att-aria-checked": () => String(this.areAllSelected()),
            "t-out": () => (this.areAllSelected() ? _t("Deselect all") : _t("Select all")),
        },
     ...
     */
    areAllSelected() {
        return this.selectEl.selectedOptions.length === this.options.size;
    }
