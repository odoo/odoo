...
class ApplyConfiguratorScreen extends Component {
    ...
    async applyConfigurator(themeName) {
        ...
        if (themeName !== undefined) {
            ...
            // been installed.
            window.location.replace(`/web#action=website.website_preview&website_id=${encodeURIComponent(resp.website_id)}&enable_editor=1&with_loader=1&background_installation=${resp.background_installation}`);
        }
    }
}
