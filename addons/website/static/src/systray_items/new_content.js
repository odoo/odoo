        ...
        this.state = useState({
            newContentElements: [
                ...
                },
                {
                    ...
                    status: MODULE_STATUS.NOT_INSTALLED,
                    icon: xml`<img src="/website/static/src/img/apps_thumbs/event.svg"/>`,
                    title: _t('Event'),
                },
                {
                    ...
                    status: MODULE_STATUS.NOT_INSTALLED,
                    icon: xml`<img src="/website/static/src/img/apps_thumbs/forum.svg"/>`,
                    redirectUrl: '/forum',
                    title: _t('Forum'),
                },
                {
                    ...
                    status: MODULE_STATUS.NOT_INSTALLED,
                    icon: xml`<img src="/website/static/src/img/apps_thumbs/job-position.svg"/>`,
                ...
                },
                {
                    ...
                    status: MODULE_STATUS.NOT_INSTALLED,
                    icon: xml`<img src="/website/static/src/img/apps_thumbs/bag.svg"/>`,
                    title: _t('Product'),
                },
                {
                    ...
                    status: MODULE_STATUS.NOT_INSTALLED,
                    icon: xml`<img src="/website/static/src/img/apps_thumbs/course.svg"/>`,
                    title: _t('Course'),
                },
                {
                    ...
                    status: MODULE_STATUS.NOT_INSTALLED,
                    icon: xml`<img src="/website/static/src/img/apps_thumbs/livechat-widget.svg"/>`,
