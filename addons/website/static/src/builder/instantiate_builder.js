...
export class InstantiateBuilder extends Component {
    static template = "website.InstantiateBuilder";
...
registry.category("lazy_components").add("website.InstantiateBuilder", InstantiateBuilder);
