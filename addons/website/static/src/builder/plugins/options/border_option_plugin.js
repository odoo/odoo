import { CARD_PARENT_HANDLERS, BLOCKQUOTE_PARENT_HANDLERS } from "@website/builder/plugins/options/utils";
    ...
    resources = {
        builder_options: [
            withSequence(BOX_BORDER_SHADOW, {
                ...
                exclude: `.s_col_no_bgcolor, .s_col_no_bgcolor.row > div, .s_image_gallery .row > div, .s_masonry_block .s_col_no_resize, .s_text_cover .row > .o_not_editable, ${CARD_PARENT_HANDLERS}, ${BLOCKQUOTE_PARENT_HANDLERS}`,
            }),
        ],
    };
}
