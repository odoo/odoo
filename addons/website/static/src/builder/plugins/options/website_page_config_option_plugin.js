...
import { BreadcrumbOption } from "./breadcrumb_option_plugin";
...
class WebsitePageConfigOptionPlugin extends Plugin {
    ...
    resources = {
        ...
        builder_options: [
            ...
            {
                OptionComponent: BreadcrumbOption,
                selector: ".o_page_breadcrumb",
                editableOnly: false,
                groups: ["website.group_website_designer"],
                props: {
                    doesPageOptionExist: this.doesPageOptionExist.bind(this),
    ...
    /**
     * Return the HTML element corresponding to the given type.
     *
...
export class BaseWebsitePageConfigAction extends BuilderAction {
    ...
    /**
     * Show or hide a target element, and update visibility plugin state.
     *
