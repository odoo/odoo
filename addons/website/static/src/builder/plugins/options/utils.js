...
export const BASE_ONLY_BG_IMAGE_SELECTOR = ".s_tabs .oe_structure > *, footer .oe_structure > *, section.s_banner_categories, .s_banner_categories .row > div";
