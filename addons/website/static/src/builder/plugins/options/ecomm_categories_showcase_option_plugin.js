...
class EcommCategoriesShowcaseOptionPlugin extends Plugin {
    ...
    getActions() {
        return {
            ...
            setMinHeight: {
                getValue: ({ editingElement }) => 
                    editingElement.classList.contains('o_min_height_short') ? '0' : 
                    editingElement.classList.contains('o_min_height_tall') ? '2' : '1',
                apply: ({ editingElement, value }) => {
                    editingElement.classList.remove('o_min_height_short', 'o_min_height_tall');
                    if (value === '0') editingElement.classList.add('o_min_height_short');
                    if (value === '2') editingElement.classList.add('o_min_height_tall');
                },
                isApplied: ({ editingElement, value }) => 
                    value === '0' ? editingElement.classList.contains('o_min_height_short') :
                    value === '2' ? editingElement.classList.contains('o_min_height_tall') :
                    !editingElement.classList.contains('o_min_height_short') && !editingElement.classList.contains('o_min_height_tall'),
            },
        };
    }
