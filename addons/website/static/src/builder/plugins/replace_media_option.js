...
export class ReplaceMediaOption extends BaseOptionComponent {
    ...
    tooltipName(editingElement) {
        if (editingElement.classList.contains("o_file_box")) {
            return _t("Replace Document");
        } else if (editingElement.classList.contains("media_iframe_video")) {
    ...
    canSetLink(editingElement) {
        return (
            ...
            !editingElement.classList.contains("o_file_box")
        );
    }
