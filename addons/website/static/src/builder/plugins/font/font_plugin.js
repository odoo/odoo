...
import { BuilderFontPlugin } from "@html_builder/plugins/font/font_plugin";

// TODO Website-specific
class WebsiteFontPlugin extends BuilderFontPlugin {
    static id = "websiteFont";
    static shared = [...BuilderFontPlugin.shared, "addFont", "deleteFont"];
    static dependencies = [...BuilderFontPlugin.dependencies, "customizeWebsite"];
