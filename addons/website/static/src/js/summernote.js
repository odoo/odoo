...
define(['summernote/editing/Editor', 'summernote/summernote'], function (Editor) {
    ...
    dom.removeBetween = function (sc, so, ec, eo, towrite) {
        ...
        var ancestor = dom.commonAncestor(sc.tagName ? sc.parentNode : sc, ec.tagName ? ec.parentNode : ec) || $(sc).closest(".o_editable")[0];
