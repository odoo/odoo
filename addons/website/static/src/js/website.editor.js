        ...
        load_menu: function () {
            ...
            openerp.jsonRpc('/website/customize_template_get', 'call', { 'xml_id': this.view_name }).then(
                function(result) {
                    ...
                    // Adding Static Menus
                    self.$menu.append('<li class="divider"></li>');
                    self.$menu.append('<li><a data-action="ace" href="#">HTML Editor</a></li>');
                    self.$menu.append('<li class="js_change_theme"><a href="/page/website.themes">Change Theme</a></li>');
                    self.$menu.append('<li><a href="/web#return_label=Website&action=website.action_module_website">Install Apps</a></li>');
