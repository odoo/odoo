...
var HtmlPage = Class.extend(mixins.PropertiesMixin, {
    init: function () {
        ...
        this.defaultDescription = $('meta[name="default_description"]').attr('content') || _t("The description will be generated by social media based on page content unless you specify one.");
...
var MetaTitleDescription = Widget.extend({
    ...
    start: function () {
        ...
        if (this.htmlPage.description().trim() !== this.htmlPage.defaultDescription.trim()) {
    ...
    getDescription: function () {
        return this.$description.val() || this.htmlPage.defaultDescription;
    },
    /**
     * @private
     */
