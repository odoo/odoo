...
var MetaImageSelector = Widget.extend({
    ...
    init: function (parent, data) {
        ...
        data.pageImages.unshift(sprintf('/web/image/res.company/%s/logo', odoo.session_info.website_company_id));
        data.pageImages.unshift(sprintf('/web/image/website/%s/social_default_image', odoo.session_info.website_id));
