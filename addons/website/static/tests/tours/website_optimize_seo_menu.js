...
registerWebsitePreviewTour(
    ...
    () => [
        ...
        },
        {
            ...
            trigger:
                ".oe_seo_configuration .oe_seo_checks img[src='/web/image/website.s_banner_default_image']",
        },
        {
            content: "Add an alt to one of the images",
            trigger: ".oe_seo_configuration .oe_seo_checks input.form-control.is-invalid",
        ...
        {
            content: "Wait for the iframe to load and check that the image's alt was properly edited",
            trigger: ":iframe [is-ready=true] #wrapwrap:has(#zone_left img[alt='A very good description'])",
        },
        ...openSeoModalSteps,
        {
            content: "Check the modifications are still present in the modal",
            trigger: ".oe_seo_configuration .oe_seo_checks input.form-control.is-valid",
            run: () => {
                const input = document.querySelector(".oe_seo_configuration .oe_seo_checks input.form-control.is-valid");
