...
// Area of the signup form holding the fields added from the editor.
...
// Selects the form itself: the options of the previously added field are then
// replaced by the ones of the form, which adds the next field at the end.
...
registerWebsitePreviewTour(
    ...
    () => [
        // Add custom and existing fields on the signup form, as an editor.
        ...clickOnEditAndWaitEditMode(),
        ...
        // Sign up with those fields, as a visitor: the form is submitted by the
        // browser, the editor cannot do it (the button is disabled once logged
        // in).
        {
