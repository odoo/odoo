...
wTourUtils.registerWebsitePreviewTour('snippet_table_of_content', {
    ...
    {
        content: "Check that the mobile TOC is not visible on desktop",
        trigger: 'iframe .s_table_of_content:not(.o_snippet_desktop_invisible)',
        run: () => {}, // This is a check.
    },
    {
        content: "Toggle de mobile view",
    ...
    {
        content: "Check that the desktop TOC is not visible on mobile",
        trigger: 'iframe .s_table_of_content:not(.o_snippet_mobile_invisible)',
        run: () => {}, // This is a check.
    },
]);
