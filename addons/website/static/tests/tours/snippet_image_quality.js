...
registerWebsitePreviewTour('website_image_quality', {
    ...
    },
    {
        ...
        trigger: 'we-customizeblock-options:has(we-title:contains("Image")) .o_we_image_weight:contains(" kb"):not(:contains("36.3 kb"))',
        run() {
            // Make sure the reached size is smaller than the original one.
            if (parseFloat(this.anchor.innerText) >= 36.3) {
    ...
    },
    {
        ...
        trigger: ':iframe .s_text_image img[src$="UmdjXRF8WT6zW/S55YBaZ4YLuRoopv55ZIqZKBC8uATEEUgAAA="]',
    },
    {
        content: "Check image size",
        trigger: 'we-customizeblock-options:has(we-title:contains("Image")) .o_we_image_weight:contains("22.8")',
    },
]);
