...
registerWebsitePreviewTour(
    ...
    () => [
        ...
        // It's important to test saving right after changing that option only
        // as this is why this test was made in the first place: the page was
        // not marked as dirty when that option was the only one that was
        // changed.
        ...clickOnSave(),
        {
