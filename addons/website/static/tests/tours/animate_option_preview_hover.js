...
function hoverSnippetOptionAndAssertNoRestart(expectedCount) {
    return [
        {
            content: "Expand the Columns options",
            trigger: ".options-container[data-container-title='Columns'] .options-container-label",
            run() {
                if (this.anchor.querySelector("i[data-icon='arrow_right']")) {
                    this.anchor.click();
                }
            },
        },
        {
            ...
            trigger: ".hb-row[data-label='Content Width'] .o-hb-btn[title='Thin']",
            run: "hover",
        },
        {
...
registerWebsitePreviewTour(
    ...
    () => [
        ...
        ...changeOptionInPopover("Card", "Animation", "On Appearance"),
        ...
        checkAnimationRestartCount(4),
        {
            ...
            trigger: ".o-snippets-top-actions button[data-icon='redo']",
            run: "click",
        },
