function patchFormEditorRegistryM2m () {
    odoo.define('website.test_website_form_m2m_field', function (require) {
...
odoo.define('website.tour.form_editor', function (require) {
    ...
    wTourUtils.registerWebsitePreviewTour('website_form_m2m_field', {
        ...
        {
            content: "Add custom form with many2many field",
            trigger: 'iframe section.s_website_form',
            run: function () {
                patchFormEditorRegistryM2m();
            },
        },
        {
            content: "Select the contact us form by clicking on an input field",
