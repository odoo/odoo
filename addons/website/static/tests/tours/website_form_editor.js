...
registerWebsitePreviewTour("website_form_editor_tour", {
    ...
    },
    {
        ...
        run: () => {
            ...
            setTimeout(() => {
                const addedOptionEl = document.querySelector('iframe').contentDocument.querySelector('.s_website_form_field select option:nth-child(5)').textContent;
    ...
    {
        trigger: ".overlay select[name=link_style_shape]",
