...
registerWebsitePreviewTour(
    ...
    () => [
        ...
        // not deleted.
        // B) Add a 3rd field. Field A's visibility is tied to field B being
        // set, field B is autopopulated and its visibility is tied to field C
        // being set, and field C is empty.
        ...clickOnEditAndWaitEditMode(),
        {
