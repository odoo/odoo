...
wTourUtils.registerWebsitePreviewTour('edit_menus', {
    ...
    {
        content: "There should be a new_menu menu item.",
        trigger: 'iframe .top_menu .nav-item a:contains("new_menu")',
        run: () => {}, // It's a check.
    },
    {
        content: "Trigger link dialog (click 'Add Menu Item')",
    ...
    {
        content: "Write a label for the new nested menu item.",
        trigger: '.modal-dialog .o_website_dialog input:eq(0)',
        run: 'text new_nested_menu',
    },
    {
        content: "Write a url for the new nested menu item.",
        trigger: '.modal-dialog .o_website_dialog input:eq(1)',
        run: 'text #',
    },
    {
        content: "Save the new nested menu",
        trigger: '.modal-footer .btn-primary',
    },
    {
        content: "There should be a new_menu menu item.",
        trigger: 'iframe .top_menu .nav-item a:contains("new_nested_menu")',
        run: () => {}, // It's a check.
    },
    {
