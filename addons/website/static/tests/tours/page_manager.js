...
const checkWebsiteFilter = [{
    ...
    },
    {
        ...
        trigger:
            ".o_searchview_input_container .o_searchview_facet.o_facet_active_website small.o_facet_value:contains('Test Website')",
    },
    {
    ...
    },
    {
        ...
        trigger:
            ".o_searchview_input_container .o_searchview_facet.o_facet_active_website small.o_facet_value:contains('My Website')",
    },
    {
...
const checkActiveWebsiteFilter = [
    ...
    },
    {
        ...
        trigger:
            ".o_searchview_input_container .o_searchview_facet.o_facet_active_website small.o_facet_value:contains('My Website 2')",
    },
];
