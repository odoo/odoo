...
test("carousel section slider resets slide to attributes", async () => {
    ...
    for (controlEl of controlEls) {
        expect(controlEl.dataset.bsSlide).toBe(undefined);
    }
    for (indicatorEl of indicatorEls) {
        expect(indicatorEls.dataset.bsSlideTo).toBe(undefined);
    }
    ...
    for (indicatorEl of indicatorEls) {
        expect(indicatorEls.dataset.bsSlideTo).not.toBe(undefined);
    }
});
