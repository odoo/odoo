...
test("Countdown snippet exists with default colors, when they are not defined", async () => {
    ...
    await startInteractions(countdownEl);
    expect(".o_error_dialog").toHaveCount(0);
    expect("section.s_countdown").toHaveStyle({
        color: "rgb(17, 24, 39)",
    });
});
