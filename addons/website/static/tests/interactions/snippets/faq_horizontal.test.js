...
test("faq_horizontal is update titles position with a o_header_standard", async () => {
    ...
    expect(Math.round(parseFloat(title.style.top))).toBe(HEADER_SIZE + DEFAULT_OFFSET - 400)
...
test("faq_horizontal is update titles position with a o_header_fixed", async () => {
...
test("faq_horizontal is update titles position with a o_header_disappears", async () => {
...
test("faq_horizontal is update titles position with a o_header_fade_out", async () => {
