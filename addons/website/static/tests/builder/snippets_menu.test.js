...
test("undo and redo buttons", async () => {
    ...
    expect(editor.editable).toHaveInnerHTML(
        '<div id="wrap" class="oe_structure oe_empty o_savable" data-oe-model="ir.ui.view" data-oe-id="539" data-oe-field="arch" data-editor-message-default="true" data-editor-message="Drag blocks here" contenteditable="true" data-dirty-element="1"> <p> Texta </p> </div>'
    );
    await animationFrame();
