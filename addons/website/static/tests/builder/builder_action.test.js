    ...
    describe("reload action: apply, clean save and reload are called in the right order (async)", () => {
        ...
        describe("warn on use async apply or async clean on previewable action", () => {
            beforeEach(async () => {
                ...
                addBuilderAction({
                    IncorrectApplyAction: class extends BuilderAction {
                        static id = "incorrectApply";
                        getValue() {
                            return "hello";
                        }
                        isApplied({ editingElement }) {
                            return editingElement.dataset.incorrectApply === "true";
                        }
                        async apply({ editingElement }) {
                    ...
                    IncorrectCleanAction: class extends BuilderAction {
                        static id = "incorrectClean";
                        isApplied({ editingElement }) {
                            return editingElement.dataset.incorrectClean !== "true";
                        }
                        apply({ editingElement }) {
                            expect.step("apply");
