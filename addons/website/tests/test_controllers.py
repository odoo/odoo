...
class TestControllers(tests.HttpCase):
    ...
    def test_07_get_alt_images(self):
        ...
        with MockRequest(self.env, website=self.env.ref('base.default_website')):
            ...
            actual_srcs = [img["src"] for img in result]
    ...
    def test_08_update_alt_images(self):
        ...
        test_view = self.env["ir.ui.view"].create({
            ...
            "type": "qweb",
            # Website-specific: writing to a generic view in a website context
            # would COW it and the update would land on the copy instead.
        ...
        with MockRequest(env, website=website):
            imgs = Website().get_alt_images(models)
    ...
    def test_robots_and_meta(self):
        ...
        # 2. Check that the login page does not contain the noindex meta tag
