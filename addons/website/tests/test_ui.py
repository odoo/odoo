...
class TestUi(HttpCaseWithUserRestricted):
    ...
    def test_05_specific_website_editor(self):
        ...
        self.start_tour(f'/website/force/{website_default.id}?{url_params}', "generic_website_editor", login="restricted")
        self.start_tour(f'/website/force/{new_website.id}?{url_params}', "specific_website_editor", login="restricted")
    ...
    def test_10_website_conditional_visibility(self):
        ...
        self.start_tour('/odoo', 'conditional_visibility_2', login="restricted")
