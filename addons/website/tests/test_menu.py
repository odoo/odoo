...
class TestMenuHttp(common.HttpCase):
    ...
    def test_03_mega_menu_translate(self):
        ...
        website.language_ids = [Command.link(fr.id)]
        menu = Menu.create({
        ...
        # Translate
        root = html.fromstring(menu.mega_menu_content, parser=html.HTMLParser(encoding="utf-8"))
        ...
        self.assertIn("french_mega_menu_content", menu.with_context(lang=fr.code, website_id=website.id).mega_menu_content)
