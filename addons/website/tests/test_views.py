...
class TestViewSaving(common.TransactionCase):
    ...
    def test_replace_arch(self):
        ...
        result = self.env['ir.ui.view'].replace_arch_section(self.test_view.id, None, replacement)
    ...
    def test_fixup_arch(self):
        ...
        result = self.env['ir.ui.view'].replace_arch_section(self.test_view.id, '/div/div[1]/h3', replacement)
    ...
    def test_multiple_xpath_matches(self):
        with self.assertRaises(ValueError):
            self.env['ir.ui.view'].replace_arch_section(self.test_view.id, '/div/div/h3', h.H6("Lol nope"))
    ...
    def test_save_only_embedded(self):
        ...
        self.env['ir.ui.view'].browse(company_id).save(value=node)
    ...
    def test_field_tail(self):
        ...
        self.test_view.save(value=replacement, xpath='/div/div[2]/ul/li[3]')
