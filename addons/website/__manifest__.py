...

{
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'website/static/src/components/autocomplete_with_pages/autocomplete_with_pages.xml',
            'website/static/src/components/autocomplete_with_pages/url_autocomplete.xml',
