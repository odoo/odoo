...
* Voucher Payment [Customer & Supplier]
    ...
    'test' : [
        ...
        'test/case1_eur_eur.yml',
        'test/case1_eur_eur_payment_rate.yml',
        'test/case2_eur_usd_debtor_in_usd.yml',
        'test/case2_eur_usd_debtor_in_eur.yml',
        'test/case3_usd_usd.yml',
        'test/case4_cad_chf.yml',
        'test/case_usd_eur.yml',
    ],
    'auto_install': False,
    'application': True,
    'installable': True,
