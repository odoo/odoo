...
#    _rec_name = 'number'
    ...
    _columns = {
        ...
        'type':fields.selection([
            ...
            ('payment','Payment'),
            ('receipt','Receipt'),
        ],'Default Type', size=8, readonly=True, states={'draft':[('readonly',False)]}),
        ...
        'state':fields.selection(
            [('draft','Draft'),
             ...
             ('proforma','Pro-forma'),
             ('posted','Posted')
            ], 'Status', readonly=True, size=8, track_visibility='onchange',
        ...
        ],'Payment', select=True, size=9, readonly=True, states={'draft':[('readonly',False)]}),
        ...
        'payment_option':fields.selection([
                                           ...
                                           ], 'Payment Difference', required=True, size=16, readonly=True, states={'draft': [('readonly', False)]}, help="This field helps you to choose what you want to do with the eventual difference between the paid amount and the sum of allocated amounts. You can either choose to keep open this difference on the partner's account, or reconcile it with the payment(s)"),
...
class account_voucher_line(osv.osv):
    ...
    _columns = {
        ...
        'type':fields.selection([('dr','Debit'),('cr','Credit')], 'Dr/Cr', size=2),
