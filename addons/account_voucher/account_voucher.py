...
#    _rec_name = 'number'
    ...
    _columns = {
        ...
        'analytic_id': fields.many2one('account.analytic.account','Write-Off Analytic Account', readonly=True, states={'draft': [('readonly', False)]}, help="An analytic Account which records this written-off money."),
