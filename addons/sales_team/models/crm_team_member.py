...
class CrmTeamMember(models.Model):
    ...
    _unique_active_membership = models.UniqueIndex(
        '(crm_team_id, user_id) WHERE active IS TRUE',
    ...
    def create(self, vals_list):
        ...
        (tracked fields).
        """
        self.flush_model(['active'])  # To ensure that _unique_active_membership is update
