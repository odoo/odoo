...
class ResCompany(models.Model):
    ...
    # TODO: Set this via l10n_xx muse have reconcile = True and user_type = self.env.ref('account.data_account_type_current_assets')
    transfer_account = fields.Many2one('account.account',
