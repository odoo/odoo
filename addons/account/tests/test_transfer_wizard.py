...
class TestTransferWizard(AccountTestInvoicingCommon):
    ...
    def test_change_period_reconcile_pair_by_pair_customer_invoices(self):
        ...
        self.assertRecordValues(destination_move.line_ids, [
            ...
            {'balance':  1000.0, 'account_id': self.receivable_account.id},
            {'balance': -1000.0, 'account_id': accrual_account.id},
            {'balance':  600.0, 'account_id': self.partner_b.property_account_receivable_id.id},
            {'balance': -600.0, 'account_id': accrual_account.id},
            {'balance':  1400.0, 'account_id': self.partner_b.property_account_receivable_id.id},
            {'balance': -1400.0, 'account_id': accrual_account.id},
        ])
        ...
        # (regardless of installments, one reconciliation per invoice), not cross-reconciled altogether
