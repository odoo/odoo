...
class TestSequenceMixin(TestSequenceMixinCommon):
    ...
    def test_sequence_change_date(self):
        ...
        self.assertEqual(self.test_move.name, 'MISC/2015-2016/01/0001')
        ...
        self.assertEqual(self.test_move.name, 'MISC/2019-2020/02/0001')
    ...
    def test_sequence_change_date_with_quick_edit_mode(self):
        ...
        self.assertEqual(bill.name, 'BILL/2015-2016/01/0001')
        bill = bill.copy({'date': '2016-02-01'})

        self.assertEqual(bill.name, 'BILL/2015-2016/02/0001')
        with Form(bill) as bill_form:
            bill_form.date = '2016-02-02'
            self.assertEqual(bill_form.name, 'BILL/2015-2016/02/0001')
            bill_form.date = '2016-03-01'
            self.assertEqual(bill_form.name, 'BILL/2015-2016/03/0001')
            bill_form.date = '2017-01-01'
            self.assertEqual(bill_form.name, 'BILL/2016-2017/01/0001')
    ...
    def test_sequence_empty_editable_with_quick_edit_mode(self):
        ...
        self.assertEqual(bill_1.name, 'BILL/2015-2016/01/0001')
        ...
        with Form(bill_2) as bill_2_form:
            ...
            bill_2_form.name = 'BILL/2015-2016/01/0002'
            self.assertEqual(bill_2_form.name, 'BILL/2015-2016/01/0002')
        ...
        with Form(bill_3) as bill_3_form:
            self.assertEqual(bill_3_form.name, 'BILL/2015-2016/02/0001')

        with Form(bill_4) as bill_4_form:
            self.assertFalse(bill_4_form.name)
            bill_4_form.name = 'BILL/2015-2016/02/0002'
            self.assertEqual(bill_4_form.name, 'BILL/2015-2016/02/0002')
    ...
    def test_sequence_draft_change_date(self):
        ...
        self.assertEqual(new_move.name, 'MISC/2015-2016/02/0001')
        self.assertEqual(new_multiple_move_1.name, 'MISC/2015-2016/03/0001')
        self.assertEqual(new_multiple_move_2.name, 'MISC/2016-2017/04/0001')
        ...
        self.assertEqual(new_multiple_move_1.name, 'AJ/2015-2016/01/0001')
        self.assertEqual(new_multiple_move_2.name, 'AJ/2015-2016/02/0001')
    ...
    def test_sequence_draft_first_of_period(self):
        ...
        self.assertEqual(move_a.name, 'MISC/2022-2023/02/0001')

        move_b = self.test_move.copy({'date': '2023-02-02'})
        self.assertEqual(move_b.name, '/')

        move_b.action_post()
        self.assertEqual(move_b.name, 'MISC/2022-2023/02/0002')
    ...
    def test_journal_sequence(self):
        ...
        copy1.action_post()
        self.assertEqual(copy1.name, 'MISC/2015-2016/01/0002')
        ...
        self.assertEqual(copy2.name, 'MISC2/2015-2016/01/0001')
        ...
        with Form(copy2) as move_form:  # It is editable in the form
            ...
            self.assertEqual(move_form.name, 'MISC2/2015-2016/01/0001')
    ...
    def test_journal_sequence_multiple_type(self):
        ...
        self.assertEqual(entry.name, 'MISC/2015-2016/01/0002')
        self.assertEqual(entry2.name, 'MISC/2015-2016/01/0003')
        self.assertEqual(invoice.name, 'INV/2015-2016/00001')
        self.assertEqual(invoice2.name, 'INV/2015-2016/00002')
        self.assertEqual(refund.name, 'RINV/2015-2016/00001')
        self.assertEqual(refund2.name, 'RINV/2015-2016/00002')
    ...
    def test_change_journal_on_first_account_move(self):
        ...
        self.assertEqual(move.name, 'MISC/2021-2022/10/0001')
        with Form(move) as move_form:
            move_form.journal_id = journal
        self.assertEqual(move.name, 'AJ/2021-2022/10/0001')
