...
class TestUi(AccountTestInvoicingHttpCommon):
    ...
    def test_deductible_amount_column(self):
        self.assertFalse(self.env.user.has_group('account.group_purchase_all_invoicing_rights'))
        ...
        move.action_post()
        self.assertTrue(self.env.user.has_group('account.group_purchase_all_invoicing_rights'))
