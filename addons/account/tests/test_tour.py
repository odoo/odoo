...
class TestUi(AccountTestInvoicingHttpCommon):
    ...
    def test_deductible_amount_column(self):
        self.assertFalse(self.env.user.has_group('account.group_purchase_deductible_amount'))
        ...
        move.action_post()
        self.assertTrue(self.env.user.has_group('account.group_purchase_deductible_amount'))
