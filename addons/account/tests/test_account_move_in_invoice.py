...
class TestAccountMoveInInvoiceOnchanges(AccountTestInvoicingCommon):
    ...
    def test_in_invoice_payment_register_wizard(self):
        ...
        with self.assertRaisesRegex(UserError, r"There's nothing left to pay on those selected journal items, so no payment registration is necessary. You've got your finances under control like a boss!"):
