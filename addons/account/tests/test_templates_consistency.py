...
class AccountingTestTemplConsistency(TransactionCase):
    ...
    def test_account_account_fields(self):
        ...
        self.check_fields_consistency(
            'account.account', 'account.account.template', exceptions=['company_id', 'deprecated', 'opening_debit', 'opening_credit', 'allowed_journal_ids', 'group_id', 'root_id', 'is_off_balance', 'non_trade', 'include_initial_balance'])
    ...
    def test_reconcile_model_fields(self):
        ...
        self.check_fields_consistency('account.reconcile.model.line', 'account.reconcile.model.line.template', exceptions=['company_id', 'journal_id', 'analytic_account_id', 'amount'])
