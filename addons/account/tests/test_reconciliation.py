...
class TestReconciliation(TransactionCase):
    ...
    def test_balanced_exchanges_gain_loss(self):
        ...
        # We create a bank statement with two lines of 1.0 USD each.
        bank_stmt_id = self.acc_bank_stmt_model.create(cr, uid, {
            'journal_id': self.bank_journal_usd_id,
        ...
        # The invoice should be paid, as the payment totally covers its total
        ...
        # We should be able to find a move line of 0.01 cent on the Debtors account, being the cent we lost during the currency exchange
        ...
        #  We should be able to find a move line of 1 cent on the Foreign Exchange Loss account
