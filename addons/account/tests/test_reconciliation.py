...
@tagged('hbto', 'post_install', '-at_install')
class TestReconciliationInvoiceWidgets(TestReconciliation):
    ...
    def test_reconcile_assign_outstanding_case_01(self):
        ...
        self.assertEqual(apr_r1i2.amount, 546.52, "Amount in company currency is wrong")
        ...
        self.assertEqual(inv2_rec.amount_residual, -317.17)
        ...
        self.assertEqual(apr_p2i2.amount, -317.17, "Amount in company currency is wrong")
