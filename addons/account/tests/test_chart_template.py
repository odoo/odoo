...
class TestChartTemplate(AccountTestInvoicingCommon):
    ...
    def test_new_tax_rate(self):
        ...
        * Update the taxes on
        ...
        Ultimately, there should be a date on linked to the rate, so that invoices created in the past
        or in the future take the right rate immediately. This is subject to future improvements.
        """
        def local_get_data(self, template_code):
