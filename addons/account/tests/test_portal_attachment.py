...
class TestPortalAttachment(AccountTestInvoicingHttpCommon):
    ...
    def test_01_portal_attachment(self):
        ...
        res = self.url_open(
            ...
            json={
                'params': {
                    ...
                    "access_token": attachment._attachment_ownership_access_token(),
                },
            },
        )
        self.assertEqual(res.status_code, 200)
        ...
        self.assertEqual(res.status_code, 200)
        self.assertIn(
            "The attachment(s) does not exist or you do not have the rights to access it.", res.text
        )
        ...
        res = self.url_open(
            ...
            json={
                'params': {
                    ...
                    "attachment_tokens": [attachment._attachment_ownership_access_token()],
                },
            },
        )
        self.assertEqual(res.status_code, 200)
