...
class TestMergePartner(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.bank1 = cls.Bank.create({'account_number': '12345', 'partner_id': cls.partner1.id})
        cls.bank2 = cls.Bank.create({'account_number': '67890', 'partner_id': cls.partner2.id})
        cls.bank3 = cls.Bank.create({'account_number': '12345', 'partner_id': cls.partner3.id})
