...
class TestAccountMoveOutInvoiceOnchanges(AccountTestInvoicingCommon):
    ...
    def test_out_invoice_switch_out_refund_4(self):
        # Assert that when switching from out_invoice to out_refund the bank partner is changed accordingly
        ...
        self.assertEqual(move.partner_bank_id, self.partner_a_bank_account)
