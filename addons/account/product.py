    ...
    def write(self, cr, uid, ids, vals, context=None):
        if 'uom_po_id' in vals:
            ...
            if self.pool.get('account.move.line').search(cr, uid, [('product_id', 'in', product_ids)], context=context, limit=1):
                raise Warning(_('Error!'), _("You can not change the unit of measure of a product that has been already used in an account journal item. If you need to change the unit of measure, you may deactivate this product.") % ())
