            ...
            if invoice.move_id:
                for line in invoice.move_id.line_id:
                    ...
                    if line.currency_id == invoice.currency_id:
                        ...
                        ctx['date'] = line.date
                        line_amount = self.pool['res.currency'].compute(cr, uid, line.company_id.currency_id.id, invoice.currency_id.id, line.amount_residual, context=ctx)
                    ...
                    if line.reconcile_partial_id:
                        ...
                        line_amount = self.pool['res.currency'].round(cr, uid, invoice.currency_id, line_amount / len(partial_reconciliation_invoices))
