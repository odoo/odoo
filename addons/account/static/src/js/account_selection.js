...
export class HierarchySelection extends SelectionField {
...
HierarchySelection.template = "account.AccountTypeSelection";

registry.category("fields").add("account_type_selection", HierarchySelection);
