export const accountTourUtils = {
    getProductColumnTrigger() {
        // Default trigger for the account module.
        // To be overridden in 'sale'.
        return '.o-dropdown-item input[name="product_id"]';
    },
    ...
    showProductColumn() {
        ...
        return [
            ...
            },
            {
                ...
                trigger: this.getProductColumnTrigger(),
                run: function ({ anchor }) {
                    if (!anchor.checked) {
                        anchor.click();
                    }
