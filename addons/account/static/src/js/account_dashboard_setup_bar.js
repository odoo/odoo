<<<<<<< b659d841462a7749f7b38ae3e5b9ec0988e8a867
=======
...
var AccountSetupBarRenderer = KanbanRenderer.extend({
    ...
    _notifyTargetChange: function (target_name, value) {
        this.trigger('dashboard_edit_target', {
  ...
  /**
    ...
    onActionClicked: function(e) {
        ...
        if(type_attr == COMPANY_METHOD_TYPE) {
            self.trigger('company_button_action', {rpc_method: name_attr, context: action_context})
        }
    },
});
                    ...
                    function(rslt_action) {
                        if (rslt_action !== undefined) {
                            self.do_action(rslt_action, {
                                ...
                                on_close: function () {
                                    self.trigger('reload'); //Reloads the dashboard to refresh the status of the setup bar.
                                },
                            });
                        }
