...
export class FetchEInvoices extends Component {
    ...
    get buttonLabel() {
        return this.env.searchModel.globalContext.show_fetch_einvoices_button
            ? _t("Fetch e-Invoices")
...
export const fetchEInvoicesActionMenu = {
    ...
    isDisplayed: ({ config, searchModel }) =>
        ...
        (searchModel.globalContext.show_fetch_einvoices_button ||
            searchModel.globalContext.show_refresh_einvoices_status_button ||
            false),
};
