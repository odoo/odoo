...
from odoo.exceptions import MissingError, ValidationError, UserError, RedirectWarning
...
class ResCompany(models.Model):
    ...
    def _with_locked_records(self, records, allow_raising=True):
        ...
        """
        # TODO deprecate and use lock_records directly
        try:
            locked = records.lock_records(strict=allow_raising)
            return bool(locked) and locked == records
        except MissingError:
