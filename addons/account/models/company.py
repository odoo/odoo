...
class ResCompany(models.Model):
    ...
    auto_correct_accounting_date = fields.Boolean(help='The "Accounting Date" will automatically be set to the first day following the "Tax Lock Date" when Invoice/Bill is validated for a Tax Locked period.')
