...
Best Regards,'''))
    ...
    # Accrual Accounting
    expense_accrual_account_id = fields.Many2one('account.account', help="Account used to move the period of an expense", domain=lambda self: [('user_type_id', '=', self.env.ref('account.data_account_type_accrued_expense').id)])
    revenue_accrual_account_id = fields.Many2one('account.account', help="Account used to move the period of a revenue", domain=lambda self: [('user_type_id', '=', self.env.ref('account.data_account_type_accrued_revenue').id)])
