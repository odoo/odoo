...
class ResCompany(models.Model):
    ...
    accounts_sale_tax_id = fields.Many2one('account.tax', string="Default Sale Tax")
    accounts_purchase_tax_id = fields.Many2one('account.tax', string="Default Purchase Tax")
