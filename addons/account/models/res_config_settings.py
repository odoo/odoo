    ...
    def _compute_has_chart_of_accounts(self):
        ...
        for config in self:
            ...
            candidate_template_selection = [
                ...
                if (
                    ChartTemplate._is_parent_of(template_code, candidate_template_code)
                    or (parent_template_code and ChartTemplate._is_parent_of(parent_template_code[0], candidate_template_code))
                    )
            ]
