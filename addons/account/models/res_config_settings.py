...
from odoo.addons import portal, product, digest, base_setup, analytic


class ResConfigSettings(base_setup.ResConfigSettings, product.ResConfigSettings, analytic.ResConfigSettings, portal.ResConfigSettings, digest.ResConfigSettings):
