...
class AccountAccountType(models.Model):
    ...
    account_type = fields.Selection([
        ...
        ('payable', 'Payable'),
        ('liquidity', 'Liquidity'),
    ], required=True, default='other', string='Type', oldname='type',
...
class AccountAccount(models.Model):
    ...
    internal_type = fields.Selection(related='user_type_id.account_type', string="Internal Type", store=True, readonly=True)
...
class AccountJournal(models.Model):
    ...
    def _get_alias_values(self, alias_name=None):
        ...
        return {
            'alias_defaults': {'invoice_type': 'in_invoice'},
...
class AccountTax(models.Model):
    ...
    def _search(self, args, offset=0, limit=None, order=None, count=False, access_rights_uid=None):
        ...
        if context.get('invoice_type'):
            ...
            elif context.get('invoice_type') in ('in_invoice', 'in_refund'):
