...
class AccountAccountTag(models.Model):
    ...
    tax_report_line_id = fields.Many2one(string="Parent Tax Report Line", comodel_name='account.tax.report.line', help="The tax report line for wich this tag was generated")
...
class AccountTaxReportLine(models.Model):
    ...
    children_tag_ids = fields.One2many(string="Generated Tags", comodel_name='account.account.tag', inverse_name='tax_report_line_id', help="Tax tags generated by this line")
