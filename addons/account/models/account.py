...
class AccountAccountTag(models.Model):
    ...
    tax_report_line_ids = fields.Many2one(string="Parent Tax Report Lines", comodel_name='account.tax.report.line', relation='account_tax_report_line_tags_rel', help="The tax report lines for wich this tag was generated")
...
class AccountTaxReportLine(models.Model):
    ...
    children_tag_ids = fields.Many2many(string="Generated Tags", comodel_name='account.account.tag', relation='account_tax_report_line_tags_rel', help="Tax tags generated by this line")
    country_id = fields.Many2one(string="Country", comodel_name='res.country', required=True, help="Country for which this line is available.")
    ...
    formula = fields.Char(string="Formula", help="Python expression used to compute the value of a total line. This field is mutually exclusive with tag_name, setting it turns the line to a total line. Tax report line codes can be used as variable in this expression to refer to the balance of the corresponding lines in the report. A formula cannot refer to another line using a formula.")
