...
class AccountJournal(models.Model):
    ...
    bank_account_id = fields.Many2one('res.partner.bank', string="Bank Account", ondelete='restrict', copy=False, domain=lambda self: [('partner_id','=', self.env.user.company_id.partner_id.id)])
