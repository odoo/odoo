...
class AccountMoveSend(models.AbstractModel):
    ...
    @api.model
    @after_commit
    def _generate_and_send_invoices_post_commit(self, moves, from_cron=False, allow_raising=True, allow_fallback_pdf=False,
                                                **custom_settings):
        self._generate_and_send_invoices(moves, from_cron=from_cron, allow_raising=allow_raising, allow_fallback_pdf=allow_fallback_pdf,
                                         **custom_settings)
