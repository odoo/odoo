...
from odoo.addons.account.tools import format_account_number
...
class AccountBankStatementLine(models.Model):
    ...
    account_number = fields.Char(string='Sanitized Bank Account Number', search='_search_account_number')
    ...
    def _compute_formatted_account_number(self):
        for st_line in self:
            st_line.formatted_account_number = format_account_number(self.env, st_line.account_number)
    ...
    def _inverse_formatted_account_number(self):
        for st_line in self:
            st_line.account_number = sanitize_account_number(st_line.formatted_account_number)
