...
class AccountTax(models.Model):
    ...
    def _should_keep_zero_line(self, base_line, tax_data, tax_rep_data):
        """ Hook to allow keeping tax lines with a zero amount. This is called per base line, per tax and per repartition
        line. If any call returns True, the tax line will be kept, even if it is zero.

        :param base_line:        One base line from base lines generated by the '_prepare_base_line_for_taxes_computation' method.
        :param tax_data:         One tax data from the base_line['taxes_data'].
        :param tax_rep_data:     One repartition line from tax_data['tax_reps_data'].
        """
        return False
        ...
        for base_line in base_lines:
            ...
            for tax_data in tax_details['taxes_data']:
                ...
                for tax_rep_data in tax_data['tax_reps_data']:
                    ...
                    tax_line['keep_zero_line'] |= self._should_keep_zero_line(base_line, tax_data, tax_rep_data)
