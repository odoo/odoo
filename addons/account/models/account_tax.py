...
class AccountTax(models.Model):
    ...
    def _fix_base_lines_tax_details_on_manual_tax_amounts(self, base_lines, company, filter_function=None):
        ...
        for base_line in base_lines:
            ...
            # By consistency, we also have to adapt the price_unit.
            if base_line['quantity'] and base_line['discount'] != 100.0:
                base_line['price_unit'] += tax_details['delta_total_excluded_currency'] / base_line['quantity'] / (1 - (base_line['discount'] / 100.0))
    ...
    def _squash_global_discount_lines(self, base_lines, company):
        ...
        for base_line in base_lines:
            ...
            raw_total_excluded_currency_before = base_line['tax_details']['raw_total_excluded_currency']
            ratio_before = raw_total_excluded_currency_before / raw_gross_total_excluded_currency_before
            ...
            raw_total_excluded_currency_after = base_line['tax_details']['raw_total_excluded_currency']
            ratio_after = raw_total_excluded_currency_after / raw_gross_total_excluded_currency_before
            if ratio_before != 1.0:
                base_line['discount'] *= (1 - ratio_after) / (1 - ratio_before)
