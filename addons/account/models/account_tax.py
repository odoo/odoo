...
from odoo.tools.float_utils import float_repr, float_round, float_compare, float_is_zero
...
class AccountTax(models.Model):
    ...
    def _merge_tax_details(self, tax_details_1, tax_details_2):
        """ Helper to merge two 'tax_details' from different base_lines together.

        [!] Only added python-side.

        :param tax_details_1: The first tax details.
        :param tax_details_2: The second tax details.
        :return: A new tax_details being the combination of the two passed as parameter.
        """
        results = {
