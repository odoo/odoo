...
from odoo.tools import float_compare, date_utils, email_split, email_re, float_is_zero, float_round
...
class AccountMoveLine(models.Model):
    ...
    def _get_price_total_and_subtotal(self, price_unit=None, quantity=None, discount=None, currency=None, product=None, partner=None, taxes=None, move_type=None):
        ...
        price_unit = float_round(price_unit or self.price_unit, precision_digits=precision_digits.digits)
