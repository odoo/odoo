        ...
        for record in self:
            ...
            for tag in record.tag_ids:
                ...
                for report_line in tag.tax_report_line_ids:
                    ...
                    audit_str += report_line.tag_name + ': ' + str(tag_amount)
                    ...
                    if not line.tax_exigible:
                        ...
                        if line.tax_line_id and line.tax_line_id.tax_exigibility == 'on_payment':
                            ...
                            self.env['account.move.line'].with_context(check_move_validity=False).create({
                                ...
                                'account_id': line.tax_repartition_line_id.account_id.id or self._get_amount_tax_cash_basis(line, line.tax_line_id),
                                'analytic_account_id': line.analytic_account_id.id,
                                'analytic_tag_ids': line.analytic_tag_ids.ids,
