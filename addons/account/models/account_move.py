...
class AccountMove(models.Model):
    ...
    def _get_mail_template(self):
        ...
        if all(move.move_type in ('in_invoice', 'in_refund') and move.journal_id.is_self_billing for move in self):
            template_xmlid = 'account.email_template_edi_self_billing'
