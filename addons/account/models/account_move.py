    ...
    def _check_reversal_amounts_and_quantities(self):
        ...
        for move in self:
            ...
            for line in original_move.invoice_line_ids.filtered(lambda l: l.display_type == 'product'):
                original_quantities[line.product_id] += line.product_uom_id._compute_quantity(line.quantity,
                                                                                              line.product_id.uom_id)
            for line in reversals.invoice_line_ids.filtered(lambda l: l.display_type == 'product'):
                reverse_quantities[line.product_id] += line.product_uom_id._compute_quantity(line.quantity,
                                                                                             line.product_id.uom_id)
