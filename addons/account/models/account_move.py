...
class AccountMove(models.Model):
    ...
    def _check_duplicate_supplier_reference(self):
        ...
        '''.format(", ".join(["(%s, %s, %s, %s, %s, CAST(%s as DATE))"] * len(self))), list(chain(*self.mapped(lambda r: [r.id, r.ref, r.company_id.id, r.commercial_partner_id.id or 0, r.type, r.invoice_date or None]))) + [tuple(moves.ids)])
