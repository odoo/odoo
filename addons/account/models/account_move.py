...
class AccountMove(models.Model):
    ...
    def _compute_date(self):
        for move in self:
            if not move.invoice_date or not move.is_invoice():
                ...
                continue
            accounting_date = move._get_accounting_date_source_field()
    ...
    def _post(self, soft=True):
        ...
        for move in to_post:
            ...
            if lock_dates:
                move.date = move._get_accounting_date(move._get_accounting_date_source_field(), affects_tax_report, lock_dates=lock_dates)
