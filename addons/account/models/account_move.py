...
class AccountPartialReconcile(models.Model):
    ...
    max_date = fields.Datetime(string='Date of reconciliation', compute='_compute_max_date',
        readonly=True, copy=False, stored=True,
        help='Technical field used to determine at which date this reconciliation needs to be shown on reports.')
