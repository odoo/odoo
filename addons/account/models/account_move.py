...
class AccountMove(models.Model):
    ...
    def _compute_name(self):
        ...
        for move in self:
            ...
            if (move_has_name or move.state == 'draft') and not move.posted_before and not move._sequence_matches_date():
    ...
    def _compute_name_placeholder_form(self):
        for move in self:
            if (not move.name or not move.posted_before) and not move._get_last_sequence():
                ...
                move.name_placeholder_form = sequence_format_string.format(**sequence_format_values)
            else:
                move.name_placeholder_form = False
