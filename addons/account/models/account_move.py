...
class AccountMoveLine(models.Model):
    ...
    def create(self, vals_list):
        ...
        for line, vals in zip(lines, vals_list):
            ...
            if 'tax_exigible' not in vals and line.tax_ids and not line.tax_repartition_line_id:
                line.tax_exigible = not bool('on_payment' in line.tax_ids.flatten_taxes_hierarchy().mapped('tax_exigibility'))
