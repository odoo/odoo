...
class AccountMoveLine(models.Model):
    ...
    @api.model
    def _get_query_tax_details(self, domain_query, include_without_tax_line=False) -> SQL:
        ...
        return SQL('''
            ...
            tax_line_join=SQL('LEFT JOIN') if include_without_tax_line else SQL('JOIN'),
            extra_query_base_tax_line_mapping=extra_query_base_tax_line_mapping,
        )

    @api.model
    def _get_query_tax_details_from_domain(self, domain, include_without_tax_line=False) -> SQL:
        ...
        return self._get_query_tax_details(query, include_without_tax_line)
