...
class AccountMoveLine(models.Model):
    ...
    def _compute_totals(self):
        ...
        for line in self:
            ...
            line.price_subtotal = base_line['tax_details']['total_excluded_currency'] + base_line['tax_details']['delta_total_excluded_currency']
            line.price_total = base_line['tax_details']['total_included_currency'] + base_line['tax_details']['delta_total_excluded_currency']
