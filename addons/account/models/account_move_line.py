...
class AccountMoveLine(models.Model):
    ...
    def _web_read_group(self, domain, groupby=(), aggregates=(), having=(), offset=0, limit=None, order=None) -> list[dict]:
        # Hide total amount_currency from _web_read_group when view is not grouped by currency_id. Avoids mix of currencies
        res = super()._web_read_group(domain, groupby, aggregates, having=having, offset=offset, limit=limit, order=order)
