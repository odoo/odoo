    ...
    def _compute_product_uom_id(self):
        for line in self.filtered(lambda l: l.parent_state == 'draft'):
            ...
            if line.move_id.is_purchase_document():
                line.product_uom_id = line.product_id.seller_ids.filtered(lambda s: s.partner_id == line.partner_id and s.company_id == line.company_id)[:1].product_uom_id or line.product_id.uom_id
            else:
