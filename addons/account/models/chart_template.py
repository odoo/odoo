...
class WizardMultiChartsAccounts(models.TransientModel):
    ...
    def execute(self):
        ...
        if self.sale_tax_id and taxes_ref:
            ...
            IrConfig.sudo().set_param("account.default_sale_tax_id", self.purchase_tax_id.id)
        if self.purchase_tax_id and taxes_ref:
            ...
            IrConfig.sudo().set_param("account.default_purchase_tax_id", self.purchase_tax_id.id)
