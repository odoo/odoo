...
class AccountChartTemplate(models.Model):
    ...
    def load_for_current_company(self, sale_tax_rate, purchase_tax_rate):
        ...
        company.write({
        'default_cash_difference_income_account_id': acc_template_ref[self.default_cash_difference_income_account_id.id],
        'default_cash_difference_expense_account_id': acc_template_ref[self.default_cash_difference_expense_account_id.id],
        })
