...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _pre_reload_data(self, company, template_data, data, force_create=True, force_update=False):
        ...
        current_fiscal_position_ids =  self.env['account.fiscal.position'].with_context(active_test=False).search([
        ...
        xmlid2fiscal_position= {
            ...
            for record, xml_id in current_fiscal_position_ids.get_external_id().items() if xml_id.startswith('account.')
        }
        xmlid2tax_group = {
