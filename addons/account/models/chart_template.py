...
class AccountChartTemplate(models.Model):
    ...
    transfer_account_code_prefix = fields.Char(string='Prefix of the main transfer accounts', default='transfer_0')
...
class WizardMultiChartsAccounts(models.TransientModel):
    ...
    transfer_account_code_prefix = fields.Char('Transfer Accounts Prefix')
