...
class AccountInvoice(models.Model):
    ...
    def _onchange_amount_total(self):
        for inv in self:
            if float_compare(inv.amount_total, 0., precision_rounding=inv.currency_id.rounding) == -1:
    ...
    def action_invoice_open(self):
        ...
        if to_open_invoices.filtered(lambda inv: float_compare(inv.amount_total, 0., precision_rounding=inv.currency_id.rounding) == -1):
