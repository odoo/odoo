...
class AccountInvoiceLine(models.Model):
    ...
    def _set_taxes(self):
        ...
        self.invoice_line_tax_ids = fp_taxes = self.invoice_id.fiscal_position_id.map_tax(taxes, product_id=self.product_id.id, partner_id=self.invoice_id.partner_id.id)
    ...
    def _onchange_account_id(self):
        ...
        if not self.product_id:
            fpos = self.invoice_id.fiscal_position_id
            self.invoice_line_tax_ids = fpos.map_tax(self.account_id.tax_ids, partner_id=self.partner_id.id).ids
