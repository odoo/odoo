...
class AccountAccount(models.Model):
    ...
    active = fields.Boolean(default=True, tracking=True, search='_search_active')
    ...
    hierarchy_code = fields.Char(compute="_compute_hierarchy_code", store=True, recursive=True)
    ...
    @api.depends('code', 'parent_id.hierarchy_code')
            ...
            if formatted_display_name and account.code:
                if parent := account.parent_id:
                    account.display_name = (
                        f"""{account.code} {parent.name} \t--{account.name}--"""
