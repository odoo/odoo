...
class AccountAccountTag(models.Model):
    ...
    report_expression_id = fields.Many2one('account.report.expression', compute='_compute_report_expression_id', compute_sudo=False)
    balance_negate = fields.Boolean(compute='_compute_report_expression_id', compute_sudo=False)
