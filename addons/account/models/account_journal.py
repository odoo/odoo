...
class AccountJournal(models.Model):
    ...
    show_sync_in_einvoices_button = fields.Boolean(
        string="Show E-Invoice Buttons",
        compute='_compute_show_sync_in_einvoices_button',
    )
    show_sync_out_einvoices_button = fields.Boolean(
        string="Show E-Invoice Status Buttons",
        compute='_compute_show_sync_out_einvoices_button',
    )
    ...
    @api.depends('type')
    def _compute_show_sync_in_einvoices_button(self):
        # TO OVERRIDE
        self.show_sync_in_einvoices_button = False

    @api.depends('type')
    def _compute_show_sync_out_einvoices_button(self):
        # TO OVERRIDE
        self.show_sync_out_einvoices_button = False
    ...
    def button_sync_in_einvoices(self):
        # TO OVERRIDE
        """
    ...
    def button_sync_out_einvoices(self):
        # TO OVERRIDE
        """
