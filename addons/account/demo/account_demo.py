...
def file_read(path: str) -> BinaryBytes:
    ...
    def _get_demo_data_attachment(self, template_code):
        return {
            'ir_attachment_in_invoice_1': {
                ...
                'raw': file_read('account/static/demo/in_invoice_yourcompany_demo_1.pdf'),
            },
            'ir_attachment_in_invoice_2': {
                ...
                'res_field': 'invoice_pdf_report_file',
                'raw': file_read('account/static/demo/in_invoice_yourcompany_demo_2.pdf'),
            },
