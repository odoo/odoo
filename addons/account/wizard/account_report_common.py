...
class account_common_report(osv.osv_memory):
    ...
    _columns = {
        'chart_account_id': fields.many2one('account.account', 'Chart of Account', help='Select Charts of Accounts', required=True, domain = [('parent_id','=',False), ('deprecated', '=', False)]),
