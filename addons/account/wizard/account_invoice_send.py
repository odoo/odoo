...
class AccountInvoiceSend(models.TransientModel):
    ...
    is_email = fields.Boolean('Email', default=lambda self: self.env['res.company']._get_current_company().invoice_is_email)
    is_print = fields.Boolean('Print', default=lambda self: self.env['res.company']._get_current_company().invoice_is_print)
