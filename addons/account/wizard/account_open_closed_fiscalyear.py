...
class account_open_closed_fiscalyear(osv.osv_memory):
    ...
    def remove_entries(self, cr, uid, ids, context=None):
        ...
        if not period_journal:
            raise Warning(_('Error!'), _("You have to set the 'End  of Year Entries Journal' for this Fiscal Year which is set after generating opening entries from 'Generate Opening Entries'."))
