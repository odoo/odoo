    ...
    def data_save(self, cr, uid, ids, context=None):
        ...
        def _reconcile_fy_closing(cr, uid, ids, context=None):
            ...
            if len(cr.fetchall()) > 1:
                raise Warning(_('Warning!'), _('The entries to reconcile should belong to the same company.'))
        ...
        if not fy_period_set or not fy2_period_set:
            raise Warning(_('User Error!'), _('The periods to generate opening entries cannot be found.'))
