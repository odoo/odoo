...
class AccountPaymentRegister(models.TransientModel):
    ...
    def _compute_currency_id(self):
        for wizard in self:
            line_currencies = wizard.line_ids.mapped('currency_id')
            shared_currency = line_currencies if len(line_currencies) == 1 else wizard.company_id.currency_id
            wizard.currency_id = wizard.journal_id.currency_id or shared_currency
