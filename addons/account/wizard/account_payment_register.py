...
class AccountPaymentRegister(models.TransientModel):
    ...
    def _get_batch_available_partner_banks(self, batch_result, journal):
        ...
        if journal and payment_values['payment_type'] == 'inbound':
    ...
    def _compute_available_journal_ids(self):
        """
        Get all journals that have an outstanding account.
        """
    ...
    def _compute_payment_method_id(self):
        for wizard in self:
            ...
            if wizard.payment_type == 'inbound' and inbound_payment_method.id in available_payment_methods.ids:
                ...
                wizard.payment_method_id = self.env['account.payment']._get_default_payment_method()
