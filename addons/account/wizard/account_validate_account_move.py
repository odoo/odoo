...
class validate_account_move(osv.osv_memory):
    ...
    def validate_move(self, cr, uid, ids, context=None):
        ...
        if not ids_move:
            raise UserError(_('Warning!'), _('Specified journals do not have any account move entries in draft state for the specified periods.'))
...
class validate_account_move_lines(osv.osv_memory):
    ...
    def validate_move_lines(self, cr, uid, ids, context=None):
        ...
        if not move_ids:
            raise UserError(_('Warning!'), _('Selected Entry Lines does not have any account move entries in draft state.'))
