...
class ReportTax(models.AbstractModel):
    ...
    def _get_with_statement(self, user_types, options, domain=None):
    ...
    def _compute_from_amls(self, options, taxes):
        ...
        if options['options'] == 'cash_basis':
            ...
            sql2 = sql2.replace('debit', 'debit_cash_basis').replace('credit', 'credit_cash_basis')
        user_types = self.env['account.account.type'].search([('type', 'in', ('receivable', 'payable'))])
        with_sql, with_params = self._get_with_statement(user_types, options)
