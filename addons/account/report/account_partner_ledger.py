...
#                    "AND " + self.query +" " \
    ...
    def lines(self, partner):
        ...
        self.cr.execute(
            "SELECT l.id, l.date, j.code, acc.code as a_code, acc.name as a_name, l.ref, m.name as move_name, l.name, COALESCE((l.debit),0.00) as debit, COALESCE((l.credit),0.00) as credit, l.amount_currency,l.currency_id, c.symbol AS currency_code " \
