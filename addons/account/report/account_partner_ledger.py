...
class ReportPartnerLedger(models.AbstractModel, CommonReportHeader):
    ...
    def render_html(self, data):
        ...
        self.reconcil = True
        cr = self.env.cr
        if data['form']['filters'] == 'unreconciled':
            self.reconcil = False
        ...
        self.account_ids = [a for (a,) in cr.fetchall()]
        ...
        self.partner_ids = [res['partner_id'] for res in cr.dictfetchall()]
