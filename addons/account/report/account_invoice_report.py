...
class AccountInvoiceReport(models.Model):
    ...
    def _compute_amounts_in_user_currency(self):
        ...
        """
        user_currency_id = self.env['res.company']._get_current_company().currency_id
        currency_rate_id = self.env['res.currency.rate'].search([
            ('rate', '=', 1),
            '|', ('company_id', '=', self.env['res.company']._get_current_company().id), ('company_id', '=', False)], limit=1)
