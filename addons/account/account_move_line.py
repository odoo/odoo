...
class account_move_line(osv.osv):
    ...
    _columns = {
        ...
        'date_maturity': fields.date('Due date', help="This field is used for payable and receivable entries. You can put the limit date for the payment of this entry line."),
