...
class account_account(osv.osv):
    ...
    def __compute(self, cr, uid, ids, field_names, arg=None, context=None,
        ...
        if children_and_consolidated:
            period_special = context.get('periods_special', False)
            aml_query = self.pool.get('account.move.line')._query_get(cr, uid, context=dict(context or {}, periods_special=period_special))
