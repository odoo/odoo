...
class AccountMove(models.Model):
    ...
    def _get_invoiced_lot_values(self):
        ...
        for sml in stock_move_lines:
            ...
            if product_uom.compare(quantity, 0) < 0 or \
                    product_uom.compare(previous_qty_delivered, previous_qty_invoiced) < 0:
        ...
        for lot, qty in qties_per_lot.items():
            ...
            lot = lot.sudo()
            if lot.product_uom_id.is_zero(invoiced_qties[lot.product_id]) \
