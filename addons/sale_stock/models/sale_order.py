...
class SaleOrder(models.Model):
    ...
    picking_policy = fields.Selection([
        ...
        default=lambda self: self.env['ir.config_parameter'].sudo().get_param('sale_stock.picking_policy', 'direct'),
        string='Shipping Policy', required=True, help="It specifies goods to be deliver partially or all at once")
