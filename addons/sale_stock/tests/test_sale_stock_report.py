...
class TestSaleStockInvoices(TestSaleCommon):
    ...
    def test_invoice_with_several_returns(self):
        ...
        move_form = Form(pick_return.move_ids, view='stock.view_stock_move_form_operations')
        ...
        move_form = Form(delivery02.move_ids, view='stock.view_stock_move_form_operations')
        ...
        move_form = Form(delivery03.move_ids, view='stock.view_stock_move_form_operations')
        with move_form.move_line_ids.new() as line:
            line.lot_id = lot02
            line.quantity = 5
        with move_form.move_line_ids.new() as line:
