...
class TestSaleStock(TestSaleCommon, ValuationReconciliationTestCommon):
    ...
    def test_02_sale_stock_return(self):
        ...
        self.assertEqual(self.so.invoice_status, 'invoiced', 'Sale Stock: so invoice_status should be "no" instead of "%s" after invoicing the return' % self.so.invoice_status)
