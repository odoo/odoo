...
# class optima_ecommerce(models.Model):
#     _name = 'optima_ecommerce.optima_ecommerce'
...
class product_style_shapes(osv.Model):
	_name = 'product.style_shapes'
	_columns = {
	 'name': fields.char("Name", default="12 Point Burst"),
	 'css': fields.char("CSS Name", default="burst-12"),
	}
class optima_product_styles(osv.Model):
	_inherit = 'product.style'
	_columns = {
	 'msg' : fields.char("Promotion Message"),
	 'text_color' : fields.char("Text Color"),
	 'bg_color' : fields.char("Background Color"),
         'shape' : fields.many2one('product.style_shapes', "Shape", 
	              help="You can apply promotion message using any shape of your choice as the Background of your message"),
	 'width' : fields.integer("Width(pixels)", default=40),
	 'height' : fields.integer("Height(pixels)", default=40),
         'top' : fields.integer("Position from Top(%)", default=40),
         'text_top' : fields.integer("Msg Position(pixels)", default=9),
	 'left' : fields.integer("Position from Left(%)", default=40),
         'font_size' : fields.integer("Font Size(pixels)", default=10),
