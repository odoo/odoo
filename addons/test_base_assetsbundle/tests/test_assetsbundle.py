...
class TestJavascriptAssetsBundle(FileTouchable):
    def setUp(self):
        ...
        self.jsbundle_xmlid = 'test_base_assetsbundle.bundle1'
        self.cssbundle_xmlid = 'test_base_assetsbundle.bundle2'
    ...
    def test_03_date_invalidation(self):
        ...
        path = get_resource_path('test_base_assetsbundle', 'static', 'src', 'js', 'test_jsfile1.js')
        bundle1 = self._get_asset(self.jsbundle_xmlid)
    ...
    def test_04_content_invalidation(self):
        ...
        <data>
            <xpath expr="." position="inside">
                <script type="text/javascript" src="/test_base_assetsbundle/static/src/js/test_jsfile4.js"/>
            </xpath>
        </data>
        """
    ...
    def test_05_debug(self):
        ...
        self.assertIn('/test_base_assetsbundle/static/src/js/test_jsfile1.js', content)
    ...
    def test_11_css_content_invalidation(self):
        ...
        <data>
            <xpath expr="." position="inside">
                <link rel="stylesheet" href="/test_base_assetsbundle/static/src/css/test_cssfile2.css"/>
            </xpath>
        </data>
        """
    ...
    def test_12_css_debug(self):
        ...
        content = self._node_to_list(nodes)
        # find back one of the original asset file
        self.assertIn('/test_base_assetsbundle/static/src/css/test_cssfile1.css', content)
    ...
    def test_14_duplicated_css_assets(self):
        ...
        content = self._node_to_list(nodes)
        self.assertEqual(content[2].count('test_base_assetsbundle.bundle2.css'), 1)
    ...
    def test_17_css_bundle_date_invalidation(self):
        ...
        path = get_resource_path('test_base_assetsbundle', 'static', 'src', 'css', 'test_cssfile1.css')
        ltr_bundle1 = self._get_asset(self.cssbundle_xmlid)
    ...
    def test_18_css_bundle_content_invalidation(self):
        ...
        <data>
            <xpath expr="." position="inside">
                <script type="text/css" src="/test_base_assetsbundle/static/src/css/test_cssfile3.css"/>
            </xpath>
        </data>
        """
        bundle = self.browse_ref(self.cssbundle_xmlid)
    ...
    def test_19_css_in_debug_assets(self):
        ...
        self.assertIn('/test_base_assetsbundle/static/src/css/test_cssfile1/rtl/{0}.css'.format(self.cssbundle_xmlid), content)

        # there should be assets(css) created in debug mode as user's lang direction is rtl
        css_bundle = self.env['ir.attachment'].search([
            ('url', '=', '/test_base_assetsbundle/static/src/css/test_cssfile1/rtl/{0}.css'.format(self.cssbundle_xmlid))
        ])
        self.assertEqual(len(css_bundle), 1)

    def test_20_exteral_lib_assets(self):
        html = self.env['ir.ui.view'].render_template('test_base_assetsbundle.template2')
        attachments = self.env['ir.attachment'].search([('url', '=like', '/web/content/%-%/test_base_assetsbundle.bundle4.%')])
...
<html>
    ...
    def test_21_exteral_lib_assets_debug_mode(self):
        html = self.env['ir.ui.view'].render_template('test_base_assetsbundle.template2', {"debug": "assets"})
        attachments = self.env['ir.attachment'].search([('url', '=like', '/web/content/%-%/test_base_assetsbundle.bundle4.%')])
...
<html>
    <head>
        <link rel="stylesheet" href="http://test.external.link/style1.css"/>
        <link rel="stylesheet" href="http://test.external.link/style2.css"/>
        <link type="text/css" rel="stylesheet" href="/test_base_assetsbundle/static/src/css/test_cssfile1.css"/>
        <link type="text/css" rel="stylesheet" href="/test_base_assetsbundle/static/src/css/test_cssfile2.css"/>
        <meta/>
        <script type="text/javascript" src="http://test.external.link/javascript1.js"></script>
        <script type="text/javascript" src="http://test.external.link/javascript2.js"></script>
        <script type="text/javascript" src="/test_base_assetsbundle/static/src/js/test_jsfile1.js"></script>
        <script type="text/javascript" src="/test_base_assetsbundle/static/src/js/test_jsfile2.js"></script>
        <script type="text/javascript" src="/test_base_assetsbundle/static/src/js/test_jsfile3.js"></script>
    </head>
    <body>
    </body>
</html>""").encode('utf8'))
...
class TestAssetsBundleInBrowser(HttpCase):
    ...
    def test_02_js_interpretation_inline(self):
        ...
        self.env['ir.ui.view'].create({
            ...
            'type': 'qweb',
            'arch': view_arch,
            'inherit_id': self.browse_ref('test_base_assetsbundle.bundle1').id,
        })
        self.env.user.flush()
...
class TestAssetsBundleWithIRAMock(FileTouchable):
    def setUp(self):
        ...
        self.stylebundle_xmlid = 'test_base_assetsbundle.bundle3'
    ...
    def test_01_debug_mode_assets(self):
        ...
        path = get_resource_path('test_base_assetsbundle', 'static', 'src', 'scss', 'test_file1.scss')
        t = time.time() + 5
