...
class TestViesIAP(HttpCase):
    ...
    def test_vies_iap_valid_vat(self):
        ...
        with (
            self.assertLogs('odoo.addons.l10n_eu_account_vies.models.res_partner', logging.INFO) as log_catcher,
        ):
    ...
    def test_vies_iap_controller(self):
        ...
        with (
            self.assertLogs('odoo.addons.l10n_eu_account_vies.controllers.webhook', level="WARNING") as log_catcher,
        ):
            self.url_open(
                '/l10n_eu_account_vies/1/webhook_update_vies',
                data={
