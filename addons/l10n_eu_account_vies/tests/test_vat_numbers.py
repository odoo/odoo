...
class TestStructure(TransactionCase):
    ...
    def test_parent_validation(self):
        ...
        with patch(
            'odoo.addons.l10n_eu_account_vies.models.res_partner.ResPartner._check_vies_validity_iap',
    ...
    def test_no_vies_revalidation_when_creating_company_from_contact(self):
        ...
        self.env.user.company_id.vat_check_vies = True
        with patch('odoo.addons.l10n_eu_account_vies.models.res_partner.ResPartner._check_vies_validity_iap', TestStructure._check_vies_validity_iap):
            partner = self.env["res.partner"].create({
                'name': 'Dummy Partner',
                'country_id': self.env.ref("base.be").id,
            })
        ...
        with patch('odoo.addons.l10n_eu_account_vies.models.res_partner.ResPartner._check_vies_validity_iap',
