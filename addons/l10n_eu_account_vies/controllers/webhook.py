...
class L10nEUAccountViesWebhookController(http.Controller):
    @http.route('/l10n_eu_account_vies/1/webhook_update_vies', type='http', csrf=False, save_session=False, auth='public')
