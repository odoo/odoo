...
class ResConfigSettings(models.TransientModel):
    ...
    pos_l10n_pk_edi_pos_identifier = fields.Integer(related='pos_config_id.l10n_pk_edi_pos_identifier', readonly=False)
    pos_l10n_pk_edi_pos_test_identifier = fields.Integer(related='pos_config_id.l10n_pk_edi_pos_test_identifier', readonly=False)
