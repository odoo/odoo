...
class PosConfig(models.Model):
    ...
    l10n_pk_edi_pos_identifier = fields.Integer(
        string="Shop ID",
        help="Shop ID provided by the FBR when registering your point of sale.",
    )
    l10n_pk_edi_pos_test_identifier = fields.Integer(
        string="Test Shop ID",
    ...
    def _create_cash_payment_method(self, cash_journal_vals=None):
        ...
        payment_method = super()._create_cash_payment_method(cash_journal_vals)
        if payment_method.company_id.account_fiscal_country_id.code == 'PK':
            payment_method.l10n_pk_edi_pos_fbr_payment_code = '1'
