...
class TestMassMailing(TestMassMailCommon):
    ...
    def test_mailing_w_blacklist(self):
        ...
        self.assertMessageRecordsCount(recipients, expected_message_count)
    ...
    def test_mailing_w_blacklist_nomixin(self):
        ...
        expected_message_count = [0 if t.get('trace_status') == 'cancel' else 1 for t in expected_traces]
        self.assertMessageRecordsCount(test_records, expected_message_count)
    ...
    def test_mailing_mailing_list_optout(self):
        ...
        self.assertEqual(mailing.canceled, 2)
        expected_message_count = [0 if t.get('trace_status') == 'cancel' else 1 for t in expected_traces]
        self.assertMessageRecordsCount(records, expected_message_count)
