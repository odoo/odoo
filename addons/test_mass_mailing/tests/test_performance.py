...
class TestMassMailPerformance(TestMassMailPerformanceBase):
    ...
    def test_send_mailing(self):
        ...
        with self.mock_mail_gateway(mail_unlink_sent=True), self.assertQueryCount(__system__=1578, marketing=1579):  # 1424, 1425
...
class TestMassMailBlPerformance(TestMassMailPerformanceBase):
    ...
    def test_send_mailing_w_bl(self):
        ...
        # runbot needs +101 compared to local
        with self.mock_mail_gateway(mail_unlink_sent=True), self.assertQueryCount(__system__=1637, marketing=1638):  # 1484, 1485
            mailing.action_send_mail()
