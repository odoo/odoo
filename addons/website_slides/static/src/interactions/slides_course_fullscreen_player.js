...
class WebsiteSlidesFullscreenVimeoPlayer extends Interaction {
...
class WebsiteSlidesFullscreenYoutubePlayer extends Interaction {
...
class WebsiteSlidesFullscreenSidebar extends Interaction {
    ...
    onTabClick(event) {
        ...
        const el = event.currentTarget.closest(".o_wslides_fs_sidebar_list_item");
