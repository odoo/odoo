...
//        },
    ...
    renderSlide() {
        ...
        try {
            ...
            if (slide.category === "quiz" || slide.isQuiz) {
                ...
                this.renderAt(`website.slides.fullscreen.video.${slide.videoSourceType}`, this.data, contentEl);
    ...
    async changeSlide() {
        ...
        this.renderSlide();
        if (this.slide.autoSetDone && !this.user.public) {
            // no useless RPC call
...
registry
    .category("public.interactions")
    .add("website_slides.WebsiteSlidesFullscreenYoutubePlayer", WebsiteSlidesFullscreenYoutubePlayer);
registry
    .category("public.interactions")
