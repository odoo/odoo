...
export class WebsiteSlidesQuizEdit extends Interaction {
    ...
    async reorderQuestions() {
        await this.waitFor(this.orm.webResequence("slide.question", this.getQuestionsIds(), { offset:1 }));
    ...
    onEditQuestionClick(ev) {
        ...
        const destroy = this.mountComponent(editedQuestionEl, WebsiteSlidesCourseQuizQuestionForm, {
            question,
            update: true,
            onSave: (renderedQuestion) => {
