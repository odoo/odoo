        ...
        */
        ...
        _renderSlide: function () {
            ...
            if (['document', 'infographic'].includes(slide.category)) {
                $content.html(renderToElement('website.slides.fullscreen.content', {widget: this}));
                ...
                $content.html(renderToElement('website.slides.fullscreen.video.google_drive', {widget: this}));
