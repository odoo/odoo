...
var addSection = function (sectionName, backend = false) {
    ...
    return [
        ...
        },
        {
            ...
            trigger:
                prefix + 'div.o_wslides_slide_list_category_header:contains("' + sectionName + '")',
            run: "click",
        },
    ];
};
...
const clickOnAddTagDropdown = (prefix) => [
    ...
    {
        content: "Wait dropdown items are loaded",
        trigger: `${prefix} .o_popover:has(.o_select_menu_item)`,
    },
];
...
var addNewCourseTag = function (courseTagName, backend) {
    ...
    return [
        ...clickOnAddTagDropdown(prefix),
        {
            ...
            trigger: prefix + ".o_popover .o_select_menu_searchbox input",
            run: "edit 123",
        },
        {
