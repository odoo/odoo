...
class Channel(models.Model):
    ...
    description_card = fields.Text(translate=True) # The description that is displayed on the course card.
    ...
    def create(self, vals):
        ...
        if not vals.get('description_card') and vals.get('description'):
            vals['description_card'] = vals['description']
    ...
    def write(self, vals):
        # If description_card wasn't manually modified, there is an implicit link between this field and description.
        if vals.get('description') and self.description == self.description_card:
            vals['description_card'] = vals.get('description')
