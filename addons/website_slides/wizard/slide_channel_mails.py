...
class ElearningMails(models.TransientModel):
    _name = 'elearning.mails'
    _description = 'Mass mails course'
    ...
    # recipients
    partner_ids = fields.Many2many('res.partner', related="channel_id.partner_ids", string='Recipients', required=True)
    ...
    def create(self, values):
        ...
        return super(ElearningMails, self).create(values)
