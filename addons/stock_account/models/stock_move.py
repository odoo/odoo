...
class StockMove(models.Model):
    ...
    def _generate_valuation_lines_data(self, partner_id, qty, debit_value, credit_value, debit_account_id, credit_account_id, description):
        ...
        def get_credit_debit_from_value(amount):
            if self.env.context.get('is_returned') and self.env.company.account_storno:
        ...
        debit_line_vals = {
            ...
            'debit': get_credit_debit_from_value(debit_value),
            'credit': get_credit_debit_from_value(-debit_value),
        ...
        credit_line_vals = {
            ...
            'ref': description,
            'partner_id': partner_id,
            'credit': get_credit_debit_from_value(credit_value),
            'debit': get_credit_debit_from_value(-credit_value),
        ...
        if credit_value != debit_value:
            ...
            rslt['price_diff_line_vals'] = {
                ...
                'ref': description,
                'partner_id': partner_id,
                'credit': get_credit_debit_from_value(diff_amount),
                'debit': get_credit_debit_from_value(-diff_amount),
