...
class StockValuationReport(models.AbstractModel):
    ...
    def _get_report_data(self, date=False, product_category=False, warehouse=False):
        ...
        accounts_by_product = company._get_accounts_by_product(products=products_with_qty)
        ...
        if not date:
            ...
            inventory_data = company.stock_value(accounts_by_product_with_qty, at_date=date)
