...
class TestStockValuation(TestStockValuationBase):
    ...
    def test_scrap_reception_valuation(self):
        ...
        receipt.button_validate()
        scrap_form = Form(self.env['stock.move.line'].with_context(default_picking_id=receipt.id, default_company_id=self.env.company.id), view='stock.view_scrap_move_line_form2')
