...
class TestStockValuation(TestStockValuationCommon):
    ...
    def test_average_automated_with_cost_change(self):
        ...
        move1 = self._make_out_move(product, 10)
