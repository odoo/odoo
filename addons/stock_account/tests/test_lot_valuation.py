...
class TestLotValuation(TestStockValuationCommon):
    ...
    def test_lot_normal_1(self):
        ...
        self.assertEqual(self.lot1.stock_valuation_layer_ids.lot_id, self.lot1)
        ...
        self.assertEqual(self.lot2.stock_valuation_layer_ids.lot_id, self.lot2)
        ...
        self.assertEqual(self.lot3.stock_valuation_layer_ids.lot_id, self.lot3)
