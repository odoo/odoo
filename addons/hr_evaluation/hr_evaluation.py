    ...
    def write(self, cr, uid, ids, vals, context=None):
        if vals.get('employee_id'):
            ...
            if employee_id.parent_id and employee_id.parent_id.user_id:
                message_follower_ids = vals.get('message_follower_ids') or []  # webclient can send None or False
                message_follower_ids += self.env['mail.followers']._add_follower_command(self._name, ids, {employee_id.parent_id.user_id.partner_id.id: None}, {}, force=True)[0]
