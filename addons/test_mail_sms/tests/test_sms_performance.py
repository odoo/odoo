...
class TestSMSMassPerformance(BaseMailPerformance, sms_common.MockSMS):
    ...
    def test_sms_composer_mass(self):
        ...
        with self.mockSMSGateway(sms_allow_unlink=True), self.assertQueryCount(employee=9):
    ...
    def test_sms_composer_mass_w_log(self):
        ...
        with self.mockSMSGateway(sms_allow_unlink=True), self.assertQueryCount(employee=12):
            composer.action_send_sms()
