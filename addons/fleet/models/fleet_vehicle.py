...
class FleetVehicle(models.Model):
    ...
    power = fields.Float('Power', help='Power in kW of the vehicle', compute='_compute_model_fields', store=True, readonly=False)
    ...
    co2_emission_unit = fields.Selection([('g/km', 'g/km'), ('g/mi', 'g/mi')], compute='_compute_model_fields',
        store=True, readonly=False, default="g/km", required=True)
