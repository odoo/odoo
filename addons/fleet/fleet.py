...
class fleet_vehicle_model(osv.Model):
    ...
    _columns = {
        ...
        'image_medium': fields.related('brand_id', 'image_medium', type="binary", string="Medium Logo"),
        'image_small': fields.related('brand_id', 'image_small', type="binary", string="Small Logo"),
    }
...
class fleet_vehicle(osv.Model):
    ...
    _columns = {
        ...
        'image_medium': fields.related('model_id', 'image_medium', type="binary", string="Medium Logo"),
        'image_small': fields.related('model_id', 'image_small', type="binary", string="Small Logo"),
