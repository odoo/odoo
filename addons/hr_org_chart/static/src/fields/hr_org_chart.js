...
export class HrOrgChart extends Component {
    ...
    async setup() {
        ...
        useRecordObserver(async (record) => {
            ...
            let new_parent_id = record.data.parent_id?.[0] || false;
            if(this.lastParent !== new_parent_id){
                await this.fetchEmployeeData(this.state.employee_id, new_parent_id, true);
            }
            this.lastParent = new_parent_id;
        })
    }
