            ...
            for so_line in so_lines:
                ...
                for stock_move in so_line.move_ids:
                    ...
                    def get_expected_qty_to_ship_later():
                        ...
                        if pos_pickings and all(pos_picking.state == 'confirmed' for pos_picking in pos_pickings):
                    ...
                    qty_delivered_or_to_be_delivered = max(so_line.qty_delivered, get_expected_qty_to_ship_later())
                    new_qty = so_line.product_uom_qty - qty_delivered_or_to_be_delivered
