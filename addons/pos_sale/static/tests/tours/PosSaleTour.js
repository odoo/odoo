...
registry.category("web_tour.tours").add("PosSettleOrder2", {
    ...
    steps: () =>
        [
            ...
            ProductScreen.clickQuotationButton(),
            ProductScreen.selectFirstOrder(),
            ProductScreen.clickOrderline("[A001] Product A", "1"),
            ProductScreen.selectedOrderlineHas("[A001] Product A", "1.00"),
            ProductScreen.clickOrderline("[A002] Product B", "1"),
            ProductScreen.pressNumpad("Qty", "0"),
            ProductScreen.selectedOrderlineHas("[A002] Product B", "0.00"),
            ProductScreen.clickPayButton(),
            PaymentScreen.clickPaymentMethod("Bank"),
