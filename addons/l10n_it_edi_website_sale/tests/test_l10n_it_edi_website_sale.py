...
class TestUi(HttpCase):
    def setUp(self):
        ...
        self.website.company_id.account_fiscal_country_id = self.website.company_id.country_id = self.env.ref('base.it')
    ...
    def test_public_user_codice_fiscale(self):
        ...
        self.assertEqual(new_partner.l10n_it_codice_fiscale, '12345670017', "The new partner should have the Codice Fiscale filled according to the VAT")
