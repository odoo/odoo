...
class TestSaleProject(HttpCase, TestSaleProjectCommon):
    ...
    def test_sale_order_with_project_task(self):
        ...
        self.assertEqual(
            ...
            "Task name in global project should include SO name and the single-line description.",
        )
        self.assertFalse(
            so_line_order_task_in_global.task_id.description,
            "Task description should be empty for single-line descriptions."
        )
        #  service_tracking 'task_in_project'
        ...
        self.assertEqual(
            ...
            "Description for new project task.",
            "Task name should be the single-line description.",
        )
        self.assertFalse(
