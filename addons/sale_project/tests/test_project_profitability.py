        ...
        self.assertDictEqual(
            self.project._get_profitability_items(False)['revenues'],
            {
                'data': [{
                    ...
                    'invoiced': 2 * (
                                self.product_a.standard_price + self.product_b.standard_price) * analytic_contribution,
                }],
                'total': {
                    'to_invoice': NEG_AMOUNT * analytic_contribution,
                    'invoiced': 2 * (
        ...
        self.assertDictEqual(
            self.project._get_profitability_items(False)['revenues'],
            {
                'data': [{
                    ...
                    'to_invoice': 0.0,
                    'invoiced': (2 * (
                                self.product_a.standard_price + self.product_b.standard_price) + NEG_AMOUNT) * analytic_contribution,
                }],
                'total': {
                    'to_invoice': 0.0,
                    'invoiced': (2 * (
