...
class ProjectTask(models.Model):
    ...
    @api.depends('sale_line_id', 'project_id', 'allow_billable', 'project_id.reinvoiced_sale_order_id', 'project_id.sale_order_id', 'project_id.reinvoiced_sale_order_id.state')
    def _compute_sale_order_id(self):
        for task in self:
            ...
            sale_order = (
                ...
                or (task.project_id.reinvoiced_sale_order_id.state not in ['draft', 'sent'] and task.project_id.reinvoiced_sale_order_id)
