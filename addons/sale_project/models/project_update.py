...
class ProjectUpdate(models.Model):
    ...
    def _create_service_dict(self, sol, company_uom, product_uom_unit):
    ...
    def _get_common_services_values(self, project, company_uom):
        ...
        services = [
            self._create_service_dict(sol, company_uom, product_uom_unit)
            for sol in sols
            if sol.product_uom.category_id == company_uom.category_id or sol.product_uom == product_uom_unit
        ]
        return services
