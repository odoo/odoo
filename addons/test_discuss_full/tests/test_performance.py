    ...
    def test_init_messaging(self):
        ...
        self.assertEqual(init_messaging, {
            ...
            'channels': [
                {
                    ...
                    'is_minimized': False,
                    'is_pinned': True,
                    'last_meaningful_action_time': channel_general.channel_last_seen_partner_ids.filtered(lambda p: p.partner_id == self.users[0].partner_id).last_meaningful_action_time.strftime(DEFAULT_SERVER_DATETIME_FORMAT),
                ...
                },
                {
                    ...
                    'is_minimized': False,
                    'is_pinned': True,
                    'last_meaningful_action_time': channel_public_1.channel_last_seen_partner_ids.filtered(lambda p: p.partner_id == self.users[0].partner_id).last_meaningful_action_time.strftime(DEFAULT_SERVER_DATETIME_FORMAT),
                    ...
                    'name': 'public 1',
                    'public': 'public',
                    'seen_message_id': next(res['message_id'] for res in channel_public_1._channel_last_message_ids()),
                    'state': 'open',
                ...
                },
                {
                    ...
                    'is_minimized': False,
                    'is_pinned': True,
                    'last_meaningful_action_time': channel_public_2.channel_last_seen_partner_ids.filtered(lambda p: p.partner_id == self.users[0].partner_id).last_meaningful_action_time.strftime(DEFAULT_SERVER_DATETIME_FORMAT),
                    'last_message_id': next(res['message_id'] for res in channel_public_2._channel_last_message_ids()),
                    'message_needaction_counter': 0,
                    'message_unread_counter': 0,
                    'name': 'public 2',
                    'public': 'public',
                    'seen_message_id': next(res['message_id'] for res in channel_public_2._channel_last_message_ids()),
                    'state': 'open',
                ...
                },
                {
                    ...
                    'is_minimized': False,
                    'is_pinned': True,
                    'last_meaningful_action_time': channel_group_1.channel_last_seen_partner_ids.filtered(lambda p: p.partner_id == self.users[0].partner_id).last_meaningful_action_time.strftime(DEFAULT_SERVER_DATETIME_FORMAT),
                    'last_message_id': next(res['message_id'] for res in channel_group_1._channel_last_message_ids()),
                    'message_needaction_counter': 0,
                    'message_unread_counter': 0,
                    'name': 'group 1',
                    'public': 'groups',
                    'seen_message_id': next(res['message_id'] for res in channel_group_1._channel_last_message_ids()),
                    'state': 'open',
                ...
                },
                {
                    ...
                    'is_minimized': False,
                    'is_pinned': True,
                    'last_meaningful_action_time': channel_group_2.channel_last_seen_partner_ids.filtered(lambda p: p.partner_id == self.users[0].partner_id).last_meaningful_action_time.strftime(DEFAULT_SERVER_DATETIME_FORMAT),
                    'last_message_id': next(res['message_id'] for res in channel_group_2._channel_last_message_ids()),
                    'message_needaction_counter': 0,
                    'message_unread_counter': 0,
                    'name': 'group 2',
                    'public': 'groups',
                    'seen_message_id': next(res['message_id'] for res in channel_group_2._channel_last_message_ids()),
                    'state': 'open',
                ...
                },
                {
                    ...
                    'is_minimized': False,
                    'is_pinned': True,
                    'last_meaningful_action_time': channel_private_1.channel_last_seen_partner_ids.filtered(lambda p: p.partner_id == self.users[0].partner_id).last_meaningful_action_time.strftime(DEFAULT_SERVER_DATETIME_FORMAT),
                    'last_message_id': next(res['message_id'] for res in channel_private_1._channel_last_message_ids()),
                    'message_needaction_counter': 0,
                    'message_unread_counter': 0,
                    'name': 'private 1',
                    'public': 'private',
                    'seen_message_id': next(res['message_id'] for res in channel_private_1._channel_last_message_ids()),
                    'state': 'open',
                ...
                },
                {
                    ...
                    'is_minimized': False,
                    'is_pinned': True,
                    'last_meaningful_action_time': channel_private_2.channel_last_seen_partner_ids.filtered(lambda p: p.partner_id == self.users[0].partner_id).last_meaningful_action_time.strftime(DEFAULT_SERVER_DATETIME_FORMAT),
                    'last_message_id': next(res['message_id'] for res in channel_private_2._channel_last_message_ids()),
                    'message_needaction_counter': 0,
                    'message_unread_counter': 0,
                    'name': 'private 2',
                    'public': 'private',
                    'seen_message_id': next(res['message_id'] for res in channel_private_2._channel_last_message_ids()),
                    'state': 'open',
                ...
                },
                {
                    ...
                    'is_minimized': False,
                    'is_pinned': True,
                    'last_meaningful_action_time': channel_dm_1.channel_last_seen_partner_ids.filtered(lambda p: p.partner_id == self.users[0].partner_id).last_meaningful_action_time.strftime(DEFAULT_SERVER_DATETIME_FORMAT),
                ...
                },
                {
                    ...
                    'is_minimized': False,
                    'is_pinned': True,
                    'last_meaningful_action_time': channel_dm_2.channel_last_seen_partner_ids.filtered(lambda p: p.partner_id == self.users[0].partner_id).last_meaningful_action_time.strftime(DEFAULT_SERVER_DATETIME_FORMAT),
                    'last_message_id': False,
                    'members': [
                        {
                            'active': True,
                ...
                },
                {
                    ...
                    'is_minimized': False,
                    'is_pinned': True,
                    'last_meaningful_action_time': channel_dm_3.channel_last_seen_partner_ids.filtered(lambda p: p.partner_id == self.users[0].partner_id).last_meaningful_action_time.strftime(DEFAULT_SERVER_DATETIME_FORMAT),
                    'last_message_id': False,
                    'members': [
                        {
                            'active': True,
                ...
                },
                {
                    ...
                    'is_minimized': False,
                    'is_pinned': True,
                    'last_meaningful_action_time': channel_dm_4.channel_last_seen_partner_ids.filtered(lambda p: p.partner_id == self.users[0].partner_id).last_meaningful_action_time.strftime(DEFAULT_SERVER_DATETIME_FORMAT),
                    'last_message_id': False,
                    'members': [
                        {
                            'active': True,
                ...
                },
                {
                    ...
                    'is_minimized': False,
                    'is_pinned': True,
                    'last_meaningful_action_time': channel_livechat_1.channel_last_seen_partner_ids.filtered(lambda p: p.partner_id == self.users[0].partner_id).last_meaningful_action_time.strftime(DEFAULT_SERVER_DATETIME_FORMAT),
                ...
                },
                {
                    ...
                    'is_minimized': False,
                    'is_pinned': True,
                    'last_meaningful_action_time': channel_livechat_2.channel_last_seen_partner_ids.filtered(lambda p: p.partner_id == self.users[0].partner_id).last_meaningful_action_time.strftime(DEFAULT_SERVER_DATETIME_FORMAT),
            ...
            'current_user_settings': {
                'id': self.env['mail.user.settings'].find_or_create_for_user(self.users[0]).id,
