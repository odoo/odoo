            ...
            'Thread': [
                ...
                },
                {
                    ...
                    'channelMembers': [('ADD', sorted([{
                        ...
                        'seenMessage': {'id': next(res['message_id'] for res in self.channel_channel_public_1._channel_last_message_ids())},
                    }], key=lambda member_data: member_data['id']))],
                    'custom_channel_name': False,
                    'id': self.channel_channel_public_1.id,
                    'memberCount': 5,
                ...
                },
                {
                    ...
                    'channelMembers': [('ADD', sorted([{
                        ...
                        'seenMessage': {'id': next(res['message_id'] for res in self.channel_channel_public_2._channel_last_message_ids())},
                    }], key=lambda member_data: member_data['id']))],
                    'custom_channel_name': False,
                    'id': self.channel_channel_public_2.id,
                    'memberCount': 5,
                ...
                },
                {
                    ...
                    'channelMembers': [('ADD', sorted([{
                        ...
                        'seenMessage': {'id': next(res['message_id'] for res in self.channel_channel_group_1._channel_last_message_ids())},
                    }], key=lambda member_data: member_data['id']))],
                    'custom_channel_name': False,
                    'id': self.channel_channel_group_1.id,
                    'memberCount': 5,
                ...
                },
                {
                    ...
                    'channelMembers': [('ADD', sorted([{
                        ...
                        'seenMessage': {'id': next(res['message_id'] for res in self.channel_channel_group_2._channel_last_message_ids())},
                    }], key=lambda member_data: member_data['id']))],
                    'custom_channel_name': False,
                    'id': self.channel_channel_group_2.id,
                    'memberCount': 5,
                ...
                },
                {
                    ...
                    'channelMembers': [('ADD', sorted([
                        ...
                        },
                        {
                            ...
                            'seenMessage': {'id': next(res['message_id'] for res in self.channel_livechat_1._channel_last_message_ids())},
                        },
                    ], key=lambda member_data: member_data['id']))],
                    'custom_channel_name': False,
                    'id': self.channel_livechat_1.id,
                ...
                },
                {
                    ...
                    'channelMembers': [('ADD', [
                        ...
                        },
                        {
                            ...
                            'fetched_message_id': {'id': next(res['message_id'] for res in self.channel_livechat_2._channel_last_message_ids())},
                            'seenMessage': {'id': next(res['message_id'] for res in self.channel_livechat_2._channel_last_message_ids())},
                        },
                    ])],
                    'custom_channel_name': False,
                    'id': self.channel_livechat_2.id,
