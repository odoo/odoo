...
class MaintenanceRequest(models.Model):
    ...
    def write(self, vals):
        ...
        for request in self:
            if 'stage_id' in vals and request.maintenance_type == 'preventive' and request.recurring_maintenance and request.env['maintenance.stage'].browse(vals['stage_id']).done:
