...
class Ewaybill(models.Model):
    ...
    def _compute_display_name(self):
        ...
        super(Ewaybill, self - challan)._compute_display_name()
    ...
    def _get_ewaybill_document_details(self):
        ...
        if picking_id := self.picking_id:
            return {
                ...
                'document_date': picking_id.date_done  # TODO check for challan that replacing schedule date?
            }
