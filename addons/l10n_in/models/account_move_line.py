...
class AccountMoveLine(models.Model):
    ...
    def _compute_l10n_in_gstr_section(self):
        ...
        def is_b2b_rcm(line):
            return (
                is_invoice_or_bill(line.move_id) and
        ...
        def is_b2cl(line):
            return (
                ...
                line.move_id.amount_total > 100000
            )
        ...
        def is_b2cs(line):
            return (
                ...
                (get_transaction_type(line.move_id) == 'inter_state' and
                    (is_invoice_or_bill(line.move_id) and line.move_id.amount_total <= 100000) or
                    (line.move_id.debit_origin_id and line.move_id.debit_origin_id.amount_total <= 100000) or
        ...
        def is_cdnr_rcm(line):
            return (
                not is_invoice_or_bill(line.move_id) and
                line.move_id.l10n_in_gst_treatment in ('regular', 'composition', 'uin_holders') and
                has_tags('gst_rc')
            )
        ...
        def is_cdnur_b2cl(line):
            return (
                ...
                (
                    (line.move_id.debit_origin_id and line.move_id.debit_origin_id.amount_total > 100000) or
                    (line.move_id.reversed_entry_id and line.move_id.reversed_entry_id.amount_total > 100000) or
        ...
        def is_cdnur_exp_wop(line):
            return (
                not is_invoice_or_bill(line.move_id) and
                line.move_id.l10n_in_gst_treatment == 'overseas' and
                has_tags(tax_tags_ids['igst_lut'])
            )

        indian_moves_lines = self.filtered(lambda l: l.move_id.country_code == 'IN' and l.move_id.move_type != 'entry' and l.parent_state == 'posted')
