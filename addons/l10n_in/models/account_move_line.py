    ...
    def _compute_l10n_in_gstr_section(self):
        ...
        def is_b2cs(line):
            return (
                ...
                (get_transaction_type(line.move_id) == 'inter_state' and
                    (is_invoice(line.move_id) and line.move_id.amount_total <= 100000) or
        ...
        tax_tags_ids = get_l10n_in_tax_tag_ids()
