...
class ResPartner(models.Model):
    ...
    def _compute_l10n_in_gst_registered_and_status(self):
        for record in self:
            ...
            is_fiscal_country_in = "IN" in record.fiscal_country_codes
            is_company_country_in = record.company_id and record.company_id.country_code == 'IN'

            record.l10n_in_is_gst_registered_enabled = (
                record.company_id.l10n_in_is_gst_registered
                if is_company_country_in else is_fiscal_country_in and company.l10n_in_is_gst_registered
            )
            record.l10n_in_gstin_status_feature_enabled = (
                record.company_id.l10n_in_gstin_status_feature
                if is_company_country_in else is_fiscal_country_in and company.l10n_in_gstin_status_feature
            )
    ...
    def onchange_company_type(self):
        ...
        if self.country_id and self.company_id.l10n_in_is_gst_registered and self.country_id.code == 'IN':
    ...
    def _onchange_country_id(self):
        ...
        elif self.country_id and self.company_id.l10n_in_is_gst_registered and self.country_id.code == 'IN':
            self.l10n_in_gst_treatment = (self.company_type == 'company') and 'regular' or 'consumer'
        return res
