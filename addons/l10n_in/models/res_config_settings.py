...
class ResConfigSettings(models.TransientModel):
    ...
    l10n_in_gst_api_feature = fields.Boolean(related='company_id.l10n_in_gst_api_feature', readonly=False)
    # Automatically set to True if either l10n_in_gst_efiling_feature or l10n_in_gst_api_feature is activated.
    ...
    # ENet Batch Payment
    l10n_in_enet_batch_payment_feature = fields.Boolean(related='company_id.l10n_in_enet_batch_payment_feature', readonly=False)

    def set_values(self):
        super().set_values()
        if self.country_code == 'IN':
            if not self.module_l10n_in_reports and (self.l10n_in_gst_api_feature or self.l10n_in_gst_efiling_feature or self.l10n_in_enet_batch_payment_feature):
