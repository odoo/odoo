    ...
    def _compute_fiscal_position_id(self):
        ...
        for move in in_moves:
            ...
            if move.l10n_in_state_id.l10n_in_tin == '96': # Foreign Country
                ...
                dummy_state_id = foreign_state

            # In sale place of supply compare with company state
            elif move.is_sale_document(include_receipts=True):
                dummy_state_id = move.l10n_in_state_id

            # In purchase place of supply compare with vendor state
            elif (
                ...
                elif pos_state_id != move.partner_id.state_id == move.company_id.state_id:
