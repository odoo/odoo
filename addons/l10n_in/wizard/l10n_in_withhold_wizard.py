    ...
    def _compute_tax_id(self):
        for wizard in self:
            ...
            for line in wizard.related_move_id.line_ids:
                section_id = line.account_id.l10n_in_tds_tcs_section_id
                if section_id in sections:
                    accounts_by_section[section_id] = line.account_id
            ...
            for section, account in accounts_by_section.items():
                if not tax_id:
                    ...
                    withhold_move_line_id = self.env['account.move.line'].search([
                        ('move_id.l10n_in_withholding_ref_move_id.commercial_partner_id.l10n_in_pan_entity_id', '=', wizard.related_move_id.partner_id.commercial_partner_id.l10n_in_pan_entity_id.id),
