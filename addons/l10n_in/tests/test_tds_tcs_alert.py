...
class TestTdsTcsAlert(L10nInTestInvoicingCommon):
    ...
    def _create_invoice(self, move_type=None, partner=None, invoice_date=None, amounts=None, taxes=[], company=None, accounts=[], quantities=[]):
