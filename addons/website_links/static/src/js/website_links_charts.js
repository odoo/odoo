...
publicWidget.registry.websiteLinksCharts = publicWidget.Widget.extend({
    ...
    start: async function () {
        ...
        return Promise.all(defs).then(function (results) {
            ...
            var _clicksByDay = results[1].groups;
            var _clicksByCountry = results[2].groups;
            var _lastWeekClicksByCountry = results[3].groups;
            var _lastMonthClicksByCountry = results[4].groups;
