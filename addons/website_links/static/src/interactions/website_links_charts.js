...
class WebsiteLinksCharts extends Interaction {
    ...
    dynamicContent = {
        ...
        "#all_time_countries_charts .title": {
            "t-out": () =>
                `${this.pieChartsData.all_time_countries_charts.numCountries} ${_t("countries")}`,
        },
        "#last_month_countries_charts .title": {
            "t-out": () =>
                `${this.pieChartsData.last_month_countries_charts.numCountries} ${_t("countries")}`,
        },
        "#last_week_countries_charts .title": {
            "t-out": () =>
                `${this.pieChartsData.last_week_countries_charts.numCountries} ${_t("countries")}`,
        },
