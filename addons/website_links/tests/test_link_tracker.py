...
class TestLinkTracker(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.company_2.write({'website_id': cls.website_2.id})
    ...
    def test_compute_short_url_host(self):
        ...
        self.assertTrue(link_1.short_url, "Short URL should be generated")
        ...
        self.assertTrue(link_2.short_url, "Short URL should be generated")
        self.assertTrue(link_2.short_url.startswith(self.website_2.domain),
            "hort URL should use company 1 website domain"
        )
