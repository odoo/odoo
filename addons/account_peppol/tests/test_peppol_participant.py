...
class TestPeppolParticipant(TransactionCase):
    ...
    def _request_handler(cls, s: Session, r: PreparedRequest, /, **kw):
        ...
        if r.url.endswith('/iso6523-actorid-upis%3A%3A9925%3ABE0482376248') or r.url.endswith('/iso6523-actorid-upis%3A%3A9925%3Abe0482376248'):
            # 9925:BE0482376248 is not on Peppol
            response.status_code = 404
            return response

        if r.url.endswith('/iso6523-actorid-upis%3A%3A0208%3A0482376248'):
            # 0208:0482376248 is on Peppol
            response._content = b'<?xml version=\'1.0\' encoding=\'UTF-8\'?>\n<smp:ServiceGroup xmlns:wsa="http://www.w3.org/2005/08/addressing" xmlns:id="http://busdox.org/transport/identifiers/1.0/" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:smp="http://busdox.org/serviceMetadata/publishing/1.0/"><id:ParticipantIdentifier scheme="iso6523-actorid-upis">0208:0482376248</id:ParticipantIdentifier></smp:ServiceGroup>'
            return response
    ...
    def test_create_success_sender(self):
        ...
        vals['peppol_endpoint'] = '0482376248'
    ...
    def test_config_unregister_participant(self):
        wizard = self.env['peppol.registration'].create({**self._get_participant_vals(), 'peppol_eas': '0208', 'peppol_endpoint': '0482376248'})
        wizard.button_register_peppol_participant()
