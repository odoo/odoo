...
from odoo.addons.account_peppol.models.res_company import peppol_canary_feature
...
class TestPeppolParticipant(TransactionCase):
    ...
    def test_canary_features(self):
        ...
        @peppol_canary_feature('shiny_new_feature', expected_kwargs=('arg1', 'arg2'))
        ...
        @peppol_canary_feature('shiny_new_feature', expected_kwargs=('non_existing_arg',))
        ...
        @peppol_canary_feature('non_existing_feature', expected_kwargs=())
    ...
    def test_peppol_canary_handles_empty_metadata(self):
        ...
        @peppol_canary_feature('proactive_peppol_prompt_countries', expected_kwargs=('country_codes',))
