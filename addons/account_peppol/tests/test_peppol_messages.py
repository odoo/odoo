...
class TestPeppolMessage(TestAccountMoveSendCommon):
    ...
    def test_validate_partner(self):
        ...
        self.assertRecordValues(
            new_partner, [{
                'account_peppol_verification_state': 'not_verified',
                'peppol_eas': '0208',
        ...
        self.assertRecordValues(
            new_partner, [{
                'account_peppol_verification_state': 'valid',  # should validate automatically
                'peppol_eas': '0208',
                'peppol_endpoint': '0477472701',
            }])
        ...
        self.assertRecordValues(
            new_partner, [{
                'account_peppol_verification_state': 'not_valid',
                'peppol_eas': '0208',
                'peppol_endpoint': '3141592654',
            }])

        new_partner.ubl_cii_format = False
        self.assertEqual(new_partner.account_peppol_verification_state, 'not_verified')
        ...
        self.assertRecordValues(
            new_partner, [{
                'account_peppol_verification_state': 'not_valid_format',
                'peppol_eas': '0208',
                'peppol_endpoint': '0477472701',
            }])
