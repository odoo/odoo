...
class AccountPeppolResponse(models.Model):
    ...
    handler_id = fields.Many2one('account.peppol.response.handler', ondelete='cascade', index='btree_not_null')
    company_id = fields.Many2one(related='handler_id.company_id')
