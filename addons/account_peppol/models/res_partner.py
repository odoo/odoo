...
class ResPartner(models.Model):
    ...
    def _check_document_type_support(self, participant_info, ubl_cii_format):
        ...
        document_type = self._get_customization_ids()[ubl_cii_format]
    ...
    # TODO: diff was a bit bad when copying the following fields in the right place above
    ...
    def _get_peppol_edi_format(self):
        ...
        if self.ubl_cii_format == 'ubl_a_nz':
            return self.env.ref('account_edi_ubl_cii.ubl_a_nz', raise_if_not_found=False)
        if self.ubl_cii_format == 'ubl_sg':
            return self.env.ref('account_edi_ubl_cii.ubl_sg', raise_if_not_found=False)
