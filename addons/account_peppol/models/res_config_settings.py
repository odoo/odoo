...
class ResConfigSettings(models.TransientModel):
    ...
    account_peppol_edi_user = fields.Many2one(related='company_id.account_peppol_edi_user', string='EDI user')
    ...
    def action_open_peppol_form(self):
        registration_wizard = self.env['peppol.registration'].create({'selected_company_id': self.company_id.id})
    ...
    def button_peppol_disconnect_branch_from_parent(self):
        ...
        self.company_id.peppol_parent_company_id = False
        return {
