...
class ResCompany(models.Model):
    ...
    def _get_active_peppol_parent_company(self):
        ...
        while parent_company and parent_company.sudo().account_peppol_proxy_state in ('not_registered', 'rejected'):
            # sudo needed in case the user does not have access to the parent company
