...
def peppol_canary_feature(code: str, /, *, expected_kwargs=()):
...
class ResCompany(models.Model):
    ...
    @peppol_canary_feature('rate_limiting_ui', expected_kwargs=('help_url',))
    ...
    @peppol_canary_feature('rate_limiting_ui')
