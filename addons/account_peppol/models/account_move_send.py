...
class AccountMoveSend(models.AbstractModel):
    ...
    def _get_alerts(self, moves, moves_data):
        ...
        if peppol_moves := moves.filtered(lambda m: moves_data[m]['sending_method'] == 'peppol'):
    ...
    def _hook_if_errors(self, moves_data, allow_raising=True):
        ...
        for move, move_data in moves_data.items():
            if move_data['sending_method'] == 'peppol' and move_data.get('blocking_error'):
    ...
    def _call_web_service_after_invoice_pdf_render(self, invoices_data):
        ...
        for invoice, invoice_data in invoices_data.items():
            if invoice_data['sending_method'] == 'peppol' and self._is_applicable_to_move('peppol', invoice):
