...
class AccountEdiFormat(models.Model):
    ...
    # TODO: maybe add a field to state the "real" format; for upgrade; or deducing from filename enough?
    #       or do sth. in `_peppol_post_invoice`
    ...
    def _get_move_applicability(self, move):
        ...
        if peppol_edi_format and move.move_type in ('out_invoice', 'out_refund'):
