...
class PeppolRegistration(models.TransientModel):
    ...
    # Fields to determine if the company is registering as itself or through the parent company.
    ...
    @api.depends('peppol_eas', 'peppol_endpoint', 'use_parent_connection', 'smp_registration', 'peppol_external_provider')
