...
class AccountPaymentRegister(models.TransientModel):
    ...
    l10n_account_wth_outstanding_account = fields.Many2one(
        ...
        check_company=True,
        compute="_compute_l10n_account_wth_outstanding_account",
        store=True,
        readonly=False,
    )
    ...
    def _compute_l10n_account_wth_outstanding_account(self):
        ...
        for wizard in self:
            ...
            if wizard.l10n_account_wth_payment_account_id or not latest_payment:
                wizard.l10n_account_wth_outstanding_account = False  # we'll use the payment method one.
            else:
                wizard.l10n_account_wth_outstanding_account = latest_payment[0]['outstanding_account_id'][0]
    ...
    def _create_payment_vals_from_wizard(self, batch_result):
        ...
        if self.l10n_account_wth_outstanding_account:
            payment_vals['outstanding_account_id'] = self.l10n_account_wth_outstanding_account.id
        ...
        for withholding_line in self.l10n_account_wth_line_ids:
            ...
            if not withholding_line.name:
                if withholding_line.tax_id.l10n_account_wth_sequence_id:
        ...
        for base_amount, withholding_lines in self.l10n_account_wth_line_ids.grouped('base_amount').items():
