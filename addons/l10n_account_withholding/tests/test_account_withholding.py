...
class TestL10nAccountWithholdingTaxes(AccountTestInvoicingCommon):
    ...
    def _register_payment(self, create_vals=None, enable_withholding=False, with_default_line=False):
        ...
        if enable_withholding or with_default_line:
            wizard.l10n_account_withholding_withhold_tax = True
            if with_default_line:
                wizard.l10n_account_withholding_line_ids = [
                    Command.create({
    ...
    def test_withholding_tax_on_payment(self):
        ...
        self.assertFalse(payment_register.l10n_account_withholding_withhold_tax)
        # We enable the withholding
        payment_register.l10n_account_withholding_withhold_tax = True
        # We add a tax.
    ...
    def test_withholding_tax_before_payment(self):
        ...
        payment_register.l10n_account_withholding_line_ids[0].base_amount = 1000
        # The amount on the tax line should have been computed. The net amount too.
        self.assertEqual(payment_register.l10n_account_withholding_line_ids[0].amount, 1000 * 0.01)
    ...
    def test_withholding_not_payment_account_on_method_line(self):
        ...
        payment_register = self._register_payment(
            create_vals={'l10n_account_withholding_outstanding_account': self.outstanding_account.id},
    ...
    def test_withholding_tax_multiple_base(self):
        ...
        payment_register.l10n_account_withholding_line_ids[1].full_base_amount = 550
        action = payment_register.action_create_payments()
        payment = self.env['account.payment'].browse(action['res_id'])
