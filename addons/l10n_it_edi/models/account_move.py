...
class AccountMove(models.Model):
    ...
    def _l10n_it_edi_get_extra_info(self, company, document_type, body_tree, incoming=True):
        ...
        if self._get_tag(body_tree, selector) is not None:
    ...
    @api.model
    def _get_tag(self, element, selector):
        if element is None:
            return None
    ...
    def _get_pension_fund_tax_for_line(self, element, extra_info):
        ...
        tax_rate_tag = self._get_tag(element, './/AliquotaIVA')
        ...
        reference_tag = self._get_tag(element, selector)
