...
class AccountMove(models.Model):
    ...
    def _prepare_fatturapa_export_values(self):
        ...
        seller = company.partner_id if not is_self_invoice else partner
        ...
        template_values = {
            ...
            'sender': company,
            'partner': partner,
            'buyer': partner if not is_self_invoice else company.partner_id,
            ...
            'codice_destinatario': partner.l10n_it_pa_index or (partner.country_id.code == 'IT' and '0000000') or 'XXXXXXX',
