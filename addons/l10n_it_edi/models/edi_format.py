...
class EdiFormat(models.Model):
    ...
    def _prepare_document_report(self, pdf_writer, edi_files):
        ...
        if edi_files.attachment_id:
            pdf_writer.embed_odoo_attachment(edi_files.attachment_id)
    ...
    def _l10n_it_edi_is_required_for_invoice(self, document, document_type):
        ...
        return (
            ...
            and document.l10n_it_send_state not in ('sent', 'delivered', 'delivered_accepted')
            and document.country_code == 'IT'
        )
    ...
    def _is_format_required(self, document, document_type=''):
        ...
        return self._l10n_it_edi_is_required_for_invoice(document, document_type)

    def _post_fattura_pa(self, flows):
        # TO OVERRIDE
        invoice = flows._get_documents()  # no batching ensure that we only have one invoice
