...
from .common import TestItEdi


@tagged("post_install_l10n", "post_install", "-at_install")
class TestItEdiImportPrediction(TestItEdi):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
                    ...
                    "invoice_line_ids": [
                        (
                            ...
                            0,
                            {
                                ...
                                "quantity": 1.0,
                                "tax_ids": [
                                    fields.Command.set([self.tax_purchase_c.id])
                                ],
                        ...
                        (
                            ...
                            0,
                            {
                                ...
                                "price_unit": 8.0,
                                "tax_ids": [
                                    fields.Command.set([self.tax_purchase_d.id])
                                ],
                                "account_id": self.predictable_account.id,
                            },
                        ),
    ...
    def test_receive_vendor_bill_with_prediction(self):
        ...
        self.company.account_config_id.predict_bill_product = True
    ...
    def test_receive_vendor_bill_without_product_prediction(self):
        self._create_predictable_invoice()
        self.company.account_config_id.predict_bill_product = False
