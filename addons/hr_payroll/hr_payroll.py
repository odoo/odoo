...
class hr_contract(osv.osv):
    ...
    _columns = {
        ...
        'schedule_pay': fields.selection([
            ...
            ], 'Scheduled Pay', size=13,  select=True),
    }
...
class hr_payslip_run(osv.osv):
    ...
    _columns = {
        ...
        'state': fields.selection([
            ('draft', 'Draft'),
            ('close', 'Close'),
        ], 'Status', select=True, size=6, readonly=True),
...
class hr_payslip(osv.osv):
    ...
    _columns = {
        ...
        'state': fields.selection([
            ...
            ('done', 'Done'),
            ('cancel', 'Rejected'),
        ], 'Status', size=6, select=True, readonly=True,
...
class hr_salary_rule(osv.osv):
    ...
    _columns = {
        ...
        'company_id':fields.many2one('res.company', 'Company', required=False),
        'condition_select': fields.selection([('none', 'Always True'),('range', 'Range'), ('python', 'Python Expression')], "Condition Based on", size=6, required=True),
        ...
        'amount_select':fields.selection([
            ...
            ('fix','Fixed Amount'),
            ('code','Python Code'),
        ],'Amount Type', size=10, select=True, required=True, help="The computation method for the rule amount."),
