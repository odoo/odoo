...
class mail_docsaway_settings(osv.osv_memory):
    ...
    def get_default_mail_docsaway(self, cr, uid, fields, context=None):
    ...
    def set_mail_docsaway(self, cr, uid, ids, context=None):
