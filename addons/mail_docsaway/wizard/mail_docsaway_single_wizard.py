...
class ConfirmDeliverySingleWizard(models.TransientModel):
    _name = 'mail_docsaway.single_wizard'
    _rec_name = 'pdf'

    wizard_id = fields.Many2one('mail_docsaway.multiple_wizard', "Wizard", default=False)
    wizard_customer_id = fields.Many2one('mail_docsaway.customer_wizard', "Wizard", default=False)
    mail_id = fields.Many2one('mail_docsaway.api', "Mail")
