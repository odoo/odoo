        ...
        def.then(function (livechatData) {
            if (!livechatData || !livechatData.operator_pid) {
                ...
                return self._openChatWindow().then(function () {
                    ...
                    utils.set_cookie('im_livechat_session', utils.unaccent(JSON.stringify(self._livechat.toData()), true), 60 * 60, 'required');
                    utils.set_cookie('im_livechat_auto_popup', JSON.stringify(false), 60 * 60, 'optional');
                    if (livechatData.operator_pid[0]) {
                        ...
                        utils.set_cookie('im_livechat_previous_operator_pid', operatorPidId, oneWeek, 'optional');
                    }
                });
            }
        }).then(function () {
