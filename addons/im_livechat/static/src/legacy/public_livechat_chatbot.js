 ...
 */
 LivechatButton.include({
     ...
     */
    _chatbotSaveSession() {
        localStorage.setItem('im_livechat.chatbot.state.uuid_' + this.messaging.livechatButtonView.livechat._uuid, JSON.stringify({
                ...
                this.messaging.livechatButtonView.chatWindow.$('.o_mail_thread_content').append(
                    $(QWeb.render('im_livechat.legacy.chatbot.is_typing_message', {
                        'chatbotImageSrc': `/im_livechat/operator/${
                            this.messaging.livechatButtonView.livechat._operatorPID[0]
                        }/avatar`,
    ...
    _chatbotShouldEndScript() {
        ...
        if (this.messaging.livechatButtonView.chatbot.currentStep.data.chatbot_step_is_last &&
            ...
            if (this.messaging.livechatButtonView.chatbot.currentStep.data.chatbot_step_type === 'question_email'
                ...
                if (lastMessage.getAuthorID() !== this.messaging.livechatButtonView.livechat._operatorPID[0]) {
    ...
    _isLastMessageFromCustomer() {
        ...
        return lastMessage && lastMessage.getAuthorID() !== this.messaging.livechatButtonView.livechat._operatorPID[0];
    },
