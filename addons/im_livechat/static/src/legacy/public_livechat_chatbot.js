 ...
 LivechatButton.include({
    ...
    async willStart() {
        ...
        if (this._rule && !!this._rule.chatbot) {
            this.messaging.update({ isPublicLivechatChatbot: true });
    ...
    _chatbotDisplayRestartButton() {
        return this.messaging.isPublicLivechatChatbot && (!this._chatbotCurrentStep ||
    ...
    async _sendMessage(message) {
        ...
        if (this.messaging.isPublicLivechatChatbot && this._chatbotCurrentStep) {
