...
export class ChatbotStepManager extends DiscussModelManager {
    /** @type {typeof ChatbotStep} */
    class;
    /** @type {Object.<string, ChatbotStep>} */
    records = {};
}

discussModelRegistry.add("ChatbotStep", [ChatbotStep, ChatbotStepManager]);
