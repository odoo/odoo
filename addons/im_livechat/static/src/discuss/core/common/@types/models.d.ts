declare module "models" {
    import { Chatbot as ChatbotClass } from "@im_livechat/discuss/core/common/chatbot_model";
    import { ChatbotScript as ChatbotScriptClass } from "@im_livechat/discuss/core/common/chatbot_script_model";
    import { ChatbotScriptStep as ChatbotScriptStepClass } from "@im_livechat/discuss/core/common/chatbot_script_step_model";
    import { ChatbotScriptStepAnswer as ChatbotScriptStepAnswerClass } from "@im_livechat/discuss/core/common/chatbot_script_step_answer_model";
    import { ChatbotStep as ChatbotStepClass } from "@im_livechat/discuss/core/common/chatbot_step_model";
    import { LivechatChannel as LivechatChannelClass } from "@im_livechat/discuss/core/common/livechat_channel_model";
    import { LivechatChannelRule as LivechatChannelRuleClass } from "@im_livechat/discuss/core/common/livechat_channel_rule_model";
    import { LivechatConversationTag as LivechatConversationTagClass } from "@im_livechat/discuss/core/common/livechat_conversation_tag_model";
    import { LivechatExpertise as LivechatExpertiseClass } from "@im_livechat/discuss/core/common/livechat_expertise_model";
