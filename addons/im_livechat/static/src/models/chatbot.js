...
registerModel({
    name: 'Chatbot',
    identifyingFields: ['publicLivechatOwner'],
    recordMethods: {
        /**
         * @private
         * @returns {boolean}
        ...
        _computeMessageDelay() {
            if (this.messaging.publicLivechatGlobal.livechatButtonView.isWebsiteLivechatChatbotFlow) {
                return 100;
            }
            return clear();
        },
    ...
    fields: {
        ...
        publicLivechatOwner: one('PublicLivechatGlobal', {
            inverse: 'chatbot',
            readonly: true,
            required: true,
        }),
