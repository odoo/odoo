...
QUnit.module("im_livechat", {}, function () {
    QUnit.module("components", {}, function () {
        ...
        QUnit.test(
            ...
            async function (assert) {
                ...
                await afterNextRender(() =>
                    document
                        .querySelector(
                            `.o_DiscussSidebarCategory[data-category-local-id="${messaging.discuss.categoryLivechat.localId}"]
        ...
        QUnit.test(
            "livechat - states: open manually by clicking the title",
            async function (assert) {
                assert.expect(2);
        ...
        QUnit.test(
            "livechat - states: close should update the value on the server",
            async function (assert) {
                assert.expect(2);
