...
test("Local sidebar category state is shared between tabs", async () => {
    ...
    await contains(
        `${env1.selector} .o-mail-DiscussSidebarCategory-livechat [data-icon='keyboard_arrow_down']`
    );
    await contains(
        `${env2.selector} .o-mail-DiscussSidebarCategory-livechat [data-icon='keyboard_arrow_down']`
    );
    await click(`${env1.selector} .o-mail-DiscussSidebarCategory-livechat .btn`);
    await contains(
        `${env1.selector} .o-mail-DiscussSidebarCategory-livechat [data-icon='chevron_forward']`
    );
    await contains(
        `${env2.selector} .o-mail-DiscussSidebarCategory-livechat [data-icon='chevron_forward']`
    );
});
