...
class TestImLivechatReport(TestImLivechatCommon):
    ...
    def test_redirect_to_form_from_pivot(self):
        ...
        self.start_tour("/odoo/action-187", "im_livechat_agents_report_pivot_redirect_tour", login="operator_1")
        self.start_tour("/odoo/action-188?view_type=pivot", "im_livechat_sessions_report_pivot_redirect_tour", login="operator_1")
