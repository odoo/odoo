...
class CorsLivechatChatbotScriptController(LivechatChatbotScriptController):
    @route("/chatbot/cors/restart", type="jsonrpc", auth="force_guest", save_session=False, cors="*")
    ...
    @route("/chatbot/cors/answer/save", type="jsonrpc", auth="force_guest", save_session=False, cors="*")
    ...
    @route("/chatbot/cors/step/trigger", type="jsonrpc", auth="force_guest", save_session=False, cors="*")
    ...
    @route("/chatbot/cors/step/validate_contact_info", type="jsonrpc", auth="force_guest", save_session=False, cors="*")
