...
class CorsLivechatController(LivechatController):
    ...
    @route("/im_livechat/cors/download_transcript/<int:channel_id>", type="jsonrpc", auth="public", cors="*")
    def cors_download_livechat_transcript(self, guest_token, channel_id, email):
        force_guest_env(guest_token)
