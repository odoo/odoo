...
class LivechatMessageReactionController(MessageReactionController):
    ...
    def livechat_message_add_reaction(self, guest_token, message_id, content, action, **kwargs):
        force_guest_env(guest_token)
        return self.mail_message_add_reaction(message_id, content, action, **kwargs)
