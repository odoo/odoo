...
class LivechatThreadController(ThreadController):
    @route("/im_livechat/cors/message/post", methods=["POST"], type="jsonrpc", auth="force_guest", cors="*")
    ...
    @route("/im_livechat/cors/message/update_content", methods=["POST"], type="jsonrpc", auth="force_guest", cors="*")
