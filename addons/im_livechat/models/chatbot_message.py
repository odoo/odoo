...
class ChatbotMessage(models.Model):
    ...
    mail_message_id = fields.Many2one('mail.message', string='Related Mail Message', index=True)
    ...
    user_raw_script_answer_id = fields.Integer(help="Id of the script answer. Useful for statistics when answer is deleted.", bigint=True)
