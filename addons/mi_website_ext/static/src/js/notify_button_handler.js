...
publicWidget.registry.NotifyButton = publicWidget.Widget.extend({
    ...
    _onClickNotify: function(ev) {
        ...
        modalElement.find('#confirm_notify_btn').off('click').one('click', () => {
            const reason = modalElement.find('#absence_reason').val();
            ...
            rpc('/notify/absence', {
                ...
                $button.prop('disabled', false).text('Confirmar y Enviar Notificación');
            });
        });
    },
});