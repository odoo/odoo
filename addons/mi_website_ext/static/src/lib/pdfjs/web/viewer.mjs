...
class PDFDocumentProperties {
  ...
  var numPages = PDFViewerApplication.pagesCount;
      ...
      if (page === numPages) {
  // Si estamos en la última página, enviamos un mensaje a la ventana padre.
  window.parent.postMessage('pdf-scrolled-to-end', '*');
  console.log('Se llegó al final del PDF. Enviando mensaje.');
}
    });
