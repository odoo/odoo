...
class TestSandwichLeaveWorkEntry(TransactionCase):
    ...
    def get_work_entry_type_count(self, work_entry_create_vals, work_entry_type):
        work_entry_type_count = {}
        for record in work_entry_create_vals:
            work_entry_type_id = record['work_entry_type_id']
            if work_entry_type_id in work_entry_type_count:
                work_entry_type_count[work_entry_type_id] += 1
            else:
                work_entry_type_count[work_entry_type_id] = 1
        return work_entry_type_count[work_entry_type]
    ...
    def test_sandwich_leave_work_entry(self):
        ...
        """
        # the employee has the leave which includes the non-working day in between
    ...
    def test_separate_sandwich_leave_work_entry(self):
        ...
        before_holiday_leave.action_validate()
        ...
        after_holiday_leave.action_validate()
    ...
    def test_long_sandwich_leave_not_containing_public_holiday(self):
        """
    ...
    def test_edge_sandwich_public_leave_work_entry(self):
        ...
        work_entry_type_count = self.get_work_entry_type_count(work_entry_create_vals, self.public_leave_work_entry_type.id)
        self.assertEqual(work_entry_type_count, 2, 'Work entry type of public leave should be 2')

    def test_different_leave_edge_sandwich_public_leave_work_entry(self):
        self.env['resource.calendar.leaves'].create({
            'name': 'Public Holiday',
            'date_from': datetime(2025, 2, 12, 00, 00, 00),
            'date_to': datetime(2025, 2, 12, 23, 59, 59),
