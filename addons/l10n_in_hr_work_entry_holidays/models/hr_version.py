...
class HrVersion(models.Model):
    ...
    def _get_working_day(self, calendar_id, date, reverse=False):
        step = -1 if reverse else 1
        while not calendar_id._works_on_date(date):
    ...
    def _adjust_leave_dates(self, leave, start_dt, end_dt, version_calendar_id):
        """
            ...
            If the leave is non-working on both ends, it will adjust to the next working day
        """
