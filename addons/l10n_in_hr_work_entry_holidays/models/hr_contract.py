        ...
        for contract in in_contracts:
            ...
            for leave in employee_leaves:
                ...
                if leave.linked_sandwich_leave_id:
                    ...
                    leave_start_dt = min(leave_start_dt, ensure_timezone(linked_leave.date_to, tz)) + timedelta(days=1)
                    leave_end_dt = max(leave_end_dt, ensure_timezone(linked_leave.date_from, tz)) - timedelta(days=1)
