...
QUnit.test("Sent", async function () {
    ...
    await contains(".o_MessageView");
    await contains(".o_MessageView_notificationIcon.fa-paper-plane");
...
QUnit.test("No Price Available", async function (assert) {
    ...
    await contains(".o_MessageView_notificationIcon.fa-paper-plane");
    await click(".o_MessageView_notificationIconClickable");
    await contains(".o_SnailmailErrorView");
    await contains(".o_SnailmailErrorView_contentPrice");
    await click(".o_SnailmailErrorView_cancelLetterButton");
    await contains(".o_SnailmailErrorView", { count: 0 });
    await def;
...
QUnit.test("Credit Error", async function (assert) {
    ...
    await click(".o_MessageView_notificationIconClickable");
    await contains(".o_SnailmailErrorView");
    await contains(".o_SnailmailErrorView_contentCredit");
    await contains(".o_SnailmailErrorView_cancelLetterButton");
    await click(".o_SnailmailErrorView_resendLetterButton");
    await contains(".o_SnailmailErrorView", { count: 0 });
    await def;
...
QUnit.test("Trial Error", async function (assert) {
    ...
    await click(".o_MessageView_notificationIconClickable");
    await contains(".o_SnailmailErrorView");
    await contains(".o_SnailmailErrorView_contentTrial");
    await contains(".o_SnailmailErrorView_cancelLetterButton");
    await click(".o_SnailmailErrorView_resendLetterButton");
    await contains(".o_SnailmailErrorView", { count: 0 });
    await def;
