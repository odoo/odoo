...
class ResCompany(models.Model):
    ...
    def _peppol_modules_document_types(self):
        ...
        # this company as a valid AE PINT recipient on the network. The customization IDs
        # below are the ones published in the spec's profiles table.
        ...
        document_types['l10n_ae_ubl_pint_peppol'] = {
