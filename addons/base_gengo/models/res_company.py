...
class ResCompany(models.Model):
    ...
    gengo_private_key = fields.Text(copy=False, groups="base.group_system")
    gengo_public_key = fields.Text(copy=False, groups="base.group_user")
    ...
    gengo_auto_approve = fields.Boolean(string="Auto Approve Translation ?", default=True,
                                        help="Jobs are Automatically Approved by Gengo.", groups="base.group_user")
