...
class AccountMove(models.Model):
        ...
        for move in self:
            ...
            if move.country_code == 'SA' and move.move_type in ('out_invoice', 'out_refund') and zatca_document and move.state != 'draft':
                ...
                if move._l10n_sa_is_simplified():
                    x509_cert_sudo = move.journal_id.sudo().l10n_sa_production_csid_certificate
    ...
    def _l10n_sa_get_qr_code(self, journal_id, unsigned_xml, certificate, signature, is_b2c=False):
        ...
        if invoice_datetime and journal_id.company_id.vat and certificate:
            ...
            public_key_enc = self._l10n_sa_get_qr_code_encoding(8, certificate._get_public_key_bytes(block=False))
            ...
            if is_b2c:
                qr_code_str += self._l10n_sa_get_qr_code_encoding(9, certificate._get_signature_bytes(block=False))
