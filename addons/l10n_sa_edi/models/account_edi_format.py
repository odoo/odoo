...
class AccountEdiFormat(models.Model):
    ...
    def _l10n_sa_get_digital_signature(self, company_id, invoice_hash):
        ...
        return company_id.sudo().l10n_sa_private_key._sign(decoded_hash, block=False)
    ...
    def _l10n_sa_sign_xml(self, xml_content, certificate, signature):
        ...
        der_cert = certificate._get_der_certificate_bytes(block=False)
    ...
    def _l10n_sa_export_zatca_invoice(self, invoice, xml_content=None):
        ...
        try:
            PCSID_data, certificate_id = invoice.journal_id._l10n_sa_api_get_pcsid()
        ...
        certificate_sudo = self.env['certificate.certificate'].sudo().browse(certificate_id)
