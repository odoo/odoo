...
class TestSaEdiCommon(AccountEdiTestCommon):
    ...
    def _setup_products(cls):
        ...
        cls.product_a = cls._create_product('Product A', 320.0, 'P0001')
        cls.product_b = cls._create_product('Product B', 15.8, 'P0002')
        cls.product_burger = cls._create_product('Burger', 265.0)

    @classmethod
    def _create_product(cls, name, price, code=None):
