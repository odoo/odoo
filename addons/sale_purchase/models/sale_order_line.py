...
class SaleOrderLine(models.Model):
    ...
    def _purchase_service_prepare_line_values(self, purchase_order, quantity=False):
        ...
        purchase_qty_uom = self.product_uom._compute_quantity(product_quantity, self.product_id.uom_id)
        ...
        purchase_line_vals = {
            ...
            'product_uom': supplierinfo.product_uom or self.product_id.uom_id.id,
