...
class SaleOrderLine(models.Model):
    ...
    def _purchase_increase_ordered_qty(self, new_qty, origin_values):
        ...
        for line in self:
            ...
            if last_purchase_line.state in ['draft', 'sent', 'to approve']:  # update qty for draft PO lines
                quantity = line.uom_id._compute_quantity(new_qty, last_purchase_line.uom_id)
                ...
                quantity = line.uom_id._compute_quantity(new_qty - origin_values.get(line.id, 0.0), last_purchase_line.uom_id)
    ...
    def _purchase_service_prepare_line_values(self, purchase_order, quantity=False):
        ...
        purchase_qty_uom = self.uom_id._compute_quantity(product_quantity, self.product_id.uom_po_id)
    ...
    def _purchase_service_create(self, quantity=False):
        ...
        for line in self:
            ...
            suppliers = line.product_id._select_seller(quantity=line.product_uom_qty, uom_id=line.uom_id)
            if not suppliers:
