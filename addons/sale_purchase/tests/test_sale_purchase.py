...
class TestSalePurchase(TestCommonSalePurchaseNoChart):
    ...
    def test_uom_conversion(self):
        ...
        # self.assertEqual(purchase_line.product_uom, self.service_purchase_2.uom_id, "The UoM on the purchase line should be the one from the product configuration")
