...
class TestSalePurchase(TestCommonSalePurchaseNoChart):
    ...
    def test_uom_conversion(self):
        ...
        self.assertNotEqual(purchase_line.uom_id, self.sol2_service_purchase_2.uom_id, "As the product configuration, the UoM on the SO line should still be different from the one on the PO line")
