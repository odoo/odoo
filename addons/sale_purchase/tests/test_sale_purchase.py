...
class TestSalePurchase(TestCommonSalePurchaseNoChart):
    ...
    def test_uom_conversion(self):
        ...
        self.assertEqual(purchase_line.product_qty, self.sol2_service_purchase_2.product_uom_qty * 6, "The quantity from the SO should be converted with th UoM factor on the PO line")
