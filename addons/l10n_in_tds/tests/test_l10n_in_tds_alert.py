...
class TestL10nInTdsAlert(L10nInTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.company.write({'l10n_in_tds': True})

        # ==== Chart of Accounts ====
        cls.purchase_account = ChartTemplate.ref('p2107')
        cls.purchase_account.write({
            'l10n_in_tds_tcs_section_id': cls.env.ref('l10n_in_tds.tds_section_194c').id
        })
        ...
        cls.internet_account.write({
            'l10n_in_tds_tcs_section_id': cls.env.ref('l10n_in_tds.tds_section_194j').id
        })
        cls.rent_account = ChartTemplate.ref('p2111')
        cls.rent_account.write({
            'l10n_in_tds_tcs_section_id': cls.env.ref('l10n_in_tds.tds_section_194ib').id
        })
        ...
        cls.tax_194c.write({'l10n_in_section_id': cls.env.ref('l10n_in_tds.tds_section_194c').id})
        cls.tax_194j = ChartTemplate.ref('tds_10_us_194j')
        cls.tax_194j.write({'l10n_in_section_id': cls.env.ref('l10n_in_tds.tds_section_194j').id})
        cls.tax_194ib = ChartTemplate.ref('tds_20_us_194ib')
        cls.tax_194ib.write({'l10n_in_section_id': cls.env.ref('l10n_in_tds.tds_section_194ib').id})
    ...
    def test_tds_warning_on_exceeded_per_transaction_limit(self):
        '''
        ...
        self.assertEqual(move.l10n_in_warning['tds_threshold_alert']['message'], "It's advisable to deduct TDS u/s 194C on this transaction.")
        ...
        self.assertEqual(move_1.l10n_in_warning['tds_threshold_alert']['message'], "It's advisable to deduct TDS u/s 194C on this transaction.")
        ...
        self.assertEqual(move_3.l10n_in_warning['tds_threshold_alert']['message'], "It's advisable to deduct TDS u/s 194C on this transaction.")

    def test_tds_warning_on_monthly_aggregate_limit(self):
        '''
        ...
        self.assertEqual(move_2.l10n_in_warning['tds_threshold_alert']['message'], "It's advisable to deduct TDS u/s 194IB on this transaction.")
        ...
        self.assertEqual(move_4.l10n_in_warning['tds_threshold_alert']['message'], "It's advisable to deduct TDS u/s 194IB on this transaction.")

    def test_tds_warning_partner_wiht_pan(self):
        '''
        ...
        self.assertEqual(move_3.l10n_in_warning['tds_threshold_alert']['message'], "It's advisable to deduct TDS u/s 194J on this transaction.")

    def test_tds_warning_on_exceeded_aggregate_limit(self):
        '''
        ...
        self.assertEqual(move_2.l10n_in_warning['tds_threshold_alert']['message'], "It's advisable to deduct TDS u/s 194C on this transaction.")
        ...
        self.assertEqual(move_5.l10n_in_warning['tds_threshold_alert']['message'], "It's advisable to deduct TDS u/s 194C on this transaction.")

    def test_tds_warning_on_case_of_credit_note(self):
        '''
    ...
    def test_tds_warning_for_multiple_accounts_in_lines(self):
        '''
    ...
    def test_tds_warning_for_if_line_has_price_zero(self):
        '''
    ...
    def test_tds_warning_for_all_lines_do_not_have_taxes(self):
        '''
    ...
    def test_tds_warning_use_in_invoice(self):
        '''
        Test when tds section is used in the invoice creation.
        '''
    ...
    def test_tds_warning_for_company_branches(self):
        '''
    ...
    def test_tds_warning_for_multiple_accounts_same_section_in_lines(self):
        '''
        Test when there are multiple products in the move line and some of them
    ...
    def test_tds_warning_for_not_consider_draft_cancel_invoices_for_aggregate(self):
        '''
