...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_in_tds_account_tax_group(self):
        return self._parse_csv('in', 'account.tax.group', module='l10n_in_tds')

    @template('in', 'account.tax')
    def _get_in_tds_account_tax(self):
        additional = self._parse_csv('in', 'account.tax', module='l10n_in_tds')
