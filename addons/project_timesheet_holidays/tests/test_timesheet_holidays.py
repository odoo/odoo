...
class TestTimesheetHolidays(TestTimesheet):
    ...
    def setUp(self):
        ...
        self.internal_project = self.env['res.company']._get_current_company().leave_timesheet_project_id
        self.internal_task_leaves = self.env['res.company']._get_current_company().leave_timesheet_task_id
