...
class TestTimesheetHolidays(TestCommonTimesheet):
    ...
    def test_timesheet_generation_with_past_contract_timeoff(self):
        ...
        ]).with_user(SUPERUSER_ID).action_approve()
        ...
        self.assertEqual(timesheets[0].unit_amount, 8, "The timesheet for the past contract should have 8 hours")
        self.assertEqual(timesheets[1].unit_amount, 7, "The timesheet for the Current contract should have 7 hours")
