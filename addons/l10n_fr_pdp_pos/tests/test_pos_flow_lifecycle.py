...
def _compute_l10n_fr_f10_enable_reporting_for_pos_tests(companies):
...
class TestPdpPosFlowLifecycle(TestPoSCommon):
    ...
    def setUpClass(cls):
        ...
        cls.startClassPatcher(patch(
            'odoo.addons.l10n_fr_pdp_reports.models.res_company.ResCompany._compute_l10n_fr_f10_enable_reporting',
            _compute_l10n_fr_f10_enable_reporting_for_pos_tests,
        ))
    ...
    def setUp(self):
        ...
        self.env['l10n.fr.pdp.reports.flow'].sudo().search([
    ...
    def _patch_pos_date(self, date):
        ...
        with patch('odoo.fields.Date.context_today', return_value=date):
            with patch('odoo.fields.Date.today', return_value=date):
                with patch('odoo.fields.Datetime.now', return_value=datetime_value):
                    yield
