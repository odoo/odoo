...
class EventRegistration(models.Model):
    ...
    def _apply_lead_generation_rules(self, event_lead_rules=False):
        ...
        if event_lead_rules:
            create_lead_rules = event_lead_rules.filtered_domain([('lead_creation_trigger', '=', 'create')])
        else:
        ...
        if open_registrations:
            if event_lead_rules:
                confirm_lead_rules = event_lead_rules.filtered_domain([('lead_creation_trigger', '=', 'confirm')])
            else:
        ...
        if done_registrations:
            if event_lead_rules:
                done_lead_rules = event_lead_rules.filtered_domain([('lead_creation_trigger', '=', 'done')])
            else:
