...
""",
    ...
    'assets': {
        ...
        'web.assets_backend': [
            ...
            ('remove', 'web/static/src/legacy/js/_deprecated/basic_fields.js'),
            ...
            ('remove', 'web/static/src/legacy/js/views/form/**/*'),
            ('remove', 'web/static/src/legacy/js/views/kanban/kanban_column.js'),
            ('remove', 'web/static/src/legacy/js/views/kanban/kanban_column_quick_create.js'),
            ('remove', 'web/static/src/legacy/js/views/kanban/kanban_controller.js'),
            ('remove', 'web/static/src/legacy/js/views/kanban/kanban_examples_registry.js'),
            ('remove', 'web/static/src/legacy/js/views/kanban/kanban_model.js'),
            ('remove', 'web/static/src/legacy/js/views/kanban/kanban_record_quick_create.js'),
            ('remove', 'web/static/src/legacy/js/views/kanban/kanban_renderer.js'),
            ('remove', 'web/static/src/legacy/js/views/kanban/kanban_view.js'),
            ('remove', 'web/static/src/legacy/js/views/kanban/quick_create_form_view.js'),
            ('remove', 'web/static/src/legacy/js/views/list/**/*'),
            ('remove', 'web/static/src/legacy/js/views/select_create_controllers_registry.js'),
            ('remove', 'web/static/src/legacy/js/views/view_dialogs.js'),
        ...
        "web.assets_backend_legacy_lazy": [
            ...
            ('remove', 'web/static/src/legacy/js/fields/field_utils.js'),
            ('remove', 'web/static/src/legacy/js/fields/field_registry.js'),
            ('remove', 'web/static/src/legacy/js/fields/field_registry_owl.js'),
            ('remove', 'web/static/src/legacy/js/fields/field_wrapper.js'),
            'web/static/src/legacy/js/views/form/**/*',
            'web/static/src/legacy/js/views/form/**/*',
            ...
            'web/static/src/legacy/js/views/list/**/*',
