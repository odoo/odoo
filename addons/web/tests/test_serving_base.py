...
@tagged('standard', 'at_install', 'lpe')
class TestStaticInheritance(unittest.TestCase):
    ...
    def test_static_inheritance_01(self):
        contents, checksum = HomeStaticTemplateHelpers().get_qweb_templates(addons=self._get_module_names())
        expected = b"""
            <templates>
                <form t-name="template_1_1" random-attr="gloria">
                    <div>At first I was afraid</div>
                ...
                <t t-name="template_1_2">
                    <div>And I grew strong</div>
                    <!-- Modified by an anonymous template from module_2 -->
                    <div>And I learned how to get along</div>
                </t>
    ...
    def test_static_inherit_different_tag(self):
        self.modules = [
            ('module_1_file_1', None, 'module_1'),
        ]
        self.template_files = {
            'module_1_file_1': b'''
                <templates id="template" xml:space="preserve">
                    ...
                    <t t-inherit="template_1_1" t-inherit-mode="extension">
                        <xpath expr="//div[2]" position="after">
                            <div>But then I spent so many nights thinking how you did me wrong</div>
                        </xpath>
                    </t>
        ...
        expected = b"""
            <templates>
                <form t-name="template_1_1">
                    <div>At first I was afraid</div>
                    <div>Kept thinking I could never live without you by my side</div>
                    <!-- Modified by an anonymous template from module_1 -->
                    <div>But then I spent so many nights thinking how you did me wrong</div>
                </form>
                <t t-name="template_1_2" t-inherit="template_1_1">
                    <div>At first I was afraid</div>
                    <div>I was petrified</div>
                    <div>Kept thinking I could never live without you by my side</div>
                </t>
    ...
    def test_static_misordered_modules(self):
        ...
        with self.assertRaises(ValueError) as ve:
            HomeStaticTemplateHelpers().get_qweb_templates(addons=self._get_module_names())
