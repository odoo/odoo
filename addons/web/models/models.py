...
class Base(models.AbstractModel):
    ...
    def web_resequence(self, field_name: str = 'sequence', offset: int = 0, specification: dict[str, dict] = {}) -> list[dict]:
        ...
        :type ids: list(id)
        :param str field_name: field used for sequence specification, defaults to
                          "sequence"
