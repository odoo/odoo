...
class Base(models.AbstractModel):
    ...
    def _search_panel_range(self, field_name, **kwargs):
        ...
        :param enable_counters: whether to count records by value. This is done in
        ...
        local_counters = {}
        if field.type != 'many2many' and kwargs.get('enable_counters'):
    ...
    def search_panel_select_range(self, field_name, **kwargs):
        ...
        if parent_name and kwargs.get('enable_counters'):
