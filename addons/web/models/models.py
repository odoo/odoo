...
class Base(models.AbstractModel):
    ...
    def search_property_definition(self, domain, field_names: 'list[str]') -> dict[str, list[dict]]:
        """ Return all property definition for records matching the domain
            ...
            <property_field_name>: [
                {
                    ...
                    "definition": <definition of property>
                }, ...
            ], ...
        }
        """
        ...
        for field_name in field_names:
            ...
            res[field.name] = [
                {"id": rec.id, "display_name": rec.display_name, "definition": rec[field.definition_record_field]}
