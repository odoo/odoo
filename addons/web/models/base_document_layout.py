...
class BaseDocumentLayout(models.TransientModel):
    ...
    partner_id = fields.Many2one(related='company_id.partner_id', readonly=False)
    phone = fields.Char(related='company_id.phone', readonly=False)
    ...
    name = fields.Char(related='company_id.name', readonly=False)
    country_id = fields.Many2one(related="company_id.country_id", readonly=False)
