...
class Export(Controller):
    ...
    def formats(self):
        ...
        return [
            {'tag': 'xlsx', 'label': self.env._("Excel Workbook (.xlsx)"), 'error': xlsx_error},
    ...
    def get_fields(self, model, domain, prefix='', parent_name='',
        ...
        exportable_fields.update(self.env['ir.exports']._get_property_fields(fields, model, domain=domain))
    ...
    def namelist(self, model, export_id):
        ...
        return {
            'fields': self.env['ir.exports']._get_fields_info(model, export.export_fields.mapped('name')),
