...
| `search/cog_menu/` | widgets | 3 | Cog dropdown in named sections (`COG_GROUP`), its shared `CogMenuItem`, and the registry validation for Action, Print and registry items |
