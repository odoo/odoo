...
| `static/src/` | 869 JavaScript/OWL source files across 248 directories (FSD layers) | `DIRECTORY_MAP.md` |
| `static/lib/` | 18 directories (17 vendored libraries + generated `popper_compat/`) — DO NOT MODIFY | `static/lib/versions.json` |
| `static/tests/` | 802 `.js` (incl. 737 `*.test.js` Hoot suites), mirroring the `static/src/` tree | `TEST_TAGS.md` |
...
| JavaScript (tests) | 802 (incl. 737 `*.test.js` Hoot suites) |
