...
export const PluginManager = _owl.PluginManager;
...
export const derived = _owl.derived;
...
export const usePlugins = _owl.usePlugins;
...
export const withoutReactivity = _owl.withoutReactivity;
