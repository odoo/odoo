    ...
    static template = xml`
        ...
        <div class="${HootJobButtons.name} items-center gap-1" t-att-class="props.hidden ? 'hidden' : 'flex'">
            <HootLink
                type="type"
                id="props.job.id"
                class="'hoot-btn-link border border-primary text-pass rounded transition-colors'"
            ...
            <HootLink
                ...
                id="props.job.id"
                options="{ ignore: true }"
                class="'hoot-btn-link border border-primary text-fail rounded transition-colors'"
                title="'Ignore ' + type"
            >
