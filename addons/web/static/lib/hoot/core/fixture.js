...
import { subscribeToAnimationChange } from "../mock/animation";
...
export class HootFixtureElement extends HTMLElement {
    ...
    static {
        ...
        this.styleElement.innerText = /* css */ `
            ...
            ${this.TAG_NAME}:not(.${this.CLASSES.animations}) * {
    ...
    connectedCallback() {
        ...
        subscribeToAnimationChange((allowAnimations) =>
            this.classList.toggle(this.constructor.CLASSES.animations, allowAnimations)
        );
    }
