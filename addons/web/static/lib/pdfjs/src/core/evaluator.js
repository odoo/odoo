          ...
          switch (fn | 0) {
            ...
            case OPS.paintXObject:
              ...
              if (xobjsCache.key === name) {
                if (xobjsCache.texts) {
                  PDFJS.Util.appendToArray(bidiTexts, xobjsCache.texts.items);
                  PDFJS.Util.extendObj(textContent.styles, xobjsCache.texts.styles);
                }
                break;
              }
              ...
              return self.getTextContent(xobj,
                ...
                then(function (formTextContent) {
                  PDFJS.Util.appendToArray(bidiTexts, formTextContent.items);
                  PDFJS.Util.extendObj(textContent.styles, formTextContent.styles);
                  stateManager.restore();
