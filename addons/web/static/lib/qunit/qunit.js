...
(function () {
  ...
  const debug = odoo.debug; // Odoo customization
  ...
  var lastError = null; // Odoo customization
  ...
  Test.prototype = {
    get moduleName() { return this.module.name; }, // Odoo customization
    ...
    run: function run() {
      ...
      try {
        ...
        lastError = e; // Odoo customization
    ...
    finish: async function finish() { // Odoo customization (function made async)
      config.current = this;
        ...
        if (typeof then === 'function') {
          ...
          if (config.notrycatch) {
            ...
            var reject = function reject(error) {
              lastError = error; // Odoo customization
  ...
  function begin() {
    ...
    var modulesLog = [];
    const names = new Set(); // Odoo customization
