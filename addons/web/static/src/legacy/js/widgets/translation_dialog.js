            ...
            return Promise.all([
                ...
                this._loadLanguages().then((l) => {
                    ...
                    return this._loadTranslations().then((t) => {
                        ...
                        this.showSrc = this.context.translation_show_src;
                    });
                }),
            ]).then(() => {
                ...
                this.data.sort((left, right) =>
                    (left.langName > right.langName || (left.langName === right.langName)) ? 1 : -1);
            });
        },
        ...
        _onSave: function () {
            ...
            this.el.querySelectorAll('input[type=text],textarea').forEach((t) => {
                ...
                if (initialValue.value !== t.value) {
                    updatedTerm[t.dataset.id] = {lang: initialValue.lang, src: initialValue.src, value: t.value};
