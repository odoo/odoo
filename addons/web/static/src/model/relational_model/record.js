...
class Record2 extends DataPoint {
    static type = "Record";
    ...
    setup(_config, data, options = {}) {
        ...
        console.warn(`OModel.id:`, OModel.id);
        this.orecord = new OModel(this.config.resId);
        flushDataToLoad();
        window.orecord = this.orecord;
        ...
        //     }
        // }
        // Object.assign(this.orecord.reactiveData, data);

        // todo: derived instead
        this._setEvalContext();
        console.warn(`this.orecord.reactiveData:`, this.orecord.reactiveData);
        ...
        // todo: why do we need textValues
    ...
    _updateORecord(orecord, changes) {
    ...
    async _save({ reload = true, onError, nextId } = {}) {
        ...
        changes = changes[this.resModel][this.resId];
