...
export class CapsLockWarning extends Interaction {
    static selector = "[data-widget='caps-lock-check']";
    dynamicContent = {
        ".password-input": {
    ...
    _onInputKeyDown(ev) {
        ...
        this.el.querySelector(".caps-lock-warning").classList.toggle("invisible", shouldHideWarning);
    }
...
registry
    ...
    .add("web.caps_lock_warning", CapsLockWarning);
