...
/**
 * Returns an object from a class definition, wether it
 ...
 * @returns {Object}
 */
export function toClassObj(classDefinition) {
    if (!classDefinition) {
        return {};
...
/**
 * Merges two classes to a single class object, wether the
...
/**
 * Adds the given classes to an element, wether the classes
 * ar strings or objects.
 *
