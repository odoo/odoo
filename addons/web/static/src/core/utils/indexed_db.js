...
export class IndexedDB {
    ...
    /**
     * Check the version of the database, if the version is different the database will be deleted
     *
     * @params {string} version
     * @returns Promise
     */
    async checkVersion(version) {
        return this.mutex.exec(() => this._checkVersion(version));
    }
    ...
    async _write(db, table, key, record) {
        return new Promise((resolve, reject) => {
            // Relaxed durability improuves the write performances
