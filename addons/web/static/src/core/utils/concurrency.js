 ...
 *   const a = yield 1;
 *   const b = yield 2;
 *   fn(); // will be called synchronously
 *   return a + b;
 * }); // returns 3
 *
 * @example
 ...
 *   const data = yield new Promise(resolve => setTimeout(resolve, 1000))
 *   fn(); // will be called asynchronously after the promise resolves
 *   return 1
 * }); // returns a Promise that resolves to 1
 */
