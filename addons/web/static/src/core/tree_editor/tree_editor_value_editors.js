...
import {
    get_DATETIME_OPTIONS_WITH_INPUT,
    get_DATETIME_OPTIONS_WITH_SELECT,
        ...
        case "datetime_option": {
            if (fieldDef.name in get_DATETIME_OPTIONS_WITH_SELECT()) {
                const { options, defaultValue, isSupported } =
                    get_DATETIME_OPTIONS_WITH_SELECT()[fieldDef.name];
            ...
            const { defaultValue, isSupported } = get_DATETIME_OPTIONS_WITH_INPUT()[fieldDef.name];
            return {
