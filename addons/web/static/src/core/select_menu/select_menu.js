...
export class SelectMenu extends Component {
    ...
    get displayInputInToggler() {
        return (!this.props.slots || !this.props.slots.default) && this.props.searchable;
    }
    ...
    get placeholderValue() {
        if (this.displayInputInToggler && this.state.isFocused && this.props.searchPlaceholder) {
    ...
    onInputBlur() {
        ...
        if (this.state.searchValue === "" && this.canDeselect && !this.props.multiSelect) {
    ...
    onStateChanged(open) {
        if (open) {
            if (this.displayInputInDropdown) {
