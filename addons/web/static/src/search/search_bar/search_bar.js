...
function manageSearchWithQuotes({ operator, value, label }) {
    ...
    return { label, operator, value, enforceOperator };
}
...
export class SearchBar extends Component {
    ...
    selectItem(item) {
        ...
        if (!item.unselectable) {
            ...
            const autoCompleteValues = manageSearchWithQuotes({ label, operator, value });
            if (!autoCompleteValues.enforceOperator) {
                delete autoCompleteValues.enforceOperator;
            }
