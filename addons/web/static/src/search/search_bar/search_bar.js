...
export class SearchBar extends Component {
    ...
    setupFacetNavigation() {
        ...
        useNavigation(this.inputContainerRef, {
            ...
            isActive: (navigator, target) => navigator.contains(target),
            hotkeys: {
                enter: {
    ...
    getDropdownNavigation() {
        ...
        return {
            ...
            isActive: (navigator, target) =>
                this.inputDropdownState.isOpen &&
                (this.inputContainerRef.el?.contains(target) || navigator.contains(target)),
            ...
            hotkeys: {
                ...
                arrowleft: {
                    bypassEditableProtection: true,
                    isAvailable: (navigator, target) =>
                        target.selectionStart === 0 || isCollapsible(navigator.activeItemIndex),
                    callback: (navigator) => {
                        const item = this.items[navigator.activeItemIndex];
