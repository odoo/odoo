...
var AbstractWebClient = Widget.extend(ServiceProviderMixin, KeyboardNavigationMixin, {
    ...
    */
    ...
    on_connection_lost: function () {
        this.connection_notification = this.call('web.Notification', 'notify', {
    ...
    on_connection_restored: function () {
        if (this.connection_notification) {
            this.call('web.Notification', 'close', this.connection_notification);
            this.call('web.Notification', 'notify', {
    ...
    /**
     * Displays a warning in a dialog of with the Notification
     *
     * @private
     * @param {OdooEvent} e
    ...
    _onDisplayWarning: function (e) {
        ...
        if (data.type === 'dialog') {
            ...
            this.call('web.Notification', 'notify', e.data);
        }
    },
    /**
