...
var Session = core.Class.extend(mixins.EventDispatcherMixin, {
    ...
    getCompanyId: function () {
        /**
         * Returns the Id of the current main company.
         *
    ...
    getCompanyCurrencyId: function () {
        /**
         * Returns the Id of the currency of the current main company..
         *
         * @returns {Integer} Id of the main company currency
         */
        let cid = this.getCompanyId();
        return cid ? this.companies_currency_id[cid] : this.company_currency_id;
    },

    getCompanyIds: function () {
        /**
         * Returns the ids of the currently enabled companies.
         *
