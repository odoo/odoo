...
var ServicesMixin = {
    ...
    do_notify: function (title, message, sticky, className) {
        return this.call('web.Notification', 'notify', {title: title, message: message, sticky: sticky, className: className});
    },
    do_warn: function (title, message, sticky, className) {
        return this.call('web.Notification', 'notify', {type: 'warning', title: title, message: message, sticky: sticky, className: className});
    },
};
