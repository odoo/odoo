...
var CalendarController = AbstractController.extend({
    ...
    /**
     * Called on 'delete' click action on the dialog generated by _onOpenEvent.
     * Can be override in order to change the behavior of delete action on calendar popup.
     *
     * @param {integer} id the id of the calendar.event object that sould be deleted.
     */
    _onDeleteEvent: function (id){
        var self = this;
        // call delete record on the model.
        Dialog.confirm(this, _t("Are you sure you want to delete this record ?"), {
            confirm_callback: function (){
                return self.model.deleteRecords([id], self.modelName).always(function () {
                          // destroy dialog generated by funtion _onOpenEvent
                          self.dialog.destroy();
                          // reload in order to remove the deleted event on the view
                          self.reload();
                });
            }
        });
                ...
                options.buttons = [
                    {
                        ...
                        close: true,
                        click: function () {
                            this.trigger_up('openEvent', _.extend({editMode: true}, event.data));
                        }
                    },
                    {
                        text: _t("Delete"),
                        click: self._onDeleteEvent.bind(self, id)
                    },
