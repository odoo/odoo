...
var BasicModel = AbstractModel.extend({
    ...
    _isX2ManyValid: function (id) {
        ...
        _.each(element._changes, function (command) {
            if (command.operation === 'DELETE' ||
                    ...
                    (command.operation === 'ADD' && command.id === null)) {
                return;
            }
    ...
    /**
     * Read data from server for all missing fields
     *
     * @param {Object} list a valid resource object
     ...
     */
    _readDatas: function (list, resIds, fieldNames) {
        var self = this;
    ...
    _readUngroupedList: function (list) {
        ...
        if (list.res_ids.length > list.limit) {
            if (!list.resIdsOrder && list.orderedBy.length) {
    ...
    /**
     * Select the data in function of the offset and limit of the res_ids list
     *
     * @param {Object} list
     */
    _selectDataList: function (list) {
        ...
        // display the create record in addition to the maximum number of records
        if (list.limit) {
            var self = this;
    ...
    _sortList: function (list) {
        ...
        if (list.resIdsOrder) {
            var resIdsOrder = {};
            for (var k = 0; k < list.resIdsOrder.length; k++) {
                resIdsOrder[list.resIdsOrder[k]] = k;
            }
            utils.stableSort(list.res_ids, function compareResIdIndexes (resId1, resId2) {
                if (!(resId1 in resIdsOrder) && !(resId2 in resIdsOrder)) {
                    return 0;
                }
                if (!(resId1 in resIdsOrder)) {
                    return Infinity;
                }
                if (!(resId2 in resIdsOrder)) {
                    return -Infinity;
                }
                return resIdsOrder[resId1] - resIdsOrder[resId2];
            });
