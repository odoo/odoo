...
var BasicModel = AbstractModel.extend({
    ...
    _applyOnChange: function (values, record, options = {}) {
        ...
        _.each(values, function (val, name) {
            ...
            if (!field) {
                ...
                // // AAB FIXME 1: can we get rid of this? What do we do with unknown fields values
                // // returned by the first onchange? With default_get, we kept them (inside x2manys),
                // // and saved them later on... (see _processX2ManyCommands)
                // // see "list in form: default_get with x2many create"
    ...
    _generateChanges: function (record, options) {
        ...
        // AAB FIXME 1: if we have to keep changes for unknown fields returned
        // by onchange, maybe we can add rawChanges here ?
