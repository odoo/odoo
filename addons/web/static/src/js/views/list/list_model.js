odoo.define('web.ListModel', function (require) {
    ...
    var ListModel = BasicModel.extend({
        ...
        saveRecords: function (referenceRecordId, recordIds, fieldName) {
            var record = this.localData[referenceRecordId];
            var listDatapointId = record.parentID;
            return this._saveRecords(listDatapointId, referenceRecordId, recordIds, fieldName);
        },
        /**
         * For a list of records, performs a write with all changes and fetches
         * all data.
         ...
         * @param {string} fieldName the field to write
         */
        _saveRecords: function (listDatapointId, referenceRecordId, recordIds, fieldName) {
            var self = this;
