...
class ProgressBarState {
    ...
    async selectBar(groupId, bar) {
        ...
        // this._updateProgressBars([group]); // update it but not sure if it is useful

        if (this._aggregateFields.length) {
            // TODO necessary ??? since _updateAggregatesBars makes the same think
            // this._updateAggregates([group]);
        }
