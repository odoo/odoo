...
export class ListPropertyTags extends Component {
...
ListPropertyTags.props = {
    ...standardFieldProps,
};

ListPropertyTags.template = "web.ListPropertyTags";
ListPropertyTags.components = { PropertyTags };
