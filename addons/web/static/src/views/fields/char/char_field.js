...
export class CharField extends Component {
    ...
    async onDynamicPlaceholderValidate(chain, defaultValue) {
        if (chain) {
            ...
            const newValue =
                this.input.el.value.slice(0, this.selectionStart) +
                dynamicPlaceholder +
                this.input.el.value.slice(this.selectionStart);
            ...
            this.input.el.focus();
            const newCursorPos = this.selectionStart + dynamicPlaceholder.length;
            this.input.el.setSelectionRange(newCursorPos, newCursorPos);
        }
    }
}
