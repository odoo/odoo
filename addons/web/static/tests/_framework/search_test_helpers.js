...
import { queryAll, queryAllContents, queryContent, queryOne } from "@odoo/hoot-dom";
...
export function getMenuItemTexts() {
    return queryAllContents`.dropdown-menu .o_menu_item`;
}
...
export function getFacetTexts() {
    return queryAllContents(`.o_searchview_facet`);
}
