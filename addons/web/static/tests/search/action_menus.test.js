...
test("render ActionMenus in form view", async () => {
    ...
    // select CogMenu
    await contains(`div.o_control_panel_breadcrumbs_actions i[data-icon="more_vert"]`).click();
...
test("[Offline] render ActionMenus in form view", async () => {
    ...
    // select CogMenu
    await contains(`div.o_control_panel_breadcrumbs_actions button[aria-label='Actions menu']`).click();
