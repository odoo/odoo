...
test(`main button click`, async () => {
    class MyComponent extends Component {
        static template = xml`<div t-custom-click="plop" class="clickMe"><t t-esc="this.props.text"/></div>`;
        static props = ["*"];
...
test(`main button (arrow function)`, async () => {
    class MyComponent extends Component {
        static template = xml`<div t-custom-click="(ev, isMiddleClick) => this.plop(ev, isMiddleClick, 'test')" class="clickMe"><t t-esc="this.props.text"/></div>`;
        static props = ["*"];
...
test(`"stop" and "prevent" modifiers`, async () => {
    class MyComponent extends Component {
        static template = xml`<div t-on-click="this.noClick"><div t-custom-click.stop.prevent="plop" class="clickMe"><t t-esc="this.props.text"/></div></div>`;
        static props = ["*"];
        plop(ev, isMiddleClick) {
            expect.step(`isMiddleClick: ${isMiddleClick}`);
...
test(`"synthetic" modifier`, async () => {
    class MyComponent extends Component {
        static template = xml`<div t-custom-click.synthetic="plop" class="clickMe"><t t-esc="this.props.text"/></div>`;
        static props = ["*"];
        plop(ev) {
