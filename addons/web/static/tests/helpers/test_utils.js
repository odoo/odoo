...
var originalWindowGetSelection; // cached replaced originalGetSelection
...
/**
 * after using patchWindowGetSelection, at the end of your test
 * you must restore the default function so there is no impact to the other tests
 */
function unpatchWindowGetSelection() {
...
return $.when(
    ...
    return {
        ...
        unpatch: unpatch,
        unpatchWindowGetSelection: unpatchWindowGetSelection,
    };
});
