...
QUnit.module("Fields", (hooks) => {
    ...
    QUnit.module("Many2OneReferenceIntegerField");

    QUnit.test("Many2OneReferenceIntegerField in form view", async function (assert) {
        await makeView({
            type: "form",
            serverData,
            resModel: "partner",
    ...
    QUnit.test("Many2OneReferenceIntegerField in list view", async function (assert) {
        await makeView({
            type: "list",
            serverData,
            resModel: "partner",
    ...
    QUnit.test("Many2OneReferenceIntegerField: unset value in form view", async function (assert) {
        await makeView({
            type: "form",
            serverData,
            resModel: "partner",
