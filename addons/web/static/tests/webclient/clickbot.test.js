...
test("clickbot show rpc error when an error dialog is detected", async () => {
    ...
    const expectedModalHtml = /* xml */ `
        <header class="modal-header">
            ...
            <button type="button" class="btn-close position-absolute top-0 end-0 mt-1 me-1" aria-label="Close" tabindex="-1" data-offline-available=""></button>
        </header>
            ...
            <div role="alert">
                ...
                <details>
                    ...
                    <div class="text-bg-100 clearfix mt-2 position-relative o_error_detail pb-2">
                        <button class="btn position-absolute top-0 end-0 pt-2 btn-link link-body-emphasis" data-offline-available=""><span class="fa fa-clipboard"></span></button>
        ...
        <footer class="modal-footer justify-content-around justify-content-md-start flex-wrap gap-1 w-100">
            <button class="btn btn-primary o-default-button" data-offline-available="">Close</button>
        </footer>`
        .trim()
        .replaceAll(/>[\n\s]+</gm, "><");
