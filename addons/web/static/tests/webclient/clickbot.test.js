...
test("clickbot show rpc error when an error dialog is detected", async () => {
    ...
    expect.verifySteps([
        ...
        'Error: Error dialog detected<header class="modal-header"><h4 class="modal-title text-break">Oops!</h4><button type="button" class="btn-close" aria-label="Close" tabindex="-1"></button></header><main class="modal-body"><div role="alert"><p class="text-prewrap"> Something went wrong... If you really are stuck, share the report with your friendly support service </p><button class="btn btn-link p-0">See technical details</button></div></main><footer class="modal-footer justify-content-around justify-content-sm-start flex-wrap gap-1 w-100"><button class="btn btn-primary o-default-button">Close</button></footer>',
    ]);
});
