...
describe("InputBox Component", () => {
    ...
    test("basic rendering of the InputBox component on desktop", async () => {
        ...
        const overlayPadding = queryFirst(".o_input_box_overlay_end").clientWidth;
        expect(".o_input_box").toHaveStyle({"--inputbox-overlay-padding-prefix": "0px", "--inputbox-overlay-padding-suffix": 2 * overlayPadding + INPUTBOX_SPACING_UNIT + "px"});
        expect(".o_input_box .o_input_box_overlay_end:eq(0)").toHaveStyle({"inset-inline-end": overlayPadding + INPUTBOX_SPACING_UNIT + "px"});
