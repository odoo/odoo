    ...
    const toTest = [
        {
            ...
            result: `<t t-name="web.A" t-translation-context="from_target"> <div attr1="45" attr2="b c" t-translation-context-attr1="from_op" t-translation-context-attr2="from_op" attr4="new" t-translation-context-attr4="from_op"/> </t>`,
        },
        {
    ...
    const toTest = [
        {
            ...
            result: `<t t-name="web.A" t-translation-context="from_target"> <!-- From file: test/from_op ; expr="./div" ; position="attributes" --><div attr1="45" attr2="b c" t-translation-context-attr1="from_op" t-translation-context-attr2="from_op" attr4="new" t-translation-context-attr4="from_op"/> </t>`,
        },
    ];
    for (const { arch, operations, result } of toTest) {
        expect(_applyInheritance(arch, operations)).toBe(result);
