...
QUnit.module('Services', {
    ...
    QUnit.test('Display a simple notification', function (assert) {
        ...
        view.call('web.Notification', 'notify', {
            title: 'a',
            message: 'b',
        });
    ...
    QUnit.test('Display a question', function (assert) {
        ...
        view.call('web.Notification', 'notify', notification(0));
        view.call('web.Notification', 'notify', notification(1));
        view.call('web.Notification', 'notify', notification(2));
    ...
    QUnit.test('call close notification service', function (assert) {
        ...
        var close = 0;
        var notificationId0 = view.call('web.Notification', 'notify', {
            title: 'a',
            message: 'b',
            onClose: function () {
                close++;
        ...
        var notificationId1 = view.call('web.Notification', 'notify', {
            title: 'a',
            message: 'b',
            sticky: true,
            onClose: function () {
        ...
        view.call('web.Notification', 'close', notificationId0);
        view.call('web.Notification', 'close', notificationId1);
