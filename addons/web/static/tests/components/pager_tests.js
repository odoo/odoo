odoo.define('web.pager_tests', function (require) {
    ...
    QUnit.module('Components', {}, function () {
        ...
        QUnit.test('pager value formatting', async function (assert) {
            ...
            await inputAndAssert("4", "4", "values are squashed when minimum = maximum");
            ...
            await inputAndAssert("6-5", "6", "maximum is floored to minimum");
            await inputAndAssert("definitelyValidNumber", "6", "fallback to previous value if not a number");
