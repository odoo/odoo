...
test(`editable list view: multi edition error and cancellation handling`, async () => {
    ...
    await contains(`.o_selected_row [name=int_field] input`).edit("eee", { confirm: "blur" });
    expect(`.o_notification`).toHaveCount(1);
...
test(`multi edit list view: mousedown on "Discard" with invalid field`, async () => {
    ...
    await contains(`.o_data_row:eq(0) .o_data_cell`).click();
    await contains(`.o_data_row:eq(0) .o_data_cell input`).edit("eee", { confirm: false });
    ...
    await contains(`.o_data_row:eq(0) .o_data_cell`).click();
    await contains(`.o_data_row:eq(0) .o_data_cell input`).edit("eee2", { confirm: false });
