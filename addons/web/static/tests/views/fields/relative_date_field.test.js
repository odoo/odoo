...
test("RelativeDateField on a date field in list view", async () => {
    ...
    Partner._records = [
        ...
        { id: 19, date: "2019-09-09" }, // + 23 months
        { id: 20, date: "2015-11-09" }, // - 23 months
        { id: 21, date: "2020-10-09" }, // + 3 year
        { id: 22, date: "2014-10-07" }, // - 3 year
    ];
    ...
    expect(cells[18]).toHaveText("In 23 months");
    expect(cells[19]).toHaveText("23 months ago");
    expect(cells[20]).toHaveText("In 3 years");
    expect(cells[21]).toHaveText("3 years ago");
