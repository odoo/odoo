...
QUnit.module("Fields", (hooks) => {
    ...
    QUnit.test("Many2One 'View all' updates on resModel change", async function (assert) {
        ...
        await click(target.querySelector("div.o_field_reference"), ".o_m2o_dropdown_option_view_all");
