    ...
    _records = [
        {
            ...
            product_id: 37,
            properties: [
                { name: "f80b6fb58d0d4c72", type: "integer", string: "prop 1", value: 3 },
                { name: "7424643eee1f3655", type: "many2one", string: "prop 2", comodel: "product", value: 41 },
            ],
    ...
    _records = [
        {
            ...
            properties_definitions: [
                ...
                { name: "7424643eee1f3655", type: "many2one", string: "prop 2", comodel: "product" },
            ],
        },
        { id: 41, name: "xpad" },
    ];
...
test("dynamic placeholder properties", async () => {
    ...
    expect(value).toBe("{{object._read_property('properties', '7424643eee1f3655').name}}");
});
