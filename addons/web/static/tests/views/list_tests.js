...
QUnit.module('Views', {
    ...
    QUnit.test('use default_order on editable tree: sort on demand', function (assert) {
        ...
        assert.equal(form.$('tbody tr:first').text(), 'Value 1',
            "Value 1 should be first");
        assert.equal(form.$('tbody tr:eq(1)').text(), 'Value 2',
            "Value 2 should be second (should be sorted after saving)");
        assert.equal(form.$('tbody tr:eq(2)').text(), 'Value 3',
            "Value 3 should be third");

        $o2m.find('.o_column_sortable').click();
        assert.equal(form.$('tbody tr:first').text(), 'Value 3',
            "Value 3 should be first");
        assert.equal(form.$('tbody tr:eq(1)').text(), 'Value 2',
            "Value 2 should be second (should be sorted after saving)");
        assert.equal(form.$('tbody tr:eq(2)').text(), 'Value 1',
    ...
    QUnit.test('use default_order on editable tree: sort on demand in page', function (assert) {
        ...
        assert.equal(form.$('tbody tr:first').text(), 'Value 44',
            "record 44 should be first");
        assert.equal(form.$('tbody tr:eq(4)').text(), 'Value 48',
            "record 48 should be last");

        form.$('.o_column_sortable').click();
        assert.equal(form.$('tbody tr:first').text(), 'Value 08',
            "record 48 should be first");
        assert.equal(form.$('tbody tr:eq(4)').text(), 'Value 04',
            "record 44 should be first");
