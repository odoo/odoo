...
QUnit.module("CalendarYearRenderer", ({ beforeEach }) => {
    ...
    QUnit.test("display events", async (assert) => {
        ...
        assert.verifySteps([
            "2021-07-15 allDay:true no event",
            "2021-07-16 1 day, all day in July",
            "2021-07-17 allDay:true no event",
        ]);
        ...
        assert.verifySteps([
            ...
            "2021-07-21 allDay:true no event",
        ]);
        ...
        assert.verifySteps([
            "2021-06-28 allDay:true no event",
            ...
            "2021-07-04 allDay:true no event",
        ]);
    });
