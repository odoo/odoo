...
QUnit.module('Views', (hooks) => {
    ...
    QUnit.skip('simple readonly list', async function (assert) {
        ...
        assert.strictEqual($(list.el).find('thead th:nth(2)').css('text-align'), 'right',
            "header cells of integer fields should be right aligned");
        assert.strictEqual($(list.el).find('tbody tr:first td:nth(2)').css('text-align'), 'right',
    ...
    QUnit.skip('export feature in list for users not in base.group_allow_export', async function (assert) {
        assert.expect(5);
    ...
    QUnit.skip('list view with adjacent buttons and invisible field (modifier)', async function (assert) {
        assert.expect(2);
    ...
    QUnit.skip('list view: action button executes action on click: buttons are disabled and re-enabled', async function (assert) {
        assert.expect(3);
    ...
    QUnit.skip('list view: buttons handler is called once on double click', async function (assert) {
        assert.expect(2);
    ...
    QUnit.skip('list view: action button executes action on click: correct parameters', async function (assert) {
        assert.expect(4);
    ...
    QUnit.skip('list view: action button executes action on click with domain selected: correct parameters', async function (assert) {
        assert.expect(10);
    ...
    QUnit.skip('do not perform extra RPC to read invisible many2one fields', async function (assert) {
        assert.expect(3);
    ...
    QUnit.skip('discard a new record in editable="top" list with less than 4 records', async function (assert) {
        assert.expect(7);
    ...
    QUnit.skip('basic grouped list rendering 7 cols with aggregates and selector', async function (assert) {
        assert.expect(4);
    ...
    QUnit.skip('editing a record should change same record in other groups when grouped by m2m field', async function (assert) {
        assert.expect(4);
    ...
    QUnit.skip('change a record field in readonly should change same record in other groups when grouped by m2m field', async function (assert) {
        assert.expect(6);
    ...
    QUnit.skip('editable list view: click on last element after creation empty new line', async function (assert) {
        assert.expect(1);
    ...
    QUnit.skip('editable list view: save data when list sorting in edit mode', async function (assert) {
        assert.expect(3);
    ...
    QUnit.skip('Row selection checkbox can be toggled by clicking on the cell', async function (assert) {
        assert.expect(9);
    ...
    QUnit.skip('column widths should depend on the content when there is data', async function (assert) {
        assert.expect(1);
    ...
    QUnit.skip('width of some of the fields should be hardcoded if no data', async function (assert) {
        const assertions = [
    ...
    QUnit.skip('width of some fields should be hardcoded if no data, and list initially invisible', async function (assert) {
        const assertions = [
            { field: 'bar', expected: 70, type: 'Boolean' },
            { field: 'int_field', expected: 74, type: 'Integer' },
            { field: 'qux', expected: 92, type: 'Float' },
    ...
    QUnit.skip('empty editable list with the handle widget and no content help', async function (assert) {
        assert.expect(4);
    ...
    QUnit.skip('editable list: list view in an initially unselected notebook page', async function (assert) {
        assert.expect(5);
    ...
    QUnit.skip('editable list view, click on m2o dropdown do not close editable row', async function (assert) {
        assert.expect(2);
    ...
    QUnit.skip('width of some of the fields should be hardcoded if no data (grouped case)', async function (assert) {
        const assertions = [
            { field: 'bar', expected: 70, type: 'Boolean' },
            { field: 'int_field', expected: 74, type: 'Integer' },
            { field: 'qux', expected: 92, type: 'Float' },
    ...
    QUnit.skip('columns with an absolute width are never narrower than that width', async function (assert) {
        assert.expect(2);
    ...
    QUnit.skip('row height and width should not change when switching mode', async function (assert) {
        // Warning: this test is css dependant
        assert.expect(5);
    ...
    QUnit.skip('deleting record which throws UserError should close confirmation dialog', async function (assert) {
        assert.expect(3);
    ...
    QUnit.skip('use default_order on editable tree: sort on demand in page', async function (assert) {
        assert.expect(4);
    ...
    QUnit.skip('bounce create button when no data and click on empty area', async function (assert) {
        assert.expect(4);
    ...
    QUnit.skip("non empty editable list with sample data: delete all records", async function (assert) {
        assert.expect(7);
    ...
    QUnit.skip("empty editable list with sample data: start create record and cancel", async function (assert) {
        assert.expect(10);
    ...
    QUnit.skip("empty editable list with sample data: create and delete record", async function (assert) {
        assert.expect(13);
    ...
    QUnit.skip('groupby node with a button with modifiers using a many2one', async function (assert) {
        assert.expect(5);
    ...
    QUnit.skip('invisible attrs on fields are re-evaluated on field change', async function (assert) {
        assert.expect(7);
    ...
    QUnit.skip('readonly attrs on fields are re-evaluated on field change', async function (assert) {
        assert.expect(9);
    ...
    QUnit.skip('required attrs on fields are re-evaluated on field change', async function (assert) {
        assert.expect(7);
    ...
    QUnit.skip('modifiers of other x2many rows a re-evaluated when a subrecord is updated', async function (assert) {
    ...
    QUnit.skip('execute ActionMenus actions with correct params (single page)', async function (assert) {
        assert.expect(12);
    ...
    QUnit.skip('execute ActionMenus actions with correct params (multi pages)', async function (assert) {
        assert.expect(13);
    ...
    QUnit.skip('pressing TAB in editable list with several fields [REQUIRE FOCUS]', async function (assert) {
        assert.expect(6);
    ...
    QUnit.skip('pressing SHIFT-TAB in editable list with several fields [REQUIRE FOCUS]', async function (assert) {
        assert.expect(6);
    ...
    QUnit.skip('navigation with tab and readonly field (with modification)', async function (assert) {
        // This test makes sure that if we have 2 cells in a row, the first in
        // edit mode, and the second one readonly, then if we press TAB when the
    ...
    QUnit.skip('edition, then navigation with tab (with a readonly field)', async function (assert) {
        // This test makes sure that if we have 2 cells in a row, the first in
    ...
    QUnit.skip('edition, then navigation with tab (with a readonly field and onchange)', async function (assert) {
    ...
    QUnit.skip('pressing SHIFT-TAB in editable list with a readonly field [REQUIRE FOCUS]', async function (assert) {
        assert.expect(4);
    ...
    QUnit.skip('pressing SHIFT-TAB in editable list with a readonly field in first column [REQUIRE FOCUS]', async function (assert) {
        assert.expect(4);
    ...
    QUnit.skip('pressing SHIFT-TAB in editable list with a readonly field in last column [REQUIRE FOCUS]', async function (assert) {
        assert.expect(4);
    ...
    QUnit.skip('navigation: moving right with keydown from text field does not move the focus', async function (assert) {
        assert.expect(6);
    ...
    QUnit.skip('discarding changes in a row properly updates the rendering', async function (assert) {
        assert.expect(3);
    ...
    QUnit.skip('grouped list with another grouped list parent, click unfold', async function (assert) {
        assert.expect(3);
    ...
    QUnit.skip('pressing ESC discard the current line changes (with required)', async function (assert) {
        assert.expect(4);
    ...
    QUnit.skip('list with handle widget, create and move should keep empty lines at last', async function (assert) {
    ...
    QUnit.skip('multi edit field with daterange widget (edition without using the picker)', async function (assert) {
        assert.expect(4);
    ...
    QUnit.skip('editable list view: non dirty record with required fields', async function (assert) {
        assert.expect(10);
    ...
    QUnit.skip('editable list view: multi edition error and cancellation handling', async function (assert) {
        assert.expect(12);
    ...
    QUnit.skip('editable list view: multi edition of many2one: set same value', async function (assert) {
        assert.expect(4);
    ...
    QUnit.skip('editable list view: clicking on "Discard changes" in multi edition', async function (assert) {
        assert.expect(2);
    ...
    QUnit.skip('editable list view (multi edition): mousedown on "Discard", but mouseup somewhere else', async function (assert) {
        assert.expect(1);
    ...
    QUnit.skip('editable list view (multi edition): writable fields in readonly (force save)', async function (assert) {
        assert.expect(7);
    ...
    QUnit.skip('editable list view: multi edition with readonly modifiers', async function (assert) {
        assert.expect(5);
    ...
    QUnit.skip('editable list view: multi edition when the domain is selected', async function (assert) {
        assert.expect(1);
    ...
    QUnit.skip('editable list view: multi edition: edit and validate last row', async function (assert) {
        assert.expect(3);
    ...
    QUnit.skip('editable readonly list view: single edition does not behave like a multi-edition', async function (assert) {
        assert.expect(3);
    ...
    QUnit.skip('editable list with many2one: click out does not discard the row', async function (assert) {
    ...
    QUnit.skip('editable list alongside html field: click out to unselect the row', async function (assert) {
        assert.expect(5);
    ...
    QUnit.skip('list view move to previous page when all records from last page deleted', async function (assert) {
        assert.expect(5);
    ...
    QUnit.skip('grouped list view move to previous page of group when all records from last page deleted', async function (assert) {
        assert.expect(7);
    ...
    QUnit.skip('list view move to previous page when all records from last page archive/unarchived', async function (assert) {
        assert.expect(9);
    ...
    QUnit.skip('list with handle field, override default_get, bottom when inline', async function (assert) {
        assert.expect(2);
    ...
    QUnit.skip('control panel buttons in multi editable grouped list views', async function (assert) {
        assert.expect(8);
    ...
    QUnit.skip('add and discard a record in a multi-level grouped list view', async function (assert) {
        assert.expect(7);
    ...
    QUnit.skip('inputs are disabled when unselecting rows in grouped editable', async function (assert) {
        assert.expect(1);
    ...
    QUnit.skip('pressing ESC in editable grouped list should discard the current line changes', async function (assert) {
        assert.expect(6);
    ...
    QUnit.skip('pressing SHIFT-TAB in editable grouped list with create="0"', async function (assert) {
        assert.expect(6);
    ...
    QUnit.skip('editing then pressing TAB (with a readonly field) in grouped list', async function (assert) {
        assert.expect(6);
    ...
    QUnit.skip('pressing ENTER in editable grouped list view with create=0', async function (assert) {
        assert.expect(10);
    ...
    QUnit.skip('add and discard a line through keyboard navigation without crashing', async function (assert) {
        assert.expect(2);
    ...
    QUnit.skip('optional fields do not disappear even after listview reload', async function (assert) {
        assert.expect(7);
    ...
    QUnit.skip('open list optional fields dropdown position to right place', async function (assert) {
        assert.expect(1);
    ...
    QUnit.skip('list view with optional fields rendering and local storage mock', async function (assert) {
        assert.expect(12);
    ...
    QUnit.skip('resize column with x2many list with several fields in form notebook', async function (assert) {
        assert.expect(1);
    ...
    QUnit.skip('list view with field component: mounted and willUnmount calls', async function (assert) {
    ...
    QUnit.skip('edition, then navigation with tab (with a readonly re-evaluated field and onchange)', async function (assert) {
    ...
    QUnit.skip('selecting a row after another one containing a table within an html field should be the correct one', async function (assert) {
        assert.expect(1);
