...
QUnit.module("Form Compiler", (hooks) => {
        ...
        const expected = /*xml*/ `
            <t>
                <div t-attf-class="{{props.readonly ? 'o_form_readonly' : 'o_form_editable'}}" class="o_form_nosheet">
                    <div class="someClass">
                        lol
                        <Field id="&quot;field_display_name_0&quot;" name="&quot;display_name&quot;" record="record" archs="&quot;views&quot; in props.fields.display_name and props.fields.display_name.views" t-att-class="{   o_readonly_modifier: false , o_required_modifier: false , o_field_empty: isFieldEmpty(record,&quot;display_name&quot;, &quot;null&quot;) }" readonly="false or null === 'readonly' or isFieldReadonly(record,&quot;display_name&quot;,&quot;null&quot;,props.readonly)" required="false"/>
                    </div>
                </div>
            </t>`;
                ...
                <table class="o_group o_inner_group o_group_col_6">
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 100%">
                                <Field id="&quot;field_charfield_1&quot;" name="&quot;charfield&quot;" record="record" archs="&quot;views&quot; in props.fields.charfield and props.fields.charfield.views" t-att-class="{   o_readonly_modifier: false , o_required_modifier: false , o_field_empty: isFieldEmpty(record,&quot;charfield&quot;, &quot;null&quot;) }" readonly="false or null === 'readonly' or isFieldReadonly(record,&quot;charfield&quot;,&quot;null&quot;,props.readonly)" required="false"/>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    QUnit.test("properly compile field with placeholder", async (assert) => {
        ...
        const expected = /*xml*/ `
        <Field id="&quot;field_display_name_0&quot;" name="&quot;display_name&quot;" record="record" archs="&quot;views&quot; in props.fields.display_name and props.fields.display_name.views" t-att-class="{   o_readonly_modifier: false , o_required_modifier: false , o_field_empty: isFieldEmpty(record,&quot;display_name&quot;, &quot;null&quot;) }" readonly="false or null === 'readonly' or isFieldReadonly(record,&quot;display_name&quot;,&quot;null&quot;,props.readonly)" required="false" placeholder="&quot;e.g. Contact's Name or //someinfo...&quot;"/>
        `;
