...
QUnit.module("Views", (hooks) => {
    ...
    QUnit.skip("duplicate fields rendered properly (one2many)", async function (assert) {
        ...
        assert.hasClass(
            form.$("div.o_field_one2many:eq(1)"),
            "o_readonly_modifier",
    ...
    QUnit.skip("invisible attrs on first notebook page", async function (assert) {
        ...
        assert.doesNotHaveClass(
            form.$(".o_notebook .nav .nav-item:first()"),
            "o_invisible_modifier"
        );
    ...
    QUnit.skip("invisible attrs on notebook page which has only one page", async function (assert) {
        assert.expect(4);
        ...
        assert.notOk(
            form.$(".o_notebook .nav .nav-link:first()").hasClass("active"),
            "first tab should not be active"
        );
        assert.ok(
            form.$(".o_notebook .nav .nav-item:first()").hasClass("o_invisible_modifier"),
    ...
    QUnit.skip("first notebook page invisible", async function (assert) {
        assert.expect(2);
        ...
        assert.notOk(
            form.$(".o_notebook .nav .nav-item:first()").is(":visible"),
            "first tab should be invisible"
        );
        assert.hasClass(form.$(".o_notebook .nav .nav-link:nth(1)"), "active");
    });

    QUnit.skip("hide notebook element if all pages hidden", async function (assert) {
        assert.expect(4);
        ...
        assert.ok(
            form.$(".o_notebook .nav li:not(.o_invisible_modifier)").length,
            "there should be visible page"
        );
        assert.notOk(
            form.$(".o_notebook .nav").hasClass("o_invisible_modifier"),
    ...
    QUnit.skip(
        "required fields should have o_required_modifier in readonly mode",
        async function (assert) {
            assert.expect(2);
    ...
    QUnit.skip("separators", async function (assert) {
        assert.expect(1);
    ...
    QUnit.skip("invisible attrs on separators", async function (assert) {
        assert.expect(1);
    ...
    QUnit.skip("onchange send only the present fields to the server", async function (assert) {
        assert.expect(1);
    ...
    QUnit.skip("nolabel", async function (assert) {
        ...
        assert.strictEqual(
            form.$("label.o_form_label").first().text(),
            "Product",
            "one should be the one for the product field"
        );
        assert.strictEqual(
            form.$("label.o_form_label").eq(1).text(),
            "Bar",
            "one should be the one for the bar field"
        );

        assert.hasAttrValue(
            form.$(".firstgroup td").first(),
            "colspan",
            undefined,
    ...
    QUnit.skip("properly apply onchange on one2many fields", async function (assert) {
        ...
        assert.strictEqual(
            form.$(".o_field_one2many .o_data_row td:first").text(),
            "aaa",
        ...
        assert.strictEqual(
            $o2m.find(".o_data_row:first td:first").text(),
            "updated record",
            "the 'display_name' of the first one2many record should have been updated"
        );
        assert.strictEqual(
            $o2m.find(".o_data_row:nth(1) td:first").text(),
            "created record",
    ...
    QUnit.skip("properly apply onchange on many2many fields", async function (assert) {
        ...
        assert.strictEqual(
            $m2m.find(".o_data_row:first td:first").text(),
            "gold",
            "the 'display_name' of the first m2m record should be correctly displayed"
        );
        assert.strictEqual(
            $m2m.find(".o_data_row:nth(1) td:first").text(),
            "silver",
    ...
    QUnit.skip("onchanges on date(time) fields", async function (assert) {
        ...
        assert.strictEqual(
            form.$(".o_field_widget[name=date]").text(),
            "01/25/2017",
            "the initial date should be correct"
        );
        assert.strictEqual(
            form.$(".o_field_widget[name=datetime]").text(),
            "12/12/2016 12:55:05",
        ...
        assert.strictEqual(
            form.$(".o_field_widget[name=date] input").val(),
            "01/25/2017",
            "the initial date should be correct in edit"
        );
        assert.strictEqual(
            form.$(".o_field_widget[name=datetime] input").val(),
            "12/12/2016 12:55:05",
    ...
    QUnit.skip("discarding before save returns", async function (assert) {
        ...
        assert.strictEqual(
            form.$('.o_field_widget[name="foo"]').val(),
            "1234",
    ...
    QUnit.skip(
        ...
        async function (assert) {
            ...
            assert.strictEqual(
                form.$(".o_data_row input:first").val(),
                "[blip] 77",
    ...
    QUnit.skip(
        ...
        async function (assert) {
            ...
            await testUtils.nextTick();
            assert.strictEqual(
                form.$(".o_data_row:nth(1) td:first").text(),
                "[blip] 14",
                "onchange should have been correctly applied after default get"
            );
        }
    ...
    QUnit.skip("diplay a stat button outside a buttonbox", async function (assert) {
        ...
        assert.strictEqual(
            form.$("button .o_field_widget").children().length,
            2,
            "the field widget should have 2 children, the text and the value"
        );
        assert.strictEqual(
            parseInt(form.$("button .o_field_widget .o_stat_value").text()),
            9,
    ...
    QUnit.skip("diplay something else than a button in a buttonbox", async function (assert) {
        ...
        assert.strictEqual(
            form.$(".oe_button_box").children().length,
            2,
    ...
    QUnit.skip("oe_read_only className is handled in list views", async function (assert) {
        ...
        assert.isVisible(
            form.$('.o_field_one2many .o_list_view thead th[data-name="display_name"]'),
    ...
    QUnit.skip("open new record even with warning message", async function (assert) {
        ...
        assert.strictEqual(form.$("input").val(), "", "input should have no value after reload");
    });
    ...
    QUnit.skip(
        ...
        async function (assert) {
            ...
            assert.notStrictEqual(
                document.activeElement,
                form.$('.o_field_many2one[name="trululu"] .o_input'),
    ...
    QUnit.skip("display toolbar", async function (assert) {
        ...
        assert.strictEqual(
            form.$(".o_cp_action_menus .dropdown-item:last").text().trim(),
            "Action partner",
    ...
    QUnit.skip("check interactions between multiple FormViewDialogs", async function (assert) {
        ...
        assert.strictEqual(
            $firstModal.find("tr.o_data_row td").text(),
            "xtv",
    ...
    QUnit.skip(
        ...
        async function (assert) {
            ...
            assert.strictEqual(
                form.$(".o_notebook .nav-item:not(.o_invisible_modifier)").length,
                2,
                "both tabs should be visible"
            );
            assert.hasClass(
                form.$(".o_notebook .nav-link:first"),
                "active",
                "first tab should be active"
            );
            ...
            assert.hasClass(
                form.$(".o_notebook .nav-item:not(.o_invisible_modifier) .nav-link"),
                "active",
            ...
            assert.hasClass(
                form.$(".o_notebook .nav-link:nth(1)"),
                "active",
    ...
    QUnit.skip("default_order on x2many embedded view", async function (assert) {
        ...
        assert.ok(
            form.$(".o_field_one2many tbody tr:first td:contains(yop)").length,
        ...
        // client-side sort
        assert.ok(
            form.$(".o_field_one2many tbody tr:eq(0) td:contains(zop)").length,
            "record zop should be first"
        );
        assert.ok(
            form.$(".o_field_one2many tbody tr:eq(1) td:contains(yop)").length,
            "record yop should be second"
        );
        assert.ok(
            form.$(".o_field_one2many tbody tr:eq(2) td:contains(xop)").length,
        ...
        assert.ok(
            form.$(".o_field_one2many tbody tr:eq(1) td:contains(zop)").length,
    ...
    QUnit.skip("form group with newline tag inside", async function (assert) {
        ...
        // Outer group
        assert.ok(
            form.$(".bottom_group").position().top - form.$(".top_group").position().top >= 200,
    ...
    QUnit.skip("buttons are disabled until status bar action is resolved", async function (assert) {
        ...
        assert.strictEqual(
            form.$(".o_form_statusbar button:not(:disabled)").length,
            2,
            "status bar buttons should be enabled"
        );
        assert.strictEqual(
            form.$(".oe_button_box button:not(:disabled)").length,
            1,
    ...
    QUnit.skip(
        ...
        async function (assert) {
            ...
            assert.ok(
                form.$(".o_statusbar_buttons button").prop("disabled"),
    ...
    QUnit.skip("readonly fields are not sent when saving", async function (assert) {
        ...
        await testUtils.dom.click(form.$(".o_data_row"));
        assert.strictEqual(
            $(".modal .o_field_widget[name=foo]").text(),
            "foo value",
    ...
    QUnit.skip("reload event is handled only once", async function (assert) {
        ...
        assert.strictEqual(
            $(".modal .o_field_widget[name=trululu] input").val(),
            "new name",
    ...
    QUnit.skip("can toggle column in x2many in sub form view", async function (assert) {
        ...
        await testUtils.dom.click(form.$(".o_external_button"));
        assert.strictEqual(
            $(".modal-body .o_form_view .o_list_view .o_data_cell").text(),
            "yopblip",
    ...
    QUnit.skip("support header button as widgets on form statusbar", async function (assert) {
        ...
        assert.strictEqual(
            form.$("span.o_attach_document").text().trim(),
            "Attach document",
            "widget should have been instantiated"
        );
    });
    ...
    QUnit.skip(
        ...
        async function (assert) {
            ...
            assert.strictEqual(
                form.$(".o_field_widget[name=text_field]").height(),
                height,
    ...
    QUnit.skip("keep editing after call_button fail", async function (assert) {
        ...
        await testUtils.dom.clickLast(
            form.$(".o_form_view .o_field_one2many .o_data_row .o_data_cell")
        );
        await testUtils.nextTick();
        await testUtils.fields.many2one.clickOpenDropdown("product_id");
        await testUtils.fields.many2one.clickHighlightedItem("product_id");
    ...
    QUnit.skip(
        ...
        async function (assert) {
            ...
            assert.strictEqual(
                form.$(".o_field_widget[name=display_name]").val(),
                "",
    ...
    QUnit.skip(
        ...
        async function (assert) {
            ...
            assert.ok(form.$("th:contains(Foo)").is(":visible"), "should have a visible foo field");

            assert.notOk(
                form.$("th:contains(Bar)").is(":visible"),
            ...
            assert.ok(form.$("th:contains(Bar)").is(":visible"), "should have a visible bar field");
        }
    );
    ...
    QUnit.skip(
        ...
        async function (assert) {
            ...
            assert.notOk(
                form.$("th:contains(Foo)").is(":visible"),
    ...
    QUnit.skip(
        ...
        async function (assert) {
            ...
            assert.strictEqual(
                $(".tooltip .oe_tooltip_help").text().trim(),
    ...
    QUnit.skip(
        ...
        async function (assert) {
            ...
            assert.strictEqual(
                document.activeElement,
                form.$('.o_field_cell[name="foo"] input')[0]
            );
        }
    );
