...
class PaymentAcquirer(models.Model):
    ...
    auto_confirm = fields.Selection([
        ...
        ('authorize', 'Authorize the amount and confirm the SO on acquirer confirmation (capture at shipping)'),
        ('confirm_so', 'Authorize & capture the amount and confirm the SO on acquirer confirmation'),
        ('generate_and_pay_invoice', 'Authorize & capture the amount, confirm the SO on acquirer confirmation, and auto-generate the invoice and its payment')],
