...
class PaymentAcquirer(models.Model):
    ...
    pending_msg = fields.Html(
        ...
        default=lambda s: _('<i>Pending...</i> Your payment is waiting for approval. The order will be confirmed at the payment validation.'),
        help='Message displayed, if order is in pending state after having done the payment process.')
    done_msg = fields.Html(
        'Done Message', translate=True,
        default=lambda s: _('<i>Done!</i> Your payment has been successfully processed. Thank you for your order!'),
    ...
    cancel_msg = fields.Html(
        ...
        default=lambda s: _('<i>Cancelled...</i> Your payment has been cancelled.'),
        help='Message displayed, if order is cancel during the payment process.')
    error_msg = fields.Html(
        'Error Message', translate=True,
        default=lambda s: _('<i>Error...</i> An error occurred during the transaction. The order is pending. Do not hesitate to contact us for any question on the status of your order.'),
