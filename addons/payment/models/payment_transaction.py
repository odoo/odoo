...
class PaymentTransaction(models.Model):
    ...
    def action_void(self):
        ...
        if self.state != 'authorized':
            return payment_utils.get_danger_notification_action(
        ...
        captured_amount = sum(child_tx.amount for child_tx in self.child_transaction_ids.filtered(
    ...
    def action_refund(self, amount_to_refund=None):
        ...
        refund_tx = self._send_refund_request(amount_to_refund=amount_to_refund)
    ...
    def _get_failed_tx_notification_action(self):
        ...
        return payment_utils.get_danger_notification_action(msg)
    ...
    def _send_capture_request(self, amount_to_capture=None):
        ...
        :return: The created capture child transaction, if any or source tx.
    ...
    def _send_void_request(self, amount_to_void=None):
        ...
        :return: The created void child transaction, if any or source tx.
        :rtype: `payment.transaction`
        """
        self.ensure_one()
        self._ensure_provider_is_not_disabled()
