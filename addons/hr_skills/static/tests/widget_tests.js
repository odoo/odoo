odoo.define('hr_skills.field_one_to_many_group_tests', function (require) {
    ...
    QUnit.module('skills_widgets', {
        ...
        QUnit.test('Resumes one2many field group by field render', async function (assert) {
            assert.expect(16);
        ...
        QUnit.test('Resumes one2many field group by field create', async function (assert) {
            assert.expect(5);
            var form = await createView({
                View: FormView,
                model: 'partner',
        ...
        QUnit.test('Resumes one2many field group by field delete', async function (assert) {
            assert.expect(2);
            var form = await createView({
                View: FormView,
                model: 'partner',
