...
class HrResumeLine(models.Model):
    ...
    date_start = fields.Date(required=True, compute='_compute_date_start', readonly=False, store=True)
    ...
    def _compute_is_social_media(self):
        ...
        for line in self:
            if social_media_type and line.line_type_id == social_media_type:
    ...
    def _compute_date_start(self):
        for line in self:
            if line.is_social_media:
                line.date_start = fields.Date.context_today(line)
