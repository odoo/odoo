...
class Employee(models.Model):
    ...
    resume_line_ids = fields.One2many('hr.resume.line', 'employee_id', string="Resumes lines")
...
class ResumeLine(models.Model):
    ...
    _description = "Resumes line of an employee"
...
class ResumeLineType(models.Model):
    ...
    _description = "Type of a Resumes line"
    _order = "sequence"
