...
This module introduces skills and resume management for employees.
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'hr_skills/static/src/views/certification_plugin.js',
            'hr_skills/static/src/views/certification_list_renderer.js',
            'hr_skills/static/src/views/certification_list_renderer.xml',
