...
class AccountMove(models.Model):
    ...
    l10n_bg_document_type = fields.Selection(string="Document Type (BG)", selection='_l10n_bg_document_type_selection_values',
                                             compute='_compute_l10n_bg_document_type', readonly=False, store=True,  copy=False)
    ...
    @api.depends('journal_id', 'move_type', 'state')
