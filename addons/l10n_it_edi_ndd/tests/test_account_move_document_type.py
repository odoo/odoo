...
class TestItAccountMoveDocumentType(TestItEdi):
    ...
    def test_td07_incomplete_address_error(self):
        """Test that setting document type as TD07 for a partner with complete address raise an error."""
        invoice = self.init_invoice("out_invoice", partner=self.italian_partner_a, amounts=[100])
