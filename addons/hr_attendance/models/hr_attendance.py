...
class HrAttendance(models.Model):
    ...
    validated_overtime_hours = fields.Float(string="Validated Extra Hours", compute='_compute_validated_overtime_hours', inverse='_inverse_validated_overtime_hours', tracking=True, store=True, readonly=False)
