...
||||||| f84eeb3ed1421e0cc07c906ff6444734dc01d35f
...
>>>>>>> c661be9693e520363efb767c61acff606d9716a9
    ...
    def _cron_auto_check_out(self):
        def check_in_tz(attendance):
            ...
            return attendance.check_in.astimezone(ZoneInfo(attendance.employee_id._get_version(attendance.date)._get_tz()))
        ...
        for company in all_companies:
            ...
            for att in to_verify_company:
                ...
                employee_timezone = ZoneInfo(att.employee_id._get_version(att.date)._get_tz())
