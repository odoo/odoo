    ...
    def _compute_worked_hours(self):
        for attendance in self:
            if attendance.check_out and attendance.check_in and attendance.employee_id:
                ...
                lunch_intervals = attendance.employee_id._get_expected_attendances(check_in_tz, check_out_tz, lunch=True)
                    ...
                    # The employee usually work on that day
                        ...
                        for attendance in attendances:
                            ...
                            if local_check_in <= planned_end_dt and local_check_out >= planned_start_dt:
                                ...
                                lunch_intervals = emp._get_expected_attendances(start_dt, stop_dt, lunch=True)
