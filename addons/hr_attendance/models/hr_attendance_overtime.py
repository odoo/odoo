...
class HrAttendanceOvertime(models.Model):
    ...
    def init(self):
        ...
        self.env.cr.execute(f"CREATE UNIQUE INDEX IF NOT EXISTS hr_attendance_overtime_unique_employee_per_day ON {self._table} (employee_id, date) WHERE adjustment is false")
