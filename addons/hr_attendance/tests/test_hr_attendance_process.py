...
class TestHrAttendance(TransactionCase):
    ...
    def test_break_duration_checkout_action(self):
        self.test_employee.company_id.attendance_break_management = True
    ...
    def test_break_duration_ignored_when_management_disabled(self):
        self.test_employee.company_id.attendance_break_management = False
        with freeze_time("2024-01-02 08:00:00"):
            self.test_employee._attendance_action_change()
        with freeze_time("2024-01-02 17:00:00"):
            self.test_employee._attendance_action_change(break_duration=0.75)
        self.assertFalse(self.test_employee.last_attendance_id.break_duration)
