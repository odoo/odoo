...
class HrAttendance(http.Controller):
    ...
    def _get_multi_company_employees_infos(
        self,
        limit,
        offset,
        domain,
    ...
    def manual_selection_with_geolocation(self, token, employee_id, pin_code, latitude=False, longitude=False, **kwargs):
        ...
        if company:
            ...
            is_company_allowed = (
                employee_company == company
                or employee_company in allowed_company_ids
            )
            if (
                is_company_allowed
                and (
    ...
    def employees_infos(self, token, limit, offset, domain, **kwargs):
        ...
        if allowed_company_ids:
            return self._get_multi_company_employees_infos(
                limit,
                offset,
                domain,
                allowed_company_ids,
