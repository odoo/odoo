...
class MailThread(models.AbstractModel):
    ...
    def _notify_record_by_sms(self, message, recipients_data, msg_vals=False, sms_content=None,
        ...
        :param sms_content: Text to use as sms content, mainly to avoid
          conversion glitches by splitting html and plain text content formatting
          (e.g.: links, styling.).
          If not given, the message `body` is used and converted from html to plaintext;
