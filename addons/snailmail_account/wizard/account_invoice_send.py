...
class AccountInvoiceSend(models.TransientModel):
    ...
    snailmail_is_letter = fields.Boolean('Send by Post', help='Allows to send the document by snail mail (coventional posting delivery service)', default=lambda self: self.env['res.company']._get_current_company().invoice_is_snailmail)
