...
class IotBoxOwlHomePage(http.Controller):
    ...
    @route.iot_route('/hw_posbox_homepage/is_ngrok_enabled', type="http", linux_only=True)
    ...
    @route.iot_route(
        '/hw_posbox_homepage/generate_password', type="jsonrpc", methods=["POST"], cors='*', linux_only=True
    )
    ...
    @route.iot_route('/hw_posbox_homepage/enable_ngrok', type="jsonrpc", methods=['POST'], linux_only=True)
    ...
    @route.iot_route('/hw_posbox_homepage/disable_ngrok', type="jsonrpc", methods=['POST'], linux_only=True)
