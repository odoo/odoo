...
from odoo.addons.hw_drivers.tools import helpers, iot_system, route, wifi
...
class IotBoxOwlHomePage(http.Controller):
    ...
    @http.route('/' if not iot_system.IS_IOT_TEST else '/hw_posbox_homepage', auth='none', type='http')
    def index(self):
