...
from odoo.addons.hw_posbox_homepage.controllers.technical import SERVER_URL, IoTTechnicalPage, get_menu
...
class IoTBoxTechnicalListHandlersPage(http.Controller, IoTTechnicalPage):
    _menu = get_menu(__name__)

    @http.route(_menu.url, type='http', auth='none', website=True, csrf=False, save_session=False)
