...
from odoo.addons.hw_posbox_homepage.controllers.main import jinja_env
...
SIX_PAYMENT_TERMINAL_TEMPLATE = jinja_env.get_template('technical/six_payment_terminal.jinja2')
