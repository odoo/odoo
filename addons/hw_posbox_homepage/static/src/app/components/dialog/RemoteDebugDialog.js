        ...
        <BootstrapDialog identifier="'remote-debug-configuration'" btnName="'Remote debug'">
            ...
            <t t-set-slot="body">
                ...
                <div class="d-flex flex-row gap-2 mb-4">
                    <input placeholder="Password" t-att-value="this.state.password" class="form-control" />
                ...
                <div class="d-flex justify-content-end gap-2">
                    <button type="submit" class="btn btn-danger mt-2 btn-sm" t-on-click="restartIotBox">Restart IOT Box</button>
                    <button type="submit" class="btn btn-warning mt-2 btn-sm" t-on-click="restartOdooService">Restart Odoo Service</button>
