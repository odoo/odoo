...
class StatusPage extends Component {
    ...
    <div t-if="!state.loading" class="container-fluid">
        <div class="text-center pt-5">
            <img style="width: 150px" src="/web/static/img/logo2.png" alt="Odoo logo"/>
            <p class="mt-3" style="font-size: 25px">IoT Box: <t t-out="state.data.hostname"/></p>
        </div>
                ...
                <table class="table table-hover table-sm">
                    ...
                    <tbody>
                        <tr t-foreach="state.data.network_interfaces" t-as="interface" t-key="interface.id">
                            <td><i t-att-class="'me-1 fa fa-fw fa-' + (interface.is_wifi ? 'wifi' : 'sitemap')"/><t t-if="interface.ssid" t-out="interface.ssid"/></td>
