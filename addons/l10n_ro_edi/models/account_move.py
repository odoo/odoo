...
class AccountMove(models.Model):
    ...
    def _l10n_ro_edi_fetch_invoice_sent_documents(self):
        ...
        for invoice in invoices_to_fetch:
            ...
            if result['state_status'] != 'ok':  # Invoice refused
    ...
    def _l10n_ro_edi_fetch_invoices(self):
        ...
        nb_days = int(self.env['ir.config_parameter'].sudo().get_param('l10n_ro_edi_nb_days_to_fetch', default=1))
    ...
    def _l10n_ro_edi_process_bill_messages(self, received_bills_messages):
        ...
        for message in received_bills_messages:
            ...
            pdf = _request_ciusro_xml_to_pdf(self.env.company.with_context(render_anaf_pdf_type=inv_type), xml_attachment_raw)
            if 'error' in pdf:
