...
class AccountMove(models.Model):
    ...
    def _l10n_ro_edi_fetch_invoices(self):
        ...
        nb_days = self.env['ir.config_parameter'].sudo().get_param('l10n_ro_edi_nb_days_to_fetch', default=1)
    ...
    def _l10n_ro_edi_process_bill_messages(self, received_bills_messages):
        ...
        for message in received_bills_messages:
            ...
            validate_xml = "DA"
            pdf = _request_ciusro_xml_to_pdf(self.env.company, xml_attachment_raw, inv_type, validate_xml)
            if 'error' in pdf:
