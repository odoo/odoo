...
<<<<<<< saas-17.4:addons/l10n_ro_edi/controllers/main.py
        response = requests.post(
...
||||||| 3b95b61b076567e2ea8c2e39ea6874eb798f14c8:addons/l10n_ro_efactura/controllers/main.py
        response = requests.post(
            url='https://logincert.anaf.ro/anaf-oauth2/v1/token',
            data={
                'grant_type': 'authorization_code',
...
=======
        return request.redirect(url_join(request.httprequest.url_root, 'web'))
>>>>>>> fe1eb42a8823433279c0d5b6400a688c1cb8679a:addons/l10n_ro_efactura/controllers/main.py
