...
class PurchaseOrder(models.Model):
    ...
    report_grids = fields.Boolean(string="Show grids on reports", default=True, help="If set, the matrix of configurable products will be shown on the report of this order.")
