...
import {
    buildFilterNodesFromValues,
    getActiveFilterValuesById,
...
export class GlobalFilterWidget extends Component {
    ...
    async _updateGlobalFilter(globalFilters) {
        ...
        this.state.filtersAndValues = buildFilterNodesFromValues(
    ...
    onFilterChange(filterId, value) {
        ...
        if (!value || checkFilterValueIsValid(node.globalFilter, node.value)) {
            const global_filters = getActiveFilterValuesById(this.state.filtersAndValues);
...
registry
    ...
    .add("spreadsheet_dashboard.GlobalFilterWidget", GlobalFilterWidget);
