...
test("share dashboard from dashboard view", async function () {
    ...
    expect(".o_spreadsheet_share").toHaveText("localhost:8069/share/url/132465");
...
test("Changing filter values will create a new share", async function () {
    ...
    await contains("i.fa-share-alt").click();
    await animationFrame();
    expect(".o_spreadsheet_share").toHaveText(`localhost:8069/share/url/1`);
    ...
    await contains("i.fa-share-alt").click();
    await animationFrame();
    expect(".o_spreadsheet_share").toHaveText(`localhost:8069/share/url/2`);
});
