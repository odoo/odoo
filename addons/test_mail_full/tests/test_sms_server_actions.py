...
class TestServerAction(TestMailFullCommon, TestMailFullRecipients):
    ...
    def test_action_sms(self):
        ...
        self.assertSMS(self.test_record.customer_id, None, 'outgoing', content='Dear %s this is an SMS.' % self.test_record.display_name)
        self.assertSMS(self.env['res.partner'], self.test_numbers_san[0], 'outgoing', content='Dear %s this is an SMS.' % self.test_record_2.display_name)
