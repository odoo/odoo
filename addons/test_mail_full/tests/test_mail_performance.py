...
class TestPortalFormatPerformance(FullBaseMailPerformance, HttpCase):
    ...
    def setUpClass(cls):
        ...
        cls.comment_1 = cls.env['mail.message'].sudo().create([
            {
                'attachment_ids': [
                    (0, 0, {
                        'datas': 'data',
        ...
        cls.rating = cls.env['rating.rating'].sudo().create([
            {
                'consumed': True,
    ...
    def test_portal_message_format(self):
        ...
        record_messages_count = self.env["mail.message"].search_count(
        ...
        self.assertNotEqual(len(res["messages"]), record_messages_count)
        expected_data = {
            "data": {
                "MessageReactions": [
                    {
                ...
                "ir.attachment": [
                    {
                        ...
                        "name": "Test file",
                        "res_name": "TestRating",
                        "size": self.comment_1.attachment_ids.file_size,
                ...
                "mail.message": [
                    ...
                    },
                    {
                        ...
                        "is_discussion": True,
                        "is_note": False,
                        "linkPreviews": self.comment_1.link_preview_ids.ids,
                        "message_type": "comment",
                        "model": self.record._name,
                        "needaction": False,
                        "notifications": self.comment_1.notification_ids.ids,
                        "pinned_at": False,
