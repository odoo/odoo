...
class TestIrMailServerPersonal(MailCommon):
    ...
    def mock_mail_connect(self):
        original_connect = IrMail_Server.connect
        ...
        with patch.object(IrMail_Server, 'connect', autospec=True, wraps=IrMail_Server, side_effect=patched_connect):
            yield
    ...
    def test_personal_mail_server_allowed_post(self):
        ...
        # check that context key is properly set for send_email call
    ...
    def test_personal_mail_server_find_mail_server(self):
        ...
        # check _find_mail_server result
