...
#    }
    ...
    def process_partner(self, cr, uid, partner_id, context=None):
        partner = self.pool.get('account_followup.stat.by.partner').browse(cr, uid, partner_id, context=context)
        if partner.next_followup_level_id.phonecall:
            self.do_partner_phonecall(cr, uid, partner_id, context)
        if partner.next_followup_level_id.mail:
            self.do_partner_mail()
        if partner.next_followup_level_id.manual:
            self.do_partner_manual()

    def do_update_followup_level(self, cr, uid, to_update, context=None):
    ...
    def do_process(self, cr, uid, ids, context=None):
        ...
        self.do_update_followup_level(cr, uid, to_update, context=context)
        for partner in partner_list:
            process_partner(cr, uid, partner, context=context)
...
#    }
    ...
    def do_partner_mail(self, cr, uid, partner_ids, context=None):
        ...
        mail_template_id = self.pool.get('ir.model.data').get_object_reference(cr, uid, 'account_followup', 'email_template_account_followup', context=context)
