{
    ...
    'website': 'https://odoo.sunsoftbf.com',
    ...
    'assets': {
        'web.assets_frontend': [
            'payment_cinetpayV18/static/src/js/buy_now.js',
        ],
        'point_of_sale._assets_pos': [
            'payment_cinetpayV18/static/src/js/cinetpay_payment.js',
        ],
        'point_of_sale._assets': [
            'payment_cinetpayV18/static/src/js/cinetpay_pos.js',
        ],   },
    'installable': True,
    'auto_install': False,
    'application': True,
