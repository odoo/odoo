...
class PaymentAcquirerOgone(models.Model):
    ...
    ogone_pspid = fields.Char('PSPID', required_if_provider='ogone', groups='base.group_system')
    ogone_userid = fields.Char('API User ID', required_if_provider='ogone', groups='base.group_system')
    ogone_password = fields.Char('API User Password', required_if_provider='ogone', groups='base.group_system')
    ogone_shakey_in = fields.Char('SHA Key IN', size=32, required_if_provider='ogone', groups='base.group_system')
    ogone_shakey_out = fields.Char('SHA Key OUT', size=32, required_if_provider='ogone', groups='base.group_system')
