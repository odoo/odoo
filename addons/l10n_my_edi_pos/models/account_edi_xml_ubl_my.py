    ...
    def _export_invoice_constraints(self, invoice, vals):
        ...
        for line in invoice.invoice_line_ids.filtered(lambda invoice_line: invoice_line.display_type not in ('line_note', 'line_section')):
            ...
            if to_general_public:
                if f"myinvois_{line.id}_class_code_required" in constraints:
                    del constraints[f"myinvois_{line.id}_class_code_required"]
                if f"myinvois_{line.id}_class_code_required_line" in constraints:
                    del constraints[f"myinvois_{line.id}_class_code_required_line"]
