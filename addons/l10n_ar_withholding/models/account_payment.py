...
class AccountPayment(models.Model):
    ...
    def _synchronize_to_moves(self, changed_fields):
        ...
        for pay in self.with_context(
            ...
            line_ids = pay.line_ids.filtered(lambda x: x.account_id == pay.company_id.l10n_ar_tax_base_account_id or x.tax_line_id.mapped('l10n_ar_withholding_payment_type'))
            line_ids.unlink()
