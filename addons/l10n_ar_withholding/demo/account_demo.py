...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _post_load_demo_data(self, company=False):
        ...
        if company == self.env.ref('base.company_ri', raise_if_not_found=False):
            profits_wth_tax_119 = self.with_company(company).ref('ri_tax_withholding_profits_regimen_119_insc')
            ...
            earnings_wth_tax_78 = self.with_company(company).ref('ri_tax_withholding_profits_regimen_78_insc')
