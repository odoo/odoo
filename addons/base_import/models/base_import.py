...
class Base_ImportImport(models.TransientModel):
    ...
    def _get_mapping_suggestion(self, header, fields_tree, header_types, mapping_fields):
        ...
        if LANGUAGE_SEPARATOR in header:
            [header, *_] = header.split(LANGUAGE_SEPARATOR)
    ...
    def _convert_import_data(
        ...
        for row in rows_to_import:
            ...
            for index_col, value in enumerate(row):
                ...
                lang = import_lang_indices[index_col]
                if lang:
                    if value:
