...
class HrLeaveAttendanceReport(models.Model):
    ...
    attendance_ids = fields.Many2many("hr.attendance", string="Attedances", compute="_compute_leave_attendance_fields")
    ...
    def _select(self):
        return """
         SELECT row_number() OVER (ORDER BY gs.day, emp.id) AS id,
                gs.day::date AS date,
