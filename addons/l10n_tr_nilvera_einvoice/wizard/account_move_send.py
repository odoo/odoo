...
class AccountMoveSend(models.TransientModel):
    ...
    def _get_default_l10n_tr_nilvera_einvoice_enable_einvoice(self, move):
        return move.l10n_tr_nilvera_send_status == 'not_sent' and move.is_invoice(include_receipts=True) and move.company_id.country_code == 'TR'
    ...
    def _need_invoice_document(self, invoice):
        # EXTENDS 'account'
        return invoice.l10n_tr_nilvera_send_status != 'sent' if invoice.country_code == 'TR' else super()._need_invoice_document(invoice)
