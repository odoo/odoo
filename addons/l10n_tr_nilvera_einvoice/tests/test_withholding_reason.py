...
class TestTRWithholdingReason(TestUBLTRCommon):
    ...
    def test_reason_follows_the_line_taxes(self):
        ...
        self.assertIn(self.reason_607, invoice.l10n_tr_available_exemption_code_ids)
        ...
        self.assertIn(self.reason_607, invoice.l10n_tr_available_exemption_code_ids)
        self.assertNotIn(self.reason_603, invoice.l10n_tr_available_exemption_code_ids)
        ...
        self.assertIn(self.reason_603, invoice.l10n_tr_available_exemption_code_ids)
        self.assertNotIn(self.reason_607, invoice.l10n_tr_available_exemption_code_ids)
    ...
    def test_sole_reason_for_the_ratio_is_preselected(self):
        ...
        self.assertEqual(invoice.l10n_tr_available_exemption_code_ids, self.reason_625)
