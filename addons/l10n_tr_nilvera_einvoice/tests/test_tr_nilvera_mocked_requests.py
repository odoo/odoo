...
class TestTRNilveraMockedRequests(TestUBLTRCommon):
    ...
    def setUpClass(cls):
        ...
        cls.einvoice_partner.with_context(l10n_tr_nilvera_use_mock=True).flush_recordset()
        cls.earchive_partner.with_context(l10n_tr_nilvera_use_mock=True).flush_recordset()
