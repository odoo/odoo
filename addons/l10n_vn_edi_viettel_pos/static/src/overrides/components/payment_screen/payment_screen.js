...
patch(PaymentScreen.prototype, {
    onMounted() {
        ...
        if (this.pos.isVietnamCompany() && this.currentOrder._isRefundOrder()) {
    ...
    async _isOrderValid(isForceValidate) {
        ...
        if (!this.pos.isVietnamCompany() || !this.currentOrder.to_invoice) {
            return result;
        }
        if (
            this.pos.config.l10n_vn_auto_send_to_sinvoice &&
    ...
    async _finalizeValidation() {
        ...
        if (
            ...
            this.pos.config.l10n_vn_auto_send_to_sinvoice &&
            this.currentOrder.to_invoice &&
            this.currentOrder.l10n_vn_sinvoice_state === "ready_to_send" &&
