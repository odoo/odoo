...
class BaseDocumentLayout(models.TransientModel):
    ...
    l10n_din5008_invoice_date = fields.Date(default=fields.Date.context_today, store=False)
    l10n_din5008_due_date = fields.Date(default=lambda self: fields.Date.context_today(self) + relativedelta(day=7), store=False)
    l10n_din5008_delivery_date = fields.Date(default=lambda self: fields.Date.context_today(self) + relativedelta(day=7), store=False)
