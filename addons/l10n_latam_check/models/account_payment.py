...
class AccountPayment(models.Model):
    ...
    # check number editable, related field readonly=False dont to the trick so we create a new computed with inverse
    ...
    def _compute_check_number(self):
        ...
        return super(AccountPayment, self - from_checkbooks - third_party_checks)._compute_check_number()
    ...
    def _compute_l10n_latam_check_warning_msg(self):
        ...
        for rec in latam_draft_checks:
            ...
            if rec.l10n_latam_check_id:
                ...
                elif not rec.is_internal_transfer and rec.payment_type == 'inbound' and \
                        rec.partner_type != last_operation.partner_type:
                    rec.l10n_latam_check_warning_msg = _(
