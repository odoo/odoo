...
class TestOwnChecks(L10nLatamCheckTest):
    ...
    def test_01_pay_with_own_checks(self):
        ...
        liquidity_line_ids = payment.l10n_latam_new_check_ids.mapped('liquidity_line_id')
        self.assertEqual(len(liquidity_line_ids), 2, "There should be a split line per check. (2)")
    ...
    def test_02_pay_with_own_check_and_cancel_payment(self):
        ...
        self.assertEqual(len(payment.l10n_latam_new_check_ids.liquidity_line_id), 0,
