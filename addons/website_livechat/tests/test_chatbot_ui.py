        ...
        expected_messages = [
            ...
            (
                (
                    ...
                    f'"inviter_persona": {{"id": {self.operator.partner_id.id}, "type": "partner"}}, '
                    f'"invitee_persona": {{"id": {self.operator.partner_id.id}, "type": "partner"}}}}\'></div>'
                ),
                self.operator.partner_id,
                False,
            ),  # human_operator has joined the channel
        ]
