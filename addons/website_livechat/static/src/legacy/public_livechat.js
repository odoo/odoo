...
LivechatButton.include({
    ...
    async start() {
        ...
        this.el.innerHTML = "";
        if (this.global.PublicLivechatGlobal.livechatButtonView.buttonText && !config.device.touch) {
            this.el.dataset.content = this.global.PublicLivechatGlobal.livechatButtonView.buttonText;
