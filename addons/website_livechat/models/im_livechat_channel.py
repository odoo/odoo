...
class ImLivechatChannel(models.Model):
    ...
    def _get_livechat_discuss_channel_vals(self, anonymous_name, operator=None, chatbot=None, user_id=None, country_id=None):
        discuss_channel_vals = super(ImLivechatChannel, self)._get_livechat_discuss_channel_vals(anonymous_name, operator, chatbot, user_id=user_id, country_id=country_id)
