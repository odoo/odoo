    ...
    def action_send_chat_request(self):
        ...
        for visitor in self:
            ...
            discuss_channel_vals_list.append({
                'channel_partner_ids': [Command.link(operator.partner_id.id)],
        ...
        for channel in discuss_channels:
            visitor_partner = self.env["res.partner"]
            guest = self.env["mail.guest"]
            if channel.livechat_visitor_id.partner_id:
                visitor_partner = channel.livechat_visitor_id.partner_id
            else:
