odoo.define('website_version.menu_version', ['web.ajax', 'web.core', 'web.Widget', 'website.website'], function (require) {
'use strict';
...
var EditorVersion = Widget.extend({
    ...
    change_version: function(event) {
        ...
        ajax.jsonRpc( '/website_version/change_version', 'call', { 'version_id':version_id }).then(function () {
                location.reload();
            });
    },
