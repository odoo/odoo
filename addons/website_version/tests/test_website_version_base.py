...
class TestWebsiteVersionBase(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.version = self.registry('website_version.version')
        ...
        version_ref = self.registry('ir.model.data').get_object_reference(cr, uid, 'website_version', 'version_0_0_0_0')
        self.version_id = version_ref and version_ref[1] or False
