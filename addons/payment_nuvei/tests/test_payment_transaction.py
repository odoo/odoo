...
class TestPaymentTransaction(NuveiCommon):
    ...
    def test_no_item_missing_from_rendering_values(self):
        ...
        cancel_url_params = {
            'tx_ref': tx.reference,
            'return_access_tkn': 'e8351a75f8c9129c13a611d14bfd8a6999fe5e5659fecc174550d581423ba709'
        }
    ...
    def test_processing_notification_data_sets_transaction_in_error(self):
        ...
        self.assertEqual(
            tx.state_message,
            'An error occurred during the processing of your payment (Invalid Card).'
            ' Please try again.'
        )
    ...
    def test_processing_notification_data_sets_unknown_transaction_in_error(self):
        ...
        self.assertEqual(
            tx.state_message,
            "Nuvei: Received invalid transaction status ??? and reason 'Invalid Card'."
        )
        self.assertEqual(tx.state, 'error')
