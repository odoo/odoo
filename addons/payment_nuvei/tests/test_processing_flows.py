...
class TestProcessingFlows(NuveiCommon):
    ...
    def test_redirect_notification_triggers_processing(self):
        ...
        with patch(
            'odoo.addons.payment_nuvei.controllers.main.NuveiController._verify_notification_signature'
        ), patch(
    ...
    def test_accept_notification_with_valid_signature(self):
        ...
        self._assert_does_not_raise(
            Forbidden, NuveiController._verify_notification_signature, self.notification_data, tx
        )
    ...
    def test_reject_notification_with_missing_signature(self):
        ...
        self.assertRaises(Forbidden, NuveiController._verify_notification_signature, payload, tx)
