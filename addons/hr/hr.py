...
class hr_job(osv.Model):
    ...
    _columns = {
        ...
        'state': fields.selection([('open', 'Recruitment Closed'), ('recruit', 'Recruitment in Progress')],
                                  string='Status', size=7, readonly=True, required=True,
...
class hr_employee(osv.osv):
    ...
    _columns = {
        ...
        'gender': fields.selection([('male', 'Male'), ('female', 'Female')], 'Gender', size=6),
        'marital': fields.selection([('single', 'Single'), ('married', 'Married'), ('widower', 'Widower'), ('divorced', 'Divorced')], 'Marital Status', size=8),
        'department_id': fields.many2one('hr.department', 'Department'),
