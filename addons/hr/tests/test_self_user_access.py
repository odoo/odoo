...
class TestSelfAccessPreferences(TestHrCommon):
    ...
    def test_access_preferences_view(self):
        ...
        james_bank_account = self.env['res.partner.bank'].create({'formatted_account_number': 'BE1234567890', 'partner_id': james.partner_id.id})
...
class TestSelfAccessRights(TestHrCommon):
    ...
    def test_access_employee_account(self):
        ...
        hubert_acc = self.env['res.partner.bank'].create({'formatted_account_number': 'FR1234567890', 'partner_id': hubert.partner_id.id})
