...
class HrEmployeeBase(models.AbstractModel):
    ...
    history_ids = fields.One2many('hr.employee.history', 'employee_id')
    current_history_id = fields.Many2one('hr.employee.history')
    name = fields.Char(related='current_history_id.name')
