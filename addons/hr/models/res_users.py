...
class User(models.Model):
    ...
    employee_phone = fields.Char(related='employee_id.private_phone', readonly=False, related_sudo=False)
    ...
    private_lang = fields.Selection(related='employee_id.private_lang', string="Employee Lang", readonly=False)
