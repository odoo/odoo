...
class User(models.Model):
    ...
    job_title = fields.Char(related='employee_id.job_title', related_inverse=True, related_sudo=False)
    work_phone = fields.Char(related='employee_id.work_phone', related_inverse=True, related_sudo=False)
    mobile_phone = fields.Char(related='employee_id.mobile_phone', related_inverse=True, related_sudo=False)
    work_email = fields.Char(related='employee_id.work_email', related_inverse=True, related_sudo=False)
    category_ids = fields.Many2many(related='employee_id.category_ids', string="Employee Tags", related_inverse=True, related_sudo=False)
    department_id = fields.Many2one(related='employee_id.department_id', related_inverse=True, related_sudo=False)
    address_id = fields.Many2one(related='employee_id.address_id', related_inverse=True, related_sudo=False)
    work_contact_id = fields.Many2one(related='employee_id.work_contact_id', related_inverse=True, related_sudo=False)
    work_location_id = fields.Many2one(related='employee_id.work_location_id', related_inverse=True, related_sudo=False)
    employee_parent_id = fields.Many2one(related='employee_id.parent_id', related_inverse=True, related_sudo=False)
    coach_id = fields.Many2one(related='employee_id.coach_id', related_inverse=True, related_sudo=False)
    private_street = fields.Char(related='employee_id.private_street', string="Private Street", related_inverse=True, related_sudo=False)
    private_street2 = fields.Char(related='employee_id.private_street2', string="Private Street2", related_inverse=True, related_sudo=False)
    private_city = fields.Char(related='employee_id.private_city', string="Private City", related_inverse=True, related_sudo=False)
    private_state_id = fields.Many2one(
        related='employee_id.private_state_id', string="Private State", related_inverse=True, related_sudo=False,
        domain="[('country_id', '=?', private_country_id)]")
    private_zip = fields.Char(related='employee_id.private_zip', related_inverse=True, string="Private Zip", related_sudo=False)
    private_country_id = fields.Many2one(related='employee_id.private_country_id', string="Private Country", related_inverse=True, related_sudo=False)
    private_phone = fields.Char(related='employee_id.private_phone', related_inverse=True, related_sudo=False)
    private_email = fields.Char(related='employee_id.private_email', string="Private Email", related_inverse=True)
    private_lang = fields.Selection(related='employee_id.lang', string="Employee Lang", related_inverse=True)
    km_home_work = fields.Integer(related='employee_id.km_home_work', related_inverse=True, related_sudo=False)
    # res.users already have a field bank_account_id and country_id from the res.partner inheritance: don't redefine them
    employee_bank_account_id = fields.Many2one(related='employee_id.bank_account_id', string="Employee's Bank Account Number", related_inverse=True, related_sudo=False)
    employee_country_id = fields.Many2one(related='employee_id.country_id', string="Employee's Country", related_inverse=True, related_sudo=False)
    identification_id = fields.Char(related='employee_id.identification_id', related_inverse=True, related_sudo=False)
    ssnid = fields.Char(related='employee_id.ssnid', related_inverse=True, related_sudo=False)
    passport_id = fields.Char(related='employee_id.passport_id', related_inverse=True, related_sudo=False)
    gender = fields.Selection(related='employee_id.gender', related_inverse=True, related_sudo=False)
    birthday = fields.Date(related='employee_id.birthday', related_inverse=True, related_sudo=False)
    place_of_birth = fields.Char(related='employee_id.place_of_birth', related_inverse=True, related_sudo=False)
    country_of_birth = fields.Many2one(related='employee_id.country_of_birth', related_inverse=True, related_sudo=False)
    marital = fields.Selection(related='employee_id.marital', related_inverse=True, related_sudo=False)
    spouse_complete_name = fields.Char(related='employee_id.spouse_complete_name', related_inverse=True, related_sudo=False)
    spouse_birthdate = fields.Date(related='employee_id.spouse_birthdate', related_inverse=True, related_sudo=False)
    children = fields.Integer(related='employee_id.children', related_inverse=True, related_sudo=False)
    emergency_contact = fields.Char(related='employee_id.emergency_contact', related_inverse=True, related_sudo=False)
    emergency_phone = fields.Char(related='employee_id.emergency_phone', related_inverse=True, related_sudo=False)
    visa_no = fields.Char(related='employee_id.visa_no', related_inverse=True, related_sudo=False)
    permit_no = fields.Char(related='employee_id.permit_no', related_inverse=True, related_sudo=False)
    visa_expire = fields.Date(related='employee_id.visa_expire', related_inverse=True, related_sudo=False)
    additional_note = fields.Text(related='employee_id.additional_note', related_inverse=True, related_sudo=False)
    barcode = fields.Char(related='employee_id.barcode', related_inverse=True, related_sudo=False)
    pin = fields.Char(related='employee_id.pin', related_inverse=True, related_sudo=False)
    certificate = fields.Selection(related='employee_id.certificate', related_inverse=True, related_sudo=False)
    study_field = fields.Char(related='employee_id.study_field', related_inverse=True, related_sudo=False)
    study_school = fields.Char(related='employee_id.study_school', related_inverse=True, related_sudo=False)
    ...
    employee_type = fields.Selection(related='employee_id.employee_type', related_inverse=True, related_sudo=False)
