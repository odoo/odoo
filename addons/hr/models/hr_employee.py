...
class HrEmployee(models.Model):
    ...
    has_work_permit = fields.Binary(string="Work Permit", groups="hr.group_hr_user", filename_field='work_permit_name')
    ...
    id_card = fields.Binary(string="ID Card Copy", groups="hr.group_hr_user", filename_field='id_card_name')
    driving_license = fields.Binary(string="Driving License", groups="hr.group_hr_user", filename_field='driving_license_name')
