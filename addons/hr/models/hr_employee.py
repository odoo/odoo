...
class HrEmployee(models.Model):
    ...
    def create(self, vals_list):
        ...
        resume_lines_values = []
        for employee in employees:
            line_type = self.env.ref('hr.resume_type_experience', raise_if_not_found=False)
    ...
    def _load_scenario(self):
        ...
        demo_tag = self.env.ref('hr.employee_resume_line_emp_eg_1', raise_if_not_found=False)
        if demo_tag:
            return
        convert.convert_file(self.env, 'hr', 'data/scenarios/hr_scenario.xml', None, mode='init')
        convert.convert_file(self.env, 'hr', 'data/scenarios/hr_skills_scenario.xml', None, mode='init')
