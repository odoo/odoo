...
class HrEmployee(models.Model):
    ...
    # private info
    legal_name = fields.Char(compute='_compute_legal_name', store=True, readonly=False, groups="hr.group_hr_user,hr.group_hr_employee_onboarding", help="The employee's official name as per government-issued or legal documents.")
    split_legal_name = fields.Boolean(compute='_compute_split_legal_name', groups="hr.group_hr_user,hr.group_hr_employee_onboarding", help="Indicates whether the legal name is split into first and last name fields based on the employee's country.")
    is_user_active = fields.Boolean(related='user_id.active', string="User's active", groups="hr.group_hr_user")
    private_phone = fields.Char(string="Private Phone", groups="hr.group_hr_user,hr.group_hr_employee_onboarding")
    private_phone_sanitized = fields.Char(compute='_compute_restricted_phone_companion_fields', store=False, export_string_translation=False, groups='hr.group_hr_user,hr.group_hr_employee_onboarding')
    private_phone_formatted = fields.Char(compute='_compute_restricted_phone_companion_fields', store=False, export_string_translation=False, groups='hr.group_hr_user,hr.group_hr_employee_onboarding')
    private_email = fields.Char(string="Private Email", groups="hr.group_hr_user,hr.group_hr_employee_onboarding")
    lang = fields.Selection(selection=_lang_get, string="Lang", groups="hr.group_hr_user")
    place_of_birth = fields.Char('Place of Birth', groups="hr.group_hr_user,hr.group_hr_employee_onboarding", tracking=True)
    country_of_birth = fields.Many2one('res.country', string="Country of Birth", groups="hr.group_hr_user,hr.group_hr_employee_onboarding", tracking=True)
    birthday = fields.Date('Birthday', groups="hr.group_hr_user,hr.group_hr_employee_onboarding", tracking=True)
    birthday_public_display = fields.Boolean('Show Birthday To Employees', groups="hr.group_hr_user,hr.group_hr_employee_onboarding", default=False)
    ...
    permit_no = fields.Char('Work Permit No', groups="hr.group_hr_user,hr.group_hr_employee_onboarding", tracking=True)
    visa_no = fields.Char('Visa No', groups="hr.group_hr_user,hr.group_hr_employee_onboarding", tracking=True)
    visa_expire = fields.Date('Visa Expiration Date', groups="hr.group_hr_user,hr.group_hr_employee_onboarding", tracking=True)
    work_permit_expiration_date = fields.Date('Work Permit Expiration Date', groups="hr.group_hr_user,hr.group_hr_employee_onboarding", tracking=True)
    has_work_permit = fields.Binary(string="Work Permit", groups="hr.group_hr_user,hr.group_hr_employee_onboarding")
    work_permit_scheduled_activity = fields.Boolean(default=False, groups="hr.group_hr_user")
    work_permit_name = fields.Char('work_permit_name', compute='_compute_work_permit_name', groups="hr.group_hr_user,hr.group_hr_employee_onboarding")
    certificate = fields.Selection(selection='_get_certificate_selection', string='Certificate Level', groups="hr.group_hr_user,hr.group_hr_employee_onboarding", tracking=True)
    study_field = fields.Char("Field of Study", groups="hr.group_hr_user,hr.group_hr_employee_onboarding", tracking=True)
    emergency_contact = fields.Char(groups="hr.group_hr_user,hr.group_hr_employee_onboarding", tracking=True)
    emergency_phone = fields.Char(groups="hr.group_hr_user,hr.group_hr_employee_onboarding", tracking=True)
    ...
    emergency_phone_sanitized = fields.Char(compute='_compute_restricted_phone_companion_fields', store=False, export_string_translation=False, groups='hr.group_hr_user,hr.group_hr_employee_onboarding')
    emergency_phone_formatted = fields.Char(compute='_compute_restricted_phone_companion_fields', store=False, export_string_translation=False, groups='hr.group_hr_user,hr.group_hr_employee_onboarding')
    ...
    id_card = fields.Binary(string="ID Card Copy", groups="hr.group_hr_user,hr.group_hr_employee_onboarding")
    driving_license = fields.Binary(string="Driving License", groups="hr.group_hr_user,hr.group_hr_employee_onboarding")
    id_card_name = fields.Char(groups="hr.group_hr_user,hr.group_hr_employee_onboarding")
    driving_license_name = fields.Char(groups="hr.group_hr_user,hr.group_hr_employee_onboarding")
