...
class ResConfigSettings(models.TransientModel):
    ...
    resource_calendar_id = fields.Many2one(
        ...
        related='company_id.resource_calendar_id', related_inverse=True)
    ...
    hr_presence_control_email_amount = fields.Integer(related="company_id.hr_presence_control_email_amount", related_inverse=True)
    hr_presence_control_ip_list = fields.Char(related="company_id.hr_presence_control_ip_list", related_inverse=True)
