...
class HrVersion(models.Model):
    ...
    company_country_id = fields.Many2one(
        'res.country', string="Company country", related='company_id.country_id', store=True, index='btree')
    ...
    def _get_whitelist_fields_from_template(self):
        ...
        return ['job_id', 'department_id', 'employee_type_id', 'wage', 'resource_calendar_id', 'hr_responsible_id']
