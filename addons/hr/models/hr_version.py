...
class HrVersion(models.Model):
    ...
    def _get_whitelist_fields_from_template(self):
        ...
        return ['job_id', 'department_id', 'employee_type_id', 'payroll_category_id', 'wage', 'resource_calendar_id', 'hr_responsible_id']
    ...
    def _is_struct_from_country(self, country_code):
        self.ensure_one()
        self_sudo = self.sudo()
        return self_sudo.payroll_category_id and self_sudo.payroll_category_id.country_id.code == country_code
