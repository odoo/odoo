...
class HrVersion(models.Model):
    ...
    departure_id = fields.Many2one('hr.employee.departure', string="Departure", copy=False, groups="hr.group_hr_user")
    ...
    departure_description = fields.Html(related='departure_id.departure_description', readonly=False, groups="hr.group_hr_user", tracking=True)
