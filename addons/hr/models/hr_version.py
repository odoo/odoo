...
class HrVersion(models.Model):
    ...
    is_custom_job_title = fields.Boolean(default=False, groups="hr.group_hr_responsible")
    ...
    is_current = fields.Boolean(compute='_compute_is_current', groups="hr.group_hr_responsible")
    is_past = fields.Boolean(compute='_compute_is_past', groups="hr.group_hr_responsible")
    is_future = fields.Boolean(compute='_compute_future', groups="hr.group_hr_responsible")
