...
class Employee(models.Model):
    ...
    address_home_has_company = fields.Boolean(
        'The employee adress has a company linked',
        compute='_compute_address_home_has_company',
    )
    ...
    def _compute_address_home_has_company(self):
        """Checks that choosen address (res.partner) is not linked to a company.
        """
        for employee in self:
            employee.address_home_has_company = employee.address_home_id.parent_id.id is not False
