...
export class VersionsTimeline extends Component {
    ...
    setup() {
        ...
        if (this.field.type === "many2one") {
            this.specialData = useSpecialData((orm, props) => {
                ...
                let domain = new Domain([['employee_id', '=', props.record.evalContext.id]]).toList();
        ...
        if (this.props.withCommand) {
            ...
            useCommand(
                ...
                },
                {
                    category: "smart_action",
                    hotkey: "alt+x",
                    isAvailable: () => !this.getAllItems().at(-1).isSelected,
                }
            );
        }
    }
    ...
    async selectItem(item) {
        ...
        }, { clearBreadcrumbs: true });  // TODO: keep breadcrumb to all Employees ?
    }
