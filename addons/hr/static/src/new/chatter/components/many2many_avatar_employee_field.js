...
} from "@mail/new/chatter/components/many2many_avatar_user_field";

export class Many2ManyTagsAvatarEmployeeField extends Many2ManyTagsAvatarUserField {}
Many2ManyTagsAvatarEmployeeField.additionalClasses = [
...
KanbanMany2ManyTagsAvatarEmployeeField.additionalClasses = [
