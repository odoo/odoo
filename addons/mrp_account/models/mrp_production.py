...
class MrpProduction(models.Model):
    ...
    wip_production_ids = fields.Many2many('account.move')
    wip_production_count = fields.Integer("WIP Journal Entry Count", compute='_compute_wip_production_count')
    ...
    def action_view_production_wip(self):
        self.ensure_one()
        action = {
