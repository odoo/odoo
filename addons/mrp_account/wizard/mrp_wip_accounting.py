...
class MrpAccountWipAccounting(models.TransientModel):
    ...
    def default_get(self, fields_list):
        ...
        if 'reference' in fields_list:
            res['reference'] = _("Manufacturing WIP - %(orders_list)s", orders_list=productions and productions.mapped('name') or _("Manual Entry"))
    ...
    def _get_line_vals(self, productions=False, date=False):
        ...
        return [
            ...
            Command.create({
                'label': _("Manufacturing WIP - %(orders_list)s", orders_list=productions and productions.mapped('name') or _("Manual Entry")),
