...
class TestProgramWithCodeOperations(TestSaleCouponCommon):
    ...
    def test_re_apply_not_claimed_coupon_code(self):
        promo_code_program = self.env["loyalty.program"].create({
            ...
            "reward_ids": [
                Command.create({"reward_type": "discount", "discount": 10}),
                Command.create({"reward_type": "discount", "discount": 20}),
            ],
        })
        ...
        self.assertTrue(promo_code_program.reward_ids <= reward_wizard.reward_ids)
