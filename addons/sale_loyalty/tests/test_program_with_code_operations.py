...
<<<<<<< HEAD:addons/sale_loyalty/tests/test_program_with_code_operations.py
        ...
        self.assertEqual(len(order.order_line), 2, "You should get a discount line") # product + discount
||||||| parent of d29af1db52b (temp):addons/sale_coupon/tests/test_program_with_code_operations.py
...
=======
    ...
    def test_delete_all_discount_lines(self):
        ...
        self.assertEqual(order.code_promo_program_id, program)
>>>>>>> d29af1db52b (temp):addons/sale_coupon/tests/test_program_with_code_operations.py
