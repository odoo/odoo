...
class AccountMove(models.Model):
    ...
    l10n_sa_delivery_date = fields.Date(string='Supply Date', default=fields.Date.context_today, copy=False,
                                        readonly=True, states={'draft': [('readonly', False)]},
                                        help="""Date when the supply of the goods and services is performed.\
                                        You can set this date to when you want ZATCA to recognize the VAT Due Liability as ZATCA will consider the earlier of the Invoice Issue Date and this date.\
    ...
    l10n_sa_confirmation_datetime = fields.Datetime(string='Confirmation Date', readonly=True, copy=False, help="Date when the Invoice is confirmed")
