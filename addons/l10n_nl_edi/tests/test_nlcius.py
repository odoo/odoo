...
class TestUBL(AccountEdiTestCommon):
    ...
    def setUpClass(cls, chart_template_ref='l10n_nl.l10nnl_chart_template', edi_format_ref='l10n_nl_edi.edi_nlcius_1'):
        ...
        cls.company_data['company'].partner_id.write({
            ...
            'zip': '1000',
            'city': 'Amsterdam',
            'country_id': cls.env.ref('base.nl'),
        ...
        cls.expected_invoice_values = '''
            <Invoice xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2">
                ...
                <cbc:BuyerReference>company_2_data</cbc:BuyerReference>
            ...
            <cac:Party>
                ...
                <cac:PartyName>
                    <cbc:Name>company_2_data</cbc:Name>
                </cac:PartyName>
                <cac:PostalAddress>
                    <cac:Country>
                ...
                <cac:PartyLegalEntity>
                    <cbc:RegistrationName>company_2_data</cbc:RegistrationName>
                </cac:PartyLegalEntity>
                <cac:Contact>
                    <cbc:Name>company_2_data</cbc:Name>
                  </cac:Contact>
            ...
            <cac:InvoiceLine>
                ...
                <cac:Item>
                    <cbc:Description>Line 1</cbc:Description>
            ...
            <cac:InvoiceLine>
                ...
                <cac:Item>
                    <cbc:Description>Line 2</cbc:Description>
    ...
    def test_nlcius_import(self):
        self.partner_a.l10n_nl_kvk = '77777677'
