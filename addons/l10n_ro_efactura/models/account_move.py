...
class AccountMove(models.Model):
    ...
    def _l10n_ro_edi_create_document_attachment(self, raw, **kwargs):
        """ Shorthand for creating the attachment_id on the invoice(s) and/or the invoice's document(s) """
        self.ensure_one()
    ...
    def _l10n_ro_edi_create_document_invoice_sending(self, key_loading, attachment_raw):
        ...
        document.attachment_id = self._l10n_ro_edi_create_document_attachment(
            raw=attachment_raw,
    ...
    def _l10n_ro_edi_create_document_invoice_sent(self, result: dict):
        ...
        attachment = self._l10n_ro_edi_create_document_attachment(raw=result['attachment_raw'])
