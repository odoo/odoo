...
class ResConfigSettings(models.TransientModel):
    ...
    account_default_check_layout_format_id = fields.Many2one('account.check.layout.format', related='company_id.account_default_check_layout_format_id', string="Check Format", readonly=False)
