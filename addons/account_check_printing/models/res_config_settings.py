...
class ResConfigSettings(models.TransientModel):
    ...
    account_check_printing_layout = fields.Selection(
        related="company_id.account_config_id.account_check_printing_layout",
        string="Check Layout",
        readonly=False,
    ...
    account_check_printing_date_label = fields.Boolean(
        related="company_id.account_config_id.account_check_printing_date_label",
    ...
    account_check_printing_multi_stub = fields.Boolean(
        related="company_id.account_config_id.account_check_printing_multi_stub",
    ...
    account_check_printing_margin_top = fields.Float(
        related="company_id.account_config_id.account_check_printing_margin_top",
    ...
    account_check_printing_margin_left = fields.Float(
        related="company_id.account_config_id.account_check_printing_margin_left",
        string="Check Left Margin",
        readonly=False,
        help="Adjust the margins of generated checks to make it fit your printer's settings.",
    )
    account_check_printing_margin_right = fields.Float(
        related="company_id.account_config_id.account_check_printing_margin_right",
