# -*- coding: utf-8 -*-
from odoo.addons.account_edi.tests.common import AccountTestEdiCommon
...
class TestAccountEdiFacturx(AccountTestEdiCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.journal.edi_format_ids = [(6, 0, cls.env.ref('account_edi_facturx.edi_facturx_1_0_05').ids)]
    ...
    def test_facturx(self):
        ...
        with self.mocked_today('2017-02-01'):
            ...
            current_etree = self.get_xml_tree_from_attachment(self.invoice.edi_document_ids)
