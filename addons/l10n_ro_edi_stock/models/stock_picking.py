...
class Picking(models.Model):
    ...
    def _compute_l10n_ro_edi_stock_current_document_data(self):
        for picking in self:
            if picking.company_id.account_fiscal_country_id.code == 'RO' and (document := picking._l10n_ro_edi_stock_get_current_document()):
                ...
                picking.l10n_ro_edi_stock_document_message = document.message
                picking.l10n_ro_edi_stock_document_load_id = document.l10n_ro_edi_stock_load_id
                picking.l10n_ro_edi_stock_document_uit = document.l10n_ro_edi_stock_uit
            else:
                picking.l10n_ro_edi_stock_state = False
                picking.l10n_ro_edi_stock_document_message = False
                picking.l10n_ro_edi_stock_document_load_id = False
    ...
    def _l10n_ro_edi_stock_fetch_document_status(self):
        ...
        for picking in to_fetch:
            ...
            if errors := picking._l10n_ro_edi_stock_validate_fetch_data():
                documents_to_delete |= picking._l10n_ro_edi_stock_get_all_documents('stock_sending_failed')
    ...
    @api.model
    def _l10n_ro_edi_stock_get_available_location_types(self, operation_type, location: str) -> str:
        """
