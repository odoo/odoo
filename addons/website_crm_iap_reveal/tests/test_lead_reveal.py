...
class TestLeadMine(TestCrmCommon, MockIAPReveal):
    ...
    def setUpClass(cls):
        ...
        cls.test_industry_tags = cls.env.ref('iap_crm.crm_iap_mine_industry_33') + cls.env.ref('iap_crm.crm_iap_mine_industry_148')
        cls.test_roles = cls.env.ref('iap_crm.crm_iap_mine_role_11') + cls.env.ref('iap_crm.crm_iap_mine_role_19')
        cls.test_seniority = cls.env.ref('iap_crm.crm_iap_mine_seniority_2')
