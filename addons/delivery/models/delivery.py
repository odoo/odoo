...
class DeliveryGrid(models.Model):
    ...
    sequence = fields.Integer(required=True, help="Gives the sequence order when displaying a list of delivery grid.", default=True)
...
class DeliveryGridLine(models.Model):
    ...
    variable = fields.Selection([('weight', 'Weight'), ('volume', 'Volume'), ('wv', 'Weight * Volume'),
        ('price', 'Price'), ('quantity', 'Quantity')], required=True, default="weight", oldname='type')
    ...
    variable_factor = fields.Selection([('weight', 'Weight'), ('volume', 'Volume'),
        ('wv', 'Weight * Volume'), ('price', 'Price'), ('quantity', 'Quantity')], required=True, default="weight")
