...
class SaleOrder(models.Model):
    ...
    def _get_line_global_discount(self):
        ...
        non_invoicable_lines = self.order_line - invoicable_lines
        global_discount_lines = non_invoicable_lines.filtered(
            lambda line: line.product_id == self.company_id.sale_discount_product_id
        )
        ...
        if total_global_discount_value:
