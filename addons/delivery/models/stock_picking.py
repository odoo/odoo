...
class StockPicking(models.Model):
    ...
    def _set_delivery_package_type(self):
        ...
        context = dict(
            self.env.context,
            default_package_carrier_type=self.carrier_id.delivery_type,
        ...
        if context['default_package_carrier_type'] in ['fixed', 'base_on_rule']:
            context['default_package_carrier_type'] = 'none'
        return {
