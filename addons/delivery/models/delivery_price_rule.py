...
class DeliveryPriceRule(models.Model):
    ...
    list_base_price = fields.Float(string='Sale Base Price', digits=0, min_digits='Product Price', required=True, default=0.0)
    list_price = fields.Float('Sale Price', digits=0, min_digits='Product Price', required=True, default=0.0)
