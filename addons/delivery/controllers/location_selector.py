...
class LocationSelectorController(Controller):
    ...
    def delivery_set_pickup_location(self, order_id, pickup_location_data):
        ...
        order.set_pickup_location(pickup_location_data)
    ...
    def delivery_get_pickup_locations(self, order_id, zip_code=None):
        ...
        country = self.env['res.country'].search(
            ...
            limit=1,
        ) if request.geoip.country_code else order.partner_shipping_id.country_id
        return order.get_pickup_locations(zip_code, country)
