...
class TestUblImportBis3InvoiceBE(TestUblBis3Common, TestUblCiiBECommon):
    ...
    def test_import_embedded_pdf(self):
        ...
        self.assertEqual(len(bill.attachment_ids), 1, "Manual upload is missing the attachment")
        ...
        self.assertEqual(len(bill.attachment_ids), 1, "Import via mail alias is missing the attachment")
