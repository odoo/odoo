...
class TestUblImportBis3InvoiceBERetrieveProduct(TestUblImportBis3InvoiceBE):
    ...
    def test_partial_import_product_by_supplier_info(self):
        ...
        _fn, xml_content = self._import_file_content('test_partial_import_product_by_supplier_info', 'xml')
        xml_attachment = self.env['ir.attachment'].create({
            'raw': xml_content,
            'name': 'test_partial_import_product_by_supplier_info.xml',
        })
    ...
    def test_partial_import_product_by_supplier_info_as_first_preference(self):
        """
        ...
        _fn, xml_content = self._import_file_content('test_partial_import_product_by_supplier_info_as_first_preference', 'xml')
        xml_attachment = self.env['ir.attachment'].create({
            'raw': xml_content,
            'name': 'test_partial_import_product_by_supplier_info_as_first_preference.xml',
        })
        imported_invoice = self._import_invoice_as_attachment_on(
            attachment=xml_attachment,
            journal=self.company_data['default_journal_purchase'],
