...
class TestUblBis3(AccountTestInvoicingCommon):
    ...
    def test_beg_testcase05_cash_discount(self):
        ...
        if with_new_helpers:
            ...
            xpath += '''
                ...
                <xpath expr="//*[local-name()='AllowanceCharge'][1]/*[local-name()='AllowanceChargeReasonCode' and text()='66']" position="replace"
                    xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2"
                    xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2">
                    <cbc:AllowanceChargeReasonCode>64</cbc:AllowanceChargeReasonCode>
                </xpath>
                <xpath expr="//*[local-name()='AllowanceCharge'][3]/*[local-name()='AllowanceChargeReasonCode' and text()='66']" position="replace"
                    xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2"
                    xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2">
                    <cbc:AllowanceChargeReasonCode>64</cbc:AllowanceChargeReasonCode>
                </xpath>
    ...
    def test_beg_testcase06_discount_with_cash_payment(self):
        ...
        self.env['account.payment.register']\
            ...
            ._create_payments()
        # TODO: check we only paid the discounted amount
        ...
        <cbc:Note>  In geval van betaling binnen 14 dagen is 2% (52.00€) betalingskorting van toepassing
            ...
            <xpath expr="//*[local-name()='AllowanceCharge'][2]/*[local-name()='AllowanceChargeReasonCode' and text()='66']" position="replace"
                xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2"
                xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2">
                <cbc:AllowanceChargeReasonCode>64</cbc:AllowanceChargeReasonCode>
            </xpath>
