    ...
    def _export_invoice_vals(self, invoice):
        ...
        vals = {
            ...
            'vals': {
                ...
                'additional_document_reference_vals_list': self._get_additional_document_reference_vals_list(invoice),
    ...
    def _import_fill_invoice_line_form(self, tree, invoice_line, qty_factor):
        ...
        if not tax_nodes:
            for elem in tree.findall('.//{*}TaxTotal'):
                tax_nodes += elem.findall('.//{*}TaxSubtotal/{*}TaxCategory/{*}Percent') or elem.findall('.//{*}TaxSubtotal/{*}Percent')
