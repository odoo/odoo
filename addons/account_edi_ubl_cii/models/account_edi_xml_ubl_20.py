...
from odoo.addons.account_edi_ubl_cii.models.account_tax import NO_ALLOWANCE_CHARGE_COUNTRIES
...
class AccountEdiXmlUBL20(models.AbstractModel):
    ...
    def _get_line_allowance_charge_nodes(self, vals):
        # For some countries like CO and PE, we don't required allowance/charge
        if not (company := vals['company']) or company.country_code in NO_ALLOWANCE_CHARGE_COUNTRIES:
            return []
