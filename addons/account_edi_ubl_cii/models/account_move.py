...
class AccountMove(models.Model):
    ...
    def _get_invoice_legal_documents_ubl(self):
        """ Retrieve the invoice UBL XML.
        :return dict: the invoice UBL data such as
        {'filename': 'INV_2024_0001_ubl_bis3.xml', 'filetype': 'xml', 'content':...}
        """
        self.ensure_one()
