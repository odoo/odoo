...
class AccountEdiCommon(models.AbstractModel):
    ...
    def _get_tax_exemption_reason(self, customer, supplier, tax):
        ...
        if reason := self._get_belgian_cocontractant_note(customer, supplier):
            if tax.amount:
                raise UserError(
                    _("Invalid Tax Setup for Co-Contractor. Please apply the standard co-contractor tax, or ensure your custom tax uses a tax amount of 0"))
            return {
