...
# -------------------------------------------------------------------------
<<<<<<< ca9f49e10060d3e3df25cc69db2cd56f4b251cf8
||||||| c9422bcb61f723f6764a8bcca6ecc7bd42ff38ea
# UNIT OF MEASURE
# -------------------------------------------------------------------------
UOM_TO_UNECE_CODE = {
...
EAS_MAPPING = {
    ...
    'SE': {'0007': 'company_registry', '9955': 'vat'},
    'SI': {'9949': 'vat'},
    'SK': {'0245': 'additional_identifiers', '9950': 'vat'},
    'SM': {'9951': 'vat'},
    'TR': {'9952': 'vat'},
    'VA': {'9953': 'vat'},
    # DOM-TOM
...
# -------------------------------------------------------------------------
>>>>>>> ccd8ffce528fc7dd6a7688681f7c4cb1d712b972
...
class AccountEdiCommon(models.AbstractModel):
    ...
    def _import_prepare_missing_customer_create_values(self, collected_values):
        ...
        for key in ('phone', 'name', 'email', 'street', 'street2', 'zip', 'city', 'routing_scheme', 'routing_endpoint'):
