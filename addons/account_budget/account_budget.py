...
class crossovered_budget(osv.osv):
    ...
    _columns = {
        ...
        'state' : fields.selection([('draft','Draft'),('cancel', 'Cancelled'),('confirm','Confirmed'),('validate','Validated'),('done','Done')], 'Status', size=8, select=True, required=True, readonly=True),
