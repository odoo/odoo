...
class BudgetReport(models.AbstractModel):
    ...
    def funct(self, object, form):
        ...
        for budget in object:
            ...
            for analytic_account in analytic_accounts:
                ...
                result.append(res)
                lines = CrossoveredBudgetLines.search([('id', 'in', budget_ids.ids), ('analytic_account_id', '=', analytic_account.id), ('date_to', '>=', form['date_from']), ('date_from', '<=', form['date_to'])])
    ...
    def render_html(self, data=None):
        ...
        selected_records = self.env['crossovered.budget'].browse(data['form']['ids'])
        docargs = {
            'doc_ids': self.ids,
