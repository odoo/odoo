...
class account_asset_asset(osv.osv):
    ...
    _columns = {
        ...
        'value_residual': fields.function(_amount_residual, method=True, string='Residual Value'),
        ...
        'salvage_value': fields.float('Salvage Value', help="It is the amount you plan to have that you cannot depreciate.", readonly=True, states={'draft':[('readonly',False)]}),
    }
    _defaults = {
...
class account_asset_depreciation_line(osv.osv):
    ...
    _columns = {
        ...
        'amount': fields.float('Current Depreciation', required=True),
        'remaining_value': fields.float('Next Period Depreciation', required=True),
