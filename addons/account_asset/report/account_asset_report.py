...
class asset_asset_report(osv.osv):
    ...
    _columns = {
        ...
        'depreciation_start_date': fields.date('Depreciation Date', readonly=True),
     	...
     	cr.execute("""
    	    create or replace view asset_asset_report as (
                select 
                    ...
                    a.depreciation_start_date as depreciation_start_date,
                ...
                group by 
                    ...
                    a.purchase_date, a.depreciation_start_date, dl.move_check, a.state, a.category_id, a.partner_id, a.company_id,
