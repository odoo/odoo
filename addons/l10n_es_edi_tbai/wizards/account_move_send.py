...
class AccountMoveSend(models.TransientModel):
    ...
    l10n_es_tbai_enable_send = fields.Boolean(compute='_compute_l10n_es_tbai_enable_send')
    ...
    def _compute_l10n_es_tbai_enable_send(self):
        for wizard in self:
            wizard.l10n_es_tbai_enable_send = any(move.l10n_es_tbai_is_required for move in wizard.move_ids)

    @api.depends('l10n_es_tbai_enable_send')
    def _compute_l10n_es_tbai_checkbox_send(self):
        for wizard in self:
            wizard.l10n_es_tbai_checkbox_send = wizard.l10n_es_tbai_enable_send
    ...
    def _get_placeholder_mail_attachments_data(self, move):
        ...
        if (
            ...
            and self.l10n_es_tbai_enable_send
            and self.l10n_es_tbai_checkbox_send
        ):
            filename = move._l10n_es_tbai_get_document_name()
            results.append({
