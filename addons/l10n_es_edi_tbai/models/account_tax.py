...
class TBAIAccountTaxMixin(models.AbstractModel):
    _name = 'l10n_es.tbai.account.tax.mixin'
    _description = 'TicketBAI Fields'
...
class AccountTax(models.Model):
    _inherit = ['account.tax', 'l10n_es.tbai.account.tax.mixin']
    _name = 'account.tax'


class AccountTaxTemplate(models.Model):
    _inherit = ['account.tax.template', 'l10n_es.tbai.account.tax.mixin']
