...
var getOdooFCResources = function (calendar) {
...
openerp.web_calendar = function (instance) {
    ...
    instance.web_calendar.QuickCreate = instance.web.Widget.extend({
        ...
        quick_add: function () {
            ...
            return this.quick_create({'name': val}).always(function () {
                return true;
            });
        },
                    ...
                    .call('fields_get').then(function (fields_def) {
                        return _(fields_def).chain()
                            ...
                            .filter(function (pair) {
                                return pair[0] !== self.field_widget.field.relation_field;
                            })
                            .filter(function (pair) {
                                return pair[1].required;
                            })
                            .map(function (pair) {
                                return pair[0];
                            })
