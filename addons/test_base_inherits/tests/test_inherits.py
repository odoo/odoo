...
class test_base_inherits(common.TransactionCase):
    ...
    def test_read_3_levels_inherits(self):
        ...
        pallet = self.env.ref('test_base_inherits.pallet_a')
    ...
    def test_write_4_one2many(self):
        ...
        box = self.env.ref('test_base_inherits.box_a')
    ...
    def test_ir_model_data_inherits(self):
        ...
        self.assertEqual(field.module, 'test_base_inherits')
