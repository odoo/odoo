...
class MassMailing(models.Model):
    ...
    body_arch = fields.Html(string='Body', translate=False, sanitize='email_out', sanitize_output_method="html")
    body_html = fields.Html(
        string='Body converted to be sent by mail', sanitize='email_out',
