...
class MassMailController(http.Controller):
    ...
    @route(['/unsubscribe_from_list'], type='http', website=True, multilang=False, auth='public')
    ...
    @route('/mail/track/<int:mail_id>/blank.gif', type='http', auth='none')
    ...
    @route('/r/<string:code>/m/<int:stat_id>', type='http', auth="none")
