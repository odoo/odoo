...
class MassMailController(http.Controller):
    ...
    # This function only unsubscribes if the HTTP method is POST.
    # If the method is GET, page can still be accessed so that users may update their subscrriptions
