odoo.define('mass_mailing.mass_mailing_editor_tour', function (require) {
    ...
    registry.category("web_tour.tours").add('mass_mailing_basic_theme_toolbar', {
        test: true,
        url: '/web',
        steps: [
    ...
    registry.category('web_tour.tours').add('mass_mailing_campaing_new_mailing', {
        test: true,
        url: '/web',
        steps: [
            stepUtils.showAppsMenuItem(),
            ...
            {
                content: 'Select "Test Newsletter" campaign',
            ...
            {
                content: 'Pick "Test Newsletter" option',
