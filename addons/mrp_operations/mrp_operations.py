...
class mrp_production_workcenter_line(osv.osv):
    ...
    def action_draft_send_note(self, cr, uid, ids):
        prod_obj = self.pool.get('mrp.production')
    ...
    def action_draft(self, cr, uid, ids):
        ...
        self.action_draft_send_note(cr, uid, ids)
        return True
    ...
    def action_start_working(self, cr, uid, ids):
        ...
        self.action_start_send_note(cr, uid, ids)
        return True
    ...
    def action_done(self, cr, uid, ids):
        ...
        self.action_done_send_note(cr, uid, ids)
    ...
    def action_cancel(self, cr, uid, ids):
        ...
        self.action_cancel_send_note(cr, uid, ids)
        return True
    ...
    def action_pause(self, cr, uid, ids):
        ...
        self.action_pending_send_note(cr, uid, ids)
        return True
