...
class account_analytic_account(osv.osv):
    ...
    _columns = {
        ...
        'quantity': fields.function(_debit_credit_bal_qtty, method=True, type='float', string='Quantity', multi='debit_credit_bal_qtty', digits_compute=dp.get_precision('Account')),
