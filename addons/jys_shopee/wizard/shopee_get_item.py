...
class ShopeeGetItem(models.TransientModel):
    _name = 'shopee.get.item'
    _description = 'Shopee Get Items'

    shop_ids = fields.Many2many('shopee.shop', 'shopee_item_product_shop_rel', 'item_wizard_id', 'shop_id', string='Shops')
