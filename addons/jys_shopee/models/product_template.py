...
class ProductTemplate(models.Model):
    ...
    shopee_sku = fields.Char('Shopee SKU')
    is_shopee = fields.Boolean('Shopee Product', default = False)
    ...
    shopee_product_ids = fields.One2many('shopee.product', 'product_tmpl_id', 'Shopee Products')
    shopee_product_image_ids = fields.One2many('shopee.product.image', 'product_tmpl_id', 'Shopee Images')
