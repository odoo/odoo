        ...
        if(self.planner['planner_application'] == 'planner_project') {
            var stages = {
                'development_process': {
                    ...
                    'input_element_stage_5' : _t(''),
                    'input_element_stage_6' : _t(''),
                    ...
                    'input_element_stage_12' : _t(''),
                    'input_element_stage_13' : _t(''),
                },
            ...
            self.$el.on('change', '#input_element_kanban_stage_pipeline', function(ev) {
                ...
                if (_.has(stages, option)) {
                    ...
                    for(var i=0; i<keys.length; i++) {
                        ...
                        $('#' + keys[i] + '_user').val(values[keys[i]]);
                    }
                }
            });
            $( ".user_project" ).on('change', function() {
                $("#" + $(this).attr("id") + "_user").val($(this).val());
            });
        }
    }
});
