...
class AccountMove(models.Model):
        ...
        if (self.journal_id.l10n_latam_use_documents and
            ...
            if self.journal_id.type == 'sale':
                ...
                if len(self.partner_id) == 0:
                    # this will allow to use the whole documents domain if partner not selected.
                    pass
                elif self.partner_id.l10n_cl_sii_taxpayer_type == '1':
    ...
    def _compute_l10n_latam_available_document_types(self):
        for record in self:
            if record.journal_id.l10n_latam_use_documents and \
                    record.journal_id.company_id.country_id == self.env.ref('base.cl'):
                record.l10n_latam_available_document_type_ids = False
    ...
    def _check_invoice_type_document_type(self):
        ...
        for rec in self.filtered(
            ...
            if rec.journal_id.type == 'sale' and not rec.journal_id.l10n_latam_use_documents:
