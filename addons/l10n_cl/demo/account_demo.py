...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_demo_data_move(self, company=False):
        ...
        def create_currency_rates(usd_rate_value, uf_rate_value):
        ...
        def modify_existing_moves(move_data, local_sale_journal, exports_purchase_journal, fiscal_position_exports, fiscal_position_imports, today, usd_rate_value):
            ...
            move_data['demo_invoice_1']['journal_id'] = local_sale_journal.id
            ...
            move_data['demo_invoice_2']['journal_id'] = local_sale_journal.id
            # use the invoice date as the same as this credit note, to have a consistent positive value in sales
            move_data['demo_invoice_2']['invoice_date'] = move_data['demo_move_auto_reconcile_2']['invoice_date']
            ...
            move_data['demo_invoice_3']['journal_id'] = local_sale_journal.id
            ...
            move_data['demo_invoice_followup']['journal_id'] = local_sale_journal.id
            ...
            move_data['demo_invoice_5']['journal_id'] = local_sale_journal.id
            move_data['demo_invoice_5']['l10n_latam_document_type_id'] = 'l10n_cl.dc_fe_dte'
            move_data['demo_invoice_5']['currency_id'] = 'base.USD'
            move_data['demo_invoice_5']['fiscal_position_id'] = fiscal_position_imports

            move_data['demo_invoice_6']['journal_id'] = local_sale_journal.id
            move_data['demo_invoice_6']['l10n_latam_document_type_id'] = 'l10n_cl.dc_fe_dte'
            move_data['demo_invoice_6']['currency_id'] = 'base.USD'
            move_data['demo_invoice_6']['fiscal_position_id'] = fiscal_position_imports

            move_data['demo_invoice_7']['journal_id'] = local_sale_journal.id
            # use the invoice date as the same as this credit note, to have a consistent positive value in sales
            move_data['demo_invoice_7']['invoice_date'] = move_data['demo_move_auto_reconcile_2']['invoice_date']
            move_data['demo_invoice_7']['l10n_latam_document_type_id'] = 'l10n_cl.dc_fe_dte'
            move_data['demo_invoice_7']['currency_id'] = 'base.USD'
            move_data['demo_invoice_7']['fiscal_position_id'] = fiscal_position_imports

            tax_otax = self.ref('OTAX_19')
            tax_rti = self.ref('I_RTI')
            move_data['demo_invoice_8']['l10n_latam_document_type_id'] = 'l10n_cl.dc_fc_f_dte'
            move_data['demo_invoice_8']['invoice_line_ids'] = [
                Command.clear(),
                Command.create({
            ...
            move_data['demo_invoice_9']['journal_id'] = local_sale_journal.id
            move_data['demo_invoice_9']['l10n_latam_document_type_id'] = 'l10n_cl.dc_fe_dte'
            move_data['demo_invoice_9']['currency_id'] = 'base.USD'
            move_data['demo_invoice_9']['fiscal_position_id'] = fiscal_position_exports

            move_data['demo_invoice_10']['journal_id'] = local_sale_journal.id
            move_data['demo_invoice_10']['l10n_latam_document_type_id'] = 'l10n_cl.dc_fe_dte'
            move_data['demo_invoice_10']['currency_id'] = 'base.USD'
            move_data['demo_invoice_10']['fiscal_position_id'] = fiscal_position_exports
            ...
            move_data['demo_invoice_equipment_purchase']['fiscal_position_id'] = fiscal_position_imports

            # Export credit notes in USD (out_refund)
            move_data['demo_move_auto_reconcile_1']['journal_id'] = local_sale_journal.id
            ...
            move_data['demo_move_auto_reconcile_2']['journal_id'] = local_sale_journal.id
            ...
            move_data['demo_move_auto_reconcile_5']['journal_id'] = local_sale_journal.id
            ...
            move_data['demo_move_auto_reconcile_4']['journal_id'] = local_sale_journal.id
            move_data['demo_move_auto_reconcile_4']['l10n_latam_document_type_id'] = 'l10n_cl.dc_ncex_dte'
        ...
        create_currency_rates(usd_rate_value, uf_rate_value)
        (
            exports_purchase_journal, local_sale_journal, local_purchase_journal,
            fiscal_position_exempt, fiscal_position_exports, fiscal_position_imports,
            fiscal_position_fees, fiscal_position_supermarket, fiscal_position_purchase_exempt
