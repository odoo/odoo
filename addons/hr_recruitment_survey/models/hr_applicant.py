...
class HrApplicant(models.Model):
    ...
    def action_send_survey(self):
        ...
        applicant_partner_ids_list = []
        applicant_survey_ids_list = []
        ...
        for applicant in self:
            ...
            applicant_partner_ids_list.append(applicant.partner_id.id)
            applicant_survey_ids_list.append(applicant.survey_id.id)

        local_context = dict(
            default_applicant_ids=self.ids,
            default_survey_id=False,
            default_survey_ids=applicant_survey_ids_list,
            default_partner_ids=applicant_partner_ids_list,
