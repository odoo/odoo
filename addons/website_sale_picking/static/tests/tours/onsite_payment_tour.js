...
registry.category("web_tour.tours").add('onsite_payment_tour', {
        ...
        wTourUtils.clickOnElement('Proceed to checkout', 'a[role="button"]:contains("Checkout")'),
        ...
        wTourUtils.clickOnElement('Go to payment page', 'a:contains("Checkout")'),
        ...wsTourUtils.fillAdressForm(),
        ...
        ...wsTourUtils.addToCart({productName: 'Warranty'}),
        wsTourUtils.goToCart(),
        wTourUtils.clickOnElement('Go to payment page', 'a[role="button"]:contains("Checkout")'),
        ...wsTourUtils.fillAdressForm(),
        {
