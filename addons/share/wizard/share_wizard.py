...
<script type="text/javascript">
    ...
    _columns = {
        ...
        'user_type': fields.selection(lambda s, *a, **k: s._user_type_selection(*a, **k),'Sharing method', size=8, required=True,
        ...
        'access_mode': fields.selection([('readonly','Can view'),('readwrite','Can edit')],'Access Mode', size=9, required=True,
