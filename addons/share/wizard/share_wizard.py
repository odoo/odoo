...
class share_wizard(osv.TransientModel):
    ...
    def _assert(self, condition, error_message, context=None):
        ...
        """
        if not condition:
            raise Warning(_('Sharing access cannot be created.'), error_message)
...
<script type="text/javascript">
    ...
    def go_step_1(self, cr, uid, ids, context=None):
        ...
        if wizard_data.user_type == 'emails' and not self.has_email(cr, uid, context=context):
            raise Warning(_('No email address configured'),
    ...
    def _create_indirect_sharing_rules(self, cr, current_user, wizard_data, group_id, fields_relations, context=None):
        ...
        try:
            ...
            raise Warning(_('Sharing access cannot be created.'),
    ...
    def go_step_2(self, cr, uid, ids, context=None):
        ...
        # B.
            ...
            if res_id <= 0:
                raise Warning(_('Record id not found'), _('The share engine has not been able to fetch a record_id for your invitation.'))
    ...
    def send_invite_email(self, cr, uid, wizard_data, context=None):
        ...
        if not user.email:
            raise Warning(_('Email Required'), _('The current user must have an email address configured in User Preferences to be able to send outgoing emails.'))
