...
class SaleProductConfiguratorController(Controller):
    ...
    def sale_product_configurator_get_values(
        ...
        **kwargs,
        ...
        :param int|None currency_id: The currency of the transaction, as a `res.currency` id.
            Required if `show_price` is True.
        ...
        """
        request.update_context(show_price=show_price)
        if company_id:
    ...
    def _get_product_information(
        ...
        **kwargs,
        ...
        :param res.currency currency: The currency of the transaction. Unused if the `show_price`
    ...
    def _get_basic_product_information(self, product_or_template, pricelist, combination, **kwargs):
        ...
        if self.env.context.get("show_price", True):
