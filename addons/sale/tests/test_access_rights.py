...
class TestAccessRights(SaleCommon, MailCommon):
    ...
    def test_access_bank_account_on_account_move(self):
        ...
        self.assertTrue(invoice.partner_bank_id.with_user(self.sale_user2).has_access("read"))
        ...
        self.env.invalidate_all()
        self.assertTrue(credit_note.with_user(self.sale_user2).has_access("read"))
        self.assertTrue(customer_bank.with_user(self.sale_user2).has_access("read"))
        ...
        self.assertFalse(other_bank.with_user(self.sale_user2).has_access("read"))
