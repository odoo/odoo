...
class TestSaleOrderDownPayment(TestSaleCommon):
    ...
    def setUpClass(cls):
        ...
        cls.sol_serv_deliver = cls.env['sale.order.line'].create({
            ...
            'product_uom_qty': 2,
            'product_uom_id': cls.company_data['product_service_delivery'].uom_id.id,
            'price_unit': 100,
            'order_id': cls.sale_order.id,
            'tax_id': False,
        })
        cls.sol_serv_order = cls.env['sale.order.line'].create({
            ...
            'product_uom_qty': 2,
            'product_uom_id': cls.company_data['product_service_order'].uom_id.id,
            'price_unit': 100,
            'order_id': cls.sale_order.id,
            'tax_id': False,
        })
        cls.sol_product_deliver = cls.env['sale.order.line'].create({
            ...
            'product_uom_qty': 2,
            'product_uom_id': cls.company_data['product_delivery_no'].uom_id.id,
            'price_unit': 100,
            'order_id': cls.sale_order.id,
            'tax_id': False,
        })
