...
class TestSaleToInvoice(TestSaleCommon):
    ...
    def test_downpayment_storno(self):
        ...
        def create_so_with_downpayments():
            ...
            for invoice in sale_order.invoice_ids:
                ...
                self.assertRecordValues(invoice.line_ids, [
                    {'debit': 0, 'credit': 50, 'balance': -50, 'is_downpayment': True},
                    {'debit': 50, 'credit': 0, 'balance': 50, 'is_downpayment': False},
                ])
        ...
        self.assertRecordValues(invoice_no_storno.line_ids, [
            {'debit': 0, 'credit': 600.0, 'balance': -600.0, 'is_downpayment': False},
            {'debit': 0, 'credit': 0, 'balance': 0, 'is_downpayment': False},
            {'debit': 50.0, 'credit': 0, 'balance': 50.0, 'is_downpayment': True},
            {'debit': 50.0, 'credit': 0, 'balance': 50.0, 'is_downpayment': True},
            {'debit': 500.0, 'credit': 0, 'balance': 500.0, 'is_downpayment': False},
        ])
        ...
        self.assertRecordValues(invoice_storno.line_ids, [
            {'debit': 0.0, 'credit': 600.0, 'balance': -600.0, 'is_downpayment': False},
            {'debit': 0.0, 'credit': 0.0, 'balance': 0.0, 'is_downpayment': False},
            {'debit': 0.0, 'credit': -50.0, 'balance': 50.0, 'is_downpayment': True},
            {'debit': 0.0, 'credit': -50.0, 'balance': 50.0, 'is_downpayment': True},
            {'debit': 500.0, 'credit': 0.0, 'balance': 500.0, 'is_downpayment': False},
        ])
    ...
    def test_negative_amount_storno(self):
        ...
        self.assertRecordValues(invoice_no_storno.line_ids, [
            {'debit': 0.0, 'credit': 600.0, 'balance': -600.0},
            {'debit': 50.0, 'credit': 0.0, 'balance': 50.0},
            {'debit': 100.0, 'credit': 0.0, 'balance': 100.0},
            {'debit': 450.0, 'credit': 0.0, 'balance': 450.0},
        ])
        ...
        self.assertRecordValues(invoice_storno.line_ids, [
            {'debit': 0.0, 'credit': 600.0, 'balance': -600.0},
            {'debit': 0.0, 'credit': -50.0, 'balance': 50.0},
