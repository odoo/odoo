...
class SaleOrder(models.Model):
    ...
    uninvoiced_balance = fields.Monetary(string="Un-invoiced Balance", store=True, compute='_compute_invoiced_amounts')
    amount_invoiced = fields.Monetary(string="Already invoiced", store=True, compute='_compute_invoiced_amounts')
    ...
    def _compute_invoiced_amounts(self):
        for order in self:
            order.uninvoiced_balance = sum(order.order_line.mapped('amount_to_invoice'))
