...
class SaleConfiguration(models.TransientModel):
    ...
    default_invoice_policy = fields.Selection([
        ...
        ], 'Default Invoicing', default='order', default_model='product.template')
    ...
    def onchange_sale_price(self):
        if self.sale_pricelist_setting == 'percentage':
            self.write({'group_product_pricelist': True, 'group_sale_pricelist': True, 'group_pricelist_item': False})
        elif self.sale_pricelist_setting == 'formula':
            self.write({'group_pricelist_item': True, 'group_sale_pricelist': True, 'group_product_pricelist': False})
        else:
            self.write({'group_pricelist_item': False, 'group_sale_pricelist': False, 'group_product_pricelist': False})
