...
class SaleOrderLine(models.Model):
    ...
    @api.depends('product_uom', 'untaxed_amount_to_invoice', 'invoice_lines.move_id.state', 'invoice_lines.quantity', 'invoice_lines.product_uom_id')
    def _get_invoice_qty(self):
        ...
        if origin_lines:
            ...
            self.flush(['product_uom', 'untaxed_amount_to_invoice', 'is_downpayment'])
