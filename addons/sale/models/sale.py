...
class SaleOrder(models.Model):
    ...
    analytic_account_id = fields.Many2one('account.analytic.account', 'Analytic Account', readonly=True, states={'draft': [('readonly', False)], 'sent': [('readonly', False)]}, help="The analytic <<< related to a sales order.", copy=False, oldname='project_id')
