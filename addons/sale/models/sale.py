...
class SaleOrder(models.Model):
    ...
    partner_id = fields.Many2one('res.partner', string='Customer', readonly=True, states={'draft': [('readonly', False)], 'sent': [('readonly', False)]}, required=True, change_default=True, index=True, track_visibility='always', help="You can find a customer by its Name, TIN, Email or Internal Reference.")
