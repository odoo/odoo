...
class SaleOrderLine(models.Model):
    ...
    def _get_display_price(self, product):
        ...
        final_price, rule_id = self.order_id.pricelist_id.get_product_price_rule(product, self.product_uom_qty or 1.0, self.order_id.partner_id)
    ...
    def _onchange_discount(self):
        ...
        price, rule_id = self.order_id.pricelist_id.get_product_price_rule(product, self.product_uom_qty or 1.0, self.order_id.partner_id)
