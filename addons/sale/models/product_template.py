...
class ProductTemplate(models.Model):
    ...
    def get_configurator_init_data(self, quantity=1, **kwargs):
        res = self.get_single_product_variant(quantity, **kwargs)
    ...
    def sale_product_configurator_get_values(
        ...
        **kwargs,
        ...
        """
        if company_id:
            self.with_context(allowed_company_ids=[company_id])
