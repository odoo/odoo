...
class sale_configuration(osv.TransientModel):
    ...
    _columns = {
        ...
        'sale_show_tax': fields.selection([
            ('total', 'Always show lines subtotal with taxes included'),
            ('subtotal', 'Show lines total based on unit price')], "Subtotal taxes",
            required=True, help='subtotal: Include taxes only if they are included in the unit price.\ntotal: Always show tax included'),
