...
class AccountMove(models.Model):
    ...
    def _get_name_invoice_report(self):
        self.ensure_one()
        if self.company_id.country_group_codes and 'GCC' in self.company_id.country_group_codes:
    ...
    def _load_narration_translation(self):
        ...
        for move in self.filtered(lambda m: m.narration and m.is_sale_document(include_receipts=True) and 'GCC' in m.company_id.country_group_codes):
