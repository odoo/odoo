...
class TestL10nPlBankAccountVerification(AccountTestInvoicingCommon):
            ...
            [
                {
                    ...
                    "bank_account_id": self.pl_supplier_bank_account.id,
            ...
            [
                {
                    ...
                    "bank_account_id": supplier_bank.id,
    ...
    def test_register_payment_for_non_pl_supplier(self, mock_get_api_response):
    ...
    def test_register_payment_for_non_pl_company(self, mock_get_api_response):
    ...
    def test_no_verification_duplicated(self):
        ...
        move = self.env[
        ...
        ].create(
            {
                ...
                "invoice_date": "2026-02-16",
                "journal_id": self.company_data["default_journal_purchase"].id,
                "bank_account_id": second_bank_account.id,  # Set second bank account for payment
                "invoice_line_ids": [
                    Command.create(
                        {
                            "product_id": self.product_a.id,
