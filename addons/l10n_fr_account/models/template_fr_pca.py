...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_fr_pca_template_data(self):
        return {
            'name': _('Association accounting plan'),
            'code_digits': 6,
    ...
    @template('fr_pca', 'account.fiscal.position')
    def _get_account_fiscal_position(self):
        return self._parse_csv('fr', 'account.fiscal.position')
