...
class TestFECExport(AccountTestInvoicingCommon):
    ...
    def test_fec_export(self):
        ...
        self.assertEqual(
            ...
            f'OUV|Balance initiale|OUVERTURE/2020|20200101|121000|Accounts Receivable|{self.partner_a.id}|partner_a|-|20200101|Balance initiale| 000000000003000,00|0,00|||20200101||\r\n'
            ...
            f'INV|Sales|INV/2020/00001|20200101|121000|Accounts Receivable|{self.partner_a.id}|partner_a|-|20200101|partner_a - INV/2020/00001| 000000000003000,00|0,00|||20200101| 000000000003000,00|USD'
        )
    ...
    def test_fec_initial_balance_skips_zero_net_partner_openings(self):
        ...
        self.assertEqual(
            b''.join(result['file_content']).decode(),
            'JournalCode|JournalLib|EcritureNum|EcritureDate|CompteNum|CompteLib|CompAuxNum|CompAuxLib|PieceRef|PieceDate|EcritureLib|Debit|Credit|EcritureLet|DateLet|ValidDate|Montantdevise|Idevise\r\n'
            f'MISC|Miscellaneous Operations|MISC/2020/06/0001|20200601|121000|Accounts Receivable|{self.partner_a.id}|partner_a|-|20200601|partner_a - MISC/2020/06/0001| 000000000000050,00|0,00|||20200601| 000000000000050,00|USD\r\n'
            'MISC|Miscellaneous Operations|MISC/2020/06/0001|20200601|400000|Product Sales|||-|20200601|MISC/2020/06/0001|0,00| 000000000000050,00|||20200601|-000000000000050,00|USD'
        )
