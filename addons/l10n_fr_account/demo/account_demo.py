...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _post_load_demo_data(self, company=False):
        ...
        if company.account_fiscal_country_id.code == 'FR':
            invoices = (
                    self.ref('demo_bill_fr')
                    + self.ref('demo_invoice_fr')
                    + self.ref('demo_move_affect_result_fr')
            )
    ...
    def _get_demo_data_move(self, company=False):
        ...
        if company.account_fiscal_country_id.code == 'FR':
            ...
            moves.update({
                self.company_xmlid('demo_bill_fr'): {
                ...
                self.company_xmlid('demo_invoice_fr'): {
                ...
                self.company_xmlid('demo_move_affect_result_fr'): {
                    'move_type': 'entry',
