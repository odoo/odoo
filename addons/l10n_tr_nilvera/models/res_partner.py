...
class ResPartner(models.Model):
    ...
    # This field is only used technically for optimisation purposes. It's needed for _compute_nilvera_customer_status.
    ...
    @api.depends('l10n_tr_nilvera_customer_status')
    def _compute_nilvera_customer_alias_id(self):
        for partner in self:
            if partner.l10n_tr_nilvera_customer_status == 'not_checked':
                partner.l10n_tr_nilvera_customer_alias_id = False
