...
class AccountJournal(models.Model):
    ...
    @api.depends('type', 'country_code', 'company_id.l10n_ge_edi_user_id')
    def _compute_show_refresh_out_einvoices_status_button(self):
        # EXTENDS 'account'
        super()._compute_show_refresh_out_einvoices_status_button()
        self.filtered(
            lambda j: j.type == 'sale' and j.country_code == 'GE' and j.company_id.sudo().l10n_ge_edi_user_id,
    ...
    def button_refresh_out_einvoices_status(self):
        ...
        self.env['account.move']._l10n_ge_edi_refresh_all_statuses(self.company_id)
