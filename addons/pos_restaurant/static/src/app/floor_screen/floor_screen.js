...
export class FloorScreen extends Component {
    ...
    setup() {
        ...
        useDraggable({
            ...
            onDrag: useThrottleForAnimation(({ element, position_h, position_v }) => {
                const table = getPosTable(element);
                table.position_h = position_h;
                table.position_v = position_v;
            ...
            onDrop: ({ element, position_h, position_v }) => {
                ...
                if (this.pos.isEditMode) {
                    this.pos.data.write("restaurant.table", [table.id], { position_h, position_v });
                } else {
        ...
        useDraggable({
            ...
            onDrag: useThrottleForAnimation((ctx) => {
                ...
                console.log(ctx.element.parentElement, this.map.el, limits);
