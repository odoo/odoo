...
registry.category("web_tour.tours").add("SplitBillScreenTour4PosCombo", {
    ...
    steps: () => [
        ...
        ...SplitBillScreen.subtotalIs("52.13"),
        ...SplitBillScreen.clickPay(),
        ...PaymentScreen.clickPaymentMethod("Bank"),
        ...PaymentScreen.clickValidate(),
        ...ReceiptScreen.clickContinueOrder(),
        ...
        ...ProductScreen.selectedOrderlineHas("Combo Product 2", "1.0", "6.15", "Office Combo"),
        ...ProductScreen.clickOrderline("Combo Product 4"),
        ...ProductScreen.selectedOrderlineHas("Combo Product 4", "1.0", "13.54", "Office Combo"),
        ...ProductScreen.clickOrderline("Combo Product 7"),
        ...ProductScreen.selectedOrderlineHas("Combo Product 7", "1.0", "20.31", "Office Combo"),
        ...ProductScreen.totalAmountIs("42.53"),
    ],
});
