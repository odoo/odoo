...
registry.category("web_tour.tours").add("PosResTicketScreenTour", {
    ...
    steps: () =>
        [
            ...
            TicketScreen.checkNoNewTicketButton(),
            ...
            Chrome.clickMenuButton(),
            Chrome.clickTicketButton(),
            TicketScreen.checkNthRowContains(2, "-0001"),
            ...
            FloorScreen.checkOrderCountSyncedInTableIs("2", "3"),
            Chrome.clickMenuButton(),
            Chrome.clickTicketButton(),
            ...
            ProductScreen.checkTotalAmountIs("3.0"),
            FloorScreen.backToFloor(),
