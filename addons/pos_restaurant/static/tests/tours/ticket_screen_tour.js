...
registry.category("web_tour.tours").add("OrderNumberConflictTour", {
    ...
    steps: () =>
        [
            ...
            Chrome.clickPlanButton(),
            Chrome.clickOrders(),
            TicketScreen.nthColumnContains(1, 7, "Order"),
            TicketScreen.nthColumnContains(1, 2, "T 103"),
            TicketScreen.nthColumnContains(2, 7, "Self-Order"),
            TicketScreen.nthColumnContains(2, 2, "T 101"),
        ].flat(),
});
