    ...
    def test_work_entry_timezone(self):
        ...
        hk_resource_calendar_id = self.env['resource.calendar'].create({
            ...
            'attendance_ids': [(5, 0, 0),
                (0, 0, {'dayofweek': '0', 'hour_from': 7, 'hour_to': 17, 'break_hours': 2}),
                (0, 0, {'dayofweek': '1', 'hour_from': 7, 'hour_to': 17, 'break_hours': 2}),
                (0, 0, {'dayofweek': '2', 'hour_from': 7, 'hour_to': 17, 'break_hours': 2}),
                (0, 0, {'dayofweek': '3', 'hour_from': 7, 'hour_to': 17, 'break_hours': 2}),
                (0, 0, {'dayofweek': '4', 'hour_from': 7, 'hour_to': 17, 'break_hours': 2}),
            ]
        })
