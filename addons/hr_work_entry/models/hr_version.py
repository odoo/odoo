...
class HrVersion(models.Model):
    ...
    def _get_applicable_leaves(self, start_dt, end_dt):
        leaves = self.env['resource.calendar.leaves'].search(self._get_leave_domain(start_dt, end_dt))
    ...
    def _get_version_work_entries_values(self, date_start, date_stop):
        ...
        all_leaves_by_resource = self._get_applicable_leaves(start_dt, end_dt)
