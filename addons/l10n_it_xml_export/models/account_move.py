...
class AccountMove(models.Model):
    ...
    def action_post(self):
        ...
        """
        closing_moves = self.filtered(lambda move: move.tax_closing_end_date and move.move_type == 'entry')
        if closing_moves and 'IT' in self.mapped('tax_country_code') and "l10n_it_xml_export_monthly_tax_report_options" not in self.env.context:
