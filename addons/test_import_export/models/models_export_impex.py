...
class ExportOne2manyChild1(models.Model, test_import_export.ExportOne2manyMultipleChild):
    _name = 'export.one2many.child.1'
    _description = 'Export One to Many Child 1'


class ExportOne2manyChild2(models.Model, test_import_export.ExportOne2manyMultipleChild):
