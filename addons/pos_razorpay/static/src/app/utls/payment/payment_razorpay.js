...
export class PaymentRazorpay extends PaymentInterface {
    ...
    async sendPaymentRequest(line) {
        ...
        this.isPaymentScreenActive = this.pos?.router?.currentScreen?.() === "PaymentScreen";
    ...
    async _waitForPaymentConfirmation() {
        this.isPaymentScreenActive = this.pos?.router?.currentScreen?.() === "PaymentScreen"; // When returning on payment screen from other screen
