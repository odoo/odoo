...
class ResCompany(models.Model):
    ...
    def _get_nemhandel_edi_mode(self):
        ...
        # by design, we can only have zero or one proxy user per company with type Nemhandel
        nemhandel_user = self.sudo().account_edi_proxy_client_ids.filtered(lambda u: u.proxy_type == 'nemhandel')
        return nemhandel_user.edi_mode or config_param or 'prod'
