...
registerRoute("/discuss/channel/get_or_create_chat", discuss_channel_get_or_create_chat);
/** @type {RouteCallback} */
async function discuss_channel_get_or_create_chat(request) {
...
registerRoute("/discuss/channel/create_channel", discuss_channel_create);
/** @type {RouteCallback} */
async function discuss_channel_create(request) {
    ...
    /** @type {import("mock_models").DiscussChannel} */
    const DiscussChannel = this.env["discuss.channel"];
    return DiscussChannel._channel_create(name, group_id)
}
