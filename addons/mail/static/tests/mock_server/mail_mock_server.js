...
export class StoreAttr {
    constructor(name, value, predicate) {
        const kwargs = unmakeKwArgs(getKwArgs(arguments, "name", "value", "predicate"));
        this.name = kwargs.name;
        delete kwargs.name;
        this.value = kwargs.value;
        delete kwargs.value;
        this.predicate = kwargs.predicate;
        delete kwargs.predicate;
    }
...
class Store {
    ...
    add(data, fields, as_thread, _delete, extra_fields, kwargs) {
        ...
        kwargs = unmakeKwArgs(
            getKwArgs(arguments, "data", "fields", "as_thread", "delete", "extra_fields")
        );
        data = kwargs.data;
        delete kwargs.data;
        fields = kwargs.fields;
    ...
    static many(records, fields, mode = "REPLACE", as_thread, kwargs) {
        kwargs = getKwArgs(arguments, "records", "fields", "mode");
    ...
    static one(records, fields, as_thread, kwargs) {
        kwargs = getKwArgs(arguments, "records", "fields");
        records = kwargs.records;
        delete kwargs.records;
        fields = kwargs.fields;
        delete kwargs.fields;
