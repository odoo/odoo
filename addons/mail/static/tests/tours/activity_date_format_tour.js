...
registry.category("web_tour.tours").add("mail_activity_date_format", {
    ...
    steps: () => [
        ...
        // Format expected from the server for the first second of 2024 is date_format = "%d/%b/%y", time_format = "%I:%M:%S %p".
        {
            trigger: ".o-mail-Activity-details tr:contains('Created') td:contains('01/Jan/24 12:00:00 AM')",
            isCheck: true,
        },
        {
