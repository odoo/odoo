...
registry.category("web_tour.tours").add("test_discuss_sub_channel_search", {
    steps: () => [
        ...
        {
            trigger: ".o-mail-SubChannelList:has(.o-mail-SubChannelPreview, 30)",
            async run() {
        ...
        {
            trigger:
                ".o-mail-SubChannelList:has(.o-mail-SubChannelPreview, 1):contains(Sub Channel 10)",
        },
        {
        ...
        {
            trigger:
                ".o-mail-SubChannelList:has(.o-mail-SubChannelPreview, 31):contains(Sub Channel 10)",
            async run() {
        ...
        {
            trigger: ".o-mail-SubChannelList:has(.o-mail-SubChannelPreview, 61)",
            async run() {
                for (let i = 99; i > 39; i--) {
                    await contains(".o-mail-SubChannelPreview", {
                        text: `Sub Channel ${i}`,
        ...
        {
            trigger: ".o-mail-SubChannelList:has(.o-mail-SubChannelPreview, 90)",
            async run() {
                for (let i = 99; i > 9; i--) {
                    await contains(".o-mail-SubChannelPreview", {
                        text: `Sub Channel ${i}`,
        ...
        {
            trigger: ".o-mail-SubChannelList:has(.o-mail-SubChannelPreview, 100)",
            async run() {
                for (let i = 99; i >= 0; i--) {
                    await contains(".o-mail-SubChannelPreview", {
                        text: `Sub Channel ${i}`,
