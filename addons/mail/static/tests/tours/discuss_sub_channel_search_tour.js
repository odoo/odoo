...
registry.category("web_tour.tours").add("test_discuss_sub_channel_search", {
    steps: () => [
        ...
        {
            trigger:
                ".o-mail-SubChannelList .o-mail-SubChannelPreview:count(31):contains(Sub Channel 10)",
            async run() {
        ...
        {
            trigger: ".o-mail-SubChannelList .o-mail-SubChannelPreview:count(61)",
            async run() {
                for (let i = 99; i > 39; i--) {
                    await contains(".o-mail-SubChannelPreview", {
                        text: `Sub Channel ${i}`,
        ...
        {
            trigger: ".o-mail-SubChannelList .o-mail-SubChannelPreview:count(90)",
            async run() {
                for (let i = 99; i > 9; i--) {
                    await contains(".o-mail-SubChannelPreview", {
                        text: `Sub Channel ${i}`,
        ...
        {
            trigger: ".o-mail-SubChannelList .o-mail-SubChannelPreview:count(100)",
            async run() {
                for (let i = 99; i >= 0; i--) {
                    await contains(".o-mail-SubChannelPreview", {
                        text: `Sub Channel ${i}`,
