...
registry.category("web_tour.tours").add("mail_template_dynamic_placeholder_tour", {
    ...
    steps: () => [
        ...
        {
            content: "Ensure the editable contain the dynamic placeholder t tag",
            trigger: `.note-editable.odoo-editor-editable t[t-out=\"format_datetime(object.create_date, tz=object.partner_id.tz) + ' (' + (object.partner_id.tz or env.user.tz) + ')'\"]:contains("localTime")`,
        },
        {
