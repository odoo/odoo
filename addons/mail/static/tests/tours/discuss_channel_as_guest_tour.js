                ...
                run() {
                    ...
                    odoo.__DEBUG__.didLogInfo.then(() => {
                        ...
                        document.body.classList.add(
                            "o_discuss_channel_as_guest_tour_modules_loaded"
                        );
                    });
                },
                extraTrigger: ".o_discuss_channel_as_guest_tour_modules_loaded",
            },
            {
                content: "Wait for all modules loaded check in previous step",
                trigger: ".o_discuss_channel_as_guest_tour_modules_loaded",
            },
            {
