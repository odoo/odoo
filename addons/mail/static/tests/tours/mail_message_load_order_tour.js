...
registry.category("web_tour.tours").add("mail_message_load_order_tour", {
    steps: () => [
        ...
        {
            trigger: ".o-mail-Thread:has(.o-mail-Message, 30)",
            async run() {
        ...
        },
        {
            ...
            trigger:
                ".o-mail-Thread:has(.o-mail-Message, 31) .o-mail-Message:first .o-mail-Message-textContent:not(:contains(31))",
            async run() {
        ...
        },
        {
            ...
            trigger:
                ".o-mail-Thread:has(.o-mail-Message, 60) .o-mail-Message-textContent:contains(17)",
            async run() {
