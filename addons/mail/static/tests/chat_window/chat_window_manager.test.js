...
test("chat window does not fetch messages if hidden", async () => {
    ...
    await contains(".o-mail-Message-content:contains(Orange)");
    await contains(".o-mail-Message-content:contains(Apple)", { count: 0 });
    await contains(".o-mail-Message-content:contains(Banana)");
...
test("click on hidden chat window should fetch its messages", async () => {
    ...
    await contains(".o-mail-Message-content:contains(Orange)");
    await contains(".o-mail-Message-content:contains(Apple)");
    await contains(".o-mail-Message-content:contains(Banana)", { count: 0 });
...
test("closing the last visible chat window should unhide the first hidden one", async () => {
    ...
    await click(".o-mail-ChatWindow-command[title='Close Chat Window']", {
        parent: [".o-mail-ChatWindow:contains(channel-D)"],
    });
    await contains(".o-mail-ChatWindow:eq(0):contains(channel-A)");
