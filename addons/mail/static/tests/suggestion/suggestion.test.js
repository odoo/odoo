...
test("Internal user should be displayed first", async () => {
    ...
    await contains(":nth-child(1 of .o-mail-Composer-suggestion)", { text: "Person D" });
    await contains(":nth-child(2 of .o-mail-Composer-suggestion)", { text: "Person C" });
    await contains(":nth-child(3 of .o-mail-Composer-suggestion)", { text: "Person B" });
    await contains(":nth-child(4 of .o-mail-Composer-suggestion)", { text: "Person A" });
});
...
test("Current user that is a follower should be considered as such", async () => {
    ...
    await contains(".o-mail-Composer-suggestion", {
        text: "Mitchell Admin",
        before: [".o-mail-Composer-suggestion", { text: "Person B" }],
    });
    await contains(".o-mail-Composer-suggestion", {
        text: "Person B",
        before: [".o-mail-Composer-suggestion", { text: "Person A" }],
    });
});
