...
test("Compact chat hub is crosstab synced", async () => {
    ...
    await click(`${env1.selector} button.fa.fa-ellipsis-h[title='Chat Options']`);
    await click(`${env1.selector} button.o-mail-ChatHub-option`, {
        text: "Hide all conversations",
    });
    await contains(`${env1.selector} .o-mail-ChatBubble .fa-commenting`);
    await contains(`${env2.selector} .o-mail-ChatBubble .fa-commenting`);
});
