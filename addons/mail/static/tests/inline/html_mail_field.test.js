...
test("HtmlMail add icon and save inline html", async function () {
    onRpc("web_save", ({ args }) => {
        expect(args[1].body.replace(/font-size: (\d+(\.\d+)?)px/, "font-size: []px")).toBe(
            `<p style="margin:0px 0 16px 0;box-sizing:border-box;"><span style="display: inline-block; width: 0px; height: 0px; vertical-align: text-bottom;" class="oe_unbreakable "><img width="0" height="0" src="/web_editor/font_to_img/61440/rgb(55%2C65%2C81)/rgb(249%2C250%2C251)/1x1" data-class="fa fa-glass" data-style="null" style="box-sizing: border-box; line-height: 14px; width: 0px; height: 0px; vertical-align: unset; margin: 0px;"></span>first</p>`
        );
        expect.step("web_save");
    });
    await mountView({
