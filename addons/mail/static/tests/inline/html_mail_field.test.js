...
test("HtmlMail add icon and save inline html", async function () {
    ...
    onRpc("web_save", ({ args }) => {
        expect(args[1].body).toBe(
            '<p style="border-radius:0px;border-style:none;padding:0px;margin:0px 0 16px 0;box-sizing:border-box;border-left-width:0px;border-bottom-width:0px;border-right-width:0px;border-top-width:0px;border-left-color:#ff0000;border-bottom-color:#ff0000;border-right-color:#ff0000;border-top-color:#ff0000;"><span style="display: inline-block; width: 14.0156px; height: 14px; vertical-align: text-bottom;" class="oe_unbreakable"><img width="14.0156" height="15" src="/mail/font_to_img/oi_local_bar/rgb(17%2C24%2C39)/rgb(255%2C255%2C255)/14x15" data-class="oi" data-style="null" style="border-radius:0px;border-style:none;padding:0px;border-left-width:0px;border-bottom-width:0px;border-right-width:0px;border-top-width:0px;border-left-color:#ff0000;border-bottom-color:#ff0000;border-right-color:#ff0000;border-top-color:#ff0000;box-sizing: border-box; line-height: 14px; width: 14.0156px; height: 15px; vertical-align: unset; margin: 0px;"></span>first</p>'
        );
        expect.step("web_save");
    });
    await mountView({
