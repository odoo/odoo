...
describe("Should not convert blacklisted class to inline styles", () => {
    ...
    test("should not convert blacklisted class to inline style", async () => {
        ...
        expect(editable).toHaveInnerHTML(
            `<a contenteditable="false" href="#" class="o_mail_redirect" style="text-decoration: none; padding: 0rem 0.1875rem; box-sizing: border-box; overflow-wrap: unset;"> @Marc Demo </a> Testing!`,
            {
    ...
    test("should convert styles from class using !important even if blacklisted class is present", async () => {
        ...
        classToStyle(editable, getCSSRules(editable.ownerDocument));
        expect(editable).toHaveInnerHTML(
            `<a contenteditable="false" href="#" class="o_mail_redirect test-style" style="text-decoration: none; padding: 0rem 0.1875rem; box-sizing: border-box; background-color: yellow; overflow-wrap: unset;"> @Marc Demo </a> Testing!`,
    ...
    test("should not convert style of class having less specificity when overridden by a blacklisted class", async () => {
        ...
        classToStyle(editable, getCSSRules(editable.ownerDocument));
        expect(editable).toHaveInnerHTML(
            `<a contenteditable="false" href="#" class="o_mail_redirect test-color" style="text-decoration: none; padding: 0rem 0.1875rem; box-sizing: border-box; overflow-wrap: unset;"> @Marc Demo </a> Testing!`,
            {
                message:
