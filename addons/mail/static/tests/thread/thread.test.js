...
test("message received while loading thread on last read message is shown once after scrolling down", async () => {
    ...
    loadResolve();
    await contains(".o-mail-Message-content", { text: "msg39" });
    await contains(".o-mail-Message-content", { text: "Hello", count: 0 });
    await scroll(".o-mail-Thread", "bottom");
    await contains(".o-mail-Message-content", { text: "msg54" });
    await contains(".o-mail-Message-content", { text: "Hello", count: 1 });
});
