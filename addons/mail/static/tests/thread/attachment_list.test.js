...
test("layout with image, video and document files", async () => {
    ...
    await start();
    await openDiscuss(channelId);
    await contains(".o-mail-AttachmentList:eq(0) .o-mail-AttachmentImage");
    await contains(".o-mail-AttachmentList:eq(1) .o-mail-AttachmentVideo");
    await contains(".o-mail-AttachmentList:eq(2) .o-mail-AttachmentCard");
});
