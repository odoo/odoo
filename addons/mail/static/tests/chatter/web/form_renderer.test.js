...
test("[TECHNICAL] unfolded read more/less links should not fold on message click besides those links", async () => {
    ...
    // any re-render would re-insert the read more/less links. If some links
