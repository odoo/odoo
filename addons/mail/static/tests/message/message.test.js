...
test("Notification Sent", async () => {
    ...
    expect(".o-mail-MessageNotificationPopover i:first[data-icon='check']").toHaveClass("fa-check");
    expect(".o-mail-MessageNotificationPopover i:last[data-icon='check']").toHaveClass("fa-check");
