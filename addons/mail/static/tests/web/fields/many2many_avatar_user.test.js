...
test('many2one_avatar_user widget edited by the smart action "Assign to me" in list view', async () => {
    ...
    await contains(":nth-child(1 of .o_data_row) .o_field_many2one_avatar_user .o-many2one", {
        text: "Luigi",
    });
    await contains(":nth-child(2 of .o_data_row) .o_field_many2one_avatar_user .o-many2one", {
        text: "Mario",
    });
    // Select all
