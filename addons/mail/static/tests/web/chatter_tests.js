...
QUnit.test("Chatter rendering with activities", async (assert) => {
    ...
    for (const [displayTodoDone, displayUploadDone] of [[true, false], [false, true], [true, true], [false, false]]) {
        ...
        await contains(".o-mail-ActivityList:contains('Planned Activities')");
        if (displayDone) {
            await contains(".o-mail-ActivityList:contains('Completed Activities')");
        }
        ...
        await contains(".o-mail-ActivityList .o-mail-Activity:contains('Due in')");
        await contains(".o-mail-ActivityList .o-mail-Activity:contains('Today')");
        await contains(`.o-mail-ActivityList .o-mail-CompletedActivity:contains('${todoDoneDate}')`, { count: 0 });
        await contains(`.o-mail-ActivityList .o-mail-CompletedActivity:contains('${uploadDoneDate}')`, { count: 0 });
        ...
        if (displayDone) {
            ...
            if (displayTodoDone) {
                await contains(`.o-mail-ActivityList .o-mail-CompletedActivity:contains('${todoDoneDate}')`);
            }
            if (displayUploadDone) {
                await contains(`.o-mail-ActivityList .o-mail-CompletedActivity:contains('${uploadDoneDate}')`);
                await contains(".o-mail-AttachmentCard:contains('test.txt')");
            } else {
                await contains(".o-mail-AttachmentCard:contains('test.txt')", { count: 0 });
            }
        } else {
            await contains(".o-mail-ActivityList div:contains('Completed Activities') .fa-caret-right", { count: 0 });
        ...
        await contains(".o-mail-ActivityList .o-mail-Activity:contains('Due in')", { count: 0 });
        await contains(".o-mail-ActivityList .o-mail-Activity:contains('Today')", { count: 0 });
        if (displayDone) {
            await contains(".o-mail-ActivityList .o-mail-CompletedActivity", { count: nCompleted });
            if (displayTodoDone) {
                await contains(`.o-mail-ActivityList .o-mail-CompletedActivity:contains('${todoDoneDate}')`);
