...
test("can mark message as unread from history", async () => {
    ...
    await start();
    await openDiscuss("mail.box_history");
    await contains(".o-mail-Message", { text: "lorem ipsum" });
    await click("[title='Mark as Unread']");
    await contains(".o-mail-Message", { text: "lorem ipsum", count: 0 });
    await click("button", { text: "Inbox", contains: [".badge", { text: "1" }] });
    await contains(".o-mail-Message", { text: "lorem ipsum" });
    await click(".o-mail-MessagingMenu-counter", { text: "1" });
    await contains(".o-mail-NotificationItem", { text: "John Doe: lorem ipsum" });
});
