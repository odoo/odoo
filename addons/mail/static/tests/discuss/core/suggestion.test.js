...
test("use a command for a specific channel type", async () => {
    ...
    await insertText(".o-mail-Composer-input", "/");
    await click(".o-mail-Composer-suggestion", { text: "who" });
...
test("Sort partner suggestions by recent chats", async () => {
    ...
    await contains(":nth-child(1 of .o-mail-Composer-suggestion)", { text: "User 2" });
    await contains(":nth-child(2 of .o-mail-Composer-suggestion)", { text: "User 3" });
    await contains(":nth-child(3 of .o-mail-Composer-suggestion)", { text: "User 1" });
});
...
test("mention suggestion are shown after deleting a character", async () => {
    ...
    await contains(".o-mail-Composer-suggestion", { text: "John Doe" });
    await insertText(".o-mail-Composer-input", "a");
    await contains(".o-mail-Composer-suggestion", { count: 0, text: "John D" });
...
test("command suggestion are shown after deleting a character", async () => {
    ...
    await contains(".o-mail-Composer-suggestion", { text: "help" });
    await insertText(".o-mail-Composer-input", "e");
    await contains(".o-mail-Composer-suggestion", { count: 0, text: "help" });
    // Simulate pressing backspace
    await press("Backspace");
    await contains(".o-mail-Composer-suggestion", { text: "help" });
});
