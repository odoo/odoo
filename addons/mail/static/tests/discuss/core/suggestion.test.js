...
test("Sort partner suggestions by recent chats", async () => {
    ...
    await contains(".o-mail-Composer-suggestion:eq(0)", { text: "User 2" });
    await contains(".o-mail-Composer-suggestion:eq(1)", { text: "User 3" });
    await contains(".o-mail-Composer-suggestion:eq(2)", { text: "User 1" });
});
