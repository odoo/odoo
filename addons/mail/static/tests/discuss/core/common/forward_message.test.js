...
test("forward message to another channel", async () => {
    ...
    await contains(".o-discuss-ChannelActionDialog.o-mail-ForwardDialog");
    await click(
        ".o-mail-ForwardDialog .o-discuss-ChannelInvitation-selectable:has(:text('Target'))"
    );
    await insertText(".o-mail-ForwardDialog textarea", "My optional note");
    await click(".o-mail-ForwardDialog button:text(Send)");
