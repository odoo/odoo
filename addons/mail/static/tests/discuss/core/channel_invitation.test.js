...
test("Create group chat transfers active call to new group chat", async () => {
    ...
    await contains(
        ".o-discuss-CallActionList .o-mail-ActionList-button.btn-success [data-icon='videocam']"
    );
    await contains(".o-discuss-CallActionList .o-mail-ActionList-button [data-icon='mic']");
