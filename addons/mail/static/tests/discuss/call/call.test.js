...
test("discuss sidebar call participant shows appropriate status icon", async () => {
    ...
    await contains(
        ".o-mail-DiscussSidebarCallParticipants:contains('Mitchell Admin') [data-icon='hearing_disabled']"
    );
    await contains(
        ".o-mail-DiscussSidebarCallParticipants:contains('Mitchell Admin') [data-icon='mic_off']",
        { count: 0 }
    ...
    await contains(
        ".o-mail-DiscussSidebarCallParticipants:contains('bob') [data-icon='hearing_disabled']"
    );
});
