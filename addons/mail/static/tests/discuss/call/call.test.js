...
test("'Start a meeting' in mobile", async () => {
    ...
    await click("button:contains(Start a meeting)");
    await click(".o-discuss-ChannelInvitation-selectable:contains(Partner 2)");
    await click("button:not([disabled]):contains(Invite to Group Chat)");
    await contains(".o-discuss-Call");
    await click("[title='Open Actions Menu']");
    await click("[title='Show Member List']");
    await contains(".o-discuss-ChannelMember:contains(Partner 2)");
});
