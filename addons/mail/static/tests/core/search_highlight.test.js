...
test("Search highlight", async () => {
    const testCases = [
        {
            input: htmlMarkup`test odoo`,
            output: `test <span class="${HIGHLIGHT_CLASS}">odoo</span>`,
            searchTerm: "odoo",
        },
        {
            input: htmlMarkup`<a href="https://www.odoo.com">https://www.odoo.com</a>`,
        ...
        {
            input: htmlMarkup`<a href="https://www.odoo.com">Odoo</a>`,
            output: `<a href="https://www.odoo.com"><span class="${HIGHLIGHT_CLASS}">Odoo</span></a>`,
            searchTerm: "odoo",
        },
        {
            input: htmlMarkup`<a href="https://www.odoo.com">Odoo</a> Odoo is a free software`,
        ...
        {
            input: htmlMarkup`odoo is a free software`,
            output: `<span class="${HIGHLIGHT_CLASS}">odoo</span> is a free software`,
            searchTerm: "odoo",
        },
        {
            input: htmlMarkup`software ODOO is a free`,
        ...
        {
            input: htmlMarkup`test <strong>Odoo</strong> test`,
