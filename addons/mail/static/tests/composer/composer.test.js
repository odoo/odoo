...
test("composer text input: basic rendering when posting a message", async () => {
    ...
    await contains("div.o-mail-Composer-input p[o-we-hint-text='Send a message to followers…']");
});
...
test("composer text input: basic rendering when logging note", async () => {
    ...
    await contains("div.o-mail-Composer-input p[o-we-hint-text='Log an internal note…']");
});
...
test("composer text input placeholder should contain channel name when thread does not have specific correspondent", async () => {
    ...
    await start();
    await openDiscuss(channelId);
    await contains("div.o-mail-Composer-input p[o-we-hint-text='Message #General…']");
});
...
test("composer input placeholder in channel thread", async () => {
    ...
    await contains(`.o-mail-Composer-input p[o-we-hint-text='Message "ThreadFromGeneral"']`);
});
...
test("composer textarea content is retained when changing channel then going back", async () => {
    ...
    await contains("div.o-mail-Composer-input p[o-we-hint-text='Message #epic-shrek-lovers…']");
    await contains(".o-mail-Composer-input", { text: "" });
...
test("pending mentions are kept when toggling composer", async () => {
    ...
    await click("button", { text: "Send message" });
    await insertText(".o-mail-Composer-input", "@");
    await click(".o-mail-Composer-suggestion", { text: "Mitchell Admin" });
...
test("leave command on channel", async () => {
    ...
    await click(".o-mail-Composer-suggestion", { text: "leave" });
...
test("composer text input placeholder should contain correspondent name when thread has exactly one correspondent", async () => {
    ...
    await start();
    await openDiscuss(channelId);
    await contains("div.o-mail-Composer-input p[o-we-hint-text='Message Marc Demo…']");
});
...
test('display canned response suggestions on typing "::"', async () => {
    ...
    await insertText(".o-mail-Composer-input", "::");
    await contains(".o-mail-Composer-suggestion-title", { text: "hello" });
    await contains(".o-mail-Composer-suggestion-description", { text: "Hello! How are you?" });
});
...
test("Canned response can be updated from the bus", async () => {
    ...
    await insertText(".o-mail-Composer-input", "::");
    await contains(".o-mail-Composer-suggestion-title", { text: "hello" });
    await contains(".o-mail-Composer-suggestion-description", { text: "Howdy! How are you?" });
});
...
test("Canned response can be deleted from the bus", async () => {
    ...
    await contains(".o-mail-Composer-suggestion-title", { text: "hello" });
    await contains(".o-mail-Composer-suggestion-title", { text: "test" });
    await insertText(".o-mail-Composer-input", "", { replace: true });
    await contains(".o-mail-Composer-suggestion", { count: 0 });
...
test("Canned response last used changes on posting", async () => {
    ...
    await insertText(".o-mail-Composer-input", "::");
    await contains(".o-mail-Composer-suggestion-title", { text: "test" });
    await contains(".o-mail-Composer-suggestion-description", { text: "Test a canned response?" });
    await click(".o-mail-Composer-suggestion");
...
test.skip("Tab to select of canned response suggestion works in chat window", async () => {
    ...
    await contains(".o-mail-Composer-suggestion-title", {
        text: "Goodbye",
        before: [".o-mail-Composer-suggestion-title", { text: "Hello" }],
    });
    await contains(".o-mail-Composer-suggestion-description", {
        text: "Goodbye! See you soon!",
        before: [".o-mail-Composer-suggestion-description", { text: "Hello! How are you?" }],
    });
    await contains(".o-mail-Composer-suggestion.active .o-mail-Composer-suggestion-title", {
        text: "Goodbye",
    });
...
test('can quickly add emoji with ":" keyword', async () => {
    ...
    await contains(".o-mail-Composer-suggestion", { text: "😅:sweat_smile:" });
    await click(".o-mail-Composer-suggestion", { text: "😅:sweat_smile:" });
    await contains(".o-mail-Composer-input", { text: "😅" });
    await contains(".o-mail-SuggestionList", { count: 0 });
