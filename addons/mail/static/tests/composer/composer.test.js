...
test("leave command on channel", async () => {
    ...
    await contains(".o-mail-Composer-suggestion", { text: "leave" });
    triggerHotkey("Enter");
...
test('display canned response suggestions on typing "::"', async () => {
    ...
    await insertText(".o-mail-Composer-input", "::");
    await contains(".o-mail-Composer-suggestionTitle", { text: "hello" });
    await contains(".o-mail-Composer-suggestionDescription", { text: "Hello! How are you?" });
});
...
test("Canned response can be updated from the bus", async () => {
    ...
    await insertText(".o-mail-Composer-input", "::");
    await contains(".o-mail-Composer-suggestionTitle", { text: "hello" });
    await contains(".o-mail-Composer-suggestionDescription", { text: "Howdy! How are you?" });
});
...
test("Canned response can be deleted from the bus", async () => {
    ...
    await contains(".o-mail-Composer-suggestionTitle", { text: "hello" });
    await contains(".o-mail-Composer-suggestionTitle", { text: "test" });
    await insertText(".o-mail-Composer-input", "", { replace: true });
    await contains(".o-mail-Composer-suggestion", { count: 0 });
...
test("Canned response last used changes on posting", async () => {
    ...
    await insertText(".o-mail-Composer-input", "::");
    await contains(".o-mail-Composer-suggestionTitle", { text: "test" });
    await contains(".o-mail-Composer-suggestionDescription", { text: "Test a canned response?" });
    await click(".o-mail-Composer-suggestion");
