...
import { Base } from "./mock_server/TO_REMOVE/base";
import { DiscussChannel } from "./mock_server/TO_REMOVE/discuss_channel";
import { DiscussChannelMember } from "./mock_server/TO_REMOVE/discuss_channel_member";
import { DiscussChannelRtcSession } from "./mock_server/TO_REMOVE/discuss_channel_rtc_session";
import { DiscussGifFavorite } from "./mock_server/TO_REMOVE/discuss_gif_favorite";
import { DiscussVoiceMetadata } from "./mock_server/TO_REMOVE/discuss_voice_metadata";
import { IrAttachment } from "./mock_server/TO_REMOVE/ir_attachment";
import { IrWebSocket } from "./mock_server/TO_REMOVE/ir_websocket";
import { M2xAvatarUser } from "./mock_server/TO_REMOVE/m2x_avatar_user";
import { MailActivity } from "./mock_server/TO_REMOVE/mail_activity";
import { MailActivityType } from "./mock_server/TO_REMOVE/mail_activity_type";
import { MailFollowers } from "./mock_server/TO_REMOVE/mail_followers";
import { MailGuest } from "./mock_server/TO_REMOVE/mail_guest";
import { MailLinkPreview } from "./mock_server/TO_REMOVE/mail_link_preview";
import { MailMessage } from "./mock_server/TO_REMOVE/mail_message";
import { MailMessageReaction } from "./mock_server/TO_REMOVE/mail_message_reaction";
import { MailMessageSubtype } from "./mock_server/TO_REMOVE/mail_message_subtype";
import { MailNotification } from "./mock_server/TO_REMOVE/mail_notification";
import { MailShortcode } from "./mock_server/TO_REMOVE/mail_shortcode";
import { MailTemplate } from "./mock_server/TO_REMOVE/mail_template";
import { MailThread } from "./mock_server/TO_REMOVE/mail_thread";
import { MailTrackingValue } from "./mock_server/TO_REMOVE/mail_tracking_value";
import { ResFake } from "./mock_server/TO_REMOVE/res_fake";
import { ResPartner } from "./mock_server/TO_REMOVE/res_partner";
import { ResUsers } from "./mock_server/TO_REMOVE/res_users";
import { ResUsersSettings } from "./mock_server/TO_REMOVE/res_users_settings";
import { ResUsersSettingsVolumes } from "./mock_server/TO_REMOVE/res_users_settings_volumes";
