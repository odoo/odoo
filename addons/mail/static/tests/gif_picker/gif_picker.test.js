...
test("GIF picker displays Klipy attribution when feature is enabled", async () => {
    ...
    await click("button[title='Add GIFs']");
    await contains(".o-discuss-GifPicker");
    await contains(".o-discuss-GifPicker-klipyAttribution-link[href='https://klipy.com'][target='_blank']", {
        text: "Powered by KLIPY",
    });
    await contains(".o-discuss-GifPicker-klipyAttribution-brand", { text: "KLIPY" });
});
