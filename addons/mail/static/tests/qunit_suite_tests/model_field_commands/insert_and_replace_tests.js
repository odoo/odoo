...
QUnit.module("mail", {}, function () {
    QUnit.module("model_field_commands", {}, function () {
        QUnit.module.skipRefactoring("insert_and_replace_tests.js");
        ...
        QUnit.test(
            ...
            async function (assert) {
                ...
                assert.strictEqual(task10.title, "task 10 updated", "the record should be updated");
                assert.strictEqual(task20.responsible, undefined, "the record should be replaced");
            }
        );
    });
});
