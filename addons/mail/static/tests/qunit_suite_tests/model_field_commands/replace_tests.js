    ...
    QUnit.module("model_field_commands", {}, function () {
        ...
        QUnit.test(
            ...
            async function (assert) {
                ...
                assert.strictEqual(contact.tasks.length, 1, "should have 1 record");
                assert.strictEqual(contact.tasks[0], task, "the new record should be linked");
                assert.strictEqual(
                    task.responsible,
                    contact,
        ...
        QUnit.test(
            ...
            async function (assert) {
                ...
                assert.strictEqual(contact.tasks[0], task20, "records should be re-ordered");
                assert.strictEqual(contact.tasks[1], task10, "recprds should be re-ordered");
            }
        );
    });
});
