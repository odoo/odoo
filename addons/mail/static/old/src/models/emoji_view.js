...
registerModel({
    ...
    recordMethods: {
        ...
        onMouseenter(ev) {
            ...
            this.update({
                emojiGridViewAsHovered: this.emojiGridItemViewOwner.emojiGridRowViewOwner
                    .emojiGridViewOwner,
            });
        },
        /**
    ...
    fields: {
        ...
        emojiPickerViewOwner: one("EmojiPickerView", {
            compute() {
                return this.emojiGridItemViewOwner.emojiGridRowViewOwner.emojiGridViewOwner
                    .emojiPickerViewOwner;
            },
        }),
    },
});
