...
QUnit.module("mail", {}, function () {
    QUnit.module("widgets", {}, function () {
        ...
        QUnit.test(
            "notification_alert widget: display blocked notification alert",
        ...
        QUnit.test(
            "notification_alert widget: no notification alert when granted",
            async function (assert) {
                assert.expect(1);
        ...
        QUnit.test(
            "notification_alert widget: no notification alert when default",
            async function (assert) {
                assert.expect(1);
