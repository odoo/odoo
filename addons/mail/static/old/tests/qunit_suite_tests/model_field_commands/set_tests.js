...
import { decrement, increment, set } from "@mail/model/model_field_command";
...
QUnit.module("mail", {}, function () {
    QUnit.module("model_field_commands", {}, function () {
        ...
        QUnit.test("set: should set a value for attribute field", async function (assert) {
            ...
            assert.strictEqual(task.difficulty, 20, "set: should set a value for attribute field");
        });
        ...
        QUnit.test("multiple attribute commands combination", async function (assert) {
            ...
            task.update({
                difficulty: [set(20), increment(16), decrement(8)],
            });
            assert.strictEqual(
                task.difficulty,
                20 + 16 - 8,
