 ...
 * @property {Translation|((params: ActionParams_T) => Translation)} [actionPanelName]
 ...
 * @property {boolean|Translation|((params: ActionParams_T) => boolean|Translation)} [inlineName=false]
 * @property {boolean|(params: ActionParams_T) => boolean} [isActive]
 * @property {Translation|(params: ActionParams_T) => Translation} [name]
