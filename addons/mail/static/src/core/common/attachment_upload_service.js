...
export class AttachmentUploadService {
    ...
    /** @deprecated  Use {@link upload} instead */
    async uploadFile(hooker, file, options) {
        return this.upload(hooker.thread, hooker.composer, file, options);
    }
    ...
    /** @deprecated  Use {@link _buildFormData} instead */
    _makeFormData(formData, file, hooker, tmpId, options) {
        return this._buildFormData(formData, file, hooker.thread, hooker.composer, tmpId, options);
    }
