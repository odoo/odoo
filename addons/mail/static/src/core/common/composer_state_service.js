...
export const composerStateService = {
    ...
    start(env, { multi_tab }) {
        ...
        odoo.composerState = {
            ...
            setTextarea: () => state.setComposerType("textarea"),
            setHtml: () => state.setComposerType("html"),
        };
        return state;
    },
};

registry.category("services").add("mail.composer_state_service", composerStateService);
