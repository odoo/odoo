...
export class Message extends Record {
    ...
    static insert(data) {
        let message;
        if (data.res_id) {
            this.store.Thread.insert({ model: data.model, id: data.res_id });
        }
    ...
    static _updateReactions(message, reactionGroups) {
