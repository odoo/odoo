...
export class ComposerSuggestedRecipient extends Component {
     ...
     */
    _update() {
        if (this._checkboxRef.el && this.composerSuggestedRecipientView && this.composerSuggestedRecipientView.suggestedRecipientInfo) {
     ...
     */
    _onChangeCheckbox() {
        if (!this.composerSuggestedRecipientView) {
            return;
        }
