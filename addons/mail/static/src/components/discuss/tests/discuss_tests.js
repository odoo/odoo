...
QUnit.test('basic rendering: sidebar', async function (assert) {
    ...
    assert.strictEqual(
        document.querySelectorAll(`
            ...
            .o_DiscussSidebar_item[data-thread-local-id="${
                this.env.services.messaging.messaging.inbox.localId
            }"]
        `).length,
        1,
    ...
    assert.strictEqual(
        document.querySelectorAll(`
            .o_DiscussSidebar_groupMailbox
            .o_DiscussSidebar_item[data-thread-local-id="${
                this.env.services.messaging.messaging.starred.localId
            }"]
        `).length,
        1,
    ...
    assert.strictEqual(
        document.querySelectorAll(`
            .o_DiscussSidebar_groupMailbox
            .o_DiscussSidebar_item[data-thread-local-id="${
                this.env.services.messaging.messaging.history.localId
            }"]
        `).length,
        1,
    ...
    assert.containsOnce(
        ...
        `
            .o_Discuss_thread[data-thread-local-id="${
                this.env.services.messaging.models['mail.thread'].findFromIdentifyingData({ id: 20, model: 'mail.channel' }).localId
            }"]
        `,
...
QUnit.test('basic rendering of squashed message', async function (assert) {
    ...
    const message2 = document.querySelector(`
        ...
        .o_ThreadView_messageList
        .o_MessageList_message[data-message-local-id="${
            this.env.services.messaging.models['mail.message'].findFromIdentifyingData({ id: 101 }).localId
        }"]
    `);
    assert.notOk(
...
QUnit.test('composer state: attachments save and restore', async function (assert) {
    ...
    assert.strictEqual(
        ...
        this.env.services.messaging.models['mail.attachment'].findFromIdentifyingData({ id: 1 }).localId,
    ...
    assert.strictEqual(
        ...
        this.env.services.messaging.models['mail.attachment'].findFromIdentifyingData({ id: 2 }).localId,
    ...
    assert.strictEqual(
        ...
        this.env.services.messaging.models['mail.attachment'].findFromIdentifyingData({ id: 3 }).localId,
    ...
    assert.strictEqual(
        ...
        this.env.services.messaging.models['mail.attachment'].findFromIdentifyingData({ id: 4 }).localId,
...
QUnit.test('post a simple message', async function (assert) {
    ...
    assert.strictEqual(
        ...
        this.env.services.messaging.models['mail.message'].findFromIdentifyingData({ id: postedMessageId }).localId,
...
QUnit.test('mark a single message as read should only move this message to "History" mailbox', async function (assert) {
    ...
    await afterNextRender(() =>
        document.querySelector(`
            .o_Message[data-message-local-id="${
                this.env.services.messaging.models['mail.message'].findFromIdentifyingData({ id: 1 }).localId
    ...
    assert.containsOnce(
        document.body,
        `.o_Message[data-message-local-id="${
            this.env.services.messaging.models['mail.message'].findFromIdentifyingData({ id: 2 }).localId
        }"]`,
