...
export function showRealtimeTzDiff(currentUserTimezone, otherUserTimezone, updateCallback) {
    ...
    const updateDisplayedTime = () => {
        ...
        const otherUserTime = formatDateTime(otherUserDateTime, {
            tz: otherUserTimezone,
            format: "hh:mm a",
        });
        const otherUserDate = currentUserDateTime.hasSame(otherUserDateTime, "day")
            ? null
            : formatDateTime(otherUserDateTime, {
                  tz: otherUserTimezone,
