...
/**
 * returns the real-time date and time of other user if it diffres from current user, updating time every minute.
 * @param {string} currentUserTimezone
 * @param {string} otherUserTimezone
 * @param {Function} updateCallback - receives { displayTime, otherDate }
