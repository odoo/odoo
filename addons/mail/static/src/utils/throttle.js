...
class Throttle {
     ...
     *   in-between).
     */
    constructor(messaging, func, duration) {
        /**
         * Reference to the messaging record. Useful to fine-tune control of
         * time flow in tests.
...
function throttle(
    ...
    const throttleObj = new Throttle(messaging, func, duration);
