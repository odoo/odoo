...
class Timer {
    ...
    /**
     * @param {Messaging} messaging the messaging record.
     ...
     *     or `.reset()`.
     */
    constructor(messaging, onTimeout, duration, { silentCancelationErrors = true } = {}) {
    ...
    async start() {
        ...
        const timeoutId = this.messaging.browser.setTimeout(
            () => {
                this.isRunning = false;
