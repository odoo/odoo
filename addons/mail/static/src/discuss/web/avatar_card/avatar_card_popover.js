...
export class AvatarCardPopover extends Component {
    ...
    setup() {
        ...
        onWillStart(async () => {
            this.user = await rpc("/discuss/avatar_card", {
                user_id: this.props.relation === "res.users" ? this.props.id : false,
                partner_id: this.props.relation === "res.partner" ? this.props.id : false,
    ...
    async getProfileAction() {
        return {
            res_id: this.props.relation === "res.partner" ? this.props.id : this.user.partner_id[0],
