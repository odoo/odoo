...
patch(HtmlComposer, {
    components: { ...HtmlComposer.components, Typing },
});
...
patch(HtmlComposer.prototype, {
    ...
    detectTyping() {
        const value = isMarkup(this.props.composer.body)
            ? createDocumentFragmentFromContent(this.props.composer.body).body.textContent
            : this.props.composer.body;
