...
import { BlurManager } from "@mail/discuss/call/blur_manager";
import { monitorAudio } from "@mail/discuss/call/media_monitoring";
import { RtcSession } from "@mail/discuss/call/rtc_session_model";
import { removeFromArray } from "@mail/utils/arrays";
import { closeStream, createLocalId, onChange } from "@mail/utils/misc";
...
export class Rtc {
    ...
    /**
     * @param {import("@mail/core/thread_model").Thread}
     */
    ...
    /**
     * @param {import("@mail/discuss/call/rtc_session_model").id} id
     */
    deleteSession(id) {
