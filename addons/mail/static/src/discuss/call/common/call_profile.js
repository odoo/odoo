...
/**
 * Turns a rendered call into the parameters the surface selection and the geometry engine run on.
 * Blind to the measured stage box on purpose: it decides which surfaces exist at all, hence which
 * videos get downloaded, before anything is measured.
 */
