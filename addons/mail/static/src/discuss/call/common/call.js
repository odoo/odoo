...
export class Call extends Component {
    ...
    get isFullscreen() {
        return this.fullscreen.id === CALL_FULLSCREEN;
    }

    get isFullSize() {
        return this.props.isPip || this.isFullscreen;
    }
    ...
    get minimized() {
        if (this.isFullscreen || this.channel.activeRtcSession) {
            return false;
        }
    ...
    get hasCallNotifications() {
        return Boolean(
            (!this.props.compact || this.isFullscreen) &&
                this.isActiveCall &&
    ...
    get isControllerFloating() {
        return this.isFullscreen || (this.channel.activeRtcSession && !this.ui.isSmall);
    }
