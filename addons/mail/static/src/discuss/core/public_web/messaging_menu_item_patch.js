...
const messagingMenuItemPatch = {
    setup() {
        ...
        Object.assign(
            this.props,
            useProps({
                channel: types.instanceOf(this.store["discuss.channel"]).optional().static(),
            })
        );
    ...
    hasActions() {
        return this.props.channel
            ? this.threadActions.actionsComputed().length
            : super.hasActions();
    },
    ...
    get meetingStartText() {
        return this.props.channel?.meeting_start_dt?.toLocaleString(DateTime.TIME_SIMPLE, {
            locale: user.lang,
        });
    },
