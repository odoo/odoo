...
const messagingMenuPatch = {
    setup() {
        ...
        this.assignComputed("chatTab", function computeChatTab() {
        ...
        this.assignComputed("channelTab", function computeChannelTab() {
            return this.store.MessagingMenuTab.insert({
        ...
        this.assignComputed("meetingTab", function computeMeetingTab() {
            return this.store.MessagingMenuTab.insert({
