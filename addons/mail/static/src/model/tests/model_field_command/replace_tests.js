...
QUnit.test('replace: should link a record for an empty x2one field', async function (assert) {
    ...
    const address = this.env.services.messaging.models['test.address'].create({ id: 10 });
...
QUnit.test('replace: should replace a record for a non-empty x2one field', async function (assert) {
    ...
    const address20 = this.env.services.messaging.models['test.address'].create({ id: 20 });;
...
QUnit.test('replace: should link a record for an empty x2many field', async function (assert) {
    ...
    const contact = this.env.services.messaging.models['test.contact'].create({ id : 10 });
    const task = this.env.services.messaging.models['test.task'].create({ id: 10 });
...
QUnit.test('replace: should replace all records for a non-empty field', async function (assert) {
    ...
    const task30 = this.env.services.messaging.models['test.task'].create({ id: 30 });
