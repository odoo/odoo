...
QUnit.test('create (txt)', async function (assert) {
    ...
    await this.start();
    assert.notOk(this.env.services.messaging.models['mail.attachment'].findFromIdentifyingData({ id: 750 }));
    ...
    assert.ok(this.env.services.messaging.models['mail.attachment'].findFromIdentifyingData({ id: 750 }));
    assert.strictEqual(this.env.services.messaging.models['mail.attachment'].findFromIdentifyingData({ id: 750 }), attachment);
...
QUnit.test('displayName', async function (assert) {
    ...
    assert.ok(attachment);
    assert.ok(this.env.services.messaging.models['mail.attachment'].findFromIdentifyingData({ id: 750 }));
    assert.strictEqual(attachment, this.env.services.messaging.models['mail.attachment'].findFromIdentifyingData({ id: 750 }));
...
QUnit.test('fileType', async function (assert) {
    ...
    assert.ok(attachment);
    assert.ok(this.env.services.messaging.models['mail.attachment'].findFromIdentifyingData({ id: 750 }));
    assert.strictEqual(attachment, this.env.services.messaging.models['mail.attachment'].findFromIdentifyingData({
        id: 750,
    }));
