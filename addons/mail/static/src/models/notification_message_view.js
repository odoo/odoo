...
registerModel({
    ...
    fields: {
        component: attr(),
        message: one('Message', { inverse: 'notificationMessageViews', related: 'messageListViewItemOwner.message', required: true }),
        messageListViewItemOwner: one('MessageListViewItem', { identifying: true, inverse: 'notificationMessageView' }),
    },
});
