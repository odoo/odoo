...
registerModel({
    ...
    recordMethods: {
         ...
         */
        _computeMobileNewMessageInputView() {
    ...
    fields: {
        ...
        mobileNewMessageInputView: one2one('AutocompleteInputView', {
            compute: '_computeMobileNewMessageInputView',
            inverse: 'messagingMenuAsMobileNewMessageInput',
            isCausal: true,
        }),
        /**
