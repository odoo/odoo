...
registerModel({
    name: 'mail.notification_list_view',
    ...
    recordMethods: {
        ...
        _computeFilteredThreads() {
            switch (this.filter) {
                case 'mailbox': {
                    return replace(this.messaging.models['mail.thread']
        ...
        _computeNotificationGroupViews() {
            ...
            return insertAndReplace(
                this.models['mail.notification_group']
                    .all()
        ...
        _computeThreadNeedactionPreviewViews() {
            ...
            return insertAndReplace(
                this.messaging.models['mail.thread']
    ...
    fields: {
        ...
        filteredThreads: many2many('mail.thread', {
            compute: '_computeFilteredThreads',
        }),
        messagingMenuOwner: one2one('mail.messaging_menu', {
            inverse: 'notificationListView',
            readonly: true,
        }),
        ...
        notificationRequestView: one2one('mail.notification_request_view', {
            compute: '_computeNotificationRequestView',
            inverse: 'notificationListViewOwner',
            isCausal: true,
        }),
        notificationViews: one2many('mail.model', {
            compute: '_computeNotificationViews',
            isCausal: true,
        }),
        threadNeedactionPreviewViews: one2many('mail.thread_needaction_preview_view', {
            compute: '_computeThreadNeedactionPreviewViews',
            inverse: 'notificationListViewOwner',
            isCausal: true,
        }),
        threadPreviewViews: one2many('mail.thread_preview_view', {
