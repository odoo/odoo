...
tour.register('mail_tour', [{
    trigger: '.o_mail_chat .o_mail_conversation_sidebar .o_add[data-type="public"]',
    ...
    trigger: '.o_mail_chat .o_mail_conversation_item[data-conversation-id="mailbox_starred"]',
    content: _t("Once a message has been starred, you can come back and review it at any time here."),
    position: "bottom",
}, {
    trigger: '.o_mail_chat .o_mail_conversation_sidebar .o_add[data-type="dm"]',
