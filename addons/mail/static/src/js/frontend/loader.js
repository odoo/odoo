...
exports.createWysiwyg = async (parent, options, additionnalAssets = []) => {
    ...
    const ComposerWysiwyg = odoo.__DEBUG__.services['mail.composer.wysiwyg'];
    return new ComposerWysiwyg(parent, options);
};
...
exports.loadFromTextarea = async (parent, textarea, options) => {
    ...
    wysiwyg.$editable.addClass('note-editable-composer');
    return wysiwyg;
};
exports.loadWysiwyg = WysiwygLoader.loadWysiwyg;
