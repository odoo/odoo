...
var ThreadMessage = MessageCommon.extend({
    ...
    */
    check_for_rerender: function () {
        ...
        return this.parent_thread.ds_message.call('message_read2', [undefined, domain, [], !!this.parent_thread.options.display_indented_thread, this.context, this.parent_thread.id])
