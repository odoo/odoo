 ...
 * @property {Array<T>} viewables
 * @extends {Component<Props, Env>}
 */
export class Viewer extends Component {
    static template = "mail.Viewer";
    static components = {};
    static props = ["viewables", "startIndex", "close", "modal?"];
    static defaultProps = {
        modal: true,
    };
    ...
    setup() {
        ...
        this.state = useState({
            ...
            viewable: this.props.viewables[this.props.startIndex],
            imageLoaded: false,
            scale: 1,
            angle: 0,
        });
    ...
    next() {
        const last = this.props.viewables.length - 1;
    ...
    activateAttachment(index) {
        ...
        this.state.viewable = this.props.viewables[index];
    }
        ...
        printWindow.document.write(`
                <html>
                    ...
                    <body onload='onloadImage()'>
                        <img src="${this.state.viewable.imageUrl}" alt=""/>
                    </body>
                </html>`);
