...
export class CallDebriefTimeline extends Component {
    ...
    get timelineSegments() {
        ...
        // Walk media segments in order, inserting a silence gap before each one
        // whenever there's unaccounted time since the previous segment ended.
        ...
        // Capture LAST GAP
        if (previousMediaSegEnd < totalDuration ) {
