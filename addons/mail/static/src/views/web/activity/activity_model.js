...
export class ActivityModel extends RelationalModel {
    ...
    async load(params = {}) {
        this.originalDomain = params.domain ? [...params.domain] : this.env.searchModel.domain;
        ...
        params.domain = [...(params.domain || this.env.searchModel.domain), ["activity_ids.active", "in", [true, false]]];
