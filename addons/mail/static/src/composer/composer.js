...
export class Composer extends Component {
    ...
    wysiwygOptions() {
        return {
            ...
            value: this.props.composer.wysiwygValue.body,
        };
    }
     ...
     * TODO: pasting images from clipboard is conflicting with odooEditor's paste event.
     */
    onPaste(ev) {
        if (!this.allowUpload) {
            return;
        ...
        switch (ev.key) {
            case "ArrowUp":
                ...
                if (
                    ...
                    this.props.composer.wysiwygValue.textContent === ""
                ) {
    ...
    async onClickFullComposer(ev) {
        ...
        const context = {
            ...
            default_body: this.props.composer.wysiwygValue.body,
    ...
    update() {
        ...
        const lastValue = (this.props.composer.wysiwygValue.body || "").toString();
        if (
            value !== null &&
            !(!lastValue && stripHistoryIds(value) === "<p><br></p>") &&
            stripHistoryIds(value) !== stripHistoryIds(lastValue)
        ) {
            Object.assign(this.props.composer.wysiwygValue, {
                body: value,
                textContent: this.wysiwyg.odooEditor.editable.textContent,
            });
    ...
    async processMessage(cb) {
        ...
        if (
            ...
            await cb(
                this.props.composer.wysiwygValue.textContent,
                this.props.composer.wysiwygValue.body
            );
