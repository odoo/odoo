        ...
        if not self.resource_ref or not self.resource_ref.id:
            ...
            try:
                ...
                if mail_template.email_layout_xmlid:
                    ...
                    render_values['email_notification_allow_header'] = mail_template.email_notification_allow_header
                    render_values['email_notification_allow_footer'] = mail_template.email_notification_allow_footer
