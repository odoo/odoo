            ...
            try:
                ...
                if mail_template.email_layout_xmlid:
                    ...
                    msg_vals = {
                        ...
                        'partner_ids': mail_values.get('partner_ids', self.env.user.partner_id.ids),
                    ...
                    ActiveModel = self.resource_ref if self.model_id.is_mail_thread else self.env['mail.thread']
                    ...
                    # While previewing, always show header and footer?
                    _lang, render_values, recipients_group = next(ActiveModel._notify_get_classified_recipients_iterator(
                        message, recipients_data, msg_vals=msg_vals, force_header=True, force_footer=True,
                    ))
