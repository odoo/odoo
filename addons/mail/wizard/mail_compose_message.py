...
class MailComposer(models.TransientModel):
    ...
    author_impersonated = fields.Boolean(
        'Author is impersonated',
        compute='_compute_author_impersonated')
    # composition
    ...
    def _compute_author_impersonated(self):
        ...
        self.author_impersonated = False
        self.filtered(lambda comp: comp.author_id != self.env.user.partner_id).author_impersonated = True
    ...
    def _action_send_mail_comment(self, res_ids):
        ...
        for res_id, post_values in post_values_all.items():
            if self.author_impersonated:
                post_values['notify_author'] = True
