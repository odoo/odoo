...
class MailComposer(models.TransientModel):
    ...
    def get_mail_values(self, res_ids):
        ...
        if mass_mail_mode and not self.no_auto_thread:
            ...
            reply_to_value = self.env['mail.thread']._notify_get_reply_to(records, default=self.email_from)
        ...
        for res_id in res_ids:
            ...
            if mass_mail_mode and self.model:
                mail_values.update(self.env['mail.thread']._notify_specific_email_values_on_record(False, record=self.env[self.model].browse(res_id)))
