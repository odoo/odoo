...
class Channel(models.Model):
    ...
    def channel_info(self, extra_info=False):
        ...
        partner_channels = self.env['mail.channel.partner'].search([('channel_id', 'in', self.ids), ('partner_id', '=', self.env.user.partner_id.id)])
        partner_channel_dict = dict((r.channel_id.id, r) for r in partner_channels)
        for channel in self:
            info = {
                'id': channel.id,
                'name': channel.name,
            ...
            if self.env.user and self.env.user.partner_id:
                ...
                partner_channel = partner_channel_dict.get(channel.id)
                if partner_channel:
            ...
            if channel.channel_type != 'channel':
                ...
                info['members'] = channel.channel_last_seen_partner_ids.mail_channel_partner_format()
