...
class MailMail(models.Model):
    ...
    def process_email_queue(self, ids=None):
        ...
        A maximum of 10K MailMail (configurable using 'mail.mail_mail_queue_batch_size'
        ...
        batch_size = int(self.env['ir.config_parameter'].sudo().get_param('mail.mail_mail_queue_batch_size', 10000))
