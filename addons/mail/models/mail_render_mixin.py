...
class MailRenderMixin(models.AbstractModel):
    ...
    def _render_qweb_eval_context(self):
        ...
        render_context = {
            ...
            'format_float': lambda value, precision_rounding=None, uom_name=None, lang_code=False: tools.format_float(self.env, value, precision_rounding, uom_name, lang_code),
