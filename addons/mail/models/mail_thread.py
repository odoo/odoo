...
<p>The following email sent to %s cannot be accepted because this is a private email address.
   Only allowed people can contact us at this address.</p>
    ...
    def _notify_thread(self, message, msg_vals=False, model_description=False, mail_auto_delete=True):
        ...
        Can be overridden to intercept and postpone notification mechanism like mail.channel moderation
        ...
        :param model_description: model descriiption used in email notification process
        ...
        self._notify_record_by_inbox(message, rdata, msg_vals=msg_vals)
        self._notify_record_by_email(message, rdata, msg_vals=msg_vals, model_description=model_description, mail_auto_delete=mail_auto_delete)

        return rdata

    def _notify_record_by_inbox(self, message, recipients_data, msg_vals=False):
    ...
    def _notify_record_by_email(self, message, recipients_data, msg_vals=False, model_description=False, mail_auto_delete=True, send_after_commit=True):
