...
class MailThread(models.AbstractModel):
    ...
    def _notify_by_email_prepare_rendering_context(self, message, msg_vals=False,
        ...
        return {
            ...
            # display
            'email_notification_force_header': self.env.context.get('email_notification_force_header') or force_footer,  # force displaying the email header
            'email_notification_force_footer': self.env.context.get('email_notification_force_footer') or force_header,  # force displaying the email footer
