...
class MailThread(models.AbstractModel):
    ...
    def _message_get_suggested_recipients(self, reply_discussion=False, reply_message=None,
        ...
        if reply_message:
            ...
            email_to_lst += [reply_message.incoming_email_to or '', reply_message.incoming_email_cc or '']
    ...
    def message_post(self, *,
        ...
        # posted 'in behalf of'). Limit to active and intrenal partners, as external
    ...
    def _notify_by_email_get_base_mail_values(self, message, recipients_data, additional_values=None):
        ...
        headers = {}
        # prepare external emails to modify Msg[To] and enable reply-aoo
        external = ','.join(
    ...
    def _notify_get_recipients(self, message, msg_vals, **kwargs):
        ...
        emailed_normalized = [
            email_normalize(addr) for addr in email_split(
