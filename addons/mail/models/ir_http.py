...
class IrHttp(models.AbstractModel):
    ...
    def session_info(self):
        ...
        assets_discuss_public_hash = HomeStaticTemplateHelpers.get_qweb_templates_checksum(debug=request.session.debug, bundle='mail.assets_discuss_public', env=self.env)
        ...
        if not request.session.uid and guest:
            ...
            translation_hash = self.env['ir.translation'].sudo().get_web_translations_hash(mods, lang)
