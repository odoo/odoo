...
class IrHttp(models.AbstractModel):
    ...
    def _initial_store_params(self):
        return ["failures", "systray_get_activities", "init_messaging"]

    def lazy_session_info(self):
        res = super().lazy_session_info()
        res["storeData"] = WebclientController._process_request(fetch_params=self._initial_store_params(), context=request.context)
        return res
