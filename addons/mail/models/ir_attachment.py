...
class IrAttachment(models.Model):
        ...
        def _is_attachment_owned(attachment, token):
            ...
            try:
                ...
                return token and verify_limited_field_access_token(
                    attachment, "attachment_ownership", token, scope="attachment_ownership"
                )
    ...
    def _get_store_as_author_access_token_fields(self):
        return [Store.Attr("as_author_access_token", lambda a: a._attachment_ownership_access_token())]
    ...
    def _attachment_ownership_access_token(self):
        ...
        return limited_field_access_token(
            self, field_name="attachment_ownership", scope="attachment_ownership"
        )
