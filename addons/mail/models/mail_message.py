...
class Message(models.Model):
    ...
    * snailmail.letter (snailmail addon)
    ...
    def _compute_preview(self):
        """ Returns an un-formatted version of the message body. Output is
        capped at 100 characters with a ' [...]' suffix if applicable. This
        100 is the longest known mail client preview length (Outlook 2013). """
        for message in self:
            plaintext_ct = tools.html_to_inner_content(message.body)
            message.preview = textwrap.shorten(plaintext_ct, 100)
