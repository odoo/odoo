...
class MailFollowers(models.Model):
    ...
    SELECT partner.id as pid,
           ...
           sub_user.uid as uid,
           CASE WHEN partner.partner_share THEN FALSE ELSE sub_user.ooo_activated END as ooo_activated,
           CASE WHEN ooo_activated THEN sub_user.ooo_msg ELSE '' END as ooo_msg,
