...
class DiscussChannel(models.Model):
    ...
    def _get_channels_as_member(self):
        domain = [("channel_member_ids", "any", [("is_self", "=", True), ("is_pinned", "=", True)])]
    ...
    def channel_pin(self, pinned=False):
        ...
        for channel in target_channels:
            if not pinned:
                store.add(channel, {'close_chat_window': True})
            else:
                store.add(channel)
        store.bus_send()
    ...
    def _get_target_channels(self, pinned):
        """ Determine which channels should be affected by the pin/unpin action.
            ...
            :param bool pinned: True if pinning, False if unpinning.
            :return: recordset of discuss.channel to update.
        """
    ...
    def _update_pin_state(self, members, pinned):
        """ Update the pinning fields for the given channel members.
            ...
            :param recordset members: discuss.channel.member records to update.
