...
class DiscussChannel(models.Model):
    ...
    def _action_unfollow(self, partner=None, guest=None):
        ...
        self._bus_send_store(
            self,
            [
                Store.Attr("channel_member_ids", Store.Many(member, [], mode="DELETE")),
                "member_count",
            ],
        )
    ...
    def _to_store_defaults(self):
        ...
        def forward_member_field(field_name):
            return Store.Attr(
                ...
                predicate_func=lambda channel: channel.self_member_id,
            )
        ...
        return [
            ...
            Store.Many(
                ...
                only_data=True,
                sorted="id",
                predicate_func=lambda channel: channel in channels_with_all_members,
            ),
            ...
            Store.Attr(
                ...
                lambda c: Store.One(c.self_member_id.rtc_inviting_session_id.sudo()),
                predicate_func=lambda c: c.self_member_id.rtc_inviting_session_id,
            ),
            Store.One(
                "self_member_id",
                extra_fields=[
            ...
            Store.Attr(
                ...
                predicate_func=lambda c: c.self_member_id,
            ),
            "uuid",
        ]
