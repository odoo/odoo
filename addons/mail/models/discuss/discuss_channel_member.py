...
class DiscussChannelMember(models.Model):
    ...
    fold_state = fields.Selection([('open', 'Open'), ('folded', 'Folded'), ('closed', 'Closed')], help="This field is deprecated and has no effect, it will be removed in future versions.")
