...
class DiscussChannelMember(models.Model):
    ...
    def _rtc_leave_call(self, session_id=None):
        ...
        if not self.channel_id.rtc_session_ids and self.channel_id.last_call_message_id:
            # giving information about the end of call through write_date
            body = Markup("<div data-oe-type=\"call\" class=\"o_mail_notification\"></div>")
            self.channel_id._message_update_content(self.channel_id.last_call_message_id, body, strict=False)
