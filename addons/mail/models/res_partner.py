...
class ResPartner(models.Model):
    ...
    last_poll = fields.Datetime("Last Poll", compute="_compute_im_status", compute_sudo=True)
    ...
    def _compute_im_status(self):
        for partner in self:
            ...
            partner.last_poll = max(partner.user_ids.presence_ids.mapped("last_poll"), default=None)
