...
class ResPartner(models.Model):
    ...
    _name = 'res.partner'
    _inherit = ['mail.thread.blacklist', 'res.partner', 'mail.activity.mixin', 'mail.call.log.mixin']
    ...
    def _get_call_log_partner_tiers(self):
        """ The partners a call was held with, closest first: whoever attended it, then
        the companies they work for, then their colleagues. Void tiers are left out, and
        nothing is returned when no call is being logged. """
