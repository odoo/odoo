...
class MailTemplate(models.Model):
    ...
    def _validate_template(self, fields={}):
        ...
        for field in dynamic_fields:
            try:
                self._render_field(field, record.ids)
            except Exception as e:
                raise ValidationError(_("Oops! We couldn't save your template due to an issue with this value: %(template_txt)s. Correct it and try again.", template_txt=self[field])) from e
