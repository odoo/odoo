...
class TestMailTemplate(MailCommon):
    ...
    def test_mail_template_acl(self):
        ...
        for expression in forbidden_qweb_expressions:
            ...
            self.assertTrue(self.env['mail.render.mixin']._has_complex_expression_template_qweb(expression))
        ...
        for expression in allowed_qweb_expressions:
            ...
            self.assertFalse(self.env['mail.render.mixin']._has_complex_expression_template_qweb(expression))
        ...
        for template, excepted in templates:
            ...
            with patch('odoo.addons.mail.models.mail_render_mixin.MailRenderMixin._render_template_qweb_static', side_effect=o_render) as render:
                rendered = mail_template._render_field('body_html', record.ids)[record.id]
