...
class TestDiscussChannelMember(MailCommon):
    ...
    def setUpClass(cls):
        ...
        cls.public_channel = cls.env['discuss.channel']._channel_create(group_id=None, name='Public channel of user 1')
    ...
    def test_unread_counter_with_message_post(self):
        channel_as_user_1 = self.env['discuss.channel'].with_user(self.user_1)._channel_create(group_id=None, name='Public channel')
    ...
    def test_unread_counter_with_message_post_multi_channel(self):
        channel_1_as_user_1 = self.env['discuss.channel'].with_user(self.user_1)._channel_create(group_id=None, name='wololo channel')
        channel_2_as_user_2 = self.env['discuss.channel'].with_user(self.user_2)._channel_create(group_id=None, name='walala channel')
