                    ...
                    [
                        {
                            ...
                            "payload": {
                                "mail.link.preview": [
                                    {
                                        "id": message_link_preview.link_preview_id.id,
                                        "image_mimetype": False,
                                        "og_description": message_link_preview.link_preview_id.og_description,
                                        "og_image": message_link_preview.link_preview_id.og_image,
                                        "og_mimetype": False,
                                        "og_site_name": False,
                                        "og_title": message_link_preview.link_preview_id.og_title,
                                        "og_type": False,
                                        "source_url": message_link_preview.link_preview_id.source_url,
                                    } for message_link_preview in message.message_link_preview_ids
                                ],
