...
class ChannelController(http.Controller):
    ...
    def discuss_channel_get_or_create_chat(self, partners_to, pin=True, force_open=False):
        channel = request.env["discuss.channel"]._channel_get_or_create_chat(partners_to, pin, force_open)
