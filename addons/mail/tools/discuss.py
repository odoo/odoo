...
class Store:
    ...
    class One:
        ...
        def __repr__(self):
            return f"One({self.record}, as_thread={self.as_thread}, only_id={self.only_id}, kwargs={self.kwargs})"
    ...
    class Many:
        ...
        def __repr__(self):
            return f"Many({self.records}, {self.mode}, as_thread={self.as_thread}, only_id={self.only_id}, kwargs={self.kwargs})"
