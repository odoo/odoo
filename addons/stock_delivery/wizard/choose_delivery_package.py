...
class ChooseDeliveryPackage(models.TransientModel):
    ...
    def _compute_shipping_weight(self):
        for rec in self:
            move_line_ids = rec.move_line_ids.filtered(lambda m:
    ...
    def action_put_in_pack(self):
        move_line_ids = self.move_line_ids._package_move_lines()
        delivery_package = move_line_ids._put_in_pack()
        ...
        return move_line_ids._post_put_in_pack_hook(delivery_package)
