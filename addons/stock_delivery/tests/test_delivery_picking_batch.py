...
class TestDeliveryPickingBatch(TestStockBatchCommon):
    ...
    def test_auto_batch_group_by_carrier_and_product(self):
        ...
        - Initial pickings with different carriers must create separate batches.
        - Each subsequent picking must join the existing batch with the same carrier.
        """
        ...
        # Separate batch should automatically created for each picking with a different carrier.
        (carrier_1_pick_1 | carrier_2_pick_1).action_assign()
        self.assertNotEqual(carrier_1_pick_1.batch_id, carrier_2_pick_1.batch_id)

        # Follow-up pickings should merged into existing batches with matching carriers.
        (carrier_1_pick_2 | carrier_2_pick_2).action_assign()
        self.assertIn(carrier_1_pick_2, carrier_1_pick_1.batch_id.picking_ids)
        self.assertIn(carrier_2_pick_2, carrier_2_pick_1.batch_id.picking_ids)
