...
class StockPicking(models.Model):
    ...
    display_collect_delivery_payment_action = fields.Boolean(
        compute='_compute_display_collect_delivery_payment_action'
    )
    ...
    def _compute_display_collect_delivery_payment_action(self):
        for picking in self:
            picking.display_collect_delivery_payment_action = (
    ...
    def action_collect_delivery_payment(self):
        ...
        res = self.sale_id.action_collect_delivery_payment()
        self.message_post(
