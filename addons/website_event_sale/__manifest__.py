...
Sell event tickets through eCommerce app.
    ...
    'assets': {
        ...
        'web.assets_frontend': [
            ...
            'website_event_sale/static/src/js/website_event_ticket_registration_dialog.xml',
            'website_event_sale/static/src/js/website_event_sale_adjust_ticket_quantity.js',
        ],
    },
    'license': 'LGPL-3',
}
