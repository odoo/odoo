...
class PricelistItem(models.Model):
    ...
    def _onchange_event_sale_warning(self):
        if self.min_quantity > 0:
            ...
            elif ((self.applied_on == '1_product' and self.product_tmpl_id.detailed_type == 'service' and self.product_id.is_event_ticket) or
                    (self.applied_on == '0_product_variant' and self.product_id.detailed_type == 'service' and self.product_id.is_event_ticket)):
