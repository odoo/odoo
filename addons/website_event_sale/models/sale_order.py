...
class SaleOrder(models.Model):
    ...
    def _cart_update(self, product_id=None, line_id=None, add_qty=0, set_qty=0, **kwargs):
        ...
        if line_id:
            ...
            self.env.context = dict(self.env.context, event_ticket_id=ticket.id)
        else:
            line = None
        ...
        values = {}
        if ticket.seats_availability == 'limited' and ticket.seats_available <= 0:
        ...
        elif ticket.seats_availability == 'limited' and new_qty > ticket.seats_available:
