...
class SaleOrder(models.Model):
    ...
    def _cart_update(self, product_id=None, line_id=None, add_qty=0, set_qty=0, **kwargs):
        ...
        # adding attendees
            ...
            # This context key is used to avoid to create the registrations while building the information of the batch.
            if not self.env.context.get('registration_in_creation'):
