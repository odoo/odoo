...
import { ChartOdooDatasourcePlugin, OdooChartCorePlugin, OdooChartCoreViewPlugin } from "@spreadsheet/chart";
...
declare module "@spreadsheet" {
    ...
    interface OdooCoreGetters extends PluginGetters<typeof ChartOdooDatasourcePlugin> {}
