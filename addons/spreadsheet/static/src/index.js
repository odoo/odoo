...
// handled by the list and Odoo chart core view plugins, which are evaluation
// plugins: it has to be an evaluation command to reach them.
spreadsheet.registerCommand("REFRESH_ALL_DATA_SOURCES", {
    category: "local",
