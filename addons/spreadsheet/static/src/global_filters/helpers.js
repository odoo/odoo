...
globalFilterDateRegistry
    .add("today", {
        ...
        getNextDateFilterValue: () => getNextRelativeDateFilterValue("today"),
        getPreviousDateFilterValue: () => getPreviousRelativeDateFilterValue("today"),
    ...
    .add("yesterday", {
        ...
        getNextDateFilterValue: () => getNextRelativeDateFilterValue("yesterday"),
        getPreviousDateFilterValue: () => getPreviousRelativeDateFilterValue("yesterday"),
        isValueValid: (value) => true,
    ...
    .add("last_7_days", {
        ...
        getNextDateFilterValue: () => getNextRelativeDateFilterValue("last_7_days"),
        getPreviousDateFilterValue: () => getPreviousRelativeDateFilterValue("last_7_days"),
        isValueValid: (value) => true,
    ...
    .add("last_30_days", {
        ...
        getNextDateFilterValue: () => getNextRelativeDateFilterValue("last_30_days"),
        getPreviousDateFilterValue: () => getPreviousRelativeDateFilterValue("last_30_days"),
        isValueValid: (value) => true,
    ...
    .add("last_90_days", {
        ...
        getNextDateFilterValue: () => getNextRelativeDateFilterValue("last_90_days"),
        getPreviousDateFilterValue: () => getPreviousRelativeDateFilterValue("last_90_days"),
        isValueValid: (value) => true,
    ...
    .add("month_to_date", {
        ...
        getNextDateFilterValue: () => getNextRelativeDateFilterValue("month_to_date"),
        getPreviousDateFilterValue: () => getPreviousRelativeDateFilterValue("month_to_date"),
        isValueValid: (value) => true,
    ...
    .add("last_month", {
        ...
        getNextDateFilterValue: () => getNextRelativeDateFilterValue("last_month"),
        getPreviousDateFilterValue: () => getPreviousRelativeDateFilterValue("last_month"),
        isValueValid: (value) => true,
    ...
    .add("year_to_date", {
        ...
        getNextDateFilterValue: () => getNextRelativeDateFilterValue("year_to_date"),
        getPreviousDateFilterValue: () => getPreviousRelativeDateFilterValue("year_to_date"),
        isValueValid: (value) => true,
    ...
    .add("last_12_months", {
        ...
        getNextDateFilterValue: () => getNextRelativeDateFilterValue("last_12_months"),
        getPreviousDateFilterValue: () => getPreviousRelativeDateFilterValue("last_12_months"),
        isValueValid: (value) => true,
...
export function getNextFixedDateFilterValue(value) {
    switch (value?.type) {
        case "quarter":
            return {
                type: "quarter",
...
export function getPreviousFixedDateFilterValue(value) {
    switch (value?.type) {
        case "quarter":
            return {
                type: "quarter",
 ...
 */
function getNextRelativeDateFilterValue(period) {
    switch (period) {
        case "today":
        case "yesterday":
        case "last_7_days":
 ...
 * @returns {RelativeDateValue}
 */
function getPreviousRelativeDateFilterValue(period) {
    switch (period) {
        case "today":
        case "yesterday":
        case "last_7_days":
