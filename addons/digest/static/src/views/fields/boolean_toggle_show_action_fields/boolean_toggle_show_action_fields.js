 ...
 */
export class BooleanToggleShowActionField extends BooleanToggleField {
    static template = "digest.BooleanToggleShowActionField";
    static props = {
    ...
    async onChange(newValue) {
        ...
        await this.orm.call(
            ...
            this.props.action,
            [this.props.record.resId, newValue],
            {}
        );
    }
}

export const booleanToggleShowActionField = {
    ...booleanToggleField,
    component: BooleanToggleShowActionField,
...
registry.category("fields").add("boolean_toggle_show_action", booleanToggleShowActionField);
