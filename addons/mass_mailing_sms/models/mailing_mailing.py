...
class Mailing(models.Model):
    ...
    def _get_default_mailing_domain(self):
        ...
        if self.mailing_type == 'sms' and 'phone_blacklisted' in self.env[self.mailing_model_name]._fields:
            mailing_domain = expression.AND([[('phone_blacklisted', '=', False)], mailing_domain])
        if self.mailing_type == 'sms' and 'phone_state' in self.env[self.mailing_model_name]._fields:
            mailing_domain = expression.AND([[('phone_state', '=', 'ok')], mailing_domain])
