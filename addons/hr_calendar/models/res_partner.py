...
class Partner(models.Model):
    ...
    def _get_schedule(self, start_period, stop_period, everybody=False, merge=True):
        ...
        resources = sum(employees_by_partner.values(), start=self.env['hr.employee'])
        calendar_periods_by_employee = resources._get_calendar_periods(start_period, stop_period)
        ...
        for partner, resources in employees_by_partner.items():
