...
class AccountMove(models.Model):
    ...
    def _has_timesheet_portal(self):
        ...
        domain = expression.AND([initial_domain, self.env['account.analytic.line']._timesheet_get_sale_domain(self.invoice_line_ids.sale_line_ids, self)])
    ...
    def _post(self, soft=True):
        self._link_timesheets_to_invoice(service_policies=['ordered_prepaid', 'delivered_milestones', 'delivered_manual'])
