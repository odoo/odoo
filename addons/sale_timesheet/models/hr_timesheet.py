...
class AccountAnalyticLine(models.Model):
    ...
    timesheet_invoice_id = fields.Many2one('account.move', domain="[('invoice_line_ids.sale_line_ids', '=', so_line), ('state', '=', 'posted')]", string="Ref. Invoice", readonly=True, copy=False, help="Invoice reference linked to the timesheet, for reporting only", index='btree_not_null')
