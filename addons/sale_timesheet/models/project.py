...
class Project(models.Model):
    ...
    sale_line_employee_ids = fields.One2many('project.sale.line.employee.map', 'project_id', "Sale line/Employee map", copy=False, export_string_translation=False,
    ...
    billable_percentage = fields.Integer(
        ...
        help="% of timesheets that are billable compared to the total number of timesheets linked to the AA of the project, rounded to the unit.", export_string_translation=False)
