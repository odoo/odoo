                        ...
                        LEFT JOIN (
                            ...
                            FROM (
                                ...
                                SELECT
                                    ...
                                    CASE
                                        WHEN SOL.qty_delivered_method IN ('timesheet', 'manual', 'milestones') THEN (SOL.untaxed_amount_to_invoice / CASE COALESCE(S.currency_rate, 0) WHEN 0 THEN 1.0 ELSE S.currency_rate END)
                                        ELSE 0.0
                                    END AS amount_untaxed_to_invoice,
                                    CASE
                                        WHEN SOL.qty_delivered_method IN ('timesheet', 'manual', 'milestones') THEN (SOL.untaxed_amount_invoiced / CASE COALESCE(S.currency_rate, 0) WHEN 0 THEN 1.0 ELSE S.currency_rate END)
                                        ELSE 0.0
