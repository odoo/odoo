...
class TestProjectBilling(TestCommonSaleTimesheet):
    ...
    def test_billing_employee_rate(self):
        ...
        # set a SOL on the project to check the fallback order when creating a task in this project
        self.project_employee_rate.sale_line_id = self.so1_line_order_no_task.id
