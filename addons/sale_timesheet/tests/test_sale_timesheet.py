...
class TestSaleTimesheet(TestCommonSaleTimesheet):
    ...
    def test_timesheet_order(self):
        ...
        self.assertFalse(timesheet1.reinvoice_id, "The timesheet1 should not be linked to the invoice, since we are in ordered quantity")
        ...
        self.assertFalse(timesheet2.reinvoice_id, "The timesheet should not be linked to the invoice, since we are in ordered quantity")
        ...
        self.assertFalse(timesheet3.reinvoice_id, "The timesheet should not be linked to the invoice, since we are in ordered quantity")
        ...
        self.assertFalse(timesheet4.reinvoice_id, "The timesheet should not be linked to the invoice, since we are in ordered quantity")
        ...
        self.assertFalse(timesheet1.reinvoice_id, "The timesheet1 should not be linked to the invoice, since we are in ordered quantity")
        self.assertFalse(timesheet2.reinvoice_id, "The timesheet2 should not be linked to the invoice, since we are in ordered quantity")
        self.assertFalse(timesheet3.reinvoice_id, "The timesheet3 should not be linked to the invoice, since we are in ordered quantity")
        self.assertFalse(timesheet4.reinvoice_id, "The timesheet4 should not be linked to the invoice, since we are in ordered quantity")
    ...
    def test_timesheet_delivery(self):
        ...
        self.assertFalse(timesheet1.reinvoice_id, "The timesheet1 should not be linked to the invoice yet")
        ...
        self.assertEqual(timesheet1.reinvoice_id, invoice1, "The timesheet1 should not be linked to the invoice 1, as we are in delivered quantity (even if invoice is in draft")
        ...
        self.assertFalse(timesheet2.reinvoice_id, "The timesheet2 should not be linked to the invoice yet")
        ...
        self.assertEqual(timesheet2.reinvoice_id, invoice2, "The timesheet2 should not be linked to the invoice 2")
        with self.assertRaises(UserError):  # We can not modify timesheet linked to invoice (even draft ones)
        ...
        self.assertFalse(timesheet3.reinvoice_id, "The timesheet3 should not be linked to the invoice yet")
        ...
        self.assertFalse(timesheet4.reinvoice_id, "The timesheet4 should not be linked to the invoice yet")

        # modify a non invoiced timesheet
        timesheet4.write({'unit_amount': 42})

        self.assertFalse(timesheet4.reinvoice_id, "The timesheet4 should not still be linked to the invoice")

        # validate the second invoice
        invoice2.action_post()

        self.assertEqual(timesheet1.reinvoice_id, invoice1, "The timesheet1 should not be linked to the invoice 1, even after validation")
        self.assertEqual(timesheet2.reinvoice_id, invoice2, "The timesheet2 should not be linked to the invoice 1, even after validation")
        self.assertFalse(timesheet3.reinvoice_id, "The timesheet3 should not be linked to the invoice, since we are in ordered quantity")
        self.assertFalse(timesheet4.reinvoice_id, "The timesheet4 should not be linked to the invoice, since we are in ordered quantity")
    ...
    def test_timesheet_manual(self):
        ...
        self.assertFalse(timesheet1.reinvoice_id, "The timesheet1 should not be linked to the invoice")
        self.assertFalse(timesheet2.reinvoice_id, "The timesheet2 should not be linked to the invoice")
        ...
        self.assertFalse(timesheet1.reinvoice_id, "The timesheet1 should not be linked to the invoice, since timesheets are used for time tracking in milestone")
        self.assertFalse(timesheet2.reinvoice_id, "The timesheet2 should not be linked to the invoice, since timesheets are used for time tracking in milestone")

        # validate the invoice
        invoice1.action_post()

        self.assertFalse(timesheet1.reinvoice_id, "The timesheet1 should not be linked to the invoice, even after invoice validation")
        self.assertFalse(timesheet2.reinvoice_id, "The timesheet2 should not be linked to the invoice, even after invoice validation")
    ...
    def test_unlink_timesheet(self):
        ...
        self.assertEqual(analytic_line.reinvoice_id, move, "The timesheet should be linked to move")

        move.with_context(check_move_validity=False).line_ids[0].unlink()
        self.assertFalse(analytic_line.reinvoice_id, "The timesheet should have been unlinked from move")
    ...
    def test_linked_timesheet_after_invoice_reversal(self):
        ...
        invoice.action_post()
        self.assertEqual(timesheet.reinvoice_id, invoice, "Timesheet should be linked to the invoice")
        ...
        self.assertFalse(timesheet.reinvoice_id, "Timesheet should not be linked to the invoice after reversal")
        ...
        invoice2.action_post()
        self.assertEqual(timesheet1.reinvoice_id, invoice2, "Timesheet1 should be linked to the invoice")
        self.assertEqual(timesheet2.reinvoice_id, invoice2, "Timesheet2 should be linked to the invoice")
        ...
        self.assertFalse(timesheet1.reinvoice_id, "Timesheet1 should be cleared after partial refund of its task")
        self.assertEqual(timesheet2.reinvoice_id, invoice2, "Timesheet2 should still be linked to the original invoice")
