...
class TestPurchaseRequisition(TestPurchaseRequisitionCommon):
    ...
    def test_02_purchase_requisition(self):
        ...
        line1 = (0, 0, {'product_id': self.product_09.id, 'product_qty': quantity, 'uom_id': self.uom_id.id, 'price_unit': price_product09})
        line2 = (0, 0, {'product_id': self.product_13.id, 'product_qty': quantity, 'uom_id': self.uom_id.id, 'price_unit': price_product13})
