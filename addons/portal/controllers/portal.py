...
class CustomerPortal(Controller):
    ...
    def _validate_login_field(self, login, invalid_fields, missing_fields, error_messages):
        if not login:
    ...
    def _create_or_update_address(
        ...
        **form_data
        ...
        if login != False:
            self._validate_login_field(login, invalid_fields, missing_fields, error_messages)
