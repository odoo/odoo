...
class PortalWizardUser(models.TransientModel):
    ...
    def _send_email(self):
        ...
        template.with_context(dbname=self._cr.dbname, lang=lang, welcome_message=self.wizard_id.welcome_message, medium='portalinvite').send_mail(self.user_id.id, force_send=True)
