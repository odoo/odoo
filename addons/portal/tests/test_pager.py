...
class TestPager(TransactionCase):
    ...
    def _assert_pager_case(self, case, result, step):
        """Assert results for a test case, dynamically calculating expected values."""

        # Calculate expected page count and extract pages
        expected_page_count = (case['total'] + step - 1) // step
    ...
    def test_pager_functionality(self):
        ...
        for case in test_cases:
            ...
            with self.subTest(case=case):
                self._assert_pager_case(case, result, 30)
