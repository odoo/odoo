...
class TestPortalAddresses(BaseCommon, HttpCase):
    ...
    def test_vat_update(self):
        ...
        self.assertEqual(res, {'successUrl': '/my/addresses?success=true', 'successMessage': 'Details saved successfully.'})
    ...
    def test_success_url(self):
        ...
        self.assertEqual(res, {'successUrl': '/my/beautiful/url', 'successMessage': 'Details saved successfully.'})
        self.assertRecordValues(
            self.portal_user.partner_id,
            [self.default_address_values],
        )
