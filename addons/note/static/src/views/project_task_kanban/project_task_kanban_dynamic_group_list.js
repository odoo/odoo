...
export class ProjectTaskKanbanDynamicGroupList extends KanbanDynamicGroupList {
    ...
    get additional_kanban_domain() {
        return ['&', ['is_todo', '=', true], '|', ['user_id', '=', session.uid], ['message_partner_ids', '=', this.model.user.partnerId]];
    }
    ...
    async _loadGroups() {
        ...
        this.domain = Domain.and([this.additional_kanban_domain, previousDomain]).toList({});
