...
class AccountEdiXmlUBL21RS(models.AbstractModel):
    ...
    def _export_invoice_vals(self, invoice):
        ...
        vals.update({
            'InvoiceType_template': 'l10n_rs_edi.ubl_rs_Invoice_Type',
            'CreditNoteType_template': 'l10n_rs_edi.ubl_rs_CreditNoteType',
        })
        vals['vals'].update({
    ...
    def _get_partner_party_identification_vals_list(self, partner):
        ...
        if partner.country_code == 'RS' and partner.l10n_rs_edi_public_funds_id:
            vals_list.append({
                'id': ('JBKJS: %s', partner.l10n_rs_edi_public_funds_id),
            })
        return vals_list
