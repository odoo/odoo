...
class AccountMoveSend(models.TransientModel):
    ...
    @api.depends('l10n_rs_edi_send_enable','l10n_rs_edi_send_readonly')
    def _compute_l10n_rs_edi_send_checkbox(self):
        for wizard in self:
            wizard.l10n_rs_edi_send_checkbox = wizard.l10n_rs_edi_send_enable and not wizard.l10n_rs_edi_send_readonly
