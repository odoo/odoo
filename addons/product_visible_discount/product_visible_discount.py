    ...
    def product_id_change(self, cr, uid, ids, pricelist, product, qty=0,
        ...
        if product and pricelist:
            ...
            list_price = pricelist_obj.price_get(cr, uid, [pricelist],
                    product.id, qty or 1.0, partner_id, pricelist_context)

            so_pricelist = pricelist_obj.browse(cr, uid, pricelist, context=context_partner)

            new_list_price = self.get_real_price(cr, uid, product.id, list_price, qty, uom, pricelist, context=context_partner)
