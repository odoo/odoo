...
class AccountClosing(models.Model):
    ...
    def _compute_amounts(self, frequency, company):
        ...
        if previous_closing and previous_closing.last_move_id:
        ...
        if not first_move and aml_aggregate['line_ids']:  # It's the first time we run for this frequency
            ...
            total_beginning += previous_closing.total_beginning
        ...
        return {'total_interval': total_interval,
                ...
                'name_interval': interval_dates['name_interval']}
    ...
    def _automated_closing(self, frequency='daily'):
        ...
        for company in res_company.filtered(lambda c: c._is_accounting_unalterable()):
            ...
            values['name'] = values['name_interval'] + ' - ' + values['date_closing_stop'][:10]
