...
class PosOrderReceipt(models.AbstractModel):
    ...
    def order_receipt_generate_data(self, basic_receipt=False):
        ...
        data['conditions']['l10n_sa_not_legal'] = not (
            self.config_id.invoice_journal_id._l10n_sa_ready_to_submit_einvoices()
            and self.l10n_sa_invoice_qr_code_str
            and self.l10n_sa_invoice_edi_state in ("accepted", "warning")
        )
