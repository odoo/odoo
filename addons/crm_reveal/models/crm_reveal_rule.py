...
DEFAULT_ENDPOINT = 'https://odoo-iap-apps.odoo.com'
...
class CRMRevealRule(models.Model):
    ...
    def _add_to_country(self, country_rules, country, rule_index):
        """
        Add the rule_index to the country code in the country_rules
        """
    ...
    def _get_reveal_views_to_process(self):
        ...
        query = """
            SELECT v.reveal_ip, array_agg(v.reveal_rule_id ORDER BY r.sequence DESC)
