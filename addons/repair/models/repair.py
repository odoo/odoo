...
class RepairOrder(models.Model):
    ...
    can_create_extra_invoice = fields.Boolean(compute='_compute_can_create_sale_or_invoice')  # will be renamed on master
    ...
    can_create_sale_or_invoice = fields.Boolean(compute='_compute_can_create_sale_or_invoice')  # will be renamed on master
    ...
    def action_create_invoice(self):
        self.ensure_one()
        is_refund_type = self.is_refund_type()
        move_type = 'out_refund' if is_refund_type else 'out_invoice'
        invoice_line_commands = (
            self.move_ids._get_repair_invoice_line_commands(is_refund_type) +
            self.repair_service_line_ids._get_repair_invoice_line_commands(is_refund_type)
        )
