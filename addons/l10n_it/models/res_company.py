...
class ResCompany(models.Model):
    ...
    l10n_it_tax_system = fields.Selection(selection=TAX_SYSTEM, string="Tax System", help="Please select the Tax system to which you are subjected.")

    # PEC server
    l10n_it_mail_pec_server_id = fields.Many2one('ir.mail_server', string="Server PEC", help="Configure your PEC-mail server to send electronic invoices.")
    ...
    l10n_it_address_send_fatturapa = fields.Char(string="Company PEC-mail", help="Enter your company PEC-mail address. Ex: yourcompany@pec.mail.it")
    ...
    l10n_it_eco_index_share_capital = fields.Float(default="0.0", size=15, string="Share capital actually paid up",
                                                 ...
                                                 financial statement")
    l10n_it_eco_index_sole_shareholder = fields.Selection([("NO", "Not a limited liability company"),
                                                         ("SU", "Socio unico"),
                                                         ("SM", "Più soci")],
                                                        string="Shareholder")
    l10n_it_eco_index_liquidation_state = fields.Selection([("LS", "The company is in a state of liquidation"),
