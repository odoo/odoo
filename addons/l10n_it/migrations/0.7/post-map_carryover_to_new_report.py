...
def migrate(cr, version):
    ...
    cr.execute(f"""
        SELECT report.id AS report_id,
               ...
               report_line.code,
               external_value.target_report_expression_id,
    ...
    code2expression_id = {
        report_line_code: target_report_expression_id
        for report_id, _, report_line_code, target_report_expression_id, *_ in report_info
