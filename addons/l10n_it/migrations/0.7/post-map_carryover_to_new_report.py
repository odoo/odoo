...
def migrate(cr, version):
    ...
    external_value_cols = [
        ...
        if col not in ['id', 'carryover_origin_report_line_id']
    ]
    ...
    expression_id2code = {
        expression_id: report_line_code
    ...
    data_to_insert = [
        (expression_id2code[expression_id], old2new_origin[carryover_origin_report_line_id], *other_external_vals)
        for report_id, expression_id, report_line_code, carryover_origin_report_line_id, *other_external_vals in report_info
