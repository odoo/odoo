...
class L10n_It_Edi_DoiDeclaration_Of_Intent(models.Model):
        ...
        for declaration in self:
            ...
            if (
                ...
                if declaration.state != "active":
                    errors.append(
                        self.env._("The Declaration of Intent must be active.")
                    )
    ...
    def action_view_sale_order_ids(self):
        ...
        return {
            "name": self.env._(
                "Sales Orders using Declaration of Intent %s", self.display_name
            ),
    ...
    def action_view_invoice_ids(self):
        ...
        return {
            "name": self.env._(
                "Invoices using Declaration of Intent %s", self.display_name
            ),
            "type": "ir.actions.act_window",
