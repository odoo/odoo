...
class AccountMove(models.Model):
    ...
    def create(self, vals_list):
        ...
        # we verify that selected journal is the right one
        recs._onchange_partner_journal()
        return recs

    def write(self, values):
        res = super().write(values)
        # we verify that selected journal is the right one
        self._onchange_partner_journal()
        return res
