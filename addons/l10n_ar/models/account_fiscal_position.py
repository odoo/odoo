...
class AccountFiscalPosition(models.Model):
    ...
    l10n_ar_afip_responsability_type_ids = fields.Many2many(
        'l10n_ar.afip.responsability.type', 'l10n_ar_afip_reponsability_type_fiscal_pos_rel',
        string='AFIP Responsability Types', help='List of AFIP responsabilities where this fiscal position '
        'should be auto-detected')

    def get_fiscal_position(self, partner_id, delivery_id=None):
        """ Take into account the partner afip responsability in order to auto-detect the fiscal position """
