...
class ResPartner(models.Model):
    ...
    l10n_ar_gross_income_number = fields.Char('Gross Income Number', features='AR',)
    ...
    l10n_ar_afip_responsibility_type_id = fields.Many2one(
        'l10n_ar.afip.responsibility.type', string='AFIP Responsibility Type', features='AR', index=True, help='Defined by AFIP to'
