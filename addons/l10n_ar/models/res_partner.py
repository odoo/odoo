...
class ResPartner(models.Model):
    ...
    def write(self, vals):
        for partner in self:
            if 'l10n_ar_afip_responsibility_type_id' in vals and vals['l10n_ar_afip_responsibility_type_id'] != partner.l10n_ar_afip_responsibility_type_id.id:
                companies = self.env['res.company'].sudo().search([('partner_id', '=', partner.id)])
