...
class TestManual(common.TestAr):
    ...
    def test_15_corner_cases(self):
        ...
        for line in invoice_line_ids:
            ...
            (unitary_part, l10n_ar_price_unit_decimal_part) = float_split_str(l10n_ar_line_prices['price_unit'], decimal_price_digits_setting)
            len_l10n_ar_price_unit_digits = len(l10n_ar_price_unit_decimal_part)
            (unitary_part, line_price_unit_decimal_part) = float_split_str(line.price_unit, decimal_price_digits_setting)
