...
* AFIP Responsibility Type (partners fiscal responsibility).
...
* In Fiscal Positions and Fiscal Positions Templates models
...
* In Account Move model
  ...
  * Currency Rate
  * AFIP Concept
  * AFIP Service Start Date
  * AFIP Service End Date

* In Account Tax Group model

  * AFIP Tribute type/code
  * AFIP VAT tyṕe/code
...
* In Company model:
  ...
  * AFIP Responsibility Type
  * AFIP Activities Start Date
  * Gross Income Number
  * Gross Income Type
  * Company Requires VAT?
  * Country Code

* In Identification Type, Currency and Unit of Measure models
...
* Accounting / Reporting / Argentinian Statements
* Accounting / Reporting / Argentinian Statements / IIBB - Sales by jurisdiction
* Accounting / Reporting / Argentinian Statements / IIBB - Purchases by jurisdiction
* Accounting / Configuration / AFIP
* Accounting / Configuration / AFIP / Document Types
* Accounting / Configuration / AFIP / Responsibility Types
""",
    'author': 'ADHOC SA',
