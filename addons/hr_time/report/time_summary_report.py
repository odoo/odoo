...
class ReportHr_TimeReport_Holidayssummary(models.AbstractModel):
    _name = 'report.hr_time.report_holidayssummary'
    ...
    def _get_leaves(self, date_from, employees, holiday_type, date_to=None):
        ...
        return self.env['hr.time'].search([
    ...
    def _get_report_values(self, docids, data=None):
        ...
        holidays_report = self.env['ir.actions.report']._get_report_from_name('hr_time.report_holidayssummary')
        holidays = self.env['hr.time'].browse(self.ids)
