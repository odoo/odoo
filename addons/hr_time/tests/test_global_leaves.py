...
class TestGlobalLeaves(TestHrHolidaysCommon):
    ...
    def test_global_leave_keeps_employee_resource_leave(self):
        ...
        partially_covered_leave = self.env['hr.time'].create({
            'name': 'Holiday 1 week',
            'employee_id': employee.id,
            'work_entry_type_id': work_entry_type.id,
    ...
    def test_employee_leave_with_global_leave(self):
        ...
        """
        user_david = mail_new_test_user(self.env, login='david', groups='base.group_user,hr_time.group_hr_time_employee')
        user_timeoff_officer_david = mail_new_test_user(self.env, login='timeoff_officer', groups='base.group_user,hr_time.group_hr_time_employee')
        ...
        employee_leave = self.env['hr.time'].create({
            'name': 'Holiday 5 days',
