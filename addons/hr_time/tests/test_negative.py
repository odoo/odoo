...
class TestNegative(TestHrHolidaysCommon):
    ...
    def setUpClass(cls):
        ...
        cls.allocation_2022 = cls.env['hr.time.allocation'].create({
        ...
        cls.allocation_2023 = cls.env['hr.time.allocation'].create({
            'employee_id': cls.employee_emp_id,
            'work_entry_type_id': cls.work_entry_type.id,
    ...
    def test_negative_time_off(self):
        ...
        with freeze_time('2023-10-02'):
            ...
            one_day_leave = self.env['hr.time'].with_user(self.user_employee_id).create({
