...
class TestAccrualAllocations(TestHrHolidaysCommon):
    ...
    def setUpClass(cls):
        ...
        cls.accrual_plan_monthly_end = cls.env['hr.time.accrual.plan'].create({
        ...
        cls.accrual_plan_monthly_end_max_leaves = cls.env['hr.time.accrual.plan'].create({
            'name': 'Accrual Plan For Test',
            'is_based_on_worked_time': False,
            'accrued_gain_time': 'end',
            'carryover_date': 'allocation',
        ...
        cls.accrual_plan_yearly_max_postponed_days_start = cls.env['hr.time.accrual.plan'].with_context(tracking_disable=True).create({
        ...
        cls.accrual_plan_monthly_start_carryover_lost = cls.env['hr.time.accrual.plan'].with_context(tracking_disable=True).create({
