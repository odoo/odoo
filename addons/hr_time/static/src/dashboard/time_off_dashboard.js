...
import { useNewAllocationRequest } from "@hr_time/views/hooks";
...
export class TimeOffDashboard extends Component {
    ...
    static template = "hr_time.TimeOffDashboard";
    ...
    async openPendingRequests() {
        ...
        const action = await this.orm.call("hr.time", "open_pending_requests", [], {
