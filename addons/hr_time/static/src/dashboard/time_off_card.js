...
import { formatNumber, useNewAllocationRequest } from "@hr_time/views/hooks";
import { useService } from "@web/core/utils/hooks";
import { Component } from "@odoo/owl";

export class TimeOffCardPopover extends Component {
    static template = "hr_time.TimeOffCardPopover";
    static props = [
        "allocated",
        "accrual_bonus",
        "approved",
    ...
    async allocatedLeaves() {
        ...
        const isInHolidaysUserGroup = await user.hasGroup("hr_time.group_hr_time_user");

        const resModel = "hr.time.allocation"
        const name = "My Allocations"
        const context = isInHolidaysUserGroup ? {} : {
            list_view_ref: "hr_time.hr_time_allocation_view_tree_my",
            form_view_ref: "hr_time.hr_time_allocation_view_form",
        }
    ...
    async navigateInfo(stateList) {
        ...
        const context = isInHolidaysUserGroup
            ...
            : {
                  search_default_group_date_from: true,
                  list_view_ref: "hr_time.hr_time_view_tree_my",
                  form_view_ref: "hr_time.hr_time_view_form",
              };
...
export class TimeOffCard extends Component {
    static template = "hr_time.TimeOffCard";
...
export class TimeOffCardMobile extends TimeOffCard {
    static template = "hr_time.TimeOffCardMobile";
}
