...
registry.category("web_tour.tours").add("hr_time_tour", {
    steps: () => [
        ...
        {
            trigger: 'button[data-menu-xmlid="hr_time.menu_hr_time_management"]',
            content: _t("Let's go validate it"),
            tooltipPosition: "bottom",
            run: "click",
        },
        {
            trigger: 'a[data-menu-xmlid="hr_time.menu_open_department_leave_approve"]',
