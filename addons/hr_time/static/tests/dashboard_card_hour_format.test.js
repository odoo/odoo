...
import { TimeOffCard } from "@hr_time/dashboard/time_off_card"
import { defineHrTimeModels } from "./hr_time_test_helpers";
...
function getHourProps(floatHour) {
	return {
		...
		data: {
			...
			holds_changes: false,
			icon: "/hr_time/static/src/img/icons/Compensatory_Time_Off.svg",
			leaves_approved: 0,
			leaves_requested: 0,
			leaves_taken: 0,
