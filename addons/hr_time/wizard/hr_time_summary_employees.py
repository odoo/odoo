...
class HrTimeSummaryEmployee(models.TransientModel):
    _name = 'hr.time.summary.employee'
    ...
    def print_report(self):
        ...
        return self.env.ref('hr_time.action_report_holidayssummary').report_action(employees, data=datas)
