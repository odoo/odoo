...
class HrTimeAccrualLevel(models.Model):
    _name = 'hr.time.accrual.level'
    ...
    accrual_plan_id = fields.Many2one('hr.time.accrual.plan', "Accrual Plan", required=True, index=True, ondelete="cascade", default=lambda self: self.env.context.get("active_id", None))
