    ...
    def action_register(self):
        ...
        for departure in cancel_leave_departures:
            ...
            if employee_allocations_sudo:
                to_delete = self.env['hr.time.allocation']
                to_modify = self.env['hr.time.allocation']
