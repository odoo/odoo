...
class HrDepartment(models.Model):
    ...
    def action_open_leave_department(self):
        action = self.env["ir.actions.actions"]._for_xml_id("hr_time.hr_time_action_action_approve_department")
        action['context'] = {
    ...
    def action_open_allocation_department(self):
        action = self.env["ir.actions.actions"]._for_xml_id("hr_time.hr_time_allocation_action_approve_department")
