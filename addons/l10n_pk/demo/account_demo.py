...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_demo_data(self, company=False):
        if company.account_fiscal_country_id.code == "PK":
            if company.state_id:
                ...
                _logger.error(
                    'Error while loading Accounting(Pakistan) demo data in the company "%s".',
                    company.name
                )
        else:
    ...
    def _get_demo_data_partner(self, company=False):
        ...
        state_id = self.env.ref('base.state_pk_is')
    ...
    def _get_demo_data_move(self, company=False):
        ...
        def _get_tax_by_id(tax_id):
            tax = self.env['account.chart.template'].ref(tax_id)
            return tax.id
        ...
        if company.account_fiscal_country_id.code == "PK":
            ...
            return {
                # Demo of B2B (business-to-business) Invoice.
                # Taxable supplies made to B2B Entity.
                'demo_invoice_b2b_1': {
                    ...
                    'invoice_line_ids': [
                        Command.create({
                            ...
                            'price_unit': 40000.0,
                            'tax_ids': [Command.set([
                                _get_tax_by_id('pk_sales_tax_services_10')
                            ])],
                        }),
                        Command.create({
                            ...
                            'price_unit': 400.0,
                            'tax_ids': [Command.set([
                                _get_tax_by_id('pk_sales_tax_services_17'),
                                _get_tax_by_id('pk_sales_tax_services_10'),
                                _get_tax_by_id('pk_sales_tax_services_5')
                            ])],
                        }),
                        Command.create({
                ...
                # Demo of B2C (business-to-consumer) Invoice.
                # Taxable supplies made to Unregistered Entity.
                'demo_invoice_b2c_1': {
                    'move_type': 'out_invoice',
                    ...
                    'invoice_line_ids': [
                        ...
                        Command.create({
                            ...
                            'tax_ids': [Command.set([
                                _get_tax_by_id('pk_sales_tax_services_5'),
                                _get_tax_by_id('pk_sales_tax_services_2')
                            ])],
                        }),
                        Command.create({
                        ...
                        Command.create({
                            ...
                            'price_unit': 1655.0,
                            'tax_ids': [Command.set([
                                _get_tax_by_id('pk_sales_tax_services_1')
                            ])],
                        }),
                    ]
                },
                ...
                # Demo of B2C (business-to-business) Credit Note.
                # Taxable supplies reversed to B2B Entity.
                ...
                # Demo of B2B (business-to-business) Vendor Bill.
                # Taxable supplies from to B2B Entity.
                'demo_vendor_bill_b2b_1': {
                    ...
                    'invoice_line_ids': [
                        Command.create({
                            ...
                            'price_unit': 1000.0,
                            'tax_ids': [Command.set([
                                _get_tax_by_id('pk_sales_tax_services_15')
                            ])],
                        }),
                        Command.create({
                ...
                'demo_vendor_bill_b2b_2': {
                    ...
                    'invoice_line_ids': [
                        Command.create({
                            ...
                            'price_unit': 1000.0,
                            'tax_ids': [Command.set([
                                _get_tax_by_id('pk_sales_tax_17')
                            ])],
                        }),
                        Command.create({
