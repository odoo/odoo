...
class TestTermCount(common.TransactionCase):
    ...
    def test_count_term(self):
        ...
        odoo.tools.trans_load(self.cr, 'test_base_translation_import/i18n/fr.po', 'fr_FR', verbose=False)
        ...
        self.assertEqual(translations[0].module, 'test_base_translation_import')
        self.assertEqual(translations[0].name, 'addons/test_base_translation_import/models.py')
        ...
        self.assertEqual(translations[1].module, 'test_base_translation_import')
        self.assertEqual(translations[1].name, 'ir.model.fields,field_description')
        self.assertEqual(translations[1].comments, '')
        field = self.env['ir.model.fields'].search([('model', '=', 'test.base.translation.import'), ('name', '=', 'name')])
    ...
    def test_count_term_module(self):
        ...
        translations = self.env['ir.translation'].search([
            ('lang', '=', 'fr_FR'),
            ('src', '=', 'Ijkl'),
            ('module', '=', 'test_base_translation_import'),
        ])
    ...
    def test_noupdate(self):
        ...
        """
        menu = self.env.ref('test_base_translation_import.menu_test_base_translation_import')
        menu.name = "New Name"
        ...
        odoo.tools.trans_load(self.cr, 'test_base_translation_import/i18n/fr.po', 'fr_FR', verbose=False, overwrite=True)
    ...
    def test_lang_with_base(self):
        ...
        odoo.tools.trans_load(self.cr, 'test_base_translation_import/i18n/fr.po', 'fr_BE', verbose=False)
        odoo.tools.trans_load(self.cr, 'test_base_translation_import/i18n/fr_BE.po', 'fr_BE', verbose=False, overwrite=True)
    ...
    def test_export_empty_string(self):
        ...
        def update_translations(create_empty_translation=False):
            ...
            with closing(io.BytesIO()) as bufferobj:
                odoo.tools.trans_export('fr_FR', ['test_base_translation_import'], bufferobj, 'po', self.cr)
                bufferobj.name = 'test_base_translation_import/i18n/fr.po'
    ...
    def test_import_from_po_file(self):
        ...
        with file_open('test_base_translation_import/i18n/tlh.po', 'rb') as f:
    ...
    def test_import_from_csv_file(self):
        ...
        with file_open('test_base_translation_import/i18n/dot.csv', 'rb') as f:
            po_file = base64.encodebytes(f.read())
    ...
    def test_export_pollution(self):
        ...
        module = self.env.ref('base.module_test_base_translation_import')
...
class TestTranslationFlow(common.TransactionCase):
    ...
    def test_export_static_templates(self):
        trans_static = []
        po_reader = TranslationModuleReader(self.env.cr, ['test_base_translation_import'])
        for line in po_reader:
            module, ttype, name, res_id, source, value, comments = line
            if name == "addons/test_base_translation_import/static/src/xml/js_templates.xml":
