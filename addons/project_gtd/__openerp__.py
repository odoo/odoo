...
========================================================
This module implements a simple personal to-do list based on tasks. It adds in the project application an editable list of tasks simplified to the minimum required fields.
