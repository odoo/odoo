...
patch(CookiesBar.prototype, {
    ...
    showPopup() {
        super.showPopup();
        // Initially when the modal is shown, its height is 0, so we need to wait
        // for the modal to be fully rendered before adjusting the position of the
        // compare button. Through the `--move-cookie-over-modal` CSS variable, we
        // can dynamically adjust the position of elements based on modal changes.
        this.waitForTimeout(() => {
