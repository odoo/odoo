...
class TestProjectHrExpenseProfitability(TestProjectProfitabilityCommon, TestProjectHrExpenseProfitabilityCommon):
    ...
    def test_project_profitability(self):
        ...
        expense_foreign = self.create_expenses({
            ...
            'employee_journal_id': self.company_data_2['default_journal_purchase'].id,
        })
        ...
        # Reset to draft the expense of the main company. Only the total from the foreign company should be computed
        ...
        # Reset to draft the expense of the foreign company. No data should be computed now.
        expense_foreign.action_reset()
        self.assertEqual(expense_foreign.state, 'draft')
        self.assertDictEqual(
            self.project._get_profitability_items(False),
            self.project_profitability_items_empty,
