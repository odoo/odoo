...
class EventEvent(models.Model):
    ...
    def _default_share_event(self):
        return self.env['ir.ui.view']._render_template('event.social_share')

    # description
    subtitle = fields.Char('Event Subtitle', translate=True)
    share_event = fields.Html(sanitize_attributes=False, default=_default_share_event)
    # registration
