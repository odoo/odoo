...
class WebsiteMenu(models.Model):
    ...
    original_name = fields.Char('Standard menu entries generated by the event module')
    ...
    def _set_website_menu(self):
        for event in self:
            if event.menu_id and not event.website_menu:
                ...
                existing_page_names = event.menu_id.child_id.mapped('original_name')
                ...
                submenu_to_delete = event.menu_id.child_id.filtered(lambda menu: menu.original_name not in required_page_names and menu.original_name in standard_page_names)
