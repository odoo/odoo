...
class IrUiView(models.Model):
    ...
    def save_embedded_field(self, el):
        ...
        if value is not None:
            ...
            if el.getchildren()[0].get('data-description'):
                Model.browse(int(el.get('data-oe-id'))).set_attachment(el.getchildren()[0].get('data-description'), int(el.getchildren()[0].get('data-original-id')), field)
