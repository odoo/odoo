...
class Web_Editor(http.Controller):
    ...
    def crop_attachment(self, id, res_model=None, res_id=None, name=None, data=None, mimetype=None, original_id=None):
        """
        Creates or updates a cropped attachment, then returns its image_src to
        ...
        return attachment.image_src + '?access_token=' + attachment.access_token
