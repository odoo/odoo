...
(function (exports, owl) {
    ...
    function _proxifyObject(obj) {
        ...
        obj[memoryProxyPramsKey] = {
            ID: generateVersionableID(),
            linkCallback: linkVersionable$2,
    ...
    class Modifier extends VersionableObject {
        constructor() {
            super(...arguments);
    ...
    class CssStyle extends VersionableObject {
        constructor(style) {
            super();
            if (style) {
                this.reset(style);
    ...
    class ClassList extends VersionableObject {
    ...
    function hasContentEditable(node) {
        var _a;
        return ((_a = node.modifiers.find(Attributes)) === null || _a === void 0 ? void 0 : _a.has('contentEditable')) || false;
    }
    /**
    ...
    function isContentEditable(node) {
        var _a;
        const editable = (_a = node.modifiers.find(Attributes)) === null || _a === void 0 ? void 0 : _a.get('contentEditable');
    ...
    class Modifiers extends VersionableObject {
     ...
     */
    class EventMixin extends VersionableObject {
        /**
    ...
    class ActionableGroupSelectItemDomObjectRenderer extends NodeRenderer {
        constructor(engine) {
            super(engine);
            this.predicate = (node) => node.ancestors(ActionableGroupNode).length >= 2;
            this.actionableGroupSelectItemNodes = new Map();
            this.engine.editor.dispatcher.registerCommandHook('@commit', this._updateActionableGroupSelectItems.bind(this));
        }
        async render(item, worker) {
            ...
            if (item instanceof ActionableNode) {
                ...
                if (item.ancestors(ActionableGroupNode).length <= 2) {
                    const title = (_a = item.modifiers.find(Attributes)) === null || _a === void 0 ? void 0 : _a.get('title');
                    domObject = {
                        tag: 'OPTGROUP',
                        attributes: {
         ...
         * @param element
         */
        _updateActionableGroupSelectItems() {
    ...
    ActionableGroupSelectItemDomObjectRenderer.id = DomObjectRenderingEngine.id;
    ...
    Odoo.dependencies = [Inline, Link, Xml];
    ...
    class IframeNode extends ContainerNode {
        constructor(params) {
            super();
            this.editable = false;
            this.breakable = false;
