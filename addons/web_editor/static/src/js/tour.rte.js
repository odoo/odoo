    ...
    base.ready().done(function () {
        tour.register("rte", {
            ...
            [{
                ...
                extra_trigger: '.note-color button.dropdown-toggle:visible:first',
                run: function () {
                ...
                content: "Select foreground spectrum colorpanel",
                trigger: ".o_foreground_toggle > button",
            }, {
                ...
                extra_trigger: '.note-color button.dropdown-toggle:visible:last',
                run: function () {
                ...
                content: "Select background spectrum colorpanel",
                trigger: ".o_background_toggle > button",
            }, {
                ...
                content: "change text foreColor again again",
