...
export class Wysiwyg extends Component {
     ...
     * @param {string} resModel - The res model of currentEditableEl.
     * @param {string} resId - The res id of currentEditableEl.
     * @param {string} resField - The res field of currentEditableEl.
    ...
    async _saveB64Image(el, resModel, resId, resField, type) {
        ...
        if (attachment.mimetype === 'image/webp') {
            ...
            imageOptions.originalId = attachment.id;
            imageOptions.mimetype = attachment.mimetype;
            imageOptions.fileName = attachment.name;
    ...
    async _saveModifiedImage(el, resModel, resId, resField, type) {
        ...
        const originalAttachmentId = imageData.originalId ? encodeURIComponent(imageData.originalId) : "";
        const newAttachmentSrc = await this._serviceRpc(
            `/web_editor/modify_image/${originalAttachmentId}`,
            {
                ...
                saved_image_data: weUtils.convertSnakeToCamelOrCamelToSnakeObject(imageData, false),
                res_type: type,
            },
        );
