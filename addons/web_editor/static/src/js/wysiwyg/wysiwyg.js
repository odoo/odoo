...
const insertText = OdooEditorLib.insertText;
...
export class Wysiwyg extends Component {
    ...
    _configureMagicbuttons() {
        ...
        const openTools = (e) => {
            ...
            switch (e.currentTarget.id) {
                ...
                case 'more-options':
                    ...
                    insertText(sel, "/");
                    sel.collapseToEnd();
                    this.odooEditor.editable.dispatchEvent(inputEvent);
                    break;
            }
        };
        ...
        magicButton.querySelector("#more-options")?.addEventListener('mousedown', openTools);
    }
