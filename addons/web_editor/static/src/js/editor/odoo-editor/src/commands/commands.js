                ...
                if (
                    ...
                    if (selectedChildren.length) {
                        ...
                        if (isGradientBeingUpdated) {
                            const classRegex = mode === 'color' ?  TEXT_CLASSES_REGEX : BG_CLASSES_REGEX;
                            // When updating a gradient, remove color applied to its descendants.
                            // This ensures the gradient remains visible without being overwritten by a descendant's color.
