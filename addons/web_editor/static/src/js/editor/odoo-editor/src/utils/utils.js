...
const INVISIBLE_BOM_CHAR = '\ufeff';
export const ZERO_WIDTH_CHARS = ['\u200b', INVISIBLE_BOM_CHAR];
...
export function isSelectionFormat(editable, format) {
    ...
    return selectedNodes.length && selectedNodes.every(n => n.nodeValue === INVISIBLE_BOM_CHAR || isFormatted(n, editable));
}
