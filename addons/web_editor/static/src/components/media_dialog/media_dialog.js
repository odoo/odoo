        ...
        elements.forEach(element => {
            if (this.props.media) {
                ...
                if (this.state.activeTab === TABS.IMAGES.id) {
                    ...
                    const newImageData = {};
                    const optionsToSave = ["shape", "shapeColors", "shapeFlip", "shapeRotate",
                        "hoverEffect", "hoverEffectColor", "hoverEffectStrokeWidth",
                        "hoverEffectIntensity", "shapeAnimationSpeed"];
                    for (const option of optionsToSave) {
                        if (oldImageData[option]) {
                            ...
                            if (weUtils.isDatasetImageOption(option)) {
                                ...
                                element.dataset[option] = oldImageData[option];
                            }
                        }
                    }
