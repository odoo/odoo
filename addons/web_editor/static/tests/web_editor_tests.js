...
QUnit.only('field html translatable', function (assert) {
    assert.expect(3);
    ...
    assert.strictEqual($button.length, 0, "should not have a translate button in readonly mode");

    form.$buttons.find('.o_form_button_edit').click();
    $button = form.$('.oe_form_field_html_text .o_field_translate');
