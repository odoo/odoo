...
QUnit.module('convert_inline', {}, function () {
    ...
    QUnit.test('convert Bootstrap classes to inline styles', async function (assert) {
        ...
        const containerStyle = `border-radius: 0px; border-style: none; margin: 0px auto; box-sizing: border-box; border-color: rgb(17, 24, 39); border-width: 0px; max-width: 1320px; padding-left: 16px; padding-right: 16px; width: 100%;`;
        const rowStyle = `border-radius: 0px; border-style: none; padding: 0px; box-sizing: border-box; border-color: rgb(17, 24, 39); border-width: 0px; margin-left: -16px; margin-right: -16px; margin-top: 0px;`;
        const colStyle = `border-radius: 0px; border-style: none; box-sizing: border-box; border-color: rgb(17, 24, 39); border-width: 0px; margin-top: 0px; padding-left: 16px; padding-right: 16px; max-width: 100%; width: 100%;`;
        assert.strictEqual($editable.html(),
