...
class PortalRating(PortalChatter):

    @http.route()
    def portal_chatter_init(self, res_model, res_id, domain=False, limit=False, **kwargs):
        result = super(PortalRating, self).portal_chatter_init(res_model, res_id, domain=domain, limit=limit, **kwargs)
    ...
    def portal_message_fetch(self, res_model, res_id, domain=False, limit=False, offset=False, **kw):
        ...
        return super(PortalRating, self).portal_message_fetch(res_model, res_id, domain=domain, limit=limit, offset=offset, **kw)
