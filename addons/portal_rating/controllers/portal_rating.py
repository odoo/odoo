...
class PortalRating(http.Controller):
    ...
    def publish_rating_comment(self, rating_id, publisher_comment):
        ...
        rating_values = rating.read(['publisher_comment', 'publisher_id', 'publisher_datetime'])[0]
        return request.env['mail.message']._portal_message_format_rating(rating_values)
