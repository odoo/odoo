...
class RatingRating(models.Model):
    ...
    def _to_store_defaults(self):
        return super()._to_store_defaults() + [
            Store.Attr("publisher_comment", predicate=lambda rating: rating.publisher_id),
            Store.Attr("publisher_datetime", predicate=lambda rating: rating.publisher_id),
            Store.One(
                "publisher_id",
                ["name", "is_company", "user", "write_date"],
                predicate=lambda rating: rating.publisher_id,
            ),
            Store.One("message_id", [], predicate=lambda rating: rating.publisher_id),
        ]
