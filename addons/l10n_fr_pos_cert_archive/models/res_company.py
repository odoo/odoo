...
class ResCompany(models.Model):
    ...
    def _l10n_fr_compute_pos_lines_csv_archive_content(self):
        ...
        query = '''
            ...
            ORDER BY line.id
        '''
        dt = datetime.strptime(self.fiscalyear_lock_date, DEFAULT_SERVER_DATE_FORMAT).replace(hour=23, minute=59, second=59)
    ...
    def _l10n_fr_create_archive_attachment(self):
        ...
        for company in self:
            ...
            filename1, content1 = company._l10n_fr_compute_amls_csv_archive_content()
            filename2, content2 = company._l10n_fr_compute_pos_lines_csv_archive_content()
            filename3, content3 = company._l10n_fr_compute_sales_closing_csv_archive_content()
