...
class TestBasic(TransactionCase):
    ...
    def test_readonly_save(self):
        ...
        """
        f = Form(self.env['test_testing_utilities.a'], view='test_base_testing_utilities.non_normalized_attrs')
...
class TestM2M(TransactionCase):
    ...
    def test_attr(self):
        f = Form(self.env['test_testing_utilities.e'], view='test_base_testing_utilities.attrs_using_m2m')
        with self.assertRaises(AssertionError):
            f.count = 5
...
class TestO2M(TransactionCase):
    def test_basic_alterations(self):
        ...
        records
        """
        f = Form(self.env['test_testing_utilities.parent'], view='test_base_testing_utilities.o2m_parent')
        ...
        with Form(r, view='test_base_testing_utilities.o2m_parent') as f:
    ...
    def test_o2m_editable_list(self):
        ...
        """
        f = Form(self.env['test_testing_utilities.parent'], view='test_base_testing_utilities.o2m_parent_ed')
        custom_tree = self.env.ref('test_base_testing_utilities.editable_external').id
    ...
    def test_o2m_inline(self):
        ...
        """
        f = Form(self.env['test_testing_utilities.parent'], view='test_base_testing_utilities.o2m_parent_inline')
    ...
    def test_readonly_o2m(self):
        ...
        f = Form(r, view='test_base_testing_utilities.o2m_parent_readonly')
    ...
    def test_o2m_dyn_onchange(self):
        f = Form(self.env['test_testing_utilities.onchange_parent'], view='test_base_testing_utilities.m2o_onchange_view')
    ...
    def test_o2m_self_recursive(self):
        Form(self.env['test_testing_utilities.recursive'], view='test_base_testing_utilities.o2m_recursive_relation_view')
    ...
    def test_o2m_attrs(self):
        ...
        f = Form(Model, view='test_base_testing_utilities.o2m_modifier')
        f.save()
    ...
    def test_o2m_widget(self):
        ...
        f = Form(self.env['test_testing_utilities.parent'], view='test_base_testing_utilities.o2m_widget_m2m')
        f.subs.add(a)
        f.subs.add(b)
        f.subs.add(c)
        r = f.save()
