...
class TwitterConfigSettings(models.TransientModel):
    ...
    def create(self, vals):
        TwitterConfig = super(TwitterConfigSettings, self).create(vals)
    ...
    @api.multi
    def write(self, vals):
        TwitterConfig = super(TwitterConfigSettings, self).write(vals)
        if vals.get('twitter_api_key') or vals.get('twitter_api_secret') or vals.get('twitter_screen_name'):
