...
from .pos_restaurant import RestaurantTable, RestaurantFloor
from .pos_payment_method import PosPaymentMethod
from .pos_self_order_custom_link import PosSelfOrderCustomLink
from .product_product import ProductProduct, ProductTemplate
