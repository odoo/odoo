...
class PosConfig(models.Model):
    ...
    def _load_pos_self_data_read(self, records, config):
        ...
        record['_self_ordering_image_home_ids'] = config._get_self_ordering_attachment(config.self_ordering_image_home_ids)
    ...
    def load_self_data(self):
        ...
        config_data = response['pos.config'][0]
        config_data['_self_ordering_image_home_ids'] = self.self_ordering_image_home_ids.ids
        config_data['_self_ordering_image_background_ids'] = self.self_ordering_image_background_ids.ids
        config_data['_pos_special_products_ids'] = self._get_special_products().ids
        config_data['_self_ordering_style'] = {
            'primaryBgColor': self.env.company.email_secondary_color,
            'primaryTextColor': self.env.company.email_primary_color,
        }
        config_data['_base_url'] = self.get_base_url()
        config_data['_self_order_pos'] = True
