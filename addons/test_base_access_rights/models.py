...
class SomeObj(models.Model):
    ...
    forbidden = fields.Integer(
        groups='test_base_access_rights.test_group,!base.group_no_one,base.group_user,!base.group_public',
        default=5
    )
    forbidden2 = fields.Integer(groups='test_base_access_rights.test_group')
