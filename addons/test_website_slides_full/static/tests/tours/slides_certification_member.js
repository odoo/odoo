...
var initTourSteps = [{
    ...
    run: function () {
        ...
        if (document.querySelectorAll('.o_wslides_slides_list_slide .o_wslides_js_slides_list_slide_link').length === 0) {
            document.querySelector('.o_wslides_course_main').classList.add('empty-content-success');
        }
    }
}, {
