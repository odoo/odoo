...
paymentForm.include({
    ...
    _xenditGetPaymentDetails(paymentOptionId) {
        ...
        return {
            ...
            card_holder_email: inputs.email ? inputs.email.value : '',
            card_holder_first_name: inputs.first_name ? inputs.first_name.value : '',
            card_holder_last_name: inputs.last_name ? inputs.last_name.value : '',
            card_holder_phone_number: inputs.phone ? inputs.phone.value : ''
        };
    },
