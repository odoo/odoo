...
class PaymentTransaction(models.Model):
    ...
    def _xendit_get_rounded_amount(self):
        """ Return the transaction amount rounded down to the precision Xendit expects for its
        currency.
        ...
        return float_round(self.amount, rounding, rounding_method='DOWN')
    ...
    def _xendit_get_pending_authentication_url(self):
        ...
        try:
            payment_request_data = self.provider_id._xendit_send_request(
    ...
    def _xendit_sync_from_provider(self):
        ...
        try:
            data = self.provider_id._xendit_send_request(endpoint, **request_kwargs)
        except ValidationError:
            _logger.exception(
    ...
    def _xendit_tokenize_from_notification_data(self, notification_data):
        ...
        if not card_details:
            token_data = self.provider_id._xendit_send_request(
