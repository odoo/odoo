...
class TestPaymentTransaction(PaymentHttpCommon, XenditCommon):
    ...
    def test_no_item_missing_from_rendering_values(self):
        ...
        self.assertDictEqual(rendering_values, {'api_url': url, 'url_params': {}, 'api_method': 'get'})
    ...
    def test_no_input_missing_from_redirect_form(self):
        ...
        with patch(
            ...
            '._get_specific_rendering_values', return_value={'api_url': 'https://dummy.com', 'url_params': {}, 'api_method': 'get'}
        ):
