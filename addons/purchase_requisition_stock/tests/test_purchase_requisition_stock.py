...
class TestPurchaseRequisitionStock(TestPurchaseRequisitionCommon):
    ...
    def test_05_move_dest_links_alternatives(self):
        ...
        self.assertEqual(int_move.reserved_availability, 0, "No product should be available, as no products were received at this point.")
        ...
        in_picking.move_ids.quantity_done = 10
        in_picking.button_validate()
        # Quantity should be reserved in the internal transfer's move
        self.assertEqual(int_move.reserved_availability, 10, "Quantity should be reserved in the original internal move.")
