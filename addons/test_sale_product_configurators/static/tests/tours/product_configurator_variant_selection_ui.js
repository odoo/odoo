...
registry.category("web_tour.tours").add('sale_product_configurator_variant_selection_tour', {
    steps: () => [
        ...
        ...tourUtils.clickSomewhereElse(),
        {
            ...
            trigger: 'td[name="product_and_description"]:contains("Steel, White")',
        },
        {
        ...
        ...tourUtils.clickSomewhereElse(),
        {
            ...
            trigger: 'td[name="product_and_description"]:contains("Aluminium, White")',
        },
        {
            content: "Assert that the optional product was added",
            trigger: 'td[name="product_and_description"]:contains("Chair floor protection")',
        },
        ...stepUtils.saveForm(),
    ],
});
