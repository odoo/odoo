...
registry.category("web_tour.tours").add('sale_product_configurator_optional_products_tour', {
    ...
    trigger: 'tr:has(div[name="o_product_configurator_name"]:contains("Office Chair Black")) button:has(i.fa-plus)',
    run: "click",
}, {
    trigger: 'tr:has(div[name="o_product_configurator_name"]:contains("Customizable Desk")) button:has(i.fa-plus)',
    run: "click",
}, {
    trigger: 'tr:has(div[name="o_product_configurator_name"]:contains("Chair floor protection")) button:has(i.fa-plus)',
    run: "click",
}, {
    trigger: 'tr:has(div[name="o_product_configurator_name"]:contains("Conference Chair")) button:has(i.fa-plus)',
    run: "click",
}, {
    trigger: 'tr:has(div[name="o_product_configurator_name"]:contains("Conference Chair")) a:contains("Remove product")',
    run: "click",
}, {
    trigger: 'tr:has(div[name="o_product_configurator_name"]:contains("Conference Chair")) button:has(i.fa-plus)',
    run: "click",
