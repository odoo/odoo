...
registry.category("web_tour.tours").add('sale_product_configurator_tour', {
    ...
    steps: () => [
        ...
        {
        trigger: '.o_sale_product_configurator_table tr:has(td>div[name="o_sale_product_configurator_name"] span:contains("Customizable Desk")) td.o_sale_product_configurator_qty span[name="sale_product_configurator_formatted_price"]:contains("800.40")',
        },
        {
