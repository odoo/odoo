...
export class TranslationModeSidePanel extends Component {
    ...
    static template = "translation_mode.TranslationModeSidePanel";
    ...
    setup() {
        ...
        this.orm
            .call("ir.config_parameter", "get_str", ["translation_mode.translate_url"])
            .then((translationUrl) => {
    ...
    openSettings() {
        this.actionService.doAction({
            ...
            name: "Settings",
            res_model: "translation_mode.settings",
            views: [[false, "form"]],
            target: "new",
            context: {
                dialog_size: "medium",
