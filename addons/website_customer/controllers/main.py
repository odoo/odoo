...
class WebsiteCustomer(http.Controller):
    ...
    def customers(self, country_id=0, page=0, country_name='', tag_id=0, **post):
        ...
        PartnerTag = request.env['res.partner.tag']
        ...
        partner_tags = PartnerTag.search([('website_published', '=', True), ('partner_ids', 'in', partners.ids)],
                                 order='classname, name ASC')
        partner_tag = tag_id and PartnerTag.browse(tag_id) or False
