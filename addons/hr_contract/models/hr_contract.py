...
class HrContract(models.Model):
    ...
    company_id = fields.Many2one(related='employee_id.company_id', store=True, readonly=False,
    ...
    currency_id = fields.Many2one(string="Currency", related='employee_id.company_id.currency_id', readonly=True)
