...
class TestEmployeeWorkingPeriods(TestContractCommon):
    ...
    def test_case_no_contract(self):
        ...
        employee_rows = self.employee._get_employee_working_periods(self.dates_inside_contracts["start"], self.dates_inside_contracts["end"])
    ...
    def test_with_draft_contract(self):
        ...
        """
        employee_rows = self.employee_bali._get_employee_working_periods(self.dates_inside_contracts["start"], self.dates_inside_contracts["end"])
    ...
    def test_with_draft_contract_ready(self):
        ...
        employee_rows = self.employee_bali._get_employee_working_periods(self.dates_outside_contracts["start"], self.dates_outside_contracts["end"])
        working_periods = employee_rows[self.employee_bali.id]['working_periods']
