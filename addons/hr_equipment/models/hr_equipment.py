...
class HrEquipmentRequest(models.Model):
    ...
    def message_new(self, msg, custom_values=None):
        ...
        result = super(HrEquipmentRequest, self).message_new(msg, custom_values=custom_values)
        if 'category_id' in custom_values:
            equipment_request = self.browse(result)
            equipment_request.onchange_category_id()
            # TODO RIM crappy code...
        return result
