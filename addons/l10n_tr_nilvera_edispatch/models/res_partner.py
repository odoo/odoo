...
class ResPartner(models.Model):
    ...
    def _get_tax_office_missing_message(self):
        """Overridden in l10n_tr_nilvera_einvoice to use the tax office field instead of ref."""
        self.ensure_one()
    ...
    def _get_tax_office_for_edispatch(self):
        """Overridden in l10n_tr_nilvera_einvoice to return the tax office field instead of ref."""
        self.ensure_one()
        return self.ref
