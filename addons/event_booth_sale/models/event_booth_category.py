...
class EventBoothCategory(models.Model):
    ...
    price = fields.Float(
        string='Price', compute='_compute_price', digits=0, min_digits='Product Price', readonly=False,
        store=True, groups="event.group_event_registration_desk")
    price_incl = fields.Float(
        string='Price incl', compute='_compute_price_incl', digits=0, min_digits='Product Price', readonly=False,
        groups="event.group_event_registration_desk")
    ...
    price_reduce = fields.Float(
        ...
        compute_sudo=True, digits=0, min_digits='Product Price', groups="event.group_event_registration_desk")
