...
class hr_department(models.Model):
    ...
    appraisal_process_ids = fields.One2many('hr.appraisal', 'department_id', domain=['&', ('state', '=', 'pending'), '|', ('date_close', '<=', fields.Datetime.now()), ('user_input_ids.state', '=', 'done')], string='Appraisal to Process')
