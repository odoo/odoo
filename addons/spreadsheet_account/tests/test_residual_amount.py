...
class SpreadsheetAccountingFunctionsTest(AccountTestInvoicingCommon):
    ...
    def test_residual_empty_params(self):
        self.assertEqual(self.env['account.account'].get_residual_amount([]), [])
    ...
    def test_residual_no_account_codes(self):
        ...
        residual_amount = self.env['account.account'].get_residual_amount([
            {
                'date_from': {
                    'range_type': 'year',
                    'year': 2023,
        ...
        self.assertEqual(residual_amount, [self.product_a.standard_price + self.product_b.standard_price])
    ...
    def test_residual_yearly(self):
        ...
        self.assertEqual(residual_amount, [self.product_a.standard_price])
    ...
    def test_residual_with_payment(self):
        ...
        self.assertEqual(residual_amount, [self.product_a.standard_price - payment.amount])
    ...
    def test_residual_quarterly(self):
        ...
        self.assertEqual(residual_amount, [0.0])
    ...
    def test_residual_posted_filter(self):
        ...
        self.assertNotEqual(residual_amount, [0.0])
