...
class ProductConfiguratorController(http.Controller):
    ...
    def configure(self, product_template_id, pricelist_id, **kw):
        ...
        return request.env['ir.ui.view']._render_template(
            "website_sale_product_configurator.configure",
            {
    ...
    def _optional_product_items(self, product_id, pricelist, **kw):
        ...
        return request.env['ir.ui.view']._render_template("website_sale_product_configurator.optional_product_items", {
            'product': product,
    ...
    def _show_advanced_configurator(self, product_id, variant_values, pricelist, **kw):
        ...
        return request.env['ir.ui.view']._render_template("website_sale_product_configurator.optional_products_modal", {
            'product': product,
