...
class ProductTemplate(models.Model):
    ...
    website_description = fields.Html(string='Description for the website', sanitize=False, translate=True)
    ...
    def _default_website_sequence(self):
        min_sequence = self.search([], order='website_sequence', limit=1).website_sequence
    ...
    def set_sequence_up(self):
        previous_product_tmpl = self.search([('website_sequence', '>', self.website_sequence), ('website_published', '=', self.website_published)], order='website_sequence', limit=1)
