...
class SaleOrder(models.Model):
    ...
    def get_abandoned_carts(self):
        ...
        website_teams = self.env['crm.team'].search([]).filtered(lambda team: team.team_type == 'website')
        return {
            ...
            'domain': [
                    ...
                    ('order_line', '!=', False),
                    ('date_order', '<', time_constraint)],
            'context': {'create': False},
            'res_model': 'sale.order',
            'help': _('''<p>Find here all the abandoned carts, i.e. the carts generated by your website's visitors more than one hour ago and not confirmed.</p>
                        <p>You should send an email to revive them!</p>
                    '''),
        }
    ...
    def get_active_carts(self):
        ...
        return {
            ...
            'view_type': 'form',
            'view_mode': 'tree,form',
            'domain': [('team_id', 'in', website_teams.ids), ('state', '=', 'draft'), ('date_order', '>=', time_constraint)],
            'context': {'create': False},
            'res_model': 'sale.order',
            'help': _('''<p>Find here all the Active carts, i.e. the carts generated by your website's visitors less than one hour ago and not confirmed.</p>'''),
        }
