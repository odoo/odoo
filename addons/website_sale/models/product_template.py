...
class ProductTemplate(models.Model):
    ...
    def _get_sales_prices(self, website):
        ...
        pricelist = website.current_pricelist_id.with_context(self.env.context)
        currency = website.currency_id
        fiscal_position_sudo = website.current_fiscal_position_id
    ...
    def _get_contextual_pricelist(self):
        ...
        if request and request.is_frontend and not pricelist:
            ...
            return website.current_pricelist_id
        return pricelist
