...
class ProductProduct(models.Model):
    ...
    def _to_markup_data(self, website):
        ...
        product_price = website.current_session_pricelist_id.sudo()._get_product_price(
        ...
        taxes = website.current_session_fiscal_position_id.sudo().map_tax(product_taxes_sudo)
