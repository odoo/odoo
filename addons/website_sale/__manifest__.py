...

{
    ...
    'data': [
        ...
        # Website snippets
        'views/templates/snippets/snippets.xml',
        'views/templates/snippets/product_snippet_template_data.xml',
        'views/templates/snippets/s_add_to_cart.xml',
        'views/templates/snippets/s_dynamic_snippet_products.xml',
        'views/templates/snippets/s_dynamic_snippet_categories.xml',
        'views/templates/snippets/s_dynamic_snippet_products_preview_data.xml',
        'views/templates/snippets/s_dynamic_snippet_category_preview_data.xml',
        'views/templates/snippets/s_mega_menu/big_icons_subtitles.xml',
        'views/templates/snippets/s_mega_menu/cards.xml',
        'views/templates/snippets/s_mega_menu/image_menu.xml',
        'views/templates/snippets/s_mega_menu/images_subtitles.xml',
        'views/templates/snippets/s_mega_menu/little_icons.xml',
        'views/templates/snippets/s_mega_menu/logos.xml',
        'views/templates/snippets/s_mega_menu/multi_menus.xml',
        'views/templates/snippets/s_mega_menu/odoo_menu.xml',
        'views/templates/snippets/s_mega_menu/thumbnails.xml',
        'views/templates/snippets/snippet_category_template_data.xml',
        'views/templates/generate_primary_template.xml',
    ],
    'demo': [
        'data/demo.xml',
    ],
