...
class WebsiteSale(payment_portal.PaymentPortal):
    ...
    @route(['/shop/<model("product.template"):product_template>'], type='http', auth="public", website=True, sitemap=True)
    def product(self, product_template, category='', search='', **kwargs):
        return request.render("website_sale.product", self._prepare_product_values(product_template, category, search, **kwargs))
    ...
    def _prepare_product_values(self, product_template, category, search, **kwargs):
        ...
        return {
            ...
            'main_object': product_template,
            'product': product_template,
            'view_track': view_track,
            'product_configurator_props': self._get_ws_product_information(
                product_template,
                request.website.pricelist_id,
            )
        }

    @route('/website_sale/product_configurator/update_combination', type='json', auth='public', website=True)
    def website_sale_product_configurator_update_combination(
        ...
        return self._get_ws_basic_product_information(
    ...
    def _get_ws_product_information(
        self,
        product_template,
        pricelist,
    ):
        ...
        return dict(
            ...
            product=dict(
                **self._get_ws_basic_product_information(
                    product or product_template,
                    pricelist,
                    combination,
                    quantity=1,
    ...
    def _get_ws_basic_product_information(self, product_or_template, pricelist, combination, **kwargs):
        ...
        basic_information = dict(
            **product_or_template.read(['description_sale', 'name'])[0]
        )
        return dict(
            **basic_information,
