...
class WebsiteSale(payment_portal.PaymentPortal):
    ...
    @route(
        ...
        auth='public',
        website=True,
        list_as_website_content=_lt("Shop Page"),
    ...
    @route(
        '/shop/checkout', type='http', methods=['GET'], auth='public', website=True, sitemap=False, list_as_website_content=_lt("Shop Checkout Page")
    )
    ...
    @route(['/shop/extra_info'], type='http', auth="public", website=True, sitemap=False, list_as_website_content=_lt("Shop Extra Information Page"))
    ...
    @route('/shop/payment', type='http', auth='public', website=True, sitemap=False, list_as_website_content=_lt("Shop Payment Page"))
    ...
    @route(['/shop/confirmation'], type='http', auth="public", website=True, sitemap=False, list_as_website_content=_lt("Shop Confirmation Page"))
