        ...
        if order.partner_id != request.website.user_id.partner_id.id:
            ...
            if shippings:
                if kw.get('partner_id'):
                    ...
                    if partner_id in shippings.mapped('id'): # check is mine address
    ...
    def values_postprocess(self, order, mode, values, errors, error_msg):
        ...
        for k, v in values.items():
            if k in authorized_fields and v is not None and v != '':
                ...
                if k not in ('field_required', 'partner_id', 'callback', 'submitted', 'state_id'): # classic case
