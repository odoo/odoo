...
class Cart(PaymentPortal):
    ...
    def add_to_cart(
        ...
        **kwargs
        ...
        """
        website = self.env['website'].get_current_website()
        order_sudo = website.current_session_sale_order_id or website._create_cart()
    ...
    def _prepare_order_history(self):
        ...
        cart_lines_sudo = website.current_session_sale_order_id.order_line if website.current_session_sale_order_id else SaleOrderLineSudo
