                ...
                <div class="o_carousel_product_outer carousel-outer position-relative d-flex align-items-center w-100 overflow-hidden">
                    ...
                    <div class="carousel-inner h-100">
                        <div class="carousel-item h-100 text-center active">
                            <div class="d-flex align-items-center justify-content-center h-100 oe_unmovable"><img src="/web/image/website.landscape_md_5" class="img img-fluid oe_unmovable product_detail_img w-100 mh-100" loading="lazy" style=""></div>
                        </div>
                ...
                <div class="o_carousel_product_indicators pt-2 overflow-hidden">
                    <ol class="carousel-indicators position-static pt-2 pt-lg-0 mx-auto my-0" style="justify-content: start;">
                        <li data-bs-target="#o-carousel-product" class="align-top position-relative active" data-bs-slide-to="0" aria-current="true">
                            <div><img src="/web/image/website.landscape_md_5" class="img o_image_64_cover" loading="lazy" style=""></div>
                        </li>
