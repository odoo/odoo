...
wTourUtils.registerWebsitePreviewTour('add_to_cart_snippet_tour', {
    ...
    () => [
        ...
        wTourUtils.clickOnSnippet({id: 's_add_to_cart'}),
        ...wTourUtils.selectElementInWeSelectWidget('product_template_picker_opt', 'Cabinet with Doors', true),
        ...
        wsTourUtils.assertCartContains({productName: 'Cabinet with Doors', backend: true}),
