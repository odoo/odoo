...
registry.category('web_tour.tours').add('shop_update_cart', {
    ...
    steps: () => [
        ...
        {
            trigger: '#cart_products a.o_cart_line_product_link>h6:contains("Storage Box")',
        },
        {
            content: "add one more",
            trigger: '#cart_products div:has(a.o_cart_line_product_link>h6:contains("Steel")) a.js_add_cart_json:eq(1)',
            run: "click",
        },
        {
            trigger:
        ...
        },
        {
            ...
            trigger:
                '#cart_products div:has(a.o_cart_line_product_link>h6:contains("Storage Box")) a.js_add_cart_json:first',
            run: "click",
        },
        {
            trigger: '#wrap:not(:has(#cart_products a.o_cart_line_product_link>h6:contains("Storage Box")))',
        },
        {
            content: "set one",
