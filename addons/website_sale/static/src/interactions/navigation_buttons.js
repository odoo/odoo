...
export class NavigationButton extends Interaction {
    static selector = '#navigation_buttons';
    dynamicContent = PATHS_TO_CHECK.reduce(
        (acc, path) => {
            // Uses *= operator in case the href is a redirect.
            // Example: '/web/login?redirect=/shop/checkout'
...
registry
    ...
    .add('website_sale.NavigationButton', NavigationButton);
