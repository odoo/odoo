...
export class ProductMultiMediaImageField extends ImageField {
    ...
    onFileEdit(ev) {
        ...
        this.dialog.add(MultiMediaDialog, {
            ...
            customImageSave: this.onCustomImageSave.bind(this),
            customVideoSave: this.onCustomVideoSave.bind(this),
        });
    }

    async onCustomImageSave(attachment) {
    ...
    async onCustomVideoSave(videoInfo) {
