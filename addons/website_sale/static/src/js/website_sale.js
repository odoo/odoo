...
odoo.define('website_sale.website_sale', function (require) {
    ...
    $('.oe_website_sale').each(function () {
        ...
        // $('.oe_cart').on('click', '.js_toggle_other_shipping', function() {
        //     $('.js_other_shipping').toggle();
        //     // $('.js_other_shipping').slideToggle({
        //     //     duration:600,
        ...
        if ($(".checkout_autoformat").length) {
            $(oe_website_sale).on('change', "select[name='country_id']", function () {
                clickwatch(function() {
                    if ($("#country_id").val()) {
                        ajax.jsonRpc("/shop/country_infos/" + $("#country_id").val(), 'call', {}).then(
                            function(data) {
                                ...
                                if (data.fields) {
                                    ...
                                    var all_fields = ["street", "zip", "city", "country_name"]; //STATE OR NOT STATE ? , "state_code"];
