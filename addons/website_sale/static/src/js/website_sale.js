            ...
            .then(function (data) {
                ...
                if (data.warning) {
                    ...
                    if (cart_alert.length == 0) {
                        ...
                        cart_alert.html('<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> <strong>Warning!</strong> ' + data.warning);
                    }
                    setTimeout(function(){ $('#data_warning').alert('close'); }, 15000);
