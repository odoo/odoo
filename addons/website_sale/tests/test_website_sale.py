...
from .test_website_sale_pricelist import TestWebsitePriceList


class TestWebsiteSalePerformance(TestWebsitePerformanceCommon, TestWebsitePriceList):
    ...
    def test_perf_sql_queries_page(self):
        ...
        self.url_open(f'/shop/cart/add', json={
            "id": 0,
            "jsonrpc": "2.0",
            "method": "call",
            "params": {
        ...
        self.url_open(f'/shop/cart/update', json={
            "id": 0,
            "jsonrpc": "2.0",
            "method": "call",
            "params": {
...
class TestWebsiteSalePerformancePostInstall(TestWebsiteSalePerformance):
