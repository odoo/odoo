...
class TestWebsiteSaleImage(HttpCaseWithWebsiteUser):
    ...
    def test_01_admin_shop_zoom_tour(self):
        ...
        self.assertFalse(self.template.product_template_image_ids[2].can_image_1024_be_zoomed)
        self.assertFalse(self.product_red.can_image_1024_be_zoomed)
        self.assertFalse(self.product_red.variant_image_ids[1].can_image_1024_be_zoomed)
        self.assertTrue(self.product_green.can_image_1024_be_zoomed)
        self.assertTrue(self.product_green.variant_image_ids[0].can_image_1024_be_zoomed)
        ...
        # CASE: If the template image is removed, the first image from product_template_image_ids
        # is used as fallback
        self.template.image_1920 = False
        self.assertEqual(
            self.template.image_1920.content,
            self.template.product_template_image_ids[0].image_1920.content,
        )
    ...
    def test_04_assign_image_to_variants(self):
        self.template.write({
            "product_template_image_ids": [
                Command.create({
                    "name": "green",
    ...
    def test_05_remove_main_image_fallback_to_extra_image(self):
        self.template.write({
            "product_template_image_ids": [
    ...
    def test_06_remove_main_image_fallback_to_variant_extra_image(self):
        self.template.write({
            "product_template_image_ids": [
                Command.create({
                    "name": "red",
    ...
    def test_07_remove_main_variant_image_fallback_to_extra_image(self):
