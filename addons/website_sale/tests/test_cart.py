...
from odoo.addons.website_sale.tests.common import WebsiteSaleCommon, MockRequest
...
class TestWebsiteSaleCart(ProductVariantsCommon, WebsiteSaleCommon):
    ...
    def test_zero_price_after_pricelist_recompute_blocks_payment(self):
        ...
        with MockRequest(website.env, website=website) as request:
            ...
            self.assertFalse(order._get_prevented_sale_lines())
            ...
            self.assertEqual(order._get_prevented_sale_lines(), order.order_line)
