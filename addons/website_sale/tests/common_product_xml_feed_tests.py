...
class CommonProductFeedXmlFeed(WebsiteSaleFeedCommon, HttpCase):
    ...
    def test_xml_not_found_if_setting_disabled(self):
        self.enabled_flag_name = False
        ...
        with self.assertRaises(NotFound), MockRequest(
            ...
            self.WebsiteSaleFeedController.product_xml_feed_data_source()
    ...
    def test_all_product_xml_feed(self):
        ...
        self.test_xml_not_found_if_setting_disabled()
