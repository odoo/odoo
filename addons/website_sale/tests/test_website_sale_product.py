...
class WebsiteSaleProductTests(TestSaleProductAttributeValueCommon):
    ...
    def test_get_contextual_price_tax_selection(self):
        ...
        parameters = itertools.product(param_main_product_tax_included, param_show_line_subtotals_tax_selection, param_extra_tax)

        for main_product_tax_included, show_line_subtotals_tax_selection, extra_tax in parameters:
            with self.subTest(main_product_tax_included=main_product_tax_included, show_line_subtotals_tax_selection=show_line_subtotals_tax_selection, extra_tax=extra_tax):
