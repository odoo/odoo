...
class TestWebsiteSaleProductConfigurator(
    ...
    def test_product_configurator_zero_priced(self):
        ...
        self.start_tour('/', 'website_sale_product_configurator_zero_priced', login='admin')
    ...
    def test_product_configurator_strikethrough_price(self):
        ...
        self.start_tour('/', 'website_sale_product_configurator_strikethrough_price', login='admin')
