...
class WebsiteSaleFeedCommon(ProductVariantsCommon, WebsiteSaleCommon, HttpCase):
    ...
    def test_feed_items_identifier_exists_iff_barcode_exists(self):
    ...
    def test_all_product_xml_feed(self):
        ...
        self.test_feed_items_identifier_exists_iff_barcode_exists()
