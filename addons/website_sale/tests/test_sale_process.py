...
class TestSaleProcess(HttpCaseWithUserDemo, WebsiteSaleCommon, HttpCaseWithUserRestricted):
    ...
    def setUpClass(cls):
        ...
        cls.partner_restricted.write(cls.dummy_partner_address_values)
    ...
    def test_update_same_address_billing_shipping_edit(self):
        ...
        self.start_tour("/shop", 'update_billing_shipping_address', login="restricted")
