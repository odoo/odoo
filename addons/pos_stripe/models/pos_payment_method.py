...
class PosPaymentMethod(models.Model):
    ...
    def stripe_connection_token(self):
        ...
        return self.sudo()._get_stripe_payment_provider()._make_request('POST', 'terminal/connection_tokens')
    ...
    def stripe_payment_intent(self, amount):
        ...
        return self.sudo()._get_stripe_payment_provider()._make_request('POST', 'payment_intents', data=params)
    ...
    def stripe_capture_payment(self, paymentIntentId, amount=None):
        ...
        return self.sudo()._get_stripe_payment_provider()._make_request('POST', endpoint, data=data)
