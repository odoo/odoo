...
class ResCompany(models.Model):
    ...
    def _verify_hashed_move(self, move, previous_hash, versioning_list, current_versioning_index):
        ...
        message = pt_hash_utils.get_message_to_hash(move.date, move.l10n_pt_hashed_on, move._get_l10n_pt_document_number(), abs(move.amount_total_signed), previous_hash)
