...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_demo_data_move(self, company=False):
        ...
        eu_sale_tax = self.env.ref(f'account.{company.id}_iva_pt_sale_eu_isenta')
        non_eu_sale_tax = self.env.ref(f'account.{company.id}_iva_pt_sale_non_eu_isenta')
        non_eu_purchase_tax = self.env.ref(f'account.{company.id}_iva_pt_purchase_non_eu_isenta')
