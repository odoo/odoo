...
class TestL10nPtCommon(AccountTestInvoicingCommon):
    ...
    @classmethod
    def create_invoice(cls, move_type, invoice_date="2024-01-01", l10n_pt_hashed_on=None, amount=1000.0, tax=None,
                       partner=None, product_id=False, do_hash=False, company=None):
        invoice_data = {
