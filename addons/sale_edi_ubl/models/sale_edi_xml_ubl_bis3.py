...
from odoo.addons import sale_edi_ubl, account_edi_ubl_cii


class SaleEdiXmlUbl_Bis3(models.AbstractModel, sale_edi_ubl.SaleEdiCommon, account_edi_ubl_cii.AccountEdiXmlUbl_Bis3):
