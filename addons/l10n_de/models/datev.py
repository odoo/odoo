    ...
    def _get_product_accounts(self):
        ...
        if company.account_fiscal_country_id.code == "DE":
            if not self.property_account_income_id:
                taxes = self.tax_ids.filtered_domain(self.env['account.tax']._check_company_domain(company))
            ...
            if not self.property_account_expense_id:
                supplier_taxes = self.supplier_tax_ids.filtered_domain(self.env['account.tax']._check_company_domain(company))
