...
class LunchOrder(models.Model):
    ...
    topping_ids_1 = fields.Many2many('lunch.topping', string='Toppings 1', domain=[('label', '=', 1)])
    topping_ids_2 = fields.Many2many('lunch.topping', string='Toppings 2', domain=[('label', '=', 2)])
    topping_ids_3 = fields.Many2many('lunch.topping', string='Toppings 3', domain=[('label', '=', 3)])
