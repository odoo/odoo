...
test("Trash existing order", async () => {
    ...
    expect("div.o_lunch_banner > div").toHaveCount(3);
    ...
    expect("div.o_lunch_banner div[name='o_lunch_order_line']").toHaveCount(1, {
    ...
    expect("div.o_lunch_banner div[name='o_lunch_order_line']").toHaveCount(0);
});
...
test("Change existing order", async () => {
    ...
    await contains("div.o_lunch_banner div[name='o_lunch_order_line']:contains(Big Plate) i.oi-plus").click();
});
