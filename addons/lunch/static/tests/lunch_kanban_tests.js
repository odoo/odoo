...
QUnit.module('LunchKanbanView', {
    ...
    QUnit.module('LunchKanbanWidget', function () {
        ...
        QUnit.test('search panel domain location', function (assert) {
            assert.expect(10);
        ...
        QUnit.test('non-empty cart', function (assert) {
            assert.expect(17);
        ...
        QUnit.test('ordered cart', function (assert) {
            assert.expect(15);
        ...
        QUnit.test('confirmed cart', function (assert) {
            assert.expect(15);
        ...
        QUnit.test('regular user', function (assert) {
            assert.expect(11);
            ...
            testUtils.fields.many2one.clickOpenDropdown('locations');
        ...
        QUnit.test('manager user', function (assert) {
            assert.expect(12);
            ...
            testUtils.fields.many2one.clickOpenDropdown('users');
        ...
        QUnit.test('add a product', function (assert) {
            assert.expect(1);
        ...
        QUnit.test('add product quantity', function (assert) {
            assert.expect(3);
        ...
        QUnit.test('remove product quantity', function (assert) {
            assert.expect(3);
        ...
        QUnit.test('clear order', function (assert) {
            assert.expect(1);
            ...
            testUtils.dom.click($widgetSecondColumn.find('button.o_lunch_widget_unlink'));

            kanban.destroy();
        });

        QUnit.test('validate order: success', function (assert) {
            assert.expect(1);
            ...
            testUtils.dom.click($widgetThirdColumn.find('button.o_lunch_widget_order_button'));

            kanban.destroy();
        });

        QUnit.test('validate order: failure', function (assert) {
            assert.expect(5);
                ...
                mockRPC: function (route) {
                    if (route.startsWith('/lunch')) {
                        ...
                        if (route === '/lunch/payment_message') {
                            ...
                            return $.when({ message: 'This is a payment message.'});
                        }
                        return mockLunchRPC({
                            infos: Object.assign({}, self.regularInfos, {
                                lines: [
