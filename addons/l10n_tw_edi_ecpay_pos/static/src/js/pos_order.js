...
patch(PosOrder.prototype, {
    ...
    set_invoice_info(
        ...
        this.l10n_tw_edi_invoice_type = l10n_tw_edi_invoice_type;
    },
    ...
    export_for_printing(baseUrl, headerData) {
        ...
        return {
            ...
            qrcode_right: this.qrcode_right ? this.get_ecpay_qrcode(this.qrcode_right) : undefined,
            company_name: this.company.name,
            ecpay_error: this.error !== undefined,
            is_ecpay_enabled: this.config.is_ecpay_enabled,
        };
    },
