...
patch(PosStore.prototype, {
    ...
    async selectPartner() {
        ...
        if (this.company.country_id?.code === "TW" && this.config.is_ecpay_enabled && partner) {
            order.set_to_invoice(true);
            order.set_invoice_info(true, false, false, false, false);
            order.l10n_tw_edi_is_b2b = Boolean(
                (partner.parent_id && partner.parent_id.company_type === "company") ||
