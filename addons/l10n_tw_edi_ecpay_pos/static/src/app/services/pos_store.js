...
patch(PosStore.prototype, {
    async _getUniformInvoiceData(order, options = {}) {
        ...
        if (uniform_invoice) {
            ...
            order.iis_create_date = uniform_invoice.iis_create_date;
            ...
            order.l10n_tw_edi_carrier_type = uniform_invoice.l10n_tw_edi_carrier_type;
            order.l10n_tw_edi_carrier_number = uniform_invoice.l10n_tw_edi_carrier_number;
