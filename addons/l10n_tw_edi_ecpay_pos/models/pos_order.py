...
class PoSOrder(models.Model):
    ...
    def _prepare_invoice_vals(self):
        ...
        vals.update({
            ...
            'l10n_tw_edi_invoice_type': self.l10n_tw_edi_invoice_type,
        })
        return vals
    ...
    def _generate_pos_order_invoice(self):
        ...
        if self.refunded_order_id:
            self.account_move.write({
                "l10n_tw_edi_origin_invoice_number_id": self.refunded_order_id.account_move,
    ...
    def l10n_tw_edi_check_mobile_barcode(self, text):
        ...
        if response_data.get("RtnCode") == 1 and response_data.get("IsExist") == "Y":
            return True
        else:
            raise UserError(_("Mobile barcode is invalid!"))
    ...
    def l10n_tw_edi_check_love_code(self, text):
        ...
        if response_data.get("RtnCode") == 1 and response_data.get("IsExist") == "Y":
            ...
            raise UserError(_("Love code is invalid!"))
    ...
    def l10n_tw_edi_check_tax_id(self, text):
        ...
        if response_data.get("RtnCode") == 1 and response_data.get("CompanyName"):
            return True
        else:
            raise UserError(_("Tax id is invalid!"))
