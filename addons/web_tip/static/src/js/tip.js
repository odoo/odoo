...
var Tip = Class.extend({
    ...
    do_tip: function (tip) {
        ...
        if (trigger_tip) {
            ...
            self.$element.prepend('<i class="oe_breathing" style="width: '+self.$element.width()+'px"/>');
            self.$element.one('click', '.oe_breathing', function(e) {
    ...
    end_tip: function(tip) {
        ...
        self.$element.find('.oe_breathing').remove();
