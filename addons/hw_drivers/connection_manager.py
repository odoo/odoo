...
class ConnectionManager(Thread):
    ...
    def _get_next_polling_interval(self):
        ...
        # e.g If the pairing code is valid for 2 hours this would lead to max 116 requests
        # Starting with 10 seconds and ending with +- 5 min interval
        self.n_times_polled += 1
        return 10 + 1.05 ** self.n_times_polled
