...
class TestActivitySchedule(ActivityScheduleCase):
    ...
    def test_next_activities(self):
        ...
        with self.subTest(test_case='Check plan summary'):
            ...
            expected_summary = (
                '<ul>'
                '<li>To-Do<ul><li>Call 1 days after previous activity completion date or Mail 0 days after previous activity deadline</li></ul></li>'
                '<li>Call<ul><li>Mail 0 days after previous activity deadline</li></ul></li>'
                '<li>Mail</li>'
                '</ul>'
            )
