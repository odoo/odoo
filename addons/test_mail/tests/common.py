...
class TestMailCase(common.SavepointCase, mail_common.MailCase):
    @classmethod
    def setUpClass(cls):
        super(TestMailCase, cls).setUpClass()

        cls.user_employee = mail_new_test_user(
            cls.env, login='employee', groups='base.group_user', name='Ernest Employee',
            notification_type='inbox', signature='--\nErnest')
