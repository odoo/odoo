...
class TestMailTemplateLanguages(TestMailTemplateCommon):
    ...
    def test_template_send_email(self):
        ...
        with self.with_user(self.user_employee.login), self.assertQueryCount(27):  # runbot 25
    ...
    def test_template_send_email_batch(self):
        ...
        with self.with_user(self.user_employee.login), self.assertQueryCount(931):  # runbot: 928
    ...
    def test_template_send_email_wreport(self):
        ...
        self.env.invalidate_all()
        with self.with_user(self.user_employee.login), self.assertQueryCount(103):  # runbot 98
    ...
    def test_template_translation_partner_lang(self):
        ...
        self.env.invalidate_all()
        mails = self.env['mail.mail'].sudo()
        with self.with_user(self.user_employee.login), self.assertQueryCount(47):  # runbot 44
            template = self.test_template.with_env(self.env)
