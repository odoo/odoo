...
class TestMailFlow(MailCommon, TestRecipients):
    ...
    def test_lead_mailgateway(self):
            ...
            [
                {
                    ...
                    'message_values': {
                        ...
                        'email_to': False,
                        'notified_partner_ids': partner_sylvie + partner_pay + partner_accounting + self.partner_employee_2 + self.partner_portal,
        ...
        for partner in message.notified_partner_ids:
            exp_msg_to_partners = partner | (partner_sylvie + partner_pay + partner_accounting + self.partner_portal)
            with self.subTest(name=partner.name):
                self.assertSMTPEmailsSent(
                    ...
                    msg_to_lst=exp_msg_to_partners.mapped('email_formatted'),
                )
