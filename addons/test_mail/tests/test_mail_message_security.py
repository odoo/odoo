...
class TestMailMessageAccess(MessageAccessCommon):
    ...
    #  - document-based (write or create, using '_group_mail_message_access'
    ...
    def test_access_create_customized(self):
        """ Test '_group_mail_message_access' support """
        ...
        # lock -> see '_group_mail_message_access'
    ...
    #  - recipients / notified
    #  - document-based: read, using '_group_mail_message_access'
    ...
    def test_access_read_customized(self):
        ...
        # lock -> see '_group_mail_message_access', cannot read locked message
    ...
    # ------------------------------------------------------------
    # UNLINK
    # - Criterion: document-based (write or create), using '_group_mail_message_access'
    # ------------------------------------------------------------
    ...
    def test_search_customized(self):
        """ Test '_group_mail_message_access' support in search """
        records = self.env['mail.test.access.custo'].with_user(self.user_admin).create([
            {'name': 'Open'},
            {'name': 'Open (other)'},
            {'name': 'Soonish Locked'},
        ...
        # lock -> see '_group_mail_message_access', which is not supported currently
