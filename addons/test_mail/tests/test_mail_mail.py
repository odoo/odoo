...
class TestMailMail(MailCommon):
    ...
    def test_mail_mail_recipients_tweaks(self):
        ...
        for mail_values, exp_smtp, exp_to in [
            (
                {
            ...
            ), (
                {
                    ...
                    ['customer@test.example.com', 'user2@test.mycompany.com'],
                    ['partner.test@test.example.com'], ['partner.test.2@test.example.com'],
                ], ['"Customer" <customer@test.example.com>, skip@test.example.com, "Skip 2" <skip.2@test.example.com>, '
            ...
            with self.subTest(mail_values=mail_values):
                ...
                for exp_smtp_to_lst, exp_msg_to in zip(exp_smtp, exp_to):
