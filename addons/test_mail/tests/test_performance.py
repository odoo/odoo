...
class TestBaseAPIPerformance(BaseMailPerformance):
    ...
    def test_activity_full(self):
        ...
        with self.assertQueryCount(admin=6, employee=6):  # tm: 5/5
        ...
        with self.assertQueryCount(admin=14, employee=13):  # tm: 6 / 6
    ...
    def test_activity_mixin(self):
        ...
        with self.assertQueryCount(admin=15, employee=14):  # tm: 9 / 9
