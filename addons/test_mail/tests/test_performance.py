...
class TestAdvMailPerformance(TransactionCase):
    ...
    def test_message_assignation_email(self):
        ...
        with self.assertQueryCount(margin=1, admin=83, emp=105):  # test_mail only: 81 - 103
            record.write({
    ...
    def test_message_post_one_email_notification(self):
        ...
        with self.assertQueryCount(margin=1, admin=76, emp=102):  # com runbot: 74 - 97 // test_mail only: 72 - 95
            record.message_post(
...
class TestHeavyMailPerformance(TransactionCase):
    ...
    def test_complex_message_post(self):
        ...
        with self.assertQueryCount(admin=116, emp=147):  # com runbot 114 - 141 // test_mail only: 110 - 137
            record.message_post(
    ...
    def test_complex_message_post_template(self):
        ...
        with self.assertQueryCount(admin=135, emp=178):  # com runbot 133 - 172 // test_mail only: 129 - 168
    ...
    def test_complex_tracking_assignation(self):
        ...
        with self.assertQueryCount(admin=85, emp=108):  # test_mail only: 82 - 106
    ...
    def test_complex_tracking_subscription_create(self):
        ...
        with self.assertQueryCount(margin=1, admin=239, emp=284):  # com runbot: 239 - 282 // test_mail only: 232 - 277
            rec = self.env['mail.test.full'].create({
                'name': 'Test',
    ...
    def test_complex_tracking_subscription_subtype(self):
        ...
        with self.assertQueryCount(admin=149, emp=175):  # test_mail only: 144 - 171
            rec.write({
                'name': 'Test2',
                'umbrella_id': self.umbrella.id,
                })
    ...
    def test_complex_tracking_subscription_write(self):
        ...
        with self.assertQueryCount(admin=154, emp=180):  # test_mail only: 149 - 175
            rec.write({
                'name': 'Test2',
                'umbrella_id': umbrella_id,
                'customer_id': customer_id,
