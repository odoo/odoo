...
class TestAdvMailPerformance(TransactionCase):
    ...
    def test_adv_activity_full(self):
        ...
        with self.assertQueryCount(margin=1, admin=51, emp=73):  # test_mail only: 51 - 73
    ...
    def test_adv_activity_mixin(self):
        ...
        with self.assertQueryCount(margin=1, admin=53, emp=75):  # test_mail only: 53 - 75
    ...
    def test_message_assignation_email(self):
        ...
        with self.assertQueryCount(margin=1, admin=84, emp=106):  # test_mail only: 81 - 103
            record.write({
    ...
    def test_message_log_with_post(self):
        ...
        with self.assertQueryCount(admin=26, emp=37):  # com runbot: 26 - 34 // test_mail only: 26 - 34
            record.message_post(
    ...
    def test_message_post_one_email_notification(self):
        ...
        with self.assertQueryCount(margin=1, admin=78, emp=104):  # com runbot: 74 - 97 // test_mail only: 72 - 95
            record.message_post(
    ...
    def test_message_post_one_inbox_notification(self):
        ...
        with self.assertQueryCount(margin=1, admin=39, emp=51):  # com runbot 37 - 46 // test_mail only: 37 - 46
            record.message_post(
...
class TestHeavyMailPerformance(TransactionCase):
    ...
    def test_complex_mail_mail_send(self):
        ...
        with self.assertQueryCount(admin=16, emp=24):  # test_mail only: 13 - 21
    ...
    def test_complex_message_post(self):
        ...
        with self.assertQueryCount(admin=120, emp=151):  # com runbot 114 - 141 // test_mail only: 110 - 137
            record.message_post(
    ...
    def test_complex_message_post_template(self):
        ...
        with self.assertQueryCount(admin=139, emp=182):  # com runbot 133 - 172 // test_mail only: 129 - 168
    ...
    def test_complex_message_subscribe(self):
        ...
        with self.assertQueryCount(admin=43, emp=43):  # test_mail only: 43 - 43
            rec.message_subscribe(
                partner_ids=pids,
                channel_ids=cids,
                subtype_ids=subtype_ids
    ...
    def test_complex_tracking_subscription_create(self):
        ...
        with self.assertQueryCount(margin=1, admin=244, emp=290):  # com runbot: 239 - 282 // test_mail only: 232 - 277
            rec = self.env['mail.test.full'].create({
                'name': 'Test',
    ...
    def test_complex_tracking_subscription_subtype(self):
        ...
        with self.assertQueryCount(admin=153, emp=179):  # test_mail only: 144 - 171
            rec.write({
                'name': 'Test2',
                'umbrella_id': self.umbrella.id,
                })
    ...
    def test_complex_tracking_subscription_write(self):
        ...
        with self.assertQueryCount(admin=157, emp=183):  # test_mail only: 149 - 175
            rec.write({
                'name': 'Test2',
                'umbrella_id': umbrella_id,
                'customer_id': customer_id,
