...
class TestMailPerformance(TransactionCase):
    ...
    def test_create_mail_with_tracking(self):
        ...
        with self.assertQueryCount(__system__=10, demo=13):  # test_mail only: 13 - 13
...
class TestAdvMailPerformance(TransactionCase):
    ...
    def test_adv_activity_full(self):
        ...
        with self.assertQueryCount(__system__=25, emp=47):  # com runbot: 26 - 46 // test_mail only: 25 - 45
    ...
    def test_adv_activity_mixin(self):
        ...
        with self.assertQueryCount(__system__=27, emp=49):  # com runbot: 28 - 86 // test_mail only: 27 - 47
    ...
    def test_message_post_one_inbox_notification(self):
        ...
        with self.assertQueryCount(__system__=32, emp=44):  # com runbot 31 - 45 // test_mail only: 32 - 44
            record.message_post(
...
class TestHeavyMailPerformance(TransactionCase):
    ...
    def test_complex_tracking_assignation(self):
        ...
        with self.assertQueryCount(__system__=61, emp=77):  # com runbot: 61 - 76 // test_mail only: 60 - 72
    ...
    def test_complex_tracking_subscription_create(self):
        ...
        with self.assertQueryCount(__system__=155, emp=173):  # com runbot: 161 - 198 // test_mail only: 161 - 192
            rec = self.env['mail.test.full'].create({
                'name': 'Test',
    ...
    def test_complex_tracking_subscription_subtype(self):
        ...
        self.assertEqual(len(rec.message_ids), 1)
        with self.assertQueryCount(__system__=99, emp=122):  # com runbot: 99 - 120 // test_mail only: 98 - 116
            rec.write({
                'name': 'Test2',
                'umbrella_id': self.umbrella.id,
                })
    ...
    def test_complex_tracking_subscription_write(self):
        ...
        with self.assertQueryCount(__system__=104, emp=126):  # test_mail only: 105 - 122
            rec.write({
                'name': 'Test2',
                'umbrella_id': umbrella_id,
                'customer_id': customer_id,
    ...
    def test_complex_tracking_template(self):
        ...
        with self.assertQueryCount(__system__=53, emp=74):  # test_mail only: 54 - 74
            rec.write({
                'name': 'Test2',
                'customer_id': customer_id,
                'user_id': self.env.uid,
