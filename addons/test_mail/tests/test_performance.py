...
class TestBaseAPIPerformance(BaseMailPerformance):
    ...
    def test_mail_composer_form_attachments(self):
        ...
        with self.assertQueryCount(admin=56, employee=56):  # tm 55/56
            composer._action_send_mail()
...
class TestMessageToStorePerformance(BaseMailPerformance):
    ...
    def test_store_add_message_multi(self):
        ...
        with self.assertQueryCount(employee=27):  # tm 23
    ...
    def test_store_add_message_group_thread_name_by_model(self):
        ...
        with self.assertQueryCount(employee=16):  # tm: 14
            res = Store().add(messages, "_store_message_fields")._build_result()
            self.assertEqual(len(res["mail.message"]), 6)
...
class TestPerformance(BaseMailPostPerformance):
    ...
    def test_message_post_loop(self):
        ...
        with self.assertQueryCount(employee=827):  # tm: 818
