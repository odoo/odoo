...
class TestMailAPIPerformance(BaseMailPerformance):
    ...
    def test_adv_activity_full(self):
        ...
        with self.assertQueryCount(__system__=19, employee=21):  # tm 17/19 - com 18/20
    ...
    def test_adv_activity_mixin(self):
        ...
        with self.assertQueryCount(__system__=20, employee=23):  # tm 18/21 - com 19/22
    ...
    def test_mail_composer(self):
        ...
        with self.assertQueryCount(__system__=35, employee=41):  # tm 33/39
    ...
    def test_mail_composer_nodelete(self):
        ...
        with self.assertQueryCount(__system__=28, employee=34):  # tm 26/32
            composer._action_send_mail()
    ...
    def test_mail_composer_w_template(self):
        ...
        with self.assertQueryCount(__system__=25, employee=26):  # tm 13/14
            composer = self.env['mail.compose.message'].with_context({
                'default_composition_mode': 'comment',
                'default_model': test_record._name,
                'default_res_id': test_record.id,
        ...
        with self.assertQueryCount(__system__=34, employee=40):  # tm 32/28
            composer._action_send_mail()
    ...
    def test_message_assignation_email(self):
        ...
        with self.assertQueryCount(__system__=41, employee=42):  # tm 38/39
            record.write({
                'user_id': self.user_test.id,
            })
    ...
    def test_message_assignation_inbox(self):
        record = self.env['mail.test.track'].create({'name': 'Test'})
        with self.assertQueryCount(__system__=19, employee=21):  # tm 18/20
            record.write({
                'user_id': self.user_test.id,
            })
    ...
    def test_message_post_one_email_notification(self):
        ...
        with self.assertQueryCount(__system__=31, employee=34):  # tm 29/32
            record.message_post(
...
class TestMailComplexPerformance(BaseMailPerformance):
    ...
    def test_complex_message_post(self):
        ...
        with self.assertQueryCount(__system__=56, employee=57):  # tm 53/54
            record.message_post(
    ...
    def test_complex_message_post_template(self):
        ...
        # about 20 (19 ?) queries per additional customer group
        with self.assertQueryCount(__system__=66, employee=67):  # tm 61/62
    ...
    def test_complex_tracking_subscription_create(self):
        ...
        with self.assertQueryCount(__system__=95, employee=96):  # tm 89/90
            rec = self.env['mail.test.ticket'].create({
                'name': 'Test',
    ...
    def test_complex_tracking_subscription_subtype(self):
        ...
        self.assertEqual(len(rec1.message_ids), 1)
        with self.assertQueryCount(__system__=61, employee=61):  # tm 58/58
            rec.write({
                'name': 'Test2',
                'container_id': self.container.id,
            })
    ...
    def test_complex_tracking_subscription_write(self):
        ...
        with self.assertQueryCount(__system__=68, employee=68):  # tm 65/65
            rec.write({
                'name': 'Test2',
                'container_id': container_id,
                'customer_id': customer_id,
    ...
    def test_complex_tracking_template(self):
        ...
        with self.assertQueryCount(__system__=29, employee=30):  # tm 28/29
            rec.write({
                'name': 'Test2',
                'customer_id': customer_id,
                'user_id': self.env.uid,
...
class TestMailHeavyPerformancePost(BaseMailPerformance):
    ...
    def test_complete_message_post(self):
        ...
        with self.assertQueryCount(employee=75):  # tm 68 - com 73
