...
class TestAPI(MailCommon, TestRecipients):
    ...
    def test_mail_partner_find_from_emails(self):
        ...
        res = tickets._partner_find_from_emails({ticket: [ticket.email_from] for ticket in tickets}, force_create=True)
...
class TestDiscuss(MailCommon, TestRecipients):
    ...
    def test_unlink_notification_message(self):
        ...
        self.assertEqual(len(message.exists()), 0, "Test message should have been deleted")
