...
test("activity view: Activity rendering with done activities", async () => {
    ...
    await contains(".o-mail-ActivityListPopoverItem", { text: DateTime.now().plus({ days: 4 }).toFormat('M/dd/yyyy') });
    await contains(".o-mail-ActivityListPopoverItem", { text: DateTime.now().plus({ days: 5 }).toFormat('M/dd/yyyy') });
    await contains(".o-mail-ActivityListPopoverItem", { text: DateTime.now().plus({ days: 6 }).toFormat('M/dd/yyyy') });
