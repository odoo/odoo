...
class AccountMove(models.Model):
    ...
    def _l10n_cr_fe_build_clave_params(self):
        ...
        tipo_info = L10N_CR_FE_TIPO_DOCUMENTO[self.move_type]
        return {
            'tipoDocumento': tipo_info['clave'],
            'tipoCedula': config.identification_type == '02' and 'juridico' or 'fisico',
            'cedula': config.identification_number,
            'situacion': 'normal',
            'consecutivo': config._l10n_cr_fe_next_consecutivo(tipo_info['consecutivo_codigo']),
