...
class CrmChatbotCase(chatbot_common.CrmChatbotCase):
    ...
    def test_chatbot_create_lead_and_forward_public_user(self):
        ...
        assigned_lead.unlink()  # reset state to allow new lead
        ...
        self.assertEqual(discuss_channel.livechat_operator_id, self.chatbot_script.operator_partner_id)
        self.sale_team.crm_team_member_ids.assignment_optout = False # reset state to allow new lead
        # sales team member invalid domain
        # probability of lead is 5.39
