...
class StockRule(models.Model):
    ...
    def _prepare_purchase_order_group(self, values):
        if values.get('move_dest_ids') and values['move_dest_ids'][0].procure_method == 'make_to_stock' and values.get('group_id') and values['group_id'].sale_ids:
            ...
            return group
        return super()._prepare_purchase_order_group(values)
