...
class TestSalePurchaseStockFlow(TransactionCase):
    ...
    def test_mto_cancel_multi_steps_confirmed_purchase(self):
        ...
        self.assertListEqual(sale_orders.picking_ids.move_ids.move_orig_ids.ids, purchase_orders.order_line.move_ids.picking_id.move_ids.ids)
        purchase_orders.order_line.move_ids.picking_id.action_cancel()
    ...
    def test_mto_po_double_quantity_update(self):
        ...
        self.assertEqual(po.order_line.move_ids.picking_id.move_ids.quantity, 10.0)
        po.order_line.product_qty = 5.0
        self.assertEqual(po.order_line.move_ids.picking_id.move_ids.quantity, 5.0)
