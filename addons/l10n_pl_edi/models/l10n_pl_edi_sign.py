...
class XadesSigner:
    ...
    def __init__(self, cert_content, certificate_password):
        pass_bytes = certificate_password.encode('utf-8') if certificate_password else None
        self.private_key = serialization.load_pem_private_key(cert_content, password=pass_bytes)
