...
class PaymentTransaction(models.Model):
        ...
        if entity_type == "payment":
            ...
            if reference:  # The refund was initiated from Odoo.
                ...
                if source_tx:
                    ...
                    tx = self._razorpay_create_refund_tx_from_payment_data(source_tx, payment_data)
    ...
    def _razorpay_create_refund_tx_from_payment_data(self, source_tx, payment_data):
        ...
        converted_amount = source_tx.provider_id._to_major_currency_units(
