...
class AccountInvoiceLine(models.Model):
    ...
    def write(self, vals):
        ...
        for line in self.filtered(lambda line: line.invoice_id.type == 'out_invoice'):
            ...
            if line.product_id.membership and not member_lines:
                ...
                if (not date_from or line.invoice_id.date_invoice > date_from) and date_to and line.invoice_id.date_invoice < date_to:
    ...
    def create(self, vals):
        ...
        if invoice_line.invoice_id.type == 'out_invoice' and \
            ...
            if date_from and date_to and invoice_line.invoice_id.date_invoice and date_from < invoice_line.invoice_id.date_invoice < date_to:
