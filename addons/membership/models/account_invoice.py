...
class account_invoice_line(osv.osv):
    ...
    def write(self, cr, uid, ids, vals, context=None):
        ...
        """
        member_line_obj = self.pool.get('membership.line')
        res = super(account_invoice_line, self).write(cr, uid, ids, vals, context=context)
        for line in self.browse(cr, uid, ids, context=context):
            if line.invoice_id.type == 'out_invoice':
                ml_ids = member_line_obj.search(cr, uid, [('account_invoice_line_id', '=', line.id)], context=context)
                if line.product_id and line.product_id.is_membership and not ml_ids:
                ...
                if line.product_id and not line.product_id.is_membership and ml_ids:
