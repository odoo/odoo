...
class TestCrmPls(CrmPlsCommon):
    ...
    def test_pls_tooltip_data(self):
        ...
        self.assertEqual(len(tooltip_data['top_3_data']), len(expected_top_3))
        self.assertEqual(len(tooltip_data['low_3_data']), len(expected_low_3))

        for expected_top, data_top in zip(expected_top_3, tooltip_data['top_3_data']):
