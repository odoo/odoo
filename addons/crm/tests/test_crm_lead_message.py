...
class TestCrmLeadMessage(common.TransactionCase):
    ...
    def test_crm_lead_message(self):
        ...
        # self.env.ref('crm.lead').with_context({'uid': self.crm_salesman_id})  #APA FIX
        ...
        request_file = open(odoo.modules.module.get_module_resource('crm', 'tests', 'customer_request.eml'), 'rb')
