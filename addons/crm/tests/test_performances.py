...
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    def test_assign_perf_duplicates(self):
        ...
        with self.with_user('user_sales_manager'):
            ...
            with self.assertQueryCount(user_sales_manager=1275):
    ...
    def test_assign_perf_populated(self):
        ...
        with self.with_user('user_sales_manager'):
<<<<<<< HEAD
            with self.assertQueryCount(user_sales_manager=6435):
=======
            with self.assertQueryCount(user_sales_manager=6548):  # 6539-6546 generally / sometimes +1/+2 on nightly
>>>>>>> 5576beca911... temp
