...
@tagged('lead_assign', 'crm_performance', '-at_install', 'post_install')
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    def test_assign_perf_duplicates(self):
        ...
        with self.with_user('user_sales_manager'):
            ...
            with self.assertQueryCount(user_sales_manager=1277):  # crm 1275
    ...
    def test_assign_perf_populated(self):
        ...
        # randomness: at least 2
        with self.with_user('user_sales_manager'):
            with self.assertQueryCount(user_sales_manager=6438):  # crm: 6436
