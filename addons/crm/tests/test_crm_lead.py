...
class TestCRMLead(TestCrmCommon):
    ...
    def test_crm_lead_creation_partner_company(self):
        ...
        self.assertEqual(lead.contact_name, False,
                         "Lead contact name should be set to False if parent is not set")
        self.assertEqual(lead.partner_name, self.contact_company.parent_name,
                         "Lead company name should be set to company name if parent is not set")
    ...
    def test_crm_lead_creation_partner_no_address(self):
        ...
        lead.partner_id = empty_partner
        # SPECIFIC FIELDS
        self.assertEqual(lead.contact_name, 'Empty partner', "Contact should same as parent name")
