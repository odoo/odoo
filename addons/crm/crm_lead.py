...
class crm_lead(format_address, osv.osv):
    ...
    _columns = {
        ...
        'type': fields.selection([ ('lead','Lead'), ('opportunity','Opportunity'), ],'Type', size=11, select=True, help="Type is used to separate Leads and Opportunities"),
        'priority': fields.selection(crm.AVAILABLE_PRIORITIES, 'Priority', size=1, select=True),
