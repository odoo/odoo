...
class crm_lead(format_address, osv.osv):
    ...
    def merge_opportunity(self, cr, uid, ids, user_id=False, section_id=False, context=None):
        ...
        if merged_data.get('section_id'):
            section_stage_ids = self.pool.get('crm.case.stage').search(cr, uid, [('section_ids', 'in', merged_data['section_id']), ('type', 'in', [merged_data.get('type'), 'both'])], order='sequence', context=context)
