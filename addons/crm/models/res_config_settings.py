...
class ResConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        ...
        has_group_lead_before = group_use_lead_id in self.env.user.group_ids.all_implied_ids.ids
        super(ResConfigSettings, self).set_values()
        # update use leads / opportunities setting on all teams according to settings update
        has_group_lead_after = group_use_lead_id in self.env.user.group_ids.all_implied_ids.ids
