...
class ResConfigSettings(models.TransientModel):
    ...
    predictive_lead_scoring_fields = fields.Many2many('crm.lead.scoring.frequency.field', string='Lead Scoring Frequency Fields', compute="_compute_pls_fields", inverse="_inverse_pls_fields_str", groups="sales_team.group_sale_salesman")
