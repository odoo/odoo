...
class CrmStage(models.Model):
    ...
    probability = fields.Float(string='Probability (%)', required=True, default=1.0, help="This percentage depicts the default/average probability of the Case for this stage to be a success")
