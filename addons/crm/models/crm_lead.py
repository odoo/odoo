...
class Lead(models.Model):
    ...
    def _pls_get_naive_bayes_probabilities(self, batch_mode=False):
        ...
        for team_id in result:
            ...
            # Fallback on team's first stage. Different if all stages are steam-specific. Clean me in master.
            if t_won == 0 and t_lost == 0 and t_total == 0 and team_id and team_id > 0:
                first_stage_id = self.env['crm.stage'].search([('team_id', 'in', [team_id, False])],
