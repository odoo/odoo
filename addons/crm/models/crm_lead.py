...
class Lead(models.Model):
    ...
    company_id = fields.Many2one('res.company', string='Company', index=True, default=lambda self: self.env['res.company']._get_current_company().id)
    ...
    def retrieve_sales_dashboard(self):
        ...
        result['currency_id'] = self.env['res.company']._get_current_company().currency_id.id
