...
class CrmLead(format_address, models.Model):
    ...
    tag_ids = fields.Many2many(
        'crm.lead.tag', 'crm_lead_tag_rel',
        'lead_id', 'tag_id', string='Tags', help="Classify and analyze your lead/opportunity categories like: Training, Service")
    ...
    company_currency = fields.Many2one(related='company_id.currency_id', string='Currency', store=True, readonly=True)
    ...
    phonecalls_ids = fields.One2many('crm.phonecall', 'opportunity_id', string='# Phonecalls')
