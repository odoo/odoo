...
translationIsReady.then(() => {
    registry.category("web_tour.tours").add("crm_tour", [
        stepUtils.showAppsMenuItem(),
        {
            ...
            content: markup(
                _t("Ready to boost your sales? Let's have a look at your <b>Pipeline</b>.")
            ),
        ...
        },
        {
            ...
            content: markup(
                _t("<b>Write a few letters</b> to look for a company, or create a new one.")
            ),
            tooltipPosition: "top",
        ...
        },
        {
            ...
            content: _t(
                "You can make your opportunity advance through your pipeline by clicking on stages here. Try sending it to the next stage!"
            ),
            tooltipPosition: "bottom",
            run: "click",
        },
        {
            ...
            content: _t(
                "Click on the breadcrumbs to go back to your Pipeline. Odoo will save all your changes as you navigate."
            ),
            tooltipPosition: "bottom",
        ...
        },
        {
            ...
            content: markup(
                _t("Drag your opportunity to <b>Won</b> when you get the deal. Congrats!")
            ),
            tooltipPosition: "right",
