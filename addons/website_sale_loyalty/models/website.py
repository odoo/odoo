...
class Website(models.Model):
    ...
    def contains_discount_reward(self, product_id):
        """Returns true if the loyalty program contains the specified product_id as a discount reward"""
        return self.has_loyalty and self.loyalty_id.contains_discount_reward(product_id)
