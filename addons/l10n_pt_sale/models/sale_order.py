...
class SaleOrderLine(models.Model):
    ...
    def _compute_discount(self):
        ...
        for line in self.filtered(lambda l: l.order_id.country_code == 'PT'):
            global_discount = (line.order_id.l10n_pt_global_discount or 0.0) / 100
            # we keep the manual line discount if the computed discount is zero
            line.l10n_pt_line_discount = line.discount or line.l10n_pt_line_discount
            line.discount = (1 - (1 - global_discount) * (1 - line.l10n_pt_line_discount / 100)) * 100
    ...
    def _l10n_pt_check_so_at_series_line(self):
        ...
        if len(sale_orders.l10n_pt_at_series_id) == 1:
            ...
            action_error = {
                ...
                'type': 'ir.actions.act_window',
                'views': [[self.env.ref('l10n_pt.view_l10n_pt_at_series_tree').id, 'list']],
            }
            raise RedirectWarning(
