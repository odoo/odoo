    ...
    def create_sales_order(self, date_order="2024-01-01", l10n_pt_hashed_on=None, amount=1000.0, tax=None,
        ...
        if do_hash:
            with freeze_time(l10n_pt_hashed_on):
                self.env['sale.order']._l10n_pt_compute_missing_hashes((company or self.company_pt).id)
...
class TestL10nPtSaleHashing(TestL10nPtSaleCommon):
    ...
    def test_l10n_pt_sale_hash_integrity_report(self):
        ...
        integrity_check_quot = integrity_check[2]  # [0] = 2024 Quotation series
        ...
        integrity_check_so = integrity_check[3]  # [1] = 2024 SO series
        ...
        integrity_check = self.company_pt._l10n_pt_sale_check_hash_integrity()['results'][3]
