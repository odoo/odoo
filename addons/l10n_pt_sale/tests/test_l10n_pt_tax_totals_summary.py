...
from odoo.addons.l10n_pt.tests.test_l10n_pt_tax_totals_summary import TestL10nPtTaxTotalsSummary
from odoo.addons.sale.tests.common import TestTaxCommonSale
from odoo.addons.account.tests.common import TestTaxCommon


@tagged('post_install', '-at_install', 'post_install_l10n')
class TestL10nPtTaxTotalsSummarySale(TestTaxCommonSale, TestL10nPtTaxTotalsSummary):
