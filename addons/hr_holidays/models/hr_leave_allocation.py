...
class HrLeaveAllocation(models.Model):
    ...
    def _process_accrual_plan_level(self, level, start_period, start_date, end_period, end_date):
        ...
        for cal_period_start, cal_period_end, calendar in employee_calendar_periods:
            cal_period_start = datetime.combine(cal_period_start,time(0, 0, 0)).replace(tzinfo=timezone(calendar.tz))
            cal_period_end = datetime.combine(cal_period_end,time(0, 0, 0)).replace(tzinfo=timezone(calendar.tz))
