...
class ResourceCalendarLeaves(models.Model):
    ...
    def _generate_public_holidays(self, companies, year_range, convert_datetime=True):
        ...
        for company in companies:
            ...
            holidays_subdiv = subdivision_per_country_dict.get(company.country_code, None)
            ...
            public_holiday_dict = holidays.country_holidays(
                ...
                subdiv=company_subdiv if company_subdiv and company_subdiv in holidays_subdiv else None,
                years=year_range,
