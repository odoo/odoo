        ...
        for leave in self:
            ...
            if leave.employee_id:
                ...
                if leave.employee_id.sudo().is_flexible and leave.request_date_to == leave.request_date_from:
                    ...
                    days = hours / 24 if leave.employee_id.sudo().is_fully_flexible else len(work_time_per_day_list)
                else:
                    ...
                    days = ceil(hours / 24) if leave.employee_id.sudo().is_fully_flexible else work_days_data['days']
            else:
