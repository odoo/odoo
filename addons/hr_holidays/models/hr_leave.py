...
class HrLeave(models.Model):
    ...
    def _onchange_request_dates(self):
        for leave in self:
            if not (leave.leave_type_request_unit == 'hour' and leave.employee_id and leave.request_date_from and leave.request_date_to):
                continue
...
<<<<<<< 37d90c246daac87b132fb463ee853dc587506c00
...
>>>>>>> fe7939f766e13517c370d63164ff08e8f25041cf
    ...
    def _prepare_holidays_meeting_values(self):
        ...
        for holiday in self:
            ...
            allday_value = (holiday.leave_type_request_unit != 'half_day' or holiday.request_date_from_period == 'am' and holiday.request_date_to_period == 'pm')
            if holiday.leave_type_request_unit == 'hour':
