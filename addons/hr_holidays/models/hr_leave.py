...
class HrLeave(models.Model):
    ...
    def _compute_allowed_work_entry_type_ids(self):
        work_entry_types = self.env['hr.work.entry.type']
        for leave in self:
            leave.allowed_work_entry_type_ids = work_entry_types.search(
                work_entry_types._get_country_domain(leave.company_id.country_id))
