...
""",
    ...
    def _get_responsible_for_approval(self):
        ...
        if self.holiday_type != 'employee':
            return responsible
        if self.validation_type == 'both' and not self.holiday_status_id.responsible_ids and self.state == 'confirm':
            if self.employee_id.parent_id.user_id:
                responsible = self.employee_id.parent_id.user_id
        elif self.validation_type == 'manager' or (self.validation_type == 'both' and self.state == 'confirm'):
