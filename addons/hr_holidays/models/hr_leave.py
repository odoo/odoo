...
""",
    ...
    def activity_update(self):
        ...
        confirm_activity = self.env.ref('hr_holidays.mail_act_leave_approval', raise_if_not_found=False)
        approval_activity = self.env.ref('hr_holidays.mail_act_leave_second_approval', raise_if_not_found=False)
        for holiday in self:
            if holiday.state == 'draft':
                ...
                if holiday.holiday_status_id.leave_validation_type != 'no_validation':
                    if holiday.state == 'confirm':
                        activity_type = confirm_activity or self.env['mail.activity.type']
                        note = _(
                        ...
                        activity_type = approval_activity or self.env['mail.activity.type']
                        note = _(
