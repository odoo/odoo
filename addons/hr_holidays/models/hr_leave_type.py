...
class HrLeaveType(models.Model):
    ...
    time_type = fields.Selection([
        ...
        help="Define the time of time off type. - Paid, working time like Attendance, Remote Work, Training, ... - Paid, non-working time like Sick Time, Paid Time Off, Extra Hours - Unpaid, non-working time like Unpaid, Unpredictable leave, ...")
