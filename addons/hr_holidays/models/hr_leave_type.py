...
class HolidaysType(models.Model):
    ...
    def _get_closest_expiring_leaves_date_and_count(self, allocations, remaining_leaves, target_date):
        ...
        carried_over_days_expiration_data = self._compute_carried_over_days_expiration_data(allocations, target_date)
        for allocation in allocations:
    ...
    def _compute_carried_over_days_expiration_data(self, allocations, target_date):
