...
class HrLeaveType(models.Model):
    ...
    show_on_dashboard = fields.Boolean(default=False, string="On Dashboard", help="Non-visible allocations can still be selected when taking a leave, but will simply not be displayed on the leave dashboard.")
