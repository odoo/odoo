    ...
    def _check_company_country_id(self):
        for leave_type in self:
            if leave_type.is_used:
                raise ValidationError(_("The company/country field cannot be edited for this time off type, as it is currently linked to existing time off or allocation requests.\nTo modify this field, please archive or delete the associated requests, or consider creating a new time off type."))
