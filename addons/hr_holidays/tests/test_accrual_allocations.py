...
class TestAccrualAllocations(TestHrHolidaysCommon):
    ...
    def setUpClass(cls):
        ...
        if cls._is_hr_contract_installed(cls):
    ...
    def _is_hr_contract_installed(self):
        """Return true if hr_contract module is installed"""
        return self.env['ir.module.module'].sudo().search([('name', '=', 'hr_contract')])['state'] == 'installed'
    ...
    def test_accrual_plan_with_changing_working_schedules_1(self):
        ...
        """
        if not self._is_hr_contract_installed():
            return
