...
class TestLeaveRequests(TestHrHolidaysCommon):
    ...
    def test_leave_creation_with_allocation(self):
        leave_type = self.env['hr.leave.type'].create({
        ...
        self.assertIn(leave.state, ['confirm', 'validate'], "Leave should not be in draft, it should be confirmed or validated.")
