...
class hr_holidays(osv.osv):
    ...
    def _get_calendar_event_vals(self, cr, uid, record, context=None):
        meeting_vals = {
            ...
            'stop': record.date_to,
            'allday': False,
            # to block that meeting date in the calendar
            'state': 'open',
            'class': 'confidential'
        }
    ...
    def holidays_validate(self, cr, uid, ids, context=None):
        ...
        for record in data_holiday:
            ...
            if record.holiday_type == 'employee' and record.type == 'remove':
                ...
                meeting_vals = self._get_calendar_event_vals(cr, uid, record, context)
