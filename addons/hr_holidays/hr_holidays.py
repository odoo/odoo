...
class hr_holidays_status(osv.osv):
    ...
    def _user_left_days(self, cr, uid, ids, name, args, context=None):
        return self.pool.get('hr.holidays').get_stats(cr, uid, ids, context=context)
...
class hr_holidays(osv.osv):
    ...
    def get_stats(self, cr, uid, type_ids, employee_id=None, context=None):
        ...
        status_types = self.pool.get('hr.holidays.status').browse(cr, uid, type_ids, context=context)
    ...
    def read(self, cr, uid, ids, fields=None, context=None, load='_classic_read'):
        ...
        for holiday in results:
            ...
            if isinstance(status_id, (list, tuple)):
                ...
                status = self.get_stats(cr, uid, [status_id], employee_id=employee_id, context=context)[status_id]
    ...
    def check_holidays(self, cr, uid, ids, context=None):
        for record in self.browse(cr, uid, ids, context=context):
            if record.holiday_type != 'employee' or record.type != 'remove' or not record.employee_id or record.holiday_status_id.limit:
                continue
            leave_days = self.get_stats(cr, uid, [record.holiday_status_id.id], record.employee_id.id, context=context)[record.holiday_status_id.id]
