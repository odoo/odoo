...
A synchronization with an internal agenda (Meetings of the CRM module) is also possible in order to automatically create a meeting when an holiday request is accepted by setting up a type of meeting in Leave Type.
""",
