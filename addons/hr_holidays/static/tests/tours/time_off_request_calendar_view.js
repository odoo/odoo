...
function simulateDrag(sourceElement, targetElement, options = {}) {
...
registry.category("web_tour.tours").add("timeoff_calendar_drag_drop_tour", {
    url: "/odoo",
    steps: () => [
        stepUtils.showAppsMenuItem(),
        {
        ...
        },
        {
            ...
            run: function () {
                ...
                simulateDrag(sundayEvent, mondayTarget);
            }
        },
        {
            ...
            run: function () {
                ...
                simulateDrag(tuesdayEvent, wednesdayTarget);
            }
        },
        {
            ...
            run: async function () {
                ...
                simulateDrag(thursdayEvent, fridayTarget);
                await delay(500);
            }
        }
    ]
...
registry.category("web_tour.tours").add("timeoff_calendar_resize_tour", {
    url: "/odoo",
    steps: () => [
        stepUtils.showAppsMenuItem(),
        {
        ...
        {
            content: "Increase the duration of the leave on Monday by 2 hours",
            ...
            run: async function() {
                ...
                simulateDrag(resizer, target, { top: false, offsetY: -1 });
                await delay(500);
            }
        },
    ]
