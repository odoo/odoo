...
from . import test_google_access_roles
from . import test_google_event
from . import test_multi_calendar_sync
from . import test_sync_calendars_google2odoo
from . import test_sync_calendars_odoo2google
