...
class calendar_config_settings(osv.TransientModel):
    ...
    def set_calset(self,cr,uid,ids,context=None) :
        ...
        params.set_param(cr, uid, 'google_calendar_client_id', myself.cal_client_id or '', groups=['base.group_no_one'], context=None)
        params.set_param(cr, uid, 'google_calendar_client_secret', myself.cal_client_secret or '', groups=['base.group_no_one'], context=None)
