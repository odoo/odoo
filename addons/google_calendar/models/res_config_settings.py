...
class ResConfigSettings(models.TransientModel):
    ...
    cal_sync_active = fields.Boolean("Synchronization", config_parameter='google_calendar_sync_active',
        help="Indicates if synchronization with Google Calendar is active or not.")
