...
import { tourPlayerState } from "./tour_player_state";
...
export class TourPlayer extends Component {
    ...
    setup() {
        ...
        this.destStepIndex = tourPlayerState.getCurrentIndex();
    ...
    async forward() {
        ...
        tourPlayerState.setCurrentIndex(this.destStepIndex)
        await this.next();
    }
