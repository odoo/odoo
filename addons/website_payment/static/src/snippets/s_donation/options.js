...
options.registry.Donation = options.Class.extend({
    ...
    start() {
        ...
        // is added directly within the respective XML files also contentEditable 
        // attribute added from XML itself.
        this.$target[0].querySelector(".s_donation_form").setAttribute("contentEditable","false")
        this.$target[0].querySelector(".s_donation_donate_btn").setAttribute("contentEditable","true")
        this.$target[0].querySelector(".s_donation_donate_btn").classList.add("oe_unremovable");
