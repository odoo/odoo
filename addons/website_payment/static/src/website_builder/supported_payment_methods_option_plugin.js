...
export class SupportedPaymentMethodsOptionPlugin extends Plugin {
...
export class SupportedPaymentMethodsLimit extends BuilderAction {
...
export class SupportedPaymentMethodsHeight extends BuilderAction {
