        ...
        return [
            {
                ...
                handler: this.reloadElement.bind(this),
            },
        ];
    }

    reloadElement(editingElement) {
        editingElement.dataset.nothing = 0; // force the refresh
        this.dispatchTo("content_manually_updated_handlers", editingElement);
        delete editingElement.dataset.nothing;
    }
}
