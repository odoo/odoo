...
PaymentForm.include({
    ...
    _updateAmount(ev) {
        if (ev.target.value >= 0) {
            ...
            // on second's dataset.
            this.el.querySelector(".o_payment_form").dataset.amount = ev.target.value;
    ...
    async _initiatePaymentFlow(providerCode, paymentOptionId, paymentMethodCode, flow) {
        if (document.querySelector('.o_donation_payment_form')) {
            ...
            const paymentFormFields = this.el.querySelector(".o_payment_form_field_container");
    ...
    _prepareTransactionRouteParams() {
        ...
        transactionRouteParams.amount = parseFloat(
            this.el.querySelector(".o_payment_form").dataset.amount
        );
