...
class WebsitePayment(http.Controller):
    ...
    def confirm(self, **kw):
        ...
        if tx_id:
            ...
            status = (tx.state == _('done') and _('success')) or _('danger')
            message = (tx.state == _('done') and _('Your payment was successful! It may take some time to be validated on our end.')) or _('Oops! There was a problem with your payment.')
