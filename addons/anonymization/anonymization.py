...
class ir_model_fields_anonymization(osv.osv):
    ...
    _columns = {
        ...
        'state': fields.selection(selection=FIELD_STATES, String='Status', size=12, required=True, readonly=True),
    }
...
class ir_model_fields_anonymization_history(osv.osv):
    ...
    _columns = {
        ...
        'state': fields.selection(selection=ANONYMIZATION_HISTORY_STATE, string='Status', size=12, required=True, readonly=True),
...
class ir_model_fields_anonymization_migration_fix(osv.osv):
    ...
    _columns = {
        ...
        'query_type': fields.selection(string='Query', selection=[('sql', 'sql'), ('python', 'python')], size=6),
