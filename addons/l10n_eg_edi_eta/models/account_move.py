...
class AccountMove(models.Model):
    ...
    def _compute_eta_qr_code_str(self):
        for move in self:
            if move.l10n_eg_uuid and move.l10n_eg_long_id and move.l10n_eg_edi_api_mode != 'demo':
                ...
                move.l10n_eg_qr_code = client.get_invoice_url(move.l10n_eg_uuid, move.l10n_eg_long_id)
            else:
    ...
    def _action_get_eta_invoice_pdf(self):
    ...
    def _generate_l10n_eg_edi_json(self, is_demo=False):
        ...
        eta_invoice = {
            ...
            'documentType': self._get_l10n_eg_eta_document_type(),
    ...
    def _l10n_eg_get_eta_invoice_pdf(self, access_token):
        ...
        pdf_content = client.get_invoice_pdf(
