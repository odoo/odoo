...
class TestEdiJson(TestEGEdiCommon):
                        ...
                        'invoiceLines': [
                            {
                                ...
                                'unitValue': {
                                    'currencySold': 'AED',
                                    'amountEGP': 610.7,
                                    'currencyExchangeRate': 5.04757,
                                    'amountSold': 120.99,
                                },
                                'discount': {'rate': 10.0, 'amount': 61.07},
                                'taxableItems': [{'taxType': 'T1', 'amount': 0.0, 'subType': 'V003', 'rate': 0.0}],
                                'salesTotal': 610.7,
                                'netTotal': 549.63,
                                'total': 549.63,
                            },
                            {
                                ...
                                'unitValue': {
                                    'currencySold': 'AED',
                                    'amountEGP': 5045.24368,
                                    'currencyExchangeRate': 5.04757,
                                    'amountSold': 999.55,
                                },
                                'discount': {'rate': 13.0, 'amount': 3279.40839},
                                'taxableItems': [{'taxType': 'T1', 'amount': 0.0, 'subType': 'V003', 'rate': 0.0}],
                                'salesTotal': 25226.21839,
                                'netTotal': 21946.81,
                                'total': 21946.81,
                            },
                        ],
                        'taxTotals': [{'taxType': 'T1', 'amount': 0.0}],
                        'totalDiscountAmount': 3340.47839,
                        'totalSalesAmount': 25836.91839,
                        'netAmount': 22496.44,
                        ...
                        'invoiceLines': [
                            {
                                ...
                                'unitValue': {
                                    'currencySold': 'AED',
                                    'amountEGP': 504.74444,
                                    'currencyExchangeRate': 5.04744,
                                    'amountSold': 100.0,
                                },
                                'discount': {'rate': 10.0, 'amount': 50.47444},
                                'taxableItems': [{'taxType': 'T1', 'amount': 0.0, 'subType': 'V003', 'rate': 0.0}],
                                'salesTotal': 504.74444,
                                'netTotal': 454.27,
                                'total': 454.27,
                            },
                            {
                                ...
                                'discount': {'rate': 13.0, 'amount': 329.23621},
                                'taxableItems': [{'taxType': 'T1', 'amount': 0.0, 'subType': 'V003', 'rate': 0.0}],
                                'salesTotal': 2532.58621,
                                'netTotal': 2203.35,
                                'total': 2203.35,
                            },
                        ],
                        'taxTotals': [{'taxType': 'T1', 'amount': 0.0}],
                        'totalDiscountAmount': 379.71065,
                        'totalSalesAmount': 3037.33065,
                        'netAmount': 2657.62,
                        'totalAmount': 2657.62,
                    },
                    'response': ETA_TEST_RESPONSE,
    ...
    def test_8_test_serialization_function(self):
        with freeze_time(self.frozen_today), patch(
            ...
            self.assertEqual(serialized_string, '"ISSUER""ADDRESS""COUNTRY""EG""GOVERNATE""Cairo""REGIONCITY""Iswan""STREET""12th dec. street""BUILDINGNUMBER""10""POSTALCODE""""BRANCHID""0""NAME""branch partner""TYPE""B""ID""456789123""RECEIVER""ADDRESS""COUNTRY""EG""GOVERNATE""Cairo""REGIONCITY""Iswan""STREET""12th dec. street""BUILDINGNUMBER""12""POSTALCODE""""NAME""عميل 1""TYPE""B""ID""123456789""DOCUMENTTYPE""i""DOCUMENTTYPEVERSION""1.0""DATETIMEISSUED""2022-03-15T00:00:00Z""TAXPAYERACTIVITYCODE""8121""INTERNALID""INV/2022/00001""INVOICELINES""INVOICELINES""DESCRIPTION""product_a""ITEMTYPE""GS1""ITEMCODE""1KGS1TEST""UNITTYPE""C62""QUANTITY""1.0""INTERNALCODE""""VALUEDIFFERENCE""0.0""TOTALTAXABLEFEES""0.0""ITEMSDISCOUNT""0.0""UNITVALUE""CURRENCYSOLD""AED""AMOUNTEGP""504.74444""CURRENCYEXCHANGERATE""5.04744""AMOUNTSOLD""100.0""DISCOUNT""RATE""10.0""AMOUNT""50.47444""TAXABLEITEMS""TAXABLEITEMS""TAXTYPE""T1""AMOUNT""0.0""SUBTYPE""V003""RATE""0.0""SALESTOTAL""504.74444""NETTOTAL""454.27""TOTAL""454.27""INVOICELINES""DESCRIPTION""product_b""ITEMTYPE""EGS""ITEMCODE""EG-EGS-TEST""UNITTYPE""CMT""QUANTITY""5.0""INTERNALCODE""""VALUEDIFFERENCE""0.0""TOTALTAXABLEFEES""0.0""ITEMSDISCOUNT""0.0""UNITVALUE""CURRENCYSOLD""AED""AMOUNTEGP""506.51724""CURRENCYEXCHANGERATE""5.04744""AMOUNTSOLD""100.35""DISCOUNT""RATE""13.0""AMOUNT""329.23621""TAXABLEITEMS""TAXABLEITEMS""TAXTYPE""T1""AMOUNT""0.0""SUBTYPE""V003""RATE""0.0""SALESTOTAL""2532.58621""NETTOTAL""2203.35""TOTAL""2203.35""TAXTOTALS""TAXTOTALS""TAXTYPE""T1""AMOUNT""0.0""TOTALDISCOUNTAMOUNT""379.71065""TOTALSALESAMOUNT""3037.33065""NETAMOUNT""2657.62""TOTALAMOUNT""2657.62""EXTRADISCOUNTAMOUNT""0.0""TOTALITEMSDISCOUNTAMOUNT""0.0""SIGNATURES""SIGNATURES""1""1"')
