    ...
    */
    extract_aggregates: function(node) {
        ...
        if(ftype == "many2many" && "context" in node.attrs) {
          this.m2m_context[this.fields_view.fields[node.attrs.name].relation] = node.attrs.context;
        }
    },
    ...
    */
    postprocess_m2m_tags: function() {
       ...
       _.each(relations, function(rel, rel_name) {
            var dataset = new instance.web.DataSetSearch(self, rel_name, self.dataset.get_context(self.m2m_context[rel_name]));
