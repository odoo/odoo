...
class HrLeave(models.Model):
    ...
    def _get_fr_date_from_to(self, date_from, date_to):
        ...
        if self.leave_type_request_unit == 'half_day' and self.request_date_to_period == 'am':
        ...
        if not resource_calendar:
            ...
            for company, leaves in fr_leaves_by_company.items():
                ...
                for leave in leaves:
                    ...
                    legal_days = 0.0
                    is_half_day_start = leave.leave_type_request_unit == 'half_day' and (
                    ...
                    is_half_day_end = (
                            leave.leave_type_request_unit == 'half_day' and leave.request_date_to_period == 'am'
