...
class purchase_config_settings(osv.osv_memory):
    ...
    _columns = {
        ...
        'group_purchase_pricelist':fields.boolean("Manage pricelist per vendor",
        ...
        'module_warning': fields.boolean("Alerts by products or vendor",
            help='Allow to configure notification on products and trigger them when a user wants to purchase a given product or a given vendor.\n'
