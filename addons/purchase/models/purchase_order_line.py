...
class PurchaseOrderLine(models.Model):
    ...
    def _compute_price_unit_product_uom(self):
        for line in self:
            line.price_unit_product_uom = not line.display_type and not line.is_downpayment and line.product_uom_id and line.product_uom_id._compute_price(line.price_unit, line.product_id.uom_id)
