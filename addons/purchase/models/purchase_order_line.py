...
class PurchaseOrderLine(models.Model):
        ...
        for line in self:
            ...
            if not seller:
                ...
                if not unavailable_seller and line.price_unit and line.product_uom == line._origin.product_uom:
                    ...
                    continue
                po_line_uom = line.product_uom or line.product_id.uom_id
                ...
                line.price_unit = (seller.product_uom or line.product_id.uom_id)._compute_price(price_unit, line.product_uom)
    ...
    def _prepare_purchase_order_line(self, product_id, product_qty, product_uom, company_id, supplier, po):
        ...
        return {
            ...
            'product_uom': seller.product_uom.id or product_id.uom_id.id,
