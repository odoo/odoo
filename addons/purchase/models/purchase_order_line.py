    ...
    def _compute_amount(self):
        ...
        for line in self:
            if line.display_type:
                ...
                document_values = AccountTax._create_document_from_po(line.order_id, with_lines=False)
                document_values['lines'].append(AccountTax._prepare_document_line_from_po_line(line))
