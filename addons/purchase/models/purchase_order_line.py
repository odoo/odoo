...
class PurchaseOrderLine(models.Model):
    ...
    def _compute_allowed_uom_ids(self):
        for line in self:
            ...
            line.allowed_uom_ids = line.product_id._get_available_uoms() | line.product_id.uom_ids | seller_uom
    ...
    def _compute_price_unit_and_date_planned_and_name(self):
        for line in self:
            ...
            if not line.selected_seller_id:
                ...
                line._reset_price_unit(line.selected_seller_id.uom_id._compute_price(price_unit, line.uom_id))
