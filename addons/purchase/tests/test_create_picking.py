...
class TestCreatePicking(common.TestProductCommon):
    ...
    def test_01_check_double_validation(self):
        ...
        # change quantity or unit prise to make untaxed amount > 5000(company required for double validation)
        self.po.order_line.write({'product_qty': 11.0})
        self.assertEqual(self.po.state, 'to approve', 'PO state should be "to approve"')
