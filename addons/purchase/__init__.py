...
def _migrate_email_templates_to_body_view(env):
    ...
    template_view_mapping = [
        ('purchase.email_template_edi_purchase', 'purchase.email_body_edi_purchase'),
        ('purchase.email_template_edi_purchase_done', 'purchase.email_body_edi_purchase_done'),
        ('purchase.email_template_edi_purchase_reminder', 'purchase.email_body_edi_purchase_reminder'),
    ]
