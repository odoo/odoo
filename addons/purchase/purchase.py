...
from openerp.tools.float_utils import float_compare as compare
    ...
    def onchange_product_id(self, cr, uid, ids, pricelist_id, product_id, qty, uom_id,
        ...
        for supplier in product.seller_ids:
            if partner_id and (supplier.name.id == partner_id):
                ...
                if compare(min_qty , qty, precision_digits=precision) == 1: # If the supplier quantity is greater than entered from user, set minimal.
                    if qty:
