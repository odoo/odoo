...
class purchase_order(osv.osv):
    ...
    _columns = {
        ...
        'date_order':fields.date('Ordered Date', required=True, states={'confirmed':[('readonly',True)], 'approved':[('readonly',True)]}, select=True, help="Date on which this document has been created."),
