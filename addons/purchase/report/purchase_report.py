        ...
        cr.execute("""
            create or replace view purchase_report as (
                ...
                select
                    ...
                    count(*) as nbr,
                    sum(l.price_unit*COALESCE(cr.rate, 1)*l.product_qty)::decimal(16,2) as price_total,
                    avg(100.0 * (l.price_unit*COALESCE(cr.rate, 1)*l.product_qty) / NULLIF(ip.value_float*l.product_qty/u.factor*u2.factor, 0.0))::decimal(16,2) as negociation,
                    sum(ip.value_float*l.product_qty/u.factor*u2.factor)::decimal(16,2) as price_standard,
                    (sum(l.product_qty*COALESCE(cr.rate, 1)*l.price_unit)/NULLIF(sum(l.product_qty/u.factor*u2.factor),0.0))::decimal(16,2) as price_average,
