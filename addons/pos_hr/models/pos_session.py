...
class PosSession(models.Model):
    ...
    def _aggregate_payments_amounts_by_employee(self, payments):
        ...
        for employee, payments in payments.grouped('cashier_id').items():
    ...
    def _aggregate_moves_by_employee(self):
        moves_per_employee = {}
        for employee, moves in self.sudo().statement_line_ids.grouped('cashier_id').items():
    ...
    def _prepare_account_bank_statement_line_vals(self, session, sign, amount, reason, extras):
        ...
        vals['cashier_id'] = extras['cashier_id']
        return vals
