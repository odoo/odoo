        ...
        if subcontract_move_id:
            ...
            for ml in move_lines:
                ...
                if float_compare(new_quantity_done, ml.reserved_uom_qty, precision_rounding=rounding) >= 0:
                    ...
                    # Need to recompute the move state manually otherwise it will remain as 'partially_available',
                    # as it won't be recomputed in the stock.move.line create(), as all subcontracted moves bypass reservation.
                    ml.move_id._recompute_state()
