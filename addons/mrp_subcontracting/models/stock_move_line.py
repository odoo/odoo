...
class StockMoveLine(models.Model):
    ...
    def _onchange_serial_number(self):
        ...
        if res and not self.lot_name and current_location_id == self.env.company.subcontracting_location_id:
    ...
    def write(self, vals):
        for move_line in self:
            if vals.get('lot_id') and move_line.move_id.is_subcontract and move_line.location_id == self.env.company.subcontracting_location_id:
