...
class MrpBom(models.Model):
    ...
    def _bom_subcontract_find (self, product_tmpl=None, product=None, picking_type=None, company_id=False, bom_type=False, subcontractor=False):
        ...
        if domain is False:
            return domain
        if subcontractor:
            domain += [('subcontractor_ids', 'in', subcontractor.id)]
        else:
