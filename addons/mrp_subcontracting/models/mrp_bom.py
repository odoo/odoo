...
class MrpBom(models.Model):
    ...
    def _bom_subcontract_find(self, product, picking_type=None, company_ids=False, bom_type='subcontract', subcontractor=False):
        domain = self._bom_find_domain(product, picking_type=picking_type, company_ids=company_ids, bom_type=bom_type)
        if subcontractor:
