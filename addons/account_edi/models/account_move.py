...
class AccountMove(models.Model):
    ...
    def button_force_cancel(self):
        ...
        for move in self:
            ...
            move.message_post(body=_("This invoice was cancelled while the EDIs %s still had a pending cancellation request.", ", ".join(to_cancel_edi_documents.mapped('edi_format_id.name'))))
        self.button_cancel()
