...
class HrEmployee(models.Model):
    ...
    has_subscribed_courses = fields.Boolean(compute='_compute_courses_completion_text', groups="hr.group_hr_responsible,base.group_system")
    courses_completion_text = fields.Char(compute="_compute_courses_completion_text", groups="hr.group_hr_responsible")
