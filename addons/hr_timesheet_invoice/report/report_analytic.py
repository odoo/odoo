...
class report_account_analytic_line_to_invoice(osv.osv):
    ...
    _columns = {
        ...
        'sale_price': fields.float('Sale price', readonly=True, digits_compute=dp.get_precision('Price')),
        'amount': fields.float('Amount', readonly=True, digits_compute=dp.get_precision('Amount')),
