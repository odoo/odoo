...
class AccountJournal(models.Model):
    ...
    def _get_l10n_es_sii_pending_domain(self):
        return [
            *self.env['account.move']._check_company_domain(self.env.companies),
            ...
            ('date', '>=', fields.Date.context_today(self.with_context(tz='Europe/Madrid')) - timedelta(days=10)),
            ('state', '=', 'posted'),
            ('move_type', '!=', 'entry'),
    ...
    def _compute_l10n_es_sii_pending_count(self):
        sii_journals = self.filtered(lambda journal: (
    ...
    def action_l10n_es_sii_open_pending(self):
        ...
        return {
            ...
            'name': self.env._("To Send to SII"),
