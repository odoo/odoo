...
class TestResequenceSII(TestEsEdiCommon):
    ...
    def setUpClass(cls):
        ...
        cls.customer_invoice_2 = cls._create_invoice(
            invoice_date="2019-05-15", date="2019-05-15", invoice_line_ids=[{}]
        )
        cls.customer_invoice_1 = cls._create_invoice(
            invoice_date="2019-05-01", date="2019-05-01", invoice_line_ids=[{}]
        )
        cls.vendor_invoice_2 = cls._create_invoice(
        ...
        cls.vendor_invoice_1 = cls._create_invoice(
