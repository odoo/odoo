...
class MrpSubcontractingPurchaseTest(TestMrpSubcontractingCommon):
    ...
    def test_subcontracting_resupply_price_diff(self):
        ...
        self.product_category.property_cost_method = 'standard'
        ...
        self.product_category.property_account_creditor_price_difference_categ = stock_price_diff_acc_id
    ...
    def test_subcontract_product_price_change(self):
        ...
        self.product_category.property_stock_account_input_categ_id = in_account
        self.product_category.property_stock_account_output_categ_id = out_account
        self.product_category.property_stock_account_production_cost_id = production_cost_account
        self.product_category.property_stock_valuation_account_id = valu_account
        stock_in_acc_id = self.product_category.property_stock_account_input_categ_id.id
