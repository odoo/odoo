...
class TestCompute(common.TransactionCase):
    ...
    def test_automation_form_view(self):
        ...
        self.assertEqual(automation_form.trigger_field_ids.ids, [state_field_id])
        self.assertEqual(automation_form.filter_domain, "[('state', '=', 'pending')]")
        automation = automation_form.save()
        self.assertEqual(automation.filter_pre_domain, False)
        ...
        self.assertEqual(automation_form.trigger_field_ids.ids, [priority_field_id])
        self.assertEqual(automation_form.filter_domain, "[('priority', '=', '2')]")
        automation = automation_form.save()
        self.assertEqual(automation.filter_pre_domain, False)
        ...
        self.assertEqual(automation_form.filter_domain, f"[('stage_id', '=', {new_lead_stage.id})]")
        self.assertEqual(automation_form.trigger_field_ids.ids, [stage_field_id])
        automation = automation_form.save()
        self.assertEqual(automation.filter_pre_domain, False)
        ...
        self.assertEqual(automation_form.filter_domain, "[('user_id', '!=', False)]")
        automation = automation_form.save()
        self.assertEqual(automation.filter_pre_domain, False)
        ...
        self.assertEqual(automation_form.filter_domain, "[('active', '=', False)]")
        automation = automation_form.save()
        self.assertEqual(automation.filter_pre_domain, False)
        ...
        self.assertEqual(automation_form.filter_domain, "[('active', '=', True)]")
        automation = automation_form.save()
        self.assertEqual(automation.filter_pre_domain, False)
        ...
        self.assertEqual(automation_form.filter_domain, f"[('tag_ids', 'in', [{a_lead_tag.id}])]")
        self.assertEqual(automation_form.trigger_field_ids.ids, [
    ...
    def test_automation_form_view_2(self):
        ...
        automation_form.filter_domain = "[('priority', '=', True), ('employee', '=', False)]"
        automation = automation_form.save()
        self.assertEqual(automation.filter_pre_domain, False)
    ...
    def test_automation_form_view_time_triggers(self):
        ...
        self.assertEqual(automation.filter_pre_domain, False)
        self.assertEqual(automation.filter_domain, "[('employee', '=', False)]")
