...
patch(PaymentScreen.prototype, {
    toggleIsToInvoice() {
        ...
        const has_intracom_taxes = orderLines.some(line=>line.tax_ids?.some(tax=>this.pos.intracom_tax_ids.includes(tax.id)));
        if(this.currentOrder.is_to_invoice() && this.pos.company.country_id?.code === "BE" && has_origin_order && has_intracom_taxes){
