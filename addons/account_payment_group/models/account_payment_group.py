...
class AccountPaymentGroup(models.Model):
    ...
    to_pay_amount = fields.Monetary(
        ...
        string='To Pay Amount', readonly=True, states={'draft': [('readonly', False)]}, track_visibility='always')
    ...
    currency_id = fields.Many2one(
        'res.currency', string='Currency', required=True, track_visibility='always',
