...
import { SpacingOption } from "../options/SpacingOption";
import { AddElementOption } from "../options/AddElementOption";
...
export class LayoutTool extends Component {
    static template = "html_builder.LayoutTool";
