declare module "plugins" {
    ...
    import { builder_header_middle_buttons, builder_options, BuilderOptionsShared, change_current_options_containers_handlers, clone_disabled_reason_providers, container_title, elements_to_options_title_components, options_container_top_buttons_providers, has_overlay_options, keep_overlay_options_predicates, no_parent_containers, on_restore_containers_handlers, remove_disabled_reason_providers } from "@html_builder/core/builder_options_plugin";
    ...
    import { dropzone_selectors, DropZoneShared, filter_for_sibling_dropzone_predicates } from "@html_builder/core/drop_zone_plugin";
    ...
    import { empty_node_predicates, is_unremovable_selectors, on_removed_handlers, on_will_remove_handlers, RemoveShared } from "@html_builder/core/remove_plugin";
    import { after_save_handlers, before_save_handlers, dirty_els_providers, save_element_handlers, save_elements_overrides, save_handlers, SaveShared } from "@html_builder/core/save_plugin";
    ...
    import { target_hide_handlers, target_show_handlers, VisibilityShared } from "@html_builder/core/visibility_plugin";
    import { default_shape_handlers, image_shape_groups_providers, post_compute_shape_handlers } from "@html_builder/plugins/image/image_shape_option_plugin";
    ...
    import { lower_panel_entries, on_mobile_preview_clicked_handlers, trigger_dom_updated_handlers } from "@html_builder/builder";
    ...
    export interface BuilderResourcesList {
        ...
        change_current_options_containers_handlers: change_current_options_containers_handlers;
        ...
        post_compute_shape_handlers: post_compute_shape_handlers;
        ...
        target_hide_handlers: target_hide_handlers;
        target_show_handlers: target_show_handlers;
        trigger_dom_updated_handlers: trigger_dom_updated_handlers;
