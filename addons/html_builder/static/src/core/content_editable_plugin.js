...
class ContentEditable extends Plugin {
    ...
    resources = {
        ...
        force_not_editable_selector: ["section:has(> .o_container_small,> .container,> .container-fluid)"],
        force_editable_selector: [".o_container_small",".container",".container-fluid"],
    };
