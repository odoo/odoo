...
export class BorderConfiguratorPlugin extends Plugin {
    static id = "borderConfigurator";
...
registry.category("builder-plugins").add(BorderConfiguratorPlugin.id, BorderConfiguratorPlugin);
