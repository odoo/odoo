...
export class AddSnippetDialog extends Component {
    ...
    /**
     * Retrieves the color-scheme cookie and injects it into the iframe's <head> and add a custom class.
     * This is necessary to allow the dark mode to be handled correctly across browsers.
     */
    insertColorScheme() {
        ...
        iframeDocument.body.style.setProperty("color-scheme", colorScheme);
