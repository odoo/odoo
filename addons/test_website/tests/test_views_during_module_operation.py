...
def test_02_copy_ids_views_unlink_on_module_update(env):
    ...
    def _simulate_xml_view():
        # Simulate a theme.ir.qweb inside theme_default XML files
        ...
        theme_child_view = ThemeView.create({
            ...
            'arch': '''
                <div position="inside">
                    <p>, and I am inherited by a theme.ir.qweb</p>
                </div>
            ''',
            'key': key,
        })
        ...
        # Simulate the theme.ir.qweb being installed on website 1 and 2
        View.create([
            theme_child_view._convert_to_base_model(website_1),
            theme_child_view._convert_to_base_model(website_2),
        ])

        # Ensure views are correctly setup: the theme.ir.qweb should have been
        # copied to an ir.qweb for website 1
    ...
    # Ensure the theme.ir.qweb got removed (since there is an IMD but not
