    ...
    def init(self, cr):
        ...
        cr.execute("""
            create or replace view report_intrastat as (
                select
                    to_char(inv.invoice_date, 'YYYY') as name,
                ...
                group by to_char(inv.invoice_date, 'YYYY'), to_char(inv.invoice_date, 'MM'),intrastat.id,inv.type,pt.intrastat_id, inv_country.code,inv.number,  inv.currency_id
            )""")
