...
export class PurchaseSuggestCatalogKanbanController extends ProductCatalogKanbanController {
    ...
    /**
     * Removes inOrderFilter from domain key in passed context, preventing issues
     * due to model / UI desynchronisation ("Remove" button takes a product out of PO, but
     * it stays in Kanban). Quickfix assumes filters are always & in domains. (removing a domain like
     * done below would brake on an OR).
