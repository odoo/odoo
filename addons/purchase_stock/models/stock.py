...
class StockWarehouseOrderpoint(models.Model):
    ...
    def _inverse_partner_id(self):
        orderpoints_without_route = self.filtered(lambda orderpoint: not orderpoint.route_id and orderpoint.partner_id)
        if orderpoints_without_route:
            orderpoints_without_route.route_id = self._get_default_route(force_action="buy")
    ...
    def _get_default_supplier(self):
        ...
        if self.show_partner and self.product_id:
            ...
            if self.replenishment_uom_id and self.replenishment_uom_id != self.uom_id:
                qty_to_order = self.uom_id._compute_quantity(self.qty_to_order, self.replenishment_uom_id)
