...
class ProductProduct(models.Model):
    ...
    def _get_quantity_in_progress(self, location_ids=False, warehouse_ids=False):
        ...
        pols = self.env['purchase.order.line'].sudo().search(domain)
        for line in pols:
            ...
            product_qty = line.product_uom._compute_quantity(line.product_qty, line.product_id.uom_id, round=False)
