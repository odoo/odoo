...
class StockMove(models.Model):
    ...
    def _get_upstream_documents_and_responsibles(self, visited):
        created_pl = self.sudo().created_purchase_line_ids.filtered(lambda cpl: cpl.state != 'cancel' and (cpl.state != 'draft' or self.env.context.get('include_draft_documents')))
        if created_pl:
