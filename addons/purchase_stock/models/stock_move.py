    ...
    def _compute_description_picking(self):
        ...
        for move in self:
            if move.purchase_line_id:
                ...
                vendor_reference = f'[{seller.product_code}]' if seller.product_code and seller.product_code not in current_description else ''
                vendor_reference += f' {seller.product_name}' if seller.product_name and seller.product_name not in current_description else ''
