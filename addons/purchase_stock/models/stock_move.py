...
class StockMove(models.Model):
    ...
    def _account_entry_move(self, qty, description, svl_id, cost):
        ...
        moves = self | returned_move
        prefetch_ids = chain(self._prefetch_ids, returned_move._prefetch_ids)
        pdiff_exists = bool(moves.with_prefetch(prefetch_ids).stock_valuation_layer_ids.stock_valuation_layer_ids.account_move_line_id)
    ...
    def _get_related_invoices(self):
        ...
        rslt += self.picking_id.purchase_ids.invoice_ids.filtered(lambda x: x.state == 'posted')
        return rslt
