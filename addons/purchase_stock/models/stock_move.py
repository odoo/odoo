...
class StockMove(models.Model):
    ...
    def _get_upstream_documents_and_responsibles(self, visited):
        created_pl = self.sudo().created_purchase_line_ids.filtered(
        ...
        elif self.sudo().purchase_line_id and self.sudo().purchase_line_id.state != 'cancel':
            return[(self.sudo().purchase_line_id.order_id, self.sudo().purchase_line_id.order_id.user_id, visited)]
        else:
