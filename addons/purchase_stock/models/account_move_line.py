...
class AccountMoveLine(models.Model):
    ...
    def _generate_price_difference_vals(self, layers):
        ...
        for layer in layers:
            ...
            aml_price_unit = aml.currency_id._convert(aml_gross_price_unit, aml.company_id.currency_id, aml.company_id, aml.move_id.invoice_date or fields.Date.context_today(self), round=False)
            ...
            unit_valuation_difference_curr = self.company_id.currency_id._convert(unit_valuation_difference, self.currency_id, self.company_id, self.move_id.invoice_date or fields.Date.context_today(self), round=False)
            ...
            po_pu_curr = po_line.currency_id._convert(po_line.price_unit, self.currency_id, self.company_id, self.move_id.invoice_date or fields.Date.context_today(self), round=False)
