    ...
    def _run_buy(self, procurements):
        ...
        for procurement, rule in procurements:
            ...
            if procurement.values.get('supplierinfo_id'):
                ...
                supplier = procurement.product_id.with_company(rule.company_id.id)._select_seller(
            ...
            supplier = supplier or procurement.product_id._prepare_sellers(False).filtered(
                lambda s: not s.company_id or s.company_id == rule.company_id
            )[:1]
            ...
            domain = rule._make_po_get_domain(rule.company_id, procurement.values, partner)
