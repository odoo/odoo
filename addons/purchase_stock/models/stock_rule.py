...
class StockRule(models.Model):
    ...
    def _run_buy(self, procurements):
        ...
        for domain, procurements_rules in procurements_by_po_domain.items():
            ...
            po_lines_by_product = {}
            grouped_po_lines = groupby(po.order_line.filtered(lambda l: not l.display_type and l.product_uom == l.product_id.uom_id), key=lambda l: l.product_id.id)
    ...
    def _update_purchase_order_line(self, product_id, product_qty, product_uom, company_id, values, line):
        ...
        uom = values['supplier'].product_uom or values['supplier'].product_id.uom_id
