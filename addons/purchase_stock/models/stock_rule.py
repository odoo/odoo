...
class StockRule(models.Model):
    ...
    def _update_purchase_order_line(self, product_id, product_qty, product_uom, company_id, values, line):
        ...
        price_unit = self.env['account.tax']._fix_tax_included_price_company(seller.price, line.product_id.supplier_tax_ids, line.sudo().tax_ids, company_id) if seller else 0.0
