...
from .product import ProductProduct, ProductSupplierinfo, ProductCategory, ProductTemplate
...
from .stock import StockWarehouseOrderpoint, StockLot, StockPicking, ProcurementGroup, StockReturnPicking, StockWarehouse
