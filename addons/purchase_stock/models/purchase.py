...
class PurchaseOrderLine(models.Model):
    ...
    def write(self, values):
        ...
        if 'product_qty' in values:
            lines = lines.filtered(lambda l: not l.display_type and float_compare(previous_product_qty[l.id], l.product_qty, precision_rounding=l.product_uom.rounding) != 0)
