...
class PurchaseOrderLine(models.Model):
    ...
    def _find_candidate(self, product_id, product_qty, product_uom, location_id, name, origin, company_id, values):
        ...
        be created.
        """
        lines = self.filtered(lambda l: l.propagate_date == values.get('propagate_date', False) and l.propagate_date_minimum_delta == values.get('propagate_date_minimum_delta', 0))
