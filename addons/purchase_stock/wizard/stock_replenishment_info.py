...
class StockReplenishmentInfo(models.TransientModel, stock.StockReplenishmentInfo):
...
class StockReplenishmentOption(models.TransientModel, stock.StockReplenishmentOption):
