...
class PurchaseOrderSuggest(models.TransientModel):
    ...
    deduce_forecast_quantity = fields.Boolean(
        "Consider Forecast Stock", default=True,
        help="If your forecast stock is positive, this quantity will be deducted from what you will replenish for the days to cover. If your forecast stock is negative, this quantity will be replenished in addition to what you wish to cover.")
