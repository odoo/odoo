...
class TestPurchaseLeadTime(TestPurchase):
    ...
    def test_00_product_company_level_delays(self):
        ...
        order_date = date_planned - timedelta(days=company.po_lead) - timedelta(days=self.product_1.seller_ids.delay)
        ...
        po_schedule_date = schedule_date
    ...
    def test_01_product_level_delay(self):
        ...
        schedule_date_line_1 = schedule_date_1
        ...
        schedule_date_line_2 = schedule_date_2
    ...
    def test_02_product_route_level_delays(self):
        ...
        # Check order date of purchase order
        order_date = date_planned - timedelta(days=self.product_1.seller_ids.delay)
        po_order_date = order_date
        ...
        incoming_shipment1_schedule_date = incoming_shipment1_date
        ...
        incoming_shipment2_schedule_date = incoming_shipment2_date
