...
class TestStockValuationWithCOA(AccountTestInvoicingCommon):
    ...
    def test_fifo_anglosaxon_return(self):
        ...
        move_form.purchase_vendor_bill_id = self.env['purchase.bill.match'].browse(-po1.id)
    ...
    def test_anglosaxon_valuation_price_total_diff_discount(self):
        ...
        invoice_form.purchase_vendor_bill_id = self.env['purchase.bill.match'].browse(-order.id)
    ...
    def test_price_diff_with_partial_bills_and_delivered_qties(self):
        ...
        for qty,    new_svl_expected,       expected_valuations,    expected_expenses in [
            ...
            bill_form.purchase_vendor_bill_id = self.env['purchase.bill.match'].browse(-po.id)
            bill = bill_form.save()
            bill.invoice_line_ids.quantity = qty
    ...
    def test_partial_bills_and_reconciliation(self):
        ...
        bill01_form.purchase_vendor_bill_id = self.env['purchase.bill.match'].browse(-po.id)
        ...
        bill02_form.purchase_vendor_bill_id = self.env['purchase.bill.match'].browse(-po.id)
