...
class TestPurchaseOrder(ValuationReconciliationTestCommon):
    ...
    def setUpClass(cls):
        ...
        cls.product_id_1 = cls.env['product.product'].create({'name': 'Large Desk', 'bill_policy': 'ordered'})
        cls.product_id_2 = cls.env['product.product'].create({'name': 'Conference Chair', 'bill_policy': 'ordered'})
