...
class TestPurchaseOrder(ValuationReconciliationTestCommon):
    ...
    def test_po_edit_after_receive_2_steps_route(self):
        ...
        self.assertEqual(self.po.picking_ids.sorted('id').move_ids.mapped('product_uom_qty'), [1.0, 1.0, 1.0, 1.0, 4.0, 4.0])
        self.po.order_line[0].product_qty = 3
        self.assertEqual(self.po.picking_ids.sorted('id').move_ids.mapped('product_uom_qty'), [1.0, 1.0, 1.0, 1.0, 2.0, 4.0])
