...
class SaleReport(models.Model):
    ...
    def _fill_pos_fields(self, additional_fields):
        ...
        values['margin_percent'] = 'MAX(CASE COALESCE(l.price_subtotal, 0) WHEN 0 THEN 1.0 ELSE (l.price_subtotal - COALESCE(l.total_cost,0)) / (l.price_subtotal - COALESCE(l.total_cost,0)) END)'
