...
class HrTime(models.Model):
    ...
    def _get_durations(self, check_work_entry_type=True, resource_calendar=None, additional_domain=None):
        ...
        if not resource_calendar:
            ...
            duration_by_leave_id = super(HrTime, self - fr_leaves)._get_durations(check_work_entry_type=check_work_entry_type, resource_calendar=resource_calendar, additional_domain=additional_domain)
