...
class MrpProduction(models.Model):
    ...
    def action_view_sale_orders(self):
        self.ensure_one()
        sale_order_ids = self.procurement_group_id.mrp_production_ids.move_dest_ids.group_id.sale_id.ids + self.sale_line_id.order_id.ids + self.move_finished_ids.move_dest_ids.group_id.sale_id.ids
        action = {
