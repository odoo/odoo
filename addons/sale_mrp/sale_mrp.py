...
class mrp_production(osv.osv):
    ...
    def _sale_ref_search(self, cursor, user, obj, name, args, domain=None, context=None):
        if context is None:
            context = {}
        return []
    ...
    _columns = {
        ...
        'sale_ref': fields.function(_ref_calc, multi='sale_name', fnct_search=_sale_ref_search, type='char', string='Sale Reference', help='Indicate the Customer Reference from sales order.'),
    }
