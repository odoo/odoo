...
class TestSaleMrpFlow(TestSaleMrpFlowCommon):
    ...
    def test_products_availability_with_mto_manufactured_product_from_interwarehouse_transfer(self):
        """
        For MTO and manufactured products from a 3-step delivery warehouse (WH2) supplied by another 3-step delivery
        warehouse (WH1), confirmed SOs create 7 delivery orders and 1 MO. Delivery orders should have 2 OUT moves
