...
class TestSaleMrpProcurement(TransactionCase):
    ...
    def test_sale_mrp(self):
        ...
        product_template_slidermobile0.route_ids = [Command.link(warehouse0.mto_pull_id.route_id.id)]
    ...
    def test_sale_mrp_pickings(self):
        ...
        self.finished_product.route_ids = [Command.link(self.warehouse.mto_pull_id.route_id.id)]
        ...
        self.complex_product.route_ids = [Command.link(self.warehouse.mto_pull_id.route_id.id)]
