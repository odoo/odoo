        ...
        so = self.env['sale.order'].create({
            ...
            'order_line': [
                (0, 0, {
                    ...
                    'product_uom_qty': 1.0,
                    'uom_id': self.kit_product.uom_id.id,
                })],
        })
        so.action_confirm()
        line = so.order_line
