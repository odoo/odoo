...
class TestMultistepManufacturing(TestMrpCommon):
    ...
    def setUpClass(cls):
        ...
        cls.product_manu.route_ids = [Command.link(cls.warehouse.mto_pull_id.route_id.id)]
    ...
    def test_cancel_multilevel_manufacturing(self):
        ...
        with Form(self.product_raw) as p1:
            ...
            self.product_raw.route_ids = [Command.link(self.warehouse_1.mto_pull_id.route_id.id)]
