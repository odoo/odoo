...
class Survey(http.Controller):
    ...
    def _check_validity(self, survey_token, answer_token, ensure_token=True, check_partner=True):
        ...
        if ensure_token != 'allow_no_answer_token_mode':
        ...
        if ensure_token != 'allow_no_answer_token_mode' and (
    ...
    def survey_print(self, survey_token, review=False, answer_token=None, **post):
        ...
        access_data = self._get_access_data(survey_token, answer_token, ensure_token='allow_no_answer_token_mode', check_partner=False)
