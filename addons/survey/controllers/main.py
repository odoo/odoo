...
class Survey(http.Controller):
    ...
    def fetch_answer(self, survey_token, answer_token, survey_id=False):
    ...
    def _check_validity(self, survey_token, answer_token, ensure_token=True, check_partner=True, survey_id=False):
        ...
        """
        survey_sudo, answer_sudo = self.fetch_answer(survey_token, answer_token, survey_id=survey_id)
        ...
        if error_key == 'survey_void' and access_data['can_answer']:
            ...
            if not answer_sudo:  # survey is not even started
                ...
                if answer_sudo.partner_id and (answer_sudo.partner_id.user_ids or survey_sudo.users_can_signup):
                    ...
                    redirect_url = f'/web/login?redirect=/survey/start/{survey_sudo.id}/{survey_sudo.access_token}?answer_token={answer_sudo.access_token}'
    ...
    @http.route([
                '/survey/test/<int:survey_id>/<string:survey_token>',
    ...
    def survey_test(self, survey_token, survey_id=False, **kwargs):
        ...
        survey_sudo, __ = self.fetch_answer(survey_token, False, survey_id)
        try:
