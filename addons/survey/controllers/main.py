...
class Survey(http.Controller):
    ...
    def _prepare_survey_data(self, survey_sudo, answer_sudo, **post):
        ...
        data = {
            ...
            'survey': survey_sudo,
            'answer': answer_sudo,
            'skipped_questions': answer_sudo._get_skipped_mandatory_questions(),
            'breadcrumb_pages': [{
                'id': page.id,
                'title': page.title,
    ...
    def _prepare_question_html(self, survey_sudo, answer_sudo, **post):
        ...
        return {
            'has_skipped_questions': any(answer_sudo._get_skipped_mandatory_questions()),
    ...
    def survey_submit(self, survey_token, answer_token, **post):
        ...
        if answer_sudo.survey_time_limit_reached or survey_sudo.questions_layout == 'one_page':
            ...
            if not answer_sudo.is_session_answer:
                ...
                if not next_page:
                    if survey_sudo.users_can_go_back and answer_sudo._get_skipped_mandatory_questions():
                        answer_sudo.write({
