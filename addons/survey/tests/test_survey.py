...
class TestSurveyInternals(common.TestSurveyCommon, MailCase):
    ...
    def test_survey_user_input_most_answered_tag_id(self):
        ...
        for user_input, most_answered_tag_id in zip(user_inputs, results):
            self.assertEqual(user_input.most_answered_tag_id, most_answered_tag_id)
