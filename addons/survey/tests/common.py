...
class SurveyCase(common.SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.survey_manager = survey_new_test_user(
        ...
        cls.survey_user = survey_new_test_user(
