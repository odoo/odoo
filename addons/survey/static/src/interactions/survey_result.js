...
class SurveyResult extends Interaction {
     ...
     */
    onFilterAddAnswerClick(event) {
        const params = new URLSearchParams(window.location.search);
        params.set("filters", this.prepareAnswersFilters(params.get("filters"), "add", event));
     ...
     */
    onFilterRemoveAnswerClick(event) {
        const params = new URLSearchParams(window.location.search);
        const filters = this.prepareAnswersFilters(params.get("filters"), "remove", event);
        if (filters) {
     ...
     */
    prepareAnswersFilters(filters, operation, event) {
        const cellDataset = event.currentTarget.dataset;
