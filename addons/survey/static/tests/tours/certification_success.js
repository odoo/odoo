...
registry.category("web_tour.tours").add("test_certification_success", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger:
                'div.o_survey_question:contains("Do we sell Acoustic Bloc Screens") label:contains("Yes")',
            run: "click",
        },
        {
            ...
            trigger:
                'div.o_survey_question:contains("Select all the existing products") label:contains("Chair floor protection")',
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger:
                'div.o_survey_question:contains("Select all the available customizations for our Customizable Desk") label:contains("Legs")',
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger:
                'div.o_survey_question:contains("Select all the products that sell for $100 or more") label:contains("Large Desk")',
            run: "click",
        },
        {
            ...
            trigger:
                'div.o_survey_question:contains("What do you think about our prices") label:contains("Underpriced")',
            run: "click",
        },
        {
