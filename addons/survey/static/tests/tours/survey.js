...
const survey_steps = (checkPageTranslation) => [
    // Page-1
    {
        ...
        trigger: 'div.o_survey_question:contains("How frequently do you buy products online") label:contains("Once a month")',
        run: "click",
    }, {
    ...
    ...(checkPageTranslation ? checkPageTranslation : []),
    {
        ...
        trigger: 'div.o_survey_question:contains("What do your think about our new eCommerce") tr:contains("The new layout and design is fresh and up-to-date") td:eq(1) label',
        run: "click",
    }, {
        content: 'Answer What do your think about our new eCommerce (It is easy to find the product that I want)',
        trigger: 'div.o_survey_question:contains("What do your think about our new eCommerce") tr:contains("It is easy to find the product that I want") td:eq(2) label',
        run: "click",
    }, {
        content: 'Answer What do your think about our new eCommerce (The tool to compare the products is useful to make a choice)',
        trigger: 'div.o_survey_question:contains("What do your think about our new eCommerce") tr:contains("The tool to compare the products is useful to make a choice") td:eq(3) label',
        run: "click",
    }, {
        content: 'Answer What do your think about our new eCommerce (The checkout process is clear and secure)',
        trigger: 'div.o_survey_question:contains("What do your think about our new eCommerce") tr:contains("The checkout process is clear and secure") td:eq(2) label',
        run: "click",
    }, {
        content: 'Answer What do your think about our new eCommerce (I have added products to my wishlist)',
        trigger: 'div.o_survey_question:contains("What do your think about our new eCommerce") tr:contains("I have added products to my wishlist") td:last label',
        run: "click",
    }, {
            ...
            ...survey_steps([
                {
                    ...
                    trigger: ".o_survey_question h2:contains('FR: ')",
                },
            ]),
        ];
    },
