...
class TestEventWebsiteTrack(OnlineEventCase):
    ...
    def test_create_menu(self):
        ...
        self._assert_website_menus(event, ['Home', 'Rooms', 'Practical'], menus_out=['Talks'])
    ...
    def test_menu_management_frontend(self):
        ...
        home_menu.unlink()
        self._assert_website_menus(event, ['Talks', 'Rooms', 'Practical'], menus_out=['Home'])
        ...
        self._assert_website_menus(event, ['Practical', 'Rooms'], menus_out=['Home', 'Talks'])

        event.write({'website_track': True})
        self.assertTrue(event.website_track)
        self.assertTrue(event.website_track_proposal)
        self._assert_website_menus(event, ['Practical', 'Rooms', 'Talks'], menus_out=['Home'])
