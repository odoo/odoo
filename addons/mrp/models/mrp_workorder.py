    ...
    def _plan_workorders(self, from_date=False, alternative=True):
        ...
        for wo in workorders_to_plan:
            ...
            if self.env.context.get('consider_blocked_by', True):
                wo.blocked_by_workorder_ids.filtered(lambda wo: wo.id not in done_wo and not wo.is_planned)._plan_workorders(from_date=from_date, alternative=alternative)
