...
class MrpBom(models.Model):
    ...
    batch_size = fields.Float('Batch Size', default=1.0, digits='Product Unit', help="All automatically generated manufacturing orders for this product will be of that size.")
