...
class MrpBom(models.Model):
    ...
    def _simulate_planning(self, product, start_date, quantity, simulated_leaves_per_workcenter=False):
        ...
        if self.allow_operation_dependencies:
            final_operations = self.operation_ids.filtered(lambda o: not o.needed_by_operation_ids)
