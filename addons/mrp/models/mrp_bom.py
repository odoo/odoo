...
class MrpBom(models.Model):
    ...
    def explode(self, product, quantity, picking_type=False):
        ...
        bom_prefetch_product_ids = set(self.bom_line_ids.product_id.ids)
        ...
        while bom_lines:
            ...
            bom = current_line.product_id.with_prefetch(bom_prefetch_product_ids).with_context(picking_type=picking_type, company_id=self.company_id.id, bom_type='phantom').current_bom_id
            if bom:
                ...
                bom_prefetch_product_ids |= set(bom.bom_line_ids.product_id.ids)
                for bom_line in bom.bom_line_ids:
    ...
    def _compute_child_bom_id(self):
        for line in self:
            if not line.product_id:
                ...
                line.child_bom_id = line.product_id.current_bom_id
