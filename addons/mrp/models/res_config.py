...
class MrpConfigSettings(models.TransientModel):
    ...
    module_mrp_repair = fields.Boolean(string='Manage repairs of products',
    ...
    module_mrp_operations = fields.Boolean(string='Allow detailed planning of work order',
            help='This allows to add state, date_start,date_stop in production order operation lines (in the "Work Centers" tab).\n'
                 '-This installs the module mrp_operations.')
    module_mrp_byproduct = fields.Boolean(string='Produce several products from one manufacturing order',
            help='You can configure by-products in the bill of material.\n'
                 'Without this module: A + B + C -> D.\n'
                 'With this module: A + B + C -> D + E.\n'
                 '-This installs the module mrp_byproduct.')
    group_mrp_routings = fields.Boolean(string='Manage Work Order Operations and work orders',
    ...
    group_mrp_properties = fields.Boolean(string='Allow several bill of materials per products using properties',
    ...
    group_rounding_efficiency = fields.Boolean(string='Manage rounding and efficiency of BoM components',
