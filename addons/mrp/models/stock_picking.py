...
class StockPicking(models.Model):
    ...
    def _compute_mrp_production_ids(self):
        for picking in self:
            picking.production_ids |= (picking.move_ids.move_dest_ids.raw_material_production_id.filtered(lambda p: p.picking_type_id.active) | picking.move_ids.move_orig_ids.production_id.filtered(lambda p: p.picking_type_id.active))
