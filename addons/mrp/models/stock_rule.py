...
class StockRule(models.Model):
    ...
    def _prepare_mo_vals(self, product_id, product_qty, product_uom, location_dest_id, name, origin, company_id, values, bom):
        ...
        mo_values = {
            ...
            'location_src_id': bom.picking_type_id.default_location_src_id.id or self.picking_type_id.default_location_src_id.id,
            'location_dest_id': bom.picking_type_id.default_location_dest_id.id or self.picking_type_id.default_location_dest_id.id or location_dest_id.id,
            ...
            'picking_type_id': bom.picking_type_id.id or self.picking_type_id.id or values['warehouse_id'].manu_type_id.id,
