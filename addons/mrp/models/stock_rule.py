...
class StockRule(models.Model):
    ...
    draft_production = fields.Boolean(
        "Draft Production",
    ...
    def _run_manufacture(self, procurements):
        ...
        for procurement, rule in procurements:
            ...
            if not mo or is_batch_size:
                ...
                procurement.values['draft_production'] = rule.draft_production
        ...
        for company_id in new_productions_values_by_company:
            ...
            mo_procurements = new_productions_values_by_company[company_id]['procurements']
            ...
            for mo, procurement in zip(productions, mo_procurements):
                if not procurement.values.get('draft_production') and self._should_auto_confirm_procurement_mo(mo):
                    mo.action_confirm()
            productions._post_run_manufacture(mo_procurements)
        return True
