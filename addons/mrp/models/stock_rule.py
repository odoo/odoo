...
class StockRule(models.Model):
    ...
    def _get_matching_bom(self, product_id, company_id, values):
        ...
        if bom and (bom.product_id and bom.product_id == product_id or product_id in bom.byproduct_ids.product_id or not bom.product_id and bom.product_tmpl_id == product_id.product_tmpl_id):
            return bom
