...
class MrpProduction(models.Model):
    ...
    def _compute_mrp_production_child_count(self):
        for production in self:
            ...
            production.mrp_production_child_count = len(moves.created_production_id + moves.move_orig_ids.created_production_id - production)
    ...
    def action_view_mrp_production_childs(self):
        ...
        mrp_production_ids = (moves.created_production_id + moves.move_orig_ids.created_production_id - self).ids
        action = {
