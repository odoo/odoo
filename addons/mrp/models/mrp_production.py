    ...
    def _compute_picking_ids(self):
        ...
        for order in self:
            ...
            if order.warehouse_id.manufacture_steps in ['pbm_sam', 'pbm']:
                # We need to use `picking.production_ids` because if MO or picking cancels, we can't decide from which MO picking is created.
                ...
                order.picking_ids = [Command.unlink(picking.id) for picking in (order.picking_ids - filtered_picking_ids)]
