...
class MrpProduction(models.Model):
    ...
    def _compute_scrap_move_count(self):
        scrapped_finished_data = self.env['stock.move']._read_group([('production_id', 'in', self.ids), ('scrapped', '=', True)], ['production_id'], ['__count'])
        scrapped_component_data = self.env['stock.move']._read_group([('raw_material_production_id', 'in', self.ids), ('scrapped', '=', True)], ['raw_material_production_id'], ['__count'])
    ...
    def button_scrap(self):
        ...
        return {
            ...
            'context': {
                ...
                'default_location_dest_id': self.env['stock.location'].search([('scrap_location', '=', True), ('company_id', '=', self.company_id.id)], limit=1).id,
            },
            'target': 'new',
        }
