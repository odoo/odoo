...
class MrpProduction(models.Model):
    ...
    def button_scrap(self):
        ...
        return {
            ...
            'context': {
                ...
                'default_location_dest_id': self.env['stock.location'].search([('usage', '=', 'inventory'), ('company_id', '=', self.company_id.id)], limit=1).id,
            },
            'target': 'new',
        }
    ...
    def action_see_move_scrap(self):
        ...
        return {
            ...
            'view_mode': 'list,form',
            'domain': [('production_id', '=', self.id), ('is_scrap', '=', True)],
