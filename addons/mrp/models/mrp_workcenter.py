...
class MrpWorkcenter(models.Model):
    ...
    def _compute_oee(self):
        for order in self:
            ...
            if time_data.get('productive', 0) != 0:
                productive_time = time_data['productive']
                blocked_time = sum(duration for loss_type, duration in time_data.items() if loss_type != 'productive')
