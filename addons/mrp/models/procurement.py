...
class ProcurementOrder(models.Model):
    ...
    def _prepare_mo_vals(self, procurement):
        ...
        if procurement.bom_id:
            ...
            properties = [x.id for x in procurement.property_ids]
            bom_id = BomObj.with_context(dict(force_company=procurement.company_id.id))._bom_find(product_id=procurement.product_id.id, properties=properties)
            bom = BomObj.browse(bom_id)
