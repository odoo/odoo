...
registry.category("web_tour.tours").add('test_manufacturing_sm_to_sml_synchronization', {
    test: true,
    steps: () => [
...
registry.category("web_tour.tours").add('test_by_product_sm_to_sml_synchronization', {
    test: true,
    steps: () => [
        { trigger: ".btn-primary[name=action_confirm]" },
