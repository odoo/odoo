...
export class MoOverviewOperationsBlock extends Component {
    ...
    setup() {
        ...
        useBus(this.env.overviewBus, "toggle-fold-all-mo", () => this._toggleFoldMo());
    }
    ...
    _toggleFoldMo() {
        const currentState = this.state.isFolded;
        this.state.isFolded = !currentState;
        this.env.overviewBus.trigger("update-folded", { indexes: [this.index], isFolded: !currentState })
    }
