...
It supports complete integration and planning of stockable goods, consumables or services. Services are completely integrated with the rest of the software. For instance, you can set up a sub-contracting service in a bill of materials to automatically purchase on order the assembly of your production.
...
* Allows to browse bill of materials in complete structure that include child and phantom bill of materials
