...
class TestMrpProductionBackorder(TestMrpCommon):
    ...
    def test_backorder_name_with_multiple_backorder(self):
        ...
        self.assertEqual(len(mo.production_group_id.mrp_production_ids), 2)
        mo_2 = mo.production_group_id.mrp_production_ids[1]
        ...
        backorder = Form(self.env['mrp.production.backorder'].with_context(**action['context']))
        backorder.save().action_backorder()
        backorder_mo1 = mo.production_group_id.mrp_production_ids[-1]
        ...
        backorder = Form(self.env['mrp.production.backorder'].with_context(**action['context']))
        backorder.save().action_backorder()
        backorder_mo2 = mo_2.production_group_id.mrp_production_ids[-1]
