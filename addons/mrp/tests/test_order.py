...
class TestMrpOrder(TestMrpCommon):
    ...
    def test_replan_mo_after_updating_bom(self):
        ...
        # Initial planning: Cutting Machine at 8:00 (90 minutes), then Weld Machine at 9:30.
        self.assertEqual(mo.workorder_ids[0].date_start, datetime(2025, 10, 1, 8, 0))
        self.assertEqual(mo.workorder_ids[1].date_start, datetime(2025, 10, 1, 9, 30))
        ...
        # New planning: Cutting Machine at 8:00 (40 minutes for two quantities), then Weld Machine should start at 8:40.
        self.assertEqual(mo.workorder_ids[0].date_start, datetime(2025, 10, 1, 8, 0))
        self.assertEqual(mo.workorder_ids[1].date_start, datetime(2025, 10, 1, 8, 40))
