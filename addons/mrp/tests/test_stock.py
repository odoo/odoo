...
class TestWarehouseMrp(common.TestMrpCommon):
    ...
    def test_manufacturing_scrap(self):
        ...
        self.assertTrue(scrap_move_line_id.move_id.raw_material_production_id)
        self.assertEqual(scrap_move_line_id.location_dest_id.usage, 'inventory')
        self.assertTrue(scrap_move_line_id.is_scrap)
        self.assertEqual(scrap_move_line_id.move_id.price_unit, scrap_move_line_id.product_id.standard_price)
...
class TestKitPicking(common.TestMrpCommon):
    ...
    def _test_scrap_kit_not_available(self, storable):
        ...
        scrap = Form.from_action(self.env, scrap.action_scrap()).save().action_done()

        self.assertEqual(scrap.state, 'done')
        self.assertRecordValues(scrap, [
