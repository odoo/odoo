...
class mrp_bom(osv.osv):
    ...
    _columns = {
        ...
        'product_tmpl_id': fields.many2one('product.template', 'Product', domain="[('product_type', 'in', ['product', 'consu'])]", required=True),
...
class mrp_production(osv.osv):
    ...
    def _calculate_qty(self, cr, uid, production, product_qty=0.0, context=None):
        ...
        for scheduled in production.product_lines:
            if scheduled.product_id.product_type not in ['product', 'consu']:
                continue
