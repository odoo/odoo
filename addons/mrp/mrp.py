...
class mrp_property(osv.osv):
    ...
    _columns = {
        ...
        'composition': fields.selection([('min','min'),('max','max'),('plus','plus')], 'Properties composition', size=4, required=True, help="Not used in computations, for information purpose only."),
...
class mrp_production(osv.osv):
    ...
    _columns = {
        ...
        'priority': fields.selection([('0', 'Not urgent'), ('1', 'Normal'), ('2', 'Urgent'), ('3', 'Very Urgent')], 'Priority',
            size=1, select=True, readonly=True, states=dict.fromkeys(['draft', 'confirmed'], [('readonly', False)])),
        ...
        'state': fields.selection(
            ...
            string='Status', size=13, readonly=True,
