...
class MrpProductionSplit(models.TransientModel):
    ...
    def default_get(self, fields):
        ...
        if self._context.get('default_production_id'):
            production = self.env['mrp.production'].browse(self._context.get('default_production_id'))
            res['max_batch_size'] = production.product_qty
        return res
