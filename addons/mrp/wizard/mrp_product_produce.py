...
class MrpProductProduce(models.TransientModel):
    ...
    def _get_track(self):
        ...
        return prod and self.env['product.product'].browse(prod).tracking or False
    ...
    def on_change_qty(self, product_qty, consume_lines):
        ...
        new_consume_lines = []
        if product_qty > 0.0:
            product_uom_qty = self.env['product.uom']._compute_qty(production.product_uom.id, product_qty, production.product_id.uom_id.id)
