...
class ChangeProductionQty(models.TransientModel):
    ...
    def _need_quantity_propagation(self, move, qty):
        return move.move_dest_ids and not float_is_zero(qty, precision_digits=self.env['decimal.precision'].precision_get('Product Unit of Measure'))
    ...
    def change_prod_qty(self):
        ...
        for wizard in self:
            ...
            if not float_is_zero(production.qty_producing, precision_digits=self.env['decimal.precision'].precision_get('Product Unit of Measure')) and\
