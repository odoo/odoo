...
from odoo.tools import float_compare, float_is_zero, float_repr, float_round, format_date, get_lang
...
class ReportMrpReport_Mo_Overview(models.AbstractModel):
    ...
    def _get_comparison_decorator(self, expected, current, digits=2):
        """Return 'danger' when a current component quantity or operation duration
