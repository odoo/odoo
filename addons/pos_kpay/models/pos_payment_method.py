...
class PosPaymentMethod(models.Model):
    ...
    kpay_terminal_endpoint = fields.Char('KPay Terminal Endpoint', copy=False)
    ...
    def _load_pos_data_fields(self, config_id):
        ...
        params += ['kpay_terminal_endpoint', 'kpay_app_id', 'kpay_app_secret', 'kpay_payment_type']
        return params
    ...
    def _is_write_forbidden(self, fields):
        return super(PosPaymentMethod, self)._is_write_forbidden(fields - {'kpay_latest_response', 'kpay_public_key'})
