...
class AccountMoveSend(models.AbstractModel):
    ...
    @api.model
    def _is_nav_30_applicable(self, move):
    ...
    def _get_default_extra_edi_checkboxes(self, move):
        ...
        if self._is_nav_30_applicable(move):
            extra_edi['hu_nav_30'] = {'checked': True, 'readonly': False, 'label': _('NAV 3.0')}
        return extra_edi
    ...
    def _get_alerts(self, moves, moves_data):
        ...
        hu_moves = moves.filtered(lambda m: moves_data[m]['extra_edi'] == 'hu_nav_30')
    ...
    def _call_web_service_before_invoice_pdf_render(self, invoices_data):
        ...
        invoices_hu = self.env['account.move'].browse([
            ...
            if 'hu_nav_30' in invoice_data['extra_edi']
