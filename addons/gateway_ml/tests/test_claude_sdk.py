...
from odoo.addons.gateway_ml.tools.claude_sdk import (
    _resolve_work_dir,
    get_claude_api_token,
)
...
class TestClaudeCredentialLookup(EncryptionKeyCase, TransactionCase):
    ...
    def test_the_service_record_exists(self):
        self.assertTrue(self.service, "gateway_ml must seed the claude service")
...
class TestResolveWorkDir(TransactionCase):
    ...
    def test_the_new_parameter_wins_over_the_legacy_one(self):
        ...
        params.set_param("gateway_ml.claude_workdir", str(self.base / "current"))
        resolved = _resolve_work_dir(self.env, "mod")
...
class TestClaudeSDKClientRuntime(TransactionCase):
    def _client(self):
        from odoo.addons.gateway_ml.tools.claude_sdk import ClaudeSDKClient
    ...
    def test_the_default_model_is_the_providers(self):
        from odoo.addons.gateway_ml.tools.claude_sdk import _default_model
