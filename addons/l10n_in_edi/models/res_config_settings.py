...
class ResConfigSettings(models.TransientModel):
    ...
    l10n_in_edi_username = fields.Char("Indian EDI username", related="company_id.l10n_in_edi_username", related_inverse=True)
    l10n_in_edi_password = fields.Char("Indian EDI password", related="company_id.l10n_in_edi_password", related_inverse=True)
