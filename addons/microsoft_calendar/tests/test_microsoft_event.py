...
class TestMicrosoftEvent(TestCommon):
    ...
    def test_forbid_edit_outlook_recurring_event_by_non_synced_user(self):
        """
        Test that users without Microsoft sync cannot edit recurring events
        that were created from Outlook (have microsoft_recurrence_master_id).
        """
        ...
        # User without Microsoft sync trying to edit
