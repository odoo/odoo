...
class hr_applicant_settings(osv.osv_memory):
    ...
    _columns = {
        'module_document_ftp': fields.boolean('Allow the automatic indexation of resumes',
            ...
            This installs the module document_ftp. This will install the knowledge management 
            module in order to allow you to search using specific keywords through the content of all documents (PDF, .DOCx...)"""),
