...
class hr_recruitment_report(osv.Model):
    ...
    _columns = {
        ...
        'salary_prop' : fields.float("Salary Proposed", digits_compute=dp.get_precision('Amount')),
        'salary_prop_avg' : fields.float("Avg. Proposed Salary", group_operator="avg", digits_compute=dp.get_precision('Amount')),
        'salary_exp' : fields.float("Salary Expected", digits_compute=dp.get_precision('Amount')),
        'salary_exp_avg' : fields.float("Avg. Expected Salary", group_operator="avg", digits_compute=dp.get_precision('Amount')),
