...
class Job(models.Model):
    ...
    def _get_default_description(self):
        return self.env['ir.qweb']._render('hr_recruitment.default_description', raise_if_not_found=False)

    @mute_logger('odoo.addons.base.models.ir_qweb')
    def _get_default_website_description(self):
        return self.env['ir.qweb']._render("hr_recruitment.default_website_description", raise_if_not_found=False)
    ...
    def get_backend_menu_id(self):
        return self.env.ref('menu_hr_recruitment_root').id
