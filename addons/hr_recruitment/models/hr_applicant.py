...
class HrApplicant(models.Model):
    ...
    def create(self, vals_list):
        for vals in vals_list:
            ...
            if skills:
                vals['applicant_skill_ids'] = skills + vals.get('applicant_skill_ids', [])
    ...
    def write(self, vals):
        ...
        if 'stage_id' in vals or 'current_applicant_skill_ids' in vals or 'applicant_skill_ids' in vals:
            if 'stage_id' in vals:
                vals['date_last_stage_update'] = fields.Datetime.now()
                if 'kanban_state' not in vals:
                    vals['kanban_state'] = 'normal'
            elif 'current_applicant_skill_ids' in vals or 'applicant_skill_ids' in vals:
...
""") % {
    ...
    def _get_employee_create_vals(self):
        ...
        return {
            ...
            'employee_skill_ids': employee_skills_vals,
        }
