...
class HrEmployee(models.Model):
    ...
    def create(self, vals):
        ...
        if new_employee.job_id:
            new_employee.job_id.write({'no_of_hired_employee': new_employee.job_id.no_of_hired_employee + 1})
            new_employee.job_id.message_post(
                body=_('New Employee %s Hired', new_employee.name),
