...
<p>%(para_1)s<br/>%(para_2)s</p>""") % {
    ...
    def create_employee_from_applicant(self):
        ...
        employee_data = {
            ...
            'private_street': address_id.street,
            'private_street2': address_id.street2,
            'private_city': address_id.city,
            'private_state_id': address_id.state_id.id,
            'private_zip': address_id.zip,
            'private_country_id': address_id.country_id,
            'private_email': address_id.email,
            'private_lang': address_id.lang,
            'private_phone': address_id.phone,
