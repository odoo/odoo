    ...
    def _get_stat_buttons(self):
        ...
        if self.user_has_groups('mrp.group_mrp_user'):
            buttons.extend([{
                ...
                'show': self.user_has_groups('mrp.group_mrp_user') and self.production_count > 0,
                'sequence': 19,
            },
            {
                'icon': 'cog',
                ...
                'show': self.user_has_groups('mrp.group_mrp_user') and self.workorder_count > 0,
                'sequence': 20,
            },
            {
                'icon': 'flask',
                ...
                'show': self.user_has_groups('mrp.group_mrp_user') and self.bom_count > 0,
                'sequence': 21,
            }])
        return buttons
