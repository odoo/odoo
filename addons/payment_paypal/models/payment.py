...
class AcquirerPaypal(models.Model):
    ...
    paypal_email_account = fields.Char('Paypal Email ID', required_if_provider='paypal', groups='base.group_system')
    paypal_seller_account = fields.Char(
        'Paypal Merchant ID', groups='base.group_system',
        help='The Merchant ID is used to ensure communications coming from Paypal are valid and secured.')
    paypal_use_ipn = fields.Boolean('Use IPN', default=True, help='Paypal Instant Payment Notification', groups='base.group_system')
    paypal_pdt_token = fields.Char(string='Paypal PDT Token', help='Payment Data Transfer allows you to receive notification of successful payments as they are made.', groups='base.group_system')
    # Server 2 server
    paypal_api_enabled = fields.Boolean('Use Rest API', default=False)
    paypal_api_username = fields.Char('Rest API Username', groups='base.group_system')
    paypal_api_password = fields.Char('Rest API Password', groups='base.group_system')
    paypal_api_access_token = fields.Char('Access Token', groups='base.group_system')
    paypal_api_access_token_validity = fields.Datetime('Access Token Validity', groups='base.group_system')
    # Default paypal fees
