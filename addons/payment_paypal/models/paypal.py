...
class AcquirerPaypal(osv.Model):
    ...
    def _get_paypal_urls(self, cr, uid, environment, context=None):
        ...
        if environment == 'prod':
            return {
                ...
                'paypal_rest_url': 'https://api.paypal.com',
            }
        else:
            return {
                'paypal_form_url': 'https://www.sandbox.paypal.com/cgi-bin/webscr',
                'paypal_rest_url': 'https://api.sandbox.paypal.com',
            }
    ...
    _columns = {
        ...
        'paypal_client_id': fields.char('PayPal Client ID', help='Unique client identifier obtained through the application registration process.'),
        'paypal_client_secret': fields.char('PayPal Client Secret', help='Unique client secret obtained through the application registration process.'),
    }
