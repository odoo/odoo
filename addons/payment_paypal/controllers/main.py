...
class PaypalController(http.Controller):
    ...
    def paypal_return_from_canceled_checkout(self, return_access_token, tx_ref):
        ...
        :param str return_access_token: The access token to verify the authenticity of the request.
                                        PayPal forbids any parameter with the name "access_token".
        """
        _logger.info(
        ...
        if not payment_utils.check_access_token(return_access_token, tx_ref):
            raise Forbidden()
