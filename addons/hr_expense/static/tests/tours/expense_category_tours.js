...
registry.category("web_tour.tours").add("change_expense_category_price_tour", {
    ...
    steps: () => [
        ...
        {
            content: "Open the category A",
            trigger: ".o_data_row .o_data_cell[data-tooltip='Category A']",
            run: "click",
        },
        {
        ...
        {
            content: "Open the category B",
            trigger: ".o_data_row .o_data_cell[data-tooltip='Category B']",
            run: "click",
        },
        {
        ...
        {
            content: "Open the category C",
            trigger: ".o_data_row .o_data_cell[data-tooltip='Category C']",
            run: "click",
        },
        {
