...
class HrExpensePostWizard(models.TransientModel):
    ...
    def _compute_payment_mode(self):
        ...
        self.is_company_paid = expenses.filtered(lambda expense: expense.payment_mode == 'company_account')
        self.is_employee_paid = expenses.filtered(lambda expense: expense.payment_mode == 'own_account')
    ...
    def action_post_entry(self):
        ...
        expense_bill_vals_list = [
            ...
            for new_bill_vals in employee_paid_expenses._prepare_bills_vals()
        ]
