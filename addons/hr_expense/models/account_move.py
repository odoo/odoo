...
class AccountMove(models.Model):
    ...
    def _creation_message(self):
        if self.expense_ids:
            return _("Expense entry created from %(name)s: (link)s", name=self.expense_ids.name, link=self.expense_ids._get_html_link())
    ...
    def _reverse_moves(self, default_values_list=None, cancel=False):
        ...
        own_expense_moves.write({'expense_ids': [Command.clear()], 'ref': False})
    ...
    def button_cancel(self):
        ...
        self.write({'expense_ids': [Command.clear()], 'ref': False})
        return res
