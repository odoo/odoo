...
class HrExpense(models.Model):
    ...
    accounting_date = fields.Date(  # The date used for the accounting entries or the one we'd like to use if not yet posted
        ...
        store=True,
        groups='account.group_account_invoice,account.group_account_readonly,hr_expense.group_hr_expense_team_approver',
    ...
    def _compute_state(self):
        ...
        Compute the states of the expense as such (priority is given to the last matching state of the list):
            ...
            - in_payment: When the move state is 'posted' and it's 'payment_state' is 'in_payment' or 'partial, and there is a residual amount
