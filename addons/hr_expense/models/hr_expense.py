...
class HrExpenseSheet(models.Model):
    ...
    journal_id = fields.Many2one('account.journal', string='Expense Journal', domain="[('type', '=', 'purchase')]", states={'done': [('readonly', True)], 'post': [('readonly', True)]}, default=_default_journal_id, help="The journal used when the expense is done.")
