...
class TestExpenses(TestExpenseCommon):
    ...
    def test_expense_main_flow(self):
        ...
        self.assertRecordValues(all_expenses.account_move_id.line_ids.sorted(lambda line: (line.move_id, line)), [
            ...
            {'balance': -1600.00, 'account_id': default_account_payable_id, 'name': 'Employee PA 2*800 + 15%',                   'date': date(2021, 10, 31), 'invoice_date': date(2021, 10, 10)},
            ...
            {'balance':  -160.00, 'account_id': default_account_payable_id, 'name': 'Employee PB 160 + 2*15%',                   'date': date(2021, 10, 31), 'invoice_date': date(2021, 10, 31)},
