...
class TestExpenses(TestExpenseCommon):
    ...
    def test_expense_main_flow(self):
        ...
        self.assertRecordValues(all_expenses, [
            ...
            {'payment_mode': 'company_account', 'state': 'posted', 'payment_state': 'paid',     'accounting_date': False},
            {'payment_mode': 'company_account', 'state': 'posted', 'payment_state': 'paid',     'accounting_date': False},
        ])
        ...
        self.assertRecordValues(expenses_by_employee, [{'payment_state': 'partial', 'state': 'posted'}] * 2)
        ...
        self.assertRecordValues(expenses_by_employee, [{'payment_state': in_payment_state, 'state': 'posted'}] * 2)
        ...
        self.assertRecordValues(expenses_by_employee, [{'payment_state': 'paid', 'state': 'posted'}] * 2)
