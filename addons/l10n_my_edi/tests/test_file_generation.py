...
class L10nMyEDITestFileGeneration(AccountTestInvoicingCommon):
    ...
    def test_13_prepaid_amount_present(self):
        ...
        # as a regular payable amount instead, see test_16), to be reported as a genuine prepayment.
        invoice = self.init_invoice('out_invoice', invoice_date='2024-07-20', currency=self.other_currency, products=self.product_a)
        invoice.action_post()
    ...
    def test_15_prepaid_amount_same_day_payment(self):
    ...
    def test_16_prepaid_amount_late_payment(self):
    ...
    def test_17_prepaid_amount_true_partial_deposit(self):
    ...
    def test_18_prepaid_amount_full_advance_payment_override(self):
    ...
    def test_19_prepaid_amount_foreign_currency_true_partial_deposit(self):
        """ Same as test_17, but the invoice is in a foreign currency; the prepaid amount must stay expressed
    ...
    def test_20_prepaid_amount_foreign_currency_full_advance_payment_override(self):
        """ Same as test_18, but the invoice is in a foreign currency. """
        foreign_currency = self.other_currency
        invoice = self._init_invoice_with_amount(
            'out_invoice', invoice_date='2017-10-10', amount=1000, currency=foreign_currency,
        )
    ...
    def test_21_prepaid_amount_excludes_exchange_difference(self):
    ...
    def test_22_prepaid_amount_excludes_cash_basis_moves(self):
    ...
    def test_23_prepaid_amount_excludes_credit_note(self):
