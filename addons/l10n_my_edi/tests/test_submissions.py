...
class L10nMyEDITestSubmission(TestAccountMoveSendCommon):
    ...
    def test_07_pending_submission(self):
        ...
        with patch(CONTACT_PROXY_METHOD, new=self._test_07_mock):
            ...
            # ... some time later, the cron runs. It has two functions: 1) fetch new incoming moves (not yet implemented) 2) Fetch status of existing moves
    ...
    def _test_07_mock(self, endpoint, params):
        ...
        elif endpoint == 'api/l10n_my_edi/1/search_invoices':
            return {
                'sent_invoices': {
                    '123458974513518': 'valid',
                },
                'received_invoices': {},
            }
        else:
