    ...
    * MyInvois API formats doc: https://sdk.myinvois.hasil.gov.my/documents
    ...
    def _add_myinvois_document_config_vals(self, vals):
        ...
        if document_type_code in ("11", "12", "13", "14"):
            supplier = customer
            customer = myinvois_document.company_id.partner_id.commercial_partner_id
            partner_shipping = customer
            document_ref = myinvois_document.invoice_ids.ref
        else:
            document_ref = None
    ...
    def _add_myinvois_document_tax_grouping_function_vals(self, vals):
        ...
        def tax_grouping_function(base_line, tax_data):
            ...
            if is_exempt_tax and myinvois_document.myinvois_exemption_reason:
                tax_exemption_reason = myinvois_document.myinvois_exemption_reason
            elif is_exempt_tax and tax.l10n_my_tax_exemption_reason:
