...
<label string="You may have selected the compare options with more than 1 years with credit/debit columns and % option.This can lead contents to be printed out of the paper.Please try again."/>
</form>'''
