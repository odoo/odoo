...
class TestAccountSubcontractingFlows(TestMrpSubcontractingCommon):
    def test_subcontracting_account_flow_1(self):
        ...
        stock_valu_acc_id = self.product_category.property_stock_valuation_account_id.id
        stock_cop_acc_id = self.product_category.property_stock_account_production_cost_id.id
