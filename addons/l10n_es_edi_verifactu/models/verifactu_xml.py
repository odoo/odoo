...
class L10nEsEdiVerifactuXml(models.AbstractModel):
    ...
    def _render_vals_operation(self, vals):
        ...
        if cancellation:
            ...
            # TODO: pass record_documents or record_identifiers directly
    ...
    def _render_vals_previous_submissions(self, vals):
        ...
        submission_rejected_before = vals.get('rejected_before', False)
    ...
    def _get_db_identifier(self):
        # TODO: or maybe hash the value to avoid leaking infos
        ...
        return str(self.env.cr.fetchall()[0][0])
    ...
    def _render_vals_SistemaInformatico(self, vals):
        ...
        render_vals = {
            'SistemaInformatico': {
                # TODO: 'NombreRazon', 'NIF' ⦓or idotro⦔
                'NombreRazon': 'Odoo',
                'NIF': 'A39200019',
                'NombreSistemaInformatico': odoo.release.product_name,
                'IdSistemaInformatico': '00',  # identifies odoo as product of Odoo the company
    ...
    def _fingerprint(self, render_values):
        ...
        if cancellation:
            ...
            string = "&".join([f"{field}={value.strip()}" for (field, value) in fingerprint_values])
        # TODO: check that the value we need exist ⇝ or error
    ...
    def _batch_record_xmls(self, xml_list):
        ...
        if errors:
            ...
            print(">> _batch_record_xmls")
            print(batch_xml.decode())
            print("<< _batch_record_xmls")
