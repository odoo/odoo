...
class Project(models.Model):
    ...
    def _get_domain_aal_with_no_move_line(self):
        ...
        return [('account_id', '=', self.analytic_account_id.id), '|', ('move_line_id', '=', False), ('move_line_id.move_type', 'in', ['entry', 'out_refund', 'out_receipt', 'in_receipt']), ('category', '!=', 'manufacturing_order')]
