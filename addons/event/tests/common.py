...
class EventCase(common.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.event_type_questions.question_ids += cls.event_question_1
        ...
        cls.event_type_questions.question_ids += cls.event_question_2

        cls.event_question_3 = cls.env['event.question'].create({
            'title': 'Question3',
            'question_type': 'text_box',
            'event_type_ids': cls.event_type_questions,
            'once_per_order': True,
        })
        cls.event_type_questions.question_ids += cls.event_question_3
