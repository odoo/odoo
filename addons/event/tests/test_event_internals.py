...
class TestEventData(TestEventInternalsCommon):
    ...
    def test_event_questions_update_from_type_change(self):
        ...
        event_type_1, event_type_2 = self.env['event.type'].create([{
            'name': 'Event Type 1',
            'question_ids': [
                Command.set((event_type_1_question + event_type_1_removed_question + event_type_common_question).ids)
            ]
        }, {
            'name': 'Event Type 2',
        ...
        self.assertEqual(
            sorted(event.question_ids.mapped('title')),
            ['Event Type 1 Question', 'Event Type 1 Removed Question', 'Event Type Common Question']
        )
        ...
        self.assertEqual(
            sorted(event.question_ids.mapped('title')),
            ['Event Type 1 Question', 'Event Type 2 Question', 'Event Type Common Question']
        )
