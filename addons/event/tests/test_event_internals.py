...
class TestEventData(TestEventInternalsCommon):
    ...
    def test_event_mail_default_config(self):
        ...
        self.assertEqual(event.event_mail_ids[1].interval_nbr, 3)
        self.assertEqual(event.event_mail_ids[1].interval_unit, 'days')
        ...
        self.assertEqual(event.event_mail_ids[2].interval_nbr, 1)
        self.assertEqual(event.event_mail_ids[2].interval_unit, 'hours')
