...
class TestMailScheduleInternals(EventMailCommon):
    ...
    def test_prevent_mail_schedulers(self):
        ...
        self.assertEqual(test_event.event_mail_ids[0].mail_state, 'running', 'Mail state should be running')
        self.assertEqual(test_event.event_mail_ids[1].mail_state, 'scheduled', 'Mail state should be scheduled')
