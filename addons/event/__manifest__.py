...
""",
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'event/static/src/template_reference_field/field_event_mail_template_many2one.js',
            'event/static/src/template_reference_field/field_event_mail_template_many2one.xml',
