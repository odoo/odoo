...
class EventEventTicket(models.Model):
    ...
    name = fields.Char(compute="_compute_name", store=True, readonly=False, recursive=True)
    ...
    @api.depends('parent_ticket_id', 'parent_ticket_id.name', 'slot_id', 'slot_id.name')
