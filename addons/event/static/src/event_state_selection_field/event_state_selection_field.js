...
export class EventStateSelection extends StateSelectionField {
    ...
    async updateRecord(value) {
        ...
        const message = _t("Are you sure you want to cancel this event? If published, the event will remain visible on your website with a cancellation banner. Don't forget to notify your registered attendees.");
