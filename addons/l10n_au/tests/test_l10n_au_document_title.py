...
class TestL10nAUDocumentTitle(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.sale_moves = (
            cls._create_invoice('out_invoice')
            | cls._create_invoice('out_refund')
        )
        cls.purchase_moves = (
            cls._create_invoice('in_invoice')
            | cls._create_invoice('in_refund')
        )
