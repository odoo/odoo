...
class L10nInHrTimeOptionalHoliday(models.Model):
    _name = 'l10n.in.hr.time.optional.holiday'
    ...
    def _unlink_except_optional_holidays(self):
        ...
        linked_leave_request = self.env["hr.time"].search_count(domain & dates_domain, limit=1)
