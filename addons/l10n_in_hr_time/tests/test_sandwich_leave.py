...
class TestSandwichLeave(TransactionCase):
    ...
    def setUp(self):
        ...
        self.demo_user = self.env["res.users"].with_company(self.indian_company).create({
            "login": "piyush",
            "name": "piyush_demo",
            "group_ids": [Command.link(self.env.ref("base.group_user").id), Command.link(self.env.ref("hr_time.group_hr_time_employee").id)],
        })
    ...
    def test_approved_leave_does_not_raise_access_error(self):
        ...
        """
        approved_leave = self.env['hr.time'].create({
        ...
        approved_leave_without_sl = self.env['hr.time'].create({
    ...
    def test_long_sandwich_leave(self):
        ...
        holiday_leave = self.env['hr.time'].create({
            'name': "Test Leave",
    ...
    def test_half_day_leave(self):
        half_leave = self.env['hr.time'].create({
            'name': "Half Day Leave",
            'employee_id': self.rahul_emp.id,
    ...
    def test_sandwich_leave_with_utc_full_day_public_holiday(self):
        ...
        before_holiday_leave = self.env['hr.time'].create({
        ...
        after_holiday_leave = self.env['hr.time'].create({
    ...
    def test_partial_hour_leave_not_counted(self):
        """
            ...
            -- non-working days: 25th, 26th January
        """
        partial_leave = self.env['hr.time'].create({
        ...
        full_leave = self.env['hr.time'].create({
    ...
    def test_bidirectional_sandwich_leave(self):
        ...
        before_leave = self.env['hr.time'].create({
        ...
        after_leave = self.env['hr.time'].create({
        ...
        middle_sandwich_leave = self.env['hr.time'].create({
            'name': 'Test Leave',
            'employee_id': self.rahul_emp.id,
            'work_entry_type_id': self.work_entry_type_day.id,
    ...
    def test_sandwich_leave_weekend_only_policy(self):
        ...
        weekend_sandwich_leave = self.env['hr.time'].create({
            'name': 'Test Leave',
            'employee_id': self.rahul_emp.id,
            'work_entry_type_id': self.work_entry_type_day.id,
    ...
    def test_sandwich_leave_public_holiday_only_policy(self):
        ...
        public_holiday_sandwich_leave = self.env['hr.time'].create({
            'name': 'Test Leave',
            'employee_id': self.rahul_emp.id,
            'work_entry_type_id': self.work_entry_type_day.id,
            'request_date_from': "2026-01-15",  # Thursday
    ...
    def test_sandwich_leave_reapprove(self):
        ...
        fri_mon_leave = self.env['hr.time'].create({
            'name': "Fri-Mon Leave",
            'employee_id': self.rahul_emp.id,
            'work_entry_type_id': self.work_entry_type_day.id,
        ...
        wed_leave = self.env['hr.time'].create({
