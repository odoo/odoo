...
registry.category("web_tour.tours").add("EWalletProgramTour1", {
    ...
    steps: () =>
        [
            ...
            PosLoyalty.checkOrderTotalIs("10.00"),
...
registry.category("web_tour.tours").add("EWalletProgramTour2", {
    ...
    steps: () =>
        [
            ...
            PosLoyalty.checkEWalletButtonState({ highlighted: false }),
            ProductScreen.clickPartnerButton(),
            ProductScreen.clickCustomer("AAAAAAA"),
            PosLoyalty.checkEWalletButtonState({ highlighted: true, text: getEWalletText("Pay") }),
            ...
            PosLoyalty.clickEWalletButton(getEWalletText("Pay")),
            PosLoyalty.checkEWalletButtonState({ highlighted: false }),
            PosLoyalty.checkOrderTotalIs("26.00"),
            ...
            ProductScreen.clickCustomer("BBBBBBB"),
            PosLoyalty.checkEWalletButtonState({ highlighted: false }),
            PosLoyalty.checkOrderTotalIs("38.00"),
            ProductScreen.clickPartnerButton(),
            ProductScreen.clickCustomer("AAAAAAA"),
            PosLoyalty.checkEWalletButtonState({ highlighted: true, text: getEWalletText("Pay") }),
            PosLoyalty.clickEWalletButton(getEWalletText("Pay")),
            ...
            PosLoyalty.checkOrderTotalIs("20.00"),
            ...
            PosLoyalty.checkEWalletButtonState({
                highlighted: true,
