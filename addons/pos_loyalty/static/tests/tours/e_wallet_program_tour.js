...
registry.category("web_tour.tours").add("EWalletProgramTour1", {
    ...
    steps: () =>
        [
            ...
            Dialog.confirm(),
            PartnerList.clickPartner("Partner One"),
...
registry.category("web_tour.tours").add("EWalletProgramTour2", {
    ...
    steps: () =>
        [
            ...
            ProductScreen.clickCustomer("Partner Two"),
            PosLoyalty.eWalletButtonState({ highlighted: false }),
            ProductScreen.addOrderline("Awesome Item", "6", "6", "36.00"),
            PosLoyalty.eWalletButtonState({
                highlighted: true,
                text: getEWalletText("Pay"),
                click: true,
            ...
            ProductScreen.clickPartnerButton(),
            ProductScreen.clickCustomer("Partner Two"),
            ProductScreen.addOrderline("Awesome Item", "2", "19", "38.00"),
            PosLoyalty.eWalletButtonState({ highlighted: false }),
            ProductScreen.clickPartnerButton(),
            ProductScreen.clickCustomer("Partner One"),
            PosLoyalty.eWalletButtonState({
            ...
            ProductScreen.clickPartnerButton(),
            ProductScreen.clickCustomer("Partner Two"),
            ProductScreen.addOrderline("Awesome Item", "1", "20", "20.00"),
