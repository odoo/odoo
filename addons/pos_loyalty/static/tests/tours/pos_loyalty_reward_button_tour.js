...
registry.category("web_tour.tours").add("PosLoyaltySpecificDiscountTour", {
    steps: () =>
        [
            ...
            ProductScreen.clickControlButton("Reward"),
            SelectionPopup.has("$ 10.00 on specific products", { run: "click" }),
            PosLoyalty.hasRewardLine("$ 10.00 on specific products", "-10.00", "1"),
            PosLoyalty.orderTotalIs("70.00"),
            ProductScreen.clickControlButton("Reward"),
            SelectionPopup.has("$ 10.00 on specific products", { run: "click" }),
            PosLoyalty.orderTotalIs("60.00"),
            ProductScreen.clickControlButton("Reward"),
            SelectionPopup.has("$ 30.00 on specific products", { run: "click" }),
            PosLoyalty.hasRewardLine("$ 30.00 on specific products", "-30.00", "1"),
