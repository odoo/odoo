...
registry.category("web_tour.tours").add("PosLoyaltySpecificDiscountWithRewardProductDomainTour", { test: true, url: "/pos/web", steps: getSteps() });
...
registry.category("web_tour.tours").add('PosLoyaltySpecificDiscountCategoryTour', { test: true, url: "/pos/web", steps: getSteps() });
