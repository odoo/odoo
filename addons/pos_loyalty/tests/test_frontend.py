...
class TestUi(TestPointOfSaleHttpCommon):
    ...
    def test_editable_gift_card_reward_line(self):
        ...
        self.start_pos_tour("PosLoyaltyEditableGiftCard")
        gift_card_order = self.env['pos.order'].search([], order='id desc', limit=1)
    ...
    def test_editable_ewallet_reward_line(self):
        ...
        self.start_pos_tour("PosLoyaltyEditableEWallet")
        ewallet_order = self.env['pos.order'].search([], order='id desc', limit=1)
