...
class PosOrder(models.Model):
    ...
    def confirm_coupon_programs(self, coupon_data):
        ...
        # Add log for newly created gift cards
        for gift_card in new_coupons.filtered(lambda c: c.program_type == 'gift_card'):
            self._add_log_for_gift_card(gift_card)
    ...
    def _add_log_for_gift_card(self, gift_card):
        body = Markup(
            """
