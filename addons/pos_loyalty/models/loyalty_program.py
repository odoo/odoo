...
class LoyaltyProgram(models.Model):
    ...
    def _load_pos_data_domain(self, data, config):
        return [('id', 'in', config.loyalty_program_ids.ids)]
    ...
    def _unrelevant_records(self, config):
        valid_record = config.loyalty_program_ids
    ...
    def _compute_total_order_count(self):
        ...
        for program in self:
            pos_orders = res.get(program.id) or 0
            program.total_order_count += pos_orders
