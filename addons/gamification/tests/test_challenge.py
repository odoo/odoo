...
class test_challenge(common.TransactionCase):
    ...
    def test_00_join_challenge(self):
        ...
        user_count = self.User.search_count([('groups_id', '=', self.group_user_id)])
    ...
    def test_10_reach_challenge(self):
        ...
        badge_user_count = self.BadgeUser.search_count([('badge_id', '=', self.badge_id), ('user_id', '=', self.demo_user.id)])
