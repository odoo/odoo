...
class Users(models.Model):
    ...
    @api.model
    def _get_users_by_tracking_karma_gain(self, user_domain, from_date=None, to_date=None, limit=30, offset=0):
...
FROM (
    ...
    ORDER BY karma_gain_total DESC, intermediate.user_id DESC
) final
LIMIT %%s OFFSET %%s""" % {
