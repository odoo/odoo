...
export class HtmlField extends Component {
    ...
    static props = {
        ...
        enableSignatureCommand: { type: Boolean, optional: true, default: false },
    };
    static defaultProps = {
        dynamicPlaceholder: false,
        enableSignatureCommand: false,
    };
    static components = {
        Wysiwyg,
        HtmlViewer,
    ...
    getConfig() {
        const config = {
            ...
            Plugins: [
                ...
                ...(this.props.enableSignatureCommand ? SIGNATURE_PLUGIN : []),
            ],
...
export const htmlField = {
    ...
    extractProps({ attrs, options }, dynamicInfo) {
        ...
        return {
            ...
            enableSignatureCommand: options.enableSignatureCommand,
        };
    },
};
