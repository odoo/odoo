...
/**
 * Remove all empty text nodes within the given root element and optionally
 * update cursors for later selection restore.
 *
 * This prevents the editor from keeping unnecessary empty text nodes
 * that may create extra nodes during formatting operations.
 *
