import { resourceSequenceSymbol } from "./resource";
...
export function resolveSequences(sequencedObjects) {
    ...
    for (const item of sequencedObjects) {
        const definition = item[resourceSequenceSymbol];
