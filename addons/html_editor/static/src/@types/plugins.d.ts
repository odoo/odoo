declare module "plugins" {
    ...
    export interface EditorResourcesList {
        ...
        on_history_changes_captured_handlers: on_history_changes_captured_handlers;
        ...
        on_will_capture_history_changes_handlers: on_will_capture_history_changes_handlers;
