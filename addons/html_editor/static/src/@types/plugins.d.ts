declare module "plugins" {
    ...
    import { can_format_content_predicates, format_specs, is_format_class_predicates, is_formattable_node_predicates, before_format_handlers, formattable_node_providers, FormatShared, can_remove_format_predicates, should_defer_format_predicates, on_all_formats_removed_handlers, on_format_applied_handlers, on_format_requested_handlers, on_collapsed_formats_removed_handlers } from "@html_editor/core/format_plugin";
    ...
    export interface EditorResourcesList {
        ...
        should_defer_format_predicates: should_defer_format_predicates;
