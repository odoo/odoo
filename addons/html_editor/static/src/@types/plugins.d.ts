declare module "plugins" {
    ...
    import { is_format_class_predicates, is_formattable_node_predicates, format_selection_overrides, FormatShared, has_format_predicates, on_all_formats_removed_handlers } from "@html_editor/core/format_plugin";
