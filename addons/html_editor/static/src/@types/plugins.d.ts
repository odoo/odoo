declare module "plugins" {
    ...
    import { after_paste_handlers, before_paste_handlers, bypass_paste_image_files, clipboard_content_processors, clipboard_text_processors, ClipboardShared, paste_text_overrides } from "@html_editor/core/clipboard_plugin";
    ...
    import { after_save_media_dialog_handlers, closest_savable_providers, media_dialog_extra_tabs, MediaShared, on_added_media_handlers, on_image_saved_handlers, on_media_dialog_saved_handlers, on_replaced_media_handlers } from "@html_editor/main/media/media_plugin";
