...
export class Dailymotion extends AbstractThirdPartyVideo {
    ...
    static getCustomUrlOptions(url, urlMatch) {
        ...
        return {
            isPlaylist,
            // The custom player of an embed url, e.g. "player/xk3d1.html".
    ...
    static exampleUrls = {
        ...
        videoInPlaylist: "https://geo.dailymotion.com/player.html?video=x7svr6t&playlist=x61w5b",
        embedCustomPlayer: "https://geo.dailymotion.com/player/xk3d1.html?video=x7svr6t",
