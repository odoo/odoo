...
export class TableResizePlugin extends Plugin {
    ...
    resetRowOrColumnOnDblClick(ev) {
        ...
        if (["left", "right"].includes(isHoveringTdBorder)) {
            ...
            this.dependencies.table.resetColumnSize(currentColumnCells[0]);
            ...
            if (
                ...
                this.dependencies.table.resetColumnSize(siblingColumnCells[0]);
            }
        } else if (["top", "bottom"].includes(isHoveringTdBorder)) {
            const currentRow = cell.parentElement;
            this.dependencies.table.resetRowSize(currentRow);
            const siblingRow =
                isHoveringTdBorder === "top"
                    ? currentRow.previousElementSibling
                    : currentRow.nextElementSibling;
            if (siblingRow) {
                this.dependencies.table.resetRowSize(siblingRow);
            }
        }
    }
