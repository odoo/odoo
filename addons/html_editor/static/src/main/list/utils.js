    ...
    list.append(
        ...content.map((c) => {
            ...
            if (c.length === 1 && c[0].nodeType === Node.ELEMENT_NODE) {
                ...
                const unwrapAndUpdateContent = (node, currentContent) => {
                    if (currentContent[0] === node) {
                ...
                if (firstClosestFont && lastClosestFont && firstClosestFont === lastClosestFont) {
                    ...
                    c = unwrapAndUpdateContent(firstClosestFont, c);
                }
                ...
                if (
                    ...
                    c = unwrapAndUpdateContent(firstClosestSpan, c);
                }
            }
            li.append(...[].concat(c));
            return li;
