...
import { removeClass, removeStyle, unwrapContents, wrapInlinesInBlocks } from "../utils/dom";
...
export class ClipboardPlugin extends Plugin {
    ...
    onCopy(ev) {
        ...
        for (const processor of this.getResource("content_for_clipboard_processors")) {
