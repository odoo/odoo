 ...
 *
 * @typedef {((position: [node: Node, offset: number]) => boolean | void)[]} should_process_text_for_insertion
...
export class DomPlugin extends Plugin {
    ...
    processTextForInsertion(text) {
        ...
        if (this.checkPredicates("should_process_text_for_insertion", position) === false) {
