...
test("undo/redo should work correctly while dragging and dropping a column", async () => {
...
test("undo/redo should work correctly while dragging and dropping a row", async () => {
    const { el, editor } = await setupEditor(
        unformat(`
            <table class="table table-bordered o_table">
                <tbody>
