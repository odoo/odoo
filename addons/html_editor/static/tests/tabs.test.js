...
describe("insert tabulation", () => {
    ...
    test("tab should not be colored when inserting tab at the beginning of a text having background color (1)", async () => {
        await testTabulation({
    ...
    test("tab should be colored when inserting a tab in the middle of text having background color (2)", async () => {
        ...
        await testTabulation({
            ...
            stepFunction: keydownTab,
            contentAfterEdit: `<p><font style="background-color: rgb(255,255,0);">ab<strong>${oeTab(
                expectedTabWidth,
                false
            )}[]cd</strong></font></p>`,
            contentAfter: `<p><font style="background-color: rgb(255,255,0);">ab<strong>${oeTab(
                expectedTabWidth
            )}[]cd</strong></font></p>`,
        });
    });
