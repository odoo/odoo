...
test("should not include opacity when converting fully transparent rgba color to hexadecimal", async () => {
    expect(rgbaToHex("rgba(0, 0, 0, 0)")).toBe("#000000");
    expect(rgbaToHex("rgba(255, 0, 0, 0)")).toBe("#ff0000");
    expect(rgbaToHex("rgba(0, 255, 0, 0)")).toBe("#00ff00");
