...
describe("list", () => {
    describe("selection collapsed", () => {
        test("should not outdent while nested within a list item if the list is unsplittable (1)", async () => {
            // Only one LI.
            await testEditor({
        ...
        test("should not outdent while nested within a list item if the list is unsplittable (2)", async () => {
            // First LI.
            await testEditor({
                contentBefore:
        ...
        test("should not outdent while nested within a list item if the list is unsplittable (3)", async () => {
            // In the middle.
            await testEditor({
                contentBefore:
        ...
        test("should not outdent while nested within a list item if the list is unsplittable (4)", async () => {
            // Last LI.
            await testEditor({
                contentBefore:
        ...
        test("should not outdent while nested within a list item if the list is unsplittable (5)", async () => {
