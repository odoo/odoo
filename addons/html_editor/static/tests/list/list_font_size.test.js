...
test("should apply font size to a fully selected list item with trailing empty line (1)", async () => {
    await testEditor({
        ...
        stepFunction: setFontSize("56px"),
        contentAfter:
            '<ul><li style="font-size: 56px; list-style-position: inside;">[abc</li><li style="font-size: 56px; list-style-position: inside;">]<br></li></ul>',
    });
});
...
test("should apply font size to a fully selected list item with trailing empty line (2)", async () => {
    await testEditor({
        ...
        stepFunction: setFontSize("56px"),
        contentAfter:
            '<ul><li style="font-size: 56px; list-style-position: inside;">[abc</li><li style="font-size: 56px; list-style-position: inside;"><br>]<br></li></ul>',
    });
});
...
test("should apply font size to a fully selected list item with trailing empty line (3)", async () => {
    await testEditor({
        ...
        stepFunction: setFontSize("56px"),
        contentAfter:
            '<ul><li style="font-size: 56px; list-style-position: inside;">[abc</li><li style="font-size: 56px; list-style-position: inside;">abcd<br>]<br></li></ul>',
    });
});
...
test("should not apply font size to list item when selection excludes trailing empty line", async () => {
    await testEditor({
        ...
        stepFunction: setFontSize("56px"),
        contentAfter:
            '<ul><li style="font-size: 56px; list-style-position: inside;">[abc</li><li><span style="font-size: 56px;">abcd]</span><br><br></li></ul>',
    });
});
