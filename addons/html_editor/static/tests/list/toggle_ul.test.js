...
describe("Range collapsed", () => {
    describe("Insert", () => {
        ...
        test("should turn a line in a paragraph in a div into a list", async () => {
            await testEditor({
                ...
                stepFunction: toggleUnorderedList,
                contentAfter:
                    "<div><p>a<br>b</p><ul><li>ABc[]</li></ul><p>d<br>e</p></div>",
            });
        });
    ...
    describe("Remove", () => {
        ...
        test("should turn a list item into a paragraph, with line breaks", async () => {
            await testEditor({
                contentBefore:
                    "<p>ab</p><ul><li>cd</li><li>e<br>f<br>[]g<br>h<br>i</li></ul>",
                stepFunction: toggleUnorderedList,
                contentAfter:
                    "<p>ab</p><ul><li>cd</li></ul><p>e<br>f<br>[]g<br>h<br>i</p>",
            });
        });
    ...
    describe("Insert", () => {
        ...
        test("should turn the middle few lines of a paragraph into a list with multiple items", async () => {
            await testEditor({
                ...
                stepFunction: toggleUnorderedList,
                contentAfter:
                    "<p>a</p><ul><li>[b</li><li>c</li><li>d]</li></ul><p>e</p>",
            });
        });
