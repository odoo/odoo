    ...
    describe("Insert", () => {
        ...
        test("should apply both color and size styles on list item (2)", async () => {
            await testEditor({
                ...
                stepFunction: toggleOrderedList,
                contentAfter:
                    '<ol><li style="font-weight: bolder; font-style: italic; font-size: 18px; color: rgb(255, 0, 0);">[abc]</li></ol>',
            });
        });
        ...
        test("should not apply color and size styles on list item", async () => {
            await testEditor({
                contentBefore:
                    '<p><span style="font-size: 18px;"><span style="color: rgb(0, 128, 0);">a</span></span>b</p>',
                stepFunction: toggleOrderedList,
                contentAfter:
                    '<ol><li><span style="font-size: 18px;"><span style="color: rgb(0, 128, 0);">a</span></span>b</li></ol>',
            });
        });
        ...
        test("should only apply color style on list item", async () => {
            await testEditor({
                contentBefore:
                    '<p><span style="color: rgb(0, 128, 0);"><b><span style="font-size: 18px;">a</span></b><i><span style="font-size: 18px;">a</span></i></span></p>',
                stepFunction: toggleOrderedList,
                contentAfter:
        ...
        test("should only apply size style on list item", async () => {
            await testEditor({
                contentBefore:
                    '<p><span style="font-size: 18px;"><b><span style="color: rgb(0, 128, 0);">a</span></b><i><span style="color: rgb(0, 128, 0);">a</span></i></span></p>',
                stepFunction: toggleOrderedList,
                contentAfter:
                    '<ol><li style="font-size: 18px;"><b><span style="color: rgb(0, 128, 0);">a</span></b><i><span style="color: rgb(0, 128, 0);">a</span></i></li></ol>',
            });
        });
    });
    describe("Remove", () => {
