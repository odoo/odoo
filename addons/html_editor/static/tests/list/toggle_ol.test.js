    ...
    describe("Insert", () => {
        ...
        test("should turn a line in a paragraph with formats into a list", async () => {
            await testEditor({
                ...
                stepFunction: toggleOrderedList,
                contentAfter: '<p><span><b>a<br>b</b></span></p><ol><li><span><b>c</b></span> <span><i>d[]</i></span></li></ol><p><span><i>e</i></span> f<br>g</p>',
            });
        });
    ...
    describe("Insert", () => {
        ...
        test("should turn a multi-line heading into a list with multiple items", async () => {
            await testEditor({
                ...
                stepFunction: toggleOrderedList,
                contentAfter: '<p>xy</p><ol><li><h1>AB[a</h1></li><li><h1>b</h1></li><li><h1>c</h1></li><li><h1>d</h1></li><li><h1>e]FG</h1></li></ol>',
            });
        });
        ...
        test("should turn the first few lines of a heading into a list with multiple items", async () => {
            await testEditor({
                ...
                stepFunction: toggleOrderedList,
                contentAfter: '<p>xy</p><ol><li><h1>AB[a</h1></li><li><h1>b</h1></li><li><h1>c]</h1></li></ol><h1>d<br>e</h1>',
            });
        });
        ...
        test("should turn the middle few lines of a heading into a list with multiple items", async () => {
            await testEditor({
                ...
                stepFunction: toggleOrderedList,
                contentAfter: '<p>xy</p><h1>a</h1><ol><li><h1>AB[b</h1></li><li><h1>c</h1></li><li><h1>d]EF</h1></li></ol><h1>e</h1>',
            });
        });
        ...
        test("should turn a last few lines of a heading into a list with multiple items", async () => {
            await testEditor({
                ...
                stepFunction: toggleOrderedList,
                contentAfter: '<p>xy</p><h1>a<br>b</h1><ol><li><h1>AB[c</h1></li><li><h1>d</h1></li><li><h1>e]EF</h1></li></ol>',
            });
        });
        ...
        test("should turn four lines over two paragraphs into a list with four items", async () => {
            await testEditor({
                ...
                stepFunction: toggleOrderedList,
                contentAfter: '<p>ab</p><p>c</p><ol><li>d[e</li><li>f</li><li>g</li><li>h]i</li></ol><p>j</p>',
            });
        });
        ...
        test("should turn two lines of a paragraph and a list item into three list items", async () => {
            await testEditor({
                contentBefore:
                    '<p>a<br>x[b<br>y</p><ol><li>c]d</li><li>ef</li></ol>',
                stepFunction: toggleOrderedList,
                contentAfter:
                    '<p>a</p><ol><li>x[b</li><li>y</li><li>c]d</li><li>ef</li></ol>',
            });
        });
        ...
        test("should turn two lines of a paragraph and two lines of a list item into four list items", async () => {
            ...
            await testEditor({
                contentBefore:
                    '<p>a<br>x[b<br>y</p><ol><li>c<br>z]d<br>A</li><li>ef</li></ol>',
                stepFunction: toggleOrderedList,
                contentAfter:
        ...
        test("should turn a list item and two lines of a paragraph into three list items", async () => {
            await testEditor({
                contentBefore:
                    '<ol><li>ab</li><li>c[d</li></ol><p>e<br>x]f<br>g</p>',
                stepFunction: toggleOrderedList,
                contentAfter:
                    '<ol><li>ab</li><li>c[d</li><li>e</li><li>x]f</li></ol><p>g</p>',
            });
        });
        ...
        test("should turn two lines of a list item and two lines of a paragraph into three list items", async () => {
            await testEditor({
                contentBefore:
                    '<ol><li>ab</li><li>c[d<br>A</li></ol><p>e<br>x]f<br>g</p>',
                stepFunction: toggleOrderedList,
                contentAfter:
                    '<ol><li>ab</li><li>c[d<br>A</li><li>e</li><li>x]f</li></ol><p>g</p>',
            });
        });
