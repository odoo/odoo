...
describe("Range collapsed", () => {
    describe("Insert", () => {
        ...
        test("should turn a checked list into an ordered list, with line breaks", async () => {
            await testEditor({
                contentBefore:
                    '<ul class="o_checklist"><li>a<br>b<br>ABc[]DE<br>d<br>e</li></ul>',
                stepFunction: toggleOrderedList,
                contentAfter: "<ol><li>a<br>b<br>ABc[]DE<br>d<br>e</li></ol>",
            });
        });
        ...
        test("should turn a line in a paragraph in a div into a list", async () => {
            await testEditor({
                ...
                stepFunction: toggleOrderedList,
                contentAfter:
                    "<div><p>a<br>b</p><ol><li>ABc[]</li></ol><p>d<br>e</p></div>",
            });
        });
    ...
    describe("Remove", () => {
        ...
        test("should turn a list item into a paragraph, with line breaks", async () => {
            await testEditor({
                contentBefore:
                    "<p>ab</p><ol><li>cd</li><li>e<br>f<br>[]g<br>h<br>i</li></ol>",
                stepFunction: toggleOrderedList,
                contentAfter:
                    "<p>ab</p><ol><li>cd</li></ol><p>e<br>f<br>[]g<br>h<br>i</p>",
            });
        });
    ...
    describe("Insert", () => {
        ...
        test("should turn the middle few lines of a paragraph into a list with multiple items", async () => {
            await testEditor({
                ...
                stepFunction: toggleOrderedList,
                contentAfter:
                    "<p>a</p><ol><li>[b</li><li>c</li><li>d]</li></ol><p>e</p>",
            });
        });
