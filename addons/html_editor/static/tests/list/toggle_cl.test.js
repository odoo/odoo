    ...
    describe("Insert", () => {
        ...
        test("should apply both color and size styles on list item (2)", async () => {
            await testEditor({
                ...
                stepFunction: toggleCheckList,
                contentAfter:
                    '<ul class="o_checklist"><li style="font-weight: bolder; font-style: italic; font-size: 18px; color: rgb(255, 0, 0);">[abc]</li></ul>',
            });
        });
        ...
        test("should not apply color and size styles on list item (1)", async () => {
            await testEditor({
                ...
                stepFunction: toggleCheckList,
                contentAfter:
                    '<ul class="o_checklist"><li><span style="font-size: 18px;"><span style="color: rgb(255, 0, 0);">a</span></span>b</li></ul>',
            });
        });
        ...
        test("should not apply color and size styles on list item (2)", async () => {
            await testEditor({
                contentBefore:
                    '<p><b><span style="font-size: 18px;"><span style="color: rgb(255, 0, 0);">a</span></span></b><i><span style="font-size: 18px;"><span style="color: rgb(255, 0, 0);">a</span></span></i></p>',
                stepFunction: toggleCheckList,
                contentAfter:
                    '<ul class="o_checklist"><li><b><span style="font-size: 18px;"><span style="color: rgb(255, 0, 0);">a</span></span></b><i><span style="font-size: 18px;"><span style="color: rgb(255, 0, 0);">a</span></span></i></li></ul>',
            });
        });
        ...
        test("should only apply size style on list item", async () => {
            await testEditor({
                ...
                stepFunction: toggleCheckList,
                contentAfter:
                    '<ul class="o_checklist"><li style="font-size: 18px;"><b><span style="color: rgb(255, 0, 0);">a</span></b><i><span style="color: rgb(255, 0, 0);">a</span></i></li></ul>',
            });
        });
    });
    describe("Remove", () => {
