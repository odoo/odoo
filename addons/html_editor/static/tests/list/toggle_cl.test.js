...
describe("Range collapsed", () => {
    describe("Insert", () => {
        ...
        test("should turn a first line into a checklist", async () => {
            await testEditor({
                ...
                stepFunction: toggleCheckList,
                contentAfter:
                    '<ul class="o_checklist"><li>a[]</li></ul><p>b<br>c<br>d<br>e</p>',
            });
        });
        ...
        test("should turn a last line into a checklist", async () => {
            await testEditor({
                ...
                stepFunction: toggleCheckList,
                contentAfter:
                    '<p>a<br>b<br>c<br>d</p><ul class="o_checklist"><li>AB[]e</li></ul>',
            });
        });
    ...
    describe("Remove", () => {
        ...
        test("should turn a checklist into a paragraph, with line breaks", async () => {
            await testEditor({
                contentBefore:
                    '<ul class="o_checklist"><li>a<br>b<br>[]c<br>d<br>e</li></ul>',
                stepFunction: toggleCheckList,
