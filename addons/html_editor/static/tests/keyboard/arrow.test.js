...
describe("Around icons", () => {
    ...
    test("should not skip icons (ArrowUp)", async () => {
        ...
        await testEditor({
            contentBefore: unformat(`
                <p><br>
                abcd<span class="fa fa-music"></span><span class="fa fa-music"></span>
                []<br><br></p>
            `),
            contentBeforeEdit: unformat(`
                <p><br>
                abcd<span class="fa fa-music" contenteditable="false">\u200b</span><span class="fa fa-music" contenteditable="false">\u200b</span>
                []<br><br></p>
            `),
            stepFunction: async () => await press("ArrowUp"),
            contentAfterEdit: unformat(`
    ...
    test("should not skip icons (ArrowDown)", async () => {
        ...
        await testEditor({
            contentBefore: unformat(`
                <p>[]<br>
                <span class="fa fa-music"></span><span class="fa fa-music"></span>abcd
                <br><br></p>
            `),
            contentBeforeEdit: unformat(`
                <p>[]<br>
                <span class="fa fa-music" contenteditable="false">\u200b</span><span class="fa fa-music" contenteditable="false">\u200b</span>abcd
                <br><br></p>
            `),
            stepFunction: async () => await press("ArrowDown"),
            contentAfterEdit: unformat(`
