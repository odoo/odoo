...
const PLACEHOLDER_WITH_START_OF_SELECTION = PLACEHOLDER().replace("<br>", "[<br>");
...
test("Everything gets selected with ctrl+a, including a contenteditable=false as first element", async () => {
    ...
    expect(getContent(el)).toBe(
        `${PLACEHOLDER_WITH_START_OF_SELECTION}<div class="o_editor_banner user-select-none o-contenteditable-false lh-1 d-flex align-items-center alert alert-info pb-0 pt-3" data-oe-role="status" contenteditable="false" role="status">
                <i class="o_editor_banner_icon mb-3 fst-normal" data-oe-aria-label="Banner Info" aria-label="Banner Info">💡</i>
                <div class="w-100 px-3" contenteditable="true">
                    <p><br></p>
                </div>
...
test("Everything gets selected with ctrl+a, including a contenteditable=false as first two elements", async () => {
    ...
    await press(["ctrl", "a"]);
    expect(getContent(el)).toBe(
        PLACEHOLDER_WITH_START_OF_SELECTION +
            `<div data-oe-role="status" contenteditable="false" role="status">a</div>${PLACEHOLDER()}<div data-oe-role="status" contenteditable="false" role="status">b</div><p>cd]</p>`
    );
...
test("should move heading element inside the banner, with paragraph element after the banner", async () => {
    ...
    await press("enter");
    expect(getContent(el)).toBe(
        wrapInPlaceholders(`<div class="o_editor_banner user-select-none o-contenteditable-false lh-1 d-flex align-items-center alert alert-info pb-0 pt-3" data-oe-role="status" contenteditable="false" role="status">
                <i class="o_editor_banner_icon mb-3 fst-normal" data-oe-aria-label="Banner Info" aria-label="Banner Info">💡</i>
                <div class="o_editor_banner_content o-contenteditable-true w-100 px-3" contenteditable="true">
                    <h1>Test[]</h1>
                </div>
