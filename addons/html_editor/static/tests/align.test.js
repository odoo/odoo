...
describe("left", () => {
    ...
    test("should left align a container with shortcut", async () => {
        await testEditor({
            ...
            stepFunction: async () => await press(["ctrl", "shift", "l"]),
            contentAfter:
...
describe("center", () => {
    ...
    test("should center align a container with shortcut", async () => {
        await testEditor({
            ...
            stepFunction: async () => await press(["ctrl", "shift", "e"]),
            contentAfter:
...
describe("right", () => {
    ...
    test("should right align a container with shortcut", async () => {
        await testEditor({
            contentBefore: '<div style="text-align: left;"><p>a[]b</p></div>',
            stepFunction: async () => await press(["ctrl", "shift", "r"]),
            contentAfter:
...
describe("justify", () => {
    ...
    test("should justify align a container with shortcut", async () => {
        await testEditor({
            ...
            stepFunction: async () => await press(["ctrl", "shift", "j"]),
            contentAfter:
