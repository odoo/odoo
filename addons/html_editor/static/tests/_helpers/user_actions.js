...
/**
 * Simulate browser auto BR removal behaviour.
 * When a character is inserted in an empty block element,
 * the browser will automatically remove the BR.
 * But this do not work during unit tests, because the
 * events generated by the test framework are not
 * trusted events.
 *
 * @param {Editor} editor
 */
function simulateBrowserAutoBRRemoval(editor) {
    ...
    if (
        ...
        console.info("[TEST] BR removed during insertText to simulate browser behavior");
