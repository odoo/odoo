...
test("should remove color only from selected text within a list item", async () => {
    await testEditor({
        ...
        stepFunction: (editor) => execCommand(editor, "removeFormat"),
        contentAfter: '<ul><li><font style="color: rgb(255, 0, 0);">a</font>[bc]<font style="color: rgb(255, 0, 0);">d</font></li></ul>',
    });
});
...
test("should remove color only from selected text within a heading", async () => {
    await testEditor({
        ...
        stepFunction: (editor) => execCommand(editor, "removeFormat"),
        contentAfter: '<ul><h1><font style="color: rgb(255, 0, 0);">a</font>[bc]<font style="color: rgb(255, 0, 0);">d</font></h1></ul>',
    });
});
