...
test("should apply background color whithout interrupting gradient text color on selected text", async () => {
    await testEditor({
        ...
        stepFunction: setColor("rgb(255, 0, 0)", "backgroundColor"),
        contentAfter:
            '<p><span class="text-gradient" style="background-image: linear-gradient(135deg, rgb(214, 255, 127) 0%, rgb(0, 179, 204) 100%);">ab<span style="background-color: rgb(255, 0, 0);">[ca]</span>bc</span></p>',
    });
});
test("should apply background color whithout interrupting gradient text color on fully selected gradient", async () => {
    await testEditor({
        ...
        stepFunction: setColor("rgb(255, 0, 0)", "backgroundColor"),
        contentAfter:
            '<p><span class="text-gradient" style="background-image: linear-gradient(135deg, rgb(214, 255, 127) 0%, rgb(0, 179, 204) 100%);"><span style="background-color: rgb(255, 0, 0);">[abcde]</span></span></p>',
    });
});
...
test("should break gradient color on selected text", async () => {
    await testEditor({
        ...
        contentAfter:
            ...
            '<span style="background-color: transparent; background-image: linear-gradient(135deg, rgb(255, 174, 127) 0%, rgb(109, 204, 0) 100%);">[ca]</span>' +
