...
class config(osv.Model):
    ...
    def get_google_drive_url(self, cr, uid, config_id, res_id, template_id, context=None):
        ...
        try:
            ...
            raise UserError(_('Key Error!'), _("At least one key cannot be found in your Google Drive name pattern"))
    ...
    def get_access_token(self, cr, uid, scope=None, context=None):
        ...
        if not google_drive_refresh_token:
            if user_is_admin:
                ...
                raise UserError(_('Error!'), _("Google Drive is not yet configured. Please contact your administrator."))
    ...
    def copy_doc(self, cr, uid, res_id, template_id, name_gdocs, res_model, context=None):
        ...
        try:
            ...
            raise UserError(_('Warning!'), _("The Google Template cannot be found. Maybe it has been deleted."))
    ...
    def get_google_drive_config(self, cr, uid, res_model, res_id, context=None):
        ...
        '''
        if not res_id:
            raise UserError(_('Google Drive Error!'), _("Creating google drive may only be done by one at a time."))
    ...
    def _resource_get(self, cr, uid, ids, name, arg, context=None):
        ...
        for data in self.browse(cr, uid, ids, context):
            ...
            if mo:
                ...
                raise UserError(_('Incorrect URL!'), _("Please enter a valid Google Document URL."))
        return result
