...
class product_product(osv.osv):
    ...
    def get_product_accounts(self, cr, uid, product_id, context=None):
        ...
        stock_output_acc = stock_output_acc = product_obj.property_stock_account_output and product_obj.property_stock_account_output.id or False
        if not stock_output_acc:
            stock_output_acc = product_obj.categ_id.property_stock_account_output_categ and product_obj.categ_id.property_stock_account_output_categ.id or False

        price_diff_acc = product_obj.property_account_creditor_price_difference and product_obj.property_account_creditor_price_difference.id or False
        if not price_diff_acc:
            price_diff_acc = product_obj.categ_id.property_account_creditor_price_difference_categ and product_obj.categ_id.property_account_creditor_price_difference_categ.id or False
        ...
        return {
            ...
            'stock_price_diff_account':price_diff_acc
        }
