...
class ResPartner(models.Model):
    ...
    property_stock_customer = fields.Many2one('stock.location', string="Customer Location", company_dependent=True,
    ...
    property_stock_supplier = fields.Many2one('stock.location', string="Supplier Location", company_dependent=True,
