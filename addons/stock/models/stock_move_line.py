...
class StockMoveLine(models.Model):
    ...
    def _apply_putaway_strategy(self):
        ...
        for (location, package), smls in groupby(self, lambda sml: (sml.location_dest_id, sml.result_package_id)):
            smls = self.env['stock.move.line'].concat(*smls)
            locations = smls[0].location_dest_id.child_internal_location_ids
