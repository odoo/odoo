...
class StockMoveLine(models.Model):
    ...
    result_package_id = fields.Many2one(
        ...
        domain="['|', '|', '|', ('location_id', '=', False), ('location_id', '=', location_dest_id), ('id', '=', package_id), ('move_line_ids.location_dest_id', '=', location_dest_id)]",
    ...
    def action_put_in_pack(self, *, package_id=False, package_type_id=False, package_name=False):
        ...
        if done_pack and not force_move_lines:
            ...
            if done_pack:
                packages_to_pack = packages_to_pack.filtered(lambda p: p.id != done_pack.id)
