...
class StockMoveLine(models.Model):
    ...
    def _find_best_wave_product_category(self, picking_type):
        ...
        self.ensure_one()
        wave_category = sorted([category for category in picking_type.wave_category_ids if self.product_id.categ_id._child_of(category)], key=lambda category: category.parent_path.count('/'))
            ...
            if lines:
                ...
                for line in lines:
                    ...
                    for wave in potential_waves:
                        ...
                        or (picking_type.wave_group_by_category and not all(category._child_of(wave_category) for category in wave.move_line_ids.product_id.mapped('categ_id'))) \
