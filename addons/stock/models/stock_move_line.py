...
class StockMoveLine(models.Model):
    ...
    picking_code = fields.Selection(related='picking_id.picking_type_id.code', readonly=True, depends=['picking_id'])
    picking_type_use_create_lots = fields.Boolean(related='picking_id.picking_type_id.use_create_lots', readonly=True, depends=['picking_id'])
    picking_type_use_existing_lots = fields.Boolean(related='picking_id.picking_type_id.use_existing_lots', readonly=True, depends=['picking_id'])
    ...
    picking_type_entire_packs = fields.Boolean(related='picking_id.picking_type_id.show_entire_packs', readonly=True, depends=['picking_id'])
