...
class ResCompany(models.Model):
    ...
    stock_text_confirmation = fields.Boolean("Stock Text Confirmation", default=True)
    ...
    def _get_text_validation(self, confirmation_type):
        self.ensure_one()
        return bool(self.stock_confirmation_type == confirmation_type and self.stock_text_confirmation)
