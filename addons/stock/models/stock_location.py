...
class Location(models.Model):
    ...
    rule_dest_ids = fields.One2many('stock.rule', 'location_dest_id', 'Rules of Source Location')
    rule_src_ids = fields.One2many('stock.rule', 'location_src_id', 'Rules of Source Location')
