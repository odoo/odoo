...
class StockPickingType(models.Model):
    ...
    sequence_code = fields.Char('Sequence Prefix', related='sequence_id.prefix', required=True, readonly=False)
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if not vals.get('sequence_id') and vals.get('sequence_code'):
                vals['sequence_code'] = vals['sequence_code'][:-1] if vals['sequence_code'][-1] == '/' else vals['sequence_code']
                if vals.get('warehouse_id'):
                    ...
                    vals['sequence_code'] = wh.code + '/' + vals['sequence_code'] + '/'
                else:
                    vals['sequence_id'] = self.env['ir.sequence'].sudo().create({
                    ...
                    vals['sequence_code'] = vals['sequence_code'] + '/'
