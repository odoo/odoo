...
class StockPickingType(models.Model):
    ...
    allow_pack_in_pack = fields.Boolean('Multi-level Package', default=True, help="Allows to do a new put in pack if destination package is already set")
...
class StockPicking(models.Model):
    ...
    picking_type_pack_in_pack = fields.Boolean(related='picking_type_id.allow_pack_in_pack')
