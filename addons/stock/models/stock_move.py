...
class StockMove(models.Model):
    ...
    quantity_done_need_compute = fields.Boolean('Done Field Need Compute', store=True, default=True)
    ...
    def _quantity_done_compute(self):
        ...
        if not any(self._ids):
            ...
            for move in self:
                ...
                move.quantity_done_need_compute = True
            ...
            # compute
            move_lines_ids = set()
            moves = self.filtered(lambda m: m.quantity_done_need_compute)
            for move in moves:
    ...
    def _quantity_done_set(self):
        ...
        for move in self:
            ...
            move.quantity_done_need_compute = move._get_qty_done_mls() == move.quantity_done
    ...
    def action_clear_lines_show_details(self):
        ...
        move_lines.unlink()
        self.quantity_done_need_compute = True
    ...
    def _generate_serial_numbers(self, next_serial_count=False):
        ...
        self.write({'move_line_ids': move_lines_commands, 'quantity_done_need_compute': True})
        return True
