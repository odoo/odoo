...
class StockQuant(models.Model):
    ...
    product_id = fields.Many2one(
        ...
        index_keys='product_id,location_id;product_id,lot_id,package_id,owner_id,location_id')
    ...
    lot_id = fields.Many2one(
        ...
        index_keys='product_id,lot_id,location_id;product_id,lot_id,package_id,location_id'
    )
    ...
    package_id = fields.Many2one(
        ...
        index_keys='product_id,package_id,location_id;product_id,package_id,owner_id,location_id')
    owner_id = fields.Many2one(
        'res.partner', 'Owner',
        help='This is the owner of the quant', check_company=True,
        index='btree_not_null',
        index_keys='product_id,owner_id,location_id',
    )
