...
class ProductTemplate(models.Model):
    ...
    serial_prefix_format = fields.Char('Custom Lot/Serial', compute='_compute_serial_prefix_format', inverse='_inverse_serial_prefix_format',
        store=True, precompute=True, help=SERIAL_PREFIX_FORMAT_HELP_TEXT)
