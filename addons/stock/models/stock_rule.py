...
class ProcurementGroup(models.Model):
    ...
    def _get_product_routes(self, product):
        """Get valid routes for a given product based on category, purchase, and manufacturing settings."""
        if not product:
        ...
        if manufacturing_route and product.bom_ids:
            route_ids |= manufacturing_route
        if buy_route and product.purchase_ok and product.seller_ids:
            route_ids |= buy_route
