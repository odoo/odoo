...
class ResConfigSettings(models.TransientModel):
    ...
    text_confirmation = fields.Boolean(
        related='company_id.text_confirmation',
        string='Text Validation with stock move', readonly=False)
    confirmation_type = fields.Selection(
        related='company_id.confirmation_type',
        string='Text Validation type', readonly=False)
