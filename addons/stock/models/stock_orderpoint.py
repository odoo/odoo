...
class StockWarehouseOrderpoint(models.Model):
    ...
    def _compute_deadline_date(self):
        ...
        horizon_date_by_company = {}
        for company in orderpoints_to_compute.company_id:
            horizon_date_by_company[company] = fields.Date.today() + relativedelta.relativedelta(days=self.env['stock.warehouse.orderpoint'].with_company(company).get_horizon_days())
        max_horizon_date = max(horizon_date_by_company.values())
        ...
        for orderpoint in orderpoints_to_compute:
            ...
            horizon_date = horizon_date_by_company[orderpoint.company_id]
