...
class StockWarehouseOrderpoint(models.Model):
    ...
    def _get_multiple_rounded_qty(self, qty_to_order):
        ...
        round_precision = self.env['decimal.precision'].precision_get('Product Unit')
        if replenishment_multiple:
            ...
            qty_to_order = fields.Float.round(qty_to_order, precision_digits=round_precision, rounding_method="UP")
