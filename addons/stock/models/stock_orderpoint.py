...
class StockWarehouseOrderpoint(models.Model):
    ...
    def _compute_qty_to_order_computed(self):
        ...
        orderpoints_by_location = {}
        for location, grouped_orderpoints in orderpoints.grouped(lambda o: o.location_id).items():
            orderpoints_by_location[location] = grouped_orderpoints
        qty_in_progress_by_orderpoint = {}
        for orderpoint_group in orderpoints_by_location.values():
            qty_in_progress_by_orderpoint.update(orderpoint_group._quantity_in_progress())
