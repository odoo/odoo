...
class StockWarehouseOrderpoint(models.Model):
    ...
    def _get_replenishment_notification_links(self):
        """ Returns a list of links to the replenishment orders that were created from this orderpoint.
        This is used to display a notification when the replenishment orders are created.
        """
        ...
        for move in moves:
            if ((move.location_id.warehouse_id and move.location_id.warehouse_id != self.warehouse_id)
                ...
                if move.picking_id.id not in seen_picking_ids:
                    links.append({
    ...
    def _get_replenishment_order_notification(self):
        links = self._get_replenishment_notification_links()
        if links:
