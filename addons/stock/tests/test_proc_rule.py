...
class TestProcRule(TransactionCase):
    ...
    def test_propagate_deadline_move(self):
        ...
        move_orig.date_deadline -= timedelta(days=6)
        self.assertEqual(move_dest.date_deadline, deadline, msg='deadline date should be propagated')
        ...
        self.assertEqual(move_orig.date_deadline, deadline, msg='deadline date should be unchanged')
        self.assertEqual(move_dest.date_deadline, deadline, msg='deadline date should be unchanged')
