...
from odoo.addons.stock.tests.common import TestStockBatchCommon


class TestBatchPicking(TestStockBatchCommon):
...
class TestBatchPicking02(TestStockBatchCommon):
    def setUp(self):
        super().setUp()
...
class TestBatchPickingSynchronization(HttpCase):
    ...
    def test_stock_picking_batch_sm_to_sml_synchronization(self):
        ...
        action_id = self.env.ref('stock.stock_picking_batch_menu').action
