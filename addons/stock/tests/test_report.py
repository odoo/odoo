...
class TestReportsPostInstall(TestReportsCommon):
    ...
    def test_print_label_barcode_custom_paper_format_reports(self):
        ...
        collected_stream, report_type = self.env['ir.actions.report']._render_qweb_pdf('stock.report_lot_label', doc.id)
