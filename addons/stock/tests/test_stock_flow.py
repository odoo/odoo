...
class TestStockFlow(TestStockCommon):
    ...
    def test_10_pickings_transfer_with_different_uom(self):
        """ Picking transfer with diffrent unit of measure. """
        ...
        for move in picking_out.move_lines:
            self.assertEqual(move.state, 'assigned', 'Wrong state of move line.')
        # Check product DozA available quantity
        ...
        # Check product SDozA available quantity
        ...
        # Check product SDozRound available quantity
        ...
        # Check product gB available quantity
        ...
        # Check product kgB available quantity
        ...
        # Check product KG done quantity.
