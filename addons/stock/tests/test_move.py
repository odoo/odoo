...
class StockMove(TransactionCase):
    ...
    def test_move_line_aggregated_product_quantities(self):
        ...
        aggregate_val_1 = aggregate_values[f'{self.product.id}_{self.product.name}__{sml1.product_uom_id.id}_{sml1.move_id.packaging_uom_id.id}']
    ...
    def test_move_line_aggregated_product_quantities_duplicate_stock_move(self):
        ...
        aggregated_val = aggregate_values[f'{self.product.id}_{self.product.name}__{self.product.uom_id.id}_{self.product.uom_id.id}']
    ...
    def test_move_line_aggregated_product_quantities_two_packages(self):
        ...
        aggregated_val = aggregate_values1[f'{self.product.id}_{self.product.name}__{self.product.uom_id.id}_{self.product.uom_id.id}']
        ...
        aggregated_val = aggregate_values2[f'{self.product.id}_{self.product.name}__{self.product.uom_id.id}_{self.product.uom_id.id}']
    ...
    def test_decrease_move_quantity_with_move_line_in_different_uom(self):
        ...
        self.env['stock.quant']._update_available_quantity(self.product, self.stock_location, 24)
        quant = self.env['stock.quant']._gather(self.product, self.stock_location)
        move = self.env['stock.move'].create({
            'product_id': self.product.id,
            'product_uom_qty': 2,
