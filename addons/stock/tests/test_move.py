...
class StockMove(SavepointCase):
    ...
    def test_link_assign_7(self):
        ...
        backorder_wizard = self.env[backorder_wizard_dict['res_model']].with_context(backorder_wizard_dict['context']).browse(backorder_wizard_dict['res_id'])
    ...
    def test_immediate_validate_3(self):
        ...
        wizard = self.env[(action.get('res_model'))].with_context(action['context']).browse(action.get('res_id'))
    ...
    def test_immediate_validate_4(self):
        ...
        immediate_trans_wiz = self.env[immediate_trans_wiz_dict['res_model']].with_context(immediate_trans_wiz_dict['context']).browse(immediate_trans_wiz_dict['res_id'])
