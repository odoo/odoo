...
class TestStockMove(TestStockCommon):
    ...
    def test_scrap_1(self):
        ...
        """
        self.env['stock.quant']._update_available_quantity(self.productA, self.stock_location, 1)
        scrap_form = Form(self.env['stock.move.line'].with_context(is_scrap=True), view='stock.view_scrap_move_line_form2')
    ...
    def test_scrap_12_qty_in_sublocation(self):
        ...
        with Form(self.env['stock.move.line'].with_context(is_scrap=True), view='stock.view_scrap_move_line_form2') as scrap_form:
            scrap_form.product_id = self.productA
    ...
    def test_serial_tracking(self):
        ...
        with receipt_form.non_scrapped_move_ids.edit(0) as move:
            move.lot_ids.add(sn)
    ...
    def test_internal_transfer_with_tracked_product(self):
        ...
        with Form(picking) as picking_form:
            with picking_form.non_scrapped_move_ids.edit(0) as line_form:
    ...
    def test_change_dest_loc_after_sm_creation(self):
        ...
        with form.non_scrapped_move_ids.new() as move:
            move.product_id = self.productA
            move.product_uom_qty = 1
        form.save()
        form.location_dest_id = self.customer_location
        self.assertEqual(form.non_scrapped_move_ids.edit(0).location_dest_id, self.customer_location)
        ...
        self.assertEqual(form.non_scrapped_move_ids.edit(0).location_dest_id, self.stock_location)
        self.assertEqual(form.non_scrapped_move_ids.edit(1).location_dest_id, self.stock_location)
