...
class TestSinglePicking(TestStockCommon):
    ...
    def test_cancel_immediate_transfer_with_qty(self):
        ...
        self.assertEqual(picking.state, 'draft', "Picking should be in a draft state.")

        # picking in a draft state and try to cancel it.
        picking.action_cancel()
    ...
    def test_cancel_immediate_transfer_without_qty(self):
        """ Test picking cancelation with immediate transfer but not done quantity"""
        # create picking with stock move line
        picking = self.env['stock.picking'].create({
            'location_id': self.pack_location,
            'location_dest_id': self.customer_location,
        ...
        # picking in a draft state and try to cancel it.
        picking.action_cancel()
        self.assertEqual(len(picking.move_lines), 0, "Picking should not have stock move.")
        self.assertEqual(picking.state, 'cancel', "Picking should be in a cancel state.")
