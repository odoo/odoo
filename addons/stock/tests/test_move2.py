...
class TestSinglePicking(TestStockCommon):
    ...
    def test_zero_quantity_count_w_inventory(self):
        ...
        self.assertEqual(inventory_line_zqc_action['context']['button_validate_picking_ids'], [delivery_order.id])
        ...
        self.assertEqual(delivery_order.inventory_ids, inventory, 'Inventory should be linked to picking via zqc wizard')
