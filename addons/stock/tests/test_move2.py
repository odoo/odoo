...
class TestSinglePicking(TestStockCommon):
    ...
    def test_picking_destination_from_operation_type_and_contact(self):
        ...
        customer_stock, customer_location, transit_location = self.env['stock.location'].create([
            {'name': 'Customer stock', 'usage': 'customer', 'location_id': self.customer_location},
            {'name': 'Customer location', 'usage': 'customer', 'location_id': self.customer_location},
            {'name': 'Inter-warehouse transit', 'usage': 'transit', 'location_id': self.stock_location},
        ])
        ...
        delivery_type = self.env['stock.picking.type'].browse(self.picking_type_out)
    ...
    def test_picking_source_from_operation_type_and_contact(self):
        ...
        vendor_stock, vendor_location, transit_location = self.env['stock.location'].create([
            {'name': 'Vendor stock', 'usage': 'supplier', 'location_id': self.supplier_location},
            {'name': 'Vendor location', 'usage': 'supplier', 'location_id': self.supplier_location},
            {'name': 'Inter-warehouse transit', 'usage': 'transit', 'location_id': self.stock_location},
        ])
        ...
        receipt_type = self.env['stock.picking.type'].browse(self.picking_type_in)
