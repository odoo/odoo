...
class TestPacking(TestPackingCommon):
    ...
    def test_pack_in_receipt_two_step_multi_putaway_02(self):
        ...
        self.assertRecordValues(internal_picking.move_line_ids, [
            {'product_uom_qty': 51, 'qty_done': 0, 'result_package_id': package_02.id, 'location_dest_id': sub_loc_01.id},
            {'product_uom_qty': 49, 'qty_done': 0, 'result_package_id': package_01.id, 'location_dest_id': sub_loc_02.id},
        ])
        ...
        move_form.save()
        self.assertRecordValues(internal_picking.move_line_ids, [
            {'product_uom_qty': 51, 'qty_done': 51, 'result_package_id': package_02.id, 'location_dest_id': sub_loc_01.id},
            {'product_uom_qty': 49, 'qty_done': 49, 'result_package_id': package_01.id, 'location_dest_id': sub_loc_02.id},
        ])
