...
class TestPacking(TestPackingCommon):
    ...
    def test_expected_package_move_lines(self):
        ...
        with self.assertRaises(UserError):
            move_lines_to_pack = (internal_picking_1 | in_picking_1).move_line_ids._package_move_lines()

        move_lines_to_pack = (internal_picking_1 | internal_picking_2).move_line_ids._package_move_lines()
