...
class TestReturnPicking(TestStockCommon):
    ...
    def test_stock_picking_report_has_return(self):
        ...
        self.env['stock.quant']._update_available_quantity(product_serial, self.stock_location, 1.0, lot_id=serial_1)
        self.env['stock.quant']._update_available_quantity(product_serial, self.stock_location, 1.0, lot_id=serial_2)
