...
class ProductLabelLayout(models.TransientModel):
    ...
    zpl_template = fields.Selection([
        ('normal-2.25x1.25', 'Normal (2.25" x 1.25")'),
        ('small-1.25x1.00', 'Small (1.25" x 1.00")'),
        ('alternative-2.00x1.00', 'Alternative (2.00" x 1.00")'),
        ('jewelry-2.20x0.50', 'Jewelry (2.20" x 0.50")'),
    ], string="ZPL Template", default='normal-2.25x1.25', required=True)
    ...
    def _compute_zpl_preview(self):
        ...
        width, height = self.zpl_template.split("-")[1].split("x")
