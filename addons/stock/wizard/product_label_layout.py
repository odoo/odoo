...
class ProductLabelLayout(models.TransientModel):
    ...
    def _prepare_report_data(self):
        ...
        if self.picking_quantity == 'picking' and self.move_ids and all(float_is_zero(ml.qty_done, precision_rounding=ml.uom_id.rounding) for ml in self.move_ids.move_line_ids):
            ...
            for line in self.move_ids.move_line_ids:
                if line.uom_id.category_id == uom_unit:
