...
class stock_fill_inventory(osv.osv_memory):
    ...
    def fill_inventory(self, cr, uid, ids, context=None):
        ...
        for location in location_ids:
            ...
            move_ids1 = move_obj.search(cr, uid, ['&', ('location_dest_id','=',location),('location_id','!=',location), ('state','=','done')], context=context)
            move_ids2 = move_obj.search(cr, uid, ['&', ('location_id', '=', location), ('location_dest_id', '!=', location), ('state','=','done')], context=context)
