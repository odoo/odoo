...
class StockPickingToBatch(models.TransientModel):
    ...
    batch_id = fields.Many2one('stock.picking.batch', string='Batch Transfer', domain="[('state', 'in', ('draft', 'in_progress'))]")
    ...
    def attach_pickings(self):
        ...
        return {
            ...
            'params': {
                ...
                'links': [{
                    'label': batch.name,
                    'url': f'/odoo/action-stock.stock_picking_batch_action/{batch.id}',
                }],
                'sticky': False,
