            ...
            for move in move_obj.browse(cr, uid, move_ids, context=context):
                ...
                for line in lines:
                    ...
                    if total_move_qty > move_qty:
                        ...
                        precisioned_total_move_qty = precision % total_move_qty
                        precisioned_move_qty = precision % move_qty
                        raise osv.except_osv(_('Processing Error'), _('Processing quantity %s for %s is larger than the available quantity %s!')\
                                     %(precisioned_total_move_qty, move.product_id.name, precisioned_move_qty))
