...
class procurement_rule(osv.osv):
    ...
    _columns = {
        ...
        'warehouse_id': fields.many2one('stock.warehouse', 'Warehouse', help='The warehouse this rule is for'),
        'propagate_warehouse_id': fields.many2one('stock.warehouse', 'Warehouse to Propagate', help="The warehouse to propagate on the created move/procurement, which can be different of the warehosue this rule is for (e.g for resupplying rules from another warehouse)"),
    }
