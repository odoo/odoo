...
This installs the module product_expiry."""),
        ...
        # 'group_barcode_nomenclature': fields.boolean("Manage barcode nomenclatures",
        #     implied_group='pos_barcodes.group_barcode_nomenclature',
        #     help="""Allows to define new barcode nomenclatures with custom barcode rules."""),
