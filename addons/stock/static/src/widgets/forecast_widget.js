...
export class ForecastWidgetField extends FloatField {
    ...
    async _openReport(ev) {
        ...
        const action = await this.orm.call('stock.move', 'action_product_forecast_report', [this.resId]);
        this.actionService.doAction(action);
    }
}
ForecastWidgetField.template = 'stock.ForecastWidget';
ForecastWidgetField.displayName = "Reserved"; // TODO: check why it doesn't take the string set in the view instead.
