...
export class StockPackageMany2One extends Component {
    ...
    static props = {
        ...
        displayParents: {
            type: String,
            validate: val => ["src", "dest"].includes(val),
        },
    };
    ...
    get displayNameContext() {
        return {
            show_src_package: this.props.displayParents === "src",
            show_dest_package: this.props.displayParents === "dest",
            is_done: this.isDone,
        }
    }
}
...
registry.category("fields").add("package_m2o", {
    ...
    extractProps(staticInfo, dynamicInfo) {
        return {
            ...
            displayParents: staticInfo.options.display_parents,
        };
    },
    supportedOptions: [
        ...m2oSupportedOptions,
        {
            label: _t("Display parent package"),
