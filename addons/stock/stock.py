...
class stock_picking(osv.osv):
    ...
    _columns = {
        ...
        'date': fields.datetime('First Promised Date', help="Delivery Date initially promised, usually the time of the order.", select=True, states={'done':[('readonly', True)], 'cancel':[('readonly',True)]}),
