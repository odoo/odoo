...
class StockPicking(models.Model):
    ...
    def rereserve_pick(self):
        ...
        """
        for pick in self:
            self.rereserve_quants(pick, move_ids=pick.move_lines.ids.filtered(lambda x: x.state not in ('done', 'cancel')))
    ...
    def put_in_pack(self):
        ...
        for pick in self:
            ...
            if operations:
                ...
                pack_operation.write({'result_package_id': package_id.id})
            else:
