...
class stock_quant(osv.osv):
    ...
    _columns = {
        ...
        'qty': fields.float('Quantity', required=True, help="Quantity of products in this quant, in the default unit of measure of the product", readonly=True, select=True, digits_compute=dp.get_precision('Product Unit of Measure')),
