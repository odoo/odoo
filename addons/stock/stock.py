...
class stock_move(osv.osv):
    ...
    _columns = {
        ...
        'prodlot_id': fields.many2one('stock.production.lot', 'Serial Number', states={'done': [('readonly', True)]}, help="Serial number is used to put a serial number on the production", select=True, ondelete='restrict'),
