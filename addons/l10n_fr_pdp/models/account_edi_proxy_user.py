...
try:
    from odoo.addons.account_audit_trail.models.mail_message import bypass_token
except ImportError:
    bypass_token = None
...
class AccountEdiProxyClientUser(models.Model):
    ...
    def _peppol_process_participant_status_get_local_state_map(self):
        self.ensure_one()
        if self.proxy_type != 'pdp':
            return super()._peppol_process_participant_status_get_local_state_map()
        return {
