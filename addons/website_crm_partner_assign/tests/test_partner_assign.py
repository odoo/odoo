...
class TestPublish(HttpCase):
    ...
    def setUpClass(cls):
        ...
        partner_test = cls.env['res.partner'].create({
            'name': 'Test Guy',
            'email': 'test.guy@example.com',
            'tz': 'UTC',
        })
    ...
    def test_02_reditor_salesman(self):
        ...
        self.start_tour(self.env['website'].get_client_action_url('/partners'), 'test_can_publish_partner', login="test")
        self.assertTrue(self.partner.website_published, "Partner should have been published")
    ...
    def test_03_reditor_not_salesman(self):
        ...
        self.start_tour(self.env['website'].get_client_action_url('/partners'), 'test_cannot_publish_partner', login="test")
