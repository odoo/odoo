    ...
    def _compute_opportunity_count(self):
        ...
        for assign_partner, partner, count in opportunity_data:
            ...
            while partner or assign_partner:
                if assign_partner and assign_partner.id in self_ids and assign_partner not in seen_partners:
                    assign_partner.opportunity_count += count
                    seen_partners.add(assign_partner)
                if partner and partner.id in self_ids and partner not in seen_partners:
