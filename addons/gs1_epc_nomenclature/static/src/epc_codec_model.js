const SCHEME_TEMPLATE = {
    ...
    0x31: {
        ...
        /*
        To be more dynamic, make a function that reconstruct elements based on AI Code
        'element_string_template': '(01) * (21) serial_integer',
        * denote that gtin (01) must be reconstructed from the fields of the model:
            -> *[foo,bar,...] would allow to define a list of fields needed
            -> otherwise, adding a variable 'AI_portion' to the FIELD_TEMPLATE elements would allow to define generic names for the AI sub-fields
        toElementString(model):
            ...
            identifiers = regex.blablabla(elment_string_template);
            for identifier in identifiers:
                elementString += getAI(identifier, model);
            return identifiers;

        getAI(identifier, model):
            if identifier == '00':
