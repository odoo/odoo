...
function toElementString(model){
    ...
    return elementString.trimStart();
}
...
function getGtin(model){
    ...
    return ' (01) ' + gtinToCheck.replace(/^0+/, '') + checkdigit;
}
...
function getGs1Checksum(data){
    ...
    // Note : same method is used for multiple data structures up to 17 digits.
