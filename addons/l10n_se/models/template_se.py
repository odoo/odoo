...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_se_template_data(self):
        return {
            'vat_disabled_tax_id': 'sale_tax_not_subject',
            'vat_disabled_purchase_tax_id': 'purchase_vat_disabled_nd',
            'code_digits': '4',
        }
    ...
    def _get_se_res_company(self):
        return {
            self.env.company.id: {
                ...
                'receivable_account_id': 'a1510',
                'payable_account_id': 'a2440',
                'account_stock_valuation_id': 'a1410',
            },
        }
