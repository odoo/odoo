...
class TestCrmStagesCase(common.TransactionCase):
    ...
    def test_00_stage_management(self):
        ...
        issue_id = project_issue.create(cr, uid, {'name':'Test1', 'stage_id': task_type_id, 'project_id':project_project_id})
        context.update({'stage_model':'project.issue'})
        ...
        check_project_task_stage_id = project_issue.browse(cr, uid, issue_id, context).stage_id.id
