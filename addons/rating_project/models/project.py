...
class Project(models.Model):
    ...
    rating_status = fields.Selection([('stage', 'Rating when changing stage'), ('periodic', 'Periodical rating'), ('no','No rating')], 'Ratings', help="How to get the customer's feedbacks?\n"
