    ...
    def _compute_owner(self):
        ...
        for equipment in self:
            if equipment.equipment_assign_to == 'employee':
                employee_user_id = equipment.employee_id.user_id
                equipment.owner_user_id = employee_user_id.id if employee_user_id else self.env.user.id
            elif equipment.equipment_assign_to == 'department':
                manager_user_id = equipment.department_id.manager_id.user_id
