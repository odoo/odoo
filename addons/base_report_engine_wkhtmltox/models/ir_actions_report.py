...
from ..engine import (
    status, wkhtmltopdf_binary, wkhtmltoimage_binary, wkhtmltoimage_version,
...
class IrActionsReport(models.Model):
    ...
    @api.model
    def _run_wkhtmltopdf(self, html, report_ref=False, landscape=False):
        ...
        with ExitStack() as stack:
            ...
            wkhtmltopdf = [wkhtmltopdf_binary] + command_args + files_command_args + paths + [pdf_report_path]
        ...
        return pdf_content, html_ids

    def _run_pdf_engine(self, engine_name, html, report_ref=False, landscape=False):
        if engine_name == 'wkhtmltopdf':
            return self._run_wkhtmltopdf(html, report_ref, landscape)
