...
class AccountEdiXmlUBL20(models.AbstractModel):
    ...
    def _get_tax_category_vals(self, invoice, tax):
        """For taxes marked as Allowance/Charge, metadata is adjusted accordingly."""
        if tax.ubl_cii_type == 'allowance_charge':
            ...
            return vals
        return super()._get_tax_category_vals(invoice, tax)
