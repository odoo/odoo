...
from odoo.addons.l10n_ch.models.res_bank import validate_l10n_ch_postal
...
class AccountBankStatementLine(models.Model):
    ...
    def _find_or_create_bank_account(self):
        if self.company_id.country_id.code == 'CH' and validate_l10n_ch_postal(self.account_number):
