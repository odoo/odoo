...
class AccountSetupBankManualConfig(models.TransientModel):
    ...
    def _onchange_recompute_qr_iban(self):
        ...
        # we want this field to be displayed in the wizard. We need to manually set account_number
        # on the inherits m2o before calling the compute function manually.
        self.res_partner_bank_id.formatted_account_number = self.formatted_account_number
