...
class PineLabsPosRequest:
    ...
    def _get_pine_labs_url(self):
        ...
        _logger.warning('To use Pine Labs outside India and Malesia, the Pine Labs Proxy Endpoint must be set because the Pine Labs test URL is only accessible in India and Malesia.')
        if self.pm.pine_labs_test_mode:
            return 'https://www.plutuscloudserviceuat.in:8201/API/CloudBasedIntegration/V1/'
        return 'https://www.plutuscloudserviceuat.in:8201/API/CloudBasedIntegration/V1/' #TODO: We will update this with the production endpoint once it becomes available.
