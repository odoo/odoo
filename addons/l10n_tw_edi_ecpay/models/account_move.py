...
class AccountMove(models.Model):
    ...
    def _l10n_tw_edi_prepare_item_list(self, json_data, is_allowance=False):
        ...
        if is_allowance:
            ...
            if exchange_difference and self.l10n_tw_edi_is_b2b:
                tax_rate = abs(self.amount_untaxed_signed) / abs(self.amount_total_signed)
                exchange_difference = self.company_id.currency_id.round(exchange_difference * tax_rate)  # Use untaxed amount for B2B credit notes
