...
class mrp_repair(osv.osv):
    ...
    _columns = {
        ...
        'product_qty': fields.float('Product Quantity', digits_compute=dp.get_precision('Quantity'),
...
class mrp_repair_line(osv.osv, ProductChangeMixin):
    ...
    _columns = {
        ...
        'product_uom_qty': fields.float('Quantity', digits_compute=dp.get_precision('Quantity'), required=True),
