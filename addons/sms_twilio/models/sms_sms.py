...
class SmsSms(models.Model):
    ...
    def _get_sms_company(self):
        # OVERRIDE sms
        return (self.mail_message_id and self.mail_message_id.record_company_id) or self.record_company_id or self.env.company
    ...
    def create(self, vals_list):
        ...
        sms.record_company_id = self.env.company
        return sms
