...
class TestFields(TransactionCaseWithUserDemo):
    ...
    def setUp(self):
        ...
        self.env.ref('test_base_new_api.discussion_0').write({'participants': [(4, self.user_demo.id)]})
        # YTI FIX ME: The cache shouldn't be inconsistent (rco is gonna fix it)
        # self.env.ref('test_base_new_api.discussion_0').participants -> 1 user
        # self.env.ref('test_base_new_api.discussion_0').invalidate_cache()
        # self.env.ref('test_base_new_api.discussion_0').with_context(active_test=False).participants -> 2 users
        self.env.ref('test_base_new_api.message_0_1').write({'author': self.user_demo.id})
    ...
    def test_01_basic_get_assertion(self):
        ...
        record = self.env.ref('test_base_new_api.message_0_0')
    ...
    def test_10_computed_custom(self):
        ...
        self.env['ir.model.fields'].create({
            ...
            'model_id': self.env.ref('test_base_new_api.model_test_new_api_message').id,
    ...
    def test_11_stored(self):
        ...
        discussion1 = self.env.ref('test_base_new_api.discussion_0')
    ...
    def test_12_cascade(self):
        ...
        message = self.env.ref('test_base_new_api.message_0_0')
    ...
    def test_21_float_digits(self):
        ...
        precision = self.env.ref('test_base_new_api.decimal_new_api_number')
    ...
    def test_40_new_ref_origin(self):
        ...
        disc = self.env.ref('test_base_new_api.discussion_0')
    ...
    def test_41_new_related(self):
        ...
        access = self.env.ref('test_base_new_api.access_discussion')
    ...
    def test_50_search_many2one(self):
        ...
        self.assertEqual(messages, self.env.ref('test_base_new_api.message_0_1'))
    ...
    def test_80_copy(self):
        ...
        discussion = self.env.ref('test_base_new_api.discussion_0')
        message = self.env.ref('test_base_new_api.message_0_0')
        message1 = self.env.ref('test_base_new_api.message_0_1')

        email = self.env.ref('test_base_new_api.emailmessage_0_0')
    ...
    def test_85_binary_guess_zip(self):
        from odoo.addons.test_base.tests.test_mimetypes import ZIP
