...
class TestUi(HttpCaseWithUserDemo):
    ...
    def test_01_admin_widget_x2many(self):
        ...
        self.start_tour("/web#action=test_base_new_api.action_discussions",
...
class TestUiTranslation(odoo.tests.HttpCase):
    ...
    def test_01_sql_constraints(self):
        ...
        self.env.ref('base.module_test_base_new_api')._update_translations(['fr_FR'])
        constraint = self.env.ref('test_base_new_api.constraint_test_new_api_category_positive_color')
        ...
        self.start_tour("/web#action=test_base_new_api.action_categories",
