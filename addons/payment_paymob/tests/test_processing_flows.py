...
class TestProcessingFlows(PaymobCommon, PaymentHttpCommon):
    ...
    def test_redirect_notification_triggers_processing(self):
        ...
        with (
            patch(
                "odoo.addons.payment_paymob.controllers.main.PaymobController"
    ...
    def test_accept_notification_with_valid_signature(self):
        ...
        self._assert_does_not_raise(
            Forbidden, PaymobController._verify_notification_signature, tx, self.webhook_data
        )
    ...
    def test_reject_notification_with_missing_signature(self):
        ...
        self.assertRaises(Forbidden, PaymobController._verify_notification_signature, payload, tx)
