...
class CrmLead(crm.models.Lead):
    ...
    order_ids = fields.One2many(sale.models.SaleOrder, 'opportunity_id', string='Orders')
    ...
    def action_sale_quotations_new(self):
        if not self.partner_id:
            return base.models.IrActions(self.env)._for_xml_id("sale_crm.crm_quotation_partner_action")
        else:
            return self.action_new_quotation()

    def action_new_quotation(self):
        action = base.models.IrActions(self.env)._for_xml_id("sale_crm.sale_action_quotations_new")
    ...
    def action_view_sale_quotation(self):
        self.ensure_one()
        action = base.models.IrActions(self.env)._for_xml_id("sale.action_quotations_with_onboarding")
        action['context'] = self._prepare_opportunity_quotation_context()
    ...
    def action_view_sale_order(self):
        self.ensure_one()
        action = base.models.IrActions(self.env)._for_xml_id("sale.action_orders")
        action['context'] = {
