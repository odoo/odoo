...
class TestBlogPerformance(UtilPerf):
    ...
    def test_10_perf_sql_blog_standard_data(self):
        self.assertEqual(self._get_url_hot_query('/blog'), 35)
    ...
    def test_20_perf_sql_blog_bigger_data_scaling(self):
        ...
        self.assertEqual(self._get_url_hot_query('/blog'), 42)
        self.assertEqual(self._get_url_hot_query(blog_post[0].website_url), 39)
    ...
    def test_30_perf_sql_blog_bigger_data_scaling(self):
        ...
        self.assertLessEqual(self._get_url_hot_query('/blog'), 79)
        self.assertLessEqual(self._get_url_hot_query(blog_post[0].website_url), 39)
