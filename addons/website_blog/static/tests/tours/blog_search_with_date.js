...
registry.category("web_tour.tours").add("blog_autocomplete_with_date", {
    steps: () => [
        ...
        {
            trigger:
                '#o_wblog_posts_loop span:has(i[data-icon="calendar_today"]):has(a[href="/blog"])',
        },
        {
        ...
        },
        {
            ...
            trigger: "#o_search_modal input.search-query ",
            run: "edit a",
        },
        {
            trigger: "#o_search_modal .o_dropdown_menu .o_search_result_item",
        },
        {
            content: "Wait for suggestions then click on search icon",
            trigger: "#o_search_modal button.oe_search_button",
            run: "click",
            expectUnloadPage: true,
        },
        {
