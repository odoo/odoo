...
registry.category("web_tour.tours").add("blog_autocomplete_with_date", {
    ...
    steps: () => [
        ...
        {
            trigger: '#o_wblog_posts_loop span:has(i.fa-calendar):has(a[href="/blog"])',
        },
        {
        ...
        },
        {
            ...
            trigger: `#o_wblog_posts_loop:has(span a[href="/blog?search=a"]):has(span i.fa-calendar):has(span a[href^="/blog?date_begin"]):has(span i.fa-search)`,
        },
    ],
});
