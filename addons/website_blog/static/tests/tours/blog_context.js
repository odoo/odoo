...
registerWebsitePreviewTour("blog_context_and_social_media", {}, () => [
    ...
    {
        trigger:
            "body:not(:has(.o_builder_sidebar_open)):not(.o_builder_open) .o_main_navbar .o_edit_website_container",
    },
    {
        content: "Click on the first article",
        trigger:
            ":iframe body[is-ready=true] article[name='blog_post'] a:contains(Start writing here....)",
        run: "click",
    },
    {
