...
registerWebsitePreviewTour(
    ...
    () => [
        ...
        ...changeOptionInPopover(
            "Blog Posts",
            "Template",
            `div[data-action-param*="website_blog.dynamic_filter_template_blog_post_card"]`
        ),
        {
            content: "Check that the new template is applied",
            trigger: ":iframe .s_dynamic_snippet_blog_posts.s_blog_post_card",
        },
        // A dynamic snippet is always visible in edit mode.
        ...isSnippetVisible(true),
        ...clickOnSave(),
...
registerWebsitePreviewTour(
    ...
    () => [
        ...isSnippetHidden(),
        {
            ...
            trigger: ":iframe .s_dynamic_snippet_blog_posts .missing_option_warning:not(.d-none)",
        },
    ]
);
