...
test("dynamic snippet blog posts loads items and displays them through template", async () => {
    ...
    const { core } = await startInteractions(`
      <div id="wrapwrap">
          <section data-snippet="s_blog_posts_big_picture" class="s_blog_posts_big_picture s_dynamic_snippet_blog_posts s_blog_post_big_picture s_blog_posts_effect_marley s_blog_posts_post_picture_size_default s_dynamic pt32 pb32 o_colored_level"
