...
export class BlogTableOfContents extends Interaction {
    ...
    generateTOC() {
        ...
        listGroup.className = "list-group list-group-flush position-relative";
        ...
        headings.forEach((heading, i) => {
            ...
            link.className = `list-group-item list-group-item-action o_wblog_toc_link o_wblog_toc_link_${level} bg-transparent border-0 position-relative small`;
