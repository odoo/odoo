(function() {
    ...
    website.EditorBarContent.include({
        start: function() {
            var self = this;
            $('a[data-action=new_blog_post]').on('click', this, function() {
                self.new_blog_post();
            });
            return this._super();
        },
        ...
        // FIXME sle: we should not override the editor to add a functionality only usable in 
        // website_blog. this should be converted into a snippet.
