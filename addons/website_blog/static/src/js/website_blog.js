$(document).ready(function() {
    ...
    $('.share_content a').on('click', function() {
        ...
        var social_network = {
            ...
            'linkedin': 'https://www.linkedin.com/shareArticle?mini=true&url=' + encodeURIComponent(url) + '&title=' + encodeURIComponent(text_to_share) + '&summary=' + encodeURIComponent($(this).attr('data-description')),
