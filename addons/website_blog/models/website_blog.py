...
class BlogPost(models.Model):
    ...
    def _default_content(self):
        ...
        return self.env['ir.ui.view'].with_context(inherit_branding=False)._render_template(
            'website.s_text_block' if is_regular_cover else 'website_blog.s_text_block_small'
        )
