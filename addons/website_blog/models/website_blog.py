...
class BlogPost(models.Model):
    ...
    author_avatar = fields.Binary(related='author_id.image_128', string="Avatar", related_inverse=True)
    author_name = fields.Char(related='author_id.display_name', string="Author Name", related_inverse=True, store=True)
    active = fields.Boolean('Active', default=True)
