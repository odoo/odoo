...
registry.category("web_tour.tours").add("SellingEventInPos", {
    steps: () =>
        [
            ...
            EventTourUtils.answerGlobalRadioOrCheckboxQuestion("Question2", "Q2-Answer1"),
            EventTourUtils.answerTicketRadioOrCheckboxQuestion("1", "Question3", "Q3-Answer1"),
            EventTourUtils.answerTicketRadioOrCheckboxQuestion("1", "Question3", "Q3-Answer3"),
            Dialog.confirm(),
            Dialog.is({ title: "Oh snap !" }),
            Dialog.confirm("Ok"),
            EventTourUtils.answerGlobalSelectQuestion("Question4", "Q4-Answer1"),
            Dialog.confirm(),
...
registry.category("web_tour.tours").add("test_selling_multiple_ticket_saved", {
    steps: () =>
        [
            ...
            Dialog.confirm(),
            EventTourUtils.answerTicketSelectQuestion("1", "Question1", "Q1-Answer1"),
            EventTourUtils.answerTicketSelectQuestion("2", "Question1", "Q1-Answer2"),
            EventTourUtils.answerGlobalRadioOrCheckboxQuestion("Question2", "Q2-Answer1"),
            EventTourUtils.answerTicketRadioOrCheckboxQuestion("1", "Question3", "Q3-Answer1"),
            EventTourUtils.answerTicketRadioOrCheckboxQuestion("1", "Question3", "Q3-Answer3"),
            Dialog.confirm(),
