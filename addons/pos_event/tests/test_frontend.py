...
class TestUi(TestPointOfSaleHttpCommon):
    ...
    def test_event_availability_in_pos(self):
        ...
        self.start_tour("/pos/ui?config_id=%d" % self.main_pos_config.id, 'CheckEventAvailability', login="pos_user")
    ...
    def test_multislot_event_availability_in_pos(self):
        ...
        self.main_pos_config.with_user(self.pos_user).open_ui()
        self.start_tour("/pos/ui?config_id=%d" % self.main_pos_config.id, 'CheckMultiSlotEventAvailability', login="pos_user")
