...
class EventTicket(models.Model):
    ...
    def get_ticket_linked_to_product_available_pos(self):
        ...
        event_ids = self.env['event.event'].with_context(context).search(
