...
class StockPicking(models.Model):
    ...
    def _package_move_lines(self, batch_pack=False, move_lines=False):
        if batch_pack:
            return super(StockPicking, self.batch_id.picking_ids if self.batch_id else self)._package_move_lines(batch_pack, move_lines)
        return super()._package_move_lines(batch_pack, move_lines)
