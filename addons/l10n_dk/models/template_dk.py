...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _setup_utility_bank_accounts(self, template_code, company, template_data):
        ...
        if template_code == 'dk':
            ...
            company.account_journal_payment_debit_account_id.tag_ids = self.env.ref('l10n_dk.account_tag_6480')
            company.account_journal_payment_credit_account_id.tag_ids = self.env.ref('l10n_dk.account_tag_6480')
