...
class TestPartnerName(TestPhCommon):
    ...
    def test_name_computation(self):
        ...
        names_to_test = {
            ...
            "Dra. Maria Clara dos Santos, CPA": ("Maria", "Clara", "dos Santos"),
            "Hon Mac Arthur Tolentino da Silva RN": ("Mac Arthur", "Tolentino", "da Silva"),
            "Fr. Jose Al Rashid MD": ("Jose", "", "Al Rashid"),
            "Gov. Ana St. Clair, PhD": ("Ana", "", "St. Clair"),
            "Ptr Sancho Panza St Maria": ("Sancho", "Panza", "St Maria"),
            "Gen Carlos von Trapp Esq.": ("Carlos", "", "von Trapp"),
            "Sec. Luz van Rijn Snr": ("Luz Snr", "", "van Rijn"),
        }
