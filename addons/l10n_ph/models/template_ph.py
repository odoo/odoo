    ...
    def _get_ph_discount_privileges(self):
        return {
            "l10n_ph_discount_privilege_sc_20_vat_incl": {
                "name": "20% Senior Citizen Discount (VAT-INCL)",
                "discount_amount": 20,
            ...
            "l10n_ph_discount_privilege_pwd_20_vat_incl": {
                "name": "20% PWD Discount (VAT-INCL)",
                "discount_amount": 20,
                "tax_id": "l10n_ph_tax_sale_vat_exempt_pwd_discount",
                "account_id": "l10n_ph_account_401022",
            },
            "l10n_ph_discount_privilege_sc_5_vat_incl": {
                "name": "5% Senior Citizen Discount (VAT-INCL)",
                "discount_amount": 5,
                "tax_id": "l10n_ph_tax_sale_12_incl",
                "account_id": "l10n_ph_account_401021",
            },
        }
