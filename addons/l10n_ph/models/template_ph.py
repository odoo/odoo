...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_ph_template_data(self):
        return {
            'property_account_receivable_id': 'l10n_ph_account_103010',
            'property_account_payable_id': 'l10n_ph_account_201010',
            'property_stock_valuation_account_id': 'l10n_ph_account_105010',
            'code_digits': '6',
        }
    ...
    def _get_ph_res_company(self):
        return {
            self.env.company.id: {
                ...
                'deferred_revenue_account_id': 'l10n_ph_account_804010',
