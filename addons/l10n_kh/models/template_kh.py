...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_kh_template_data(self):
        return {
            ...
            'property_account_income_categ_id': 'l10n_kh_20100',
    ...
    def _get_kh_res_company(self):
        return {
            self.env.company.id: {
                ...
                'income_currency_exchange_account_id': 'l10n_kh_22007',
                'expense_currency_exchange_account_id': 'l10n_kh_40016',
                ...
                'default_cash_difference_expense_account_id': 'l10n_kh_40019',
                'default_cash_difference_income_account_id': 'l10n_kh_22009',
                ...
                'account_sale_tax_id': 'l10n_kh_sale_10_m_sc_t',
                'account_purchase_tax_id': 'l10n_kh_purchase_10_m_sc',
            },
        }
    ...
    def _get_kh_account_journal(self):
        return {
            'bank': {'default_account_id': 'l10n_kh_10000'},
            'cash': {'default_account_id': 'l10n_kh_10100'},
        }
