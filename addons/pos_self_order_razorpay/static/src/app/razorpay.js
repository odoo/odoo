...
export class Razorpay {
    ...
    async cancelPayment(order) {
        ...
        try {
            const cancel_response = await this.env.services.rpc(
    ...
    async processPayment(order) {
        try {
            const initial_response = await this.env.services.rpc(
            ...
            if (initial_response) {
                this.savedOrder = initial_response.order;
    ...
    async paymentPolling(order) {
        ...
        const fetchPaymentStatus = async () => {
            try {
                ...
                const polling_response = await this.env.services.rpc(
