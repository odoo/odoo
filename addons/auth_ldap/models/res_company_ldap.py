        ...
        try:
            ...
            return {
                ...
                'params': {
                    ...
                    'message': _("Successfully connected to LDAP server at %(server)s:%(port)d", server=self.ldap_server, port=self.ldap_server_port),
                    'sticky': False,
                }
            }
            ...
            return {
                ...
                'params': {
                    ...
                    'message': _("Cannot contact LDAP server at %(server)s:%(port)d", server=self.ldap_server, port=self.ldap_server_port),
                    'sticky': False,
                }
            }
        except ldap.INVALID_CREDENTIALS:
            ...
            return {
                ...
                'params': {
                    'type': 'danger',
                    'title': _('Connection Test Failed!'),
                    'message': _("Connection to LDAP server at %(server)s:%(port)d timed out", server=self.ldap_server, port=self.ldap_server_port),
                    'sticky': False,
                }
            }
        except ldap.LDAPError as e:
