...
class TestSaleExpense(TestExpenseCommon, TestSaleCommon):
    ...
    def test_sale_expense(self):
        ...
        self.assertRecordValues(sol, [{
            'product_uom_qty': 1.0,
            'qty_delivered': 1.0,
            'price_unit': exp.untaxed_amount_currency,
            'price_subtotal': exp.untaxed_amount_currency,
        }])
        ...
        self.assertRecordValues(sol, [{
            'product_uom_qty': exp.quantity,
            'qty_delivered': exp.quantity,
            'price_unit': prod_exp_2.list_price,
            'price_subtotal': expected_amount,
        }])
