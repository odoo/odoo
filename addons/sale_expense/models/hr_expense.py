...
class Expense(hr_expense.models.HrExpense):

    sale_order_id = fields.Many2one(sale.models.SaleOrder, compute='_compute_sale_order_id', store=True, string='Customer to Reinvoice', readonly=False, tracking=True,
