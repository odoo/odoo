...
class AccountAnalyticLine(models.Model):
    ...
    def create(self, vals_list):
        ...
        if skipped_vals:
            if valid_vals:
                message = self.env._("Some of the timesheet entries were not created as no valid work intervals were available")
            else:
                message = self.env._("No timesheet entries were not created as no valid work intervals were available")
