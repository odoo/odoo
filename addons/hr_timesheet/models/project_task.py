...
class Task(models.Model):
    ...
    allow_timesheets = fields.Boolean(
        ...
        compute_sudo=True, readonly=True, recursive=True,
    ...
    @api.depends('project_root_id.allow_timesheets')
    def _compute_allow_timesheets(self):
        for task in self:
            task.allow_timesheets = task.project_root_id.allow_timesheets
    ...
    def _search_allow_timesheets(self, operator, value):
        ...
        return [('project_root_id', 'in', list(query))]
