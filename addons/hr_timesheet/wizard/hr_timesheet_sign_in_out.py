...
class hr_so_project(osv.osv_memory):
    ...
    _columns = {
        ...
        'state': fields.related('emp_id', 'state', string='Current Status', type='selection', selection=[('present', 'Present'), ('absent', 'Absent'), ('action','Action')], required=True, readonly=True),
