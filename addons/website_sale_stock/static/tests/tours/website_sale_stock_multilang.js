...
registry.category("web_tour.tours").add('website_sale_stock_multilang', {
    ...
    steps: () => [{
        ...
        trigger: '#out_of_stock_message_badge:contains("Hors-stock"), [name="click_and_collect_availability"]:contains("Pas disponible")',
    }, {
        content: "Check price",
        ...
        content: "Check out of stock message",
        trigger: '#out_of_stock_message_badge:contains("Out of stock"), [name="click_and_collect_availability"]:contains("Not available")',
    }, {
        content: "Check price",
        trigger: 'span:contains("123.45")',
    }, {
