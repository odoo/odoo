    ...
    steps: () => [
        {
            ...
            trigger: '#out_of_stock_message:contains("Hors-stock"), [name="click_and_collect_availability"]:contains("Hors-stock")',
        }, {
            content: "Check price",
            ...
            content: "Check out of stock message",
            trigger: '#out_of_stock_message:contains("Out of stock"), [name="click_and_collect_availability"]:contains("Out of stock")',
        }, {
            content: "Check price",
            trigger: 'span:contains("123.45")',
        }, {
