...
class TestWebsiteSaleStockProductConfigurator(TestProductConfiguratorCommon, HttpCaseWithUserPortal, HttpCaseWithUserEditor):
    ...
    def test_01_stock_message_update_after_close_with_optional_products(self):
        ...
        self.start_tour("/", 'website_sale_stock_message_after_close_onfigurator_modal_with_optional_products', login="editor")
    ...
    def test_02_stock_message_update_after_close_without_optional_products(self):
        ...
        self.start_tour("/", 'website_sale_stock_message_after_close_onfigurator_modal_without_optional_products', login="editor")
