...
from odoo.tools.assets.esm_bridges import _lexed_imports
...
class TestIndexModuleRelativeImports(unittest.TestCase):
    def test_a_sibling_of_an_index_module_lives_under_the_index_directory(self):
        self.assertEqual(
            _resolve_export_specifier(INDEX_SPEC, "./base.js", INDEX_URL),
    ...
    def test_without_the_url_the_specifier_alone_is_a_wrong_guess(self):
        ...
        self.assertEqual(
            _resolve_export_specifier(INDEX_SPEC, "./base.js"),
    ...
    def test_a_plain_module_resolves_the_same_either_way(self):
        ...
        self.assertEqual(
            _resolve_export_specifier(spec, "../browser/browser.js", url),
            _resolve_export_specifier(spec, "../browser/browser.js"),
        )
