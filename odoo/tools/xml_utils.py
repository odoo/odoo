...
def create_xml_node_chain(first_parent_node, nodes_list, last_node_value=None, return_node=None):
    ...
    in nodes_list as children of node first_parent_node (previously created by
    etree), setting the value of the last of these nodes to last_node_value if it is
...
def create_xml_node(parent_node, node_name, node_value=None):
    ...
    node_name as a child of given parent_node node and assigns it str_value as its
    value.
    :param parent_node: valid etree Element
    :param node_name: string
    :param node_value: string
    """
    return create_xml_node_chain(parent_node, [node_name], node_value, node_name)
