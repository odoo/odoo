...
class configmanager(object):
    ...
    def _parse_config(self, args=None):
        ...
        for arg in keys:
            ...
            # ... or keep, but cast, the config file value.
                ...
                isinstance(self.options[arg], pycompat.string_types)
        ...
        self.options["root_path"] = os.path.abspath(
            os.path.expanduser(
    ...
    def _check_addons_path(self, option, opt, value, parser):
        ...
        for path in value.split(","):
            ...
            if not self._is_addons_path(res):
                raise optparse.OptionValueError(
                    "option %s: The addons-path %r does not seem to a be a valid Addons Directory!"
                    % (opt, path)
                )
            ad_paths.append(res)
    ...
    def __setitem__(self, key, value):
        ...
        if (
            key in self.options
            and isinstance(self.options[key], pycompat.string_types)
