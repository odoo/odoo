    ...
    for tok, value, (lineno, _), _, _ in tokens:
        if call_stack == -1 and tok == NAME and value in ("def", "class"):
            ...
            if closing_parenthesis or nested:
                ...
                if funcname in keywords and messages is not None and not ignores[-1]:
                ...
                if nested:
                    funcname = value
            elif tok == STRING and funcname in keywords:
    ...
    for token in tokenize(
        ...
        if options.get("parse_template_string") and not funcname and token.type == "template_string":
            ...
            if closing_parenthesis or nested:
                ...
                if messages is not None and funcname in keywords:
