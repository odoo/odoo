...
if TYPE_CHECKING:
    ...
    # (line_no: int, messages: str | tuple[str, ...], comments: list[str], context: str | None)
    #   - `line_no`: The line number of the extracted term(s)
    ...
    for token in tokenize(
        ...
        if (
            ...
            if token.type == 'operator' and token.value == ')':
                ...
                line_no = function_stack[-1]['message_line_no'] or function_stack[-1]['function_line_no']
                cur_translator_comments = function_stack[-1]['translator_comments']
                ...
                if cur_translator_comments and cur_translator_comments[-1][0] < line_no - 1:
