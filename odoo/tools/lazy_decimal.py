#
# This is a copy of the original decimal.py file as founded in Python 2.7.13
# on 2017-01-27
#
...
# LazyDecimal('0')
#
# For the two statements above, OriginalDecimal would raise an exception
#
# >>> LazyDecimal(1.1)
# LazyDecimal('1.1')
#
# OriginalDecimal would give
# Decimal('1.100000000000000088817841970012523233890533447265625')
#
# >>> LazyDecimal(1.1) / 2.5
# LazyDecimal('0.44')
#
# OriginalDecimal would raise an TypeError;
# OriginalDecimal(1.1) / OriginalDecimal(2.5) gives
# Decimal('0.4400000000000000355271367880')
#
...
class Decimal(object):
    ...
    def __new__(cls, value="0", context=None):
        ...
        #
        # Lazyly assumes that None is meant to be 0
        #
        if value is None:
            self._sign = 0
            self._exp = 0
        ...
        if isinstance(value, basestring):
            #
            # Lazyly assumes that an empty string is meant to be 0
            #
        ...
        if isinstance(value, (Decimal, OriginalDecimal)):
    ...
    def from_float(cls, f):
        ...
        #
        # This is lazy converting float from its repr
        #
        '''
...
def _convert_other(other, raiseit=False, allow_float=True):
    ...
    if isinstance(other, Decimal):
        return other
    if isinstance(other, OriginalDecimal):
...
def json_decimal_default(obj):
    if isinstance(obj, OriginalDecimal) or isinstance(obj, Decimal):
