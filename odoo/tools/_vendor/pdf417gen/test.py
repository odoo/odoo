...
class CompactionTest(TransactionCase):
    ...
    def test_numbers_compactor(self):
        ...
        assert list(Numeric.compact_numbers(numbers)) == [112, 434]
...
class InitTest(TransactionCase):
    ...
    def test_split_to_chunks(self, data, expected):
        ...
        assert list(Init._split_to_chunks(data)) == expected
...
class ConsoleTest(TransactionCase):
    ...
    def test_encode_no_input(self, render_image, encode, read, capsys):
        ...
        Rendering.render_image.assert_not_called()
...
class EncodingTest(TransactionCase):
    ...
    def test_encode_high(self):
        ...
        assert Encoding.encode_high(Util.to_bytes(self.TEST_DATA), 6, 2) == expected
    ...
    def test_encode_low(self):
        ...
        assert list(Encoding.encode(self.TEST_DATA, 6, 2)) == expected
    ...
    def test_encode_unicode(self):
        ...
        assert Encoding.encode(uc) == expected
        assert Encoding.encode(by) == expected
...
class RenderingTest(TransactionCase):
    ...
    def test_rgb_to_hex(self):
        assert Rendering.rgb_to_hex((255, 0, 0)) == "#ff0000"
        assert Rendering.rgb_to_hex((0, 255, 0)) == "#00ff00"
        assert Rendering.rgb_to_hex((0, 0, 255)) == "#0000ff"

        assert Rendering.rgb_to_hex((100, 0, 0)) == "#640000"
        assert Rendering.rgb_to_hex((0, 100, 0)) == "#006400"
        assert Rendering.rgb_to_hex((0, 0, 100)) == "#000064"

        assert Rendering.rgb_to_hex((111, 222, 32)) == "#6fde20"
...
class ErrorCorrectionTest(TransactionCase):
    ...
    def test_error_correction(self):
        ...
        assert ErrorCorrection.compute_error_correction_code_words(data, 0) == expected_level_0
        assert ErrorCorrection.compute_error_correction_code_words(data, 1) == expected_level_1
        assert ErrorCorrection.compute_error_correction_code_words(data, 2) == expected_level_2
        assert ErrorCorrection.compute_error_correction_code_words(data, 3) == expected_level_3
        assert ErrorCorrection.compute_error_correction_code_words(data, 4) == expected_level_4
        assert ErrorCorrection.compute_error_correction_code_words(data, 5) == expected_level_5
        assert ErrorCorrection.compute_error_correction_code_words(data, 6) == expected_level_6
        assert ErrorCorrection.compute_error_correction_code_words(data, 7) == expected_level_7
        assert ErrorCorrection.compute_error_correction_code_words(data, 8) == expected_level_8
