...
class Module(Command):
    ...
    def show_modules(self, modules):
        for module in modules:
            source_version = module.latest_version or '-'
            target_version = module.installed_version or '-'
            description = module.shortdesc or '-'
            print(module.name, source_version, target_version, repr(module.state), description)  # noqa: T201
