...
class Test_Inherit_Daughter(Test_Inherit_Daughter):
...
# pylint: disable=E0102
class Test_Inherit_Property(Test_Inherit_Property):  # noqa: F811
...
class Test_Inherit_Child(models.AbstractModel, Test_Inherit_Parent):
...
# pylint: disable=E0102
class Test_Inherit_Parent(Test_Inherit_Parent):  # noqa: F811
