...
class TestTranslationRelated(odoo.tests.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.test1 = cls.env['test.translation.related.model1'].with_context(lang='en_US').create({
            'name': 'Knife',
        ...
        cls.test12 = cls.env['test.translation.related.model1'].with_context(lang='en_US').create({
            'name': 'Knife 2',
        ...
        cls.test2 = cls.env['test.translation.related.model2'].with_context(lang='en_US').create({
            'parent_id': cls.test1.id,
        })
        cls.test3 = cls.env['test.translation.related.model3'].with_context(lang='en_US').create({
    ...
    def test_import_from_po(self):
        ...
        po_string = '''
                #. module: test_translation_related
                #: model:test.translation.related.model1,name:%s
                msgid "Knife"
