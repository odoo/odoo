...
},
{
    ...
    content: "Search for the_flow.product.",
    run: "edit the_flow.product",
},
{
    isActive: ["mobile"],
    trigger: ".o_searchview_autocomplete .dropdown-item:first, .o_searchview_autocomplete .o-dropdown-item:first",
    content: "Confirm the search filter.",
    run: "click",
},
{
    isActive: ["desktop"],
...
{
    isActive: ["mobile"],
    trigger: ".o_kanban_record:contains('the_flow.product') button:contains('Add')",
    content: "Add the_flow.product from catalog.",
    run: "click",
},
{
    isActive: ["mobile"],
    trigger: ".o-kanban-button-back",
    content: "Go back to the quotation.",
    run: "click",
}, {
...
},
{
    isActive: ["mobile"],
    trigger: ".o_searchview input",
    content: "Search for the_flow.service.",
    run: "edit the_flow.service",
},
{
    isActive: ["mobile"],
...
{
    isActive: ["mobile"],
    trigger: ".o_kanban_record:contains('the_flow.service') button:contains('Add')",
    content: "Add the_flow.service from catalog.",
    run: "click",
},
{
    isActive: ["mobile"],
