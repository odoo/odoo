...
...stepUtils.goToAppSteps('crm.crm_menu_root', markup(_t('Organize your sales activities with the <b>CRM app</b>.'))),
{
    ...
    content: _t('Let\'s enter the name.'),
    position: 'left',
    run: "clear && fill the_flow.customer",
}, {
    mobile: false,
