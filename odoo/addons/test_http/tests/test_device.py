...
class TestDevice(TestHttpBase):
    ...
    def setUp(self):
        ...
        self.UA_linux_chrome = 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36'
        self.UA_linux_firefox = 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:126.0) Gecko/20100101 Firefox/126.0'
        self.UA_android_chrome = 'Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Mobile Safari/537.36'
    ...
    def get_devices_logs(self, user=None):
        ...
        logs = self.DeviceLog.search([
            ...
            ('name', 'in', devices.mapped('name')),
            ('ip_address', 'in', devices.mapped('ip_address'))
        ])
        return devices, logs
    ...
    def test_detection_device_readonly(self):
        ...
        self.hit('2024-01-01 08:00:00', '/test_http/honeypot_readonly')
    ...
    def test_detection_device_no_readonly(self):
        session = self.authenticate(self.user_admin.login, self.user_admin.login)
        self.hit('2024-01-01 08:00:00', '/test_http/honeypot_no_readonly')
    ...
    def test_detection_user_public(self):
        ...
        self.hit('2024-01-01 08:00:00', '/test_http/honeypot_public')
    ...
    def test_detection_device_according_to_time(self):
        ...
        self.hit('2024-01-01 08:30:00', '/test_http/honeypot_no_readonly')
        ...
        self.hit('2024-01-01 09:00:00', '/test_http/honeypot_no_readonly')
        ...
        self.hit('2024-01-01 10:00:00', '/test_http/honeypot_no_readonly')
    ...
    def test_detection_device_according_to_useragent(self):
        ...
        self.hit('2024-01-01 08:00:00', '/test_http/honeypot_no_readonly', headers={'User-Agent': self.UA_linux_chrome})
        ...
        self.hit('2024-01-01 08:00:00', '/test_http/honeypot_no_readonly', headers={'User-Agent': self.UA_linux_firefox})
    ...
    def test_detection_device_according_to_ipaddress(self):
        ...
        self.hit('2024-01-01 08:00:00', '/test_http/honeypot_no_readonly', ip=TEST_IP)
    ...
    def test_detection_usurpation_sid(self):
        ...
        self.hit('2024-01-01 08:00:00', '/test_http/honeypot_auth_user')

        self.hit('2024-01-01 08:00:00', '/test_http/honeypot_auth_user', headers={'session_id': session.sid}, ip=TEST_IP)
    ...
    def test_detection_devices_according_to_time_useragent(self):
        ...
        self.hit('2024-01-01 09:00:00', '/test_http/honeypot_no_readonly', headers={'User-Agent': self.UA_linux_chrome})
        self.assertEqual(len(self.user_admin.device_ids), 1)

        self.hit('2024-01-01 08:00:00', '/test_http/honeypot_no_readonly', headers={'User-Agent': self.UA_linux_firefox})
        self.assertEqual(len(self.user_admin.device_ids), 2)

        self.hit('2024-01-01 09:00:00', '/test_http/honeypot_no_readonly', headers={'User-Agent': self.UA_linux_firefox})
        self.assertEqual(len(self.user_admin.device_ids), 2)
    ...
    def test_differentiate_laptop_and_mobile(self):
        self.authenticate(self.user_admin.login, self.user_admin.login)
        self.hit('2024-01-01 08:00:00', '/test_http/honeypot_no_readonly', headers={'User-Agent': self.UA_linux_chrome})
        self.hit('2024-01-01 08:00:00', '/test_http/honeypot_no_readonly', headers={'User-Agent': self.UA_android_chrome})

        devices, logs = self.get_devices_logs(self.user_admin)
        self.assertEqual(len(devices), 2)
        self.assertEqual(len(logs), 2)

        laptop_device = devices.filtered(lambda device: device.device_type == 'laptop')
    ...
    def test_deletion_device(self):
        ...
        """
        self.authenticate(self.user_internal.login, self.user_internal.login)
        res = self.hit('2024-01-01 08:00:00', '/test_http/honeypot_auth_user')
        ...
        self.assertEqual(user_internal_device.exist, True)

        user_internal_device._revoke()

        res = self.hit('2024-01-01 08:00:01', '/test_http/honeypot_auth_user')
    ...
    def test_deletion_invalidate_sid(self):
        ...
        res = self.hit('2024-01-01 08:00:00', '/test_http/honeypot_auth_user', headers={'session_id': session.sid})
        self.assertIn('/web/login', res.url)

    def test_deletion_specific_device(self):
        self.authenticate(self.user_admin.login, self.user_admin.login)
        self.hit('2024-01-01 08:00:00', '/test_http/honeypot_auth_user', headers={'User-Agent': self.UA_linux_chrome})
        self.hit('2024-01-01 09:00:00', '/test_http/honeypot_auth_user', headers={'User-Agent': self.UA_linux_chrome})
        self.authenticate(self.user_admin.login, self.user_admin.login)
        self.hit('2024-01-01 08:00:00', '/test_http/honeypot_auth_user', headers={'User-Agent': self.UA_linux_chrome})
        self.hit('2024-01-01 09:00:00', '/test_http/honeypot_auth_user', headers={'User-Agent': self.UA_linux_chrome})
        self.hit('2024-01-01 08:00:00', '/test_http/honeypot_auth_user', headers={'User-Agent': self.UA_linux_firefox})
        ...
        self.user_admin.device_ids.filtered(lambda device: 'Firefox' in device.name)._revoke()

        res = self.hit('2024-01-01 08:00:30', '/test_http/honeypot_auth_user', headers={'User-Agent': self.UA_linux_firefox})
        self.assertIn('/web/login', res.url)
