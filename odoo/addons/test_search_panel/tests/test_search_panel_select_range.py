...
class TestSelectRange(odoo.tests.TransactionCase):
    ...
    def test_many2one(self):
        ...
        self.assertEqual(
            result['values'],
            [
                {'count': 2, 'display_name': 'Folder 1',
                    'id': f1_id, 'parent_name_id': False, },
                {'count': 1, 'display_name': 'Folder 2',
        ...
        self.assertEqual(
            result['values'],
            [
                {'count': 0, 'display_name': 'Folder 1',
                    'id': f1_id, 'parent_name_id': False, },
                {'count': 0, 'display_name': 'Folder 2',
                    'id': f2_id, 'parent_name_id': False, },
                {'count': 0, 'display_name': 'Folder 3',
                    'id': f3_id, 'parent_name_id': f1_id, },
        ...
        self.assertEqual(
            ...
            [
                ...
                {'count': 1, 'display_name': 'Folder 3', 'id': f3_id, },
                {'count': 1, 'display_name': 'Folder 4', 'id': f4_id, },
            ]
        )
        self.assertEqual(
            result['parent_field'],
        ...
        self.assertEqual(
            ...
            [
                ...
                {'count': 0, 'display_name': 'Folder 4', 'id': f4_id, },
            ]
        )
        self.assertEqual(
            result['parent_field'],
    ...
    def test_many2one_deep_hierarchy(self):
        ...
        self.assertEqual(
            result['values'],
            [
                {'count': 3, 'display_name': 'Folder 1',
                    'id': f1_id, 'parent_name_id': False, },
                {'count': 1, 'display_name': 'Folder 10',
                    'id': f10_id, 'parent_name_id': f8_id, },
                {'count': 3, 'display_name': 'Folder 2',
                    'id': f2_id, 'parent_name_id': False, },
                {'count': 0, 'display_name': 'Folder 3',
                    'id': f3_id, 'parent_name_id': False, },
                {'count': 2, 'display_name': 'Folder 4',
                    'id': f4_id, 'parent_name_id': f1_id, },
                {'count': 0, 'display_name': 'Folder 5',
                    'id': f5_id, 'parent_name_id': f2_id, },
                {'count': 3, 'display_name': 'Folder 6',
                    'id': f6_id, 'parent_name_id': f2_id, },
                {'count': 2, 'display_name': 'Folder 7',
                    'id': f7_id, 'parent_name_id': f4_id, },
                {'count': 2, 'display_name': 'Folder 8',
                    'id': f8_id, 'parent_name_id': f6_id, },
                {'count': 1, 'display_name': 'Folder 9',
