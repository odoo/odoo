...
class TestBasic(TransactionCase):
    ...
    def test_defaults(self):
        ...
        r = f.save()
        self.assertEqual((r.f1, r.f2, r.f3, r.f4), (4, 8, 4, 2))
...
class TestM2O(TransactionCase):
    ...
    def test_default_and_onchange(self):
        ...
        self.assertEqual(
            f.f, a, "The default value for the m2o should be the first Sub record"
        )
        f.f2 = "B"
        self.assertEqual(
...
class TestM2M(TransactionCase):
    ...
    def test_m2m_readonly(self):
        ...
        a = Sub.create({"name": "a"})
        b = Sub.create({"name": "b"})
        r = self.env["test_testing_utilities.g"].create({"m2m": [(6, 0, a.ids)]})
...
class TestO2M(TransactionCase):
    ...
    def test_m2o_readonly(self):
        r = self.env["test_testing_utilities.parent"].create({"subs": [(0, 0, {})]})
...
class TestEdition(TransactionCase):
    ...
    def test_trivial(self):
        r = self.env["test_testing_utilities.a"].create({"f1": 5})
    ...
    def test_m2o(self):
        ...
        r = self.env["test_testing_utilities.d"].create({"f": c.id, "f2": "OK"})
