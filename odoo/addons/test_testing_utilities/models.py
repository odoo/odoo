...
class M2MChange2(models.Model):
    ...
    m2m = fields.Many2many("test_testing_utilities.sub2", default=_get_some)
...
class O2MDefault(models.Model):
    ...
    subs = fields.One2many(
        "test_testing_utilities.sub3", "parent_id", default=_default_subs
    )
