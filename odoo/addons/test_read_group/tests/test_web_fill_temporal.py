...
class TestFillTemporal(common.TransactionCase):
    ...
    def test_date_range_and_flag(self):
        ...
        expected = [{
            '__domain_part': ['&', ('date', '>=', '1916-08-01'), ('date', '<', '1916-09-01')],
            'date:month': ('1916-08-01', 'August 1916'),
            '__count': 1,
            'value:sum': 2,
        }, {
            '__domain_part': ['&', ('date', '>=', '1916-09-01'), ('date', '<', '1916-10-01')],
            'date:month': ('1916-09-01', 'September 1916'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1916-10-01'), ('date', '<', '1916-11-01')],
            'date:month': ('1916-10-01', 'October 1916'),
            '__count': 1,
            'value:sum': 3,
        }, {
            '__domain_part': ['&', ('date', '>=', '1916-11-01'), ('date', '<', '1916-12-01')],
            'date:month': ('1916-11-01', 'November 1916'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1916-12-01'), ('date', '<', '1917-01-01')],
    ...
    def test_date_range_with_context_timezone(self):
        ...
        expected = [{
            '__domain_part': ['&', ('date', '>=', '1915-01-01'), ('date', '<', '1915-02-01')],
            'date:month': ('1915-01-01', 'January 1915'),
            '__count': 1,
            'value:sum': 3,
        }, {
            '__domain_part': ['&', ('date', '>=', '1915-02-01'), ('date', '<', '1915-03-01')],
            'date:month': ('1915-02-01', 'February 1915'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1915-03-01'), ('date', '<', '1915-04-01')],
            'date:month': ('1915-03-01', 'March 1915'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1915-04-01'), ('date', '<', '1915-05-01')],
            'date:month': ('1915-04-01', 'April 1915'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1915-05-01'), ('date', '<', '1915-06-01')],
            'date:month': ('1915-05-01', 'May 1915'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1915-06-01'), ('date', '<', '1915-07-01')],
            'date:month': ('1915-06-01', 'June 1915'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1915-07-01'), ('date', '<', '1915-08-01')],
            'date:month': ('1915-07-01', 'July 1915'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1915-08-01'), ('date', '<', '1915-09-01')],
            'date:month': ('1915-08-01', 'August 1915'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1915-09-01'), ('date', '<', '1915-10-01')],
            'date:month': ('1915-09-01', 'September 1915'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1915-10-01'), ('date', '<', '1915-11-01')],
            'date:month': ('1915-10-01', 'October 1915'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1915-11-01'), ('date', '<', '1915-12-01')],
            'date:month': ('1915-11-01', 'November 1915'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1915-12-01'), ('date', '<', '1916-01-01')],
            'date:month': ('1915-12-01', 'December 1915'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1916-01-01'), ('date', '<', '1916-02-01')],
    ...
    def test_only_with_only_null_date(self):
        ...
        expected = [{'__domain_part': [('date', '=', False)],
                     '__count': 3,
                     'value:sum': 41,
                     'date:month': False}]
    ...
    def test_date_range_groupby_week(self):
        ...
        expected = [{
            '__domain_part': ['&', ('date', '>=', '1916-08-13'), ('date', '<', '1916-08-20')],
            'date:week': ('1916-08-13', 'W34 1916'),
            '__count': 2,
            'value:sum': 7,
        }, {
            '__domain_part': ['&', ('date', '>=', '1916-08-20'), ('date', '<', '1916-08-27')],
            'date:week': ('1916-08-20', 'W35 1916'),
            '__count': 1,
            'value:sum': 13,
        }, {
            '__domain_part': ['&', ('date', '>=', '1916-08-27'), ('date', '<', '1916-09-03')],
            'date:week': ('1916-08-27', 'W36 1916'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1916-09-03'), ('date', '<', '1916-09-10')],
            'date:week': ('1916-09-03', 'W37 1916'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1916-09-10'), ('date', '<', '1916-09-17')],
    ...
    def test_with_bounds(self):
        ...
        expected = [{
            '__domain_part': ['&', ('date', '>=', '1916-02-01'), ('date', '<', '1916-03-01')],
            'date:month': ('1916-02-01', 'February 1916'),
            '__count': 1,
            'value:sum': 1,
        }, {
            '__domain_part': ['&', ('date', '>=', '1916-05-01'), ('date', '<', '1916-06-01')],
            'date:month': ('1916-05-01', 'May 1916'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1916-06-01'), ('date', '<', '1916-07-01')],
            'date:month': ('1916-06-01', 'June 1916'),
            '__count': 1,
            'value:sum': 2,
        }, {
            '__domain_part': ['&', ('date', '>=', '1916-07-01'), ('date', '<', '1916-08-01')],
    ...
    def test_with_bounds_groupby_week(self):
        ...
        expected = [{
            '__domain_part': ['&', ('date', '>=', '1916-08-06'), ('date', '<', '1916-08-13')],
            ...
            '__domain_part': ['&', ('date', '>=', '1916-09-17'), ('date', '<', '1916-09-24')],
    ...
    def test_upper_bound(self):
        ...
        expected = [{
            ...
            '__domain_part': ['&', ('date', '>=', '1916-03-01'), ('date', '<', '1916-04-01')],
            'date:month': ('1916-03-01', 'March 1916'),
            '__count': 0,
            'value:sum': False,
        }, {
            '__domain_part': ['&', ('date', '>=', '1916-04-01'), ('date', '<', '1916-05-01')],
