...
class TestFillTemporal(common.TransactionCase):
    ...
    def test_date_range_with_context_timezone(self):
        ...
        whole year was displayed in a graph like this :

            JAN  FEB  MAR  * x *  MAY  JUNE  JULY  AUG  SEP  OCT * OCT *  NOV
    ...
    def test_egde_fx_tz(self):
        ...
        inside the datebase. We are in winter time so 'Asia/Hovd' is UTC+7 :
                 ...
                 '2018-01-01 21:00:00'   -->  '2017-12-31 21:00:00'

        Now that same user groups, we must ensure that that last one is displayed
        in January not in December.
