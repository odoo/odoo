...
class TestFormattedReadGroup(common.TransactionCase):
    ...
    def test_related(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                {'__count': 2, '__extra_domain': [('foo_id_name_sudo', '=', '')], 'foo_id_name_sudo': ''},
            ]
        )
        ...
        for fname in ('foo_id_bar_id_name', 'foo_id_bar_name', 'foo_id_bar_name_sudo'):
            ...
            expected = [
                ...
                {'__count': 2, '__extra_domain': [(fname, '=', '')], fname: ''},
            ]
    ...
    def test_inherited(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                {'__count': 1, '__extra_domain': [('name', '=', '')], 'name': ''},
            ]
        )
        ...
        self.assertEqual(
            ...
            [
                ...
                {'__extra_domain': [('name', '=', '')], 'name': '', 'value:sum': 4},
            ]
        )
        ...
        self.assertEqual(
            ...
            [
                {'__count': 5, '__extra_domain': [('foo_id_name_sudo', '=', '')], 'foo_id_name_sudo': ''},
            ]
        )
    ...
    def test_groupby_chain_fnames_char(self):
        ...
        query_expected = """
            SELECT NULLIF("test_read_group_related_base__foo_id__bar_id"."name", %s),
                    COUNT(*)
            FROM "test_read_group_related_base"
            LEFT JOIN "test_read_group_related_foo" AS "test_read_group_related_base__foo_id"
                ON ("test_read_group_related_base"."foo_id" = "test_read_group_related_base__foo_id"."id")
            ...
            GROUP BY NULLIF("test_read_group_related_base__foo_id__bar_id"."name", %s)
            ORDER BY NULLIF("test_read_group_related_base__foo_id__bar_id"."name", %s) ASC
        """
            ...
            with self.assertQueries([query_expected]):
                ...
                self.assertEqual(
                    ...
                    [
                        ...
                        {
                            "__count": 2,
                            "__extra_domain": domain_for_sequence(fname_sequence, ''),
                            fname_sequence: '',
                        },
                    ],
                )
