...
class test_xids(CreatorCase):
    ...
    def test_no_module(self):
        ...
        record.invalidate_cache()
        self.assertEqual(record._export_rows([["id"], ["value"]]), [[u"x", u"True"]])
...
class test_integer_field(CreatorCase):
    ...
    def test_0(self):
        self.assertEqual(self.export(0), [[u"0"]])

    def test_basic_value(self):
        self.assertEqual(self.export(42), [[u"42"]])

    def test_negative(self):
        self.assertEqual(self.export(-32), [[u"-32"]])
...
class test_float_field(CreatorCase):
    ...
    def test_0(self):
        self.assertEqual(self.export(0.0), [[u"0.0"]])

    def test_epsilon(self):
        self.assertEqual(self.export(0.000000000027), [[u"2.7e-11"]])

    def test_negative(self):
        self.assertEqual(self.export(-2.42), [[u"-2.42"]])

    def test_positive(self):
        self.assertEqual(self.export(47.36), [[u"47.36"]])

    def test_big(self):
        self.assertEqual(self.export(87654321.4678), [[u"87654321.4678"]])
...
class test_decimal_field(CreatorCase):
    ...
    def test_epsilon(self):
        ...
        """
        self.assertEqual(self.export(0.000000000027), [[u"0.0"]])
    ...
    def test_big(self):
        self.assertEqual(self.export(87654321.4678), [[u"87654321.468"]])
...
class test_string_field(CreatorCase):
    ...
    def test_within_bounds(self):
        self.assertEqual(self.export("foobar"), [[u"foobar"]])
...
class test_date(CreatorCase):
    ...
    def test_basic(self):
        self.assertEqual(self.export("2011-11-07"), [[u"2011-11-07"]])
...
class test_datetime(CreatorCase):
    ...
    def test_basic(self):
        self.assertEqual(self.export("2011-11-07 21:05:48"), [[u"2011-11-07 21:05:48"]])
...
class test_selection(CreatorCase):
    ...
    translations_fr = [("Qux", "toto"), ("Bar", "titi"), ("Foo", "tete")]
    ...
    def test_value(self):
        ...
        """
        self.assertEqual(self.export(2), [[u"Bar"]])
    ...
    def test_localized_export(self):
        ...
        self.assertEqual(self.export(2, context={"lang": "fr_FR"}), [[u"Bar"]])
...
class test_m2o(CreatorCase):
    ...
    def test_identical(self):
        ...
        self.assertRegex(xp[0], u"__export__.export_integer_%d_[0-9a-f]{8}" % m2o)
...
class test_o2m(CreatorCase):
    ...
    names = [u"export.one2many.child:%d" % d["value"] for c, _, d in commands]
    ...
    def test_integrate_one_in_parent(self):
        self.assertEqual(
            self.export([(0, False, {"value": 42})], fields=["const", "value/value"]),
            [[u"4", u"42"]],
        )
    ...
    def test_multiple_records(self):
        self.assertEqual(
            ...
            [[u"4", u"4"], [u"", u"42"], [u"", u"36"], [u"", u"4"], [u"", u"13"]],
        )
...
class test_o2m_multiple(CreatorCase):
    ...
    def test_single_per_side(self):
        ...
        self.assertEqual(
            self.export(
                child1=[(0, False, {"value": 43})], child2=[(0, False, {"value": 42})]
            ),
    ...
    def test_single_integrate_subfield(self):
        ...
        self.assertEqual(
            self.export(
                child1=False, child2=[(0, False, {"value": 42})], fields=fields
            ),
            [[u"36", False, u"42"]],
        )
        ...
        self.assertEqual(
            self.export(
                child1=[(0, False, {"value": 43})], child2=False, fields=fields
            ),
            [[u"36", u"43", False]],
        )
...
class test_m2m(CreatorCase):
    ...
    names = [u"export.many2many.other:%d" % d["value"] for c, _, d in commands]
...
class test_function(CreatorCase):
    ...
    def test_value(self):
        ...
        """
        self.assertEqual(self.export(42), [[u"3"]])
