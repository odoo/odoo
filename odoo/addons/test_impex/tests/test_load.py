...
class test_ids_stuff(ImporterCase):
    ...
    def test_update_with_id(self):
        ...
        self.assertEqual(len(result["ids"]), 1)
        self.assertFalse(result["messages"])
        self.assertEqual([42], values(self.read()))  # updated value to imported
...
class test_boolean_field(ImporterCase):
    ...
    def test_trues(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    u"Unknown value '%s' for boolean field 'Value', assuming 'yes'"
                    % v[0],
...
class test_integer_field(ImporterCase):
    ...
    def test_positives(self):
        result = self.import_(
            ["value"], [["1"], ["42"], [str(2 ** 31 - 1)], ["12345678"]]
        )
    ...
    def test_negatives(self):
        result = self.import_(
            ["value"],
            [["-1"], ["-42"], [str(-(2 ** 31 - 1))], [str(-(2 ** 31))], ["-12345678"]],
        )
        self.assertEqual(len(result["ids"]), 5)
        self.assertFalse(result["messages"])
        self.assertEqual(
            [-1, -42, -(2 ** 31 - 1), -(2 ** 31), -12345678], values(self.read())
        )
...
class test_float_field(ImporterCase):
    ...
    def test_positives(self):
        ...
        self.assertEqual(
            [1, 42, 2 ** 31 - 1, 12345678, 2.0 ** 33, .000001], values(self.read())
        )
...
class test_string_field(ImporterCase):
    ...
    def test_imported(self):
        ...
        self.assertFalse(result["messages"])
        self.assertEqual(
            [u"foobar", u"foobarbaz", u"Með suð í eyrum ", u"People 'get' typ"],
            values(self.read()),
        )
...
class test_required_string_field(ImporterCase):
    ...
    def test_empty(self):
        ...
        self.assertEqual(
            result["messages"],
            [message(u"Missing required value for the field 'Value' (value)")],
        )
        self.assertIs(result["ids"], False)
...
class test_text(ImporterCase):
    ...
    def test_imported(self):
        s = (
            u"Breiðskífa er notað um útgefna hljómplötu sem inniheldur "
...
class test_selection(ImporterCase):
    ...
    def test_imported_translated(self):
        ...
        result = self.import_(
            ["value"], [["toto"], ["tete"], ["titi"]], context={"lang": "fr_FR"}
        )
...
class test_selection_function(ImporterCase):
    ...
    def test_translated(self):
        ...
        result = self.import_(
            ["value"], [["titi"], ["tete"]], context={"lang": "fr_FR"}
        )
        self.assertFalse(result["messages"])
        self.assertEqual(len(result["ids"]), 2)
...
class test_m2o(ImporterCase):
    ...
    def test_by_name(self):
        ...
        self.assertEqual(
            [(record1.id, name1), (record1.id, name1), (record2.id, name2)],
            values(self.read()),
        )
    ...
    def test_by_names(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    u"Found multiple matches for field 'Value' (2 matches)",
                    type="warning",
                )
            ],
        )
    ...
    def test_fail_by_implicit_id(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    u"No matching record found for name '%s' in field 'Value'" % id,
                    from_=index,
                    to_=index,
                    record=index,
    ...
    def test_fail_id_mistype(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    u"Invalid database id 'foo' for the field 'Value'",
                    moreinfo=moreaction(
    ...
    def test_sub_field(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    u"Can not create Many-To-One records indirectly, import "
...
class test_o2m(ImporterCase):
    ...
    def test_name_get(self):
        s = u"Java is a DSL for taking large XML files and converting them " u"to stack traces"
    ...
    def test_multisub(self):
        result = self.import_(
            ["const", "value/value"], [["5", "63"], ["", "64"], ["", "65"], ["", "66"]]
        )
        self.assertFalse(result["messages"])
        self.assertEqual(len(result["ids"]), 1)
    ...
    def test_link(self):
        ...
        result = self.import_(
            ["const", "value/.id"], [["42", str(id1)], ["", str(id2)]]
        )
        self.assertFalse(result["messages"])
        self.assertEqual(len(result["ids"]), 1)
...
class test_date(ImporterCase):
    ...
    def test_invalid(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    u"'not really a date' does not seem to be a valid date "
                    u"for field 'Value'",
...
class test_datetime(ImporterCase):
    ...
    def test_invalid(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    u"'not really a datetime' does not seem to be a valid "
...
class test_unique(ImporterCase):
    ...
    def test_unique(self):
        ...
        self.assertEqual(
            ...
            [
                dict(
                    message=u"The value for the field 'value' already exists "
    ...
    def test_unique_pair(self):
        ...
        self.assertItemsEqual(m.group(1).split(", "), ["value2", "value3"])
        self.assertItemsEqual(m.group(2).split(", "), ["Value2", "Value3"])
