...
class TestCompanyCheck(common.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.parent_0 = cls.env['test_orm.company_checks.parent'].create({
            'name': 'M0',
            'company_id': False,
        })
        cls.parent_a = cls.env['test_orm.company_checks.parent'].create({
            'name': 'M1',
            'company_id': cls.company_a.id,
        })
        cls.parent_b = cls.env['test_orm.company_checks.parent'].create({
            'name': 'M2',
    ...
    def test_check_company_auto(self):
        ...
        m1 = self.env['test_orm.company_checks.child'].create({'company_id': self.company_a.id})
    ...
    def test_company_and_same_company(self):
        ...
        self.env['test_orm.company_checks.child'].create({
            'name': 'M1',
    ...
    def test_no_company_check(self):
        ...
        self.env['test_orm.company_checks.child_no_check'].create({
            'name': 'M1',
            'company_id': self.company_b.id,
            'parent_id': self.parent_a.id,
        })
    ...
    def test_company_write(self):
        ...
        child = self.env['test_orm.company_checks.child'].create({
            'name': 'M1',
            'company_id': self.company_a.id,
            'parent_id': self.parent_a.id,
            'parent_ids': [Command.link(self.parent_a.id)],
    ...
    def test_check_company_write_performance(self):
        ...
        ChildModel = self.registry['test_orm.company_checks.child']
