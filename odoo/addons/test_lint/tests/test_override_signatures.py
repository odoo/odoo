...
MODEL_METHODS_TO_IGNORE = {
    ...
    ('account.journal', '_get_RmtInf_content'),
    ('acconut.move', '_get_deferred_lines_values'),
    ...
    ('ir.ui.view', 'apply_inheritance_specs'),
    ('mailing.trace', 'set_failed'),
    ('mrp.bom', '_update_order_line_info'),
    ('mrp.production', '_update_order_line_info'),
    ('mrp.production', 'action_generate_serial'),
    ('mrp.production', 'set_qty_producing'),
    ('mrp.workorder', 'button_start'),
    ('payment.provider', '_is_tokenization_required'),
    ('quality.check', 'add_check_in_chain'),
    ('payment.transaction', '_set_authorized'),
    ('payment.transaction', '_set_done'),
    ('payment.transaction', '_set_pending'),
    ('pos_preparation_display.display', '_send_load_orders_message'),
    ('product.pricelist', '_compute_price_rule'),
    ('product.template', '_get_additional_configurator_data'),
    ('product.template', '_get_configurator_price'),
    ('propose.change', '_do_remove_step'),
    ('propose.change', '_do_set_picture'),
    ('propose.change', '_do_update_step'),
    ('repair.order', '_get_product_catalog_record_lines'),
    ('report.pos_hr.single_employee_sales_report', '_get_domain'),
    ('report.pos_hr.single_employee_sales_report', 'get_sale_details'),
    ('report.mrp.report_bom_structure', '_get_bom_array_lines'),
    ('res.config.settings', 'get_values'),
    ('res.config.test', 'get_values'),
    ('res.partner', '_get_followup_responsible'),
    ('sale.commission.report', '_query'),
    ('sale.order', '_cart_add'),
    ('sale.order', '_cart_find_product_line'),
    ('sale.order', '_get_product_catalog_record_lines'),
    ('sale.order', '_prepare_order_line_values'),
    ('sale.order', '_prepare_order_line_update_values'),
    ('sale.order', '_verify_updated_quantity'),
    ('sale.order', '_action_launch_stock_rule'),
    ('sale.order.line', '_action_launch_stock_rule'),
    ('sale.order.line', '_get_qty_procurement'),
    ('sale.order.line', '_prepare_procurement_values'),
    ('sign.request', '_generate_completed_document'),
    ('stock.quant', '_get_product_available_qty'),
