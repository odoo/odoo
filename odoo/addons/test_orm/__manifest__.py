{
    ...
    "data": [
        ...
        "views/test_translation_import.xml",
    ],
    "assets": {
        'web.assets_backend': [
            'test_orm/static/src/xml/js_templates.xml',
        ],
        "web.assets_tests": [
        ...
        "test_orm.manifest1": [
            "test_orm/static/assets_bundle_valid_src/*/**",
        ],
        "test_orm.manifest2": [
            "test_orm/static/assets_bundle_valid_src/js/test_jsfile1.js",
            "test_orm/static/assets_bundle_valid_src/*/**",
        ...
        "test_orm.broken_css": [
            "test_orm/static/assets_bundle_invalid_src/css/invalid_css.css",
        ],
        "test_orm.lazy_test_component": [
            "test_orm/static/tests/lazy_test_component/**/*",
        ],
        "test_orm.broken_xml": [
            "test_orm/static/assets_bundle_invalid_src/xml/invalid_xml.xml",
        ],
        "test_orm.multiple_broken_xml": [
            "test_orm/static/assets_bundle_invalid_src/xml/invalid_xml.xml",
            "test_orm/static/assets_bundle_invalid_src/xml/second_invalid_xml.xml",
        ],
        "test_orm.multiple_same_name": [
            "test_orm/static/assets_bundle_invalid_src/xml/multiple_same_name.xml",
        ],
        "test_orm.wo_name": [
            "test_orm/static/assets_bundle_invalid_src/xml/template_wo_name.xml",
        ],
        "test_orm.file_not_found": [
            "test_orm/static/assets_bundle_invalid_src/xml/file_not_found.xml",
        ],
    },
    "author": "Odoo S.A.",
    "license": "LGPL-3",
