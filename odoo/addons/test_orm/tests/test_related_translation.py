...
class TestRelatedTranslation(odoo.tests.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.test1 = cls.env['r_translation.related_translation_1'].with_context(lang='en_US').create({
            'name': 'Knife',
        ...
        cls.test12 = cls.env['r_translation.related_translation_1'].with_context(lang='en_US').create({
            'name': 'Knife 2',
        ...
        cls.test2 = cls.env['r_translation.related_translation_2'].with_context(lang='en_US').create({
            'related_id': cls.test1.id,
        })
        cls.test3 = cls.env['r_translation.related_translation_3'].with_context(lang='en_US').create({
    ...
    def test_import_from_po(self):
        ...
        po_string = '''
                #. module: r_translation
                #: model:r_translation.related_translation_1,name:%s
                msgid "Knife"
    ...
    def test_new_records(self):
        ...
        model = self.env['r_translation.related_translation_1']
        ...
        child_en = self.env['r_translation.related_translation_2'].new({'related_id': record_en.id})
