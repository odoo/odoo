...
class TestFields(TransactionCaseWithUserDemo, TransactionExpressionCase):
    ...
    def setUp(self):
        ...
        super().setUp()
        self.env.ref('test_orm.fields_discussion_0').write({'participants': [Command.link(self.user_demo.id)]})
        # YTI FIX ME: The cache shouldn't be inconsistent (rco is gonna fix it)
        # self.env.ref('test_orm.fields_discussion_0').participants -> 1 user
        # self.env.ref('test_orm.fields_discussion_0').invalidate()
        # self.env.ref('test_orm.fields_discussion_0').with_context(active_test=False).participants -> 2 users
        self.env.ref('test_orm.fields_message_0_1').write({'author': self.user_demo.id})

    def test_00_basics(self):
        """ test accessing new fields """
        # find a discussion
        discussion = self.env.ref('test_orm.fields_discussion_0')
    ...
    def test_01_basic_get_assertion(self):
        ...
        record = self.env.ref('test_orm.fields_message_0_0')
    ...
    def test_11_stored(self):
        ...
        discussion1 = self.env.ref('test_orm.fields_discussion_0')
    ...
    def test_12_cascade(self):
        ...
        message = self.env.ref('test_orm.fields_message_0_0')
        self.env.invalidate_all()
...
%endif"""
    ...
    def test_40_new_ref_origin(self):
        ...
        disc = self.env.ref('test_orm.fields_discussion_0')
    ...
    def test_41_new_related(self):
        ...
        access = self.env.ref('test_orm.access_test_fields_discussion')
    ...
    def test_50_search_many2one(self):
        ...
        self.assertEqual(messages, self.env.ref('test_orm.fields_message_0_1'))
    ...
    def test_80_copy(self):
        discussion = self.env.ref('test_orm.fields_discussion_0')
        message = self.env.ref('test_orm.fields_message_0_0')
        message1 = self.env.ref('test_orm.fields_message_0_1')

        email = self.env.ref('test_orm.fields_emailmessage_0_0')
