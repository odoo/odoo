...
class Test_Access_Feedback_RightSome_Obj(models.Model):
...
class Test_Access_Feedback_RightInherits(models.Model):
...
class Test_Access_Feedback_RightChild(models.Model):
...
class Test_Access_Feedback_RightObj_Categ(models.Model):
