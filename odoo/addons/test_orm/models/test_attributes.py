...
class TestAttributesCategory(models.Model):
...
class TestAttributesDiscussion(models.Model):
...
class TestAttributesMessage(models.Model):
...
class TestAttributesEmailmessage(models.Model):
