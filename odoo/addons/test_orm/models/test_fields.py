...
class Test_Fields_OrderLine(models.Model):
    ...
    has_been_rewarded = fields.Char(
        compute="_compute_has_been_rewarded", store=True
    )
...
class Test_Fields_CreatePerformance(models.Model):
    ...
    tag_ids = fields.Many2many('test_fields.create.performance.line', 'perf_tag_ids')
...
class Test_Fields_Model_A(models.Model):
    ...
    name = fields.Char()
    a_restricted_b_ids = fields.Many2many('test_fields.model_b', relation='rel_fields_model_a_model_b_1')
    b_restricted_b_ids = fields.Many2many('test_fields.model_b', relation='rel_fields_model_a_model_b_2', ondelete='restrict')
...
class Test_Fields_Model_B(models.Model):
    ...
    name = fields.Char()
    a_restricted_a_ids = fields.Many2many('test_fields.model_a', relation='rel_fields_model_a_model_b_1', ondelete='restrict')
    b_restricted_a_ids = fields.Many2many('test_fields.model_a', relation='rel_fields_model_a_model_b_2')
...
class Test_Fields_DecimalPrecisionTest(models.Model):
    _name = 'test_fields.decimal.precision.test'
