...
class TestFieldsModelActiveField(models.Model):
    ...
    relatives_ids = fields.Many2many(
        ...
        'test_fields_model_active_field_relatives_rel', 'source_id', 'dest_id',
    )
...
class TestFieldsModelA(models.Model):
    ...
    name = fields.Char()
    a_restricted_b_ids = fields.Many2many('test_fields.model_b', relation='rel_model_a_model_b_1')
...
class TestFieldsModelB(models.Model):
    ...
    name = fields.Char()
    a_restricted_a_ids = fields.Many2many('test_fields.model_a', relation='rel_model_a_model_b_1', ondelete='restrict')
...
class SelectionCompanyDependent(models.Model):
    _name = 'test_fields.model_selection_company_dependent'
...
class SelectionCompanyDependent(models.Model):  # noqa: F811
    _inherit = 'test_fields.model_selection_company_dependent'
...
class TestFieldsCreatePerformance(models.Model):
    ...
    tag_ids = fields.Many2many('test_fields.create.performance.line', 'test_create_perf_tag_ids')
...
class TestFieldsModifiedLinePositive(models.Model):
    ...
    line_ids = fields.Many2many('test_fields.modified.line', relation='fields_modified_line_fields_modified_line_positive_rel')
