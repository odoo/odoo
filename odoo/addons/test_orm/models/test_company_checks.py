...
class Test_Company_Cheks_Parent(models.Model):
    _name = 'test_company_checks.parent'
    _description = 'Multicompany parent'

    name = fields.Char()
    company_id = fields.Many2one('res.company')


class Test_Company_Cheks_Child(models.Model):
    _name = 'test_company_checks.child'
    _description = 'Multicompany child'
...
class Test_Company_Cheks_Child_Nocheck(models.Model):
