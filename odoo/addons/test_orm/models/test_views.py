...
class Test_Views_Category(models.Model):
...
class Test_Views_Discussion(models.Model):
...
class Test_Views_Message(models.Model):
...
class Test_Views_Emailmessage(models.Model):
...
class Test_Views_Mixed(models.Model):
...
class Test_Views_CreativeworkEdition(models.Model):
...
class Test_Views_Model__Binary(models.Model):
...
class Test_Views_Model__A(models.Model):
    _name = 'test_views.model_a'
    _description = 'Model A'

    name = fields.Char()
    a_restricted_b_ids = fields.Many2many('test_views.model_b', relation='rel_views_model_a_model_b_1')
    b_restricted_b_ids = fields.Many2many('test_views.model_b', relation='rel_views_model_a_model_b_2', ondelete='restrict')


class Test_Views_Model__B(models.Model):
    _name = 'test_views.model_b'
    _description = 'Model B'

    name = fields.Char()
    a_restricted_a_ids = fields.Many2many('test_views.model_a', relation='rel_views_model_a_model_b_1', ondelete='restrict')
    b_restricted_a_ids = fields.Many2many('test_views.model_a', relation='rel_views_model_a_model_b_2')


class Test_Views_Model_All_Access(models.Model):
...
class Test_Views_Model_Some_Access(models.Model):
...
class Test_Views_Model_2Some_Access(models.Model):
...
class Test_Views_Model_3Some_Access(models.Model):
...
class Test_Views_Binary(models.Model):
    _name = _description = "test_views.binary"
...
class Test_Views_Calendar(models.Model):
    _name = _description = "test_views.calendar"
...
class Test_Views_ComputedModifier(models.Model):
    _name = 'test_views.computed.modifier'
