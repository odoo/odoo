...
class TestFormattedReadGroup(common.TransactionCase):
            ...
            [
                {
                    ...
                    'date:week': ('2022-01-23', 'W5 2022 (Jan 23 – 29)'),
                },
                {
                    '__count': 3,
                    '__extra_domain': ['&', ('date', '>=', '2022-01-30'), ('date', '<', '2022-02-06')],
                    'date:week': ('2022-01-30', 'W6 2022 (Jan 30 – Feb 5)'),
                },
                {
                    '__count': 1,
                    '__extra_domain': ['&', ('date', '>=', '2022-05-29'), ('date', '<', '2022-06-05')],
                    'date:week': ('2022-05-29', 'W23 2022 (May 29 – Jun 4)'),
                },
                {
                    '__count': 1,
                    '__extra_domain': ['&', ('date', '>=', '2023-01-29'), ('date', '<', '2023-02-05')],
                    'date:week': ('2023-01-29', 'W5 2023 (Jan 29 – Feb 4)'),
                },
    ...
    def test_groupby_date_week_timezone(self):
        ...
        excepted_results = {
            'fr_BE': [  # same as ISO
                {
                    'date:week': ('2021-12-27', 'W52 2021 (27 déc. – 2 janv.)'),
                    '__extra_domain': ['&', ('date', '>=', '2021-12-27'), ('date', '<', '2022-01-03')],
                    '__count': 2,
                },
                {
                    'date:week': ('2022-01-03', 'W1 2022 (3–9 janv.)'),
                    '__extra_domain': ['&', ('date', '>=', '2022-01-03'), ('date', '<', '2022-01-10')],
                    '__count': 1,
                },
                {
                    'date:week': ('2022-05-23', 'W21 2022 (23–29 mai)'),
                    '__extra_domain': ['&', ('date', '>=', '2022-05-23'), ('date', '<', '2022-05-30')],
                    '__count': 3,
                },
                {
                    'date:week': ('2022-05-30', 'W22 2022 (30 mai – 5 juin)'),
                    '__extra_domain': ['&', ('date', '>=', '2022-05-30'), ('date', '<', '2022-06-06')],
                    '__count': 1,
                },
                {
                    'date:week': ('2022-06-13', 'W24 2022 (13–19 juin)'),
                    '__extra_domain': ['&', ('date', '>=', '2022-06-13'), ('date', '<', '2022-06-20')],
                    '__count': 2,
                },
                {
                    'date:week': ('2022-06-20', 'W25 2022 (20–26 juin)'),
            ...
            'ar_SY': [  # non-iso, start of week = sat
                {
                    'date:week': ('2022-01-01', 'W1 2022 (1–7 كانون الثاني)'),
                    '__extra_domain': ['&', ('date', '>=', '2022-01-01'), ('date', '<', '2022-01-08')],
                    '__count': 3,
                },
                {
                    'date:week': ('2022-05-21', 'W21 2022 (21–27 أيار)'),
                    '__extra_domain': ['&', ('date', '>=', '2022-05-21'), ('date', '<', '2022-05-28')],
                    '__count': 1,
                },
                {
                    'date:week': ('2022-05-28', 'W22 2022 (28 أيار – 3 حزيران)'),
                    '__extra_domain': ['&', ('date', '>=', '2022-05-28'), ('date', '<', '2022-06-04')],
                    '__count': 3,
                },
                {
                    'date:week': ('2022-06-18', 'W25 2022 (18–24 حزيران)'),
            ...
            'en_US': [   # non-iso, start of week = sun
                {
                    'date:week': ('2021-12-26', 'W1 2022 (Dec 26 – Jan 1)'),
                    '__extra_domain': ['&', ('date', '>=', '2021-12-26'), ('date', '<', '2022-01-02')],
                    '__count': 1,
                },
                {
                    'date:week': ('2022-01-02', 'W2 2022 (Jan 2 – 8)'),
                    '__extra_domain': ['&', ('date', '>=', '2022-01-02'), ('date', '<', '2022-01-09')],
                    '__count': 2,
                },
                {
                    'date:week': ('2022-05-22', 'W22 2022 (May 22 – 28)'),
                ...
                {
                    'date:week': ('2022-06-12', 'W25 2022 (Jun 12 – 18)'),
                    '__extra_domain': ['&', ('date', '>=', '2022-06-12'), ('date', '<', '2022-06-19')],
                    '__count': 1,
                },
                {
                    'date:week': ('2022-06-19', 'W26 2022 (Jun 19 – 25)'),
