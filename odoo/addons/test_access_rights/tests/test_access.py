...
class TestAccess(TransactionCase):
    ...
    def make_access(self, name="", records=None, group=None, mode='r', **kwargs):
    ...
    def assertAccess(self, allowed, operation='read'):
        ...
        self.assertEqual(self.records._filter_access(operation), allowed)
    ...
    def test_mode(self):
        access = self.make_access(self.records, mode='rw')
    ...
    def test_bad_mode(self):
        message = "Inconsistent field values: mode='r', for_write=True."
        with self.assertRaisesRegex(ValidationError, message):
            self.make_access(self.records, mode='r', for_read=True, for_write=True)
    ...
    def test_sudo(self):
        ...
        self.assertEqual(records._filter_access('read'), records)
        self.assertEqual(records._filter_access('write'), records)
        self.assertEqual(records._filter_access('create'), records)
        self.assertEqual(records._filter_access('unlink'), records)
    ...
    def test_no_access(self):
        ...
        self.assertFalse(self.records._filter_access('read'))
        self.assertFalse(self.records._filter_access('write'))
        self.assertFalse(self.records._filter_access('create'))
        self.assertFalse(self.records._filter_access('unlink'))
    ...
    def test_one_permission(self):
        ...
        self.make_access(group=self.group1, mode='r')
        self.make_access(records=humans, group=self.group1, mode='w')
    ...
    def test_special_restrict_operations(self):
        ...
        self.make_access(group=self.group1, mode='r')
        self.make_access(group=self.group2, mode='crwd')
        # restriction on some operations
        self.make_access(records=self.records - self.bowser, mode='cwd')
    ...
    def test_error_message_no_access(self):
        self.make_access(group=self.group3, mode='cd')
    ...
    def test_error_message_partial_access(self):
        ...
        self.assertEqual(self.records._filter_access('read'), humans)
