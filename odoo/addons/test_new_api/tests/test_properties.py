...
class PropertiesCase(TransactionCase):
    ...
    def test_search_property_definition(self):
        self.assertEqual(
            self.env['test_new_api.message'].search_property_definition(
                ...
                'attributes': [
                    {
                        ...
                        'definition': self.discussion_1.attributes_definition
                    }
                ]
            }
        )
            ...
            ),
            {
                'attributes': [
                    ...
                    },
                    {
                        ...
                        'definition': self.discussion_2.attributes_definition
                    }
                ]
            }
        )
