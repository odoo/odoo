...
class Bar(models.Model):
    ...
    foo2_name_related = fields.Char(related='foo2.name', string='foo2_name_related', readonly=False)
    foo2_name_computed = fields.Char(compute='_compute_foo2_name_computed')
    foo2_title_related = fields.Char(related='foo2.title', readonly=False, string='foo2_title_related')
