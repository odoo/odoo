...
from odoo.tools.translate import TRANSLATE_FUNCS, LazyTranslate, _
...
class IrModelFields(models.Model):
    ...
    def _reflect_field_params(self, field, model_id):
        ...
        match field.translate:
            case False:
                translate = None
            case True:
                translate = 'standard'
            case _:
                translate = next(k for k, v in TRANSLATE_FUNCS.items() if v == field.translate)
        return {
            'model_id': model_id,
    ...
    def _instanciate_attrs(self, field_data):
        ...
        if field_data['ttype'] in ('char', 'text', 'html'):
            attrs['translate'] = TRANSLATE_FUNCS.get(
                field_data['translate'],
                True
            ) if field_data['translate'] else False
