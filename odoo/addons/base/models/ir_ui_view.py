...
* if False, the view currently does not extend its parent but can be enabled
    ...
    def _check_xml(self):
        ...
        for view in self:
            ...
            try:
                ...
                lines = etree.tostring(combined_arch).decode().splitlines(keepends=True)
    ...
    def _check_000_inheritance(self):
        ...
        #       called before other constraint metheods to avoid infinite loop in `_get_combined_arch`.
