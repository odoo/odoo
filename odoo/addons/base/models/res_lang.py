...
class Lang(models.Model):
    ...
    name = fields.Char(required=True, index=unique(message="The name of the language must be unique!"))
    code = fields.Char(string='Locale Code', required=True, help='This field is used to set/get locales for user', index=unique(message="The code of the language must be unique!"))
    iso_code = fields.Char(string='ISO code', help='This ISO code is the name of po files to use for translations')
    url_code = fields.Char('URL Code', required=True, help='The Lang Code displayed in the URL', index=unique(message="The URL code of the language must be unique!"))
