...
class Users(models.Model):
    ...
    def _unlink_except_master_data(self):
        ...
        public_user_template = self.env.ref("base.public_user", False)
        ...
        self.clear_caches()
        if (portal_user_template and portal_user_template in self) or (default_user_template and default_user_template in self) or (public_user_template and public_user_template in self):
