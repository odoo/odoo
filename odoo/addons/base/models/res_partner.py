...
class Partner(models.Model):
    ...
    vat = fields.Char(string='Tax ID', help="The Tax Identification Number."
                                    "Complete it if the contact is subjected to government taxes. Used in some legal statements.")
    ...
    customer = fields.Boolean(string='Is a Customer', default=True,
                               help="Check this box if this contact is a customer. It will show in sales orders.")
    supplier = fields.Boolean(string='Is a Vendor',
                               help="Check this box if this contact is a vendor. It will show in purchase orders.")
