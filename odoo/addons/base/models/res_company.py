...
class Company(models.Model):
    ...
    name = fields.Char(
        related="partner_id.name", string="Company Name", required=True, store=True
    )
    ...
    logo = fields.Binary(
        related="partner_id.image", default=_get_logo, string="Company Logo"
    )
