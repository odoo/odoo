...
try:
    ...
    if not available:
        ...
        if fnt := getFont(substitution_font):
            _DEFAULT_BARCODE_FONT = substitution_font
            fnt.ascent = 629
            fnt.descent = -157
    createBarcodeDrawing('Code128', value='foo', format='pdf', width=100, height=100, humanReadable=1, fontName=_DEFAULT_BARCODE_FONT).asString('pdf')
except Exception:
    pass
