...
class IrActionsReport(models.Model):
    ...
    def report_action(self, docids, data=None, config=True):
        ...
        if (self.env.user.has_group('base.group_system')) and ((not self.env.user.company_id.external_report_layout_id) or (not discard_logo_check and not self.env.user.company_id.logo)) and config:
