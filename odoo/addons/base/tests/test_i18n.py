...
class I18nTest(TransactionCase):
    def test_format_list(self):
        ...
        self.assertEqual(
            formatted_text, "Mario and Luigi", "Should default to English."
        )
        ...
        self.assertEqual(
            formatted_text,
            "To be or Not to be",
            "Should take the style into account.",
        )

        lang._activate_lang("fr_FR")

        formatted_text = format_list(
            lang.with_context(lang="fr_FR").env, ["Athos", "Porthos", "Aramis"]
        )
        self.assertEqual(
            formatted_text,
            "Athos, Porthos et Aramis",
            "Should use the language of the user.",
        )
        ...
        self.assertEqual(
            formatted_text,
            "Athos, Porthos et Aramis",
            "Should use the chosen language.",
        )
