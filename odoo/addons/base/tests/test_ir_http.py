...
class test_ir_http_mimetype(common.TransactionCase):
    ...
    def test_ir_http_mimetype_attachment(self):
        ...
        attachment = self.env["ir.attachment"].create(
            {"datas": GIF, "name": "Test mimetype gif", "datas_fname": "file.gif"}
        )
    ...
    def test_ir_http_mimetype_basic_field(self):
        ...
        partner = self.env["res.partner"].create(
            {"image": GIF, "name": "Test mimetype basic field"}
        )
    ...
    def test_ir_http_mimetype_computed_field(self):
        ...
        resized = odoo.tools.image_get_resized_images(
            prop.value_binary, return_big=True, avoid_resize_medium=True
        )["image_small"]
