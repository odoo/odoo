...
class TestConfigManager(TransactionCase):
    ...
    def test_04_syslog_logfile_exclusive_cli(self, error):
    ...
    @patch('optparse.OptionParser.error')
    def test_06_translate_in_requires_language_and_db_name(self, error):
    ...
    @patch('optparse.OptionParser.error')
    def test_07_overwrite_existing_translations_incompatible_with_translate_in_or_update(self, error):
    ...
    @patch('optparse.OptionParser.error')
    def test_08_translate_out_requires_db_name(self, error):
    ...
    @patch('optparse.OptionParser.error')
    def test_09_init_update_incompatible_with_multidb(self, error):
