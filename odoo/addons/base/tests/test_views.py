...
class TestViews(ViewCase):
    ...
    def test_searchpanel(self):
        ...
        self.assertInvalid(
            ...
            """Unknown field "res.groups.inherit_id" in domain of <field name="group_ids.all_implied_ids"> ([('inherit_id', '=', inherit_id)])""",
        )
        self.assertInvalid(
            arch % ('', '<field name="inherit_id" select="multi"/>', 'view_access', 'inherit_id'),
            """Field “inherit_id” used in domain of <field name="group_ids.all_implied_ids"> ([('view_access', '=', inherit_id)]) is present in view but is in select multi.""",
        )
    ...
    def test_partial_validation(self):
        ...
        self.assertInvalid(
            ...
            """Unknown field "res.groups.invalid_field" in domain of <field name="group_ids.all_implied_ids"> ([('invalid_field', '=', 'dummy')]))""",
            inherit_id=view0.id,
        )
    ...
    def test_view_ref(self):
        ...
        self.assertEqual(
            ...
            0,
            "The view test_views_test_view_ref should not be in the views of the many2many field group_ids.all_implied_ids"
        )
