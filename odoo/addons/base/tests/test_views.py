...
class TestViewInheritance(ViewCase):
    ...
    def test_no_default_view(self):
        self.assertFalse(
            self.View.default_view(model="does.not.exist", view_type="form")
        )
    ...
    def test_no_recursion(self):
        ...
        with self.assertRaises(ValidationError), self.cr.savepoint():
            r1.write(
                {"inherit_id": r1.id, "arch": self.arch_for("itself", parent=True)}
            )
...
class TestTemplating(ViewCase):
    ...
    def test_branding_inherit(self):
        ...
        arch_string = view1.with_context(inherit_branding=True).read_combined(["arch"])[
            "arch"
        ]
    ...
    def test_esc_no_branding(self):
        ...
        arch_string = view.with_context(inherit_branding=True).read_combined(["arch"])[
            "arch"
        ]
        arch = etree.fromstring(arch_string)
        self.View.distribute_branding(arch)
...
class TestViews(ViewCase):
    ...
    def test_view_inheritance_text_inside(self):
        ...
        self.assertEqual(view["type"], "form")
        self.assertEqual(
            view["arch"], '<form string="F">(<div>a<p/>b<p/>c</div>)</form>'
        )
    ...
    def test_view_inheritance_text_after(self):
        ...
        self.assertEqual(view["type"], "form")
        self.assertEqual(view["arch"], '<form string="F">(<div/>a<p/>b<p/>c)</form>')
    ...
    def test_view_inheritance_text_before(self):
        ...
        self.assertEqual(view["type"], "form")
        self.assertEqual(view["arch"], '<form string="F">(a<p/>b<p/>c<div/>)</form>')
    ...
    def test_context_in_view(self):
        ...
        with self.assertRaises(ValidationError):
            self.View.create(
                {"name": "valid context", "model": "ir.ui.view", "arch": arch % ""}
            )
    ...
    def test_domain_in_view(self):
        ...
        with self.assertRaises(ValidationError):
            self.View.create(
                {"name": "valid domain", "model": "ir.ui.view", "arch": arch % ""}
            )
    ...
    def test_domain_on_readonly_field_in_view(self):
        ...
        """
        self.View.create({"name": "valid domain", "model": "ir.ui.view", "arch": arch})
    ...
    def test_attrs_field(self):
        ...
        with self.assertRaises(ValidationError):
            self.View.create(
                {"name": "valid attrs", "model": "ir.ui.view", "arch": arch % ""}
            )
...
class TestDefaultView(ViewCase):
    ...
    def testDefaultViewBase(self):
        self.View.create(
            {"inherit_id": False, "priority": 10, "mode": "primary", "arch": "<qweb/>"}
        )
        view2 = self.View.create(
            {"inherit_id": False, "priority": 1, "mode": "primary", "arch": "<qweb/>"}
        )
    ...
    def testDefaultViewPrimary(self):
        ...
        self.View.create(
            {"inherit_id": False, "priority": 5, "mode": "primary", "arch": "<qweb/>"}
        )
        view3 = self.View.create(
            {
                "inherit_id": view1.id,
...
class TestViewCombined(ViewCase):
    ...
    * Apply inheriting views on top
    ...
    def test_read_from_child_primary(self):
        ...
        self.assertEqual(
            etree.fromstring(arch), E.qweb(E.a1(), E.a4(), E.a3(), E.a2()), arch
        )
    ...
    def test_cross_model_simple(self):
        ...
        self.assertEqual(
            ...
            E.qweb(E.a1(), E.c3(), E.c2(), E.c1(), E.a3(), E.a2()),
            arch,
        )
    ...
    def test_cross_model_double(self):
        ...
        self.assertEqual(
            etree.fromstring(arch),
            E.qweb(E.a1(), E.d1(), E.b2(), E.b1(), E.a3(), E.a2()),
            arch,
        )
...
class TestOptionalViews(ViewCase):
    ...
    def test_applied_state_toggle(self):
        ...
        arch = self.v0.with_context(context).read_combined(["arch"])["arch"]
        self.assertEqual(
            etree.fromstring(arch), E.qweb(E.base(), E.v1(), E.v2(), E.v3())
        )
