    ...
    def setUpClass(cls):
        ...
        if not cls.user_demo:
            ...
            cls.user_demo = cls.env['res.users'].create({
                ...
                'groups_id': [(fields.X2ManyCmd.SET, 0, [cls.env.ref('base.group_user').id, cls.env.ref('base.group_partner_manager').id])],
            })
        ...
        cls.partners = cls.env['res.partner'].create([
            {
                ...
                'category_id': [(fields.X2ManyCmd.SET, 0, [cls.partner_category_child_1.id, cls.partner_category_child_2.id,])],
                'child_ids': [(fields.X2ManyCmd.CREATE, 0, {
