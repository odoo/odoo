...
class TestIrModel(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.env['ir.model'].create({
            ...
            'field_id': [
                (fields.X2ManyCmd.CREATE, 0, {'name': 'x_name', 'ttype': 'char', 'field_description': 'Name'}),
            ]
        })
        ...
        cls.bananas_model = cls.env['ir.model'].create({
            ...
            'field_id': [
                (fields.X2ManyCmd.CREATE, 0, {'name': 'x_name', 'ttype': 'char', 'field_description': 'Name'}),
                (fields.X2ManyCmd.CREATE, 0, {'name': 'x_length', 'ttype': 'float', 'field_description': 'Length'}),
                (fields.X2ManyCmd.CREATE, 0, {'name': 'x_color', 'ttype': 'integer', 'field_description': 'Color'}),
                (fields.X2ManyCmd.CREATE, 0, {'name': 'x_ripeness_id', 'ttype': 'many2one',
