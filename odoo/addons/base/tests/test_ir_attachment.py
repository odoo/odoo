...
class TestIrAttachment(TransactionCaseWithUserDemo):
    ...
    def test_16_from_file_takes_little_memory(self):
        ...
        # only 1.3MiB. We use tracemalloc to make sure _from_file() uses
        ...
        try:
            ...
            with file_open('base/i18n/base.pot', 'rb') as file:
                attach2 = self.env['ir.attachment']._from_file(file, name='base.pot')
        ...
        self.assertTrue(attach1.mimetype == attach2.mimetype == 'text/plain',
                       (attach1.mimetype, attach2.mimetype))
