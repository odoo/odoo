...
class TestResPartnerBank(SavepointCaseWithUserDemo):
    ...
    def test_sanitized_account_number(self):
        ...
        # updating the account_number value will also update the formatted_account_number
        partner_bank.write({'account_number': 'BE001251882303WRONG'})
        self.assertEqual(partner_bank.account_number, partner_bank.formatted_account_number)
