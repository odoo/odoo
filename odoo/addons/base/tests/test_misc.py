...
class TestFormatLang(TransactionCase):
    ...
    def test_grouping(self):
        ...
        self.assertEqual(misc.formatLang(self.env['res.lang'].with_context(lang='fLT').env, 1000000, grouping=True), '10?00?000!00')
        self.assertEqual(misc.formatLang(self.env['res.lang'].with_context(lang='fLT').env, 1000000, grouping=False), '1000000.00')
    ...
    def test_rounding_mode(self):
        self.assertEqual(misc.formatLang(self.env, 100.205, rounding_mode=ROUND_HALF_UP), '100.21')
        self.assertEqual(misc.formatLang(self.env, 100.215, rounding_mode=ROUND_HALF_UP), '100.22')

        self.assertEqual(misc.formatLang(self.env, 100.205, rounding_mode=ROUND_HALF_DOWN), '100.20')
        self.assertEqual(misc.formatLang(self.env, 100.215, rounding_mode=ROUND_HALF_DOWN), '100.21')

    def test_amount_rounding(self):
        self.assertEqual(misc.formatLang(self.env, 1000000.00), '1,000,000.00')
        self.assertEqual(misc.formatLang(self.env, 1000000.00, amount_rounding='units'), '1,000,000')
        self.assertEqual(misc.formatLang(self.env, 1000000.00, amount_rounding='thousands'), '1,000')
        self.assertEqual(misc.formatLang(self.env, 1000000.00, amount_rounding='lakhs'), '10')
        self.assertEqual(misc.formatLang(self.env, 1000000.00, amount_rounding="millions"), '1')
