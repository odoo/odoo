...
""",
    'data': [
        'data/res_partner_data.xml',  # needed by res_users_data.xml
        'data/res_users_data.xml',  # needed by base_groups.xml
        'security/base_groups.xml',  # needed by ir_action_data.xml
        ...
        'data/res_currency_data.xml',  # needed by res_country_data.xml
        'data/res_country_data.xml',  # needed by clearing_label_data.xml
        ...
        'wizard/base_language_install_views.xml',  # needed by res_lang_views.xml
        ...
        'wizard/wizard_ir_model_menu_create_views.xml',  # needed by ir_model_views.xml
