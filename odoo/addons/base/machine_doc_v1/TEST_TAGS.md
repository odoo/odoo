...
```bash
# All base tests (4039 methods, 816 classes, 142 files)
...
| `test_res_users_apikeys_scope.py` | `post_install`, `-at_install` | 6 | 33 | ScopeCase, TransactionCase |
