...
```bash
# All base tests (3851 methods, 785 classes, 138 files)
...
| `test_qweb.py` | `post_install`, `-at_install` | 26 | 211 | TransactionCase, TransactionCaseWithUserDemo |
