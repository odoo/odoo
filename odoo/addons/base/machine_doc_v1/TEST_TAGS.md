...
```bash
# All base tests (4100 methods, 830 classes, 144 files)
...
| `test_qweb.py` | `post_install`, `-at_install` | 28 | 231 | TransactionCase, TransactionCaseWithUserDemo |
