...
```bash
# All base tests (3912 methods, 800 classes, 138 files)
...
### Tagged Files (78 files, 468 classes)
...
| `test_import_files.py` | `post_install`, `-at_install` | 4 | 106 | TransactionCase |
| `test_ir_actions.py` | `post_install`, `-at_install` | 7 | 104 | TestServerActionsBase, TransactionCase, TestCommonCustomFields |
| `test_ir_actions_audit.py` | `post_install`, `-at_install` | 51 | 155 | TransactionCase |
...
| `test_ir_attachment.py` | `post_install`, `-at_install` | 10 | 162 | TransactionCaseWithUserDemo, TransactionCaseWithUserPortal, TransactionCase |
...
| `test_ir_model.py` | `-at_install`, `post_install`, `test_eval_context` | 14 | 138 | TransactionCase, HttpCase |
...
| `test_views.py` | `post_install`, `-at_install`, `-standard`, `migration`, `render_all_views`, `post_install_l10n`, `at_install`, `modifiers` | 56 | 303 | TransactionCase, ViewCase, BaseCase, TransactionCaseWithUserDemo |
...
| Total test classes | 800 |
| Total test methods | 3912 |
