...
```bash
# All base tests (3899 methods, 798 classes, 138 files)
...
| `test_ir_model.py` | `-at_install`, `post_install`, `test_eval_context` | 14 | 137 | TransactionCase, HttpCase |
