...
```bash
# All base tests (4145 methods, 834 classes, 145 files)
...
| `test_res_users.py` | `post_install`, `-at_install`, `groups` | 30 | 104 | UsersCommonCase, TransactionCase, HttpCase |
