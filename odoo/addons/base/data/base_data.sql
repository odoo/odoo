...
insert into ir_model_data (name, module, model, noupdate, nodelete, res_id) VALUES ('EUR', 'base', 'res.currency', true, true, 1);
...
insert into ir_model_data (name, module, model, noupdate, nodelete, res_id) VALUES ('main_company', 'base', 'res.company', true, true, 1);
...
insert into ir_model_data (name, module, model, noupdate, nodelete, res_id) VALUES ('main_partner', 'base', 'res.partner', true, true, 1);
...
insert into ir_model_data (name, module, model, noupdate, nodelete, res_id) VALUES ('user_root', 'base', 'res.users', true, true, 1);
select setval('res_users_id_seq', 1);

insert into res_groups (id, name) VALUES (1, 'Employee');
insert into ir_model_data (name, module, model, noupdate, nodelete, res_id) VALUES ('group_user', 'base', 'res.groups', true, true, 1);
