...
class TransientModel(Model):
    ...
    def _transient_vacuum(self):
        ...
        if self._transient_max_hours:
            ...
            remaining = self._transient_clean_rows_older_than(self._transient_max_hours * 60 * 60)

        if self._transient_max_count:
            # Count-based expiration
            remaining = self._transient_clean_old_rows(self._transient_max_count)
        return self._name, remaining
