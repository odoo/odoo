...
class Field(typing.Generic[T]):
    ...
    args: dict[str, typing.Any] = None  # the parameters given to __init__()
    ...
    _depends: Collection[Field] | None = None  # collection of field dependencies
    ...
    def get_depends(self, model: BaseModel) -> tuple[Iterable[Field], Iterable[str]]:
    ...
    def setup_related(self, model: BaseModel) -> None:
        ...
        assert isinstance(field, type(self)), f"Related field {field!r} of different type then this field"
    ...
    def resolve_depends(self, registry: Registry) -> Iterable[tuple[Field, ...]]:
    ...
    def get_description(self, env: Environment, attributes: Collection[str] = ()) -> ValuesType:
...
def apply_required(model: BaseModel, field_name: str):
