...
def constrains(*args) -> Decorator:
    ...
    .. warning::
        ...
        have a inconsistent data during the current transaction. Moreover, if the constraint
        depends on database records that are not the records constrained (e.g.
        constrains('one2many')), the invariant cannot be guarantee since we use
