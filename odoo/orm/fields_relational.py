...
class Many2one(_Relational):
    ...
    def _get_inverse_name(self, model_name):
        return f"_{model_name.replace('.', '_')}_ids"
...
class One2many(_RelationalMulti):
    ...
    _is_autogenerated: bool = False     # True for auto-generated inverse fields
