...
import odoo.modules
from odoo.orm.utils import check_property_field_value_name, READ_GROUP_NUMBER_GRANULARITY
...
def get_unaccent_wrapper(cr):
    warnings.warn(
        "Since 19.0, deprecated method, use env.registry.unaccent instead",
