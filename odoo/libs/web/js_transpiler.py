...
def is_odoo_module(url, content):
    """Detect if the file is a native odoo module needing transpilation.
    ...
    """
    # Only scan the header — the directive must appear near the top.
    header = content[:500]
    result = ODOO_MODULE_RE.search(header)
