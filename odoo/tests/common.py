...
class ChromeBrowser:
    ...
    def __init__(self, test_case: HttpCase, success_signal: Callable[[str], bool], headless: bool = True, devtools: bool = False):
...
class HttpCase(TransactionCase):
    ...
    def browser_js(self, url_path, code, ready='', login=None, timeout=60, cookies=None, error_checker=None, watch=False, success_signal=None, devtools=False, **kw):
        ...
        browser = ChromeBrowser(self, headless=not watch, success_signal=success_signal or (lambda s: 'test successful' in s), devtools=devtools)
        try:
