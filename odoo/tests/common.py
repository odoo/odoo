...
class TransactionCase(BaseCase):
    ...
    def _post_setUpClass(cls):
        ...
        cls.clear()
        cls._savepoint_id = f'{next(savepoint_seq)}_{cls.__qualname__}'
        cls.cr.execute(f'SAVEPOINT test_{cls._savepoint_id}')
    ...
    def setUp(self):
        ...
        self.addCleanup(self.cr.execute, f'ROLLBACK TO SAVEPOINT test_{self._savepoint_id}')
