...
class BaseCase(case.TestCase, metaclass=MetaCase):
    ...
    def __init__(self, methodName='runTest'):
        ...
        self.test_tags = self.test_tags | set(self.get_method_additional_tags(methodName))
    ...
    def get_method_additional_tags(self, test_method):
        ...
        """
        additional_tags = []
        method_object = getattr(self, test_method, None)
        method_source = inspect.getsource(method_object) if method_object else ''
