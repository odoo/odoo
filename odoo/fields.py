    ...
    def _setup_attrs(self, model, name):
        ...
        for field in reversed(resolve_mro(model, name, self._can_setup_from)):
            ...
            if 'selection' in field.args:
                if self.related:
                    _logger.warning("%s: selection attribute will be ignored because the field is related", self)
            ...
            if 'selection_add' in field.args:
                if self.related:
                    _logger.warning("%s: selection_add attribute will be ignored because the field is related", self)
