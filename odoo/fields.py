...
from .models import check_property_field_value_name, NewId
...
class _Relational(Field[M], typing.Generic[M]):
    ...
    def __get__(self, records, owner=None) -> M:
...
class Many2one(_Relational[M], typing.Generic[M]):
    ...
    def __init__(self, comodel_name: type[M] = SENTINEL,
...
class One2many(_RelationalMulti[M], typing.Generic[M]):
    ...
    def __init__(self, comodel_name: type[M] = SENTINEL, inverse_name: str = SENTINEL,
                 string: str | Sentinel = SENTINEL, **kwargs):
...
class Many2many(_RelationalMulti[M], typing.Generic[M]):
    ...
    def __init__(self, comodel_name: type[M] = SENTINEL, relation: str = SENTINEL,
