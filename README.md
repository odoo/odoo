...
For a self-hosted installation deploy Odoo to Dome in [one-click](https://app.trydome.io/signup?package=odoo):

[![Deploy to Dome](https://trydome.io/button.svg)](https://app.trydome.io/signup?package=odoo)
