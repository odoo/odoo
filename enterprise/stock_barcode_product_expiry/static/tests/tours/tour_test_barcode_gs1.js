...
registry.category("web_tour.tours").add('test_gs1_receipt_expiration_date', { steps: () => [
    {
        ...
        run: function () {
            ...
            helper.assertLineQty(line, "0/25");
        }
    },
    ...
    },
    {
        ...
        run: function () {
            ...
            helper.assertLineQty(line, "8/25");
        }
    },
    // The following scanned barcode should be decomposed like that:
    //      - (01)00000076543210    > product barcode (76543210)
    ...
    },
    {
        ...
        run: function () {
            ...
            helper.assertLineQty(parentLine, "12/25");
    ...
    },
    {
        ...
        run: function () {
            ...
            helper.assertLineQty(parentLine, "20/25");
            helper.assertLineQty(line1, "8");
            helper.assertLineQty(line2, "4");
    ...
    },
    {
        ...
        run: function () {
            ...
            helper.assertLineQty(parentLine, "25/25");
            helper.assertLineQty(line1, "8");
            helper.assertLineQty(line2, "4");
            helper.assertLineQty(line3, "8");
            helper.assertLineQty(line4, "5");
            helper.assertLineIsHighlighted(line1, false);
            helper.assertLineIsHighlighted(line2, false);
