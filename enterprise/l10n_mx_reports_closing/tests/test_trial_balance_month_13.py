    ...
    def test_comparison(self):
        ...
        self.assertLinesValues(
            ...
            [
                ...
                ('305.01.01 Uncut results',                                      0.0,    1000.0,      0.0,     0.0,   0.0, 250.0,     0.0,  1300.0),
                ('401.01.01 Sales and/or services taxed at the general rate',    0.0,       0.0,      0.0,    20.0, 250.0, 300.0,     0.0,    20.0),
