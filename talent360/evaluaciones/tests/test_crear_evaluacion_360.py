...
class TestCrearEvaluacion360(TransactionCase):
    ...
    def relacionar_competencias_preguntas(self, competencia1, competencia2, competencia3, pregunta1, pregunta2, pregunta3):
        """
    ...
    def test03_agregar_preguntas(self):
        ...
        competencia1, competencia2, competencia3 = self.relacionar_competencias_preguntas(
            competencia1, competencia2, competencia3, pregunta1, pregunta2, pregunta3)
        self.evaluacion360.competencia_ids = [(4, competencia1.id)]
        self.evaluacion360.competencia_ids = [(4, competencia2.id)]
        self.evaluacion360.competencia_ids = [(4, competencia3.id)]
