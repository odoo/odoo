# -*- coding: utf-8 -*-
{
    'name': "AI to SQL - Odoo SQL Query Generator",
    ...
    'description': """
      Odoo AI SQL Generator uses ChatGPT tech for AI data analytics. Ask questions, get Odoo SQL queries. Real-time SQL assistant; see results, export data. Like AI dashboard  for your Odoo database. Chat GPT AI agent for Odoo AI. Your direct OpenAI key enables SQL exploration. No data sync, instant insights. Get Odoo AI for SQL
    """,
    'author': "Niyu Labs",
