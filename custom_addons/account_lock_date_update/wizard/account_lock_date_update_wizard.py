...
class AccountLockDateUpdateWizard(models.TransientModel):
    ...
    # The first application of this wizard after QBO migration
    # cutover will lock the pre-cutover period permanently.
    # Ensure QBO historical data import is complete and
    # reconciled before applying the cutover lock date.
    # Suggested: add ir.config_parameter
    # 'account_lock_date_update.qbo_cutover_complete' = True
    # as a prerequisite check before allowing action_apply().
    # -----------------------------------------------------------
