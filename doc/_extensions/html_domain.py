...
def setup(app):
    ...
    # override parameter was added for version sphinx >= 1.4
    #  (None, None) is the default empty value to avoid
    #  TypeError: 'bool' object is not iterable
    override = True if sphinx.version_info >= (1, 4) else (None, None)
    ...
    ), override=override) # docutils.nodes.address exists and is a bibliographic element
