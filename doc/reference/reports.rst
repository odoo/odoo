...
``t-lang`` parameter, so it will be rendered in the language of the parner. This way, 
each Sale Order will be printed in the language of the corresping customer. If you wish 
