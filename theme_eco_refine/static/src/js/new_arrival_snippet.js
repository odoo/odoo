odoo.define('theme_eco_refine.new_arrival_products', function(require) {
    ...
    var NewArrivalProducts = PublicWidget.Widget.extend({
        ...
        willStart: function() {
            var self = this;
            return ajax.jsonRpc('/new_arrival_products', 'call', {}).then(function(data) {
        ...
        start: function() {
            ...
            self.$el.find('#new_arrival_carousel').html(
                Qweb.render('theme_eco_refine.new_product_arrival', {
                    products: products,
